...
8010003a:	c7 44 24 04 f4 89 10 	movl   $0x801089f4,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
80100049:	e8 10 53 00 00       	call   8010535e <initlock>
...
801000bd:	e8 bd 52 00 00       	call   8010537f <acquire>
...
80100104:	e8 d8 52 00 00       	call   801053e1 <release>
        return b;
...
8010011f:	e8 44 4b 00 00       	call   80104c68 <sleep>
      goto loop;
...
8010017c:	e8 60 52 00 00       	call   801053e1 <release>
      return b;
...
80100198:	c7 04 24 fb 89 10 80 	movl   $0x801089fb,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 0c 8a 10 80 	movl   $0x80108a0c,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 13 8a 10 80 	movl   $0x80108a13,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 3e 51 00 00       	call   8010537f <acquire>
...
8010029d:	e8 a1 4a 00 00       	call   80104d43 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 33 51 00 00       	call   801053e1 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 bf 4f 00 00       	call   8010537f <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 1a 8a 10 80 	movl   $0x80108a1a,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 23 8a 10 80 	movl   $0x80108a23,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 a9 4e 00 00       	call   801053e1 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 2a 8a 10 80 	movl   $0x80108a2a,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 39 8a 10 80 	movl   $0x80108a39,(%esp)
...
8010058f:	e8 9c 4e 00 00       	call   80105430 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 3b 8a 10 80 	movl   $0x80108a3b,(%esp)
...
801006b2:	e8 eb 4f 00 00       	call   801056a2 <memmove>
    pos -= 80;
...
801006e1:	e8 ed 4e 00 00       	call   801055d3 <memset>
  }
...
80100776:	e8 ba 68 00 00       	call   80107035 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 ae 68 00 00       	call   80107035 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 a2 68 00 00       	call   80107035 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 95 68 00 00       	call   80107035 <uartputc>
  cgaputc(c);
...
801007ba:	e8 c0 4b 00 00       	call   8010537f <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 2b 46 00 00       	call   80104e1a <procdump>
      break;
...
801008f3:	e8 4b 44 00 00       	call   80104d43 <wakeup>
        }
      }
      break;
...
80100914:	e8 c8 4a 00 00       	call   801053e1 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 41 4a 00 00       	call   8010537f <acquire>
  while(n > 0){
...
80100959:	e8 83 4a 00 00       	call   801053e1 <release>
        ilock(ip);
...
80100982:	e8 e1 42 00 00       	call   80104c68 <sleep>
...
801009fe:	e8 de 49 00 00       	call   801053e1 <release>
  ilock(ip);
...
80100a32:	e8 48 49 00 00       	call   8010537f <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 70 49 00 00       	call   801053e1 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 3f 8a 10 	movl   $0x80108a3f,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100a96:	e8 c3 48 00 00       	call   8010535e <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 47 8a 10 	movl   $0x80108a47,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
80100aaa:	e8 af 48 00 00       	call   8010535e <initlock>
...
80100b6e:	e9 76 03 00 00       	jmp    80100ee9 <exec+0x3fa>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 0e 76 00 00       	call   80108186 <setupkvm>
...
80100c14:	e8 3b 79 00 00       	call   80108554 <allocuvm>
...
80100c52:	e8 12 78 00 00       	call   80108469 <loaduvm>
...
80100cc0:	e8 8f 78 00 00       	call   80108554 <allocuvm>
...
80100ce5:	e8 9a 7a 00 00       	call   80108784 <clearpteu>
  sp = sz;
...
80100d1b:	e8 1d 4b 00 00       	call   8010583d <strlen>
...
80100d44:	e8 f4 4a 00 00       	call   8010583d <strlen>
...
80100d74:	e8 d0 7b 00 00       	call   80108949 <copyout>
...
80100e1b:	e8 29 7b 00 00       	call   80108949 <copyout>
...
80100e73:	e8 7b 49 00 00       	call   801057f3 <safestrcpy>
...
80100ed2:	e8 a0 73 00 00       	call   80108277 <switchuvm>
  freevm(oldpgdir);
80100ed7:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eda:	89 04 24             	mov    %eax,(%esp)
80100edd:	e8 08 78 00 00       	call   801086ea <freevm>
  return 0;
...
80100ef5:	e8 f0 77 00 00       	call   801086ea <freevm>
  if(ip){
...
80100f1d:	c7 44 24 04 4d 8a 10 	movl   $0x80108a4d,0x4(%esp)
80100f24:	80 
80100f25:	c7 04 24 60 18 11 80 	movl   $0x80111860,(%esp)
80100f2c:	e8 2d 44 00 00       	call   8010535e <initlock>
}
80100f31:	c9                   	leave  
80100f32:	c3                   	ret    
...
80100f40:	e8 3a 44 00 00       	call   8010537f <acquire>
...
80100f69:	e8 73 44 00 00       	call   801053e1 <release>
      return f;
...
80100f87:	e8 55 44 00 00       	call   801053e1 <release>
  return 0;
...
80100fa0:	e8 da 43 00 00       	call   8010537f <acquire>
  if(f->ref < 1)
...
80100fad:	7f 0c                	jg     80100fbb <filedup+0x28>
    panic("filedup");
80100faf:	c7 04 24 54 8a 10 80 	movl   $0x80108a54,(%esp)
...
80100fd1:	e8 0b 44 00 00       	call   801053e1 <release>
  return f;
...
80100fe8:	e8 92 43 00 00       	call   8010537f <acquire>
  if(f->ref < 1)
...
80100ff5:	7f 0c                	jg     80101003 <fileclose+0x28>
    panic("fileclose");
80100ff7:	c7 04 24 5c 8a 10 80 	movl   $0x80108a5c,(%esp)
...
80101023:	e8 b9 43 00 00       	call   801053e1 <release>
...
8010106d:	e8 6f 43 00 00       	call   801053e1 <release>
...
801011ac:	eb 0c                	jmp    801011ba <fileread+0xba>
  ...
  panic("fileread");
801011ae:	c7 04 24 66 8a 10 80 	movl   $0x80108a66,(%esp)
...
801012ba:	c7 04 24 6f 8a 10 80 	movl   $0x80108a6f,(%esp)
...
801012ea:	eb 0c                	jmp    801012f8 <filewrite+0x13c>
  ...
  panic("filewrite");
801012ec:	c7 04 24 7f 8a 10 80 	movl   $0x80108a7f,(%esp)
...
80101332:	e8 6b 43 00 00       	call   801056a2 <memmove>
  brelse(bp);
...
80101378:	e8 56 42 00 00       	call   801055d3 <memset>
  log_write(bp);
...
801014d5:	c7 04 24 89 8a 10 80 	movl   $0x80108a89,(%esp)
...
80101567:	c7 04 24 9f 8a 10 80 	movl   $0x80108a9f,(%esp)
...
801015b7:	c7 44 24 04 b2 8a 10 	movl   $0x80108ab2,0x4(%esp)
801015be:	80 
801015bf:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801015c6:	e8 93 3d 00 00       	call   8010535e <initlock>
}
801015cb:	c9                   	leave  
801015cc:	c3                   	ret    
...
80101648:	e8 86 3f 00 00       	call   801055d3 <memset>
      dip->type = type;
...
8010169e:	c7 04 24 b9 8a 10 80 	movl   $0x80108ab9,(%esp)
...
80101747:	e8 56 3f 00 00       	call   801056a2 <memmove>
  log_write(bp);
...
80101771:	e8 09 3c 00 00       	call   8010537f <acquire>
...
801017bb:	e8 21 3c 00 00       	call   801053e1 <release>
      return ip;
...
801017ee:	c7 04 24 cb 8a 10 80 	movl   $0x80108acb,(%esp)
...
8010182c:	e8 b0 3b 00 00       	call   801053e1 <release>
...
80101843:	e8 37 3b 00 00       	call   8010537f <acquire>
  ip->ref++;
...
8010185e:	e8 7e 3b 00 00       	call   801053e1 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 db 8a 10 80 	movl   $0x80108adb,(%esp)
80101885:	e8 b0 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101891:	e8 e9 3a 00 00       	call   8010537f <acquire>
...
801018a6:	e8 bd 33 00 00       	call   80104c68 <sleep>
...
801018d0:	e8 0c 3b 00 00       	call   801053e1 <release>
...
8010197b:	e8 22 3d 00 00       	call   801056a2 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 e1 8a 10 80 	movl   $0x80108ae1,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 f0 8a 10 80 	movl   $0x80108af0,(%esp)
801019e0:	e8 55 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801019ec:	e8 8e 39 00 00       	call   8010537f <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 36 33 00 00       	call   80104d43 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a14:	e8 c8 39 00 00       	call   801053e1 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 52 39 00 00       	call   8010537f <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 f8 8a 10 80 	movl   $0x80108af8,(%esp)
...
80101a8a:	e8 52 39 00 00       	call   801053e1 <release>
    itrunc(ip);
...
80101ab5:	e8 c5 38 00 00       	call   8010537f <acquire>
    ip->flags = 0;
...
80101aca:	e8 74 32 00 00       	call   80104d43 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 f7 38 00 00       	call   801053e1 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101c05:	c7 04 24 02 8b 10 80 	movl   $0x80108b02,(%esp)
...
80101ea6:	e8 f7 37 00 00       	call   801056a2 <memmove>
    brelse(bp);
...
80102005:	e8 98 36 00 00       	call   801056a2 <memmove>
    log_write(bp);
...
80102083:	e8 bd 36 00 00       	call   80105745 <strncmp>
}
80102088:	c9                   	leave  
80102089:	c3                   	ret    
...
8010209d:	c7 04 24 15 8b 10 80 	movl   $0x80108b15,(%esp)
...
801020d9:	74 0c                	je     801020e7 <dirlookup+0x5d>
      panic("dirlink read");
801020db:	c7 04 24 27 8b 10 80 	movl   $0x80108b27,(%esp)
...
801021be:	74 0c                	je     801021cc <dirlink+0x79>
      panic("dirlink read");
801021c0:	c7 04 24 27 8b 10 80 	movl   $0x80108b27,(%esp)
...
80102205:	e8 91 35 00 00       	call   8010579b <strncpy>
  de.inum = inum;
...
80102235:	74 0c                	je     80102243 <dirlink+0xf0>
    panic("dirlink");
80102237:	c7 04 24 34 8b 10 80 	movl   $0x80108b34,(%esp)
...
801022bc:	e8 e1 33 00 00       	call   801056a2 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d7:	e8 c6 33 00 00       	call   801056a2 <memmove>
    name[len] = 0;
...
80102526:	c7 44 24 04 3c 8b 10 	movl   $0x80108b3c,0x4(%esp)
8010252d:	80 
8010252e:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
80102535:	e8 24 2e 00 00       	call   8010535e <initlock>
  picenable(IRQ_IDE);
...
801025d0:	75 0c                	jne    801025de <idestart+0x18>
    panic("idestart");
801025d2:	c7 04 24 40 8b 10 80 	movl   $0x80108b40,(%esp)
...
801026f8:	e8 82 2c 00 00       	call   8010537f <acquire>
  if((b = idequeue) == 0){
...
80102712:	e8 ca 2c 00 00       	call   801053e1 <release>
...
80102785:	e8 b9 25 00 00       	call   80104d43 <wakeup>
...
801027a7:	e8 35 2c 00 00       	call   801053e1 <release>
}
801027ac:	c9                   	leave  
801027ad:	c3                   	ret    
...
801027c0:	c7 04 24 49 8b 10 80 	movl   $0x80108b49,(%esp)
...
801027d9:	c7 04 24 5d 8b 10 80 	movl   $0x80108b5d,(%esp)
...
80102866:	e8 fd 23 00 00       	call   80104c68 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
8010287f:	e8 5d 2b 00 00       	call   801053e1 <release>
}
80102884:	c9                   	leave  
80102885:	c3                   	ret    
...
8010290d:	c7 04 24 90 8b 10 80 	movl   $0x80108b90,(%esp)
...
801029c7:	c7 44 24 04 c2 8b 10 	movl   $0x80108bc2,0x4(%esp)
801029ce:	80 
801029cf:	c7 04 24 40 32 11 80 	movl   $0x80113240,(%esp)
801029d6:	e8 83 29 00 00       	call   8010535e <initlock>
  kmem.use_lock = 0;
...
80102a81:	76 0c                	jbe    80102a8f <kfree+0x39>
    panic("kfree");
80102a83:	c7 04 24 c7 8b 10 80 	movl   $0x80108bc7,(%esp)
...
80102aa5:	e8 29 2b 00 00       	call   801055d3 <memset>
...
80102aba:	e8 c0 28 00 00       	call   8010537f <acquire>
  r = (struct run*)v;
...
80102ae8:	e8 f4 28 00 00       	call   801053e1 <release>
}
80102aed:	c9                   	leave  
80102aee:	c3                   	ret    
...
80102b05:	e8 75 28 00 00       	call   8010537f <acquire>
  r = kmem.freelist;
...
80102b32:	e8 aa 28 00 00       	call   801053e1 <release>
  return (char*)r;
...
80102eb2:	c7 04 24 d0 8b 10 80 	movl   $0x80108bd0,(%esp)
...
80103115:	e8 30 25 00 00       	call   8010564a <memcmp>
...
80103215:	c7 44 24 04 fc 8b 10 	movl   $0x80108bfc,0x4(%esp)
8010321c:	80 
8010321d:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80103224:	e8 35 21 00 00       	call   8010535e <initlock>
  readsb(ROOTDEV, &sb);
...
801032d8:	e8 c5 23 00 00       	call   801056a2 <memmove>
...
8010342a:	e8 50 1f 00 00       	call   8010537f <acquire>
  while(1){
    if(log.committing){
...
80103447:	e8 1c 18 00 00       	call   80104c68 <sleep>
...
8010347b:	e8 e8 17 00 00       	call   80104c68 <sleep>
...
80103496:	e8 46 1f 00 00       	call   801053e1 <release>
      break;
...
801034b5:	e8 c5 1e 00 00       	call   8010537f <acquire>
  log.outstanding -= 1;
...
801034d0:	c7 04 24 00 8c 10 80 	movl   $0x80108c00,(%esp)
...
801034ff:	e8 3f 18 00 00       	call   80104d43 <wakeup>
  }
  release(&log.lock);
80103504:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
8010350b:	e8 d1 1e 00 00       	call   801053e1 <release>
...
801035bf:	e8 de 20 00 00       	call   801056a2 <memmove>
...
8010364a:	c7 04 24 0f 8c 10 80 	movl   $0x80108c0f,(%esp)
...
8010365f:	c7 04 24 25 8c 10 80 	movl   $0x80108c25,(%esp)
80103666:	e8 cf ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
8010366b:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80103672:	e8 08 1d 00 00       	call   8010537f <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801036e9:	e8 f3 1c 00 00       	call   801053e1 <release>
}
801036ee:	c9                   	leave  
801036ef:	c3                   	ret    
...
80103765:	c7 04 24 40 8c 10 80 	movl   $0x80108c40,(%esp)
...
80103780:	e8 a0 37 00 00       	call   80106f25 <uartinit>
  pinit();         // process table
80103785:	e8 a3 0b 00 00       	call   8010432d <pinit>
  tvinit();        // trap vectors
8010378a:	e8 48 33 00 00       	call   80106ad7 <tvinit>
  binit();         // buffer cache
...
801037ac:	e8 68 32 00 00       	call   80106a19 <timerinit>
...
801037ca:	e8 e6 0c 00 00       	call   801044b5 <userinit>
...
801037d7:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801037da:	e8 7b 4a 00 00       	call   8010825a <switchkvm>
  seginit();
801037df:	e8 f2 43 00 00       	call   80107bd6 <seginit>
  lapicinit();
...
80103804:	c7 04 24 57 8c 10 80 	movl   $0x80108c57,(%esp)
8010380b:	e8 90 cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
80103810:	e8 36 34 00 00       	call   80106c4b <idtinit>
...
80103830:	e8 72 12 00 00       	call   80104aa7 <scheduler>
...
80103862:	e8 3b 1e 00 00       	call   801056a2 <memmove>
...
801039e3:	00 
801039e4:	c7 44 24 04 68 8c 10 	movl   $0x80108c68,0x4(%esp)
801039eb:	80 
801039ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039ef:	89 04 24             	mov    %eax,(%esp)
801039f2:	e8 53 1c 00 00       	call   8010564a <memcmp>
...
80103b24:	00 
80103b25:	c7 44 24 04 6d 8c 10 	movl   $0x80108c6d,0x4(%esp)
80103b2c:	80 
80103b2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b30:	89 04 24             	mov    %eax,(%esp)
80103b33:	e8 12 1b 00 00       	call   8010564a <memcmp>
...
80103c01:	8b 04 85 b0 8c 10 80 	mov    -0x7fef7350(,%eax,4),%eax
...
80103c3a:	c7 04 24 72 8c 10 80 	movl   $0x80108c72,(%esp)
...
80103ccd:	c7 04 24 90 8c 10 80 	movl   $0x80108c90,(%esp)
...
80103fc6:	c7 44 24 04 c4 8c 10 	movl   $0x80108cc4,0x4(%esp)
80103fcd:	80 
80103fce:	89 04 24             	mov    %eax,(%esp)
80103fd1:	e8 88 13 00 00       	call   8010535e <initlock>
  (*f0)->type = FD_PIPE;
...
8010407d:	e8 fd 12 00 00       	call   8010537f <acquire>
  if(writable){
...
801040a0:	e8 9e 0c 00 00       	call   80104d43 <wakeup>
...
801040bf:	e8 7f 0c 00 00       	call   80104d43 <wakeup>
  }
...
801040e4:	e8 f8 12 00 00       	call   801053e1 <release>
    kfree((char*)p);
...
801040fc:	e8 e0 12 00 00       	call   801053e1 <release>
}
80104101:	c9                   	leave  
80104102:	c3                   	ret    
...
8010410f:	e8 6b 12 00 00       	call   8010537f <acquire>
  for(i = 0; i < n; i++){
...
80104142:	e8 9a 12 00 00       	call   801053e1 <release>
        return -1;
...
8010415c:	e8 e2 0b 00 00       	call   80104d43 <wakeup>
...
80104174:	e8 ef 0a 00 00       	call   80104c68 <sleep>
{
  int i;
...
801041dd:	e8 61 0b 00 00       	call   80104d43 <wakeup>
  release(&p->lock);
801041e2:	8b 45 08             	mov    0x8(%ebp),%eax
801041e5:	89 04 24             	mov    %eax,(%esp)
801041e8:	e8 f4 11 00 00       	call   801053e1 <release>
  return n;
...
801041ff:	e8 7b 11 00 00       	call   8010537f <acquire>
...
80104219:	e8 c3 11 00 00       	call   801053e1 <release>
      return -1;
...
8010423b:	e8 28 0a 00 00       	call   80104c68 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801042ca:	e8 74 0a 00 00       	call   80104d43 <wakeup>
  release(&p->lock);
801042cf:	8b 45 08             	mov    0x8(%ebp),%eax
801042d2:	89 04 24             	mov    %eax,(%esp)
801042d5:	e8 07 11 00 00       	call   801053e1 <release>
  return i;
...
80104333:	c7 44 24 04 cc 8c 10 	movl   $0x80108ccc,0x4(%esp)
8010433a:	80 
8010433b:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104342:	e8 17 10 00 00       	call   8010535e <initlock>
}
80104347:	c9                   	leave  
80104348:	c3                   	ret    
...
80104380:	83 ec 28             	sub    $0x28,%esp
  ...
  //acquire(&ptable.lock);
  pushcli();
80104383:	e8 4b 11 00 00       	call   801054d3 <pushcli>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104388:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
8010438f:	eb 51                	jmp    801043e2 <allocproc+0x65>
    //if(p->state == UNUSED)
    if(cas(&p->state, UNUSED, EMBRYO))
80104391:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104394:	83 c0 0c             	add    $0xc,%eax
80104397:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010439e:	00 
8010439f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801043a6:	00 
801043a7:	89 04 24             	mov    %eax,(%esp)
801043aa:	e8 4a ff ff ff       	call   801042f9 <cas>
801043af:	85 c0                	test   %eax,%eax
801043b1:	74 28                	je     801043db <allocproc+0x5e>
      goto found;
801043b3:	90                   	nop
  return 0;
...
found:
  ...
  //release(&ptable.lock);
  popcli();
801043b4:	e8 5e 11 00 00       	call   80105517 <popcli>

  p->pid = allocpid();
801043b9:	e8 8b ff ff ff       	call   80104349 <allocpid>
801043be:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043c1:	89 42 10             	mov    %eax,0x10(%edx)

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
801043c4:	e8 26 e7 ff ff       	call   80102aef <kalloc>
...
801043d7:	75 35                	jne    8010440e <allocproc+0x91>
801043d9:	eb 1f                	jmp    801043fa <allocproc+0x7d>
  struct proc *p;
  char *sp;
  ...
  pushcli();
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043db:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
801043e2:	81 7d f4 b4 a1 11 80 	cmpl   $0x8011a1b4,-0xc(%ebp)
801043e9:	72 a6                	jb     80104391 <allocproc+0x14>
    //if(p->state == UNUSED)
    if(cas(&p->state, UNUSED, EMBRYO))
      goto found;
  //release(&ptable.lock);
  popcli();
801043eb:	e8 27 11 00 00       	call   80105517 <popcli>
  return 0;
801043f0:	b8 00 00 00 00       	mov    $0x0,%eax
801043f5:	e9 b9 00 00 00       	jmp    801044b3 <allocproc+0x136>
...
80104409:	e9 a5 00 00 00       	jmp    801044b3 <allocproc+0x136>
  }
  sp = p->kstack + KSTACKSIZE;
8010440e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104411:	8b 40 08             	mov    0x8(%eax),%eax
80104414:	05 00 10 00 00       	add    $0x1000,%eax
80104419:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
8010441f:	83 e8 80             	sub    $0xffffff80,%eax
80104422:	89 45 f0             	mov    %eax,-0x10(%ebp)
80104425:	eb 0e                	jmp    80104435 <allocproc+0xb8>
    csf->used = 0;
...
8010442a:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  ...
  struct cstackframe *csf;
  for(csf = p->pending_signals.frames; csf < &p->pending_signals.frames[MAX_CSTACK_FRAMES]; csf++) {
80104431:	83 45 f0 14          	addl   $0x14,-0x10(%ebp)
80104435:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104438:	05 48 01 00 00       	add    $0x148,%eax
8010443d:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80104440:	77 e5                	ja     80104427 <allocproc+0xaa>
    csf->used = 0;
  }
  p->pending_signals.head = 0;
80104442:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104445:	c7 80 48 01 00 00 00 	movl   $0x0,0x148(%eax)
8010444c:	00 00 00 

  // available for handeling signal 
  p->handling_signal = 0;
8010444f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104452:	c7 80 9c 01 00 00 00 	movl   $0x0,0x19c(%eax)
80104459:	00 00 00 

  // Leave room for trap frame.
  sp -= sizeof *p->tf;
8010445c:	83 6d ec 4c          	subl   $0x4c,-0x14(%ebp)
  p->tf = (struct trapframe*)sp;
80104460:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104463:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104466:	89 50 18             	mov    %edx,0x18(%eax)

  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104469:	83 6d ec 04          	subl   $0x4,-0x14(%ebp)
  *(uint*)sp = (uint)trapret;
8010446d:	ba 89 6a 10 80       	mov    $0x80106a89,%edx
80104472:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104475:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
80104477:	83 6d ec 14          	subl   $0x14,-0x14(%ebp)
  p->context = (struct context*)sp;
8010447b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010447e:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104481:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
80104484:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104487:	8b 40 1c             	mov    0x1c(%eax),%eax
8010448a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104491:	00 
80104492:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104499:	00 
8010449a:	89 04 24             	mov    %eax,(%esp)
8010449d:	e8 31 11 00 00       	call   801055d3 <memset>
  p->context->eip = (uint)forkret;
801044a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044a5:	8b 40 1c             	mov    0x1c(%eax),%eax
801044a8:	ba 3c 4c 10 80       	mov    $0x80104c3c,%edx
...
801044b8:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
801044bb:	e8 bd fe ff ff       	call   8010437d <allocproc>
801044c0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801044c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044c6:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  if((p->pgdir = setupkvm()) == 0)
801044cb:	e8 b6 3c 00 00       	call   80108186 <setupkvm>
801044d0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801044d3:	89 42 04             	mov    %eax,0x4(%edx)
801044d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044d9:	8b 40 04             	mov    0x4(%eax),%eax
801044dc:	85 c0                	test   %eax,%eax
801044de:	75 0c                	jne    801044ec <userinit+0x37>
    panic("userinit: out of memory?");
801044e0:	c7 04 24 d3 8c 10 80 	movl   $0x80108cd3,(%esp)
801044e7:	e8 4e c0 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801044ec:	ba 2c 00 00 00       	mov    $0x2c,%edx
801044f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f4:	8b 40 04             	mov    0x4(%eax),%eax
801044f7:	89 54 24 08          	mov    %edx,0x8(%esp)
801044fb:	c7 44 24 04 00 c5 10 	movl   $0x8010c500,0x4(%esp)
80104502:	80 
80104503:	89 04 24             	mov    %eax,(%esp)
80104506:	e8 d3 3e 00 00       	call   801083de <inituvm>
  p->sz = PGSIZE;
8010450b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010450e:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104514:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104517:	8b 40 18             	mov    0x18(%eax),%eax
8010451a:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104521:	00 
80104522:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104529:	00 
8010452a:	89 04 24             	mov    %eax,(%esp)
8010452d:	e8 a1 10 00 00       	call   801055d3 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80104532:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104535:	8b 40 18             	mov    0x18(%eax),%eax
80104538:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010453e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104541:	8b 40 18             	mov    0x18(%eax),%eax
80104544:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
8010454a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010454d:	8b 40 18             	mov    0x18(%eax),%eax
80104550:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104553:	8b 52 18             	mov    0x18(%edx),%edx
80104556:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
8010455a:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
8010455e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104561:	8b 40 18             	mov    0x18(%eax),%eax
80104564:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104567:	8b 52 18             	mov    0x18(%edx),%edx
8010456a:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
8010456e:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80104572:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104575:	8b 40 18             	mov    0x18(%eax),%eax
80104578:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
8010457f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104582:	8b 40 18             	mov    0x18(%eax),%eax
80104585:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010458c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010458f:	8b 40 18             	mov    0x18(%eax),%eax
80104592:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104599:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010459c:	83 c0 6c             	add    $0x6c,%eax
8010459f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801045a6:	00 
801045a7:	c7 44 24 04 ec 8c 10 	movl   $0x80108cec,0x4(%esp)
801045ae:	80 
801045af:	89 04 24             	mov    %eax,(%esp)
801045b2:	e8 3c 12 00 00       	call   801057f3 <safestrcpy>
  p->cwd = namei("/");
801045b7:	c7 04 24 f5 8c 10 80 	movl   $0x80108cf5,(%esp)
801045be:	e8 50 de ff ff       	call   80102413 <namei>
...
801045d8:	83 ec 28             	sub    $0x28,%esp
  uint sz;
...
801045ea:	7e 34                	jle    80104620 <growproc+0x4b>
...
801045fd:	89 54 24 08          	mov    %edx,0x8(%esp)
80104601:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104604:	89 54 24 04          	mov    %edx,0x4(%esp)
80104608:	89 04 24             	mov    %eax,(%esp)
8010460b:	e8 44 3f 00 00       	call   80108554 <allocuvm>
80104610:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104613:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104617:	75 41                	jne    8010465a <growproc+0x85>
      return -1;
80104619:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010461e:	eb 58                	jmp    80104678 <growproc+0xa3>
  } else if(n < 0){
80104620:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104624:	79 34                	jns    8010465a <growproc+0x85>
...
80104637:	89 54 24 08          	mov    %edx,0x8(%esp)
8010463b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010463e:	89 54 24 04          	mov    %edx,0x4(%esp)
80104642:	89 04 24             	mov    %eax,(%esp)
80104645:	e8 e4 3f 00 00       	call   8010862e <deallocuvm>
8010464a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010464d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104651:	75 07                	jne    8010465a <growproc+0x85>
      return -1;
80104653:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104658:	eb 1e                	jmp    80104678 <growproc+0xa3>
  }
  proc->sz = sz;
8010465a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104660:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104663:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
80104665:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010466b:	89 04 24             	mov    %eax,(%esp)
8010466e:	e8 04 3c 00 00       	call   80108277 <switchuvm>
  return 0;
...
8010467d:	57                   	push   %edi
8010467e:	56                   	push   %esi
8010467f:	53                   	push   %ebx
80104680:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
80104683:	e8 f5 fc ff ff       	call   8010437d <allocproc>
80104688:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010468b:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010468f:	75 0a                	jne    8010469b <fork+0x21>
    return -1;
80104691:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104696:	e9 61 01 00 00       	jmp    801047fc <fork+0x182>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
8010469b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046a1:	8b 10                	mov    (%eax),%edx
801046a3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046a9:	8b 40 04             	mov    0x4(%eax),%eax
801046ac:	89 54 24 04          	mov    %edx,0x4(%esp)
801046b0:	89 04 24             	mov    %eax,(%esp)
801046b3:	e8 12 41 00 00       	call   801087ca <copyuvm>
801046b8:	8b 55 e0             	mov    -0x20(%ebp),%edx
801046bb:	89 42 04             	mov    %eax,0x4(%edx)
801046be:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046c1:	8b 40 04             	mov    0x4(%eax),%eax
801046c4:	85 c0                	test   %eax,%eax
801046c6:	75 2c                	jne    801046f4 <fork+0x7a>
    kfree(np->kstack);
801046c8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046cb:	8b 40 08             	mov    0x8(%eax),%eax
801046ce:	89 04 24             	mov    %eax,(%esp)
801046d1:	e8 80 e3 ff ff       	call   80102a56 <kfree>
    np->kstack = 0;
801046d6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046d9:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
801046e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046e3:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
801046ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046ef:	e9 08 01 00 00       	jmp    801047fc <fork+0x182>
  }
  np->sz = proc->sz;
...
8010470b:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
8010470e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104711:	8b 50 18             	mov    0x18(%eax),%edx
80104714:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010471a:	8b 40 18             	mov    0x18(%eax),%eax
8010471d:	89 c3                	mov    %eax,%ebx
8010471f:	b8 13 00 00 00       	mov    $0x13,%eax
80104724:	89 d7                	mov    %edx,%edi
80104726:	89 de                	mov    %ebx,%esi
80104728:	89 c1                	mov    %eax,%ecx
8010472a:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
8010472c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010472f:	8b 40 18             	mov    0x18(%eax),%eax
80104732:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80104739:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104740:	eb 3d                	jmp    8010477f <fork+0x105>
    if(proc->ofile[i])
...
80104754:	74 25                	je     8010477b <fork+0x101>
...
80104769:	e8 25 c8 ff ff       	call   80100f93 <filedup>
8010476e:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104771:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104774:	83 c1 08             	add    $0x8,%ecx
80104777:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
...
80104783:	7e bd                	jle    80104742 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
80104791:	e8 a0 d0 ff ff       	call   80101836 <idup>
80104796:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104799:	89 42 68             	mov    %eax,0x68(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
8010479c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047a2:	8d 50 6c             	lea    0x6c(%eax),%edx
801047a5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047a8:	83 c0 6c             	add    $0x6c,%eax
801047ab:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801047b2:	00 
801047b3:	89 54 24 04          	mov    %edx,0x4(%esp)
801047b7:	89 04 24             	mov    %eax,(%esp)
801047ba:	e8 34 10 00 00       	call   801057f3 <safestrcpy>
  //copy signal handler
  np->sighandler = proc->sighandler; 
801047bf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047c5:	8b 50 7c             	mov    0x7c(%eax),%edx
801047c8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047cb:	89 50 7c             	mov    %edx,0x7c(%eax)
  pid = np->pid;
801047ce:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047d1:	8b 40 10             	mov    0x10(%eax),%eax
801047d4:	89 45 dc             	mov    %eax,-0x24(%ebp)

  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
801047d7:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801047de:	e8 9c 0b 00 00       	call   8010537f <acquire>
  np->state = RUNNABLE;
801047e3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047e6:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
801047ed:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801047f4:	e8 e8 0b 00 00       	call   801053e1 <release>
  
  return pid;
801047f9:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801047fc:	83 c4 2c             	add    $0x2c,%esp
801047ff:	5b                   	pop    %ebx
80104800:	5e                   	pop    %esi
80104801:	5f                   	pop    %edi
80104802:	5d                   	pop    %ebp
...
80104807:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int fd;

  if(proc == initproc)
8010480a:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104811:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104816:	39 c2                	cmp    %eax,%edx
80104818:	75 0c                	jne    80104826 <exit+0x22>
    panic("init exiting");
8010481a:	c7 04 24 f7 8c 10 80 	movl   $0x80108cf7,(%esp)
80104821:	e8 14 bd ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104826:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010482d:	eb 44                	jmp    80104873 <exit+0x6f>
    if(proc->ofile[fd]){
8010482f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104835:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104838:	83 c2 08             	add    $0x8,%edx
8010483b:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010483f:	85 c0                	test   %eax,%eax
80104841:	74 2c                	je     8010486f <exit+0x6b>
...
80104856:	e8 80 c7 ff ff       	call   80100fdb <fileclose>
      proc->ofile[fd] = 0;
8010485b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104861:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104864:	83 c2 08             	add    $0x8,%edx
80104867:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010486e:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010486f:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104873:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104877:	7e b6                	jle    8010482f <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80104879:	e8 9f eb ff ff       	call   8010341d <begin_op>
  iput(proc->cwd);
8010487e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104884:	8b 40 68             	mov    0x68(%eax),%eax
80104887:	89 04 24             	mov    %eax,(%esp)
8010488a:	e8 8c d1 ff ff       	call   80101a1b <iput>
  end_op();
8010488f:	e8 0d ec ff ff       	call   801034a1 <end_op>
  proc->cwd = 0;
80104894:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010489a:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
801048a1:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801048a8:	e8 d2 0a 00 00       	call   8010537f <acquire>

  proc->state = ZOMBIE;
801048ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048b3:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
801048ba:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048c0:	8b 40 14             	mov    0x14(%eax),%eax
801048c3:	89 04 24             	mov    %eax,(%esp)
801048c6:	e8 2b 04 00 00       	call   80104cf6 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048cb:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
801048d2:	eb 3b                	jmp    8010490f <exit+0x10b>
    if(p->parent == proc){
801048d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048d7:	8b 50 14             	mov    0x14(%eax),%edx
801048da:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048e0:	39 c2                	cmp    %eax,%edx
801048e2:	75 24                	jne    80104908 <exit+0x104>
      p->parent = initproc;
801048e4:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
801048ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048ed:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
801048f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048f3:	8b 40 0c             	mov    0xc(%eax),%eax
801048f6:	83 f8 05             	cmp    $0x5,%eax
801048f9:	75 0d                	jne    80104908 <exit+0x104>
        wakeup1(initproc);
801048fb:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104900:	89 04 24             	mov    %eax,(%esp)
80104903:	e8 ee 03 00 00       	call   80104cf6 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104908:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
8010490f:	81 7d f4 b4 a1 11 80 	cmpl   $0x8011a1b4,-0xc(%ebp)
80104916:	72 bc                	jb     801048d4 <exit+0xd0>
    }
  }
  ...
  sched();
80104918:	e8 3b 02 00 00       	call   80104b58 <sched>
  panic("zombie exit");
8010491d:	c7 04 24 04 8d 10 80 	movl   $0x80108d04,(%esp)
80104924:	e8 11 bc ff ff       	call   8010053a <panic>
...
8010492c:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
8010492f:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104936:	e8 44 0a 00 00       	call   8010537f <acquire>
  for(;;){
    proc->chan = (int)proc;
8010493b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104941:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104948:	89 50 20             	mov    %edx,0x20(%eax)
    proc->state = SLEEPING;    
8010494b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104951:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
    // Scan through table looking for zombie children.
    havekids = 0;
80104958:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010495f:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104966:	e9 84 00 00 00       	jmp    801049ef <wait+0xc6>
      if(p->parent != proc)
8010496b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010496e:	8b 50 14             	mov    0x14(%eax),%edx
80104971:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104977:	39 c2                	cmp    %eax,%edx
80104979:	74 02                	je     8010497d <wait+0x54>
        continue;
8010497b:	eb 6b                	jmp    801049e8 <wait+0xbf>
      havekids = 1;
8010497d:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104984:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104987:	8b 40 0c             	mov    0xc(%eax),%eax
8010498a:	83 f8 05             	cmp    $0x5,%eax
8010498d:	75 59                	jne    801049e8 <wait+0xbf>
        // Found one.
        pid = p->pid;
...
8010499b:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
801049a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049a5:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801049ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049af:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
801049b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049b9:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)

        proc->chan = 0;
801049bd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049c3:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
        proc->state = RUNNING;
801049ca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049d0:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
        release(&ptable.lock);
801049d7:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801049de:	e8 fe 09 00 00       	call   801053e1 <release>
        return pid;
801049e3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801049e6:	eb 5e                	jmp    80104a46 <wait+0x11d>
  for(;;){
    proc->chan = (int)proc;
    proc->state = SLEEPING;    
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049e8:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
801049ef:	81 7d f4 b4 a1 11 80 	cmpl   $0x8011a1b4,-0xc(%ebp)
801049f6:	0f 82 6f ff ff ff    	jb     8010496b <wait+0x42>
        return pid;
      }
    }
...
801049fc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104a00:	74 0d                	je     80104a0f <wait+0xe6>
80104a02:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a08:	8b 40 24             	mov    0x24(%eax),%eax
80104a0b:	85 c0                	test   %eax,%eax
80104a0d:	74 2d                	je     80104a3c <wait+0x113>
      proc->chan = 0;
80104a0f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a15:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
      proc->state = RUNNING;      
80104a1c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a22:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      release(&ptable.lock);
80104a29:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104a30:	e8 ac 09 00 00       	call   801053e1 <release>
      return -1;
80104a35:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a3a:	eb 0a                	jmp    80104a46 <wait+0x11d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sched();
80104a3c:	e8 17 01 00 00       	call   80104b58 <sched>
  }
80104a41:	e9 f5 fe ff ff       	jmp    8010493b <wait+0x12>
}
80104a46:	c9                   	leave  
80104a47:	c3                   	ret    
...
80104a4b:	83 ec 18             	sub    $0x18,%esp
  if (!p || p->state != ZOMBIE)
80104a4e:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104a52:	74 0b                	je     80104a5f <freeproc+0x17>
80104a54:	8b 45 08             	mov    0x8(%ebp),%eax
80104a57:	8b 40 0c             	mov    0xc(%eax),%eax
80104a5a:	83 f8 05             	cmp    $0x5,%eax
80104a5d:	74 0c                	je     80104a6b <freeproc+0x23>
    panic("freeproc not zombie");
80104a5f:	c7 04 24 10 8d 10 80 	movl   $0x80108d10,(%esp)
80104a66:	e8 cf ba ff ff       	call   8010053a <panic>
  kfree(p->kstack);
80104a6b:	8b 45 08             	mov    0x8(%ebp),%eax
80104a6e:	8b 40 08             	mov    0x8(%eax),%eax
80104a71:	89 04 24             	mov    %eax,(%esp)
80104a74:	e8 dd df ff ff       	call   80102a56 <kfree>
  p->kstack = 0;
80104a79:	8b 45 08             	mov    0x8(%ebp),%eax
80104a7c:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  freevm(p->pgdir);
80104a83:	8b 45 08             	mov    0x8(%ebp),%eax
80104a86:	8b 40 04             	mov    0x4(%eax),%eax
80104a89:	89 04 24             	mov    %eax,(%esp)
80104a8c:	e8 59 3c 00 00       	call   801086ea <freevm>
  p->killed = 0;
80104a91:	8b 45 08             	mov    0x8(%ebp),%eax
80104a94:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
  p->chan = 0;
80104a9b:	8b 45 08             	mov    0x8(%ebp),%eax
80104a9e:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
}
80104aa5:	c9                   	leave  
80104aa6:	c3                   	ret    
...
80104aaa:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104aad:	e8 41 f8 ff ff       	call   801042f3 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104ab2:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ab9:	e8 c1 08 00 00       	call   8010537f <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104abe:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104ac5:	eb 77                	jmp    80104b3e <scheduler+0x97>
      if(p->state != RUNNABLE)
80104ac7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aca:	8b 40 0c             	mov    0xc(%eax),%eax
80104acd:	83 f8 03             	cmp    $0x3,%eax
80104ad0:	74 02                	je     80104ad4 <scheduler+0x2d>
        continue;
80104ad2:	eb 63                	jmp    80104b37 <scheduler+0x90>
...
80104ad7:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104add:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ae0:	89 04 24             	mov    %eax,(%esp)
80104ae3:	e8 8f 37 00 00       	call   80108277 <switchuvm>
      p->state = RUNNING;
80104ae8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aeb:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
80104af2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104af8:	8b 40 1c             	mov    0x1c(%eax),%eax
80104afb:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104b02:	83 c2 04             	add    $0x4,%edx
80104b05:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b09:	89 14 24             	mov    %edx,(%esp)
80104b0c:	e8 53 0d 00 00       	call   80105864 <swtch>
      switchkvm();
80104b11:	e8 44 37 00 00       	call   8010825a <switchkvm>
...
80104b2a:	75 0b                	jne    80104b37 <scheduler+0x90>
        freeproc(p);
80104b2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b2f:	89 04 24             	mov    %eax,(%esp)
80104b32:	e8 11 ff ff ff       	call   80104a48 <freeproc>
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b37:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
80104b3e:	81 7d f4 b4 a1 11 80 	cmpl   $0x8011a1b4,-0xc(%ebp)
80104b45:	72 80                	jb     80104ac7 <scheduler+0x20>
      // It should have changed its p->state before coming back.
      proc = 0;
      if (p->state == ZOMBIE)
        freeproc(p);
    ...
    release(&ptable.lock);
80104b47:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b4e:	e8 8e 08 00 00       	call   801053e1 <release>

  }
80104b53:	e9 55 ff ff ff       	jmp    80104aad <scheduler+0x6>
...
80104b5b:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80104b5e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b65:	e8 3f 09 00 00       	call   801054a9 <holding>
80104b6a:	85 c0                	test   %eax,%eax
80104b6c:	75 0c                	jne    80104b7a <sched+0x22>
    panic("sched ptable.lock");
80104b6e:	c7 04 24 24 8d 10 80 	movl   $0x80108d24,(%esp)
80104b75:	e8 c0 b9 ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
80104b7a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b80:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104b86:	83 f8 01             	cmp    $0x1,%eax
80104b89:	74 0c                	je     80104b97 <sched+0x3f>
    panic("sched locks");
80104b8b:	c7 04 24 36 8d 10 80 	movl   $0x80108d36,(%esp)
80104b92:	e8 a3 b9 ff ff       	call   8010053a <panic>
  if(proc->state == RUNNING)
80104b97:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b9d:	8b 40 0c             	mov    0xc(%eax),%eax
80104ba0:	83 f8 04             	cmp    $0x4,%eax
80104ba3:	75 0c                	jne    80104bb1 <sched+0x59>
    panic("sched running");
80104ba5:	c7 04 24 42 8d 10 80 	movl   $0x80108d42,(%esp)
80104bac:	e8 89 b9 ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104bb1:	e8 2d f7 ff ff       	call   801042e3 <readeflags>
80104bb6:	25 00 02 00 00       	and    $0x200,%eax
80104bbb:	85 c0                	test   %eax,%eax
80104bbd:	74 0c                	je     80104bcb <sched+0x73>
    panic("sched interruptible");
80104bbf:	c7 04 24 50 8d 10 80 	movl   $0x80108d50,(%esp)
80104bc6:	e8 6f b9 ff ff       	call   8010053a <panic>
  intena = cpu->intena;
80104bcb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104bd1:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104bd7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104bda:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104be0:	8b 40 04             	mov    0x4(%eax),%eax
80104be3:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104bea:	83 c2 1c             	add    $0x1c,%edx
80104bed:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bf1:	89 14 24             	mov    %edx,(%esp)
80104bf4:	e8 6b 0c 00 00       	call   80105864 <swtch>
  cpu->intena = intena;
80104bf9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104bff:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c02:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104c08:	c9                   	leave  
80104c09:	c3                   	ret    
...
80104c10:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c17:	e8 63 07 00 00       	call   8010537f <acquire>
  proc->state = RUNNABLE;
80104c1c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c22:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104c29:	e8 2a ff ff ff       	call   80104b58 <sched>
  release(&ptable.lock);
80104c2e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c35:	e8 a7 07 00 00       	call   801053e1 <release>
}
80104c3a:	c9                   	leave  
80104c3b:	c3                   	ret    
...
80104c3f:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104c42:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c49:	e8 93 07 00 00       	call   801053e1 <release>

  if (first) {
80104c4e:	a1 08 c0 10 80       	mov    0x8010c008,%eax
80104c53:	85 c0                	test   %eax,%eax
80104c55:	74 0f                	je     80104c66 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104c57:	c7 05 08 c0 10 80 00 	movl   $0x0,0x8010c008
80104c5e:	00 00 00 
    initlog();
80104c61:	e8 a9 e5 ff ff       	call   8010320f <initlog>
  }
...
80104c76:	75 0c                	jne    80104c84 <sleep+0x1c>
    panic("sleep");
80104c78:	c7 04 24 64 8d 10 80 	movl   $0x80108d64,(%esp)
80104c7f:	e8 b6 b8 ff ff       	call   8010053a <panic>

  if(lk == 0)
80104c84:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104c88:	75 0c                	jne    80104c96 <sleep+0x2e>
    panic("sleep without lk");
80104c8a:	c7 04 24 6a 8d 10 80 	movl   $0x80108d6a,(%esp)
80104c91:	e8 a4 b8 ff ff       	call   8010053a <panic>
...
80104c96:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104c9d:	74 17                	je     80104cb6 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104c9f:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ca6:	e8 d4 06 00 00       	call   8010537f <acquire>
    release(lk);
80104cab:	8b 45 0c             	mov    0xc(%ebp),%eax
80104cae:	89 04 24             	mov    %eax,(%esp)
80104cb1:	e8 2b 07 00 00       	call   801053e1 <release>
  }

  // Go to sleep.
  proc->chan = (int)chan;
80104cb6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cbc:	8b 55 08             	mov    0x8(%ebp),%edx
80104cbf:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104cc2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cc8:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)


  sched();
80104ccf:	e8 84 fe ff ff       	call   80104b58 <sched>

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104cd4:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104cdb:	74 17                	je     80104cf4 <sleep+0x8c>
    release(&ptable.lock);
80104cdd:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ce4:	e8 f8 06 00 00       	call   801053e1 <release>
    acquire(lk);
80104ce9:	8b 45 0c             	mov    0xc(%ebp),%eax
80104cec:	89 04 24             	mov    %eax,(%esp)
80104cef:	e8 8b 06 00 00       	call   8010537f <acquire>
  }
}
80104cf4:	c9                   	leave  
80104cf5:	c3                   	ret    
...
80104cf9:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104cfc:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
80104d03:	eb 33                	jmp    80104d38 <wakeup1+0x42>
...
80104d0e:	75 21                	jne    80104d31 <wakeup1+0x3b>
80104d10:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d13:	8b 50 20             	mov    0x20(%eax),%edx
80104d16:	8b 45 08             	mov    0x8(%ebp),%eax
80104d19:	39 c2                	cmp    %eax,%edx
80104d1b:	75 14                	jne    80104d31 <wakeup1+0x3b>
      // Tidy up.
      p->chan = 0;
80104d1d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d20:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
      p->state = RUNNABLE;
80104d27:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d2a:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104d31:	81 45 fc a0 01 00 00 	addl   $0x1a0,-0x4(%ebp)
80104d38:	81 7d fc b4 a1 11 80 	cmpl   $0x8011a1b4,-0x4(%ebp)
80104d3f:	72 c4                	jb     80104d05 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == (int)chan){
      // Tidy up.
      p->chan = 0;
      p->state = RUNNABLE;
...
80104d46:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104d49:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d50:	e8 2a 06 00 00       	call   8010537f <acquire>
  wakeup1(chan);
80104d55:	8b 45 08             	mov    0x8(%ebp),%eax
80104d58:	89 04 24             	mov    %eax,(%esp)
80104d5b:	e8 96 ff ff ff       	call   80104cf6 <wakeup1>
  release(&ptable.lock);
80104d60:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d67:	e8 75 06 00 00       	call   801053e1 <release>
}
80104d6c:	c9                   	leave  
80104d6d:	c3                   	ret    
...
80104d71:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  cprintf("my input pid is %d go over %d procs\n", pid, NPROC );
80104d74:	c7 44 24 08 40 00 00 	movl   $0x40,0x8(%esp)
80104d7b:	00 
80104d7c:	8b 45 08             	mov    0x8(%ebp),%eax
80104d7f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d83:	c7 04 24 7c 8d 10 80 	movl   $0x80108d7c,(%esp)
80104d8a:	e8 11 b6 ff ff       	call   801003a0 <cprintf>
  acquire(&ptable.lock);
80104d8f:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d96:	e8 e4 05 00 00       	call   8010537f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d9b:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104da2:	eb 5a                	jmp    80104dfe <kill+0x90>
    
    cprintf("my pid is %d\n", p->pid );
80104da4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da7:	8b 40 10             	mov    0x10(%eax),%eax
80104daa:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dae:	c7 04 24 a1 8d 10 80 	movl   $0x80108da1,(%esp)
80104db5:	e8 e6 b5 ff ff       	call   801003a0 <cprintf>
    if(p->pid == pid){
80104dba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dbd:	8b 40 10             	mov    0x10(%eax),%eax
80104dc0:	3b 45 08             	cmp    0x8(%ebp),%eax
80104dc3:	75 32                	jne    80104df7 <kill+0x89>
      p->killed = 1;
...
80104dd8:	75 0a                	jne    80104de4 <kill+0x76>
        p->state = RUNNABLE;
...
80104deb:	e8 f1 05 00 00       	call   801053e1 <release>
      return 0;
80104df0:	b8 00 00 00 00       	mov    $0x0,%eax
80104df5:	eb 21                	jmp    80104e18 <kill+0xaa>
kill(int pid)
{
  struct proc *p;
  cprintf("my input pid is %d go over %d procs\n", pid, NPROC );
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104df7:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
80104dfe:	81 7d f4 b4 a1 11 80 	cmpl   $0x8011a1b4,-0xc(%ebp)
80104e05:	72 9d                	jb     80104da4 <kill+0x36>
  }
      //int pid_test = p->pid;
...
80104e0e:	e8 ce 05 00 00       	call   801053e1 <release>
...
80104e1d:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e20:	c7 45 f0 b4 39 11 80 	movl   $0x801139b4,-0x10(%ebp)
80104e27:	e9 e3 00 00 00       	jmp    80104f0f <procdump+0xf5>
    if(p->state == UNUSED)
80104e2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e2f:	8b 40 0c             	mov    0xc(%eax),%eax
80104e32:	85 c0                	test   %eax,%eax
80104e34:	75 05                	jne    80104e3b <procdump+0x21>
      continue;
80104e36:	e9 cd 00 00 00       	jmp    80104f08 <procdump+0xee>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104e3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e3e:	8b 40 0c             	mov    0xc(%eax),%eax
80104e41:	85 c0                	test   %eax,%eax
80104e43:	78 2e                	js     80104e73 <procdump+0x59>
80104e45:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e48:	8b 40 0c             	mov    0xc(%eax),%eax
80104e4b:	83 f8 05             	cmp    $0x5,%eax
80104e4e:	77 23                	ja     80104e73 <procdump+0x59>
80104e50:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e53:	8b 40 0c             	mov    0xc(%eax),%eax
80104e56:	8b 04 85 0c c0 10 80 	mov    -0x7fef3ff4(,%eax,4),%eax
80104e5d:	85 c0                	test   %eax,%eax
80104e5f:	74 12                	je     80104e73 <procdump+0x59>
      state = states[p->state];
80104e61:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e64:	8b 40 0c             	mov    0xc(%eax),%eax
80104e67:	8b 04 85 0c c0 10 80 	mov    -0x7fef3ff4(,%eax,4),%eax
80104e6e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104e71:	eb 07                	jmp    80104e7a <procdump+0x60>
    else
      state = "???";
80104e73:	c7 45 ec af 8d 10 80 	movl   $0x80108daf,-0x14(%ebp)
...
80104e95:	c7 04 24 b3 8d 10 80 	movl   $0x80108db3,(%esp)
80104e9c:	e8 ff b4 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
80104ea1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ea4:	8b 40 0c             	mov    0xc(%eax),%eax
80104ea7:	83 f8 02             	cmp    $0x2,%eax
80104eaa:	75 50                	jne    80104efc <procdump+0xe2>
...
80104ec2:	e8 69 05 00 00       	call   80105430 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104ec7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104ece:	eb 1b                	jmp    80104eeb <procdump+0xd1>
        cprintf(" %p", pc[i]);
80104ed0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ed3:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ed7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104edb:	c7 04 24 bc 8d 10 80 	movl   $0x80108dbc,(%esp)
80104ee2:	e8 b9 b4 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
...
80104eef:	7f 0b                	jg     80104efc <procdump+0xe2>
80104ef1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ef4:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ef8:	85 c0                	test   %eax,%eax
80104efa:	75 d4                	jne    80104ed0 <procdump+0xb6>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104efc:	c7 04 24 c0 8d 10 80 	movl   $0x80108dc0,(%esp)
80104f03:	e8 98 b4 ff ff       	call   801003a0 <cprintf>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f08:	81 45 f0 a0 01 00 00 	addl   $0x1a0,-0x10(%ebp)
80104f0f:	81 7d f0 b4 a1 11 80 	cmpl   $0x8011a1b4,-0x10(%ebp)
80104f16:	0f 82 10 ff ff ff    	jb     80104e2c <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104f2a:	8b 40 7c             	mov    0x7c(%eax),%eax
80104f2d:	89 45 fc             	mov    %eax,-0x4(%ebp)
  proc->sighandler = new_handler;
80104f30:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f36:	8b 55 08             	mov    0x8(%ebp),%edx
80104f39:	89 50 7c             	mov    %edx,0x7c(%eax)
  return oldhandler;
...
80104f44:	83 ec 28             	sub    $0x28,%esp
  struct proc *p; 
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104f47:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104f4e:	eb 59                	jmp    80104fa9 <sigsend+0x68>
    if (p->pid == dest_pid) {
80104f50:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f53:	8b 40 10             	mov    0x10(%eax),%eax
80104f56:	3b 45 08             	cmp    0x8(%ebp),%eax
80104f59:	75 47                	jne    80104fa2 <sigsend+0x61>
...
80104f67:	8d 8a 80 00 00 00    	lea    0x80(%edx),%ecx
80104f6d:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f70:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104f74:	8b 55 08             	mov    0x8(%ebp),%edx
80104f77:	89 54 24 08          	mov    %edx,0x8(%esp)
80104f7b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f7f:	89 0c 24             	mov    %ecx,(%esp)
80104f82:	e8 e3 00 00 00       	call   8010506a <push>
80104f87:	85 c0                	test   %eax,%eax
80104f89:	74 15                	je     80104fa0 <sigsend+0x5f>
      {
        wakeup((void*)p->chan);
80104f8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f8e:	8b 40 20             	mov    0x20(%eax),%eax
80104f91:	89 04 24             	mov    %eax,(%esp)
80104f94:	e8 aa fd ff ff       	call   80104d43 <wakeup>
        return 0;
80104f99:	b8 00 00 00 00       	mov    $0x0,%eax
80104f9e:	eb 17                	jmp    80104fb7 <sigsend+0x76>
      }
      break;
80104fa0:	eb 10                	jmp    80104fb2 <sigsend+0x71>
  struct proc *p; 
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104fa2:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
80104fa9:	81 7d f4 b4 a1 11 80 	cmpl   $0x8011a1b4,-0xc(%ebp)
80104fb0:	72 9e                	jb     80104f50 <sigsend+0xf>
        return 0;
      }
      break;
    }
...
80104fc5:	8b 50 18             	mov    0x18(%eax),%edx
80104fc8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fce:	8d 98 4c 01 00 00    	lea    0x14c(%eax),%ebx
80104fd4:	b8 13 00 00 00       	mov    $0x13,%eax
80104fd9:	89 d7                	mov    %edx,%edi
80104fdb:	89 de                	mov    %ebx,%esi
80104fdd:	89 c1                	mov    %eax,%ecx
80104fdf:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  
  //finish handling signal so we could handle the next one
  proc->handling_signal = 0;
80104fe1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fe7:	c7 80 9c 01 00 00 00 	movl   $0x0,0x19c(%eax)
80104fee:	00 00 00 
  proc->curr_signal->used = 0;
80104ff1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ff7:	8b 80 98 01 00 00    	mov    0x198(%eax),%eax
80104ffd:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  return 0;
80105004:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105009:	5b                   	pop    %ebx
8010500a:	5e                   	pop    %esi
8010500b:	5f                   	pop    %edi
...
80105011:	83 ec 18             	sub    $0x18,%esp
  if (is_empty(&(proc->pending_signals))) {
80105014:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010501a:	83 e8 80             	sub    $0xffffff80,%eax
8010501d:	89 04 24             	mov    %eax,(%esp)
80105020:	e8 36 01 00 00       	call   8010515b <is_empty>
80105025:	85 c0                	test   %eax,%eax
80105027:	74 3a                	je     80105063 <sigpause+0x55>
    acquire(&ptable.lock);
80105029:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105030:	e8 4a 03 00 00       	call   8010537f <acquire>
    proc->chan = (int)proc;
80105035:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010503b:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105042:	89 50 20             	mov    %edx,0x20(%eax)
    proc->state = SLEEPING;
80105045:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010504b:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
    sched();
80105052:	e8 01 fb ff ff       	call   80104b58 <sched>
    release(&ptable.lock);
80105057:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010505e:	e8 7e 03 00 00       	call   801053e1 <release>
  }

  return 0;
80105063:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105068:	c9                   	leave  
80105069:	c3                   	ret    
...
8010506d:	83 ec 1c             	sub    $0x1c,%esp
  struct cstackframe *csf;
...
80105076:	eb 43                	jmp    801050bb <push+0x51>
    if(cas(&(csf->used), 0, 1)) 
80105078:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010507b:	83 c0 0c             	add    $0xc,%eax
8010507e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80105085:	00 
80105086:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010508d:	00 
8010508e:	89 04 24             	mov    %eax,(%esp)
80105091:	e8 63 f2 ff ff       	call   801042f9 <cas>
80105096:	85 c0                	test   %eax,%eax
80105098:	74 1d                	je     801050b7 <push+0x4d>
      goto found;
8010509a:	90                   	nop
...
801050a6:	8b 55 10             	mov    0x10(%ebp),%edx
801050a9:	89 50 04             	mov    %edx,0x4(%eax)
  csf->value = value;
801050ac:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050af:	8b 55 14             	mov    0x14(%ebp),%edx
801050b2:	89 50 08             	mov    %edx,0x8(%eax)
801050b5:	eb 18                	jmp    801050cf <push+0x65>
// -------------- cstack implementation ------------
int 
push(struct cstack *cstack, int sender_pid, int recepient_pid, int value)
{
  struct cstackframe *csf;
  for(csf = cstack->frames; csf < &cstack->frames[MAX_CSTACK_FRAMES]; csf++) {
801050b7:	83 45 fc 14          	addl   $0x14,-0x4(%ebp)
801050bb:	8b 45 08             	mov    0x8(%ebp),%eax
801050be:	05 c8 00 00 00       	add    $0xc8,%eax
801050c3:	3b 45 fc             	cmp    -0x4(%ebp),%eax
801050c6:	77 b0                	ja     80105078 <push+0xe>
    if(cas(&(csf->used), 0, 1)) 
      goto found;
  }
...
801050cd:	eb 3a                	jmp    80105109 <push+0x9f>
  csf->sender_pid = sender_pid;
  csf->recepient_pid = recepient_pid;
  csf->value = value;
...
801050d2:	8b 90 c8 00 00 00    	mov    0xc8(%eax),%edx
801050d8:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050db:	89 50 10             	mov    %edx,0x10(%eax)
  } while (!cas((int*)&(cstack->head), (int)csf->next, (int)csf));
801050de:	8b 55 fc             	mov    -0x4(%ebp),%edx
801050e1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050e4:	8b 40 10             	mov    0x10(%eax),%eax
801050e7:	8b 4d 08             	mov    0x8(%ebp),%ecx
801050ea:	81 c1 c8 00 00 00    	add    $0xc8,%ecx
801050f0:	89 54 24 08          	mov    %edx,0x8(%esp)
801050f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801050f8:	89 0c 24             	mov    %ecx,(%esp)
801050fb:	e8 f9 f1 ff ff       	call   801042f9 <cas>
80105100:	85 c0                	test   %eax,%eax
80105102:	74 cb                	je     801050cf <push+0x65>
  ...
  return 1;
80105104:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105109:	c9                   	leave  
8010510a:	c3                   	ret    
...
80105114:	8b 80 c8 00 00 00    	mov    0xc8(%eax),%eax
8010511a:	89 45 fc             	mov    %eax,-0x4(%ebp)
    if (!csf)
8010511d:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105121:	75 07                	jne    8010512a <pop+0x1f>
      return 0;
80105123:	b8 00 00 00 00       	mov    $0x0,%eax
80105128:	eb 2f                	jmp    80105159 <pop+0x4e>

    next = csf->next;
8010512a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010512d:	8b 40 10             	mov    0x10(%eax),%eax
80105130:	89 45 f8             	mov    %eax,-0x8(%ebp)
  } while (!cas((int*)&(cstack->head), (int)csf, (int)next));
80105133:	8b 55 f8             	mov    -0x8(%ebp),%edx
80105136:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105139:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010513c:	81 c1 c8 00 00 00    	add    $0xc8,%ecx
80105142:	89 54 24 08          	mov    %edx,0x8(%esp)
80105146:	89 44 24 04          	mov    %eax,0x4(%esp)
8010514a:	89 0c 24             	mov    %ecx,(%esp)
8010514d:	e8 a7 f1 ff ff       	call   801042f9 <cas>
80105152:	85 c0                	test   %eax,%eax
80105154:	74 bb                	je     80105111 <pop+0x6>
...
80105161:	8b 80 c8 00 00 00    	mov    0xc8(%eax),%eax
80105167:	85 c0                	test   %eax,%eax
80105169:	0f 94 c0             	sete   %al
8010516c:	0f b6 c0             	movzbl %al,%eax
}
8010516f:	5d                   	pop    %ebp
80105170:	c3                   	ret    

80105171 <roundup_4div>:
...
80105177:	83 c0 03             	add    $0x3,%eax
8010517a:	83 e0 fc             	and    $0xfffffffc,%eax
}
8010517d:	5d                   	pop    %ebp
8010517e:	c3                   	ret    
...
80105185:	83 ec 2c             	sub    $0x2c,%esp
  if (proc == 0)  //no proccess
80105188:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010518e:	85 c0                	test   %eax,%eax
80105190:	75 05                	jne    80105197 <fix_tf+0x18>
    return;
80105192:	e9 89 01 00 00       	jmp    80105320 <fix_tf+0x1a1>

  if (((tf->cs) & 3) != DPL_USER) //has no user privilge
80105197:	8b 45 08             	mov    0x8(%ebp),%eax
8010519a:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010519e:	0f b7 c0             	movzwl %ax,%eax
801051a1:	83 e0 03             	and    $0x3,%eax
801051a4:	83 f8 03             	cmp    $0x3,%eax
801051a7:	74 05                	je     801051ae <fix_tf+0x2f>
    return;
801051a9:	e9 72 01 00 00       	jmp    80105320 <fix_tf+0x1a1>
...
801051b4:	05 9c 01 00 00       	add    $0x19c,%eax
801051b9:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
801051c0:	00 
801051c1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801051c8:	00 
801051c9:	89 04 24             	mov    %eax,(%esp)
801051cc:	e8 28 f1 ff ff       	call   801042f9 <cas>
801051d1:	85 c0                	test   %eax,%eax
801051d3:	75 05                	jne    801051da <fix_tf+0x5b>
    goto done;
801051d5:	e9 46 01 00 00       	jmp    80105320 <fix_tf+0x1a1>
...
801051e0:	83 e8 80             	sub    $0xffffff80,%eax
801051e3:	89 04 24             	mov    %eax,(%esp)
801051e6:	e8 20 ff ff ff       	call   8010510b <pop>
801051eb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801051ee:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801051f2:	74 0e                	je     80105202 <fix_tf+0x83>
801051f4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051fa:	8b 40 7c             	mov    0x7c(%eax),%eax
801051fd:	83 f8 ff             	cmp    $0xffffffff,%eax
80105200:	75 25                	jne    80105227 <fix_tf+0xa8>
    if (new_signal)
80105202:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
80105206:	74 0a                	je     80105212 <fix_tf+0x93>
      new_signal->used = 0;
...
80105218:	c7 80 9c 01 00 00 00 	movl   $0x0,0x19c(%eax)
8010521f:	00 00 00 
    goto done; 
80105222:	e9 f9 00 00 00       	jmp    80105320 <fix_tf+0x1a1>
  }

  proc->curr_signal = new_signal;
80105227:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010522d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105230:	89 90 98 01 00 00    	mov    %edx,0x198(%eax)

  //else, we have a pending signal and a handler: 
  
  // back-up the old trap-frame for handeling user stack
  proc->old_tf = *(tf);
80105236:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010523d:	8b 45 08             	mov    0x8(%ebp),%eax
80105240:	8d 9a 4c 01 00 00    	lea    0x14c(%edx),%ebx
80105246:	89 c2                	mov    %eax,%edx
80105248:	b8 13 00 00 00       	mov    $0x13,%eax
8010524d:	89 df                	mov    %ebx,%edi
8010524f:	89 d6                	mov    %edx,%esi
80105251:	89 c1                	mov    %eax,%ecx
80105253:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  
  int addr_space; 
  //int ret_addr;
  
  int stam = 0;
80105255:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  if (1 == stam) {
8010525c:	83 7d e0 01          	cmpl   $0x1,-0x20(%ebp)
80105260:	75 07                	jne    80105269 <fix_tf+0xea>
    goToStack: // lable#1
    asm volatile("movl $24, %eax; int $64"); //movl $SYS_sigret, %eax; int $T_SYSCALL; 
80105262:	b8 18 00 00 00       	mov    $0x18,%eax
80105267:	cd 40                	int    $0x40
    returnFromStack:; // lable#2
  }

  addr_space = &&returnFromStack - &&goToStack;
80105269:	ba 69 52 10 80       	mov    $0x80105269,%edx
8010526e:	b8 62 52 10 80       	mov    $0x80105262,%eax
80105273:	29 c2                	sub    %eax,%edx
80105275:	89 d0                	mov    %edx,%eax
80105277:	89 45 dc             	mov    %eax,-0x24(%ebp)
  addr_space = roundup_4div(addr_space);
8010527a:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010527d:	89 04 24             	mov    %eax,(%esp)
80105280:	e8 ec fe ff ff       	call   80105171 <roundup_4div>
80105285:	89 45 dc             	mov    %eax,-0x24(%ebp)

  tf->esp -= addr_space;
80105288:	8b 45 08             	mov    0x8(%ebp),%eax
8010528b:	8b 50 44             	mov    0x44(%eax),%edx
8010528e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105291:	29 c2                	sub    %eax,%edx
80105293:	8b 45 08             	mov    0x8(%ebp),%eax
80105296:	89 50 44             	mov    %edx,0x44(%eax)
  memmove((void *)tf->esp, &&goToStack, addr_space);
80105299:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010529c:	8b 45 08             	mov    0x8(%ebp),%eax
8010529f:	8b 40 44             	mov    0x44(%eax),%eax
801052a2:	89 54 24 08          	mov    %edx,0x8(%esp)
801052a6:	c7 44 24 04 62 52 10 	movl   $0x80105262,0x4(%esp)
801052ad:	80 
801052ae:	89 04 24             	mov    %eax,(%esp)
801052b1:	e8 ec 03 00 00       	call   801056a2 <memmove>

  tf->esp -= 4;
801052b6:	8b 45 08             	mov    0x8(%ebp),%eax
801052b9:	8b 40 44             	mov    0x44(%eax),%eax
801052bc:	8d 50 fc             	lea    -0x4(%eax),%edx
801052bf:	8b 45 08             	mov    0x8(%ebp),%eax
801052c2:	89 50 44             	mov    %edx,0x44(%eax)
  *(uint *)tf->esp = new_signal->value;      //param 2
801052c5:	8b 45 08             	mov    0x8(%ebp),%eax
801052c8:	8b 40 44             	mov    0x44(%eax),%eax
801052cb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801052ce:	8b 52 08             	mov    0x8(%edx),%edx
801052d1:	89 10                	mov    %edx,(%eax)

  tf->esp -= 4;
801052d3:	8b 45 08             	mov    0x8(%ebp),%eax
801052d6:	8b 40 44             	mov    0x44(%eax),%eax
801052d9:	8d 50 fc             	lea    -0x4(%eax),%edx
801052dc:	8b 45 08             	mov    0x8(%ebp),%eax
801052df:	89 50 44             	mov    %edx,0x44(%eax)
  *(uint *)tf->esp = new_signal->sender_pid; //param 1
801052e2:	8b 45 08             	mov    0x8(%ebp),%eax
801052e5:	8b 40 44             	mov    0x44(%eax),%eax
801052e8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801052eb:	8b 12                	mov    (%edx),%edx
801052ed:	89 10                	mov    %edx,(%eax)

  tf->esp -= 4;
801052ef:	8b 45 08             	mov    0x8(%ebp),%eax
801052f2:	8b 40 44             	mov    0x44(%eax),%eax
801052f5:	8d 50 fc             	lea    -0x4(%eax),%edx
801052f8:	8b 45 08             	mov    0x8(%ebp),%eax
801052fb:	89 50 44             	mov    %edx,0x44(%eax)
  *(uint *)tf->esp = tf->esp + 12;
801052fe:	8b 45 08             	mov    0x8(%ebp),%eax
80105301:	8b 40 44             	mov    0x44(%eax),%eax
80105304:	8b 55 08             	mov    0x8(%ebp),%edx
80105307:	8b 52 44             	mov    0x44(%edx),%edx
...
80105315:	8b 40 7c             	mov    0x7c(%eax),%eax
80105318:	89 c2                	mov    %eax,%edx
8010531a:	8b 45 08             	mov    0x8(%ebp),%eax
8010531d:	89 50 38             	mov    %edx,0x38(%eax)

  done:;
80105320:	83 c4 2c             	add    $0x2c,%esp
80105323:	5b                   	pop    %ebx
80105324:	5e                   	pop    %esi
80105325:	5f                   	pop    %edi
80105326:	5d                   	pop    %ebp
...
80105353:	f0 87 02             	lock xchg %eax,(%edx)
...
80105364:	8b 55 0c             	mov    0xc(%ebp),%edx
80105367:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
8010536a:	8b 45 08             	mov    0x8(%ebp),%eax
8010536d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80105373:	8b 45 08             	mov    0x8(%ebp),%eax
80105376:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
8010537d:	5d                   	pop    %ebp
8010537e:	c3                   	ret    
...
80105385:	e8 49 01 00 00       	call   801054d3 <pushcli>
  if(holding(lk))
8010538a:	8b 45 08             	mov    0x8(%ebp),%eax
8010538d:	89 04 24             	mov    %eax,(%esp)
80105390:	e8 14 01 00 00       	call   801054a9 <holding>
80105395:	85 c0                	test   %eax,%eax
80105397:	74 0c                	je     801053a5 <acquire+0x26>
    panic("acquire");
80105399:	c7 04 24 ec 8d 10 80 	movl   $0x80108dec,(%esp)
801053a0:	e8 95 b1 ff ff       	call   8010053a <panic>
...
801053a9:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801053b0:	00 
801053b1:	89 04 24             	mov    %eax,(%esp)
801053b4:	e8 8b ff ff ff       	call   80105344 <xchg>
801053b9:	85 c0                	test   %eax,%eax
801053bb:	75 e9                	jne    801053a6 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801053bd:	8b 45 08             	mov    0x8(%ebp),%eax
801053c0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801053c7:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
801053ca:	8b 45 08             	mov    0x8(%ebp),%eax
801053cd:	83 c0 0c             	add    $0xc,%eax
801053d0:	89 44 24 04          	mov    %eax,0x4(%esp)
801053d4:	8d 45 08             	lea    0x8(%ebp),%eax
801053d7:	89 04 24             	mov    %eax,(%esp)
801053da:	e8 51 00 00 00       	call   80105430 <getcallerpcs>
}
801053df:	c9                   	leave  
801053e0:	c3                   	ret    
...
801053e4:	83 ec 18             	sub    $0x18,%esp
  if(!holding(lk))
801053e7:	8b 45 08             	mov    0x8(%ebp),%eax
801053ea:	89 04 24             	mov    %eax,(%esp)
801053ed:	e8 b7 00 00 00       	call   801054a9 <holding>
801053f2:	85 c0                	test   %eax,%eax
801053f4:	75 0c                	jne    80105402 <release+0x21>
    panic("release");
801053f6:	c7 04 24 f4 8d 10 80 	movl   $0x80108df4,(%esp)
801053fd:	e8 38 b1 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80105402:	8b 45 08             	mov    0x8(%ebp),%eax
80105405:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
8010540c:	8b 45 08             	mov    0x8(%ebp),%eax
8010540f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105419:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105420:	00 
80105421:	89 04 24             	mov    %eax,(%esp)
80105424:	e8 1b ff ff ff       	call   80105344 <xchg>

  popcli();
80105429:	e8 e9 00 00 00       	call   80105517 <popcli>
}
8010542e:	c9                   	leave  
8010542f:	c3                   	ret    
...
80105439:	83 e8 08             	sub    $0x8,%eax
8010543c:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
8010543f:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105446:	eb 38                	jmp    80105480 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105448:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010544c:	74 38                	je     80105486 <getcallerpcs+0x56>
8010544e:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105455:	76 2f                	jbe    80105486 <getcallerpcs+0x56>
80105457:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010545b:	74 29                	je     80105486 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
8010545d:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105460:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105467:	8b 45 0c             	mov    0xc(%ebp),%eax
8010546a:	01 c2                	add    %eax,%edx
...
80105479:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
8010547c:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105480:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105484:	7e c2                	jle    80105448 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105486:	eb 19                	jmp    801054a1 <getcallerpcs+0x71>
    pcs[i] = 0;
80105488:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010548b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105492:	8b 45 0c             	mov    0xc(%ebp),%eax
80105495:	01 d0                	add    %edx,%eax
80105497:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
8010549d:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801054a1:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801054a5:	7e e1                	jle    80105488 <getcallerpcs+0x58>
    pcs[i] = 0;
}
801054a7:	c9                   	leave  
801054a8:	c3                   	ret    
...
801054b3:	74 17                	je     801054cc <holding+0x23>
801054b5:	8b 45 08             	mov    0x8(%ebp),%eax
801054b8:	8b 50 08             	mov    0x8(%eax),%edx
801054bb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054c1:	39 c2                	cmp    %eax,%edx
801054c3:	75 07                	jne    801054cc <holding+0x23>
801054c5:	b8 01 00 00 00       	mov    $0x1,%eax
801054ca:	eb 05                	jmp    801054d1 <holding+0x28>
...
801054d6:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
801054d9:	e8 4a fe ff ff       	call   80105328 <readeflags>
801054de:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
801054e1:	e8 52 fe ff ff       	call   80105338 <cli>
  if(cpu->ncli++ == 0)
801054e6:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801054ed:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
801054f3:	8d 48 01             	lea    0x1(%eax),%ecx
801054f6:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
801054fc:	85 c0                	test   %eax,%eax
801054fe:	75 15                	jne    80105515 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80105500:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105506:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105509:	81 e2 00 02 00 00    	and    $0x200,%edx
8010550f:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105515:	c9                   	leave  
80105516:	c3                   	ret    
...
8010551a:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010551d:	e8 06 fe ff ff       	call   80105328 <readeflags>
80105522:	25 00 02 00 00       	and    $0x200,%eax
80105527:	85 c0                	test   %eax,%eax
80105529:	74 0c                	je     80105537 <popcli+0x20>
    panic("popcli - interruptible");
8010552b:	c7 04 24 fc 8d 10 80 	movl   $0x80108dfc,(%esp)
80105532:	e8 03 b0 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80105537:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010553d:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105543:	83 ea 01             	sub    $0x1,%edx
80105546:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
8010554c:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105552:	85 c0                	test   %eax,%eax
80105554:	79 0c                	jns    80105562 <popcli+0x4b>
    panic("popcli");
80105556:	c7 04 24 13 8e 10 80 	movl   $0x80108e13,(%esp)
8010555d:	e8 d8 af ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
80105562:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105568:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010556e:	85 c0                	test   %eax,%eax
80105570:	75 15                	jne    80105587 <popcli+0x70>
80105572:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105578:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010557e:	85 c0                	test   %eax,%eax
80105580:	74 05                	je     80105587 <popcli+0x70>
    sti();
80105582:	e8 b7 fd ff ff       	call   8010533e <sti>
}
80105587:	c9                   	leave  
80105588:	c3                   	ret    
...
8010559d:	fc                   	cld    
8010559e:	f3 aa                	rep stos %al,%es:(%edi)
...
801055b3:	8b 4d 08             	mov    0x8(%ebp),%ecx
801055b6:	8b 55 10             	mov    0x10(%ebp),%edx
801055b9:	8b 45 0c             	mov    0xc(%ebp),%eax
801055bc:	89 cb                	mov    %ecx,%ebx
801055be:	89 df                	mov    %ebx,%edi
801055c0:	89 d1                	mov    %edx,%ecx
801055c2:	fc                   	cld    
801055c3:	f3 ab                	rep stos %eax,%es:(%edi)
801055c5:	89 ca                	mov    %ecx,%edx
801055c7:	89 fb                	mov    %edi,%ebx
801055c9:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801055dc:	83 e0 03             	and    $0x3,%eax
801055df:	85 c0                	test   %eax,%eax
801055e1:	75 49                	jne    8010562c <memset+0x59>
801055e3:	8b 45 10             	mov    0x10(%ebp),%eax
801055e6:	83 e0 03             	and    $0x3,%eax
801055e9:	85 c0                	test   %eax,%eax
801055eb:	75 3f                	jne    8010562c <memset+0x59>
    c &= 0xFF;
801055ed:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801055f4:	8b 45 10             	mov    0x10(%ebp),%eax
801055f7:	c1 e8 02             	shr    $0x2,%eax
801055fa:	89 c2                	mov    %eax,%edx
801055fc:	8b 45 0c             	mov    0xc(%ebp),%eax
801055ff:	c1 e0 18             	shl    $0x18,%eax
80105602:	89 c1                	mov    %eax,%ecx
80105604:	8b 45 0c             	mov    0xc(%ebp),%eax
80105607:	c1 e0 10             	shl    $0x10,%eax
8010560a:	09 c1                	or     %eax,%ecx
8010560c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010560f:	c1 e0 08             	shl    $0x8,%eax
80105612:	09 c8                	or     %ecx,%eax
80105614:	0b 45 0c             	or     0xc(%ebp),%eax
80105617:	89 54 24 08          	mov    %edx,0x8(%esp)
8010561b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010561f:	8b 45 08             	mov    0x8(%ebp),%eax
80105622:	89 04 24             	mov    %eax,(%esp)
80105625:	e8 84 ff ff ff       	call   801055ae <stosl>
8010562a:	eb 19                	jmp    80105645 <memset+0x72>
  } else
    stosb(dst, c, n);
...
80105640:	e8 44 ff ff ff       	call   80105589 <stosb>
  return dst;
...
80105659:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
8010565c:	eb 30                	jmp    8010568e <memcmp+0x44>
    if(*s1 != *s2)
...
8010566a:	38 c2                	cmp    %al,%dl
8010566c:	74 18                	je     80105686 <memcmp+0x3c>
      return *s1 - *s2;
8010566e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105671:	0f b6 00             	movzbl (%eax),%eax
80105674:	0f b6 d0             	movzbl %al,%edx
80105677:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010567a:	0f b6 00             	movzbl (%eax),%eax
8010567d:	0f b6 c0             	movzbl %al,%eax
80105680:	29 c2                	sub    %eax,%edx
80105682:	89 d0                	mov    %edx,%eax
80105684:	eb 1a                	jmp    801056a0 <memcmp+0x56>
    s1++, s2++;
80105686:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010568a:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
80105699:	75 c3                	jne    8010565e <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801056ab:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
801056ae:	8b 45 08             	mov    0x8(%ebp),%eax
801056b1:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801056b4:	8b 45 fc             	mov    -0x4(%ebp),%eax
801056b7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801056ba:	73 3d                	jae    801056f9 <memmove+0x57>
801056bc:	8b 45 10             	mov    0x10(%ebp),%eax
801056bf:	8b 55 fc             	mov    -0x4(%ebp),%edx
801056c2:	01 d0                	add    %edx,%eax
801056c4:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801056c7:	76 30                	jbe    801056f9 <memmove+0x57>
    s += n;
801056c9:	8b 45 10             	mov    0x10(%ebp),%eax
801056cc:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801056cf:	8b 45 10             	mov    0x10(%ebp),%eax
801056d2:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801056d5:	eb 13                	jmp    801056ea <memmove+0x48>
      *--d = *--s;
801056d7:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801056db:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
801056df:	8b 45 fc             	mov    -0x4(%ebp),%eax
801056e2:	0f b6 10             	movzbl (%eax),%edx
801056e5:	8b 45 f8             	mov    -0x8(%ebp),%eax
801056e8:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
801056ed:	8d 50 ff             	lea    -0x1(%eax),%edx
801056f0:	89 55 10             	mov    %edx,0x10(%ebp)
801056f3:	85 c0                	test   %eax,%eax
801056f5:	75 e0                	jne    801056d7 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801056f7:	eb 26                	jmp    8010571f <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
801056f9:	eb 17                	jmp    80105712 <memmove+0x70>
      *d++ = *s++;
801056fb:	8b 45 f8             	mov    -0x8(%ebp),%eax
801056fe:	8d 50 01             	lea    0x1(%eax),%edx
80105701:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105704:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105707:	8d 4a 01             	lea    0x1(%edx),%ecx
8010570a:	89 4d fc             	mov    %ecx,-0x4(%ebp)
...
8010571d:	75 dc                	jne    801056fb <memmove+0x59>
      *d++ = *s++;
...
8010573e:	e8 5f ff ff ff       	call   801056a2 <memmove>
}
80105743:	c9                   	leave  
80105744:	c3                   	ret    
...
80105746:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105748:	eb 0c                	jmp    80105756 <strncmp+0x11>
    n--, p++, q++;
...
80105774:	74 d4                	je     8010574a <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105776:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010577a:	75 07                	jne    80105783 <strncmp+0x3e>
    return 0;
8010577c:	b8 00 00 00 00       	mov    $0x0,%eax
80105781:	eb 16                	jmp    80105799 <strncmp+0x54>
...
801057a4:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
801057a7:	90                   	nop
801057a8:	8b 45 10             	mov    0x10(%ebp),%eax
801057ab:	8d 50 ff             	lea    -0x1(%eax),%edx
801057ae:	89 55 10             	mov    %edx,0x10(%ebp)
801057b1:	85 c0                	test   %eax,%eax
801057b3:	7e 1e                	jle    801057d3 <strncpy+0x38>
801057b5:	8b 45 08             	mov    0x8(%ebp),%eax
801057b8:	8d 50 01             	lea    0x1(%eax),%edx
801057bb:	89 55 08             	mov    %edx,0x8(%ebp)
801057be:	8b 55 0c             	mov    0xc(%ebp),%edx
801057c1:	8d 4a 01             	lea    0x1(%edx),%ecx
801057c4:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801057c7:	0f b6 12             	movzbl (%edx),%edx
801057ca:	88 10                	mov    %dl,(%eax)
801057cc:	0f b6 00             	movzbl (%eax),%eax
801057cf:	84 c0                	test   %al,%al
801057d1:	75 d5                	jne    801057a8 <strncpy+0xd>
    ;
  while(n-- > 0)
801057d3:	eb 0c                	jmp    801057e1 <strncpy+0x46>
    *s++ = 0;
801057d5:	8b 45 08             	mov    0x8(%ebp),%eax
801057d8:	8d 50 01             	lea    0x1(%eax),%edx
801057db:	89 55 08             	mov    %edx,0x8(%ebp)
801057de:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
801057e4:	8d 50 ff             	lea    -0x1(%eax),%edx
801057e7:	89 55 10             	mov    %edx,0x10(%ebp)
801057ea:	85 c0                	test   %eax,%eax
801057ec:	7f e7                	jg     801057d5 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
801057fc:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801057ff:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105803:	7f 05                	jg     8010580a <safestrcpy+0x17>
    return os;
80105805:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105808:	eb 31                	jmp    8010583b <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
8010580a:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010580e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105812:	7e 1e                	jle    80105832 <safestrcpy+0x3f>
80105814:	8b 45 08             	mov    0x8(%ebp),%eax
80105817:	8d 50 01             	lea    0x1(%eax),%edx
8010581a:	89 55 08             	mov    %edx,0x8(%ebp)
8010581d:	8b 55 0c             	mov    0xc(%ebp),%edx
80105820:	8d 4a 01             	lea    0x1(%edx),%ecx
80105823:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105826:	0f b6 12             	movzbl (%edx),%edx
80105829:	88 10                	mov    %dl,(%eax)
8010582b:	0f b6 00             	movzbl (%eax),%eax
8010582e:	84 c0                	test   %al,%al
80105830:	75 d8                	jne    8010580a <safestrcpy+0x17>
    ;
  *s = 0;
80105832:	8b 45 08             	mov    0x8(%ebp),%eax
80105835:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
8010584a:	eb 04                	jmp    80105850 <strlen+0x13>
8010584c:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105850:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105853:	8b 45 08             	mov    0x8(%ebp),%eax
80105856:	01 d0                	add    %edx,%eax
80105858:	0f b6 00             	movzbl (%eax),%eax
8010585b:	84 c0                	test   %al,%al
8010585d:	75 ed                	jne    8010584c <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105864:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105868:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010586e:	56                   	push   %esi
  pushl %edi
8010586f:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80105870:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105872:	89 d4                	mov    %edx,%esp
...
80105884:	3b 45 08             	cmp    0x8(%ebp),%eax
80105887:	76 12                	jbe    8010589b <fetchint+0x22>
80105889:	8b 45 08             	mov    0x8(%ebp),%eax
8010588c:	8d 50 04             	lea    0x4(%eax),%edx
8010588f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105895:	8b 00                	mov    (%eax),%eax
80105897:	39 c2                	cmp    %eax,%edx
80105899:	76 07                	jbe    801058a2 <fetchint+0x29>
    return -1;
8010589b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058a0:	eb 0f                	jmp    801058b1 <fetchint+0x38>
  *ip = *(int*)(addr);
801058a2:	8b 45 08             	mov    0x8(%ebp),%eax
801058a5:	8b 10                	mov    (%eax),%edx
...
801058b6:	83 ec 10             	sub    $0x10,%esp
  char *s, *ep;
...
801058c4:	77 07                	ja     801058cd <fetchstr+0x1a>
    return -1;
801058c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058cb:	eb 46                	jmp    80105913 <fetchstr+0x60>
  *pp = (char*)addr;
...
801058e3:	8b 00                	mov    (%eax),%eax
801058e5:	89 45 fc             	mov    %eax,-0x4(%ebp)
801058e8:	eb 1c                	jmp    80105906 <fetchstr+0x53>
    if(*s == 0)
801058ea:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058ed:	0f b6 00             	movzbl (%eax),%eax
801058f0:	84 c0                	test   %al,%al
801058f2:	75 0e                	jne    80105902 <fetchstr+0x4f>
      return s - *pp;
801058f4:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058f7:	8b 45 0c             	mov    0xc(%ebp),%eax
801058fa:	8b 00                	mov    (%eax),%eax
801058fc:	29 c2                	sub    %eax,%edx
801058fe:	89 d0                	mov    %edx,%eax
80105900:	eb 11                	jmp    80105913 <fetchstr+0x60>
...
80105909:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010590c:	72 dc                	jb     801058ea <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105924:	8b 50 44             	mov    0x44(%eax),%edx
80105927:	8b 45 08             	mov    0x8(%ebp),%eax
8010592a:	c1 e0 02             	shl    $0x2,%eax
8010592d:	01 d0                	add    %edx,%eax
8010592f:	8d 50 04             	lea    0x4(%eax),%edx
80105932:	8b 45 0c             	mov    0xc(%ebp),%eax
80105935:	89 44 24 04          	mov    %eax,0x4(%esp)
80105939:	89 14 24             	mov    %edx,(%esp)
8010593c:	e8 38 ff ff ff       	call   80105879 <fetchint>
}
80105941:	c9                   	leave  
80105942:	c3                   	ret    
...
801059e0:	83 ec 24             	sub    $0x24,%esp
  int num;
...
801059fb:	83 f8 19             	cmp    $0x19,%eax
...
80105a26:	eb 3d                	jmp    80105a65 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105a28:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a2e:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
80105a3d:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105a41:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105a45:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a49:	c7 04 24 1a 8e 10 80 	movl   $0x80108e1a,(%esp)
80105a50:	e8 4b a9 ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105a55:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a5b:	8b 40 18             	mov    0x18(%eax),%eax
80105a5e:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105a65:	83 c4 24             	add    $0x24,%esp
80105a68:	5b                   	pop    %ebx
80105a69:	5d                   	pop    %ebp
80105a6a:	c3                   	ret    
...
80105a78:	8b 45 08             	mov    0x8(%ebp),%eax
80105a7b:	89 04 24             	mov    %eax,(%esp)
80105a7e:	e8 92 fe ff ff       	call   80105915 <argint>
80105a83:	85 c0                	test   %eax,%eax
80105a85:	79 07                	jns    80105a8e <argfd+0x23>
    return -1;
80105a87:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a8c:	eb 50                	jmp    80105ade <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105a8e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a91:	85 c0                	test   %eax,%eax
80105a93:	78 21                	js     80105ab6 <argfd+0x4b>
80105a95:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a98:	83 f8 0f             	cmp    $0xf,%eax
80105a9b:	7f 19                	jg     80105ab6 <argfd+0x4b>
80105a9d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105aa3:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105aa6:	83 c2 08             	add    $0x8,%edx
80105aa9:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105aad:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ab0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ab4:	75 07                	jne    80105abd <argfd+0x52>
    return -1;
80105ab6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105abb:	eb 21                	jmp    80105ade <argfd+0x73>
  if(pfd)
80105abd:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105ac1:	74 08                	je     80105acb <argfd+0x60>
    *pfd = fd;
80105ac3:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105ac6:	8b 45 0c             	mov    0xc(%ebp),%eax
80105ac9:	89 10                	mov    %edx,(%eax)
  if(pf)
80105acb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105acf:	74 08                	je     80105ad9 <argfd+0x6e>
    *pf = f;
80105ad1:	8b 45 10             	mov    0x10(%ebp),%eax
80105ad4:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105ad7:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105ae3:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105ae6:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105aed:	eb 30                	jmp    80105b1f <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105aef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105af5:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105af8:	83 c2 08             	add    $0x8,%edx
80105afb:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105aff:	85 c0                	test   %eax,%eax
80105b01:	75 18                	jne    80105b1b <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105b03:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b09:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105b0c:	8d 4a 08             	lea    0x8(%edx),%ecx
80105b0f:	8b 55 08             	mov    0x8(%ebp),%edx
80105b12:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105b16:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b19:	eb 0f                	jmp    80105b2a <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105b1b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105b1f:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105b23:	7e ca                	jle    80105aef <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105b9f:	e8 c7 fe ff ff       	call   80105a6b <argfd>
80105ba4:	85 c0                	test   %eax,%eax
80105ba6:	78 35                	js     80105bdd <sys_read+0x5a>
80105ba8:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105bab:	89 44 24 04          	mov    %eax,0x4(%esp)
80105baf:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105bb6:	e8 5a fd ff ff       	call   80105915 <argint>
80105bbb:	85 c0                	test   %eax,%eax
80105bbd:	78 1e                	js     80105bdd <sys_read+0x5a>
...
80105bdb:	79 07                	jns    80105be4 <sys_read+0x61>
    return -1;
80105bdd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105be2:	eb 19                	jmp    80105bfd <sys_read+0x7a>
...
80105bf8:	e8 03 b5 ff ff       	call   80101100 <fileread>
}
80105bfd:	c9                   	leave  
80105bfe:	c3                   	ret    
...
80105c13:	00 
80105c14:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c1b:	e8 4b fe ff ff       	call   80105a6b <argfd>
80105c20:	85 c0                	test   %eax,%eax
80105c22:	78 35                	js     80105c59 <sys_write+0x5a>
80105c24:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105c27:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c2b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105c32:	e8 de fc ff ff       	call   80105915 <argint>
80105c37:	85 c0                	test   %eax,%eax
80105c39:	78 1e                	js     80105c59 <sys_write+0x5a>
80105c3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c3e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c42:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105c45:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105c50:	e8 ee fc ff ff       	call   80105943 <argptr>
80105c55:	85 c0                	test   %eax,%eax
80105c57:	79 07                	jns    80105c60 <sys_write+0x61>
    return -1;
80105c59:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c5e:	eb 19                	jmp    80105c79 <sys_write+0x7a>
  return filewrite(f, p, n);
80105c60:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105c63:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105c66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c69:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105c6d:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c71:	89 04 24             	mov    %eax,(%esp)
80105c74:	e8 43 b5 ff ff       	call   801011bc <filewrite>
}
80105c79:	c9                   	leave  
80105c7a:	c3                   	ret    
...
80105ccf:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
  
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80105cd2:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105cd5:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cd9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105ce0:	00 
80105ce1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ce8:	e8 7e fd ff ff       	call   80105a6b <argfd>
80105ced:	85 c0                	test   %eax,%eax
80105cef:	78 1f                	js     80105d10 <sys_fstat+0x44>
80105cf1:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105cf8:	00 
80105cf9:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105cfc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d07:	e8 37 fc ff ff       	call   80105943 <argptr>
80105d0c:	85 c0                	test   %eax,%eax
80105d0e:	79 07                	jns    80105d17 <sys_fstat+0x4b>
    return -1;
80105d10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d15:	eb 12                	jmp    80105d29 <sys_fstat+0x5d>
  return filestat(f, st);
80105d17:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105d1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d1d:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d21:	89 04 24             	mov    %eax,(%esp)
80105d24:	e8 88 b3 ff ff       	call   801010b1 <filestat>
}
80105d29:	c9                   	leave  
80105d2a:	c3                   	ret    
...
80105d2e:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105d31:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105d34:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d38:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d3f:	e8 61 fc ff ff       	call   801059a5 <argstr>
80105d44:	85 c0                	test   %eax,%eax
80105d46:	78 17                	js     80105d5f <sys_link+0x34>
80105d48:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105d4b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d56:	e8 4a fc ff ff       	call   801059a5 <argstr>
80105d5b:	85 c0                	test   %eax,%eax
80105d5d:	79 0a                	jns    80105d69 <sys_link+0x3e>
    return -1;
80105d5f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d64:	e9 42 01 00 00       	jmp    80105eab <sys_link+0x180>

  begin_op();
80105d69:	e8 af d6 ff ff       	call   8010341d <begin_op>
  if((ip = namei(old)) == 0){
80105d6e:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105d71:	89 04 24             	mov    %eax,(%esp)
80105d74:	e8 9a c6 ff ff       	call   80102413 <namei>
80105d79:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d7c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d80:	75 0f                	jne    80105d91 <sys_link+0x66>
    end_op();
80105d82:	e8 1a d7 ff ff       	call   801034a1 <end_op>
    return -1;
80105d87:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d8c:	e9 1a 01 00 00       	jmp    80105eab <sys_link+0x180>
  }

  ilock(ip);
80105d91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d94:	89 04 24             	mov    %eax,(%esp)
80105d97:	e8 cc ba ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105d9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d9f:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105da3:	66 83 f8 01          	cmp    $0x1,%ax
80105da7:	75 1a                	jne    80105dc3 <sys_link+0x98>
    iunlockput(ip);
80105da9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dac:	89 04 24             	mov    %eax,(%esp)
80105daf:	e8 38 bd ff ff       	call   80101aec <iunlockput>
    end_op();
80105db4:	e8 e8 d6 ff ff       	call   801034a1 <end_op>
    return -1;
80105db9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dbe:	e9 e8 00 00 00       	jmp    80105eab <sys_link+0x180>
  }

  ip->nlink++;
80105dc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dc6:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105dca:	8d 50 01             	lea    0x1(%eax),%edx
80105dcd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dd0:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105dd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dd7:	89 04 24             	mov    %eax,(%esp)
80105dda:	e8 cd b8 ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80105ddf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105de2:	89 04 24             	mov    %eax,(%esp)
80105de5:	e8 cc bb ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105dea:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105ded:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105df0:	89 54 24 04          	mov    %edx,0x4(%esp)
80105df4:	89 04 24             	mov    %eax,(%esp)
80105df7:	e8 39 c6 ff ff       	call   80102435 <nameiparent>
80105dfc:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105dff:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e03:	75 02                	jne    80105e07 <sys_link+0xdc>
    goto bad;
80105e05:	eb 68                	jmp    80105e6f <sys_link+0x144>
  ilock(dp);
80105e07:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e0a:	89 04 24             	mov    %eax,(%esp)
80105e0d:	e8 56 ba ff ff       	call   80101868 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105e12:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e15:	8b 10                	mov    (%eax),%edx
80105e17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e1a:	8b 00                	mov    (%eax),%eax
80105e1c:	39 c2                	cmp    %eax,%edx
80105e1e:	75 20                	jne    80105e40 <sys_link+0x115>
80105e20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e23:	8b 40 04             	mov    0x4(%eax),%eax
80105e26:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e2a:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105e2d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e31:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e34:	89 04 24             	mov    %eax,(%esp)
80105e37:	e8 17 c3 ff ff       	call   80102153 <dirlink>
80105e3c:	85 c0                	test   %eax,%eax
80105e3e:	79 0d                	jns    80105e4d <sys_link+0x122>
    iunlockput(dp);
80105e40:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e43:	89 04 24             	mov    %eax,(%esp)
80105e46:	e8 a1 bc ff ff       	call   80101aec <iunlockput>
    goto bad;
80105e4b:	eb 22                	jmp    80105e6f <sys_link+0x144>
  }
  iunlockput(dp);
80105e4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e50:	89 04 24             	mov    %eax,(%esp)
80105e53:	e8 94 bc ff ff       	call   80101aec <iunlockput>
  iput(ip);
80105e58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e5b:	89 04 24             	mov    %eax,(%esp)
80105e5e:	e8 b8 bb ff ff       	call   80101a1b <iput>

  end_op();
80105e63:	e8 39 d6 ff ff       	call   801034a1 <end_op>

  return 0;
80105e68:	b8 00 00 00 00       	mov    $0x0,%eax
80105e6d:	eb 3c                	jmp    80105eab <sys_link+0x180>

bad:
  ilock(ip);
80105e6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e72:	89 04 24             	mov    %eax,(%esp)
80105e75:	e8 ee b9 ff ff       	call   80101868 <ilock>
  ip->nlink--;
80105e7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e7d:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105e81:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105eb3:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105eba:	eb 4b                	jmp    80105f07 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105ebc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ebf:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105ec6:	00 
80105ec7:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ecb:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105ece:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ed2:	8b 45 08             	mov    0x8(%ebp),%eax
80105ed5:	89 04 24             	mov    %eax,(%esp)
80105ed8:	e8 98 be ff ff       	call   80101d75 <readi>
80105edd:	83 f8 10             	cmp    $0x10,%eax
80105ee0:	74 0c                	je     80105eee <isdirempty+0x41>
      panic("isdirempty: readi");
80105ee2:	c7 04 24 36 8e 10 80 	movl   $0x80108e36,(%esp)
80105ee9:	e8 4c a6 ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105eee:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105ef2:	66 85 c0             	test   %ax,%ax
80105ef5:	74 07                	je     80105efe <isdirempty+0x51>
      return 0;
80105ef7:	b8 00 00 00 00       	mov    $0x0,%eax
80105efc:	eb 1b                	jmp    80105f19 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105f01:	83 c0 10             	add    $0x10,%eax
80105f04:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f07:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f0a:	8b 45 08             	mov    0x8(%ebp),%eax
80105f0d:	8b 40 18             	mov    0x18(%eax),%eax
80105f10:	39 c2                	cmp    %eax,%edx
80105f12:	72 a8                	jb     80105ebc <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80105f14:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105f19:	c9                   	leave  
80105f1a:	c3                   	ret    
...
80105f1e:	83 ec 48             	sub    $0x48,%esp
  ...
  if(argstr(0, &path) < 0)
80105f21:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105f24:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f28:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f2f:	e8 71 fa ff ff       	call   801059a5 <argstr>
80105f34:	85 c0                	test   %eax,%eax
80105f36:	79 0a                	jns    80105f42 <sys_unlink+0x27>
    return -1;
80105f38:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f3d:	e9 af 01 00 00       	jmp    801060f1 <sys_unlink+0x1d6>

  begin_op();
80105f42:	e8 d6 d4 ff ff       	call   8010341d <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105f47:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105f4a:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105f4d:	89 54 24 04          	mov    %edx,0x4(%esp)
80105f51:	89 04 24             	mov    %eax,(%esp)
80105f54:	e8 dc c4 ff ff       	call   80102435 <nameiparent>
80105f59:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f5c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f60:	75 0f                	jne    80105f71 <sys_unlink+0x56>
    end_op();
80105f62:	e8 3a d5 ff ff       	call   801034a1 <end_op>
    return -1;
80105f67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f6c:	e9 80 01 00 00       	jmp    801060f1 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105f71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f74:	89 04 24             	mov    %eax,(%esp)
80105f77:	e8 ec b8 ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105f7c:	c7 44 24 04 48 8e 10 	movl   $0x80108e48,0x4(%esp)
80105f83:	80 
80105f84:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f87:	89 04 24             	mov    %eax,(%esp)
80105f8a:	e8 d9 c0 ff ff       	call   80102068 <namecmp>
80105f8f:	85 c0                	test   %eax,%eax
80105f91:	0f 84 45 01 00 00    	je     801060dc <sys_unlink+0x1c1>
80105f97:	c7 44 24 04 4a 8e 10 	movl   $0x80108e4a,0x4(%esp)
80105f9e:	80 
80105f9f:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105fa2:	89 04 24             	mov    %eax,(%esp)
80105fa5:	e8 be c0 ff ff       	call   80102068 <namecmp>
80105faa:	85 c0                	test   %eax,%eax
80105fac:	0f 84 2a 01 00 00    	je     801060dc <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105fb2:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105fb5:	89 44 24 08          	mov    %eax,0x8(%esp)
80105fb9:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105fbc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fc3:	89 04 24             	mov    %eax,(%esp)
80105fc6:	e8 bf c0 ff ff       	call   8010208a <dirlookup>
80105fcb:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105fce:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105fd2:	75 05                	jne    80105fd9 <sys_unlink+0xbe>
    goto bad;
80105fd4:	e9 03 01 00 00       	jmp    801060dc <sys_unlink+0x1c1>
  ilock(ip);
...
80105feb:	66 85 c0             	test   %ax,%ax
80105fee:	7f 0c                	jg     80105ffc <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105ff0:	c7 04 24 4d 8e 10 80 	movl   $0x80108e4d,(%esp)
80105ff7:	e8 3e a5 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105ffc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fff:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106003:	66 83 f8 01          	cmp    $0x1,%ax
80106007:	75 1f                	jne    80106028 <sys_unlink+0x10d>
80106009:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010600c:	89 04 24             	mov    %eax,(%esp)
8010600f:	e8 99 fe ff ff       	call   80105ead <isdirempty>
80106014:	85 c0                	test   %eax,%eax
80106016:	75 10                	jne    80106028 <sys_unlink+0x10d>
    iunlockput(ip);
80106018:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010601b:	89 04 24             	mov    %eax,(%esp)
8010601e:	e8 c9 ba ff ff       	call   80101aec <iunlockput>
    goto bad;
80106023:	e9 b4 00 00 00       	jmp    801060dc <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80106028:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010602f:	00 
80106030:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106037:	00 
80106038:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010603b:	89 04 24             	mov    %eax,(%esp)
8010603e:	e8 90 f5 ff ff       	call   801055d3 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106043:	8b 45 c8             	mov    -0x38(%ebp),%eax
80106046:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010604d:	00 
8010604e:	89 44 24 08          	mov    %eax,0x8(%esp)
80106052:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106055:	89 44 24 04          	mov    %eax,0x4(%esp)
80106059:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010605c:	89 04 24             	mov    %eax,(%esp)
8010605f:	e8 75 be ff ff       	call   80101ed9 <writei>
80106064:	83 f8 10             	cmp    $0x10,%eax
80106067:	74 0c                	je     80106075 <sys_unlink+0x15a>
    panic("unlink: writei");
80106069:	c7 04 24 5f 8e 10 80 	movl   $0x80108e5f,(%esp)
80106070:	e8 c5 a4 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80106075:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106078:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010607c:	66 83 f8 01          	cmp    $0x1,%ax
80106080:	75 1c                	jne    8010609e <sys_unlink+0x183>
    dp->nlink--;
80106082:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106085:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106089:	8d 50 ff             	lea    -0x1(%eax),%edx
8010608c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010608f:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106093:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106096:	89 04 24             	mov    %eax,(%esp)
80106099:	e8 0e b6 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
8010609e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060a1:	89 04 24             	mov    %eax,(%esp)
801060a4:	e8 43 ba ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
801060a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060ac:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801060b0:	8d 50 ff             	lea    -0x1(%eax),%edx
...
801060c0:	e8 e7 b5 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
801060c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060c8:	89 04 24             	mov    %eax,(%esp)
801060cb:	e8 1c ba ff ff       	call   80101aec <iunlockput>

  end_op();
801060d0:	e8 cc d3 ff ff       	call   801034a1 <end_op>

  return 0;
801060d5:	b8 00 00 00 00       	mov    $0x0,%eax
801060da:	eb 15                	jmp    801060f1 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
801060dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060df:	89 04 24             	mov    %eax,(%esp)
801060e2:	e8 05 ba ff ff       	call   80101aec <iunlockput>
  end_op();
801060e7:	e8 b5 d3 ff ff       	call   801034a1 <end_op>
  return -1;
...
801060f6:	83 ec 48             	sub    $0x48,%esp
801060f9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801060fc:	8b 55 10             	mov    0x10(%ebp),%edx
801060ff:	8b 45 14             	mov    0x14(%ebp),%eax
80106102:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106106:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
8010610a:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010610e:	8d 45 de             	lea    -0x22(%ebp),%eax
80106111:	89 44 24 04          	mov    %eax,0x4(%esp)
80106115:	8b 45 08             	mov    0x8(%ebp),%eax
80106118:	89 04 24             	mov    %eax,(%esp)
8010611b:	e8 15 c3 ff ff       	call   80102435 <nameiparent>
80106120:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106123:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106127:	75 0a                	jne    80106133 <create+0x40>
    return 0;
80106129:	b8 00 00 00 00       	mov    $0x0,%eax
8010612e:	e9 7e 01 00 00       	jmp    801062b1 <create+0x1be>
  ilock(dp);
80106133:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106136:	89 04 24             	mov    %eax,(%esp)
80106139:	e8 2a b7 ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
8010613e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106141:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80106152:	e8 33 bf ff ff       	call   8010208a <dirlookup>
80106157:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010615a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010615e:	74 47                	je     801061a7 <create+0xb4>
    iunlockput(dp);
80106160:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106163:	89 04 24             	mov    %eax,(%esp)
80106166:	e8 81 b9 ff ff       	call   80101aec <iunlockput>
    ilock(ip);
8010616b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010616e:	89 04 24             	mov    %eax,(%esp)
80106171:	e8 f2 b6 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106176:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
8010617b:	75 15                	jne    80106192 <create+0x9f>
8010617d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106180:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106184:	66 83 f8 02          	cmp    $0x2,%ax
80106188:	75 08                	jne    80106192 <create+0x9f>
      return ip;
8010618a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010618d:	e9 1f 01 00 00       	jmp    801062b1 <create+0x1be>
    iunlockput(ip);
80106192:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106195:	89 04 24             	mov    %eax,(%esp)
80106198:	e8 4f b9 ff ff       	call   80101aec <iunlockput>
    return 0;
8010619d:	b8 00 00 00 00       	mov    $0x0,%eax
801061a2:	e9 0a 01 00 00       	jmp    801062b1 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
801061a7:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
801061ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ae:	8b 00                	mov    (%eax),%eax
801061b0:	89 54 24 04          	mov    %edx,0x4(%esp)
801061b4:	89 04 24             	mov    %eax,(%esp)
801061b7:	e8 11 b4 ff ff       	call   801015cd <ialloc>
801061bc:	89 45 f0             	mov    %eax,-0x10(%ebp)
801061bf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801061c3:	75 0c                	jne    801061d1 <create+0xde>
    panic("create: ialloc");
801061c5:	c7 04 24 6e 8e 10 80 	movl   $0x80108e6e,(%esp)
801061cc:	e8 69 a3 ff ff       	call   8010053a <panic>

  ilock(ip);
801061d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061d4:	89 04 24             	mov    %eax,(%esp)
801061d7:	e8 8c b6 ff ff       	call   80101868 <ilock>
  ip->major = major;
801061dc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061df:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
801061e3:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
801061e7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061ea:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
801061ee:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
801061f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061f5:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
801061fb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061fe:	89 04 24             	mov    %eax,(%esp)
80106201:	e8 a6 b4 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106206:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010620b:	75 6a                	jne    80106277 <create+0x184>
    dp->nlink++;  // for ".."
8010620d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106210:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106214:	8d 50 01             	lea    0x1(%eax),%edx
80106217:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010621a:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
8010621e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106221:	89 04 24             	mov    %eax,(%esp)
80106224:	e8 83 b4 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106229:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010622c:	8b 40 04             	mov    0x4(%eax),%eax
8010622f:	89 44 24 08          	mov    %eax,0x8(%esp)
80106233:	c7 44 24 04 48 8e 10 	movl   $0x80108e48,0x4(%esp)
8010623a:	80 
8010623b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010623e:	89 04 24             	mov    %eax,(%esp)
80106241:	e8 0d bf ff ff       	call   80102153 <dirlink>
80106246:	85 c0                	test   %eax,%eax
80106248:	78 21                	js     8010626b <create+0x178>
8010624a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010624d:	8b 40 04             	mov    0x4(%eax),%eax
80106250:	89 44 24 08          	mov    %eax,0x8(%esp)
80106254:	c7 44 24 04 4a 8e 10 	movl   $0x80108e4a,0x4(%esp)
8010625b:	80 
8010625c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010625f:	89 04 24             	mov    %eax,(%esp)
80106262:	e8 ec be ff ff       	call   80102153 <dirlink>
80106267:	85 c0                	test   %eax,%eax
80106269:	79 0c                	jns    80106277 <create+0x184>
      panic("create dots");
8010626b:	c7 04 24 7d 8e 10 80 	movl   $0x80108e7d,(%esp)
80106272:	e8 c3 a2 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80106277:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010627a:	8b 40 04             	mov    0x4(%eax),%eax
8010627d:	89 44 24 08          	mov    %eax,0x8(%esp)
80106281:	8d 45 de             	lea    -0x22(%ebp),%eax
80106284:	89 44 24 04          	mov    %eax,0x4(%esp)
80106288:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010628b:	89 04 24             	mov    %eax,(%esp)
8010628e:	e8 c0 be ff ff       	call   80102153 <dirlink>
80106293:	85 c0                	test   %eax,%eax
80106295:	79 0c                	jns    801062a3 <create+0x1b0>
    panic("create: dirlink");
80106297:	c7 04 24 89 8e 10 80 	movl   $0x80108e89,(%esp)
8010629e:	e8 97 a2 ff ff       	call   8010053a <panic>

  iunlockput(dp);
801062a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062a6:	89 04 24             	mov    %eax,(%esp)
801062a9:	e8 3e b8 ff ff       	call   80101aec <iunlockput>
...
801062b6:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
801062c7:	e8 d9 f6 ff ff       	call   801059a5 <argstr>
801062cc:	85 c0                	test   %eax,%eax
801062ce:	78 17                	js     801062e7 <sys_open+0x34>
801062d0:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801062d3:	89 44 24 04          	mov    %eax,0x4(%esp)
801062d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801062de:	e8 32 f6 ff ff       	call   80105915 <argint>
801062e3:	85 c0                	test   %eax,%eax
801062e5:	79 0a                	jns    801062f1 <sys_open+0x3e>
    return -1;
801062e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062ec:	e9 5c 01 00 00       	jmp    8010644d <sys_open+0x19a>

  begin_op();
801062f1:	e8 27 d1 ff ff       	call   8010341d <begin_op>

  if(omode & O_CREATE){
801062f6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062f9:	25 00 02 00 00       	and    $0x200,%eax
801062fe:	85 c0                	test   %eax,%eax
80106300:	74 3b                	je     8010633d <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80106302:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106305:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010630c:	00 
8010630d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106314:	00 
80106315:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010631c:	00 
8010631d:	89 04 24             	mov    %eax,(%esp)
80106320:	e8 ce fd ff ff       	call   801060f3 <create>
80106325:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80106328:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010632c:	75 6b                	jne    80106399 <sys_open+0xe6>
      end_op();
8010632e:	e8 6e d1 ff ff       	call   801034a1 <end_op>
      return -1;
80106333:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106338:	e9 10 01 00 00       	jmp    8010644d <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
8010633d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106340:	89 04 24             	mov    %eax,(%esp)
80106343:	e8 cb c0 ff ff       	call   80102413 <namei>
80106348:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010634b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010634f:	75 0f                	jne    80106360 <sys_open+0xad>
      end_op();
80106351:	e8 4b d1 ff ff       	call   801034a1 <end_op>
      return -1;
80106356:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010635b:	e9 ed 00 00 00       	jmp    8010644d <sys_open+0x19a>
    }
    ilock(ip);
80106360:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106363:	89 04 24             	mov    %eax,(%esp)
80106366:	e8 fd b4 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010636b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010636e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106372:	66 83 f8 01          	cmp    $0x1,%ax
80106376:	75 21                	jne    80106399 <sys_open+0xe6>
80106378:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010637b:	85 c0                	test   %eax,%eax
8010637d:	74 1a                	je     80106399 <sys_open+0xe6>
      iunlockput(ip);
8010637f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106382:	89 04 24             	mov    %eax,(%esp)
80106385:	e8 62 b7 ff ff       	call   80101aec <iunlockput>
      end_op();
8010638a:	e8 12 d1 ff ff       	call   801034a1 <end_op>
      return -1;
8010638f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106394:	e9 b4 00 00 00       	jmp    8010644d <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106399:	e8 95 ab ff ff       	call   80100f33 <filealloc>
8010639e:	89 45 f0             	mov    %eax,-0x10(%ebp)
801063a1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801063a5:	74 14                	je     801063bb <sys_open+0x108>
801063a7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063aa:	89 04 24             	mov    %eax,(%esp)
801063ad:	e8 2e f7 ff ff       	call   80105ae0 <fdalloc>
801063b2:	89 45 ec             	mov    %eax,-0x14(%ebp)
801063b5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801063b9:	79 28                	jns    801063e3 <sys_open+0x130>
    if(f)
801063bb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801063bf:	74 0b                	je     801063cc <sys_open+0x119>
      fileclose(f);
801063c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063c4:	89 04 24             	mov    %eax,(%esp)
801063c7:	e8 0f ac ff ff       	call   80100fdb <fileclose>
    iunlockput(ip);
801063cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063cf:	89 04 24             	mov    %eax,(%esp)
801063d2:	e8 15 b7 ff ff       	call   80101aec <iunlockput>
    end_op();
801063d7:	e8 c5 d0 ff ff       	call   801034a1 <end_op>
    return -1;
801063dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063e1:	eb 6a                	jmp    8010644d <sys_open+0x19a>
  }
  iunlock(ip);
801063e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063e6:	89 04 24             	mov    %eax,(%esp)
801063e9:	e8 c8 b5 ff ff       	call   801019b6 <iunlock>
  end_op();
801063ee:	e8 ae d0 ff ff       	call   801034a1 <end_op>

  f->type = FD_INODE;
801063f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063f6:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
801063fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063ff:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106402:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106405:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106408:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
8010640f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106412:	83 e0 01             	and    $0x1,%eax
80106415:	85 c0                	test   %eax,%eax
80106417:	0f 94 c0             	sete   %al
8010641a:	89 c2                	mov    %eax,%edx
8010641c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010641f:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106422:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106425:	83 e0 01             	and    $0x1,%eax
80106428:	85 c0                	test   %eax,%eax
8010642a:	75 0a                	jne    80106436 <sys_open+0x183>
8010642c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010642f:	83 e0 02             	and    $0x2,%eax
80106432:	85 c0                	test   %eax,%eax
80106434:	74 07                	je     8010643d <sys_open+0x18a>
80106436:	b8 01 00 00 00       	mov    $0x1,%eax
8010643b:	eb 05                	jmp    80106442 <sys_open+0x18f>
8010643d:	b8 00 00 00 00       	mov    $0x0,%eax
80106442:	89 c2                	mov    %eax,%edx
80106444:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106447:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80106452:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106455:	e8 c3 cf ff ff       	call   8010341d <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010645a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010645d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106461:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106468:	e8 38 f5 ff ff       	call   801059a5 <argstr>
8010646d:	85 c0                	test   %eax,%eax
8010646f:	78 2c                	js     8010649d <sys_mkdir+0x4e>
80106471:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106474:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010647b:	00 
8010647c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106483:	00 
80106484:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010648b:	00 
8010648c:	89 04 24             	mov    %eax,(%esp)
8010648f:	e8 5f fc ff ff       	call   801060f3 <create>
80106494:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106497:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010649b:	75 0c                	jne    801064a9 <sys_mkdir+0x5a>
    end_op();
8010649d:	e8 ff cf ff ff       	call   801034a1 <end_op>
    return -1;
801064a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064a7:	eb 15                	jmp    801064be <sys_mkdir+0x6f>
  }
  iunlockput(ip);
...
801064c3:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
80106513:	78 30                	js     80106545 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106515:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106518:	0f bf c8             	movswl %ax,%ecx
8010651b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010651e:	0f bf d0             	movswl %ax,%edx
80106521:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106524:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106528:	89 54 24 08          	mov    %edx,0x8(%esp)
8010652c:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106533:	00 
80106534:	89 04 24             	mov    %eax,(%esp)
80106537:	e8 b7 fb ff ff       	call   801060f3 <create>
8010653c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010653f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106543:	75 0c                	jne    80106551 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80106545:	e8 57 cf ff ff       	call   801034a1 <end_op>
    return -1;
8010654a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010654f:	eb 15                	jmp    80106566 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106551:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106554:	89 04 24             	mov    %eax,(%esp)
80106557:	e8 90 b5 ff ff       	call   80101aec <iunlockput>
  end_op();
8010655c:	e8 40 cf ff ff       	call   801034a1 <end_op>
  return 0;
...
8010656b:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
8010656e:	e8 aa ce ff ff       	call   8010341d <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106573:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106576:	89 44 24 04          	mov    %eax,0x4(%esp)
8010657a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106581:	e8 1f f4 ff ff       	call   801059a5 <argstr>
80106586:	85 c0                	test   %eax,%eax
80106588:	78 14                	js     8010659e <sys_chdir+0x36>
8010658a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010658d:	89 04 24             	mov    %eax,(%esp)
80106590:	e8 7e be ff ff       	call   80102413 <namei>
80106595:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106598:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010659c:	75 0c                	jne    801065aa <sys_chdir+0x42>
    end_op();
8010659e:	e8 fe ce ff ff       	call   801034a1 <end_op>
    return -1;
801065a3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065a8:	eb 61                	jmp    8010660b <sys_chdir+0xa3>
  }
  ilock(ip);
801065aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065ad:	89 04 24             	mov    %eax,(%esp)
801065b0:	e8 b3 b2 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
801065b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065b8:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801065bc:	66 83 f8 01          	cmp    $0x1,%ax
801065c0:	74 17                	je     801065d9 <sys_chdir+0x71>
    iunlockput(ip);
801065c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c5:	89 04 24             	mov    %eax,(%esp)
801065c8:	e8 1f b5 ff ff       	call   80101aec <iunlockput>
    end_op();
801065cd:	e8 cf ce ff ff       	call   801034a1 <end_op>
    return -1;
801065d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065d7:	eb 32                	jmp    8010660b <sys_chdir+0xa3>
  }
  iunlock(ip);
801065d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065dc:	89 04 24             	mov    %eax,(%esp)
801065df:	e8 d2 b3 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
801065e4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065ea:	8b 40 68             	mov    0x68(%eax),%eax
801065ed:	89 04 24             	mov    %eax,(%esp)
801065f0:	e8 26 b4 ff ff       	call   80101a1b <iput>
  end_op();
801065f5:	e8 a7 ce ff ff       	call   801034a1 <end_op>
  proc->cwd = ip;
801065fa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106600:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106603:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106610:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106624:	e8 7c f3 ff ff       	call   801059a5 <argstr>
80106629:	85 c0                	test   %eax,%eax
8010662b:	78 1a                	js     80106647 <sys_exec+0x3a>
8010662d:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106633:	89 44 24 04          	mov    %eax,0x4(%esp)
80106637:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010663e:	e8 d2 f2 ff ff       	call   80105915 <argint>
80106643:	85 c0                	test   %eax,%eax
80106645:	79 0a                	jns    80106651 <sys_exec+0x44>
    return -1;
80106647:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010664c:	e9 c8 00 00 00       	jmp    80106719 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
80106651:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106658:	00 
80106659:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106660:	00 
80106661:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106667:	89 04 24             	mov    %eax,(%esp)
8010666a:	e8 64 ef ff ff       	call   801055d3 <memset>
  for(i=0;; i++){
8010666f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106676:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106679:	83 f8 1f             	cmp    $0x1f,%eax
8010667c:	76 0a                	jbe    80106688 <sys_exec+0x7b>
      return -1;
8010667e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106683:	e9 91 00 00 00       	jmp    80106719 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106688:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010668b:	c1 e0 02             	shl    $0x2,%eax
8010668e:	89 c2                	mov    %eax,%edx
80106690:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106696:	01 c2                	add    %eax,%edx
80106698:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010669e:	89 44 24 04          	mov    %eax,0x4(%esp)
801066a2:	89 14 24             	mov    %edx,(%esp)
801066a5:	e8 cf f1 ff ff       	call   80105879 <fetchint>
801066aa:	85 c0                	test   %eax,%eax
801066ac:	79 07                	jns    801066b5 <sys_exec+0xa8>
      return -1;
801066ae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b3:	eb 64                	jmp    80106719 <sys_exec+0x10c>
    if(uarg == 0){
801066b5:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801066bb:	85 c0                	test   %eax,%eax
801066bd:	75 26                	jne    801066e5 <sys_exec+0xd8>
      argv[i] = 0;
801066bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066c2:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801066c9:	00 00 00 00 
      break;
801066cd:	90                   	nop
    }
...
801066d1:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801066d7:	89 54 24 04          	mov    %edx,0x4(%esp)
801066db:	89 04 24             	mov    %eax,(%esp)
801066de:	e8 0c a4 ff ff       	call   80100aef <exec>
801066e3:	eb 34                	jmp    80106719 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106700:	e8 ae f1 ff ff       	call   801058b3 <fetchstr>
80106705:	85 c0                	test   %eax,%eax
80106707:	79 07                	jns    80106710 <sys_exec+0x103>
      return -1;
80106709:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010670e:	eb 09                	jmp    80106719 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106710:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80106714:	e9 5d ff ff ff       	jmp    80106676 <sys_exec+0x69>
  return exec(path, argv);
}
80106719:	c9                   	leave  
8010671a:	c3                   	ret    
...
8010671e:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106721:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106728:	00 
80106729:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010672c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106730:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106737:	e8 07 f2 ff ff       	call   80105943 <argptr>
8010673c:	85 c0                	test   %eax,%eax
8010673e:	79 0a                	jns    8010674a <sys_pipe+0x2f>
    return -1;
80106740:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106745:	e9 9b 00 00 00       	jmp    801067e5 <sys_pipe+0xca>
...
80106757:	e8 d2 d7 ff ff       	call   80103f2e <pipealloc>
8010675c:	85 c0                	test   %eax,%eax
8010675e:	79 07                	jns    80106767 <sys_pipe+0x4c>
    return -1;
80106760:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106765:	eb 7e                	jmp    801067e5 <sys_pipe+0xca>
  fd0 = -1;
80106767:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010676e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106771:	89 04 24             	mov    %eax,(%esp)
80106774:	e8 67 f3 ff ff       	call   80105ae0 <fdalloc>
80106779:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010677c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106780:	78 14                	js     80106796 <sys_pipe+0x7b>
80106782:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106785:	89 04 24             	mov    %eax,(%esp)
80106788:	e8 53 f3 ff ff       	call   80105ae0 <fdalloc>
8010678d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106790:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106794:	79 37                	jns    801067cd <sys_pipe+0xb2>
    if(fd0 >= 0)
80106796:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010679a:	78 14                	js     801067b0 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010679c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067a2:	8b 55 f4             	mov    -0xc(%ebp),%edx
801067a5:	83 c2 08             	add    $0x8,%edx
801067a8:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801067af:	00 
    fileclose(rf);
801067b0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801067b3:	89 04 24             	mov    %eax,(%esp)
801067b6:	e8 20 a8 ff ff       	call   80100fdb <fileclose>
    fileclose(wf);
801067bb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801067be:	89 04 24             	mov    %eax,(%esp)
801067c1:	e8 15 a8 ff ff       	call   80100fdb <fileclose>
    return -1;
801067c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067cb:	eb 18                	jmp    801067e5 <sys_pipe+0xca>
  }
  fd[0] = fd0;
801067cd:	8b 45 ec             	mov    -0x14(%ebp),%eax
801067d0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801067d3:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
801067d5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801067d8:	8d 50 04             	lea    0x4(%eax),%edx
801067db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801067de:	89 02                	mov    %eax,(%edx)
  return 0;
...
801067ea:	83 ec 08             	sub    $0x8,%esp
  return fork();
801067ed:	e8 88 de ff ff       	call   8010467a <fork>
}
801067f2:	c9                   	leave  
801067f3:	c3                   	ret    
...
801067f7:	83 ec 08             	sub    $0x8,%esp
  exit();
801067fa:	e8 05 e0 ff ff       	call   80104804 <exit>
...
80106809:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010680c:	e8 18 e1 ff ff       	call   80104929 <wait>
}
80106811:	c9                   	leave  
80106812:	c3                   	ret    
...
80106827:	e8 e9 f0 ff ff       	call   80105915 <argint>
8010682c:	85 c0                	test   %eax,%eax
8010682e:	79 07                	jns    80106837 <sys_kill+0x24>
    return -1;
80106830:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106835:	eb 0b                	jmp    80106842 <sys_kill+0x2f>
  return kill(pid);
80106837:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010683a:	89 04 24             	mov    %eax,(%esp)
8010683d:	e8 2c e5 ff ff       	call   80104d6e <kill>
}
80106842:	c9                   	leave  
80106843:	c3                   	ret    
...
80106855:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
80106866:	e8 aa f0 ff ff       	call   80105915 <argint>
8010686b:	85 c0                	test   %eax,%eax
8010686d:	79 07                	jns    80106876 <sys_sbrk+0x24>
    return -1;
8010686f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106874:	eb 24                	jmp    8010689a <sys_sbrk+0x48>
  addr = proc->sz;
...
80106887:	e8 49 dd ff ff       	call   801045d5 <growproc>
8010688c:	85 c0                	test   %eax,%eax
8010688e:	79 07                	jns    80106897 <sys_sbrk+0x45>
    return -1;
80106890:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106895:	eb 03                	jmp    8010689a <sys_sbrk+0x48>
  return addr;
...
8010689f:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
...
801068a9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068b0:	e8 60 f0 ff ff       	call   80105915 <argint>
801068b5:	85 c0                	test   %eax,%eax
801068b7:	79 07                	jns    801068c0 <sys_sleep+0x24>
    return -1;
801068b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068be:	eb 6c                	jmp    8010692c <sys_sleep+0x90>
  acquire(&tickslock);
801068c0:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
801068c7:	e8 b3 ea ff ff       	call   8010537f <acquire>
  ticks0 = ticks;
801068cc:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
801068d1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801068d4:	eb 34                	jmp    8010690a <sys_sleep+0x6e>
    if(proc->killed){
801068d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068dc:	8b 40 24             	mov    0x24(%eax),%eax
801068df:	85 c0                	test   %eax,%eax
801068e1:	74 13                	je     801068f6 <sys_sleep+0x5a>
      release(&tickslock);
801068e3:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
801068ea:	e8 f2 ea ff ff       	call   801053e1 <release>
      return -1;
801068ef:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068f4:	eb 36                	jmp    8010692c <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801068f6:	c7 44 24 04 c0 a1 11 	movl   $0x8011a1c0,0x4(%esp)
801068fd:	80 
801068fe:	c7 04 24 00 aa 11 80 	movl   $0x8011aa00,(%esp)
80106905:	e8 5e e3 ff ff       	call   80104c68 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010690a:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
8010690f:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106912:	89 c2                	mov    %eax,%edx
80106914:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106917:	39 c2                	cmp    %eax,%edx
80106919:	72 bb                	jb     801068d6 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010691b:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106922:	e8 ba ea ff ff       	call   801053e1 <release>
  return 0;
...
80106931:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
80106934:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
8010693b:	e8 3f ea ff ff       	call   8010537f <acquire>
  xticks = ticks;
80106940:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106945:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106948:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
8010694f:	e8 8d ea ff ff       	call   801053e1 <release>
  return xticks;
...
80106995:	83 ec 28             	sub    $0x28,%esp
  int dest_pid;
  int value;

  if(argint(0, &dest_pid) < 0 || argint(1, &value) < 0)
80106998:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010699b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010699f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069a6:	e8 6a ef ff ff       	call   80105915 <argint>
801069ab:	85 c0                	test   %eax,%eax
801069ad:	78 17                	js     801069c6 <sys_sigsend+0x34>
801069af:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069b2:	89 44 24 04          	mov    %eax,0x4(%esp)
801069b6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801069bd:	e8 53 ef ff ff       	call   80105915 <argint>
801069c2:	85 c0                	test   %eax,%eax
801069c4:	79 07                	jns    801069cd <sys_sigsend+0x3b>
    return -1;
801069c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069cb:	eb 12                	jmp    801069df <sys_sigsend+0x4d>
...
801069da:	e8 62 e5 ff ff       	call   80104f41 <sigsend>
}
801069df:	c9                   	leave  
801069e0:	c3                   	ret    
...
801069e4:	83 ec 08             	sub    $0x8,%esp
  return sigret();
801069e7:	e8 cd e5 ff ff       	call   80104fb9 <sigret>
}
801069ec:	c9                   	leave  
801069ed:	c3                   	ret    

801069ee <sys_sigpause>:
...
801069f1:	83 ec 08             	sub    $0x8,%esp
  return sigpause();
801069f4:	e8 15 e6 ff ff       	call   8010500e <sigpause>
}
801069f9:	c9                   	leave  
801069fa:	c3                   	ret    
...
801069fe:	83 ec 08             	sub    $0x8,%esp
80106a01:	8b 55 08             	mov    0x8(%ebp),%edx
80106a04:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a07:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106a0b:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106a0e:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106a12:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106a1f:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106a26:	00 
80106a27:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106a2e:	e8 c8 ff ff ff       	call   801069fb <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106a33:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106a3a:	00 
80106a3b:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106a42:	e8 b4 ff ff ff       	call   801069fb <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106a47:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106a4e:	00 
80106a4f:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106a56:	e8 a0 ff ff ff       	call   801069fb <outb>
  picenable(IRQ_TIMER);
80106a5b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a62:	e8 5a d3 ff ff       	call   80103dc1 <picenable>
}
80106a67:	c9                   	leave  
80106a68:	c3                   	ret    
...
80106a6a:	06                   	push   %es
  pushl %fs
80106a6b:	0f a0                	push   %fs
  pushl %gs
80106a6d:	0f a8                	push   %gs
  pushal
80106a6f:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106a70:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106a74:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106a76:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106a78:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106a7c:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106a7e:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106a80:	54                   	push   %esp
  call trap
80106a81:	e8 e1 01 00 00       	call   80106c67 <trap>
  addl $4, %esp
80106a86:	83 c4 04             	add    $0x4,%esp
...
80106a89:	54                   	push   %esp
  call fix_tf
80106a8a:	e8 f0 e6 ff ff       	call   8010517f <fix_tf>
  addl $4, %esp
...
80106ac9:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106acc:	0f 20 d0             	mov    %cr2,%eax
80106acf:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
...
80106ada:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
80106add:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106ae4:	e9 c3 00 00 00       	jmp    80106bac <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106ae9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aec:	8b 04 85 a8 c0 10 80 	mov    -0x7fef3f58(,%eax,4),%eax
80106af3:	89 c2                	mov    %eax,%edx
80106af5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106af8:	66 89 14 c5 00 a2 11 	mov    %dx,-0x7fee5e00(,%eax,8)
80106aff:	80 
80106b00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b03:	66 c7 04 c5 02 a2 11 	movw   $0x8,-0x7fee5dfe(,%eax,8)
80106b0a:	80 08 00 
80106b0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b10:	0f b6 14 c5 04 a2 11 	movzbl -0x7fee5dfc(,%eax,8),%edx
80106b17:	80 
80106b18:	83 e2 e0             	and    $0xffffffe0,%edx
80106b1b:	88 14 c5 04 a2 11 80 	mov    %dl,-0x7fee5dfc(,%eax,8)
80106b22:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b25:	0f b6 14 c5 04 a2 11 	movzbl -0x7fee5dfc(,%eax,8),%edx
80106b2c:	80 
80106b2d:	83 e2 1f             	and    $0x1f,%edx
80106b30:	88 14 c5 04 a2 11 80 	mov    %dl,-0x7fee5dfc(,%eax,8)
80106b37:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b3a:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106b41:	80 
80106b42:	83 e2 f0             	and    $0xfffffff0,%edx
80106b45:	83 ca 0e             	or     $0xe,%edx
80106b48:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106b4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b52:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106b59:	80 
80106b5a:	83 e2 ef             	and    $0xffffffef,%edx
80106b5d:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106b64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b67:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106b6e:	80 
80106b6f:	83 e2 9f             	and    $0xffffff9f,%edx
80106b72:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106b79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b7c:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106b83:	80 
80106b84:	83 ca 80             	or     $0xffffff80,%edx
80106b87:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106b8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b91:	8b 04 85 a8 c0 10 80 	mov    -0x7fef3f58(,%eax,4),%eax
80106b98:	c1 e8 10             	shr    $0x10,%eax
80106b9b:	89 c2                	mov    %eax,%edx
80106b9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ba0:	66 89 14 c5 06 a2 11 	mov    %dx,-0x7fee5dfa(,%eax,8)
80106ba7:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106ba8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106bac:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106bb3:	0f 8e 30 ff ff ff    	jle    80106ae9 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106bb9:	a1 a8 c1 10 80       	mov    0x8010c1a8,%eax
80106bbe:	66 a3 00 a4 11 80    	mov    %ax,0x8011a400
80106bc4:	66 c7 05 02 a4 11 80 	movw   $0x8,0x8011a402
80106bcb:	08 00 
80106bcd:	0f b6 05 04 a4 11 80 	movzbl 0x8011a404,%eax
80106bd4:	83 e0 e0             	and    $0xffffffe0,%eax
80106bd7:	a2 04 a4 11 80       	mov    %al,0x8011a404
80106bdc:	0f b6 05 04 a4 11 80 	movzbl 0x8011a404,%eax
80106be3:	83 e0 1f             	and    $0x1f,%eax
80106be6:	a2 04 a4 11 80       	mov    %al,0x8011a404
80106beb:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106bf2:	83 c8 0f             	or     $0xf,%eax
80106bf5:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106bfa:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106c01:	83 e0 ef             	and    $0xffffffef,%eax
80106c04:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106c09:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106c10:	83 c8 60             	or     $0x60,%eax
80106c13:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106c18:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106c1f:	83 c8 80             	or     $0xffffff80,%eax
80106c22:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106c27:	a1 a8 c1 10 80       	mov    0x8010c1a8,%eax
80106c2c:	c1 e8 10             	shr    $0x10,%eax
80106c2f:	66 a3 06 a4 11 80    	mov    %ax,0x8011a406
  
  initlock(&tickslock, "time");
80106c35:	c7 44 24 04 9c 8e 10 	movl   $0x80108e9c,0x4(%esp)
80106c3c:	80 
80106c3d:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106c44:	e8 15 e7 ff ff       	call   8010535e <initlock>
}
80106c49:	c9                   	leave  
80106c4a:	c3                   	ret    
...
80106c4e:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106c51:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106c58:	00 
80106c59:	c7 04 24 00 a2 11 80 	movl   $0x8011a200,(%esp)
80106c60:	e8 38 fe ff ff       	call   80106a9d <lidt>
}
80106c65:	c9                   	leave  
80106c66:	c3                   	ret    
...
80106c6d:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106c70:	8b 45 08             	mov    0x8(%ebp),%eax
80106c73:	8b 40 30             	mov    0x30(%eax),%eax
80106c76:	83 f8 40             	cmp    $0x40,%eax
80106c79:	75 3f                	jne    80106cba <trap+0x53>
    if(proc->killed)
80106c7b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c81:	8b 40 24             	mov    0x24(%eax),%eax
80106c84:	85 c0                	test   %eax,%eax
80106c86:	74 05                	je     80106c8d <trap+0x26>
      exit();
80106c88:	e8 77 db ff ff       	call   80104804 <exit>
    proc->tf = tf;
80106c8d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c93:	8b 55 08             	mov    0x8(%ebp),%edx
80106c96:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106c99:	e8 3e ed ff ff       	call   801059dc <syscall>
    if(proc->killed)
80106c9e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ca4:	8b 40 24             	mov    0x24(%eax),%eax
80106ca7:	85 c0                	test   %eax,%eax
80106ca9:	74 0a                	je     80106cb5 <trap+0x4e>
      exit();
80106cab:	e8 54 db ff ff       	call   80104804 <exit>
    return;
80106cb0:	e9 2d 02 00 00       	jmp    80106ee2 <trap+0x27b>
80106cb5:	e9 28 02 00 00       	jmp    80106ee2 <trap+0x27b>
  }

  switch(tf->trapno){
80106cba:	8b 45 08             	mov    0x8(%ebp),%eax
80106cbd:	8b 40 30             	mov    0x30(%eax),%eax
80106cc0:	83 e8 20             	sub    $0x20,%eax
80106cc3:	83 f8 1f             	cmp    $0x1f,%eax
80106cc6:	0f 87 bc 00 00 00    	ja     80106d88 <trap+0x121>
80106ccc:	8b 04 85 44 8f 10 80 	mov    -0x7fef70bc(,%eax,4),%eax
80106cd3:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106cd5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106cdb:	0f b6 00             	movzbl (%eax),%eax
80106cde:	84 c0                	test   %al,%al
80106ce0:	75 31                	jne    80106d13 <trap+0xac>
      acquire(&tickslock);
80106ce2:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106ce9:	e8 91 e6 ff ff       	call   8010537f <acquire>
      ticks++;
80106cee:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106cf3:	83 c0 01             	add    $0x1,%eax
80106cf6:	a3 00 aa 11 80       	mov    %eax,0x8011aa00
      wakeup(&ticks);
80106cfb:	c7 04 24 00 aa 11 80 	movl   $0x8011aa00,(%esp)
80106d02:	e8 3c e0 ff ff       	call   80104d43 <wakeup>
      release(&tickslock);
80106d07:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106d0e:	e8 ce e6 ff ff       	call   801053e1 <release>
    }
    lapiceoi();
80106d13:	e8 c5 c1 ff ff       	call   80102edd <lapiceoi>
    break;
80106d18:	e9 41 01 00 00       	jmp    80106e5e <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106d1d:	e8 c9 b9 ff ff       	call   801026eb <ideintr>
    lapiceoi();
80106d22:	e8 b6 c1 ff ff       	call   80102edd <lapiceoi>
    break;
80106d27:	e9 32 01 00 00       	jmp    80106e5e <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106d2c:	e8 7b bf ff ff       	call   80102cac <kbdintr>
    lapiceoi();
80106d31:	e8 a7 c1 ff ff       	call   80102edd <lapiceoi>
    break;
80106d36:	e9 23 01 00 00       	jmp    80106e5e <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106d3b:	e8 97 03 00 00       	call   801070d7 <uartintr>
    lapiceoi();
80106d40:	e8 98 c1 ff ff       	call   80102edd <lapiceoi>
    break;
80106d45:	e9 14 01 00 00       	jmp    80106e5e <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d4a:	8b 45 08             	mov    0x8(%ebp),%eax
80106d4d:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106d50:	8b 45 08             	mov    0x8(%ebp),%eax
80106d53:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d57:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106d5a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d60:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80106d66:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106d6a:	89 54 24 08          	mov    %edx,0x8(%esp)
80106d6e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d72:	c7 04 24 a4 8e 10 80 	movl   $0x80108ea4,(%esp)
80106d79:	e8 22 96 ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106d7e:	e8 5a c1 ff ff       	call   80102edd <lapiceoi>
    break;
80106d83:	e9 d6 00 00 00       	jmp    80106e5e <trap+0x1f7>
...
80106d90:	74 11                	je     80106da3 <trap+0x13c>
80106d92:	8b 45 08             	mov    0x8(%ebp),%eax
80106d95:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106d99:	0f b7 c0             	movzwl %ax,%eax
80106d9c:	83 e0 03             	and    $0x3,%eax
80106d9f:	85 c0                	test   %eax,%eax
80106da1:	75 46                	jne    80106de9 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106da3:	e8 1e fd ff ff       	call   80106ac6 <rcr2>
80106da8:	8b 55 08             	mov    0x8(%ebp),%edx
80106dab:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106dae:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106db5:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106db8:	0f b6 ca             	movzbl %dl,%ecx
80106dbb:	8b 55 08             	mov    0x8(%ebp),%edx
80106dbe:	8b 52 30             	mov    0x30(%edx),%edx
80106dc1:	89 44 24 10          	mov    %eax,0x10(%esp)
80106dc5:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106dc9:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106dcd:	89 54 24 04          	mov    %edx,0x4(%esp)
80106dd1:	c7 04 24 c8 8e 10 80 	movl   $0x80108ec8,(%esp)
80106dd8:	e8 c3 95 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106ddd:	c7 04 24 fa 8e 10 80 	movl   $0x80108efa,(%esp)
80106de4:	e8 51 97 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106de9:	e8 d8 fc ff ff       	call   80106ac6 <rcr2>
80106dee:	89 c2                	mov    %eax,%edx
80106df0:	8b 45 08             	mov    0x8(%ebp),%eax
80106df3:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106df6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106dfc:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106dff:	0f b6 f0             	movzbl %al,%esi
80106e02:	8b 45 08             	mov    0x8(%ebp),%eax
80106e05:	8b 58 34             	mov    0x34(%eax),%ebx
80106e08:	8b 45 08             	mov    0x8(%ebp),%eax
80106e0b:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e0e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e14:	83 c0 6c             	add    $0x6c,%eax
80106e17:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e1a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e20:	8b 40 10             	mov    0x10(%eax),%eax
80106e23:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106e27:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106e2b:	89 74 24 14          	mov    %esi,0x14(%esp)
80106e2f:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106e33:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106e37:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106e3a:	89 74 24 08          	mov    %esi,0x8(%esp)
80106e3e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e42:	c7 04 24 00 8f 10 80 	movl   $0x80108f00,(%esp)
80106e49:	e8 52 95 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106e4e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e54:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106e5b:	eb 01                	jmp    80106e5e <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106e66:	74 24                	je     80106e8c <trap+0x225>
80106e68:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e6e:	8b 40 24             	mov    0x24(%eax),%eax
80106e71:	85 c0                	test   %eax,%eax
80106e73:	74 17                	je     80106e8c <trap+0x225>
80106e75:	8b 45 08             	mov    0x8(%ebp),%eax
80106e78:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106e7c:	0f b7 c0             	movzwl %ax,%eax
80106e7f:	83 e0 03             	and    $0x3,%eax
80106e82:	83 f8 03             	cmp    $0x3,%eax
80106e85:	75 05                	jne    80106e8c <trap+0x225>
    exit();
80106e87:	e8 78 d9 ff ff       	call   80104804 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80106e8c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e92:	85 c0                	test   %eax,%eax
80106e94:	74 1e                	je     80106eb4 <trap+0x24d>
80106e96:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e9c:	8b 40 0c             	mov    0xc(%eax),%eax
80106e9f:	83 f8 04             	cmp    $0x4,%eax
80106ea2:	75 10                	jne    80106eb4 <trap+0x24d>
80106ea4:	8b 45 08             	mov    0x8(%ebp),%eax
80106ea7:	8b 40 30             	mov    0x30(%eax),%eax
80106eaa:	83 f8 20             	cmp    $0x20,%eax
80106ead:	75 05                	jne    80106eb4 <trap+0x24d>
    yield();
80106eaf:	e8 56 dd ff ff       	call   80104c0a <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106eb4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106eba:	85 c0                	test   %eax,%eax
80106ebc:	74 24                	je     80106ee2 <trap+0x27b>
80106ebe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ec4:	8b 40 24             	mov    0x24(%eax),%eax
80106ec7:	85 c0                	test   %eax,%eax
80106ec9:	74 17                	je     80106ee2 <trap+0x27b>
80106ecb:	8b 45 08             	mov    0x8(%ebp),%eax
80106ece:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106ed2:	0f b7 c0             	movzwl %ax,%eax
80106ed5:	83 e0 03             	and    $0x3,%eax
80106ed8:	83 f8 03             	cmp    $0x3,%eax
80106edb:	75 05                	jne    80106ee2 <trap+0x27b>
    exit();
80106edd:	e8 22 d9 ff ff       	call   80104804 <exit>
}
80106ee2:	83 c4 3c             	add    $0x3c,%esp
80106ee5:	5b                   	pop    %ebx
80106ee6:	5e                   	pop    %esi
80106ee7:	5f                   	pop    %edi
80106ee8:	5d                   	pop    %ebp
...
80106eed:	83 ec 14             	sub    $0x14,%esp
80106ef0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ef3:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106ef7:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106efb:	89 c2                	mov    %eax,%edx
80106efd:	ec                   	in     (%dx),%al
80106efe:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106f01:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106f05:	c9                   	leave  
80106f06:	c3                   	ret    
...
80106f0d:	8b 55 08             	mov    0x8(%ebp),%edx
80106f10:	8b 45 0c             	mov    0xc(%ebp),%eax
80106f13:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106f17:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106f1a:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106f1e:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106f22:	ee                   	out    %al,(%dx)
}
80106f23:	c9                   	leave  
80106f24:	c3                   	ret    
...
80106f28:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106f2b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f32:	00 
80106f33:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106f3a:	e8 c8 ff ff ff       	call   80106f07 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106f3f:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106f46:	00 
80106f47:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106f4e:	e8 b4 ff ff ff       	call   80106f07 <outb>
  outb(COM1+0, 115200/9600);
80106f53:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106f5a:	00 
80106f5b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106f62:	e8 a0 ff ff ff       	call   80106f07 <outb>
  outb(COM1+1, 0);
80106f67:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f6e:	00 
80106f6f:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106f76:	e8 8c ff ff ff       	call   80106f07 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106f7b:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106f82:	00 
80106f83:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106f8a:	e8 78 ff ff ff       	call   80106f07 <outb>
  outb(COM1+4, 0);
80106f8f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f96:	00 
80106f97:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106f9e:	e8 64 ff ff ff       	call   80106f07 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106fa3:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106faa:	00 
80106fab:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106fb2:	e8 50 ff ff ff       	call   80106f07 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106fb7:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106fbe:	e8 27 ff ff ff       	call   80106eea <inb>
80106fc3:	3c ff                	cmp    $0xff,%al
80106fc5:	75 02                	jne    80106fc9 <uartinit+0xa4>
    return;
80106fc7:	eb 6a                	jmp    80107033 <uartinit+0x10e>
  uart = 1;
80106fc9:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
80106fd0:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106fd3:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106fda:	e8 0b ff ff ff       	call   80106eea <inb>
  inb(COM1+0);
80106fdf:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106fe6:	e8 ff fe ff ff       	call   80106eea <inb>
  picenable(IRQ_COM1);
80106feb:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106ff2:	e8 ca cd ff ff       	call   80103dc1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106ff7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ffe:	00 
80106fff:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107006:	e8 5f b9 ff ff       	call   8010296a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010700b:	c7 45 f4 c4 8f 10 80 	movl   $0x80108fc4,-0xc(%ebp)
80107012:	eb 15                	jmp    80107029 <uartinit+0x104>
    uartputc(*p);
80107014:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107017:	0f b6 00             	movzbl (%eax),%eax
8010701a:	0f be c0             	movsbl %al,%eax
8010701d:	89 04 24             	mov    %eax,(%esp)
80107020:	e8 10 00 00 00       	call   80107035 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107025:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107029:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010702c:	0f b6 00             	movzbl (%eax),%eax
8010702f:	84 c0                	test   %al,%al
80107031:	75 e1                	jne    80107014 <uartinit+0xef>
    uartputc(*p);
}
80107033:	c9                   	leave  
80107034:	c3                   	ret    
...
80107038:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
8010703b:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107040:	85 c0                	test   %eax,%eax
80107042:	75 02                	jne    80107046 <uartputc+0x11>
    return;
80107044:	eb 4b                	jmp    80107091 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107046:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010704d:	eb 10                	jmp    8010705f <uartputc+0x2a>
    microdelay(10);
8010704f:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107056:	e8 a7 be ff ff       	call   80102f02 <microdelay>
{
  int i;
...
8010705f:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107063:	7f 16                	jg     8010707b <uartputc+0x46>
80107065:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010706c:	e8 79 fe ff ff       	call   80106eea <inb>
80107071:	0f b6 c0             	movzbl %al,%eax
80107074:	83 e0 20             	and    $0x20,%eax
80107077:	85 c0                	test   %eax,%eax
80107079:	74 d4                	je     8010704f <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
8010707b:	8b 45 08             	mov    0x8(%ebp),%eax
8010707e:	0f b6 c0             	movzbl %al,%eax
80107081:	89 44 24 04          	mov    %eax,0x4(%esp)
80107085:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010708c:	e8 76 fe ff ff       	call   80106f07 <outb>
}
80107091:	c9                   	leave  
80107092:	c3                   	ret    
...
80107096:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107099:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
8010709e:	85 c0                	test   %eax,%eax
801070a0:	75 07                	jne    801070a9 <uartgetc+0x16>
    return -1;
801070a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070a7:	eb 2c                	jmp    801070d5 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
801070a9:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801070b0:	e8 35 fe ff ff       	call   80106eea <inb>
801070b5:	0f b6 c0             	movzbl %al,%eax
801070b8:	83 e0 01             	and    $0x1,%eax
801070bb:	85 c0                	test   %eax,%eax
801070bd:	75 07                	jne    801070c6 <uartgetc+0x33>
    return -1;
801070bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070c4:	eb 0f                	jmp    801070d5 <uartgetc+0x42>
  return inb(COM1+0);
801070c6:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801070cd:	e8 18 fe ff ff       	call   80106eea <inb>
...
801070da:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
801070dd:	c7 04 24 93 70 10 80 	movl   $0x80107093,(%esp)
801070e4:	e8 c4 96 ff ff       	call   801007ad <consoleintr>
}
801070e9:	c9                   	leave  
801070ea:	c3                   	ret    
...
801070ed:	6a 00                	push   $0x0
  jmp alltraps
801070ef:	e9 75 f9 ff ff       	jmp    80106a69 <alltraps>
...
801070f4:	6a 00                	push   $0x0
  pushl $1
801070f6:	6a 01                	push   $0x1
  jmp alltraps
801070f8:	e9 6c f9 ff ff       	jmp    80106a69 <alltraps>
...
801070fd:	6a 00                	push   $0x0
  pushl $2
801070ff:	6a 02                	push   $0x2
  jmp alltraps
80107101:	e9 63 f9 ff ff       	jmp    80106a69 <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $3
80107108:	6a 03                	push   $0x3
  jmp alltraps
8010710a:	e9 5a f9 ff ff       	jmp    80106a69 <alltraps>
...
80107111:	6a 04                	push   $0x4
  jmp alltraps
80107113:	e9 51 f9 ff ff       	jmp    80106a69 <alltraps>
...
80107118:	6a 00                	push   $0x0
  pushl $5
8010711a:	6a 05                	push   $0x5
  jmp alltraps
8010711c:	e9 48 f9 ff ff       	jmp    80106a69 <alltraps>
...
80107121:	6a 00                	push   $0x0
  pushl $6
80107123:	6a 06                	push   $0x6
  jmp alltraps
80107125:	e9 3f f9 ff ff       	jmp    80106a69 <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $7
8010712c:	6a 07                	push   $0x7
  jmp alltraps
8010712e:	e9 36 f9 ff ff       	jmp    80106a69 <alltraps>

80107133 <vector8>:
.globl vector8
vector8:
  pushl $8
80107133:	6a 08                	push   $0x8
  jmp alltraps
80107135:	e9 2f f9 ff ff       	jmp    80106a69 <alltraps>
...
8010713a:	6a 00                	push   $0x0
  pushl $9
8010713c:	6a 09                	push   $0x9
  jmp alltraps
8010713e:	e9 26 f9 ff ff       	jmp    80106a69 <alltraps>

80107143 <vector10>:
.globl vector10
vector10:
  pushl $10
80107143:	6a 0a                	push   $0xa
  jmp alltraps
80107145:	e9 1f f9 ff ff       	jmp    80106a69 <alltraps>

8010714a <vector11>:
.globl vector11
vector11:
  pushl $11
8010714a:	6a 0b                	push   $0xb
  jmp alltraps
8010714c:	e9 18 f9 ff ff       	jmp    80106a69 <alltraps>

80107151 <vector12>:
.globl vector12
vector12:
  pushl $12
80107151:	6a 0c                	push   $0xc
  jmp alltraps
80107153:	e9 11 f9 ff ff       	jmp    80106a69 <alltraps>

80107158 <vector13>:
.globl vector13
vector13:
  pushl $13
80107158:	6a 0d                	push   $0xd
  jmp alltraps
8010715a:	e9 0a f9 ff ff       	jmp    80106a69 <alltraps>

8010715f <vector14>:
.globl vector14
vector14:
  pushl $14
8010715f:	6a 0e                	push   $0xe
  jmp alltraps
80107161:	e9 03 f9 ff ff       	jmp    80106a69 <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $15
80107168:	6a 0f                	push   $0xf
  jmp alltraps
8010716a:	e9 fa f8 ff ff       	jmp    80106a69 <alltraps>
...
8010716f:	6a 00                	push   $0x0
  pushl $16
80107171:	6a 10                	push   $0x10
  jmp alltraps
80107173:	e9 f1 f8 ff ff       	jmp    80106a69 <alltraps>

80107178 <vector17>:
.globl vector17
vector17:
  pushl $17
80107178:	6a 11                	push   $0x11
  jmp alltraps
8010717a:	e9 ea f8 ff ff       	jmp    80106a69 <alltraps>
...
8010717f:	6a 00                	push   $0x0
  pushl $18
80107181:	6a 12                	push   $0x12
  jmp alltraps
80107183:	e9 e1 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107188:	6a 00                	push   $0x0
  pushl $19
8010718a:	6a 13                	push   $0x13
  jmp alltraps
8010718c:	e9 d8 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107191:	6a 00                	push   $0x0
  pushl $20
80107193:	6a 14                	push   $0x14
  jmp alltraps
80107195:	e9 cf f8 ff ff       	jmp    80106a69 <alltraps>
...
8010719a:	6a 00                	push   $0x0
  pushl $21
8010719c:	6a 15                	push   $0x15
  jmp alltraps
8010719e:	e9 c6 f8 ff ff       	jmp    80106a69 <alltraps>
...
801071a3:	6a 00                	push   $0x0
  pushl $22
801071a5:	6a 16                	push   $0x16
  jmp alltraps
801071a7:	e9 bd f8 ff ff       	jmp    80106a69 <alltraps>
...
801071ac:	6a 00                	push   $0x0
  pushl $23
801071ae:	6a 17                	push   $0x17
  jmp alltraps
801071b0:	e9 b4 f8 ff ff       	jmp    80106a69 <alltraps>
...
801071b5:	6a 00                	push   $0x0
  pushl $24
801071b7:	6a 18                	push   $0x18
  jmp alltraps
801071b9:	e9 ab f8 ff ff       	jmp    80106a69 <alltraps>
...
801071be:	6a 00                	push   $0x0
  pushl $25
801071c0:	6a 19                	push   $0x19
  jmp alltraps
801071c2:	e9 a2 f8 ff ff       	jmp    80106a69 <alltraps>
...
801071c7:	6a 00                	push   $0x0
  pushl $26
801071c9:	6a 1a                	push   $0x1a
  jmp alltraps
801071cb:	e9 99 f8 ff ff       	jmp    80106a69 <alltraps>
...
801071d0:	6a 00                	push   $0x0
  pushl $27
801071d2:	6a 1b                	push   $0x1b
  jmp alltraps
801071d4:	e9 90 f8 ff ff       	jmp    80106a69 <alltraps>
...
801071db:	6a 1c                	push   $0x1c
  jmp alltraps
801071dd:	e9 87 f8 ff ff       	jmp    80106a69 <alltraps>
...
801071e2:	6a 00                	push   $0x0
  pushl $29
801071e4:	6a 1d                	push   $0x1d
  jmp alltraps
801071e6:	e9 7e f8 ff ff       	jmp    80106a69 <alltraps>
...
801071eb:	6a 00                	push   $0x0
  pushl $30
801071ed:	6a 1e                	push   $0x1e
  jmp alltraps
801071ef:	e9 75 f8 ff ff       	jmp    80106a69 <alltraps>
...
801071f4:	6a 00                	push   $0x0
  pushl $31
801071f6:	6a 1f                	push   $0x1f
  jmp alltraps
801071f8:	e9 6c f8 ff ff       	jmp    80106a69 <alltraps>
...
801071fd:	6a 00                	push   $0x0
  pushl $32
801071ff:	6a 20                	push   $0x20
  jmp alltraps
80107201:	e9 63 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107206:	6a 00                	push   $0x0
  pushl $33
80107208:	6a 21                	push   $0x21
  jmp alltraps
8010720a:	e9 5a f8 ff ff       	jmp    80106a69 <alltraps>
...
8010720f:	6a 00                	push   $0x0
  pushl $34
80107211:	6a 22                	push   $0x22
  jmp alltraps
80107213:	e9 51 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107218:	6a 00                	push   $0x0
  pushl $35
8010721a:	6a 23                	push   $0x23
  jmp alltraps
8010721c:	e9 48 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107221:	6a 00                	push   $0x0
  pushl $36
80107223:	6a 24                	push   $0x24
  jmp alltraps
80107225:	e9 3f f8 ff ff       	jmp    80106a69 <alltraps>
...
8010722a:	6a 00                	push   $0x0
  pushl $37
8010722c:	6a 25                	push   $0x25
  jmp alltraps
8010722e:	e9 36 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107233:	6a 00                	push   $0x0
  pushl $38
80107235:	6a 26                	push   $0x26
  jmp alltraps
80107237:	e9 2d f8 ff ff       	jmp    80106a69 <alltraps>
...
8010723c:	6a 00                	push   $0x0
  pushl $39
8010723e:	6a 27                	push   $0x27
  jmp alltraps
80107240:	e9 24 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107245:	6a 00                	push   $0x0
  pushl $40
80107247:	6a 28                	push   $0x28
  jmp alltraps
80107249:	e9 1b f8 ff ff       	jmp    80106a69 <alltraps>
...
8010724e:	6a 00                	push   $0x0
  pushl $41
80107250:	6a 29                	push   $0x29
  jmp alltraps
80107252:	e9 12 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107257:	6a 00                	push   $0x0
  pushl $42
80107259:	6a 2a                	push   $0x2a
  jmp alltraps
8010725b:	e9 09 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107260:	6a 00                	push   $0x0
  pushl $43
80107262:	6a 2b                	push   $0x2b
  jmp alltraps
80107264:	e9 00 f8 ff ff       	jmp    80106a69 <alltraps>
...
80107269:	6a 00                	push   $0x0
  pushl $44
8010726b:	6a 2c                	push   $0x2c
  jmp alltraps
8010726d:	e9 f7 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107272:	6a 00                	push   $0x0
  pushl $45
80107274:	6a 2d                	push   $0x2d
  jmp alltraps
80107276:	e9 ee f7 ff ff       	jmp    80106a69 <alltraps>
...
8010727b:	6a 00                	push   $0x0
  pushl $46
8010727d:	6a 2e                	push   $0x2e
  jmp alltraps
8010727f:	e9 e5 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107284:	6a 00                	push   $0x0
  pushl $47
80107286:	6a 2f                	push   $0x2f
  jmp alltraps
80107288:	e9 dc f7 ff ff       	jmp    80106a69 <alltraps>
...
8010728d:	6a 00                	push   $0x0
  pushl $48
8010728f:	6a 30                	push   $0x30
  jmp alltraps
80107291:	e9 d3 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107296:	6a 00                	push   $0x0
  pushl $49
80107298:	6a 31                	push   $0x31
  jmp alltraps
8010729a:	e9 ca f7 ff ff       	jmp    80106a69 <alltraps>
...
8010729f:	6a 00                	push   $0x0
  pushl $50
801072a1:	6a 32                	push   $0x32
  jmp alltraps
801072a3:	e9 c1 f7 ff ff       	jmp    80106a69 <alltraps>
...
801072a8:	6a 00                	push   $0x0
  pushl $51
801072aa:	6a 33                	push   $0x33
  jmp alltraps
801072ac:	e9 b8 f7 ff ff       	jmp    80106a69 <alltraps>
...
801072b1:	6a 00                	push   $0x0
  pushl $52
801072b3:	6a 34                	push   $0x34
  jmp alltraps
801072b5:	e9 af f7 ff ff       	jmp    80106a69 <alltraps>
...
801072ba:	6a 00                	push   $0x0
  pushl $53
801072bc:	6a 35                	push   $0x35
  jmp alltraps
801072be:	e9 a6 f7 ff ff       	jmp    80106a69 <alltraps>
...
801072c3:	6a 00                	push   $0x0
  pushl $54
801072c5:	6a 36                	push   $0x36
  jmp alltraps
801072c7:	e9 9d f7 ff ff       	jmp    80106a69 <alltraps>
...
801072cc:	6a 00                	push   $0x0
  pushl $55
801072ce:	6a 37                	push   $0x37
  jmp alltraps
801072d0:	e9 94 f7 ff ff       	jmp    80106a69 <alltraps>
...
801072d5:	6a 00                	push   $0x0
  pushl $56
801072d7:	6a 38                	push   $0x38
  jmp alltraps
801072d9:	e9 8b f7 ff ff       	jmp    80106a69 <alltraps>
...
801072de:	6a 00                	push   $0x0
  pushl $57
801072e0:	6a 39                	push   $0x39
  jmp alltraps
801072e2:	e9 82 f7 ff ff       	jmp    80106a69 <alltraps>
...
801072e7:	6a 00                	push   $0x0
  pushl $58
801072e9:	6a 3a                	push   $0x3a
  jmp alltraps
801072eb:	e9 79 f7 ff ff       	jmp    80106a69 <alltraps>
...
801072f0:	6a 00                	push   $0x0
  pushl $59
801072f2:	6a 3b                	push   $0x3b
  jmp alltraps
801072f4:	e9 70 f7 ff ff       	jmp    80106a69 <alltraps>
...
801072f9:	6a 00                	push   $0x0
  pushl $60
801072fb:	6a 3c                	push   $0x3c
  jmp alltraps
801072fd:	e9 67 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107302:	6a 00                	push   $0x0
  pushl $61
80107304:	6a 3d                	push   $0x3d
  jmp alltraps
80107306:	e9 5e f7 ff ff       	jmp    80106a69 <alltraps>
...
8010730b:	6a 00                	push   $0x0
  pushl $62
8010730d:	6a 3e                	push   $0x3e
  jmp alltraps
8010730f:	e9 55 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107314:	6a 00                	push   $0x0
  pushl $63
80107316:	6a 3f                	push   $0x3f
  jmp alltraps
80107318:	e9 4c f7 ff ff       	jmp    80106a69 <alltraps>
...
8010731d:	6a 00                	push   $0x0
  pushl $64
8010731f:	6a 40                	push   $0x40
  jmp alltraps
80107321:	e9 43 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107326:	6a 00                	push   $0x0
  pushl $65
80107328:	6a 41                	push   $0x41
  jmp alltraps
8010732a:	e9 3a f7 ff ff       	jmp    80106a69 <alltraps>
...
8010732f:	6a 00                	push   $0x0
  pushl $66
80107331:	6a 42                	push   $0x42
  jmp alltraps
80107333:	e9 31 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107338:	6a 00                	push   $0x0
  pushl $67
8010733a:	6a 43                	push   $0x43
  jmp alltraps
8010733c:	e9 28 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107341:	6a 00                	push   $0x0
  pushl $68
80107343:	6a 44                	push   $0x44
  jmp alltraps
80107345:	e9 1f f7 ff ff       	jmp    80106a69 <alltraps>
...
8010734a:	6a 00                	push   $0x0
  pushl $69
8010734c:	6a 45                	push   $0x45
  jmp alltraps
8010734e:	e9 16 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107353:	6a 00                	push   $0x0
  pushl $70
80107355:	6a 46                	push   $0x46
  jmp alltraps
80107357:	e9 0d f7 ff ff       	jmp    80106a69 <alltraps>
...
8010735c:	6a 00                	push   $0x0
  pushl $71
8010735e:	6a 47                	push   $0x47
  jmp alltraps
80107360:	e9 04 f7 ff ff       	jmp    80106a69 <alltraps>
...
80107365:	6a 00                	push   $0x0
  pushl $72
80107367:	6a 48                	push   $0x48
  jmp alltraps
80107369:	e9 fb f6 ff ff       	jmp    80106a69 <alltraps>
...
8010736e:	6a 00                	push   $0x0
  pushl $73
80107370:	6a 49                	push   $0x49
  jmp alltraps
80107372:	e9 f2 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107377:	6a 00                	push   $0x0
  pushl $74
80107379:	6a 4a                	push   $0x4a
  jmp alltraps
8010737b:	e9 e9 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107380:	6a 00                	push   $0x0
  pushl $75
80107382:	6a 4b                	push   $0x4b
  jmp alltraps
80107384:	e9 e0 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107389:	6a 00                	push   $0x0
  pushl $76
8010738b:	6a 4c                	push   $0x4c
  jmp alltraps
8010738d:	e9 d7 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107392:	6a 00                	push   $0x0
  pushl $77
80107394:	6a 4d                	push   $0x4d
  jmp alltraps
80107396:	e9 ce f6 ff ff       	jmp    80106a69 <alltraps>
...
8010739b:	6a 00                	push   $0x0
  pushl $78
8010739d:	6a 4e                	push   $0x4e
  jmp alltraps
8010739f:	e9 c5 f6 ff ff       	jmp    80106a69 <alltraps>
...
801073a4:	6a 00                	push   $0x0
  pushl $79
801073a6:	6a 4f                	push   $0x4f
  jmp alltraps
801073a8:	e9 bc f6 ff ff       	jmp    80106a69 <alltraps>
...
801073ad:	6a 00                	push   $0x0
  pushl $80
801073af:	6a 50                	push   $0x50
  jmp alltraps
801073b1:	e9 b3 f6 ff ff       	jmp    80106a69 <alltraps>
...
801073b6:	6a 00                	push   $0x0
  pushl $81
801073b8:	6a 51                	push   $0x51
  jmp alltraps
801073ba:	e9 aa f6 ff ff       	jmp    80106a69 <alltraps>
...
801073bf:	6a 00                	push   $0x0
  pushl $82
801073c1:	6a 52                	push   $0x52
  jmp alltraps
801073c3:	e9 a1 f6 ff ff       	jmp    80106a69 <alltraps>
...
801073c8:	6a 00                	push   $0x0
  pushl $83
801073ca:	6a 53                	push   $0x53
  jmp alltraps
801073cc:	e9 98 f6 ff ff       	jmp    80106a69 <alltraps>
...
801073d1:	6a 00                	push   $0x0
  pushl $84
801073d3:	6a 54                	push   $0x54
  jmp alltraps
801073d5:	e9 8f f6 ff ff       	jmp    80106a69 <alltraps>
...
801073da:	6a 00                	push   $0x0
  pushl $85
801073dc:	6a 55                	push   $0x55
  jmp alltraps
801073de:	e9 86 f6 ff ff       	jmp    80106a69 <alltraps>
...
801073e3:	6a 00                	push   $0x0
  pushl $86
801073e5:	6a 56                	push   $0x56
  jmp alltraps
801073e7:	e9 7d f6 ff ff       	jmp    80106a69 <alltraps>
...
801073ec:	6a 00                	push   $0x0
  pushl $87
801073ee:	6a 57                	push   $0x57
  jmp alltraps
801073f0:	e9 74 f6 ff ff       	jmp    80106a69 <alltraps>
...
801073f5:	6a 00                	push   $0x0
  pushl $88
801073f7:	6a 58                	push   $0x58
  jmp alltraps
801073f9:	e9 6b f6 ff ff       	jmp    80106a69 <alltraps>
...
801073fe:	6a 00                	push   $0x0
  pushl $89
80107400:	6a 59                	push   $0x59
  jmp alltraps
80107402:	e9 62 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107407:	6a 00                	push   $0x0
  pushl $90
80107409:	6a 5a                	push   $0x5a
  jmp alltraps
8010740b:	e9 59 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107410:	6a 00                	push   $0x0
  pushl $91
80107412:	6a 5b                	push   $0x5b
  jmp alltraps
80107414:	e9 50 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107419:	6a 00                	push   $0x0
  pushl $92
8010741b:	6a 5c                	push   $0x5c
  jmp alltraps
8010741d:	e9 47 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107422:	6a 00                	push   $0x0
  pushl $93
80107424:	6a 5d                	push   $0x5d
  jmp alltraps
80107426:	e9 3e f6 ff ff       	jmp    80106a69 <alltraps>
...
8010742b:	6a 00                	push   $0x0
  pushl $94
8010742d:	6a 5e                	push   $0x5e
  jmp alltraps
8010742f:	e9 35 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107434:	6a 00                	push   $0x0
  pushl $95
80107436:	6a 5f                	push   $0x5f
  jmp alltraps
80107438:	e9 2c f6 ff ff       	jmp    80106a69 <alltraps>
...
8010743d:	6a 00                	push   $0x0
  pushl $96
8010743f:	6a 60                	push   $0x60
  jmp alltraps
80107441:	e9 23 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107446:	6a 00                	push   $0x0
  pushl $97
80107448:	6a 61                	push   $0x61
  jmp alltraps
8010744a:	e9 1a f6 ff ff       	jmp    80106a69 <alltraps>
...
8010744f:	6a 00                	push   $0x0
  pushl $98
80107451:	6a 62                	push   $0x62
  jmp alltraps
80107453:	e9 11 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107458:	6a 00                	push   $0x0
  pushl $99
8010745a:	6a 63                	push   $0x63
  jmp alltraps
8010745c:	e9 08 f6 ff ff       	jmp    80106a69 <alltraps>
...
80107461:	6a 00                	push   $0x0
  pushl $100
80107463:	6a 64                	push   $0x64
  jmp alltraps
80107465:	e9 ff f5 ff ff       	jmp    80106a69 <alltraps>
...
8010746a:	6a 00                	push   $0x0
  pushl $101
8010746c:	6a 65                	push   $0x65
  jmp alltraps
8010746e:	e9 f6 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107473:	6a 00                	push   $0x0
  pushl $102
80107475:	6a 66                	push   $0x66
  jmp alltraps
80107477:	e9 ed f5 ff ff       	jmp    80106a69 <alltraps>
...
8010747c:	6a 00                	push   $0x0
  pushl $103
8010747e:	6a 67                	push   $0x67
  jmp alltraps
80107480:	e9 e4 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107485:	6a 00                	push   $0x0
  pushl $104
80107487:	6a 68                	push   $0x68
  jmp alltraps
80107489:	e9 db f5 ff ff       	jmp    80106a69 <alltraps>
...
8010748e:	6a 00                	push   $0x0
  pushl $105
80107490:	6a 69                	push   $0x69
  jmp alltraps
80107492:	e9 d2 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107497:	6a 00                	push   $0x0
  pushl $106
80107499:	6a 6a                	push   $0x6a
  jmp alltraps
8010749b:	e9 c9 f5 ff ff       	jmp    80106a69 <alltraps>
...
801074a0:	6a 00                	push   $0x0
  pushl $107
801074a2:	6a 6b                	push   $0x6b
  jmp alltraps
801074a4:	e9 c0 f5 ff ff       	jmp    80106a69 <alltraps>
...
801074a9:	6a 00                	push   $0x0
  pushl $108
801074ab:	6a 6c                	push   $0x6c
  jmp alltraps
801074ad:	e9 b7 f5 ff ff       	jmp    80106a69 <alltraps>
...
801074b2:	6a 00                	push   $0x0
  pushl $109
801074b4:	6a 6d                	push   $0x6d
  jmp alltraps
801074b6:	e9 ae f5 ff ff       	jmp    80106a69 <alltraps>
...
801074bb:	6a 00                	push   $0x0
  pushl $110
801074bd:	6a 6e                	push   $0x6e
  jmp alltraps
801074bf:	e9 a5 f5 ff ff       	jmp    80106a69 <alltraps>
...
801074c4:	6a 00                	push   $0x0
  pushl $111
801074c6:	6a 6f                	push   $0x6f
  jmp alltraps
801074c8:	e9 9c f5 ff ff       	jmp    80106a69 <alltraps>
...
801074cd:	6a 00                	push   $0x0
  pushl $112
801074cf:	6a 70                	push   $0x70
  jmp alltraps
801074d1:	e9 93 f5 ff ff       	jmp    80106a69 <alltraps>
...
801074d6:	6a 00                	push   $0x0
  pushl $113
801074d8:	6a 71                	push   $0x71
  jmp alltraps
801074da:	e9 8a f5 ff ff       	jmp    80106a69 <alltraps>
...
801074df:	6a 00                	push   $0x0
  pushl $114
801074e1:	6a 72                	push   $0x72
  jmp alltraps
801074e3:	e9 81 f5 ff ff       	jmp    80106a69 <alltraps>
...
801074e8:	6a 00                	push   $0x0
  pushl $115
801074ea:	6a 73                	push   $0x73
  jmp alltraps
801074ec:	e9 78 f5 ff ff       	jmp    80106a69 <alltraps>
...
801074f1:	6a 00                	push   $0x0
  pushl $116
801074f3:	6a 74                	push   $0x74
  jmp alltraps
801074f5:	e9 6f f5 ff ff       	jmp    80106a69 <alltraps>
...
801074fa:	6a 00                	push   $0x0
  pushl $117
801074fc:	6a 75                	push   $0x75
  jmp alltraps
801074fe:	e9 66 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107503:	6a 00                	push   $0x0
  pushl $118
80107505:	6a 76                	push   $0x76
  jmp alltraps
80107507:	e9 5d f5 ff ff       	jmp    80106a69 <alltraps>
...
8010750c:	6a 00                	push   $0x0
  pushl $119
8010750e:	6a 77                	push   $0x77
  jmp alltraps
80107510:	e9 54 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107515:	6a 00                	push   $0x0
  pushl $120
80107517:	6a 78                	push   $0x78
  jmp alltraps
80107519:	e9 4b f5 ff ff       	jmp    80106a69 <alltraps>
...
8010751e:	6a 00                	push   $0x0
  pushl $121
80107520:	6a 79                	push   $0x79
  jmp alltraps
80107522:	e9 42 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107527:	6a 00                	push   $0x0
  pushl $122
80107529:	6a 7a                	push   $0x7a
  jmp alltraps
8010752b:	e9 39 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107530:	6a 00                	push   $0x0
  pushl $123
80107532:	6a 7b                	push   $0x7b
  jmp alltraps
80107534:	e9 30 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107539:	6a 00                	push   $0x0
  pushl $124
8010753b:	6a 7c                	push   $0x7c
  jmp alltraps
8010753d:	e9 27 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107542:	6a 00                	push   $0x0
  pushl $125
80107544:	6a 7d                	push   $0x7d
  jmp alltraps
80107546:	e9 1e f5 ff ff       	jmp    80106a69 <alltraps>
...
8010754b:	6a 00                	push   $0x0
  pushl $126
8010754d:	6a 7e                	push   $0x7e
  jmp alltraps
8010754f:	e9 15 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107554:	6a 00                	push   $0x0
  pushl $127
80107556:	6a 7f                	push   $0x7f
  jmp alltraps
80107558:	e9 0c f5 ff ff       	jmp    80106a69 <alltraps>
...
8010755d:	6a 00                	push   $0x0
  pushl $128
8010755f:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107564:	e9 00 f5 ff ff       	jmp    80106a69 <alltraps>
...
80107569:	6a 00                	push   $0x0
  pushl $129
8010756b:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107570:	e9 f4 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107575:	6a 00                	push   $0x0
  pushl $130
80107577:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010757c:	e9 e8 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107581:	6a 00                	push   $0x0
  pushl $131
80107583:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107588:	e9 dc f4 ff ff       	jmp    80106a69 <alltraps>
...
8010758d:	6a 00                	push   $0x0
  pushl $132
8010758f:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107594:	e9 d0 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107599:	6a 00                	push   $0x0
  pushl $133
8010759b:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801075a0:	e9 c4 f4 ff ff       	jmp    80106a69 <alltraps>
...
801075a5:	6a 00                	push   $0x0
  pushl $134
801075a7:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801075ac:	e9 b8 f4 ff ff       	jmp    80106a69 <alltraps>
...
801075b1:	6a 00                	push   $0x0
  pushl $135
801075b3:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801075b8:	e9 ac f4 ff ff       	jmp    80106a69 <alltraps>
...
801075bd:	6a 00                	push   $0x0
  pushl $136
801075bf:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801075c4:	e9 a0 f4 ff ff       	jmp    80106a69 <alltraps>
...
801075c9:	6a 00                	push   $0x0
  pushl $137
801075cb:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801075d0:	e9 94 f4 ff ff       	jmp    80106a69 <alltraps>
...
801075d5:	6a 00                	push   $0x0
  pushl $138
801075d7:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801075dc:	e9 88 f4 ff ff       	jmp    80106a69 <alltraps>
...
801075e1:	6a 00                	push   $0x0
  pushl $139
801075e3:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801075e8:	e9 7c f4 ff ff       	jmp    80106a69 <alltraps>
...
801075ed:	6a 00                	push   $0x0
  pushl $140
801075ef:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801075f4:	e9 70 f4 ff ff       	jmp    80106a69 <alltraps>
...
801075f9:	6a 00                	push   $0x0
  pushl $141
801075fb:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107600:	e9 64 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107605:	6a 00                	push   $0x0
  pushl $142
80107607:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010760c:	e9 58 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107611:	6a 00                	push   $0x0
  pushl $143
80107613:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107618:	e9 4c f4 ff ff       	jmp    80106a69 <alltraps>
...
8010761d:	6a 00                	push   $0x0
  pushl $144
8010761f:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107624:	e9 40 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107629:	6a 00                	push   $0x0
  pushl $145
8010762b:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107630:	e9 34 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107635:	6a 00                	push   $0x0
  pushl $146
80107637:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010763c:	e9 28 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107641:	6a 00                	push   $0x0
  pushl $147
80107643:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107648:	e9 1c f4 ff ff       	jmp    80106a69 <alltraps>
...
8010764d:	6a 00                	push   $0x0
  pushl $148
8010764f:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107654:	e9 10 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107659:	6a 00                	push   $0x0
  pushl $149
8010765b:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107660:	e9 04 f4 ff ff       	jmp    80106a69 <alltraps>
...
80107665:	6a 00                	push   $0x0
  pushl $150
80107667:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010766c:	e9 f8 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107671:	6a 00                	push   $0x0
  pushl $151
80107673:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107678:	e9 ec f3 ff ff       	jmp    80106a69 <alltraps>
...
8010767d:	6a 00                	push   $0x0
  pushl $152
8010767f:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107684:	e9 e0 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107689:	6a 00                	push   $0x0
  pushl $153
8010768b:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107690:	e9 d4 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107695:	6a 00                	push   $0x0
  pushl $154
80107697:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010769c:	e9 c8 f3 ff ff       	jmp    80106a69 <alltraps>
...
801076a1:	6a 00                	push   $0x0
  pushl $155
801076a3:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801076a8:	e9 bc f3 ff ff       	jmp    80106a69 <alltraps>
...
801076ad:	6a 00                	push   $0x0
  pushl $156
801076af:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801076b4:	e9 b0 f3 ff ff       	jmp    80106a69 <alltraps>
...
801076b9:	6a 00                	push   $0x0
  pushl $157
801076bb:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801076c0:	e9 a4 f3 ff ff       	jmp    80106a69 <alltraps>
...
801076c5:	6a 00                	push   $0x0
  pushl $158
801076c7:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801076cc:	e9 98 f3 ff ff       	jmp    80106a69 <alltraps>
...
801076d1:	6a 00                	push   $0x0
  pushl $159
801076d3:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801076d8:	e9 8c f3 ff ff       	jmp    80106a69 <alltraps>
...
801076dd:	6a 00                	push   $0x0
  pushl $160
801076df:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801076e4:	e9 80 f3 ff ff       	jmp    80106a69 <alltraps>
...
801076e9:	6a 00                	push   $0x0
  pushl $161
801076eb:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801076f0:	e9 74 f3 ff ff       	jmp    80106a69 <alltraps>
...
801076f5:	6a 00                	push   $0x0
  pushl $162
801076f7:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801076fc:	e9 68 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107701:	6a 00                	push   $0x0
  pushl $163
80107703:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107708:	e9 5c f3 ff ff       	jmp    80106a69 <alltraps>
...
8010770d:	6a 00                	push   $0x0
  pushl $164
8010770f:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107714:	e9 50 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107719:	6a 00                	push   $0x0
  pushl $165
8010771b:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107720:	e9 44 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107725:	6a 00                	push   $0x0
  pushl $166
80107727:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010772c:	e9 38 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107731:	6a 00                	push   $0x0
  pushl $167
80107733:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107738:	e9 2c f3 ff ff       	jmp    80106a69 <alltraps>
...
8010773d:	6a 00                	push   $0x0
  pushl $168
8010773f:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107744:	e9 20 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107749:	6a 00                	push   $0x0
  pushl $169
8010774b:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107750:	e9 14 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107755:	6a 00                	push   $0x0
  pushl $170
80107757:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010775c:	e9 08 f3 ff ff       	jmp    80106a69 <alltraps>
...
80107761:	6a 00                	push   $0x0
  pushl $171
80107763:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107768:	e9 fc f2 ff ff       	jmp    80106a69 <alltraps>
...
8010776d:	6a 00                	push   $0x0
  pushl $172
8010776f:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107774:	e9 f0 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107779:	6a 00                	push   $0x0
  pushl $173
8010777b:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107780:	e9 e4 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107785:	6a 00                	push   $0x0
  pushl $174
80107787:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010778c:	e9 d8 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107791:	6a 00                	push   $0x0
  pushl $175
80107793:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107798:	e9 cc f2 ff ff       	jmp    80106a69 <alltraps>
...
8010779d:	6a 00                	push   $0x0
  pushl $176
8010779f:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801077a4:	e9 c0 f2 ff ff       	jmp    80106a69 <alltraps>
...
801077a9:	6a 00                	push   $0x0
  pushl $177
801077ab:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801077b0:	e9 b4 f2 ff ff       	jmp    80106a69 <alltraps>
...
801077b5:	6a 00                	push   $0x0
  pushl $178
801077b7:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801077bc:	e9 a8 f2 ff ff       	jmp    80106a69 <alltraps>
...
801077c1:	6a 00                	push   $0x0
  pushl $179
801077c3:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801077c8:	e9 9c f2 ff ff       	jmp    80106a69 <alltraps>
...
801077cd:	6a 00                	push   $0x0
  pushl $180
801077cf:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801077d4:	e9 90 f2 ff ff       	jmp    80106a69 <alltraps>
...
801077d9:	6a 00                	push   $0x0
  pushl $181
801077db:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801077e0:	e9 84 f2 ff ff       	jmp    80106a69 <alltraps>
...
801077e5:	6a 00                	push   $0x0
  pushl $182
801077e7:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801077ec:	e9 78 f2 ff ff       	jmp    80106a69 <alltraps>
...
801077f1:	6a 00                	push   $0x0
  pushl $183
801077f3:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801077f8:	e9 6c f2 ff ff       	jmp    80106a69 <alltraps>
...
801077fd:	6a 00                	push   $0x0
  pushl $184
801077ff:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107804:	e9 60 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107809:	6a 00                	push   $0x0
  pushl $185
8010780b:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107810:	e9 54 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107815:	6a 00                	push   $0x0
  pushl $186
80107817:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010781c:	e9 48 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107821:	6a 00                	push   $0x0
  pushl $187
80107823:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107828:	e9 3c f2 ff ff       	jmp    80106a69 <alltraps>
...
8010782d:	6a 00                	push   $0x0
  pushl $188
8010782f:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107834:	e9 30 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107839:	6a 00                	push   $0x0
  pushl $189
8010783b:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107840:	e9 24 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107845:	6a 00                	push   $0x0
  pushl $190
80107847:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010784c:	e9 18 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107851:	6a 00                	push   $0x0
  pushl $191
80107853:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107858:	e9 0c f2 ff ff       	jmp    80106a69 <alltraps>
...
8010785d:	6a 00                	push   $0x0
  pushl $192
8010785f:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107864:	e9 00 f2 ff ff       	jmp    80106a69 <alltraps>
...
80107869:	6a 00                	push   $0x0
  pushl $193
8010786b:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107870:	e9 f4 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107875:	6a 00                	push   $0x0
  pushl $194
80107877:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010787c:	e9 e8 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107881:	6a 00                	push   $0x0
  pushl $195
80107883:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107888:	e9 dc f1 ff ff       	jmp    80106a69 <alltraps>
...
8010788d:	6a 00                	push   $0x0
  pushl $196
8010788f:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107894:	e9 d0 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107899:	6a 00                	push   $0x0
  pushl $197
8010789b:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801078a0:	e9 c4 f1 ff ff       	jmp    80106a69 <alltraps>
...
801078a5:	6a 00                	push   $0x0
  pushl $198
801078a7:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801078ac:	e9 b8 f1 ff ff       	jmp    80106a69 <alltraps>
...
801078b1:	6a 00                	push   $0x0
  pushl $199
801078b3:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801078b8:	e9 ac f1 ff ff       	jmp    80106a69 <alltraps>
...
801078bd:	6a 00                	push   $0x0
  pushl $200
801078bf:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801078c4:	e9 a0 f1 ff ff       	jmp    80106a69 <alltraps>
...
801078c9:	6a 00                	push   $0x0
  pushl $201
801078cb:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801078d0:	e9 94 f1 ff ff       	jmp    80106a69 <alltraps>
...
801078d5:	6a 00                	push   $0x0
  pushl $202
801078d7:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801078dc:	e9 88 f1 ff ff       	jmp    80106a69 <alltraps>
...
801078e1:	6a 00                	push   $0x0
  pushl $203
801078e3:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801078e8:	e9 7c f1 ff ff       	jmp    80106a69 <alltraps>
...
801078ed:	6a 00                	push   $0x0
  pushl $204
801078ef:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801078f4:	e9 70 f1 ff ff       	jmp    80106a69 <alltraps>
...
801078f9:	6a 00                	push   $0x0
  pushl $205
801078fb:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107900:	e9 64 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107905:	6a 00                	push   $0x0
  pushl $206
80107907:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010790c:	e9 58 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107911:	6a 00                	push   $0x0
  pushl $207
80107913:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107918:	e9 4c f1 ff ff       	jmp    80106a69 <alltraps>
...
8010791d:	6a 00                	push   $0x0
  pushl $208
8010791f:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107924:	e9 40 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107929:	6a 00                	push   $0x0
  pushl $209
8010792b:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107930:	e9 34 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107935:	6a 00                	push   $0x0
  pushl $210
80107937:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010793c:	e9 28 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107941:	6a 00                	push   $0x0
  pushl $211
80107943:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107948:	e9 1c f1 ff ff       	jmp    80106a69 <alltraps>
...
8010794d:	6a 00                	push   $0x0
  pushl $212
8010794f:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107954:	e9 10 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107959:	6a 00                	push   $0x0
  pushl $213
8010795b:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107960:	e9 04 f1 ff ff       	jmp    80106a69 <alltraps>
...
80107965:	6a 00                	push   $0x0
  pushl $214
80107967:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010796c:	e9 f8 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107971:	6a 00                	push   $0x0
  pushl $215
80107973:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107978:	e9 ec f0 ff ff       	jmp    80106a69 <alltraps>
...
8010797d:	6a 00                	push   $0x0
  pushl $216
8010797f:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107984:	e9 e0 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107989:	6a 00                	push   $0x0
  pushl $217
8010798b:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107990:	e9 d4 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107995:	6a 00                	push   $0x0
  pushl $218
80107997:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010799c:	e9 c8 f0 ff ff       	jmp    80106a69 <alltraps>
...
801079a1:	6a 00                	push   $0x0
  pushl $219
801079a3:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801079a8:	e9 bc f0 ff ff       	jmp    80106a69 <alltraps>
...
801079ad:	6a 00                	push   $0x0
  pushl $220
801079af:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801079b4:	e9 b0 f0 ff ff       	jmp    80106a69 <alltraps>
...
801079b9:	6a 00                	push   $0x0
  pushl $221
801079bb:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801079c0:	e9 a4 f0 ff ff       	jmp    80106a69 <alltraps>
...
801079c5:	6a 00                	push   $0x0
  pushl $222
801079c7:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801079cc:	e9 98 f0 ff ff       	jmp    80106a69 <alltraps>
...
801079d1:	6a 00                	push   $0x0
  pushl $223
801079d3:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801079d8:	e9 8c f0 ff ff       	jmp    80106a69 <alltraps>
...
801079dd:	6a 00                	push   $0x0
  pushl $224
801079df:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801079e4:	e9 80 f0 ff ff       	jmp    80106a69 <alltraps>
...
801079e9:	6a 00                	push   $0x0
  pushl $225
801079eb:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801079f0:	e9 74 f0 ff ff       	jmp    80106a69 <alltraps>
...
801079f5:	6a 00                	push   $0x0
  pushl $226
801079f7:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801079fc:	e9 68 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a01:	6a 00                	push   $0x0
  pushl $227
80107a03:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107a08:	e9 5c f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a0d:	6a 00                	push   $0x0
  pushl $228
80107a0f:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107a14:	e9 50 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a19:	6a 00                	push   $0x0
  pushl $229
80107a1b:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107a20:	e9 44 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a25:	6a 00                	push   $0x0
  pushl $230
80107a27:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107a2c:	e9 38 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a31:	6a 00                	push   $0x0
  pushl $231
80107a33:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107a38:	e9 2c f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a3d:	6a 00                	push   $0x0
  pushl $232
80107a3f:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107a44:	e9 20 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a49:	6a 00                	push   $0x0
  pushl $233
80107a4b:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107a50:	e9 14 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a55:	6a 00                	push   $0x0
  pushl $234
80107a57:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107a5c:	e9 08 f0 ff ff       	jmp    80106a69 <alltraps>
...
80107a61:	6a 00                	push   $0x0
  pushl $235
80107a63:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107a68:	e9 fc ef ff ff       	jmp    80106a69 <alltraps>
...
80107a6d:	6a 00                	push   $0x0
  pushl $236
80107a6f:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107a74:	e9 f0 ef ff ff       	jmp    80106a69 <alltraps>
...
80107a79:	6a 00                	push   $0x0
  pushl $237
80107a7b:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107a80:	e9 e4 ef ff ff       	jmp    80106a69 <alltraps>
...
80107a85:	6a 00                	push   $0x0
  pushl $238
80107a87:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107a8c:	e9 d8 ef ff ff       	jmp    80106a69 <alltraps>
...
80107a91:	6a 00                	push   $0x0
  pushl $239
80107a93:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107a98:	e9 cc ef ff ff       	jmp    80106a69 <alltraps>
...
80107a9d:	6a 00                	push   $0x0
  pushl $240
80107a9f:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107aa4:	e9 c0 ef ff ff       	jmp    80106a69 <alltraps>
...
80107aa9:	6a 00                	push   $0x0
  pushl $241
80107aab:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107ab0:	e9 b4 ef ff ff       	jmp    80106a69 <alltraps>
...
80107ab5:	6a 00                	push   $0x0
  pushl $242
80107ab7:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107abc:	e9 a8 ef ff ff       	jmp    80106a69 <alltraps>
...
80107ac1:	6a 00                	push   $0x0
  pushl $243
80107ac3:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107ac8:	e9 9c ef ff ff       	jmp    80106a69 <alltraps>
...
80107acd:	6a 00                	push   $0x0
  pushl $244
80107acf:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107ad4:	e9 90 ef ff ff       	jmp    80106a69 <alltraps>
...
80107ad9:	6a 00                	push   $0x0
  pushl $245
80107adb:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107ae0:	e9 84 ef ff ff       	jmp    80106a69 <alltraps>
...
80107ae5:	6a 00                	push   $0x0
  pushl $246
80107ae7:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107aec:	e9 78 ef ff ff       	jmp    80106a69 <alltraps>
...
80107af1:	6a 00                	push   $0x0
  pushl $247
80107af3:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107af8:	e9 6c ef ff ff       	jmp    80106a69 <alltraps>
...
80107afd:	6a 00                	push   $0x0
  pushl $248
80107aff:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107b04:	e9 60 ef ff ff       	jmp    80106a69 <alltraps>
...
80107b09:	6a 00                	push   $0x0
  pushl $249
80107b0b:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107b10:	e9 54 ef ff ff       	jmp    80106a69 <alltraps>
...
80107b15:	6a 00                	push   $0x0
  pushl $250
80107b17:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107b1c:	e9 48 ef ff ff       	jmp    80106a69 <alltraps>
...
80107b21:	6a 00                	push   $0x0
  pushl $251
80107b23:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107b28:	e9 3c ef ff ff       	jmp    80106a69 <alltraps>
...
80107b2d:	6a 00                	push   $0x0
  pushl $252
80107b2f:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107b34:	e9 30 ef ff ff       	jmp    80106a69 <alltraps>
...
80107b39:	6a 00                	push   $0x0
  pushl $253
80107b3b:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107b40:	e9 24 ef ff ff       	jmp    80106a69 <alltraps>
...
80107b45:	6a 00                	push   $0x0
  pushl $254
80107b47:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107b4c:	e9 18 ef ff ff       	jmp    80106a69 <alltraps>
...
80107b51:	6a 00                	push   $0x0
  pushl $255
80107b53:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107b58:	e9 0c ef ff ff       	jmp    80106a69 <alltraps>
...
80107b60:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107b63:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b66:	83 e8 01             	sub    $0x1,%eax
80107b69:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
...
80107b7a:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107b7e:	8d 45 fa             	lea    -0x6(%ebp),%eax
...
80107bda:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107bdd:	e8 a3 b2 ff ff       	call   80102e85 <cpunum>
80107be2:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107be8:	05 80 33 11 80       	add    $0x80113380,%eax
80107bed:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107bf0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bf3:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107bf9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bfc:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107c02:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c05:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107c09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c0c:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107c10:	83 e2 f0             	and    $0xfffffff0,%edx
80107c13:	83 ca 0a             	or     $0xa,%edx
80107c16:	88 50 7d             	mov    %dl,0x7d(%eax)
80107c19:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c1c:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107c20:	83 ca 10             	or     $0x10,%edx
...
80107cfc:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d03:	83 ca 0f             	or     $0xf,%edx
80107d06:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107d0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d0f:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d16:	83 e2 ef             	and    $0xffffffef,%edx
80107d19:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
...
80107d5b:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
...
80107e3f:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107e46:	ff ff 
80107e48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e4b:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107e52:	00 00 
80107e54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e57:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107e5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e61:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107e68:	83 e2 f0             	and    $0xfffffff0,%edx
80107e6b:	83 ca 02             	or     $0x2,%edx
80107e6e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107e74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e77:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107e7e:	83 ca 10             	or     $0x10,%edx
80107e81:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107e87:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e8a:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107e91:	83 ca 60             	or     $0x60,%edx
80107e94:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107e9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e9d:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107ea4:	83 ca 80             	or     $0xffffff80,%edx
80107ea7:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ead:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eb0:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107eb7:	83 ca 0f             	or     $0xf,%edx
80107eba:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107ec0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ec3:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107eca:	83 e2 ef             	and    $0xffffffef,%edx
80107ecd:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107ed3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ed6:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107edd:	83 e2 df             	and    $0xffffffdf,%edx
80107ee0:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107ee6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee9:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107ef0:	83 ca 40             	or     $0x40,%edx
80107ef3:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107ef9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107efc:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f03:	83 ca 80             	or     $0xffffff80,%edx
80107f06:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f0f:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)
...
80107f28:	c1 e8 10             	shr    $0x10,%eax
80107f2b:	89 c1                	mov    %eax,%ecx
80107f2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f30:	05 b4 00 00 00       	add    $0xb4,%eax
80107f35:	c1 e8 18             	shr    $0x18,%eax
80107f38:	89 c2                	mov    %eax,%edx
80107f3a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f3d:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107f44:	00 00 
80107f46:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f49:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107f50:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f53:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107f59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f5c:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107f63:	83 e1 f0             	and    $0xfffffff0,%ecx
80107f66:	83 c9 02             	or     $0x2,%ecx
80107f69:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107f6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f72:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107f79:	83 c9 10             	or     $0x10,%ecx
80107f7c:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107f82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f85:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107f8c:	83 e1 9f             	and    $0xffffff9f,%ecx
80107f8f:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107f95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f98:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107f9f:	83 c9 80             	or     $0xffffff80,%ecx
80107fa2:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fa8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fab:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107fb2:	83 e1 f0             	and    $0xfffffff0,%ecx
80107fb5:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107fbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fbe:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107fc5:	83 e1 ef             	and    $0xffffffef,%ecx
80107fc8:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107fce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd1:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107fd8:	83 e1 df             	and    $0xffffffdf,%ecx
80107fdb:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107fe1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe4:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107feb:	83 c9 40             	or     $0x40,%ecx
80107fee:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107ff4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff7:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ffe:	83 c9 80             	or     $0xffffff80,%ecx
80108001:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108007:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800a:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108010:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108013:	83 c0 70             	add    $0x70,%eax
80108016:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
8010801d:	00 
8010801e:	89 04 24             	mov    %eax,(%esp)
80108021:	e8 37 fb ff ff       	call   80107b5d <lgdt>
  loadgs(SEG_KCPU << 3);
80108026:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
8010802d:	e8 6a fb ff ff       	call   80107b9c <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108032:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108035:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
8010803b:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80108042:	00 00 00 00 
}
80108046:	83 c4 24             	add    $0x24,%esp
80108049:	5b                   	pop    %ebx
8010804a:	5d                   	pop    %ebp
8010804b:	c3                   	ret    
...
80108055:	c1 e8 16             	shr    $0x16,%eax
80108058:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
8010806c:	83 e0 01             	and    $0x1,%eax
8010806f:	85 c0                	test   %eax,%eax
80108071:	74 17                	je     8010808a <walkpgdir+0x3e>
...
80108080:	e8 44 fb ff ff       	call   80107bc9 <p2v>
80108085:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108088:	eb 4b                	jmp    801080d5 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010808a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010808e:	74 0e                	je     8010809e <walkpgdir+0x52>
80108090:	e8 5a aa ff ff       	call   80102aef <kalloc>
80108095:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108098:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010809c:	75 07                	jne    801080a5 <walkpgdir+0x59>
      return 0;
8010809e:	b8 00 00 00 00       	mov    $0x0,%eax
801080a3:	eb 47                	jmp    801080ec <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801080a5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080ac:	00 
801080ad:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801080b4:	00 
801080b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b8:	89 04 24             	mov    %eax,(%esp)
801080bb:	e8 13 d5 ff ff       	call   801055d3 <memset>
...
801080c6:	e8 f1 fa ff ff       	call   80107bbc <v2p>
801080cb:	83 c8 07             	or     $0x7,%eax
801080ce:	89 c2                	mov    %eax,%edx
801080d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080d3:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
801080d5:	8b 45 0c             	mov    0xc(%ebp),%eax
801080d8:	c1 e8 0c             	shr    $0xc,%eax
801080db:	25 ff 03 00 00       	and    $0x3ff,%eax
...
801080f7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801080fc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801080ff:	8b 55 0c             	mov    0xc(%ebp),%edx
80108102:	8b 45 10             	mov    0x10(%ebp),%eax
80108105:	01 d0                	add    %edx,%eax
80108107:	83 e8 01             	sub    $0x1,%eax
8010810a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010810f:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108112:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108119:	00 
...
80108127:	e8 20 ff ff ff       	call   8010804c <walkpgdir>
8010812c:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010812f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108133:	75 07                	jne    8010813c <mappages+0x4e>
      return -1;
80108135:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010813a:	eb 48                	jmp    80108184 <mappages+0x96>
    if(*pte & PTE_P)
8010813c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010813f:	8b 00                	mov    (%eax),%eax
80108141:	83 e0 01             	and    $0x1,%eax
80108144:	85 c0                	test   %eax,%eax
80108146:	74 0c                	je     80108154 <mappages+0x66>
      panic("remap");
80108148:	c7 04 24 cc 8f 10 80 	movl   $0x80108fcc,(%esp)
8010814f:	e8 e6 83 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
...
8010816a:	75 08                	jne    80108174 <mappages+0x86>
      break;
8010816c:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80108172:	eb 10                	jmp    80108184 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
80108174:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
8010817b:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80108182:	eb 8e                	jmp    80108112 <mappages+0x24>
  return 0;
}
80108184:	c9                   	leave  
80108185:	c3                   	ret    
...
8010818a:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
8010818d:	e8 5d a9 ff ff       	call   80102aef <kalloc>
80108192:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108195:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108199:	75 0a                	jne    801081a5 <setupkvm+0x1f>
    return 0;
8010819b:	b8 00 00 00 00       	mov    $0x0,%eax
801081a0:	e9 98 00 00 00       	jmp    8010823d <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
801081a5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081ac:	00 
801081ad:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801081b4:	00 
801081b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081b8:	89 04 24             	mov    %eax,(%esp)
801081bb:	e8 13 d4 ff ff       	call   801055d3 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
801081c0:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
801081c7:	e8 fd f9 ff ff       	call   80107bc9 <p2v>
801081cc:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
801081d1:	76 0c                	jbe    801081df <setupkvm+0x59>
    panic("PHYSTOP too high");
801081d3:	c7 04 24 d2 8f 10 80 	movl   $0x80108fd2,(%esp)
801081da:	e8 5b 83 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801081df:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
801081e6:	eb 49                	jmp    80108231 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
801081e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081eb:	8b 48 0c             	mov    0xc(%eax),%ecx
801081ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f1:	8b 50 04             	mov    0x4(%eax),%edx
801081f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f7:	8b 58 08             	mov    0x8(%eax),%ebx
801081fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081fd:	8b 40 04             	mov    0x4(%eax),%eax
80108200:	29 c3                	sub    %eax,%ebx
80108202:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108205:	8b 00                	mov    (%eax),%eax
80108207:	89 4c 24 10          	mov    %ecx,0x10(%esp)
8010820b:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010820f:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108213:	89 44 24 04          	mov    %eax,0x4(%esp)
80108217:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010821a:	89 04 24             	mov    %eax,(%esp)
8010821d:	e8 cc fe ff ff       	call   801080ee <mappages>
80108222:	85 c0                	test   %eax,%eax
80108224:	79 07                	jns    8010822d <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80108226:	b8 00 00 00 00       	mov    $0x0,%eax
8010822b:	eb 10                	jmp    8010823d <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010822d:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108231:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
80108238:	72 ae                	jb     801081e8 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
8010823d:	83 c4 34             	add    $0x34,%esp
80108240:	5b                   	pop    %ebx
80108241:	5d                   	pop    %ebp
80108242:	c3                   	ret    
...
80108246:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108249:	e8 38 ff ff ff       	call   80108186 <setupkvm>
8010824e:	a3 58 aa 11 80       	mov    %eax,0x8011aa58
  switchkvm();
80108253:	e8 02 00 00 00       	call   8010825a <switchkvm>
}
80108258:	c9                   	leave  
80108259:	c3                   	ret    
...
8010825d:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
80108260:	a1 58 aa 11 80       	mov    0x8011aa58,%eax
80108265:	89 04 24             	mov    %eax,(%esp)
80108268:	e8 4f f9 ff ff       	call   80107bbc <v2p>
8010826d:	89 04 24             	mov    %eax,(%esp)
80108270:	e8 3c f9 ff ff       	call   80107bb1 <lcr3>
}
80108275:	c9                   	leave  
80108276:	c3                   	ret    
...
8010827b:	83 ec 14             	sub    $0x14,%esp
  pushcli();
8010827e:	e8 50 d2 ff ff       	call   801054d3 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80108283:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108289:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108290:	83 c2 08             	add    $0x8,%edx
80108293:	89 d3                	mov    %edx,%ebx
80108295:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010829c:	83 c2 08             	add    $0x8,%edx
8010829f:	c1 ea 10             	shr    $0x10,%edx
801082a2:	89 d1                	mov    %edx,%ecx
801082a4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801082ab:	83 c2 08             	add    $0x8,%edx
801082ae:	c1 ea 18             	shr    $0x18,%edx
801082b1:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
801082b8:	67 00 
801082ba:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
801082c1:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
801082c7:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801082ce:	83 e1 f0             	and    $0xfffffff0,%ecx
801082d1:	83 c9 09             	or     $0x9,%ecx
801082d4:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801082da:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801082e1:	83 c9 10             	or     $0x10,%ecx
801082e4:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801082ea:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801082f1:	83 e1 9f             	and    $0xffffff9f,%ecx
801082f4:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801082fa:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108301:	83 c9 80             	or     $0xffffff80,%ecx
80108304:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010830a:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108311:	83 e1 f0             	and    $0xfffffff0,%ecx
80108314:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010831a:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108321:	83 e1 ef             	and    $0xffffffef,%ecx
80108324:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010832a:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108331:	83 e1 df             	and    $0xffffffdf,%ecx
80108334:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010833a:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108341:	83 c9 40             	or     $0x40,%ecx
80108344:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010834a:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108351:	83 e1 7f             	and    $0x7f,%ecx
80108354:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010835a:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80108360:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108366:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
8010836d:	83 e2 ef             	and    $0xffffffef,%edx
80108370:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80108376:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010837c:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80108382:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108388:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010838f:	8b 52 08             	mov    0x8(%edx),%edx
80108392:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108398:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
8010839b:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
801083a2:	e8 df f7 ff ff       	call   80107b86 <ltr>
  if(p->pgdir == 0)
801083a7:	8b 45 08             	mov    0x8(%ebp),%eax
801083aa:	8b 40 04             	mov    0x4(%eax),%eax
801083ad:	85 c0                	test   %eax,%eax
801083af:	75 0c                	jne    801083bd <switchuvm+0x146>
    panic("switchuvm: no pgdir");
801083b1:	c7 04 24 e3 8f 10 80 	movl   $0x80108fe3,(%esp)
801083b8:	e8 7d 81 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
801083bd:	8b 45 08             	mov    0x8(%ebp),%eax
801083c0:	8b 40 04             	mov    0x4(%eax),%eax
801083c3:	89 04 24             	mov    %eax,(%esp)
801083c6:	e8 f1 f7 ff ff       	call   80107bbc <v2p>
801083cb:	89 04 24             	mov    %eax,(%esp)
801083ce:	e8 de f7 ff ff       	call   80107bb1 <lcr3>
  popcli();
801083d3:	e8 3f d1 ff ff       	call   80105517 <popcli>
}
801083d8:	83 c4 14             	add    $0x14,%esp
801083db:	5b                   	pop    %ebx
801083dc:	5d                   	pop    %ebp
801083dd:	c3                   	ret    
...
801083e1:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
801083e4:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801083eb:	76 0c                	jbe    801083f9 <inituvm+0x1b>
    panic("inituvm: more than a page");
801083ed:	c7 04 24 f7 8f 10 80 	movl   $0x80108ff7,(%esp)
801083f4:	e8 41 81 ff ff       	call   8010053a <panic>
  mem = kalloc();
801083f9:	e8 f1 a6 ff ff       	call   80102aef <kalloc>
801083fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80108401:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108408:	00 
80108409:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108410:	00 
80108411:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108414:	89 04 24             	mov    %eax,(%esp)
80108417:	e8 b7 d1 ff ff       	call   801055d3 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010841c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010841f:	89 04 24             	mov    %eax,(%esp)
80108422:	e8 95 f7 ff ff       	call   80107bbc <v2p>
80108427:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010842e:	00 
8010842f:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108433:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010843a:	00 
8010843b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108442:	00 
80108443:	8b 45 08             	mov    0x8(%ebp),%eax
80108446:	89 04 24             	mov    %eax,(%esp)
80108449:	e8 a0 fc ff ff       	call   801080ee <mappages>
  memmove(mem, init, sz);
8010844e:	8b 45 10             	mov    0x10(%ebp),%eax
80108451:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108462:	e8 3b d2 ff ff       	call   801056a2 <memmove>
}
80108467:	c9                   	leave  
80108468:	c3                   	ret    
...
80108473:	25 ff 0f 00 00       	and    $0xfff,%eax
80108478:	85 c0                	test   %eax,%eax
8010847a:	74 0c                	je     80108488 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
8010847c:	c7 04 24 14 90 10 80 	movl   $0x80109014,(%esp)
80108483:	e8 b2 80 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108488:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010848f:	e9 a9 00 00 00       	jmp    8010853d <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108494:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108497:	8b 55 0c             	mov    0xc(%ebp),%edx
8010849a:	01 d0                	add    %edx,%eax
8010849c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801084a3:	00 
801084a4:	89 44 24 04          	mov    %eax,0x4(%esp)
801084a8:	8b 45 08             	mov    0x8(%ebp),%eax
801084ab:	89 04 24             	mov    %eax,(%esp)
801084ae:	e8 99 fb ff ff       	call   8010804c <walkpgdir>
801084b3:	89 45 ec             	mov    %eax,-0x14(%ebp)
801084b6:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801084ba:	75 0c                	jne    801084c8 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
801084bc:	c7 04 24 37 90 10 80 	movl   $0x80109037,(%esp)
801084c3:	e8 72 80 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
801084c8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084cb:	8b 00                	mov    (%eax),%eax
801084cd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801084d2:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
801084d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084d8:	8b 55 18             	mov    0x18(%ebp),%edx
801084db:	29 c2                	sub    %eax,%edx
801084dd:	89 d0                	mov    %edx,%eax
801084df:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801084e4:	77 0f                	ja     801084f5 <loaduvm+0x8c>
      n = sz - i;
801084e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084e9:	8b 55 18             	mov    0x18(%ebp),%edx
801084ec:	29 c2                	sub    %eax,%edx
801084ee:	89 d0                	mov    %edx,%eax
801084f0:	89 45 f0             	mov    %eax,-0x10(%ebp)
801084f3:	eb 07                	jmp    801084fc <loaduvm+0x93>
    else
      n = PGSIZE;
801084f5:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801084fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084ff:	8b 55 14             	mov    0x14(%ebp),%edx
80108502:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108505:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108508:	89 04 24             	mov    %eax,(%esp)
8010850b:	e8 b9 f6 ff ff       	call   80107bc9 <p2v>
80108510:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108513:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108517:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010851b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010851f:	8b 45 10             	mov    0x10(%ebp),%eax
80108522:	89 04 24             	mov    %eax,(%esp)
80108525:	e8 4b 98 ff ff       	call   80101d75 <readi>
8010852a:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010852d:	74 07                	je     80108536 <loaduvm+0xcd>
      return -1;
8010852f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108534:	eb 18                	jmp    8010854e <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80108536:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010853d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108540:	3b 45 18             	cmp    0x18(%ebp),%eax
80108543:	0f 82 4b ff ff ff    	jb     80108494 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
8010854e:	83 c4 24             	add    $0x24,%esp
80108551:	5b                   	pop    %ebx
80108552:	5d                   	pop    %ebp
80108553:	c3                   	ret    
...
80108557:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
8010855f:	79 0a                	jns    8010856b <allocuvm+0x17>
    return 0;
80108561:	b8 00 00 00 00       	mov    $0x0,%eax
80108566:	e9 c1 00 00 00       	jmp    8010862c <allocuvm+0xd8>
  if(newsz < oldsz)
8010856b:	8b 45 10             	mov    0x10(%ebp),%eax
8010856e:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108571:	73 08                	jae    8010857b <allocuvm+0x27>
    return oldsz;
80108573:	8b 45 0c             	mov    0xc(%ebp),%eax
80108576:	e9 b1 00 00 00       	jmp    8010862c <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
8010857b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010857e:	05 ff 0f 00 00       	add    $0xfff,%eax
80108583:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108588:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010858b:	e9 8d 00 00 00       	jmp    8010861d <allocuvm+0xc9>
    mem = kalloc();
80108590:	e8 5a a5 ff ff       	call   80102aef <kalloc>
80108595:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108598:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010859c:	75 2c                	jne    801085ca <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010859e:	c7 04 24 55 90 10 80 	movl   $0x80109055,(%esp)
801085a5:	e8 f6 7d ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801085aa:	8b 45 0c             	mov    0xc(%ebp),%eax
801085ad:	89 44 24 08          	mov    %eax,0x8(%esp)
801085b1:	8b 45 10             	mov    0x10(%ebp),%eax
801085b4:	89 44 24 04          	mov    %eax,0x4(%esp)
801085b8:	8b 45 08             	mov    0x8(%ebp),%eax
801085bb:	89 04 24             	mov    %eax,(%esp)
801085be:	e8 6b 00 00 00       	call   8010862e <deallocuvm>
      return 0;
801085c3:	b8 00 00 00 00       	mov    $0x0,%eax
801085c8:	eb 62                	jmp    8010862c <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
801085ca:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801085d1:	00 
801085d2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801085d9:	00 
801085da:	8b 45 f0             	mov    -0x10(%ebp),%eax
801085dd:	89 04 24             	mov    %eax,(%esp)
801085e0:	e8 ee cf ff ff       	call   801055d3 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801085e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801085e8:	89 04 24             	mov    %eax,(%esp)
801085eb:	e8 cc f5 ff ff       	call   80107bbc <v2p>
801085f0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801085f3:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801085fa:	00 
801085fb:	89 44 24 0c          	mov    %eax,0xc(%esp)
801085ff:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108606:	00 
80108607:	89 54 24 04          	mov    %edx,0x4(%esp)
8010860b:	8b 45 08             	mov    0x8(%ebp),%eax
8010860e:	89 04 24             	mov    %eax,(%esp)
80108611:	e8 d8 fa ff ff       	call   801080ee <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108616:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010861d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108620:	3b 45 10             	cmp    0x10(%ebp),%eax
80108623:	0f 82 67 ff ff ff    	jb     80108590 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
80108629:	8b 45 10             	mov    0x10(%ebp),%eax
}
8010862c:	c9                   	leave  
8010862d:	c3                   	ret    
...
80108631:	83 ec 28             	sub    $0x28,%esp
  ...
  if(newsz >= oldsz)
80108634:	8b 45 10             	mov    0x10(%ebp),%eax
80108637:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010863a:	72 08                	jb     80108644 <deallocuvm+0x16>
    return oldsz;
8010863c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010863f:	e9 a4 00 00 00       	jmp    801086e8 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108644:	8b 45 10             	mov    0x10(%ebp),%eax
80108647:	05 ff 0f 00 00       	add    $0xfff,%eax
8010864c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108651:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108654:	e9 80 00 00 00       	jmp    801086d9 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108659:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010865c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108663:	00 
80108664:	89 44 24 04          	mov    %eax,0x4(%esp)
80108668:	8b 45 08             	mov    0x8(%ebp),%eax
8010866b:	89 04 24             	mov    %eax,(%esp)
8010866e:	e8 d9 f9 ff ff       	call   8010804c <walkpgdir>
80108673:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108676:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010867a:	75 09                	jne    80108685 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010867c:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108683:	eb 4d                	jmp    801086d2 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108685:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108688:	8b 00                	mov    (%eax),%eax
8010868a:	83 e0 01             	and    $0x1,%eax
8010868d:	85 c0                	test   %eax,%eax
8010868f:	74 41                	je     801086d2 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108691:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108694:	8b 00                	mov    (%eax),%eax
80108696:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010869b:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
8010869e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801086a2:	75 0c                	jne    801086b0 <deallocuvm+0x82>
        panic("kfree");
801086a4:	c7 04 24 6d 90 10 80 	movl   $0x8010906d,(%esp)
801086ab:	e8 8a 7e ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
801086b0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801086b3:	89 04 24             	mov    %eax,(%esp)
801086b6:	e8 0e f5 ff ff       	call   80107bc9 <p2v>
801086bb:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801086be:	8b 45 e8             	mov    -0x18(%ebp),%eax
801086c1:	89 04 24             	mov    %eax,(%esp)
801086c4:	e8 8d a3 ff ff       	call   80102a56 <kfree>
      *pte = 0;
...
801086cc:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801086d2:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801086d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086dc:	3b 45 0c             	cmp    0xc(%ebp),%eax
801086df:	0f 82 74 ff ff ff    	jb     80108659 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801086ed:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
801086f0:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801086f4:	75 0c                	jne    80108702 <freevm+0x18>
    panic("freevm: no pgdir");
801086f6:	c7 04 24 73 90 10 80 	movl   $0x80109073,(%esp)
801086fd:	e8 38 7e ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108702:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108709:	00 
8010870a:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108711:	80 
80108712:	8b 45 08             	mov    0x8(%ebp),%eax
80108715:	89 04 24             	mov    %eax,(%esp)
80108718:	e8 11 ff ff ff       	call   8010862e <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010871d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108724:	eb 48                	jmp    8010876e <freevm+0x84>
    if(pgdir[i] & PTE_P){
80108726:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108729:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
8010873c:	74 2c                	je     8010876a <freevm+0x80>
...
80108765:	e8 ec a2 ff ff       	call   80102a56 <kfree>
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
8010876a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010876e:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108775:	76 af                	jbe    80108726 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
8010877d:	e8 d4 a2 ff ff       	call   80102a56 <kfree>
}
80108782:	c9                   	leave  
80108783:	c3                   	ret    
...
80108787:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
8010878a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108791:	00 
80108792:	8b 45 0c             	mov    0xc(%ebp),%eax
80108795:	89 44 24 04          	mov    %eax,0x4(%esp)
80108799:	8b 45 08             	mov    0x8(%ebp),%eax
8010879c:	89 04 24             	mov    %eax,(%esp)
8010879f:	e8 a8 f8 ff ff       	call   8010804c <walkpgdir>
801087a4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801087a7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801087ab:	75 0c                	jne    801087b9 <clearpteu+0x35>
    panic("clearpteu");
801087ad:	c7 04 24 84 90 10 80 	movl   $0x80109084,(%esp)
801087b4:	e8 81 7d ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
801087b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087bc:	8b 00                	mov    (%eax),%eax
801087be:	83 e0 fb             	and    $0xfffffffb,%eax
801087c1:	89 c2                	mov    %eax,%edx
801087c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087c6:	89 10                	mov    %edx,(%eax)
}
801087c8:	c9                   	leave  
801087c9:	c3                   	ret    
...
801087ce:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801087d1:	e8 b0 f9 ff ff       	call   80108186 <setupkvm>
...
801087e4:	e9 fd 00 00 00       	jmp    801088e6 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
801087e9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801087f0:	e9 d0 00 00 00       	jmp    801088c5 <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801087f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087f8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801087ff:	00 
80108800:	89 44 24 04          	mov    %eax,0x4(%esp)
80108804:	8b 45 08             	mov    0x8(%ebp),%eax
80108807:	89 04 24             	mov    %eax,(%esp)
8010880a:	e8 3d f8 ff ff       	call   8010804c <walkpgdir>
8010880f:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108812:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108816:	75 0c                	jne    80108824 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108818:	c7 04 24 8e 90 10 80 	movl   $0x8010908e,(%esp)
8010881f:	e8 16 7d ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
80108824:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108827:	8b 00                	mov    (%eax),%eax
80108829:	83 e0 01             	and    $0x1,%eax
8010882c:	85 c0                	test   %eax,%eax
8010882e:	75 0c                	jne    8010883c <copyuvm+0x72>
      panic("copyuvm: page not present");
80108830:	c7 04 24 a8 90 10 80 	movl   $0x801090a8,(%esp)
80108837:	e8 fe 7c ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
80108853:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108856:	e8 94 a2 ff ff       	call   80102aef <kalloc>
8010885b:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010885e:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108862:	75 02                	jne    80108866 <copyuvm+0x9c>
      goto bad;
80108864:	eb 70                	jmp    801088d6 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108866:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108869:	89 04 24             	mov    %eax,(%esp)
8010886c:	e8 58 f3 ff ff       	call   80107bc9 <p2v>
80108871:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108878:	00 
80108879:	89 44 24 04          	mov    %eax,0x4(%esp)
8010887d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108880:	89 04 24             	mov    %eax,(%esp)
80108883:	e8 1a ce ff ff       	call   801056a2 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108888:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
8010888b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010888e:	89 04 24             	mov    %eax,(%esp)
80108891:	e8 26 f3 ff ff       	call   80107bbc <v2p>
80108896:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108899:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010889d:	89 44 24 0c          	mov    %eax,0xc(%esp)
801088a1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801088a8:	00 
801088a9:	89 54 24 04          	mov    %edx,0x4(%esp)
801088ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088b0:	89 04 24             	mov    %eax,(%esp)
801088b3:	e8 36 f8 ff ff       	call   801080ee <mappages>
801088b8:	85 c0                	test   %eax,%eax
801088ba:	79 02                	jns    801088be <copyuvm+0xf4>
      goto bad;
801088bc:	eb 18                	jmp    801088d6 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
...
801088cb:	0f 82 24 ff ff ff    	jb     801087f5 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
801088d4:	eb 10                	jmp    801088e6 <copyuvm+0x11c>

bad:
  freevm(d);
801088d6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088d9:	89 04 24             	mov    %eax,(%esp)
801088dc:	e8 09 fe ff ff       	call   801086ea <freevm>
  return 0;
801088e1:	b8 00 00 00 00       	mov    $0x0,%eax
}
801088e6:	83 c4 44             	add    $0x44,%esp
801088e9:	5b                   	pop    %ebx
801088ea:	5d                   	pop    %ebp
801088eb:	c3                   	ret    
...
801088ef:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
801088f2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801088f9:	00 
801088fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801088fd:	89 44 24 04          	mov    %eax,0x4(%esp)
80108901:	8b 45 08             	mov    0x8(%ebp),%eax
80108904:	89 04 24             	mov    %eax,(%esp)
80108907:	e8 40 f7 ff ff       	call   8010804c <walkpgdir>
...
80108919:	75 07                	jne    80108922 <uva2ka+0x36>
    return 0;
8010891b:	b8 00 00 00 00       	mov    $0x0,%eax
80108920:	eb 25                	jmp    80108947 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108922:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108925:	8b 00                	mov    (%eax),%eax
80108927:	83 e0 04             	and    $0x4,%eax
8010892a:	85 c0                	test   %eax,%eax
8010892c:	75 07                	jne    80108935 <uva2ka+0x49>
    return 0;
8010892e:	b8 00 00 00 00       	mov    $0x0,%eax
80108933:	eb 12                	jmp    80108947 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108935:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108938:	8b 00                	mov    (%eax),%eax
8010893a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010893f:	89 04 24             	mov    %eax,(%esp)
80108942:	e8 82 f2 ff ff       	call   80107bc9 <p2v>
}
80108947:	c9                   	leave  
80108948:	c3                   	ret    
...
80108952:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108955:	e9 87 00 00 00       	jmp    801089e1 <copyout+0x98>
...
80108968:	89 44 24 04          	mov    %eax,0x4(%esp)
8010896c:	8b 45 08             	mov    0x8(%ebp),%eax
8010896f:	89 04 24             	mov    %eax,(%esp)
80108972:	e8 75 ff ff ff       	call   801088ec <uva2ka>
80108977:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
8010897a:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
8010897e:	75 07                	jne    80108987 <copyout+0x3e>
      return -1;
80108980:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108985:	eb 69                	jmp    801089f0 <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108987:	8b 45 0c             	mov    0xc(%ebp),%eax
8010898a:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010898d:	29 c2                	sub    %eax,%edx
8010898f:	89 d0                	mov    %edx,%eax
80108991:	05 00 10 00 00       	add    $0x1000,%eax
80108996:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108999:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010899c:	3b 45 14             	cmp    0x14(%ebp),%eax
8010899f:	76 06                	jbe    801089a7 <copyout+0x5e>
      n = len;
801089a1:	8b 45 14             	mov    0x14(%ebp),%eax
801089a4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801089a7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089aa:	8b 55 0c             	mov    0xc(%ebp),%edx
801089ad:	29 c2                	sub    %eax,%edx
801089af:	8b 45 e8             	mov    -0x18(%ebp),%eax
801089b2:	01 c2                	add    %eax,%edx
801089b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089b7:	89 44 24 08          	mov    %eax,0x8(%esp)
801089bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089be:	89 44 24 04          	mov    %eax,0x4(%esp)
801089c2:	89 14 24             	mov    %edx,(%esp)
801089c5:	e8 d8 cc ff ff       	call   801056a2 <memmove>
    len -= n;
801089ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089cd:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
801089d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089d3:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
801089d6:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089d9:	05 00 10 00 00       	add    $0x1000,%eax
801089de:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
801089e1:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
801089e5:	0f 85 6f ff ff ff    	jne    8010895a <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
