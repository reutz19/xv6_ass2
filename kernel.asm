...
8010003a:	c7 44 24 04 04 85 10 	movl   $0x80108504,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100049:	e8 91 4e 00 00       	call   80104edf <initlock>
...
801000bd:	e8 3e 4e 00 00       	call   80104f00 <acquire>
...
80100104:	e8 59 4e 00 00       	call   80104f62 <release>
        return b;
...
8010017c:	e8 e1 4d 00 00       	call   80104f62 <release>
      return b;
...
80100198:	c7 04 24 0b 85 10 80 	movl   $0x8010850b,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 1c 85 10 80 	movl   $0x8010851c,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 23 85 10 80 	movl   $0x80108523,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 bf 4c 00 00       	call   80104f00 <acquire>
...
8010029d:	e8 40 4a 00 00       	call   80104ce2 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 b4 4c 00 00       	call   80104f62 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 40 4b 00 00       	call   80104f00 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 2a 85 10 80 	movl   $0x8010852a,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 33 85 10 80 	movl   $0x80108533,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 2a 4a 00 00       	call   80104f62 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 3a 85 10 80 	movl   $0x8010853a,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 49 85 10 80 	movl   $0x80108549,(%esp)
...
8010058f:	e8 1d 4a 00 00       	call   80104fb1 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 4b 85 10 80 	movl   $0x8010854b,(%esp)
...
801006b2:	e8 6c 4b 00 00       	call   80105223 <memmove>
    pos -= 80;
...
801006e1:	e8 6e 4a 00 00       	call   80105154 <memset>
  }
...
80100776:	e8 c9 63 00 00       	call   80106b44 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 bd 63 00 00       	call   80106b44 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 b1 63 00 00       	call   80106b44 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 a4 63 00 00       	call   80106b44 <uartputc>
  cgaputc(c);
...
801007ba:	e8 41 47 00 00       	call   80104f00 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 96 45 00 00       	call   80104d85 <procdump>
      break;
...
801008f3:	e8 ea 43 00 00       	call   80104ce2 <wakeup>
        }
      }
      break;
...
80100914:	e8 49 46 00 00       	call   80104f62 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 c2 45 00 00       	call   80104f00 <acquire>
  while(n > 0){
...
80100959:	e8 04 46 00 00       	call   80104f62 <release>
        ilock(ip);
...
80100982:	e8 83 42 00 00       	call   80104c0a <sleep>
...
801009fe:	e8 5f 45 00 00       	call   80104f62 <release>
  ilock(ip);
...
80100a32:	e8 c9 44 00 00       	call   80104f00 <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 f1 44 00 00       	call   80104f62 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 4f 85 10 	movl   $0x8010854f,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a96:	e8 44 44 00 00       	call   80104edf <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 57 85 10 	movl   $0x80108557,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 80 07 11 80 	movl   $0x80110780,(%esp)
80100aaa:	e8 30 44 00 00       	call   80104edf <initlock>
...
80100b6e:	e9 76 03 00 00       	jmp    80100ee9 <exec+0x3fa>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 1d 71 00 00       	call   80107c95 <setupkvm>
...
80100c14:	e8 4a 74 00 00       	call   80108063 <allocuvm>
...
80100c52:	e8 21 73 00 00       	call   80107f78 <loaduvm>
...
80100cc0:	e8 9e 73 00 00       	call   80108063 <allocuvm>
...
80100ce5:	e8 a9 75 00 00       	call   80108293 <clearpteu>
  sp = sz;
...
80100d1b:	e8 9e 46 00 00       	call   801053be <strlen>
...
80100d44:	e8 75 46 00 00       	call   801053be <strlen>
...
80100d74:	e8 df 76 00 00       	call   80108458 <copyout>
...
80100e1b:	e8 38 76 00 00       	call   80108458 <copyout>
...
80100e73:	e8 fc 44 00 00       	call   80105374 <safestrcpy>
...
80100ed2:	e8 af 6e 00 00       	call   80107d86 <switchuvm>
  freevm(oldpgdir);
80100ed7:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eda:	89 04 24             	mov    %eax,(%esp)
80100edd:	e8 17 73 00 00       	call   801081f9 <freevm>
  return 0;
...
80100ef5:	e8 ff 72 00 00       	call   801081f9 <freevm>
  if(ip){
...
80100f1d:	c7 44 24 04 5d 85 10 	movl   $0x8010855d,0x4(%esp)
80100f24:	80 
80100f25:	c7 04 24 40 08 11 80 	movl   $0x80110840,(%esp)
80100f2c:	e8 ae 3f 00 00       	call   80104edf <initlock>
}
80100f31:	c9                   	leave  
80100f32:	c3                   	ret    
...
80100f40:	e8 bb 3f 00 00       	call   80104f00 <acquire>
...
80100f69:	e8 f4 3f 00 00       	call   80104f62 <release>
      return f;
...
80100f87:	e8 d6 3f 00 00       	call   80104f62 <release>
  return 0;
...
80100fa0:	e8 5b 3f 00 00       	call   80104f00 <acquire>
  if(f->ref < 1)
...
80100fad:	7f 0c                	jg     80100fbb <filedup+0x28>
    panic("filedup");
80100faf:	c7 04 24 64 85 10 80 	movl   $0x80108564,(%esp)
...
80100fd1:	e8 8c 3f 00 00       	call   80104f62 <release>
  return f;
...
80100fe8:	e8 13 3f 00 00       	call   80104f00 <acquire>
  if(f->ref < 1)
...
80100ff5:	7f 0c                	jg     80101003 <fileclose+0x28>
    panic("fileclose");
80100ff7:	c7 04 24 6c 85 10 80 	movl   $0x8010856c,(%esp)
...
80101023:	e8 3a 3f 00 00       	call   80104f62 <release>
...
8010106d:	e8 f0 3e 00 00       	call   80104f62 <release>
...
801011ac:	eb 0c                	jmp    801011ba <fileread+0xba>
  ...
  panic("fileread");
801011ae:	c7 04 24 76 85 10 80 	movl   $0x80108576,(%esp)
...
801012ba:	c7 04 24 7f 85 10 80 	movl   $0x8010857f,(%esp)
...
801012ea:	eb 0c                	jmp    801012f8 <filewrite+0x13c>
  ...
  panic("filewrite");
801012ec:	c7 04 24 8f 85 10 80 	movl   $0x8010858f,(%esp)
...
80101332:	e8 ec 3e 00 00       	call   80105223 <memmove>
  brelse(bp);
...
80101378:	e8 d7 3d 00 00       	call   80105154 <memset>
  log_write(bp);
...
801014d5:	c7 04 24 99 85 10 80 	movl   $0x80108599,(%esp)
...
80101567:	c7 04 24 af 85 10 80 	movl   $0x801085af,(%esp)
...
801015b7:	c7 44 24 04 c2 85 10 	movl   $0x801085c2,0x4(%esp)
801015be:	80 
801015bf:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801015c6:	e8 14 39 00 00       	call   80104edf <initlock>
}
801015cb:	c9                   	leave  
801015cc:	c3                   	ret    
...
80101648:	e8 07 3b 00 00       	call   80105154 <memset>
      dip->type = type;
...
8010169e:	c7 04 24 c9 85 10 80 	movl   $0x801085c9,(%esp)
...
80101747:	e8 d7 3a 00 00       	call   80105223 <memmove>
  log_write(bp);
...
80101771:	e8 8a 37 00 00       	call   80104f00 <acquire>
...
801017bb:	e8 a2 37 00 00       	call   80104f62 <release>
      return ip;
...
801017ee:	c7 04 24 db 85 10 80 	movl   $0x801085db,(%esp)
...
8010182c:	e8 31 37 00 00       	call   80104f62 <release>
...
80101843:	e8 b8 36 00 00       	call   80104f00 <acquire>
  ip->ref++;
...
8010185e:	e8 ff 36 00 00       	call   80104f62 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 eb 85 10 80 	movl   $0x801085eb,(%esp)
80101885:	e8 b0 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
80101891:	e8 6a 36 00 00       	call   80104f00 <acquire>
...
801018a6:	e8 5f 33 00 00       	call   80104c0a <sleep>
...
801018d0:	e8 8d 36 00 00       	call   80104f62 <release>
...
8010197b:	e8 a3 38 00 00       	call   80105223 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 f1 85 10 80 	movl   $0x801085f1,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 00 86 10 80 	movl   $0x80108600,(%esp)
801019e0:	e8 55 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801019ec:	e8 0f 35 00 00       	call   80104f00 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 d5 32 00 00       	call   80104ce2 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
80101a14:	e8 49 35 00 00       	call   80104f62 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 d3 34 00 00       	call   80104f00 <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 08 86 10 80 	movl   $0x80108608,(%esp)
...
80101a8a:	e8 d3 34 00 00       	call   80104f62 <release>
    itrunc(ip);
...
80101ab5:	e8 46 34 00 00       	call   80104f00 <acquire>
    ip->flags = 0;
...
80101aca:	e8 13 32 00 00       	call   80104ce2 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 78 34 00 00       	call   80104f62 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101c05:	c7 04 24 12 86 10 80 	movl   $0x80108612,(%esp)
...
80101ea6:	e8 78 33 00 00       	call   80105223 <memmove>
    brelse(bp);
...
80102005:	e8 19 32 00 00       	call   80105223 <memmove>
    log_write(bp);
...
80102083:	e8 3e 32 00 00       	call   801052c6 <strncmp>
}
80102088:	c9                   	leave  
80102089:	c3                   	ret    
...
8010209d:	c7 04 24 25 86 10 80 	movl   $0x80108625,(%esp)
...
801020d9:	74 0c                	je     801020e7 <dirlookup+0x5d>
      panic("dirlink read");
801020db:	c7 04 24 37 86 10 80 	movl   $0x80108637,(%esp)
...
801021be:	74 0c                	je     801021cc <dirlink+0x79>
      panic("dirlink read");
801021c0:	c7 04 24 37 86 10 80 	movl   $0x80108637,(%esp)
...
80102205:	e8 12 31 00 00       	call   8010531c <strncpy>
  de.inum = inum;
...
80102235:	74 0c                	je     80102243 <dirlink+0xf0>
    panic("dirlink");
80102237:	c7 04 24 44 86 10 80 	movl   $0x80108644,(%esp)
...
801022bc:	e8 62 2f 00 00       	call   80105223 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d7:	e8 47 2f 00 00       	call   80105223 <memmove>
    name[len] = 0;
...
80102526:	c7 44 24 04 4c 86 10 	movl   $0x8010864c,0x4(%esp)
8010252d:	80 
8010252e:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102535:	e8 a5 29 00 00       	call   80104edf <initlock>
  picenable(IRQ_IDE);
...
801025d0:	75 0c                	jne    801025de <idestart+0x18>
    panic("idestart");
801025d2:	c7 04 24 50 86 10 80 	movl   $0x80108650,(%esp)
...
801026f8:	e8 03 28 00 00       	call   80104f00 <acquire>
  if((b = idequeue) == 0){
...
80102712:	e8 4b 28 00 00       	call   80104f62 <release>
...
80102785:	e8 58 25 00 00       	call   80104ce2 <wakeup>
...
801027a7:	e8 b6 27 00 00       	call   80104f62 <release>
}
801027ac:	c9                   	leave  
801027ad:	c3                   	ret    
...
801027c0:	c7 04 24 59 86 10 80 	movl   $0x80108659,(%esp)
...
801027d9:	c7 04 24 6d 86 10 80 	movl   $0x8010866d,(%esp)
...
80102866:	e8 9f 23 00 00       	call   80104c0a <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
8010287f:	e8 de 26 00 00       	call   80104f62 <release>
}
80102884:	c9                   	leave  
80102885:	c3                   	ret    
...
8010290d:	c7 04 24 a0 86 10 80 	movl   $0x801086a0,(%esp)
...
801029c7:	c7 44 24 04 d2 86 10 	movl   $0x801086d2,0x4(%esp)
801029ce:	80 
801029cf:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
801029d6:	e8 04 25 00 00       	call   80104edf <initlock>
  kmem.use_lock = 0;
...
80102a68:	81 7d 08 3c 52 11 80 	cmpl   $0x8011523c,0x8(%ebp)
...
80102a81:	76 0c                	jbe    80102a8f <kfree+0x39>
    panic("kfree");
80102a83:	c7 04 24 d7 86 10 80 	movl   $0x801086d7,(%esp)
...
80102aa5:	e8 aa 26 00 00       	call   80105154 <memset>
...
80102aba:	e8 41 24 00 00       	call   80104f00 <acquire>
  r = (struct run*)v;
...
80102ae8:	e8 75 24 00 00       	call   80104f62 <release>
}
80102aed:	c9                   	leave  
80102aee:	c3                   	ret    
...
80102b05:	e8 f6 23 00 00       	call   80104f00 <acquire>
  r = kmem.freelist;
...
80102b32:	e8 2b 24 00 00       	call   80104f62 <release>
  return (char*)r;
...
80102eb2:	c7 04 24 e0 86 10 80 	movl   $0x801086e0,(%esp)
...
80103115:	e8 b1 20 00 00       	call   801051cb <memcmp>
...
80103215:	c7 44 24 04 0c 87 10 	movl   $0x8010870c,0x4(%esp)
8010321c:	80 
8010321d:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80103224:	e8 b6 1c 00 00       	call   80104edf <initlock>
  readsb(ROOTDEV, &sb);
...
801032d8:	e8 46 1f 00 00       	call   80105223 <memmove>
...
8010342a:	e8 d1 1a 00 00       	call   80104f00 <acquire>
  while(1){
    if(log.committing){
...
80103447:	e8 be 17 00 00       	call   80104c0a <sleep>
...
8010347b:	e8 8a 17 00 00       	call   80104c0a <sleep>
...
80103496:	e8 c7 1a 00 00       	call   80104f62 <release>
      break;
...
801034b5:	e8 46 1a 00 00       	call   80104f00 <acquire>
  log.outstanding -= 1;
...
801034d0:	c7 04 24 10 87 10 80 	movl   $0x80108710,(%esp)
...
801034ff:	e8 de 17 00 00       	call   80104ce2 <wakeup>
  }
  release(&log.lock);
80103504:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
8010350b:	e8 52 1a 00 00       	call   80104f62 <release>
...
801035bf:	e8 5f 1c 00 00       	call   80105223 <memmove>
...
8010364a:	c7 04 24 1f 87 10 80 	movl   $0x8010871f,(%esp)
...
8010365f:	c7 04 24 35 87 10 80 	movl   $0x80108735,(%esp)
80103666:	e8 cf ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
8010366b:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80103672:	e8 89 18 00 00       	call   80104f00 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801036e9:	e8 74 18 00 00       	call   80104f62 <release>
}
801036ee:	c9                   	leave  
801036ef:	c3                   	ret    
...
80103765:	c7 04 24 50 87 10 80 	movl   $0x80108750,(%esp)
...
80103780:	e8 af 32 00 00       	call   80106a34 <uartinit>
  pinit();         // process table
80103785:	e8 a3 0b 00 00       	call   8010432d <pinit>
  tvinit();        // trap vectors
8010378a:	e8 57 2e 00 00       	call   801065e6 <tvinit>
  binit();         // buffer cache
...
801037ac:	e8 80 2d 00 00       	call   80106531 <timerinit>
...
801037ca:	e8 91 0c 00 00       	call   80104460 <userinit>
...
801037d7:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801037da:	e8 8a 45 00 00       	call   80107d69 <switchkvm>
  seginit();
801037df:	e8 01 3f 00 00       	call   801076e5 <seginit>
  lapicinit();
...
80103804:	c7 04 24 67 87 10 80 	movl   $0x80108767,(%esp)
8010380b:	e8 90 cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
80103810:	e8 45 2f 00 00       	call   8010675a <idtinit>
...
80103830:	e8 17 12 00 00       	call   80104a4c <scheduler>
...
80103862:	e8 bc 19 00 00       	call   80105223 <memmove>
...
801039e3:	00 
801039e4:	c7 44 24 04 78 87 10 	movl   $0x80108778,0x4(%esp)
801039eb:	80 
801039ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039ef:	89 04 24             	mov    %eax,(%esp)
801039f2:	e8 d4 17 00 00       	call   801051cb <memcmp>
...
80103b24:	00 
80103b25:	c7 44 24 04 7d 87 10 	movl   $0x8010877d,0x4(%esp)
80103b2c:	80 
80103b2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b30:	89 04 24             	mov    %eax,(%esp)
80103b33:	e8 93 16 00 00       	call   801051cb <memcmp>
...
80103c01:	8b 04 85 c0 87 10 80 	mov    -0x7fef7840(,%eax,4),%eax
...
80103c3a:	c7 04 24 82 87 10 80 	movl   $0x80108782,(%esp)
...
80103ccd:	c7 04 24 a0 87 10 80 	movl   $0x801087a0,(%esp)
...
80103fc6:	c7 44 24 04 d4 87 10 	movl   $0x801087d4,0x4(%esp)
80103fcd:	80 
80103fce:	89 04 24             	mov    %eax,(%esp)
80103fd1:	e8 09 0f 00 00       	call   80104edf <initlock>
  (*f0)->type = FD_PIPE;
...
8010407d:	e8 7e 0e 00 00       	call   80104f00 <acquire>
  if(writable){
...
801040a0:	e8 3d 0c 00 00       	call   80104ce2 <wakeup>
...
801040bf:	e8 1e 0c 00 00       	call   80104ce2 <wakeup>
  }
...
801040e4:	e8 79 0e 00 00       	call   80104f62 <release>
    kfree((char*)p);
...
801040fc:	e8 61 0e 00 00       	call   80104f62 <release>
}
80104101:	c9                   	leave  
80104102:	c3                   	ret    
...
8010410f:	e8 ec 0d 00 00       	call   80104f00 <acquire>
  for(i = 0; i < n; i++){
...
80104142:	e8 1b 0e 00 00       	call   80104f62 <release>
        return -1;
...
8010415c:	e8 81 0b 00 00       	call   80104ce2 <wakeup>
...
80104174:	e8 91 0a 00 00       	call   80104c0a <sleep>
{
  int i;
...
801041dd:	e8 00 0b 00 00       	call   80104ce2 <wakeup>
  release(&p->lock);
801041e2:	8b 45 08             	mov    0x8(%ebp),%eax
801041e5:	89 04 24             	mov    %eax,(%esp)
801041e8:	e8 75 0d 00 00       	call   80104f62 <release>
  return n;
...
801041ff:	e8 fc 0c 00 00       	call   80104f00 <acquire>
...
80104219:	e8 44 0d 00 00       	call   80104f62 <release>
      return -1;
...
8010423b:	e8 ca 09 00 00       	call   80104c0a <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801042ca:	e8 13 0a 00 00       	call   80104ce2 <wakeup>
  release(&p->lock);
801042cf:	8b 45 08             	mov    0x8(%ebp),%eax
801042d2:	89 04 24             	mov    %eax,(%esp)
801042d5:	e8 88 0c 00 00       	call   80104f62 <release>
  return i;
...
80104333:	c7 44 24 04 d9 87 10 	movl   $0x801087d9,0x4(%esp)
8010433a:	80 
8010433b:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104342:	e8 98 0b 00 00       	call   80104edf <initlock>
}
80104347:	c9                   	leave  
80104348:	c3                   	ret    
...
8010438d:	eb 49                	jmp    801043d8 <allocproc+0x58>
    //if(p->state == UNUSED)
...
801043d0:	75 27                	jne    801043f9 <allocproc+0x79>
801043d2:	eb 14                	jmp    801043e8 <allocproc+0x68>
{
  struct proc *p;
  char *sp;
  ...
  //acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043d4:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
801043d8:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
801043df:	72 ae                	jb     8010438f <allocproc+0xf>
    //if(p->state == UNUSED)
    if(cas(&p->state, UNUSED, EMBRYO))
      goto found;
  //release(&ptable.lock);
...
801043e6:	eb 76                	jmp    8010445e <allocproc+0xde>
...
801043f7:	eb 65                	jmp    8010445e <allocproc+0xde>
  }
  sp = p->kstack + KSTACKSIZE;
801043f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043fc:	8b 40 08             	mov    0x8(%eax),%eax
801043ff:	05 00 10 00 00       	add    $0x1000,%eax
80104404:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80104407:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
8010440b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010440e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104411:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104414:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
80104418:	ba a1 65 10 80       	mov    $0x801065a1,%edx
8010441d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104420:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
80104422:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
80104426:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104429:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010442c:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
8010442f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104432:	8b 40 1c             	mov    0x1c(%eax),%eax
80104435:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010443c:	00 
8010443d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104444:	00 
80104445:	89 04 24             	mov    %eax,(%esp)
80104448:	e8 07 0d 00 00       	call   80105154 <memset>
  p->context->eip = (uint)forkret;
8010444d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104450:	8b 40 1c             	mov    0x1c(%eax),%eax
80104453:	ba de 4b 10 80       	mov    $0x80104bde,%edx
80104458:	89 50 10             	mov    %edx,0x10(%eax)
...
80104463:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
80104466:	e8 15 ff ff ff       	call   80104380 <allocproc>
8010446b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
8010446e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104471:	a3 48 b6 10 80       	mov    %eax,0x8010b648
  if((p->pgdir = setupkvm()) == 0)
80104476:	e8 1a 38 00 00       	call   80107c95 <setupkvm>
8010447b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010447e:	89 42 04             	mov    %eax,0x4(%edx)
80104481:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104484:	8b 40 04             	mov    0x4(%eax),%eax
80104487:	85 c0                	test   %eax,%eax
80104489:	75 0c                	jne    80104497 <userinit+0x37>
    panic("userinit: out of memory?");
8010448b:	c7 04 24 e0 87 10 80 	movl   $0x801087e0,(%esp)
80104492:	e8 a3 c0 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80104497:	ba 2c 00 00 00       	mov    $0x2c,%edx
8010449c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010449f:	8b 40 04             	mov    0x4(%eax),%eax
801044a2:	89 54 24 08          	mov    %edx,0x8(%esp)
801044a6:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
801044ad:	80 
801044ae:	89 04 24             	mov    %eax,(%esp)
801044b1:	e8 37 3a 00 00       	call   80107eed <inituvm>
  p->sz = PGSIZE;
801044b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044b9:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
801044bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044c2:	8b 40 18             	mov    0x18(%eax),%eax
801044c5:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
801044cc:	00 
801044cd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801044d4:	00 
801044d5:	89 04 24             	mov    %eax,(%esp)
801044d8:	e8 77 0c 00 00       	call   80105154 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
801044dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044e0:	8b 40 18             	mov    0x18(%eax),%eax
801044e3:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
801044e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044ec:	8b 40 18             	mov    0x18(%eax),%eax
801044ef:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
801044f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f8:	8b 40 18             	mov    0x18(%eax),%eax
801044fb:	8b 55 f4             	mov    -0xc(%ebp),%edx
801044fe:	8b 52 18             	mov    0x18(%edx),%edx
80104501:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104505:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
...
80104519:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
...
80104530:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80104537:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010453a:	8b 40 18             	mov    0x18(%eax),%eax
8010453d:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104544:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104547:	83 c0 6c             	add    $0x6c,%eax
8010454a:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104551:	00 
80104552:	c7 44 24 04 f9 87 10 	movl   $0x801087f9,0x4(%esp)
80104559:	80 
8010455a:	89 04 24             	mov    %eax,(%esp)
8010455d:	e8 12 0e 00 00       	call   80105374 <safestrcpy>
  p->cwd = namei("/");
80104562:	c7 04 24 02 88 10 80 	movl   $0x80108802,(%esp)
80104569:	e8 a5 de ff ff       	call   80102413 <namei>
8010456e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104571:	89 42 68             	mov    %eax,0x68(%edx)
...
8010458c:	8b 00                	mov    (%eax),%eax
8010458e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
80104591:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104595:	7e 34                	jle    801045cb <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
80104597:	8b 55 08             	mov    0x8(%ebp),%edx
8010459a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010459d:	01 c2                	add    %eax,%edx
8010459f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045a5:	8b 40 04             	mov    0x4(%eax),%eax
801045a8:	89 54 24 08          	mov    %edx,0x8(%esp)
801045ac:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045af:	89 54 24 04          	mov    %edx,0x4(%esp)
801045b3:	89 04 24             	mov    %eax,(%esp)
801045b6:	e8 a8 3a 00 00       	call   80108063 <allocuvm>
801045bb:	89 45 f4             	mov    %eax,-0xc(%ebp)
801045be:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801045c2:	75 41                	jne    80104605 <growproc+0x85>
      return -1;
801045c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045c9:	eb 58                	jmp    80104623 <growproc+0xa3>
  } else if(n < 0){
801045cb:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801045cf:	79 34                	jns    80104605 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
801045d1:	8b 55 08             	mov    0x8(%ebp),%edx
801045d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045d7:	01 c2                	add    %eax,%edx
801045d9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045df:	8b 40 04             	mov    0x4(%eax),%eax
801045e2:	89 54 24 08          	mov    %edx,0x8(%esp)
801045e6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045e9:	89 54 24 04          	mov    %edx,0x4(%esp)
801045ed:	89 04 24             	mov    %eax,(%esp)
801045f0:	e8 48 3b 00 00       	call   8010813d <deallocuvm>
801045f5:	89 45 f4             	mov    %eax,-0xc(%ebp)
801045f8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801045fc:	75 07                	jne    80104605 <growproc+0x85>
      return -1;
801045fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104603:	eb 1e                	jmp    80104623 <growproc+0xa3>
  }
  proc->sz = sz;
80104605:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
80104619:	e8 68 37 00 00       	call   80107d86 <switchuvm>
  return 0;
8010461e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104623:	c9                   	leave  
80104624:	c3                   	ret    
...
80104628:	57                   	push   %edi
80104629:	56                   	push   %esi
8010462a:	53                   	push   %ebx
8010462b:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
8010462e:	e8 4d fd ff ff       	call   80104380 <allocproc>
80104633:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104636:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010463a:	75 0a                	jne    80104646 <fork+0x21>
    return -1;
8010463c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104641:	e9 61 01 00 00       	jmp    801047a7 <fork+0x182>
...
80104657:	89 54 24 04          	mov    %edx,0x4(%esp)
8010465b:	89 04 24             	mov    %eax,(%esp)
8010465e:	e8 76 3c 00 00       	call   801082d9 <copyuvm>
80104663:	8b 55 e0             	mov    -0x20(%ebp),%edx
...
80104671:	75 2c                	jne    8010469f <fork+0x7a>
    kfree(np->kstack);
80104673:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104676:	8b 40 08             	mov    0x8(%eax),%eax
80104679:	89 04 24             	mov    %eax,(%esp)
8010467c:	e8 d5 e3 ff ff       	call   80102a56 <kfree>
    np->kstack = 0;
80104681:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104684:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
8010468b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010468e:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
80104695:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010469a:	e9 08 01 00 00       	jmp    801047a7 <fork+0x182>
  }
  np->sz = proc->sz;
8010469f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046a5:	8b 10                	mov    (%eax),%edx
801046a7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046aa:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
801046ac:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801046b3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046b6:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
...
801046c8:	89 c3                	mov    %eax,%ebx
801046ca:	b8 13 00 00 00       	mov    $0x13,%eax
801046cf:	89 d7                	mov    %edx,%edi
801046d1:	89 de                	mov    %ebx,%esi
801046d3:	89 c1                	mov    %eax,%ecx
801046d5:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801046d7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046da:	8b 40 18             	mov    0x18(%eax),%eax
801046dd:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
801046e4:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801046eb:	eb 3d                	jmp    8010472a <fork+0x105>
    if(proc->ofile[i])
801046ed:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046f3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801046f6:	83 c2 08             	add    $0x8,%edx
801046f9:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801046fd:	85 c0                	test   %eax,%eax
801046ff:	74 25                	je     80104726 <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
80104701:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104707:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010470a:	83 c2 08             	add    $0x8,%edx
8010470d:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104711:	89 04 24             	mov    %eax,(%esp)
80104714:	e8 7a c8 ff ff       	call   80100f93 <filedup>
80104719:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010471c:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010471f:	83 c1 08             	add    $0x8,%ecx
80104722:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
80104726:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
8010472a:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
8010472e:	7e bd                	jle    801046ed <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
80104730:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104736:	8b 40 68             	mov    0x68(%eax),%eax
80104739:	89 04 24             	mov    %eax,(%esp)
8010473c:	e8 f5 d0 ff ff       	call   80101836 <idup>
80104741:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104744:	89 42 68             	mov    %eax,0x68(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
80104747:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010474d:	8d 50 6c             	lea    0x6c(%eax),%edx
80104750:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104753:	83 c0 6c             	add    $0x6c,%eax
80104756:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010475d:	00 
8010475e:	89 54 24 04          	mov    %edx,0x4(%esp)
80104762:	89 04 24             	mov    %eax,(%esp)
80104765:	e8 0a 0c 00 00       	call   80105374 <safestrcpy>
  np->sighandler = proc->sighandler; 
8010476a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104770:	8b 50 7c             	mov    0x7c(%eax),%edx
80104773:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104776:	89 50 7c             	mov    %edx,0x7c(%eax)
  //copy signal handler
...
8010477f:	89 45 dc             	mov    %eax,-0x24(%ebp)
  ...
  acquire(&ptable.lock);
80104782:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104789:	e8 72 07 00 00       	call   80104f00 <acquire>
  np->state = RUNNABLE;
8010478e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104791:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
80104798:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
8010479f:	e8 be 07 00 00       	call   80104f62 <release>
...
801047bc:	a1 48 b6 10 80       	mov    0x8010b648,%eax
801047c1:	39 c2                	cmp    %eax,%edx
801047c3:	75 0c                	jne    801047d1 <exit+0x22>
    panic("init exiting");
801047c5:	c7 04 24 04 88 10 80 	movl   $0x80108804,(%esp)
801047cc:	e8 69 bd ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801047d1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801047d8:	eb 44                	jmp    8010481e <exit+0x6f>
    if(proc->ofile[fd]){
801047da:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047e0:	8b 55 f0             	mov    -0x10(%ebp),%edx
801047e3:	83 c2 08             	add    $0x8,%edx
801047e6:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801047ea:	85 c0                	test   %eax,%eax
801047ec:	74 2c                	je     8010481a <exit+0x6b>
...
8010481e:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104822:	7e b6                	jle    801047da <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80104824:	e8 f4 eb ff ff       	call   8010341d <begin_op>
  iput(proc->cwd);
80104829:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010482f:	8b 40 68             	mov    0x68(%eax),%eax
80104832:	89 04 24             	mov    %eax,(%esp)
80104835:	e8 e1 d1 ff ff       	call   80101a1b <iput>
  end_op();
8010483a:	e8 62 ec ff ff       	call   801034a1 <end_op>
  proc->cwd = 0;
8010483f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104845:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
8010484c:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104853:	e8 a8 06 00 00       	call   80104f00 <acquire>

  proc->state = ZOMBIE;
80104858:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010485e:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
...
80104871:	e8 22 04 00 00       	call   80104c98 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104876:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
8010487d:	eb 38                	jmp    801048b7 <exit+0x108>
    if(p->parent == proc){
...
8010488d:	75 24                	jne    801048b3 <exit+0x104>
      p->parent = initproc;
...
801048a4:	75 0d                	jne    801048b3 <exit+0x104>
        wakeup1(initproc);
801048a6:	a1 48 b6 10 80       	mov    0x8010b648,%eax
801048ab:	89 04 24             	mov    %eax,(%esp)
801048ae:	e8 e5 03 00 00       	call   80104c98 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048b3:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
801048b7:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
801048be:	72 bf                	jb     8010487f <exit+0xd0>
    }
  }
  ...
  sched();
801048c0:	e8 35 02 00 00       	call   80104afa <sched>
  panic("zombie exit");
801048c5:	c7 04 24 11 88 10 80 	movl   $0x80108811,(%esp)
801048cc:	e8 69 bc ff ff       	call   8010053a <panic>
...
801048d4:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
801048d7:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801048de:	e8 1d 06 00 00       	call   80104f00 <acquire>
  for(;;){
    proc->chan = (int)proc;
...
80104900:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104907:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
8010490e:	e9 81 00 00 00       	jmp    80104994 <wait+0xc3>
      if(p->parent != proc)
80104913:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104916:	8b 50 14             	mov    0x14(%eax),%edx
80104919:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010491f:	39 c2                	cmp    %eax,%edx
80104921:	74 02                	je     80104925 <wait+0x54>
        continue;
80104923:	eb 6b                	jmp    80104990 <wait+0xbf>
      havekids = 1;
...
80104935:	75 59                	jne    80104990 <wait+0xbf>
        // Found one.
        pid = p->pid;
...
80104943:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
8010494a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010494d:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104954:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104957:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
8010495e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104961:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
...
80104978:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
        release(&ptable.lock);
8010497f:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104986:	e8 d7 05 00 00       	call   80104f62 <release>
        return pid;
8010498b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010498e:	eb 5b                	jmp    801049eb <wait+0x11a>
  for(;;){
    proc->chan = (int)proc;
    proc->state = SLEEPING;    
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104990:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
80104994:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
8010499b:	0f 82 72 ff ff ff    	jb     80104913 <wait+0x42>
        return pid;
      }
    }
...
801049a1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801049a5:	74 0d                	je     801049b4 <wait+0xe3>
801049a7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049ad:	8b 40 24             	mov    0x24(%eax),%eax
801049b0:	85 c0                	test   %eax,%eax
801049b2:	74 2d                	je     801049e1 <wait+0x110>
      proc->chan = 0;
...
801049c7:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      release(&ptable.lock);
801049ce:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801049d5:	e8 88 05 00 00       	call   80104f62 <release>
      return -1;
801049da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801049df:	eb 0a                	jmp    801049eb <wait+0x11a>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sched();
801049e1:	e8 14 01 00 00       	call   80104afa <sched>
  }
801049e6:	e9 f8 fe ff ff       	jmp    801048e3 <wait+0x12>
}
801049eb:	c9                   	leave  
801049ec:	c3                   	ret    
...
801049f0:	83 ec 18             	sub    $0x18,%esp
  if (!p || p->state != ZOMBIE)
801049f3:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801049f7:	74 0b                	je     80104a04 <freeproc+0x17>
801049f9:	8b 45 08             	mov    0x8(%ebp),%eax
801049fc:	8b 40 0c             	mov    0xc(%eax),%eax
801049ff:	83 f8 05             	cmp    $0x5,%eax
80104a02:	74 0c                	je     80104a10 <freeproc+0x23>
    panic("freeproc not zombie");
80104a04:	c7 04 24 1d 88 10 80 	movl   $0x8010881d,(%esp)
80104a0b:	e8 2a bb ff ff       	call   8010053a <panic>
  kfree(p->kstack);
80104a10:	8b 45 08             	mov    0x8(%ebp),%eax
80104a13:	8b 40 08             	mov    0x8(%eax),%eax
80104a16:	89 04 24             	mov    %eax,(%esp)
80104a19:	e8 38 e0 ff ff       	call   80102a56 <kfree>
  p->kstack = 0;
80104a1e:	8b 45 08             	mov    0x8(%ebp),%eax
80104a21:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  freevm(p->pgdir);
80104a28:	8b 45 08             	mov    0x8(%ebp),%eax
80104a2b:	8b 40 04             	mov    0x4(%eax),%eax
80104a2e:	89 04 24             	mov    %eax,(%esp)
80104a31:	e8 c3 37 00 00       	call   801081f9 <freevm>
  p->killed = 0;
80104a36:	8b 45 08             	mov    0x8(%ebp),%eax
80104a39:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
  p->chan = 0;
80104a40:	8b 45 08             	mov    0x8(%ebp),%eax
80104a43:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
}
80104a4a:	c9                   	leave  
80104a4b:	c3                   	ret    
...
80104a4f:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104a52:	e8 9c f8 ff ff       	call   801042f3 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104a57:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104a5e:	e8 9d 04 00 00       	call   80104f00 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a63:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
80104a6a:	eb 74                	jmp    80104ae0 <scheduler+0x94>
      if(p->state != RUNNABLE)
...
80104a75:	74 02                	je     80104a79 <scheduler+0x2d>
        continue;
80104a77:	eb 63                	jmp    80104adc <scheduler+0x90>
...
80104a88:	e8 f9 32 00 00       	call   80107d86 <switchuvm>
      p->state = RUNNING;
...
80104ab1:	e8 2f 09 00 00       	call   801053e5 <swtch>
      switchkvm();
80104ab6:	e8 ae 32 00 00       	call   80107d69 <switchkvm>
...
80104acc:	83 f8 05             	cmp    $0x5,%eax
80104acf:	75 0b                	jne    80104adc <scheduler+0x90>
        freeproc(p);
80104ad1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ad4:	89 04 24             	mov    %eax,(%esp)
80104ad7:	e8 11 ff ff ff       	call   801049ed <freeproc>
    // Enable interrupts on this processor.
    sti();
...
80104ae0:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
80104ae7:	72 83                	jb     80104a6c <scheduler+0x20>
      // It should have changed its p->state before coming back.
      proc = 0;
      if (p->state == ZOMBIE)
        freeproc(p);
    ...
    release(&ptable.lock);
80104ae9:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104af0:	e8 6d 04 00 00       	call   80104f62 <release>

  }
80104af5:	e9 58 ff ff ff       	jmp    80104a52 <scheduler+0x6>
...
80104afd:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80104b00:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104b07:	e8 1e 05 00 00       	call   8010502a <holding>
80104b0c:	85 c0                	test   %eax,%eax
80104b0e:	75 0c                	jne    80104b1c <sched+0x22>
    panic("sched ptable.lock");
80104b10:	c7 04 24 31 88 10 80 	movl   $0x80108831,(%esp)
80104b17:	e8 1e ba ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
80104b1c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b22:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104b28:	83 f8 01             	cmp    $0x1,%eax
80104b2b:	74 0c                	je     80104b39 <sched+0x3f>
    panic("sched locks");
80104b2d:	c7 04 24 43 88 10 80 	movl   $0x80108843,(%esp)
80104b34:	e8 01 ba ff ff       	call   8010053a <panic>
  if(proc->state == RUNNING)
80104b39:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b3f:	8b 40 0c             	mov    0xc(%eax),%eax
80104b42:	83 f8 04             	cmp    $0x4,%eax
80104b45:	75 0c                	jne    80104b53 <sched+0x59>
    panic("sched running");
80104b47:	c7 04 24 4f 88 10 80 	movl   $0x8010884f,(%esp)
80104b4e:	e8 e7 b9 ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104b53:	e8 8b f7 ff ff       	call   801042e3 <readeflags>
80104b58:	25 00 02 00 00       	and    $0x200,%eax
80104b5d:	85 c0                	test   %eax,%eax
80104b5f:	74 0c                	je     80104b6d <sched+0x73>
    panic("sched interruptible");
80104b61:	c7 04 24 5d 88 10 80 	movl   $0x8010885d,(%esp)
80104b68:	e8 cd b9 ff ff       	call   8010053a <panic>
  intena = cpu->intena;
80104b6d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b73:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104b79:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104b7c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b82:	8b 40 04             	mov    0x4(%eax),%eax
80104b85:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104b8c:	83 c2 1c             	add    $0x1c,%edx
80104b8f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b93:	89 14 24             	mov    %edx,(%esp)
80104b96:	e8 4a 08 00 00       	call   801053e5 <swtch>
  cpu->intena = intena;
80104b9b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ba1:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ba4:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104baa:	c9                   	leave  
80104bab:	c3                   	ret    
...
80104bb2:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104bb9:	e8 42 03 00 00       	call   80104f00 <acquire>
  proc->state = RUNNABLE;
80104bbe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bc4:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104bcb:	e8 2a ff ff ff       	call   80104afa <sched>
  release(&ptable.lock);
80104bd0:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104bd7:	e8 86 03 00 00       	call   80104f62 <release>
}
80104bdc:	c9                   	leave  
80104bdd:	c3                   	ret    
...
80104be1:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104be4:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104beb:	e8 72 03 00 00       	call   80104f62 <release>

  if (first) {
80104bf0:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104bf5:	85 c0                	test   %eax,%eax
80104bf7:	74 0f                	je     80104c08 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104bf9:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104c00:	00 00 00 
    initlog();
80104c03:	e8 07 e6 ff ff       	call   8010320f <initlog>
  }
...
80104c18:	75 0c                	jne    80104c26 <sleep+0x1c>
    panic("sleep");
80104c1a:	c7 04 24 71 88 10 80 	movl   $0x80108871,(%esp)
...
80104c2c:	c7 04 24 77 88 10 80 	movl   $0x80108877,(%esp)
...
80104c38:	81 7d 0c 60 29 11 80 	cmpl   $0x80112960,0xc(%ebp)
80104c3f:	74 17                	je     80104c58 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104c41:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104c48:	e8 b3 02 00 00       	call   80104f00 <acquire>
    release(lk);
80104c4d:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c50:	89 04 24             	mov    %eax,(%esp)
80104c53:	e8 0a 03 00 00       	call   80104f62 <release>
  }
...
80104c6a:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  ...
  sched();
80104c71:	e8 84 fe ff ff       	call   80104afa <sched>

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104c76:	81 7d 0c 60 29 11 80 	cmpl   $0x80112960,0xc(%ebp)
80104c7d:	74 17                	je     80104c96 <sleep+0x8c>
    release(&ptable.lock);
80104c7f:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104c86:	e8 d7 02 00 00       	call   80104f62 <release>
    acquire(lk);
80104c8b:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c8e:	89 04 24             	mov    %eax,(%esp)
80104c91:	e8 6a 02 00 00       	call   80104f00 <acquire>
  }
}
80104c96:	c9                   	leave  
80104c97:	c3                   	ret    
...
80104c9b:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104c9e:	c7 45 fc 94 29 11 80 	movl   $0x80112994,-0x4(%ebp)
80104ca5:	eb 30                	jmp    80104cd7 <wakeup1+0x3f>
    if(p->state == SLEEPING && p->chan == (int)chan){
80104ca7:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104caa:	8b 40 0c             	mov    0xc(%eax),%eax
80104cad:	83 f8 02             	cmp    $0x2,%eax
80104cb0:	75 21                	jne    80104cd3 <wakeup1+0x3b>
80104cb2:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104cb5:	8b 50 20             	mov    0x20(%eax),%edx
80104cb8:	8b 45 08             	mov    0x8(%ebp),%eax
80104cbb:	39 c2                	cmp    %eax,%edx
80104cbd:	75 14                	jne    80104cd3 <wakeup1+0x3b>
      // Tidy up.
      p->chan = 0;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104cd3:	83 6d fc 80          	subl   $0xffffff80,-0x4(%ebp)
80104cd7:	81 7d fc 94 49 11 80 	cmpl   $0x80114994,-0x4(%ebp)
80104cde:	72 c7                	jb     80104ca7 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == (int)chan){
      // Tidy up.
      p->chan = 0;
      p->state = RUNNABLE;
...
80104ce5:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104ce8:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104cef:	e8 0c 02 00 00       	call   80104f00 <acquire>
  wakeup1(chan);
80104cf4:	8b 45 08             	mov    0x8(%ebp),%eax
80104cf7:	89 04 24             	mov    %eax,(%esp)
80104cfa:	e8 99 ff ff ff       	call   80104c98 <wakeup1>
  release(&ptable.lock);
80104cff:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104d06:	e8 57 02 00 00       	call   80104f62 <release>
}
80104d0b:	c9                   	leave  
80104d0c:	c3                   	ret    
...
80104d10:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80104d13:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104d1a:	e8 e1 01 00 00       	call   80104f00 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d1f:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
80104d26:	eb 4d                	jmp    80104d75 <kill+0x68>
    if(p->pid == pid){
80104d28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d2b:	8b 40 10             	mov    0x10(%eax),%eax
80104d2e:	3b 45 08             	cmp    0x8(%ebp),%eax
80104d31:	75 32                	jne    80104d65 <kill+0x58>
      p->killed = 1;
80104d33:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d36:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104d3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d40:	8b 40 0c             	mov    0xc(%eax),%eax
80104d43:	83 f8 02             	cmp    $0x2,%eax
80104d46:	75 0a                	jne    80104d52 <kill+0x45>
        p->state = RUNNABLE;
80104d48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d4b:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      
      release(&ptable.lock);
80104d52:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104d59:	e8 04 02 00 00       	call   80104f62 <release>
      return 0;
80104d5e:	b8 00 00 00 00       	mov    $0x0,%eax
80104d63:	eb 1e                	jmp    80104d83 <kill+0x76>
    ...
    release(&ptable.lock);
80104d65:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104d6c:	e8 f1 01 00 00       	call   80104f62 <release>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d71:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
80104d75:	81 7d f4 94 49 11 80 	cmpl   $0x80114994,-0xc(%ebp)
80104d7c:	72 aa                	jb     80104d28 <kill+0x1b>
      //cprintf("res = %d,    pid = %d", res, pid_test);
...
80104d88:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d8b:	c7 45 f0 94 29 11 80 	movl   $0x80112994,-0x10(%ebp)
80104d92:	e9 e0 00 00 00       	jmp    80104e77 <procdump+0xf2>
    if(p->state == UNUSED)
80104d97:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d9a:	8b 40 0c             	mov    0xc(%eax),%eax
80104d9d:	85 c0                	test   %eax,%eax
80104d9f:	75 05                	jne    80104da6 <procdump+0x21>
      continue;
80104da1:	e9 cd 00 00 00       	jmp    80104e73 <procdump+0xee>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104da6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104da9:	8b 40 0c             	mov    0xc(%eax),%eax
80104dac:	85 c0                	test   %eax,%eax
80104dae:	78 2e                	js     80104dde <procdump+0x59>
80104db0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104db3:	8b 40 0c             	mov    0xc(%eax),%eax
80104db6:	83 f8 05             	cmp    $0x5,%eax
80104db9:	77 23                	ja     80104dde <procdump+0x59>
80104dbb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104dbe:	8b 40 0c             	mov    0xc(%eax),%eax
80104dc1:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104dc8:	85 c0                	test   %eax,%eax
80104dca:	74 12                	je     80104dde <procdump+0x59>
      state = states[p->state];
80104dcc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104dcf:	8b 40 0c             	mov    0xc(%eax),%eax
80104dd2:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104dd9:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104ddc:	eb 07                	jmp    80104de5 <procdump+0x60>
    else
      state = "???";
80104dde:	c7 45 ec 88 88 10 80 	movl   $0x80108888,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104de5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104de8:	8d 50 6c             	lea    0x6c(%eax),%edx
80104deb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104dee:	8b 40 10             	mov    0x10(%eax),%eax
80104df1:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104df5:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104df8:	89 54 24 08          	mov    %edx,0x8(%esp)
80104dfc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e00:	c7 04 24 8c 88 10 80 	movl   $0x8010888c,(%esp)
80104e07:	e8 94 b5 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
80104e0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e0f:	8b 40 0c             	mov    0xc(%eax),%eax
80104e12:	83 f8 02             	cmp    $0x2,%eax
80104e15:	75 50                	jne    80104e67 <procdump+0xe2>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104e17:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e1a:	8b 40 1c             	mov    0x1c(%eax),%eax
80104e1d:	8b 40 0c             	mov    0xc(%eax),%eax
80104e20:	83 c0 08             	add    $0x8,%eax
80104e23:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104e26:	89 54 24 04          	mov    %edx,0x4(%esp)
80104e2a:	89 04 24             	mov    %eax,(%esp)
80104e2d:	e8 7f 01 00 00       	call   80104fb1 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104e32:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104e39:	eb 1b                	jmp    80104e56 <procdump+0xd1>
        cprintf(" %p", pc[i]);
80104e3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e3e:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104e42:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e46:	c7 04 24 95 88 10 80 	movl   $0x80108895,(%esp)
80104e4d:	e8 4e b5 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104e52:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104e56:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104e5a:	7f 0b                	jg     80104e67 <procdump+0xe2>
80104e5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e5f:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104e63:	85 c0                	test   %eax,%eax
80104e65:	75 d4                	jne    80104e3b <procdump+0xb6>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104e67:	c7 04 24 99 88 10 80 	movl   $0x80108899,(%esp)
80104e6e:	e8 2d b5 ff ff       	call   801003a0 <cprintf>
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e73:	83 6d f0 80          	subl   $0xffffff80,-0x10(%ebp)
80104e77:	81 7d f0 94 49 11 80 	cmpl   $0x80114994,-0x10(%ebp)
80104e7e:	0f 82 13 ff ff ff    	jb     80104d97 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104e92:	8b 40 7c             	mov    0x7c(%eax),%eax
...
80104ea1:	89 50 7c             	mov    %edx,0x7c(%eax)
  return oldhandler;
...
80104eaf:	9c                   	pushf  
80104eb0:	58                   	pop    %eax
80104eb1:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
...
80104ed4:	f0 87 02             	lock xchg %eax,(%edx)
80104ed7:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
80104ee8:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80104eeb:	8b 45 08             	mov    0x8(%ebp),%eax
80104eee:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80104ef4:	8b 45 08             	mov    0x8(%ebp),%eax
80104ef7:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104efe:	5d                   	pop    %ebp
80104eff:	c3                   	ret    
...
80104f06:	e8 49 01 00 00       	call   80105054 <pushcli>
  if(holding(lk))
80104f0b:	8b 45 08             	mov    0x8(%ebp),%eax
80104f0e:	89 04 24             	mov    %eax,(%esp)
80104f11:	e8 14 01 00 00       	call   8010502a <holding>
80104f16:	85 c0                	test   %eax,%eax
80104f18:	74 0c                	je     80104f26 <acquire+0x26>
    panic("acquire");
80104f1a:	c7 04 24 c5 88 10 80 	movl   $0x801088c5,(%esp)
80104f21:	e8 14 b6 ff ff       	call   8010053a <panic>
...
80104f2a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104f31:	00 
80104f32:	89 04 24             	mov    %eax,(%esp)
80104f35:	e8 8b ff ff ff       	call   80104ec5 <xchg>
80104f3a:	85 c0                	test   %eax,%eax
80104f3c:	75 e9                	jne    80104f27 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104f3e:	8b 45 08             	mov    0x8(%ebp),%eax
80104f41:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104f48:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104f4b:	8b 45 08             	mov    0x8(%ebp),%eax
80104f4e:	83 c0 0c             	add    $0xc,%eax
80104f51:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f55:	8d 45 08             	lea    0x8(%ebp),%eax
80104f58:	89 04 24             	mov    %eax,(%esp)
80104f5b:	e8 51 00 00 00       	call   80104fb1 <getcallerpcs>
}
80104f60:	c9                   	leave  
80104f61:	c3                   	ret    
...
80104f6e:	e8 b7 00 00 00       	call   8010502a <holding>
80104f73:	85 c0                	test   %eax,%eax
80104f75:	75 0c                	jne    80104f83 <release+0x21>
    panic("release");
80104f77:	c7 04 24 cd 88 10 80 	movl   $0x801088cd,(%esp)
80104f7e:	e8 b7 b5 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104f83:	8b 45 08             	mov    0x8(%ebp),%eax
80104f86:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104f8d:	8b 45 08             	mov    0x8(%ebp),%eax
80104f90:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104f9a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104fa1:	00 
80104fa2:	89 04 24             	mov    %eax,(%esp)
80104fa5:	e8 1b ff ff ff       	call   80104ec5 <xchg>

  popcli();
80104faa:	e8 e9 00 00 00       	call   80105098 <popcli>
}
80104faf:	c9                   	leave  
80104fb0:	c3                   	ret    

80104fb1 <getcallerpcs>:
...
80104fba:	83 e8 08             	sub    $0x8,%eax
80104fbd:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104fc0:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104fc7:	eb 38                	jmp    80105001 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104fc9:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104fcd:	74 38                	je     80105007 <getcallerpcs+0x56>
80104fcf:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104fd6:	76 2f                	jbe    80105007 <getcallerpcs+0x56>
80104fd8:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104fdc:	74 29                	je     80105007 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104fde:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104fe1:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80104ffa:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104ffd:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105001:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105005:	7e c2                	jle    80104fc9 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105007:	eb 19                	jmp    80105022 <getcallerpcs+0x71>
    pcs[i] = 0;
80105009:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010500c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80105018:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  for(; i < 10; i++)
8010501e:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105022:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105026:	7e e1                	jle    80105009 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80105028:	c9                   	leave  
80105029:	c3                   	ret    
...
80105030:	8b 00                	mov    (%eax),%eax
80105032:	85 c0                	test   %eax,%eax
80105034:	74 17                	je     8010504d <holding+0x23>
80105036:	8b 45 08             	mov    0x8(%ebp),%eax
80105039:	8b 50 08             	mov    0x8(%eax),%edx
8010503c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105042:	39 c2                	cmp    %eax,%edx
80105044:	75 07                	jne    8010504d <holding+0x23>
80105046:	b8 01 00 00 00       	mov    $0x1,%eax
8010504b:	eb 05                	jmp    80105052 <holding+0x28>
...
80105057:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
8010505a:	e8 4a fe ff ff       	call   80104ea9 <readeflags>
8010505f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105062:	e8 52 fe ff ff       	call   80104eb9 <cli>
  if(cpu->ncli++ == 0)
80105067:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010506e:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
80105074:	8d 48 01             	lea    0x1(%eax),%ecx
80105077:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
8010507d:	85 c0                	test   %eax,%eax
8010507f:	75 15                	jne    80105096 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80105081:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105087:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010508a:	81 e2 00 02 00 00    	and    $0x200,%edx
80105090:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105096:	c9                   	leave  
80105097:	c3                   	ret    
...
8010509b:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010509e:	e8 06 fe ff ff       	call   80104ea9 <readeflags>
801050a3:	25 00 02 00 00       	and    $0x200,%eax
801050a8:	85 c0                	test   %eax,%eax
801050aa:	74 0c                	je     801050b8 <popcli+0x20>
    panic("popcli - interruptible");
801050ac:	c7 04 24 d5 88 10 80 	movl   $0x801088d5,(%esp)
801050b3:	e8 82 b4 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
801050b8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050be:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801050c4:	83 ea 01             	sub    $0x1,%edx
801050c7:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801050cd:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050d3:	85 c0                	test   %eax,%eax
801050d5:	79 0c                	jns    801050e3 <popcli+0x4b>
    panic("popcli");
801050d7:	c7 04 24 ec 88 10 80 	movl   $0x801088ec,(%esp)
801050de:	e8 57 b4 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
801050e3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050e9:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050ef:	85 c0                	test   %eax,%eax
801050f1:	75 15                	jne    80105108 <popcli+0x70>
801050f3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050f9:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801050ff:	85 c0                	test   %eax,%eax
80105101:	74 05                	je     80105108 <popcli+0x70>
    sti();
80105103:	e8 b7 fd ff ff       	call   80104ebf <sti>
}
80105108:	c9                   	leave  
80105109:	c3                   	ret    
...
80105112:	8b 55 10             	mov    0x10(%ebp),%edx
80105115:	8b 45 0c             	mov    0xc(%ebp),%eax
80105118:	89 cb                	mov    %ecx,%ebx
8010511a:	89 df                	mov    %ebx,%edi
8010511c:	89 d1                	mov    %edx,%ecx
8010511e:	fc                   	cld    
8010511f:	f3 aa                	rep stos %al,%es:(%edi)
80105121:	89 ca                	mov    %ecx,%edx
80105123:	89 fb                	mov    %edi,%ebx
80105125:	89 5d 08             	mov    %ebx,0x8(%ebp)
80105128:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105134:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105137:	8b 55 10             	mov    0x10(%ebp),%edx
8010513a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010513d:	89 cb                	mov    %ecx,%ebx
8010513f:	89 df                	mov    %ebx,%edi
80105141:	89 d1                	mov    %edx,%ecx
80105143:	fc                   	cld    
80105144:	f3 ab                	rep stos %eax,%es:(%edi)
80105146:	89 ca                	mov    %ecx,%edx
80105148:	89 fb                	mov    %edi,%ebx
8010514a:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105162:	75 49                	jne    801051ad <memset+0x59>
80105164:	8b 45 10             	mov    0x10(%ebp),%eax
80105167:	83 e0 03             	and    $0x3,%eax
8010516a:	85 c0                	test   %eax,%eax
8010516c:	75 3f                	jne    801051ad <memset+0x59>
    c &= 0xFF;
8010516e:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105175:	8b 45 10             	mov    0x10(%ebp),%eax
80105178:	c1 e8 02             	shr    $0x2,%eax
8010517b:	89 c2                	mov    %eax,%edx
8010517d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105180:	c1 e0 18             	shl    $0x18,%eax
80105183:	89 c1                	mov    %eax,%ecx
80105185:	8b 45 0c             	mov    0xc(%ebp),%eax
80105188:	c1 e0 10             	shl    $0x10,%eax
8010518b:	09 c1                	or     %eax,%ecx
8010518d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105190:	c1 e0 08             	shl    $0x8,%eax
80105193:	09 c8                	or     %ecx,%eax
80105195:	0b 45 0c             	or     0xc(%ebp),%eax
80105198:	89 54 24 08          	mov    %edx,0x8(%esp)
8010519c:	89 44 24 04          	mov    %eax,0x4(%esp)
801051a0:	8b 45 08             	mov    0x8(%ebp),%eax
801051a3:	89 04 24             	mov    %eax,(%esp)
801051a6:	e8 84 ff ff ff       	call   8010512f <stosl>
801051ab:	eb 19                	jmp    801051c6 <memset+0x72>
  } else
    stosb(dst, c, n);
801051ad:	8b 45 10             	mov    0x10(%ebp),%eax
801051b0:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801051c1:	e8 44 ff ff ff       	call   8010510a <stosb>
  return dst;
...
801051da:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801051dd:	eb 30                	jmp    8010520f <memcmp+0x44>
    if(*s1 != *s2)
801051df:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051e2:	0f b6 10             	movzbl (%eax),%edx
801051e5:	8b 45 f8             	mov    -0x8(%ebp),%eax
801051e8:	0f b6 00             	movzbl (%eax),%eax
801051eb:	38 c2                	cmp    %al,%dl
801051ed:	74 18                	je     80105207 <memcmp+0x3c>
      return *s1 - *s2;
801051ef:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051f2:	0f b6 00             	movzbl (%eax),%eax
801051f5:	0f b6 d0             	movzbl %al,%edx
801051f8:	8b 45 f8             	mov    -0x8(%ebp),%eax
801051fb:	0f b6 00             	movzbl (%eax),%eax
801051fe:	0f b6 c0             	movzbl %al,%eax
80105201:	29 c2                	sub    %eax,%edx
80105203:	89 d0                	mov    %edx,%eax
80105205:	eb 1a                	jmp    80105221 <memcmp+0x56>
    s1++, s2++;
80105207:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010520b:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
8010521a:	75 c3                	jne    801051df <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105232:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80105235:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105238:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010523b:	73 3d                	jae    8010527a <memmove+0x57>
8010523d:	8b 45 10             	mov    0x10(%ebp),%eax
80105240:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105243:	01 d0                	add    %edx,%eax
80105245:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105248:	76 30                	jbe    8010527a <memmove+0x57>
    s += n;
8010524a:	8b 45 10             	mov    0x10(%ebp),%eax
8010524d:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105250:	8b 45 10             	mov    0x10(%ebp),%eax
80105253:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105256:	eb 13                	jmp    8010526b <memmove+0x48>
      *--d = *--s;
80105258:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010525c:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105260:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105263:	0f b6 10             	movzbl (%eax),%edx
...
80105276:	75 e0                	jne    80105258 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105278:	eb 26                	jmp    801052a0 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
8010527a:	eb 17                	jmp    80105293 <memmove+0x70>
      *d++ = *s++;
8010527c:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010527f:	8d 50 01             	lea    0x1(%eax),%edx
80105282:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105285:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105288:	8d 4a 01             	lea    0x1(%edx),%ecx
8010528b:	89 4d fc             	mov    %ecx,-0x4(%ebp)
8010528e:	0f b6 12             	movzbl (%edx),%edx
80105291:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
8010529e:	75 dc                	jne    8010527c <memmove+0x59>
      *d++ = *s++;
...
801052bf:	e8 5f ff ff ff       	call   80105223 <memmove>
}
801052c4:	c9                   	leave  
801052c5:	c3                   	ret    
...
801052c7:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801052c9:	eb 0c                	jmp    801052d7 <strncmp+0x11>
    n--, p++, q++;
801052cb:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801052cf:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801052d3:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801052db:	74 1a                	je     801052f7 <strncmp+0x31>
801052dd:	8b 45 08             	mov    0x8(%ebp),%eax
801052e0:	0f b6 00             	movzbl (%eax),%eax
801052e3:	84 c0                	test   %al,%al
801052e5:	74 10                	je     801052f7 <strncmp+0x31>
...
801052f5:	74 d4                	je     801052cb <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801052f7:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052fb:	75 07                	jne    80105304 <strncmp+0x3e>
    return 0;
801052fd:	b8 00 00 00 00       	mov    $0x0,%eax
80105302:	eb 16                	jmp    8010531a <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
80105304:	8b 45 08             	mov    0x8(%ebp),%eax
80105307:	0f b6 00             	movzbl (%eax),%eax
8010530a:	0f b6 d0             	movzbl %al,%edx
8010530d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105310:	0f b6 00             	movzbl (%eax),%eax
80105313:	0f b6 c0             	movzbl %al,%eax
80105316:	29 c2                	sub    %eax,%edx
...
8010532c:	8d 50 ff             	lea    -0x1(%eax),%edx
8010532f:	89 55 10             	mov    %edx,0x10(%ebp)
80105332:	85 c0                	test   %eax,%eax
80105334:	7e 1e                	jle    80105354 <strncpy+0x38>
80105336:	8b 45 08             	mov    0x8(%ebp),%eax
80105339:	8d 50 01             	lea    0x1(%eax),%edx
8010533c:	89 55 08             	mov    %edx,0x8(%ebp)
8010533f:	8b 55 0c             	mov    0xc(%ebp),%edx
80105342:	8d 4a 01             	lea    0x1(%edx),%ecx
80105345:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105348:	0f b6 12             	movzbl (%edx),%edx
8010534b:	88 10                	mov    %dl,(%eax)
8010534d:	0f b6 00             	movzbl (%eax),%eax
80105350:	84 c0                	test   %al,%al
80105352:	75 d5                	jne    80105329 <strncpy+0xd>
    ;
  while(n-- > 0)
80105354:	eb 0c                	jmp    80105362 <strncpy+0x46>
    *s++ = 0;
80105356:	8b 45 08             	mov    0x8(%ebp),%eax
80105359:	8d 50 01             	lea    0x1(%eax),%edx
8010535c:	89 55 08             	mov    %edx,0x8(%ebp)
8010535f:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
8010536d:	7f e7                	jg     80105356 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
80105384:	7f 05                	jg     8010538b <safestrcpy+0x17>
    return os;
80105386:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105389:	eb 31                	jmp    801053bc <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
8010538b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010538f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105393:	7e 1e                	jle    801053b3 <safestrcpy+0x3f>
80105395:	8b 45 08             	mov    0x8(%ebp),%eax
80105398:	8d 50 01             	lea    0x1(%eax),%edx
8010539b:	89 55 08             	mov    %edx,0x8(%ebp)
8010539e:	8b 55 0c             	mov    0xc(%ebp),%edx
801053a1:	8d 4a 01             	lea    0x1(%edx),%ecx
801053a4:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801053a7:	0f b6 12             	movzbl (%edx),%edx
801053aa:	88 10                	mov    %dl,(%eax)
801053ac:	0f b6 00             	movzbl (%eax),%eax
801053af:	84 c0                	test   %al,%al
801053b1:	75 d8                	jne    8010538b <safestrcpy+0x17>
    ;
  *s = 0;
801053b3:	8b 45 08             	mov    0x8(%ebp),%eax
801053b6:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
801053c1:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
801053c4:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801053cb:	eb 04                	jmp    801053d1 <strlen+0x13>
801053cd:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
801053de:	75 ed                	jne    801053cd <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801053e5:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801053e9:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801053f0:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801053f1:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801053f3:	89 d4                	mov    %edx,%esp
...
8010542b:	89 10                	mov    %edx,(%eax)
  return 0;
8010542d:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105432:	5d                   	pop    %ebp
80105433:	c3                   	ret    
...
80105442:	3b 45 08             	cmp    0x8(%ebp),%eax
80105445:	77 07                	ja     8010544e <fetchstr+0x1a>
    return -1;
80105447:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010544c:	eb 46                	jmp    80105494 <fetchstr+0x60>
  *pp = (char*)addr;
8010544e:	8b 55 08             	mov    0x8(%ebp),%edx
...
80105481:	eb 11                	jmp    80105494 <fetchstr+0x60>
...
8010548a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010548d:	72 dc                	jb     8010546b <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801054a5:	8b 50 44             	mov    0x44(%eax),%edx
801054a8:	8b 45 08             	mov    0x8(%ebp),%eax
801054ab:	c1 e0 02             	shl    $0x2,%eax
801054ae:	01 d0                	add    %edx,%eax
801054b0:	8d 50 04             	lea    0x4(%eax),%edx
801054b3:	8b 45 0c             	mov    0xc(%ebp),%eax
801054b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801054ba:	89 14 24             	mov    %edx,(%esp)
801054bd:	e8 38 ff ff ff       	call   801053fa <fetchint>
}
801054c2:	c9                   	leave  
801054c3:	c3                   	ret    
...
801054f6:	73 16                	jae    8010550e <argptr+0x4a>
801054f8:	8b 45 fc             	mov    -0x4(%ebp),%eax
801054fb:	89 c2                	mov    %eax,%edx
801054fd:	8b 45 10             	mov    0x10(%ebp),%eax
80105500:	01 c2                	add    %eax,%edx
80105502:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105508:	8b 00                	mov    (%eax),%eax
8010550a:	39 c2                	cmp    %eax,%edx
8010550c:	76 07                	jbe    80105515 <argptr+0x51>
    return -1;
8010550e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105513:	eb 0f                	jmp    80105524 <argptr+0x60>
  *pp = (char*)i;
80105515:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105518:	89 c2                	mov    %eax,%edx
8010551a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010551d:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105539:	e8 58 ff ff ff       	call   80105496 <argint>
8010553e:	85 c0                	test   %eax,%eax
80105540:	79 07                	jns    80105549 <argstr+0x23>
    return -1;
80105542:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105547:	eb 12                	jmp    8010555b <argstr+0x35>
  return fetchstr(addr, pp);
80105549:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010554c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010554f:	89 54 24 04          	mov    %edx,0x4(%esp)
80105553:	89 04 24             	mov    %eax,(%esp)
80105556:	e8 d9 fe ff ff       	call   80105434 <fetchstr>
}
8010555b:	c9                   	leave  
8010555c:	c3                   	ret    
...
80105561:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105564:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010556a:	8b 40 18             	mov    0x18(%eax),%eax
8010556d:	8b 40 1c             	mov    0x1c(%eax),%eax
80105570:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105573:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105577:	7e 30                	jle    801055a9 <syscall+0x4c>
80105579:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010557c:	83 f8 16             	cmp    $0x16,%eax
8010557f:	77 28                	ja     801055a9 <syscall+0x4c>
80105581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105584:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010558b:	85 c0                	test   %eax,%eax
8010558d:	74 1a                	je     801055a9 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
8010558f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105595:	8b 58 18             	mov    0x18(%eax),%ebx
80105598:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010559b:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801055a2:	ff d0                	call   *%eax
801055a4:	89 43 1c             	mov    %eax,0x1c(%ebx)
801055a7:	eb 3d                	jmp    801055e6 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801055a9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055af:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
801055bb:	8b 55 f4             	mov    -0xc(%ebp),%edx
801055be:	89 54 24 0c          	mov    %edx,0xc(%esp)
801055c2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801055c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801055ca:	c7 04 24 f3 88 10 80 	movl   $0x801088f3,(%esp)
801055d1:	e8 ca ad ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801055d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055dc:	8b 40 18             	mov    0x18(%eax),%eax
801055df:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
801055ff:	e8 92 fe ff ff       	call   80105496 <argint>
80105604:	85 c0                	test   %eax,%eax
80105606:	79 07                	jns    8010560f <argfd+0x23>
    return -1;
80105608:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010560d:	eb 50                	jmp    8010565f <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
8010560f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105612:	85 c0                	test   %eax,%eax
80105614:	78 21                	js     80105637 <argfd+0x4b>
80105616:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105619:	83 f8 0f             	cmp    $0xf,%eax
8010561c:	7f 19                	jg     80105637 <argfd+0x4b>
8010561e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105624:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105627:	83 c2 08             	add    $0x8,%edx
8010562a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010562e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105631:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105635:	75 07                	jne    8010563e <argfd+0x52>
    return -1;
80105637:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010563c:	eb 21                	jmp    8010565f <argfd+0x73>
  if(pfd)
8010563e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105642:	74 08                	je     8010564c <argfd+0x60>
    *pfd = fd;
80105644:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105647:	8b 45 0c             	mov    0xc(%ebp),%eax
8010564a:	89 10                	mov    %edx,(%eax)
  if(pf)
8010564c:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105650:	74 08                	je     8010565a <argfd+0x6e>
    *pf = f;
80105652:	8b 45 10             	mov    0x10(%ebp),%eax
80105655:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105658:	89 10                	mov    %edx,(%eax)
  return 0;
8010565a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010565f:	c9                   	leave  
80105660:	c3                   	ret    
...
80105664:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105667:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010566e:	eb 30                	jmp    801056a0 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105670:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105676:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105679:	83 c2 08             	add    $0x8,%edx
8010567c:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105680:	85 c0                	test   %eax,%eax
80105682:	75 18                	jne    8010569c <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105684:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010568a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010568d:	8d 4a 08             	lea    0x8(%edx),%ecx
80105690:	8b 55 08             	mov    0x8(%ebp),%edx
80105693:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105697:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010569a:	eb 0f                	jmp    801056ab <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
801056a0:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801056a4:	7e ca                	jle    80105670 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
801056c9:	e8 1e ff ff ff       	call   801055ec <argfd>
801056ce:	85 c0                	test   %eax,%eax
801056d0:	79 07                	jns    801056d9 <sys_dup+0x2c>
    return -1;
801056d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056d7:	eb 29                	jmp    80105702 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801056d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056dc:	89 04 24             	mov    %eax,(%esp)
801056df:	e8 7d ff ff ff       	call   80105661 <fdalloc>
801056e4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801056e7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801056eb:	79 07                	jns    801056f4 <sys_dup+0x47>
    return -1;
801056ed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056f2:	eb 0e                	jmp    80105702 <sys_dup+0x55>
  filedup(f);
801056f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056f7:	89 04 24             	mov    %eax,(%esp)
801056fa:	e8 94 b8 ff ff       	call   80100f93 <filedup>
  return fd;
...
8010570d:	89 44 24 08          	mov    %eax,0x8(%esp)
80105711:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105718:	00 
80105719:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105720:	e8 c7 fe ff ff       	call   801055ec <argfd>
80105725:	85 c0                	test   %eax,%eax
80105727:	78 35                	js     8010575e <sys_read+0x5a>
80105729:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010572c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105730:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105737:	e8 5a fd ff ff       	call   80105496 <argint>
8010573c:	85 c0                	test   %eax,%eax
8010573e:	78 1e                	js     8010575e <sys_read+0x5a>
80105740:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105743:	89 44 24 08          	mov    %eax,0x8(%esp)
80105747:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010574a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010574e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105755:	e8 6a fd ff ff       	call   801054c4 <argptr>
8010575a:	85 c0                	test   %eax,%eax
8010575c:	79 07                	jns    80105765 <sys_read+0x61>
    return -1;
8010575e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105763:	eb 19                	jmp    8010577e <sys_read+0x7a>
  return fileread(f, p, n);
80105765:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105768:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010576b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010576e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105772:	89 54 24 04          	mov    %edx,0x4(%esp)
80105776:	89 04 24             	mov    %eax,(%esp)
80105779:	e8 82 b9 ff ff       	call   80101100 <fileread>
}
8010577e:	c9                   	leave  
8010577f:	c3                   	ret    
...
8010579c:	e8 4b fe ff ff       	call   801055ec <argfd>
801057a1:	85 c0                	test   %eax,%eax
801057a3:	78 35                	js     801057da <sys_write+0x5a>
801057a5:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057a8:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ac:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801057b3:	e8 de fc ff ff       	call   80105496 <argint>
801057b8:	85 c0                	test   %eax,%eax
801057ba:	78 1e                	js     801057da <sys_write+0x5a>
801057bc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057bf:	89 44 24 08          	mov    %eax,0x8(%esp)
801057c3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801057c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057d1:	e8 ee fc ff ff       	call   801054c4 <argptr>
801057d6:	85 c0                	test   %eax,%eax
801057d8:	79 07                	jns    801057e1 <sys_write+0x61>
    return -1;
801057da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057df:	eb 19                	jmp    801057fa <sys_write+0x7a>
  return filewrite(f, p, n);
801057e1:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801057e4:	8b 55 ec             	mov    -0x14(%ebp),%edx
801057e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ea:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801057ee:	89 54 24 04          	mov    %edx,0x4(%esp)
801057f2:	89 04 24             	mov    %eax,(%esp)
801057f5:	e8 c2 b9 ff ff       	call   801011bc <filewrite>
}
801057fa:	c9                   	leave  
801057fb:	c3                   	ret    
...
80105809:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010580c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105810:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105817:	e8 d0 fd ff ff       	call   801055ec <argfd>
8010581c:	85 c0                	test   %eax,%eax
8010581e:	79 07                	jns    80105827 <sys_close+0x2b>
    return -1;
80105820:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105825:	eb 24                	jmp    8010584b <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105827:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010582d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105830:	83 c2 08             	add    $0x8,%edx
80105833:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010583a:	00 
  fileclose(f);
8010583b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010583e:	89 04 24             	mov    %eax,(%esp)
80105841:	e8 95 b7 ff ff       	call   80100fdb <fileclose>
  return 0;
...
80105850:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
...
8010585a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105861:	00 
80105862:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105869:	e8 7e fd ff ff       	call   801055ec <argfd>
8010586e:	85 c0                	test   %eax,%eax
80105870:	78 1f                	js     80105891 <sys_fstat+0x44>
80105872:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105879:	00 
8010587a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010587d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105881:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105888:	e8 37 fc ff ff       	call   801054c4 <argptr>
8010588d:	85 c0                	test   %eax,%eax
8010588f:	79 07                	jns    80105898 <sys_fstat+0x4b>
    return -1;
80105891:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105896:	eb 12                	jmp    801058aa <sys_fstat+0x5d>
  return filestat(f, st);
80105898:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010589b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010589e:	89 54 24 04          	mov    %edx,0x4(%esp)
801058a2:	89 04 24             	mov    %eax,(%esp)
801058a5:	e8 07 b8 ff ff       	call   801010b1 <filestat>
}
801058aa:	c9                   	leave  
801058ab:	c3                   	ret    
...
801058af:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801058b2:	8d 45 d8             	lea    -0x28(%ebp),%eax
801058b5:	89 44 24 04          	mov    %eax,0x4(%esp)
801058b9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801058c0:	e8 61 fc ff ff       	call   80105526 <argstr>
801058c5:	85 c0                	test   %eax,%eax
801058c7:	78 17                	js     801058e0 <sys_link+0x34>
801058c9:	8d 45 dc             	lea    -0x24(%ebp),%eax
801058cc:	89 44 24 04          	mov    %eax,0x4(%esp)
801058d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801058d7:	e8 4a fc ff ff       	call   80105526 <argstr>
801058dc:	85 c0                	test   %eax,%eax
801058de:	79 0a                	jns    801058ea <sys_link+0x3e>
    return -1;
801058e0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058e5:	e9 42 01 00 00       	jmp    80105a2c <sys_link+0x180>

  begin_op();
801058ea:	e8 2e db ff ff       	call   8010341d <begin_op>
  if((ip = namei(old)) == 0){
801058ef:	8b 45 d8             	mov    -0x28(%ebp),%eax
801058f2:	89 04 24             	mov    %eax,(%esp)
801058f5:	e8 19 cb ff ff       	call   80102413 <namei>
801058fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058fd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105901:	75 0f                	jne    80105912 <sys_link+0x66>
    end_op();
80105903:	e8 99 db ff ff       	call   801034a1 <end_op>
    return -1;
80105908:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010590d:	e9 1a 01 00 00       	jmp    80105a2c <sys_link+0x180>
  }

  ilock(ip);
80105912:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105915:	89 04 24             	mov    %eax,(%esp)
80105918:	e8 4b bf ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
8010591d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105920:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105924:	66 83 f8 01          	cmp    $0x1,%ax
80105928:	75 1a                	jne    80105944 <sys_link+0x98>
    iunlockput(ip);
8010592a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010592d:	89 04 24             	mov    %eax,(%esp)
80105930:	e8 b7 c1 ff ff       	call   80101aec <iunlockput>
    end_op();
80105935:	e8 67 db ff ff       	call   801034a1 <end_op>
    return -1;
8010593a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010593f:	e9 e8 00 00 00       	jmp    80105a2c <sys_link+0x180>
  }

  ip->nlink++;
80105944:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105947:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010594b:	8d 50 01             	lea    0x1(%eax),%edx
8010594e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105951:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105955:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105958:	89 04 24             	mov    %eax,(%esp)
8010595b:	e8 4c bd ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80105960:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105963:	89 04 24             	mov    %eax,(%esp)
80105966:	e8 4b c0 ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010596b:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010596e:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105971:	89 54 24 04          	mov    %edx,0x4(%esp)
80105975:	89 04 24             	mov    %eax,(%esp)
80105978:	e8 b8 ca ff ff       	call   80102435 <nameiparent>
8010597d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105980:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105984:	75 02                	jne    80105988 <sys_link+0xdc>
    goto bad;
80105986:	eb 68                	jmp    801059f0 <sys_link+0x144>
  ilock(dp);
80105988:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010598b:	89 04 24             	mov    %eax,(%esp)
8010598e:	e8 d5 be ff ff       	call   80101868 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105993:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105996:	8b 10                	mov    (%eax),%edx
80105998:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010599b:	8b 00                	mov    (%eax),%eax
8010599d:	39 c2                	cmp    %eax,%edx
8010599f:	75 20                	jne    801059c1 <sys_link+0x115>
801059a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059a4:	8b 40 04             	mov    0x4(%eax),%eax
801059a7:	89 44 24 08          	mov    %eax,0x8(%esp)
801059ab:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801059ae:	89 44 24 04          	mov    %eax,0x4(%esp)
801059b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059b5:	89 04 24             	mov    %eax,(%esp)
801059b8:	e8 96 c7 ff ff       	call   80102153 <dirlink>
801059bd:	85 c0                	test   %eax,%eax
801059bf:	79 0d                	jns    801059ce <sys_link+0x122>
    iunlockput(dp);
801059c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059c4:	89 04 24             	mov    %eax,(%esp)
801059c7:	e8 20 c1 ff ff       	call   80101aec <iunlockput>
    goto bad;
801059cc:	eb 22                	jmp    801059f0 <sys_link+0x144>
  }
  iunlockput(dp);
...
801059df:	e8 37 c0 ff ff       	call   80101a1b <iput>

  end_op();
801059e4:	e8 b8 da ff ff       	call   801034a1 <end_op>

  return 0;
801059e9:	b8 00 00 00 00       	mov    $0x0,%eax
801059ee:	eb 3c                	jmp    80105a2c <sys_link+0x180>

bad:
  ilock(ip);
801059f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059f3:	89 04 24             	mov    %eax,(%esp)
801059f6:	e8 6d be ff ff       	call   80101868 <ilock>
  ip->nlink--;
801059fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059fe:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105a02:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105a12:	e8 95 bc ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105a17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a1a:	89 04 24             	mov    %eax,(%esp)
80105a1d:	e8 ca c0 ff ff       	call   80101aec <iunlockput>
  end_op();
80105a22:	e8 7a da ff ff       	call   801034a1 <end_op>
  return -1;
...
80105a31:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105a34:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105a3b:	eb 4b                	jmp    80105a88 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105a3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a40:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105a47:	00 
80105a48:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a4c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105a4f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a53:	8b 45 08             	mov    0x8(%ebp),%eax
80105a56:	89 04 24             	mov    %eax,(%esp)
80105a59:	e8 17 c3 ff ff       	call   80101d75 <readi>
80105a5e:	83 f8 10             	cmp    $0x10,%eax
80105a61:	74 0c                	je     80105a6f <isdirempty+0x41>
      panic("isdirempty: readi");
80105a63:	c7 04 24 0f 89 10 80 	movl   $0x8010890f,(%esp)
80105a6a:	e8 cb aa ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105a6f:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105a73:	66 85 c0             	test   %ax,%ax
80105a76:	74 07                	je     80105a7f <isdirempty+0x51>
      return 0;
80105a78:	b8 00 00 00 00       	mov    $0x0,%eax
80105a7d:	eb 1b                	jmp    80105a9a <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105a82:	83 c0 10             	add    $0x10,%eax
80105a85:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a88:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105a8b:	8b 45 08             	mov    0x8(%ebp),%eax
80105a8e:	8b 40 18             	mov    0x18(%eax),%eax
80105a91:	39 c2                	cmp    %eax,%edx
80105a93:	72 a8                	jb     80105a3d <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105a9f:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105aa2:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105aa5:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aa9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ab0:	e8 71 fa ff ff       	call   80105526 <argstr>
80105ab5:	85 c0                	test   %eax,%eax
80105ab7:	79 0a                	jns    80105ac3 <sys_unlink+0x27>
    return -1;
80105ab9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105abe:	e9 af 01 00 00       	jmp    80105c72 <sys_unlink+0x1d6>

  begin_op();
80105ac3:	e8 55 d9 ff ff       	call   8010341d <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105ac8:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105acb:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105ace:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ad2:	89 04 24             	mov    %eax,(%esp)
80105ad5:	e8 5b c9 ff ff       	call   80102435 <nameiparent>
80105ada:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105add:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ae1:	75 0f                	jne    80105af2 <sys_unlink+0x56>
    end_op();
80105ae3:	e8 b9 d9 ff ff       	call   801034a1 <end_op>
    return -1;
80105ae8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105aed:	e9 80 01 00 00       	jmp    80105c72 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105af2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105af5:	89 04 24             	mov    %eax,(%esp)
80105af8:	e8 6b bd ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105afd:	c7 44 24 04 21 89 10 	movl   $0x80108921,0x4(%esp)
80105b04:	80 
80105b05:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105b08:	89 04 24             	mov    %eax,(%esp)
80105b0b:	e8 58 c5 ff ff       	call   80102068 <namecmp>
80105b10:	85 c0                	test   %eax,%eax
80105b12:	0f 84 45 01 00 00    	je     80105c5d <sys_unlink+0x1c1>
80105b18:	c7 44 24 04 23 89 10 	movl   $0x80108923,0x4(%esp)
80105b1f:	80 
80105b20:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105b23:	89 04 24             	mov    %eax,(%esp)
80105b26:	e8 3d c5 ff ff       	call   80102068 <namecmp>
80105b2b:	85 c0                	test   %eax,%eax
80105b2d:	0f 84 2a 01 00 00    	je     80105c5d <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105b33:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
80105b47:	e8 3e c5 ff ff       	call   8010208a <dirlookup>
80105b4c:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b4f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b53:	75 05                	jne    80105b5a <sys_unlink+0xbe>
    goto bad;
80105b55:	e9 03 01 00 00       	jmp    80105c5d <sys_unlink+0x1c1>
  ilock(ip);
80105b5a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b5d:	89 04 24             	mov    %eax,(%esp)
80105b60:	e8 03 bd ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80105b65:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b68:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b6c:	66 85 c0             	test   %ax,%ax
80105b6f:	7f 0c                	jg     80105b7d <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105b71:	c7 04 24 26 89 10 80 	movl   $0x80108926,(%esp)
80105b78:	e8 bd a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105b7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b80:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b84:	66 83 f8 01          	cmp    $0x1,%ax
80105b88:	75 1f                	jne    80105ba9 <sys_unlink+0x10d>
80105b8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b8d:	89 04 24             	mov    %eax,(%esp)
80105b90:	e8 99 fe ff ff       	call   80105a2e <isdirempty>
80105b95:	85 c0                	test   %eax,%eax
80105b97:	75 10                	jne    80105ba9 <sys_unlink+0x10d>
    iunlockput(ip);
80105b99:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b9c:	89 04 24             	mov    %eax,(%esp)
80105b9f:	e8 48 bf ff ff       	call   80101aec <iunlockput>
    goto bad;
80105ba4:	e9 b4 00 00 00       	jmp    80105c5d <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105ba9:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105bb0:	00 
80105bb1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105bb8:	00 
80105bb9:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105bbc:	89 04 24             	mov    %eax,(%esp)
80105bbf:	e8 90 f5 ff ff       	call   80105154 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105bc4:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105bc7:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105bce:	00 
...
80105be0:	e8 f4 c2 ff ff       	call   80101ed9 <writei>
80105be5:	83 f8 10             	cmp    $0x10,%eax
80105be8:	74 0c                	je     80105bf6 <sys_unlink+0x15a>
    panic("unlink: writei");
80105bea:	c7 04 24 38 89 10 80 	movl   $0x80108938,(%esp)
80105bf1:	e8 44 a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105bf6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bf9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105bfd:	66 83 f8 01          	cmp    $0x1,%ax
80105c01:	75 1c                	jne    80105c1f <sys_unlink+0x183>
    dp->nlink--;
80105c03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c06:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105c0a:	8d 50 ff             	lea    -0x1(%eax),%edx
80105c0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c10:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105c14:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c17:	89 04 24             	mov    %eax,(%esp)
80105c1a:	e8 8d ba ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
80105c1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c22:	89 04 24             	mov    %eax,(%esp)
80105c25:	e8 c2 be ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
80105c2a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c2d:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105c31:	8d 50 ff             	lea    -0x1(%eax),%edx
80105c34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c37:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105c3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c3e:	89 04 24             	mov    %eax,(%esp)
80105c41:	e8 66 ba ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105c46:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c49:	89 04 24             	mov    %eax,(%esp)
80105c4c:	e8 9b be ff ff       	call   80101aec <iunlockput>

  end_op();
80105c51:	e8 4b d8 ff ff       	call   801034a1 <end_op>

  return 0;
80105c56:	b8 00 00 00 00       	mov    $0x0,%eax
80105c5b:	eb 15                	jmp    80105c72 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105c5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c60:	89 04 24             	mov    %eax,(%esp)
80105c63:	e8 84 be ff ff       	call   80101aec <iunlockput>
  end_op();
80105c68:	e8 34 d8 ff ff       	call   801034a1 <end_op>
  return -1;
...
80105d23:	e9 0a 01 00 00       	jmp    80105e32 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105d28:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105d2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d2f:	8b 00                	mov    (%eax),%eax
80105d31:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d35:	89 04 24             	mov    %eax,(%esp)
80105d38:	e8 90 b8 ff ff       	call   801015cd <ialloc>
80105d3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d40:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d44:	75 0c                	jne    80105d52 <create+0xde>
    panic("create: ialloc");
80105d46:	c7 04 24 47 89 10 80 	movl   $0x80108947,(%esp)
80105d4d:	e8 e8 a7 ff ff       	call   8010053a <panic>

  ilock(ip);
80105d52:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d55:	89 04 24             	mov    %eax,(%esp)
80105d58:	e8 0b bb ff ff       	call   80101868 <ilock>
  ip->major = major;
80105d5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d60:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105d64:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105d68:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d6b:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105d6f:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105d73:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d76:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105d7c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d7f:	89 04 24             	mov    %eax,(%esp)
80105d82:	e8 25 b9 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105d87:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105d8c:	75 6a                	jne    80105df8 <create+0x184>
    dp->nlink++;  // for ".."
...
80105d9b:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105d9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105da2:	89 04 24             	mov    %eax,(%esp)
80105da5:	e8 02 b9 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105daa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dad:	8b 40 04             	mov    0x4(%eax),%eax
80105db0:	89 44 24 08          	mov    %eax,0x8(%esp)
80105db4:	c7 44 24 04 21 89 10 	movl   $0x80108921,0x4(%esp)
80105dbb:	80 
80105dbc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dbf:	89 04 24             	mov    %eax,(%esp)
80105dc2:	e8 8c c3 ff ff       	call   80102153 <dirlink>
80105dc7:	85 c0                	test   %eax,%eax
80105dc9:	78 21                	js     80105dec <create+0x178>
80105dcb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dce:	8b 40 04             	mov    0x4(%eax),%eax
80105dd1:	89 44 24 08          	mov    %eax,0x8(%esp)
80105dd5:	c7 44 24 04 23 89 10 	movl   $0x80108923,0x4(%esp)
80105ddc:	80 
80105ddd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de0:	89 04 24             	mov    %eax,(%esp)
80105de3:	e8 6b c3 ff ff       	call   80102153 <dirlink>
80105de8:	85 c0                	test   %eax,%eax
80105dea:	79 0c                	jns    80105df8 <create+0x184>
      panic("create dots");
80105dec:	c7 04 24 56 89 10 80 	movl   $0x80108956,(%esp)
80105df3:	e8 42 a7 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105df8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dfb:	8b 40 04             	mov    0x4(%eax),%eax
...
80105e0f:	e8 3f c3 ff ff       	call   80102153 <dirlink>
80105e14:	85 c0                	test   %eax,%eax
80105e16:	79 0c                	jns    80105e24 <create+0x1b0>
    panic("create: dirlink");
80105e18:	c7 04 24 62 89 10 80 	movl   $0x80108962,(%esp)
80105e1f:	e8 16 a7 ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105e24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e27:	89 04 24             	mov    %eax,(%esp)
80105e2a:	e8 bd bc ff ff       	call   80101aec <iunlockput>
...
80105e37:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105e41:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e48:	e8 d9 f6 ff ff       	call   80105526 <argstr>
80105e4d:	85 c0                	test   %eax,%eax
80105e4f:	78 17                	js     80105e68 <sys_open+0x34>
80105e51:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e54:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e5f:	e8 32 f6 ff ff       	call   80105496 <argint>
80105e64:	85 c0                	test   %eax,%eax
80105e66:	79 0a                	jns    80105e72 <sys_open+0x3e>
    return -1;
80105e68:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e6d:	e9 5c 01 00 00       	jmp    80105fce <sys_open+0x19a>

  begin_op();
80105e72:	e8 a6 d5 ff ff       	call   8010341d <begin_op>

  if(omode & O_CREATE){
80105e77:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e7a:	25 00 02 00 00       	and    $0x200,%eax
80105e7f:	85 c0                	test   %eax,%eax
80105e81:	74 3b                	je     80105ebe <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105e83:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e86:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105e8d:	00 
80105e8e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e95:	00 
80105e96:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105e9d:	00 
80105e9e:	89 04 24             	mov    %eax,(%esp)
80105ea1:	e8 ce fd ff ff       	call   80105c74 <create>
80105ea6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105ea9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ead:	75 6b                	jne    80105f1a <sys_open+0xe6>
      end_op();
80105eaf:	e8 ed d5 ff ff       	call   801034a1 <end_op>
      return -1;
80105eb4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eb9:	e9 10 01 00 00       	jmp    80105fce <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80105ebe:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ec1:	89 04 24             	mov    %eax,(%esp)
80105ec4:	e8 4a c5 ff ff       	call   80102413 <namei>
80105ec9:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ecc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ed0:	75 0f                	jne    80105ee1 <sys_open+0xad>
      end_op();
80105ed2:	e8 ca d5 ff ff       	call   801034a1 <end_op>
      return -1;
80105ed7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105edc:	e9 ed 00 00 00       	jmp    80105fce <sys_open+0x19a>
    }
    ilock(ip);
80105ee1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ee4:	89 04 24             	mov    %eax,(%esp)
80105ee7:	e8 7c b9 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105eec:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eef:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ef3:	66 83 f8 01          	cmp    $0x1,%ax
80105ef7:	75 21                	jne    80105f1a <sys_open+0xe6>
80105ef9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105efc:	85 c0                	test   %eax,%eax
80105efe:	74 1a                	je     80105f1a <sys_open+0xe6>
      iunlockput(ip);
80105f00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f03:	89 04 24             	mov    %eax,(%esp)
80105f06:	e8 e1 bb ff ff       	call   80101aec <iunlockput>
      end_op();
80105f0b:	e8 91 d5 ff ff       	call   801034a1 <end_op>
      return -1;
80105f10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f15:	e9 b4 00 00 00       	jmp    80105fce <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105f1a:	e8 14 b0 ff ff       	call   80100f33 <filealloc>
80105f1f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f22:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f26:	74 14                	je     80105f3c <sys_open+0x108>
80105f28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f2b:	89 04 24             	mov    %eax,(%esp)
80105f2e:	e8 2e f7 ff ff       	call   80105661 <fdalloc>
80105f33:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105f36:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105f3a:	79 28                	jns    80105f64 <sys_open+0x130>
    if(f)
80105f3c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f40:	74 0b                	je     80105f4d <sys_open+0x119>
      fileclose(f);
80105f42:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f45:	89 04 24             	mov    %eax,(%esp)
80105f48:	e8 8e b0 ff ff       	call   80100fdb <fileclose>
    iunlockput(ip);
80105f4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f50:	89 04 24             	mov    %eax,(%esp)
80105f53:	e8 94 bb ff ff       	call   80101aec <iunlockput>
    end_op();
80105f58:	e8 44 d5 ff ff       	call   801034a1 <end_op>
    return -1;
80105f5d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f62:	eb 6a                	jmp    80105fce <sys_open+0x19a>
  }
  iunlock(ip);
80105f64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f67:	89 04 24             	mov    %eax,(%esp)
80105f6a:	e8 47 ba ff ff       	call   801019b6 <iunlock>
  end_op();
80105f6f:	e8 2d d5 ff ff       	call   801034a1 <end_op>

  f->type = FD_INODE;
80105f74:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f77:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105f7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f80:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f83:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105f86:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f89:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105f90:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f93:	83 e0 01             	and    $0x1,%eax
80105f96:	85 c0                	test   %eax,%eax
80105f98:	0f 94 c0             	sete   %al
80105f9b:	89 c2                	mov    %eax,%edx
80105f9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa0:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105fa3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fa6:	83 e0 01             	and    $0x1,%eax
80105fa9:	85 c0                	test   %eax,%eax
80105fab:	75 0a                	jne    80105fb7 <sys_open+0x183>
80105fad:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fb0:	83 e0 02             	and    $0x2,%eax
80105fb3:	85 c0                	test   %eax,%eax
80105fb5:	74 07                	je     80105fbe <sys_open+0x18a>
80105fb7:	b8 01 00 00 00       	mov    $0x1,%eax
80105fbc:	eb 05                	jmp    80105fc3 <sys_open+0x18f>
80105fbe:	b8 00 00 00 00       	mov    $0x0,%eax
80105fc3:	89 c2                	mov    %eax,%edx
80105fc5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fc8:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80105fd3:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
80105fd6:	e8 42 d4 ff ff       	call   8010341d <begin_op>
...
80105fe9:	e8 38 f5 ff ff       	call   80105526 <argstr>
80105fee:	85 c0                	test   %eax,%eax
80105ff0:	78 2c                	js     8010601e <sys_mkdir+0x4e>
80105ff2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ff5:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105ffc:	00 
80105ffd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106004:	00 
80106005:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010600c:	00 
8010600d:	89 04 24             	mov    %eax,(%esp)
80106010:	e8 5f fc ff ff       	call   80105c74 <create>
80106015:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106018:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010601c:	75 0c                	jne    8010602a <sys_mkdir+0x5a>
    end_op();
8010601e:	e8 7e d4 ff ff       	call   801034a1 <end_op>
    return -1;
80106023:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106028:	eb 15                	jmp    8010603f <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010602a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010602d:	89 04 24             	mov    %eax,(%esp)
80106030:	e8 b7 ba ff ff       	call   80101aec <iunlockput>
  end_op();
80106035:	e8 67 d4 ff ff       	call   801034a1 <end_op>
  return 0;
...
80106094:	78 30                	js     801060c6 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106096:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106099:	0f bf c8             	movswl %ax,%ecx
8010609c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010609f:	0f bf d0             	movswl %ax,%edx
801060a2:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801060a5:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801060a9:	89 54 24 08          	mov    %edx,0x8(%esp)
801060ad:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801060b4:	00 
801060b5:	89 04 24             	mov    %eax,(%esp)
801060b8:	e8 b7 fb ff ff       	call   80105c74 <create>
801060bd:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060c0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060c4:	75 0c                	jne    801060d2 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801060c6:	e8 d6 d3 ff ff       	call   801034a1 <end_op>
    return -1;
801060cb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060d0:	eb 15                	jmp    801060e7 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801060d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060d5:	89 04 24             	mov    %eax,(%esp)
801060d8:	e8 0f ba ff ff       	call   80101aec <iunlockput>
  end_op();
801060dd:	e8 bf d3 ff ff       	call   801034a1 <end_op>
  return 0;
...
80106191:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801061a5:	e8 7c f3 ff ff       	call   80105526 <argstr>
801061aa:	85 c0                	test   %eax,%eax
801061ac:	78 1a                	js     801061c8 <sys_exec+0x3a>
801061ae:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801061b4:	89 44 24 04          	mov    %eax,0x4(%esp)
801061b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801061bf:	e8 d2 f2 ff ff       	call   80105496 <argint>
801061c4:	85 c0                	test   %eax,%eax
801061c6:	79 0a                	jns    801061d2 <sys_exec+0x44>
    return -1;
801061c8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061cd:	e9 c8 00 00 00       	jmp    8010629a <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
801061d2:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801061d9:	00 
801061da:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801061e1:	00 
801061e2:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801061e8:	89 04 24             	mov    %eax,(%esp)
801061eb:	e8 64 ef ff ff       	call   80105154 <memset>
  for(i=0;; i++){
801061f0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801061f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061fa:	83 f8 1f             	cmp    $0x1f,%eax
801061fd:	76 0a                	jbe    80106209 <sys_exec+0x7b>
      return -1;
801061ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106204:	e9 91 00 00 00       	jmp    8010629a <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106209:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010620c:	c1 e0 02             	shl    $0x2,%eax
8010620f:	89 c2                	mov    %eax,%edx
80106211:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106217:	01 c2                	add    %eax,%edx
80106219:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010621f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106223:	89 14 24             	mov    %edx,(%esp)
80106226:	e8 cf f1 ff ff       	call   801053fa <fetchint>
8010622b:	85 c0                	test   %eax,%eax
8010622d:	79 07                	jns    80106236 <sys_exec+0xa8>
      return -1;
8010622f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106234:	eb 64                	jmp    8010629a <sys_exec+0x10c>
    if(uarg == 0){
80106236:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010623c:	85 c0                	test   %eax,%eax
8010623e:	75 26                	jne    80106266 <sys_exec+0xd8>
      argv[i] = 0;
80106240:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106243:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010624a:	00 00 00 00 
      break;
8010624e:	90                   	nop
    }
...
80106252:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106258:	89 54 24 04          	mov    %edx,0x4(%esp)
8010625c:	89 04 24             	mov    %eax,(%esp)
8010625f:	e8 8b a8 ff ff       	call   80100aef <exec>
80106264:	eb 34                	jmp    8010629a <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
80106266:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010626c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010626f:	c1 e2 02             	shl    $0x2,%edx
80106272:	01 c2                	add    %eax,%edx
80106274:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010627a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010627e:	89 04 24             	mov    %eax,(%esp)
80106281:	e8 ae f1 ff ff       	call   80105434 <fetchstr>
80106286:	85 c0                	test   %eax,%eax
80106288:	79 07                	jns    80106291 <sys_exec+0x103>
      return -1;
8010628a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010628f:	eb 09                	jmp    8010629a <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106291:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80106295:	e9 5d ff ff ff       	jmp    801061f7 <sys_exec+0x69>
  return exec(path, argv);
}
8010629a:	c9                   	leave  
8010629b:	c3                   	ret    
...
801062a2:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801062a9:	00 
801062aa:	8d 45 ec             	lea    -0x14(%ebp),%eax
801062ad:	89 44 24 04          	mov    %eax,0x4(%esp)
801062b1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801062b8:	e8 07 f2 ff ff       	call   801054c4 <argptr>
801062bd:	85 c0                	test   %eax,%eax
801062bf:	79 0a                	jns    801062cb <sys_pipe+0x2f>
    return -1;
801062c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c6:	e9 9b 00 00 00       	jmp    80106366 <sys_pipe+0xca>
...
801062d8:	e8 51 dc ff ff       	call   80103f2e <pipealloc>
801062dd:	85 c0                	test   %eax,%eax
801062df:	79 07                	jns    801062e8 <sys_pipe+0x4c>
    return -1;
801062e1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062e6:	eb 7e                	jmp    80106366 <sys_pipe+0xca>
  fd0 = -1;
801062e8:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801062ef:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062f2:	89 04 24             	mov    %eax,(%esp)
801062f5:	e8 67 f3 ff ff       	call   80105661 <fdalloc>
801062fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062fd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106301:	78 14                	js     80106317 <sys_pipe+0x7b>
80106303:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106306:	89 04 24             	mov    %eax,(%esp)
80106309:	e8 53 f3 ff ff       	call   80105661 <fdalloc>
8010630e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106311:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106315:	79 37                	jns    8010634e <sys_pipe+0xb2>
    if(fd0 >= 0)
80106317:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010631b:	78 14                	js     80106331 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010631d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106323:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106326:	83 c2 08             	add    $0x8,%edx
80106329:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106330:	00 
    fileclose(rf);
80106331:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106334:	89 04 24             	mov    %eax,(%esp)
80106337:	e8 9f ac ff ff       	call   80100fdb <fileclose>
    fileclose(wf);
8010633c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010633f:	89 04 24             	mov    %eax,(%esp)
80106342:	e8 94 ac ff ff       	call   80100fdb <fileclose>
    return -1;
80106347:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010634c:	eb 18                	jmp    80106366 <sys_pipe+0xca>
  }
  fd[0] = fd0;
8010634e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106351:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106354:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106356:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106359:	8d 50 04             	lea    0x4(%eax),%edx
8010635c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010635f:	89 02                	mov    %eax,(%edx)
  return 0;
...
8010636b:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010636e:	e8 b2 e2 ff ff       	call   80104625 <fork>
}
80106373:	c9                   	leave  
80106374:	c3                   	ret    
...
80106378:	83 ec 08             	sub    $0x8,%esp
  exit();
8010637b:	e8 2f e4 ff ff       	call   801047af <exit>
...
8010638a:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010638d:	e8 3f e5 ff ff       	call   801048d1 <wait>
}
80106392:	c9                   	leave  
80106393:	c3                   	ret    
...
801063a8:	e8 e9 f0 ff ff       	call   80105496 <argint>
801063ad:	85 c0                	test   %eax,%eax
801063af:	79 07                	jns    801063b8 <sys_kill+0x24>
    return -1;
801063b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063b6:	eb 0b                	jmp    801063c3 <sys_kill+0x2f>
  return kill(pid);
801063b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063bb:	89 04 24             	mov    %eax,(%esp)
801063be:	e8 4a e9 ff ff       	call   80104d0d <kill>
}
801063c3:	c9                   	leave  
801063c4:	c3                   	ret    
...
801063ce:	8b 40 10             	mov    0x10(%eax),%eax
}
801063d1:	5d                   	pop    %ebp
801063d2:	c3                   	ret    
...
801063e7:	e8 aa f0 ff ff       	call   80105496 <argint>
801063ec:	85 c0                	test   %eax,%eax
801063ee:	79 07                	jns    801063f7 <sys_sbrk+0x24>
    return -1;
801063f0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063f5:	eb 24                	jmp    8010641b <sys_sbrk+0x48>
  addr = proc->sz;
801063f7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063fd:	8b 00                	mov    (%eax),%eax
801063ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80106402:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106405:	89 04 24             	mov    %eax,(%esp)
80106408:	e8 73 e1 ff ff       	call   80104580 <growproc>
8010640d:	85 c0                	test   %eax,%eax
8010640f:	79 07                	jns    80106418 <sys_sbrk+0x45>
    return -1;
80106411:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106416:	eb 03                	jmp    8010641b <sys_sbrk+0x48>
  return addr;
...
80106420:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
...
80106431:	e8 60 f0 ff ff       	call   80105496 <argint>
80106436:	85 c0                	test   %eax,%eax
80106438:	79 07                	jns    80106441 <sys_sleep+0x24>
    return -1;
8010643a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010643f:	eb 6c                	jmp    801064ad <sys_sleep+0x90>
  acquire(&tickslock);
80106441:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
80106448:	e8 b3 ea ff ff       	call   80104f00 <acquire>
  ticks0 = ticks;
8010644d:	a1 e0 51 11 80       	mov    0x801151e0,%eax
80106452:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106455:	eb 34                	jmp    8010648b <sys_sleep+0x6e>
    if(proc->killed){
80106457:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010645d:	8b 40 24             	mov    0x24(%eax),%eax
80106460:	85 c0                	test   %eax,%eax
80106462:	74 13                	je     80106477 <sys_sleep+0x5a>
      release(&tickslock);
80106464:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
8010646b:	e8 f2 ea ff ff       	call   80104f62 <release>
      return -1;
80106470:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106475:	eb 36                	jmp    801064ad <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106477:	c7 44 24 04 a0 49 11 	movl   $0x801149a0,0x4(%esp)
8010647e:	80 
8010647f:	c7 04 24 e0 51 11 80 	movl   $0x801151e0,(%esp)
80106486:	e8 7f e7 ff ff       	call   80104c0a <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010648b:	a1 e0 51 11 80       	mov    0x801151e0,%eax
80106490:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106493:	89 c2                	mov    %eax,%edx
80106495:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106498:	39 c2                	cmp    %eax,%edx
8010649a:	72 bb                	jb     80106457 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010649c:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
801064a3:	e8 ba ea ff ff       	call   80104f62 <release>
  return 0;
...
801064b2:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801064b5:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
801064bc:	e8 3f ea ff ff       	call   80104f00 <acquire>
  xticks = ticks;
801064c1:	a1 e0 51 11 80       	mov    0x801151e0,%eax
801064c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801064c9:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
801064d0:	e8 8d ea ff ff       	call   80104f62 <release>
  return xticks;
...
80106523:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106526:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010652a:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106537:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
8010653e:	00 
8010653f:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106546:	e8 c8 ff ff ff       	call   80106513 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
8010654b:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106552:	00 
80106553:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010655a:	e8 b4 ff ff ff       	call   80106513 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
8010655f:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106566:	00 
80106567:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010656e:	e8 a0 ff ff ff       	call   80106513 <outb>
  picenable(IRQ_TIMER);
80106573:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010657a:	e8 42 d8 ff ff       	call   80103dc1 <picenable>
}
8010657f:	c9                   	leave  
80106580:	c3                   	ret    
...
80106582:	06                   	push   %es
  pushl %fs
80106583:	0f a0                	push   %fs
  pushl %gs
80106585:	0f a8                	push   %gs
  pushal
80106587:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106588:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010658c:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010658e:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106590:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106594:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106596:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106598:	54                   	push   %esp
  call trap
80106599:	e8 d8 01 00 00       	call   80106776 <trap>
  addl $4, %esp
...
801065af:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801065b2:	8b 45 0c             	mov    0xc(%ebp),%eax
801065b5:	83 e8 01             	sub    $0x1,%eax
801065b8:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801065bc:	8b 45 08             	mov    0x8(%ebp),%eax
801065bf:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801065c3:	8b 45 08             	mov    0x8(%ebp),%eax
801065c6:	c1 e8 10             	shr    $0x10,%eax
801065c9:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
801065cd:	8d 45 fa             	lea    -0x6(%ebp),%eax
801065d0:	0f 01 18             	lidtl  (%eax)
}
801065d3:	c9                   	leave  
801065d4:	c3                   	ret    
...
801065db:	0f 20 d0             	mov    %cr2,%eax
801065de:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
801065e1:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801065e4:	c9                   	leave  
801065e5:	c3                   	ret    
...
801065e9:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
801065ec:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801065f3:	e9 c3 00 00 00       	jmp    801066bb <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801065f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065fb:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
80106602:	89 c2                	mov    %eax,%edx
80106604:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106607:	66 89 14 c5 e0 49 11 	mov    %dx,-0x7feeb620(,%eax,8)
8010660e:	80 
8010660f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106612:	66 c7 04 c5 e2 49 11 	movw   $0x8,-0x7feeb61e(,%eax,8)
80106619:	80 08 00 
8010661c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010661f:	0f b6 14 c5 e4 49 11 	movzbl -0x7feeb61c(,%eax,8),%edx
80106626:	80 
80106627:	83 e2 e0             	and    $0xffffffe0,%edx
8010662a:	88 14 c5 e4 49 11 80 	mov    %dl,-0x7feeb61c(,%eax,8)
80106631:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106634:	0f b6 14 c5 e4 49 11 	movzbl -0x7feeb61c(,%eax,8),%edx
8010663b:	80 
8010663c:	83 e2 1f             	and    $0x1f,%edx
8010663f:	88 14 c5 e4 49 11 80 	mov    %dl,-0x7feeb61c(,%eax,8)
80106646:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106649:	0f b6 14 c5 e5 49 11 	movzbl -0x7feeb61b(,%eax,8),%edx
80106650:	80 
80106651:	83 e2 f0             	and    $0xfffffff0,%edx
80106654:	83 ca 0e             	or     $0xe,%edx
80106657:	88 14 c5 e5 49 11 80 	mov    %dl,-0x7feeb61b(,%eax,8)
8010665e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106661:	0f b6 14 c5 e5 49 11 	movzbl -0x7feeb61b(,%eax,8),%edx
80106668:	80 
80106669:	83 e2 ef             	and    $0xffffffef,%edx
...
8010667d:	80 
8010667e:	83 e2 9f             	and    $0xffffff9f,%edx
...
80106692:	80 
80106693:	83 ca 80             	or     $0xffffff80,%edx
80106696:	88 14 c5 e5 49 11 80 	mov    %dl,-0x7feeb61b(,%eax,8)
8010669d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a0:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
801066a7:	c1 e8 10             	shr    $0x10,%eax
801066aa:	89 c2                	mov    %eax,%edx
801066ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066af:	66 89 14 c5 e6 49 11 	mov    %dx,-0x7feeb61a(,%eax,8)
801066b6:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
801066b7:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801066bb:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
801066c2:	0f 8e 30 ff ff ff    	jle    801065f8 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801066c8:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
801066cd:	66 a3 e0 4b 11 80    	mov    %ax,0x80114be0
801066d3:	66 c7 05 e2 4b 11 80 	movw   $0x8,0x80114be2
801066da:	08 00 
801066dc:	0f b6 05 e4 4b 11 80 	movzbl 0x80114be4,%eax
801066e3:	83 e0 e0             	and    $0xffffffe0,%eax
801066e6:	a2 e4 4b 11 80       	mov    %al,0x80114be4
801066eb:	0f b6 05 e4 4b 11 80 	movzbl 0x80114be4,%eax
801066f2:	83 e0 1f             	and    $0x1f,%eax
801066f5:	a2 e4 4b 11 80       	mov    %al,0x80114be4
801066fa:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
80106701:	83 c8 0f             	or     $0xf,%eax
80106704:	a2 e5 4b 11 80       	mov    %al,0x80114be5
80106709:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
80106710:	83 e0 ef             	and    $0xffffffef,%eax
80106713:	a2 e5 4b 11 80       	mov    %al,0x80114be5
80106718:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
8010671f:	83 c8 60             	or     $0x60,%eax
80106722:	a2 e5 4b 11 80       	mov    %al,0x80114be5
80106727:	0f b6 05 e5 4b 11 80 	movzbl 0x80114be5,%eax
8010672e:	83 c8 80             	or     $0xffffff80,%eax
80106731:	a2 e5 4b 11 80       	mov    %al,0x80114be5
80106736:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
8010673b:	c1 e8 10             	shr    $0x10,%eax
8010673e:	66 a3 e6 4b 11 80    	mov    %ax,0x80114be6
  
  initlock(&tickslock, "time");
80106744:	c7 44 24 04 74 89 10 	movl   $0x80108974,0x4(%esp)
8010674b:	80 
8010674c:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
80106753:	e8 87 e7 ff ff       	call   80104edf <initlock>
}
80106758:	c9                   	leave  
80106759:	c3                   	ret    
...
8010675d:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106760:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106767:	00 
80106768:	c7 04 24 e0 49 11 80 	movl   $0x801149e0,(%esp)
8010676f:	e8 38 fe ff ff       	call   801065ac <lidt>
}
80106774:	c9                   	leave  
80106775:	c3                   	ret    
...
80106779:	57                   	push   %edi
8010677a:	56                   	push   %esi
8010677b:	53                   	push   %ebx
8010677c:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
8010677f:	8b 45 08             	mov    0x8(%ebp),%eax
80106782:	8b 40 30             	mov    0x30(%eax),%eax
80106785:	83 f8 40             	cmp    $0x40,%eax
80106788:	75 3f                	jne    801067c9 <trap+0x53>
    if(proc->killed)
8010678a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106790:	8b 40 24             	mov    0x24(%eax),%eax
80106793:	85 c0                	test   %eax,%eax
80106795:	74 05                	je     8010679c <trap+0x26>
      exit();
80106797:	e8 13 e0 ff ff       	call   801047af <exit>
    proc->tf = tf;
8010679c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067a2:	8b 55 08             	mov    0x8(%ebp),%edx
801067a5:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801067a8:	e8 b0 ed ff ff       	call   8010555d <syscall>
    if(proc->killed)
801067ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067b3:	8b 40 24             	mov    0x24(%eax),%eax
801067b6:	85 c0                	test   %eax,%eax
801067b8:	74 0a                	je     801067c4 <trap+0x4e>
      exit();
801067ba:	e8 f0 df ff ff       	call   801047af <exit>
    return;
801067bf:	e9 2d 02 00 00       	jmp    801069f1 <trap+0x27b>
801067c4:	e9 28 02 00 00       	jmp    801069f1 <trap+0x27b>
  }

  switch(tf->trapno){
801067c9:	8b 45 08             	mov    0x8(%ebp),%eax
801067cc:	8b 40 30             	mov    0x30(%eax),%eax
801067cf:	83 e8 20             	sub    $0x20,%eax
801067d2:	83 f8 1f             	cmp    $0x1f,%eax
801067d5:	0f 87 bc 00 00 00    	ja     80106897 <trap+0x121>
801067db:	8b 04 85 1c 8a 10 80 	mov    -0x7fef75e4(,%eax,4),%eax
801067e2:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
801067e4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801067ea:	0f b6 00             	movzbl (%eax),%eax
801067ed:	84 c0                	test   %al,%al
801067ef:	75 31                	jne    80106822 <trap+0xac>
      acquire(&tickslock);
801067f1:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
801067f8:	e8 03 e7 ff ff       	call   80104f00 <acquire>
      ticks++;
801067fd:	a1 e0 51 11 80       	mov    0x801151e0,%eax
80106802:	83 c0 01             	add    $0x1,%eax
80106805:	a3 e0 51 11 80       	mov    %eax,0x801151e0
      wakeup(&ticks);
8010680a:	c7 04 24 e0 51 11 80 	movl   $0x801151e0,(%esp)
80106811:	e8 cc e4 ff ff       	call   80104ce2 <wakeup>
      release(&tickslock);
80106816:	c7 04 24 a0 49 11 80 	movl   $0x801149a0,(%esp)
8010681d:	e8 40 e7 ff ff       	call   80104f62 <release>
    }
    lapiceoi();
80106822:	e8 b6 c6 ff ff       	call   80102edd <lapiceoi>
    break;
80106827:	e9 41 01 00 00       	jmp    8010696d <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010682c:	e8 ba be ff ff       	call   801026eb <ideintr>
    lapiceoi();
80106831:	e8 a7 c6 ff ff       	call   80102edd <lapiceoi>
    break;
80106836:	e9 32 01 00 00       	jmp    8010696d <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010683b:	e8 6c c4 ff ff       	call   80102cac <kbdintr>
    lapiceoi();
80106840:	e8 98 c6 ff ff       	call   80102edd <lapiceoi>
    break;
80106845:	e9 23 01 00 00       	jmp    8010696d <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010684a:	e8 97 03 00 00       	call   80106be6 <uartintr>
    lapiceoi();
8010684f:	e8 89 c6 ff ff       	call   80102edd <lapiceoi>
    break;
80106854:	e9 14 01 00 00       	jmp    8010696d <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106859:	8b 45 08             	mov    0x8(%ebp),%eax
8010685c:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
8010685f:	8b 45 08             	mov    0x8(%ebp),%eax
80106862:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106866:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106869:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
...
80106875:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106879:	89 54 24 08          	mov    %edx,0x8(%esp)
8010687d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106881:	c7 04 24 7c 89 10 80 	movl   $0x8010897c,(%esp)
80106888:	e8 13 9b ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
8010688d:	e8 4b c6 ff ff       	call   80102edd <lapiceoi>
    break;
80106892:	e9 d6 00 00 00       	jmp    8010696d <trap+0x1f7>
...
8010689f:	74 11                	je     801068b2 <trap+0x13c>
...
801068b0:	75 46                	jne    801068f8 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801068b2:	e8 1e fd ff ff       	call   801065d5 <rcr2>
801068b7:	8b 55 08             	mov    0x8(%ebp),%edx
801068ba:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
801068bd:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801068c4:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801068c7:	0f b6 ca             	movzbl %dl,%ecx
801068ca:	8b 55 08             	mov    0x8(%ebp),%edx
801068cd:	8b 52 30             	mov    0x30(%edx),%edx
801068d0:	89 44 24 10          	mov    %eax,0x10(%esp)
801068d4:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801068d8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801068dc:	89 54 24 04          	mov    %edx,0x4(%esp)
801068e0:	c7 04 24 a0 89 10 80 	movl   $0x801089a0,(%esp)
801068e7:	e8 b4 9a ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801068ec:	c7 04 24 d2 89 10 80 	movl   $0x801089d2,(%esp)
801068f3:	e8 42 9c ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801068f8:	e8 d8 fc ff ff       	call   801065d5 <rcr2>
801068fd:	89 c2                	mov    %eax,%edx
801068ff:	8b 45 08             	mov    0x8(%ebp),%eax
80106902:	8b 78 38             	mov    0x38(%eax),%edi
...
8010690b:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010690e:	0f b6 f0             	movzbl %al,%esi
80106911:	8b 45 08             	mov    0x8(%ebp),%eax
80106914:	8b 58 34             	mov    0x34(%eax),%ebx
80106917:	8b 45 08             	mov    0x8(%ebp),%eax
8010691a:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010691d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106923:	83 c0 6c             	add    $0x6c,%eax
...
80106929:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010692f:	8b 40 10             	mov    0x10(%eax),%eax
80106932:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106936:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010693a:	89 74 24 14          	mov    %esi,0x14(%esp)
8010693e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106942:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106946:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106949:	89 74 24 08          	mov    %esi,0x8(%esp)
8010694d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106951:	c7 04 24 d8 89 10 80 	movl   $0x801089d8,(%esp)
80106958:	e8 43 9a ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
...
8010696a:	eb 01                	jmp    8010696d <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106994:	75 05                	jne    8010699b <trap+0x225>
    exit();
80106996:	e8 14 de ff ff       	call   801047af <exit>
...
801069ea:	75 05                	jne    801069f1 <trap+0x27b>
    exit();
801069ec:	e8 be dd ff ff       	call   801047af <exit>
}
801069f1:	83 c4 3c             	add    $0x3c,%esp
801069f4:	5b                   	pop    %ebx
801069f5:	5e                   	pop    %esi
801069f6:	5f                   	pop    %edi
801069f7:	5d                   	pop    %ebp
...
80106a37:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106a3a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a41:	00 
80106a42:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106a49:	e8 c8 ff ff ff       	call   80106a16 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106a4e:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106a55:	00 
80106a56:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106a5d:	e8 b4 ff ff ff       	call   80106a16 <outb>
  outb(COM1+0, 115200/9600);
80106a62:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106a69:	00 
80106a6a:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a71:	e8 a0 ff ff ff       	call   80106a16 <outb>
  outb(COM1+1, 0);
80106a76:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a7d:	00 
80106a7e:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106a85:	e8 8c ff ff ff       	call   80106a16 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106a8a:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106a91:	00 
80106a92:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106a99:	e8 78 ff ff ff       	call   80106a16 <outb>
  outb(COM1+4, 0);
80106a9e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106aa5:	00 
80106aa6:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106aad:	e8 64 ff ff ff       	call   80106a16 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106ab2:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106ab9:	00 
80106aba:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106ac1:	e8 50 ff ff ff       	call   80106a16 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106ac6:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106acd:	e8 27 ff ff ff       	call   801069f9 <inb>
80106ad2:	3c ff                	cmp    $0xff,%al
80106ad4:	75 02                	jne    80106ad8 <uartinit+0xa4>
    return;
80106ad6:	eb 6a                	jmp    80106b42 <uartinit+0x10e>
  uart = 1;
80106ad8:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106adf:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106ae2:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106ae9:	e8 0b ff ff ff       	call   801069f9 <inb>
  inb(COM1+0);
80106aee:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106af5:	e8 ff fe ff ff       	call   801069f9 <inb>
  picenable(IRQ_COM1);
80106afa:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b01:	e8 bb d2 ff ff       	call   80103dc1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106b06:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b0d:	00 
80106b0e:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b15:	e8 50 be ff ff       	call   8010296a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106b1a:	c7 45 f4 9c 8a 10 80 	movl   $0x80108a9c,-0xc(%ebp)
80106b21:	eb 15                	jmp    80106b38 <uartinit+0x104>
    uartputc(*p);
80106b23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b26:	0f b6 00             	movzbl (%eax),%eax
80106b29:	0f be c0             	movsbl %al,%eax
80106b2c:	89 04 24             	mov    %eax,(%esp)
80106b2f:	e8 10 00 00 00       	call   80106b44 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106b47:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106b4a:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106b4f:	85 c0                	test   %eax,%eax
80106b51:	75 02                	jne    80106b55 <uartputc+0x11>
    return;
80106b53:	eb 4b                	jmp    80106ba0 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106b55:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106b5c:	eb 10                	jmp    80106b6e <uartputc+0x2a>
    microdelay(10);
80106b5e:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106b65:	e8 98 c3 ff ff       	call   80102f02 <microdelay>
{
  int i;
...
80106b72:	7f 16                	jg     80106b8a <uartputc+0x46>
80106b74:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b7b:	e8 79 fe ff ff       	call   801069f9 <inb>
80106b80:	0f b6 c0             	movzbl %al,%eax
80106b83:	83 e0 20             	and    $0x20,%eax
80106b86:	85 c0                	test   %eax,%eax
80106b88:	74 d4                	je     80106b5e <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
...
80106b9b:	e8 76 fe ff ff       	call   80106a16 <outb>
}
80106ba0:	c9                   	leave  
80106ba1:	c3                   	ret    
...
80106ba5:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106ba8:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106bad:	85 c0                	test   %eax,%eax
80106baf:	75 07                	jne    80106bb8 <uartgetc+0x16>
    return -1;
80106bb1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bb6:	eb 2c                	jmp    80106be4 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106bb8:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106bbf:	e8 35 fe ff ff       	call   801069f9 <inb>
80106bc4:	0f b6 c0             	movzbl %al,%eax
80106bc7:	83 e0 01             	and    $0x1,%eax
80106bca:	85 c0                	test   %eax,%eax
80106bcc:	75 07                	jne    80106bd5 <uartgetc+0x33>
    return -1;
80106bce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bd3:	eb 0f                	jmp    80106be4 <uartgetc+0x42>
  return inb(COM1+0);
80106bd5:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106bdc:	e8 18 fe ff ff       	call   801069f9 <inb>
80106be1:	0f b6 c0             	movzbl %al,%eax
}
80106be4:	c9                   	leave  
80106be5:	c3                   	ret    
...
80106be9:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106bec:	c7 04 24 a2 6b 10 80 	movl   $0x80106ba2,(%esp)
80106bf3:	e8 b5 9b ff ff       	call   801007ad <consoleintr>
}
80106bf8:	c9                   	leave  
80106bf9:	c3                   	ret    
...
80106bfc:	6a 00                	push   $0x0
  jmp alltraps
80106bfe:	e9 7e f9 ff ff       	jmp    80106581 <alltraps>
...
80106c03:	6a 00                	push   $0x0
  pushl $1
80106c05:	6a 01                	push   $0x1
  jmp alltraps
80106c07:	e9 75 f9 ff ff       	jmp    80106581 <alltraps>
...
80106c0c:	6a 00                	push   $0x0
  pushl $2
80106c0e:	6a 02                	push   $0x2
  jmp alltraps
80106c10:	e9 6c f9 ff ff       	jmp    80106581 <alltraps>
...
80106c15:	6a 00                	push   $0x0
  pushl $3
80106c17:	6a 03                	push   $0x3
  jmp alltraps
80106c19:	e9 63 f9 ff ff       	jmp    80106581 <alltraps>
...
80106c1e:	6a 00                	push   $0x0
  pushl $4
80106c20:	6a 04                	push   $0x4
  jmp alltraps
80106c22:	e9 5a f9 ff ff       	jmp    80106581 <alltraps>
...
80106c27:	6a 00                	push   $0x0
  pushl $5
80106c29:	6a 05                	push   $0x5
  jmp alltraps
80106c2b:	e9 51 f9 ff ff       	jmp    80106581 <alltraps>
...
80106c30:	6a 00                	push   $0x0
  pushl $6
80106c32:	6a 06                	push   $0x6
  jmp alltraps
80106c34:	e9 48 f9 ff ff       	jmp    80106581 <alltraps>
...
80106c39:	6a 00                	push   $0x0
  pushl $7
80106c3b:	6a 07                	push   $0x7
  jmp alltraps
80106c3d:	e9 3f f9 ff ff       	jmp    80106581 <alltraps>

80106c42 <vector8>:
.globl vector8
vector8:
  pushl $8
80106c42:	6a 08                	push   $0x8
  jmp alltraps
80106c44:	e9 38 f9 ff ff       	jmp    80106581 <alltraps>
...
80106c49:	6a 00                	push   $0x0
  pushl $9
80106c4b:	6a 09                	push   $0x9
  jmp alltraps
80106c4d:	e9 2f f9 ff ff       	jmp    80106581 <alltraps>

80106c52 <vector10>:
.globl vector10
vector10:
  pushl $10
80106c52:	6a 0a                	push   $0xa
  jmp alltraps
80106c54:	e9 28 f9 ff ff       	jmp    80106581 <alltraps>

80106c59 <vector11>:
.globl vector11
vector11:
  pushl $11
80106c59:	6a 0b                	push   $0xb
  jmp alltraps
80106c5b:	e9 21 f9 ff ff       	jmp    80106581 <alltraps>

80106c60 <vector12>:
.globl vector12
vector12:
  pushl $12
80106c60:	6a 0c                	push   $0xc
  jmp alltraps
80106c62:	e9 1a f9 ff ff       	jmp    80106581 <alltraps>

80106c67 <vector13>:
.globl vector13
vector13:
  pushl $13
80106c67:	6a 0d                	push   $0xd
  jmp alltraps
80106c69:	e9 13 f9 ff ff       	jmp    80106581 <alltraps>

80106c6e <vector14>:
.globl vector14
vector14:
  pushl $14
80106c6e:	6a 0e                	push   $0xe
  jmp alltraps
80106c70:	e9 0c f9 ff ff       	jmp    80106581 <alltraps>
...
80106c75:	6a 00                	push   $0x0
  pushl $15
80106c77:	6a 0f                	push   $0xf
  jmp alltraps
80106c79:	e9 03 f9 ff ff       	jmp    80106581 <alltraps>
...
80106c7e:	6a 00                	push   $0x0
  pushl $16
80106c80:	6a 10                	push   $0x10
  jmp alltraps
80106c82:	e9 fa f8 ff ff       	jmp    80106581 <alltraps>

80106c87 <vector17>:
.globl vector17
vector17:
  pushl $17
80106c87:	6a 11                	push   $0x11
  jmp alltraps
80106c89:	e9 f3 f8 ff ff       	jmp    80106581 <alltraps>
...
80106c8e:	6a 00                	push   $0x0
  pushl $18
80106c90:	6a 12                	push   $0x12
  jmp alltraps
80106c92:	e9 ea f8 ff ff       	jmp    80106581 <alltraps>
...
80106c97:	6a 00                	push   $0x0
  pushl $19
80106c99:	6a 13                	push   $0x13
  jmp alltraps
80106c9b:	e9 e1 f8 ff ff       	jmp    80106581 <alltraps>
...
80106ca0:	6a 00                	push   $0x0
  pushl $20
80106ca2:	6a 14                	push   $0x14
  jmp alltraps
80106ca4:	e9 d8 f8 ff ff       	jmp    80106581 <alltraps>
...
80106ca9:	6a 00                	push   $0x0
  pushl $21
80106cab:	6a 15                	push   $0x15
  jmp alltraps
80106cad:	e9 cf f8 ff ff       	jmp    80106581 <alltraps>
...
80106cb2:	6a 00                	push   $0x0
  pushl $22
80106cb4:	6a 16                	push   $0x16
  jmp alltraps
80106cb6:	e9 c6 f8 ff ff       	jmp    80106581 <alltraps>
...
80106cbb:	6a 00                	push   $0x0
  pushl $23
80106cbd:	6a 17                	push   $0x17
  jmp alltraps
80106cbf:	e9 bd f8 ff ff       	jmp    80106581 <alltraps>
...
80106cc4:	6a 00                	push   $0x0
  pushl $24
80106cc6:	6a 18                	push   $0x18
  jmp alltraps
80106cc8:	e9 b4 f8 ff ff       	jmp    80106581 <alltraps>
...
80106ccd:	6a 00                	push   $0x0
  pushl $25
80106ccf:	6a 19                	push   $0x19
  jmp alltraps
80106cd1:	e9 ab f8 ff ff       	jmp    80106581 <alltraps>
...
80106cd6:	6a 00                	push   $0x0
  pushl $26
80106cd8:	6a 1a                	push   $0x1a
  jmp alltraps
80106cda:	e9 a2 f8 ff ff       	jmp    80106581 <alltraps>
...
80106cdf:	6a 00                	push   $0x0
  pushl $27
80106ce1:	6a 1b                	push   $0x1b
  jmp alltraps
80106ce3:	e9 99 f8 ff ff       	jmp    80106581 <alltraps>
...
80106ce8:	6a 00                	push   $0x0
  pushl $28
80106cea:	6a 1c                	push   $0x1c
  jmp alltraps
80106cec:	e9 90 f8 ff ff       	jmp    80106581 <alltraps>
...
80106cf1:	6a 00                	push   $0x0
  pushl $29
80106cf3:	6a 1d                	push   $0x1d
  jmp alltraps
80106cf5:	e9 87 f8 ff ff       	jmp    80106581 <alltraps>
...
80106cfa:	6a 00                	push   $0x0
  pushl $30
80106cfc:	6a 1e                	push   $0x1e
  jmp alltraps
80106cfe:	e9 7e f8 ff ff       	jmp    80106581 <alltraps>
...
80106d03:	6a 00                	push   $0x0
  pushl $31
80106d05:	6a 1f                	push   $0x1f
  jmp alltraps
80106d07:	e9 75 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d0c:	6a 00                	push   $0x0
  pushl $32
80106d0e:	6a 20                	push   $0x20
  jmp alltraps
80106d10:	e9 6c f8 ff ff       	jmp    80106581 <alltraps>
...
80106d15:	6a 00                	push   $0x0
  pushl $33
80106d17:	6a 21                	push   $0x21
  jmp alltraps
80106d19:	e9 63 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d1e:	6a 00                	push   $0x0
  pushl $34
80106d20:	6a 22                	push   $0x22
  jmp alltraps
80106d22:	e9 5a f8 ff ff       	jmp    80106581 <alltraps>
...
80106d27:	6a 00                	push   $0x0
  pushl $35
80106d29:	6a 23                	push   $0x23
  jmp alltraps
80106d2b:	e9 51 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d30:	6a 00                	push   $0x0
  pushl $36
80106d32:	6a 24                	push   $0x24
  jmp alltraps
80106d34:	e9 48 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d39:	6a 00                	push   $0x0
  pushl $37
80106d3b:	6a 25                	push   $0x25
  jmp alltraps
80106d3d:	e9 3f f8 ff ff       	jmp    80106581 <alltraps>
...
80106d42:	6a 00                	push   $0x0
  pushl $38
80106d44:	6a 26                	push   $0x26
  jmp alltraps
80106d46:	e9 36 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d4b:	6a 00                	push   $0x0
  pushl $39
80106d4d:	6a 27                	push   $0x27
  jmp alltraps
80106d4f:	e9 2d f8 ff ff       	jmp    80106581 <alltraps>
...
80106d54:	6a 00                	push   $0x0
  pushl $40
80106d56:	6a 28                	push   $0x28
  jmp alltraps
80106d58:	e9 24 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d5d:	6a 00                	push   $0x0
  pushl $41
80106d5f:	6a 29                	push   $0x29
  jmp alltraps
80106d61:	e9 1b f8 ff ff       	jmp    80106581 <alltraps>
...
80106d66:	6a 00                	push   $0x0
  pushl $42
80106d68:	6a 2a                	push   $0x2a
  jmp alltraps
80106d6a:	e9 12 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d6f:	6a 00                	push   $0x0
  pushl $43
80106d71:	6a 2b                	push   $0x2b
  jmp alltraps
80106d73:	e9 09 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d78:	6a 00                	push   $0x0
  pushl $44
80106d7a:	6a 2c                	push   $0x2c
  jmp alltraps
80106d7c:	e9 00 f8 ff ff       	jmp    80106581 <alltraps>
...
80106d81:	6a 00                	push   $0x0
  pushl $45
80106d83:	6a 2d                	push   $0x2d
  jmp alltraps
80106d85:	e9 f7 f7 ff ff       	jmp    80106581 <alltraps>
...
80106d8a:	6a 00                	push   $0x0
  pushl $46
80106d8c:	6a 2e                	push   $0x2e
  jmp alltraps
80106d8e:	e9 ee f7 ff ff       	jmp    80106581 <alltraps>
...
80106d93:	6a 00                	push   $0x0
  pushl $47
80106d95:	6a 2f                	push   $0x2f
  jmp alltraps
80106d97:	e9 e5 f7 ff ff       	jmp    80106581 <alltraps>
...
80106d9c:	6a 00                	push   $0x0
  pushl $48
80106d9e:	6a 30                	push   $0x30
  jmp alltraps
80106da0:	e9 dc f7 ff ff       	jmp    80106581 <alltraps>
...
80106da5:	6a 00                	push   $0x0
  pushl $49
80106da7:	6a 31                	push   $0x31
  jmp alltraps
80106da9:	e9 d3 f7 ff ff       	jmp    80106581 <alltraps>
...
80106dae:	6a 00                	push   $0x0
  pushl $50
80106db0:	6a 32                	push   $0x32
  jmp alltraps
80106db2:	e9 ca f7 ff ff       	jmp    80106581 <alltraps>
...
80106db7:	6a 00                	push   $0x0
  pushl $51
80106db9:	6a 33                	push   $0x33
  jmp alltraps
80106dbb:	e9 c1 f7 ff ff       	jmp    80106581 <alltraps>
...
80106dc0:	6a 00                	push   $0x0
  pushl $52
80106dc2:	6a 34                	push   $0x34
  jmp alltraps
80106dc4:	e9 b8 f7 ff ff       	jmp    80106581 <alltraps>
...
80106dc9:	6a 00                	push   $0x0
  pushl $53
80106dcb:	6a 35                	push   $0x35
  jmp alltraps
80106dcd:	e9 af f7 ff ff       	jmp    80106581 <alltraps>
...
80106dd2:	6a 00                	push   $0x0
  pushl $54
80106dd4:	6a 36                	push   $0x36
  jmp alltraps
80106dd6:	e9 a6 f7 ff ff       	jmp    80106581 <alltraps>
...
80106ddb:	6a 00                	push   $0x0
  pushl $55
80106ddd:	6a 37                	push   $0x37
  jmp alltraps
80106ddf:	e9 9d f7 ff ff       	jmp    80106581 <alltraps>
...
80106de4:	6a 00                	push   $0x0
  pushl $56
80106de6:	6a 38                	push   $0x38
  jmp alltraps
80106de8:	e9 94 f7 ff ff       	jmp    80106581 <alltraps>
...
80106ded:	6a 00                	push   $0x0
  pushl $57
80106def:	6a 39                	push   $0x39
  jmp alltraps
80106df1:	e9 8b f7 ff ff       	jmp    80106581 <alltraps>
...
80106df6:	6a 00                	push   $0x0
  pushl $58
80106df8:	6a 3a                	push   $0x3a
  jmp alltraps
80106dfa:	e9 82 f7 ff ff       	jmp    80106581 <alltraps>
...
80106dff:	6a 00                	push   $0x0
  pushl $59
80106e01:	6a 3b                	push   $0x3b
  jmp alltraps
80106e03:	e9 79 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e08:	6a 00                	push   $0x0
  pushl $60
80106e0a:	6a 3c                	push   $0x3c
  jmp alltraps
80106e0c:	e9 70 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e11:	6a 00                	push   $0x0
  pushl $61
80106e13:	6a 3d                	push   $0x3d
  jmp alltraps
80106e15:	e9 67 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e1a:	6a 00                	push   $0x0
  pushl $62
80106e1c:	6a 3e                	push   $0x3e
  jmp alltraps
80106e1e:	e9 5e f7 ff ff       	jmp    80106581 <alltraps>
...
80106e23:	6a 00                	push   $0x0
  pushl $63
80106e25:	6a 3f                	push   $0x3f
  jmp alltraps
80106e27:	e9 55 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e2c:	6a 00                	push   $0x0
  pushl $64
80106e2e:	6a 40                	push   $0x40
  jmp alltraps
80106e30:	e9 4c f7 ff ff       	jmp    80106581 <alltraps>
...
80106e35:	6a 00                	push   $0x0
  pushl $65
80106e37:	6a 41                	push   $0x41
  jmp alltraps
80106e39:	e9 43 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e3e:	6a 00                	push   $0x0
  pushl $66
80106e40:	6a 42                	push   $0x42
  jmp alltraps
80106e42:	e9 3a f7 ff ff       	jmp    80106581 <alltraps>
...
80106e47:	6a 00                	push   $0x0
  pushl $67
80106e49:	6a 43                	push   $0x43
  jmp alltraps
80106e4b:	e9 31 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e50:	6a 00                	push   $0x0
  pushl $68
80106e52:	6a 44                	push   $0x44
  jmp alltraps
80106e54:	e9 28 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e59:	6a 00                	push   $0x0
  pushl $69
80106e5b:	6a 45                	push   $0x45
  jmp alltraps
80106e5d:	e9 1f f7 ff ff       	jmp    80106581 <alltraps>
...
80106e62:	6a 00                	push   $0x0
  pushl $70
80106e64:	6a 46                	push   $0x46
  jmp alltraps
80106e66:	e9 16 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e6b:	6a 00                	push   $0x0
  pushl $71
80106e6d:	6a 47                	push   $0x47
  jmp alltraps
80106e6f:	e9 0d f7 ff ff       	jmp    80106581 <alltraps>
...
80106e74:	6a 00                	push   $0x0
  pushl $72
80106e76:	6a 48                	push   $0x48
  jmp alltraps
80106e78:	e9 04 f7 ff ff       	jmp    80106581 <alltraps>
...
80106e7d:	6a 00                	push   $0x0
  pushl $73
80106e7f:	6a 49                	push   $0x49
  jmp alltraps
80106e81:	e9 fb f6 ff ff       	jmp    80106581 <alltraps>
...
80106e86:	6a 00                	push   $0x0
  pushl $74
80106e88:	6a 4a                	push   $0x4a
  jmp alltraps
80106e8a:	e9 f2 f6 ff ff       	jmp    80106581 <alltraps>
...
80106e8f:	6a 00                	push   $0x0
  pushl $75
80106e91:	6a 4b                	push   $0x4b
  jmp alltraps
80106e93:	e9 e9 f6 ff ff       	jmp    80106581 <alltraps>
...
80106e98:	6a 00                	push   $0x0
  pushl $76
80106e9a:	6a 4c                	push   $0x4c
  jmp alltraps
80106e9c:	e9 e0 f6 ff ff       	jmp    80106581 <alltraps>
...
80106ea1:	6a 00                	push   $0x0
  pushl $77
80106ea3:	6a 4d                	push   $0x4d
  jmp alltraps
80106ea5:	e9 d7 f6 ff ff       	jmp    80106581 <alltraps>
...
80106eaa:	6a 00                	push   $0x0
  pushl $78
80106eac:	6a 4e                	push   $0x4e
  jmp alltraps
80106eae:	e9 ce f6 ff ff       	jmp    80106581 <alltraps>
...
80106eb3:	6a 00                	push   $0x0
  pushl $79
80106eb5:	6a 4f                	push   $0x4f
  jmp alltraps
80106eb7:	e9 c5 f6 ff ff       	jmp    80106581 <alltraps>
...
80106ebc:	6a 00                	push   $0x0
  pushl $80
80106ebe:	6a 50                	push   $0x50
  jmp alltraps
80106ec0:	e9 bc f6 ff ff       	jmp    80106581 <alltraps>
...
80106ec5:	6a 00                	push   $0x0
  pushl $81
80106ec7:	6a 51                	push   $0x51
  jmp alltraps
80106ec9:	e9 b3 f6 ff ff       	jmp    80106581 <alltraps>
...
80106ece:	6a 00                	push   $0x0
  pushl $82
80106ed0:	6a 52                	push   $0x52
  jmp alltraps
80106ed2:	e9 aa f6 ff ff       	jmp    80106581 <alltraps>
...
80106ed7:	6a 00                	push   $0x0
  pushl $83
80106ed9:	6a 53                	push   $0x53
  jmp alltraps
80106edb:	e9 a1 f6 ff ff       	jmp    80106581 <alltraps>
...
80106ee0:	6a 00                	push   $0x0
  pushl $84
80106ee2:	6a 54                	push   $0x54
  jmp alltraps
80106ee4:	e9 98 f6 ff ff       	jmp    80106581 <alltraps>
...
80106ee9:	6a 00                	push   $0x0
  pushl $85
80106eeb:	6a 55                	push   $0x55
  jmp alltraps
80106eed:	e9 8f f6 ff ff       	jmp    80106581 <alltraps>
...
80106ef2:	6a 00                	push   $0x0
  pushl $86
80106ef4:	6a 56                	push   $0x56
  jmp alltraps
80106ef6:	e9 86 f6 ff ff       	jmp    80106581 <alltraps>
...
80106efb:	6a 00                	push   $0x0
  pushl $87
80106efd:	6a 57                	push   $0x57
  jmp alltraps
80106eff:	e9 7d f6 ff ff       	jmp    80106581 <alltraps>
...
80106f04:	6a 00                	push   $0x0
  pushl $88
80106f06:	6a 58                	push   $0x58
  jmp alltraps
80106f08:	e9 74 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f0d:	6a 00                	push   $0x0
  pushl $89
80106f0f:	6a 59                	push   $0x59
  jmp alltraps
80106f11:	e9 6b f6 ff ff       	jmp    80106581 <alltraps>
...
80106f16:	6a 00                	push   $0x0
  pushl $90
80106f18:	6a 5a                	push   $0x5a
  jmp alltraps
80106f1a:	e9 62 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f1f:	6a 00                	push   $0x0
  pushl $91
80106f21:	6a 5b                	push   $0x5b
  jmp alltraps
80106f23:	e9 59 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f28:	6a 00                	push   $0x0
  pushl $92
80106f2a:	6a 5c                	push   $0x5c
  jmp alltraps
80106f2c:	e9 50 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f31:	6a 00                	push   $0x0
  pushl $93
80106f33:	6a 5d                	push   $0x5d
  jmp alltraps
80106f35:	e9 47 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f3a:	6a 00                	push   $0x0
  pushl $94
80106f3c:	6a 5e                	push   $0x5e
  jmp alltraps
80106f3e:	e9 3e f6 ff ff       	jmp    80106581 <alltraps>
...
80106f43:	6a 00                	push   $0x0
  pushl $95
80106f45:	6a 5f                	push   $0x5f
  jmp alltraps
80106f47:	e9 35 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f4c:	6a 00                	push   $0x0
  pushl $96
80106f4e:	6a 60                	push   $0x60
  jmp alltraps
80106f50:	e9 2c f6 ff ff       	jmp    80106581 <alltraps>
...
80106f55:	6a 00                	push   $0x0
  pushl $97
80106f57:	6a 61                	push   $0x61
  jmp alltraps
80106f59:	e9 23 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f5e:	6a 00                	push   $0x0
  pushl $98
80106f60:	6a 62                	push   $0x62
  jmp alltraps
80106f62:	e9 1a f6 ff ff       	jmp    80106581 <alltraps>
...
80106f67:	6a 00                	push   $0x0
  pushl $99
80106f69:	6a 63                	push   $0x63
  jmp alltraps
80106f6b:	e9 11 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f70:	6a 00                	push   $0x0
  pushl $100
80106f72:	6a 64                	push   $0x64
  jmp alltraps
80106f74:	e9 08 f6 ff ff       	jmp    80106581 <alltraps>
...
80106f79:	6a 00                	push   $0x0
  pushl $101
80106f7b:	6a 65                	push   $0x65
  jmp alltraps
80106f7d:	e9 ff f5 ff ff       	jmp    80106581 <alltraps>
...
80106f82:	6a 00                	push   $0x0
  pushl $102
80106f84:	6a 66                	push   $0x66
  jmp alltraps
80106f86:	e9 f6 f5 ff ff       	jmp    80106581 <alltraps>
...
80106f8b:	6a 00                	push   $0x0
  pushl $103
80106f8d:	6a 67                	push   $0x67
  jmp alltraps
80106f8f:	e9 ed f5 ff ff       	jmp    80106581 <alltraps>
...
80106f94:	6a 00                	push   $0x0
  pushl $104
80106f96:	6a 68                	push   $0x68
  jmp alltraps
80106f98:	e9 e4 f5 ff ff       	jmp    80106581 <alltraps>
...
80106f9d:	6a 00                	push   $0x0
  pushl $105
80106f9f:	6a 69                	push   $0x69
  jmp alltraps
80106fa1:	e9 db f5 ff ff       	jmp    80106581 <alltraps>
...
80106fa6:	6a 00                	push   $0x0
  pushl $106
80106fa8:	6a 6a                	push   $0x6a
  jmp alltraps
80106faa:	e9 d2 f5 ff ff       	jmp    80106581 <alltraps>
...
80106faf:	6a 00                	push   $0x0
  pushl $107
80106fb1:	6a 6b                	push   $0x6b
  jmp alltraps
80106fb3:	e9 c9 f5 ff ff       	jmp    80106581 <alltraps>
...
80106fb8:	6a 00                	push   $0x0
  pushl $108
80106fba:	6a 6c                	push   $0x6c
  jmp alltraps
80106fbc:	e9 c0 f5 ff ff       	jmp    80106581 <alltraps>
...
80106fc1:	6a 00                	push   $0x0
  pushl $109
80106fc3:	6a 6d                	push   $0x6d
  jmp alltraps
80106fc5:	e9 b7 f5 ff ff       	jmp    80106581 <alltraps>
...
80106fca:	6a 00                	push   $0x0
  pushl $110
80106fcc:	6a 6e                	push   $0x6e
  jmp alltraps
80106fce:	e9 ae f5 ff ff       	jmp    80106581 <alltraps>
...
80106fd3:	6a 00                	push   $0x0
  pushl $111
80106fd5:	6a 6f                	push   $0x6f
  jmp alltraps
80106fd7:	e9 a5 f5 ff ff       	jmp    80106581 <alltraps>
...
80106fdc:	6a 00                	push   $0x0
  pushl $112
80106fde:	6a 70                	push   $0x70
  jmp alltraps
80106fe0:	e9 9c f5 ff ff       	jmp    80106581 <alltraps>
...
80106fe5:	6a 00                	push   $0x0
  pushl $113
80106fe7:	6a 71                	push   $0x71
  jmp alltraps
80106fe9:	e9 93 f5 ff ff       	jmp    80106581 <alltraps>
...
80106fee:	6a 00                	push   $0x0
  pushl $114
80106ff0:	6a 72                	push   $0x72
  jmp alltraps
80106ff2:	e9 8a f5 ff ff       	jmp    80106581 <alltraps>
...
80106ff7:	6a 00                	push   $0x0
  pushl $115
80106ff9:	6a 73                	push   $0x73
  jmp alltraps
80106ffb:	e9 81 f5 ff ff       	jmp    80106581 <alltraps>
...
80107000:	6a 00                	push   $0x0
  pushl $116
80107002:	6a 74                	push   $0x74
  jmp alltraps
80107004:	e9 78 f5 ff ff       	jmp    80106581 <alltraps>
...
80107009:	6a 00                	push   $0x0
  pushl $117
8010700b:	6a 75                	push   $0x75
  jmp alltraps
8010700d:	e9 6f f5 ff ff       	jmp    80106581 <alltraps>
...
80107012:	6a 00                	push   $0x0
  pushl $118
80107014:	6a 76                	push   $0x76
  jmp alltraps
80107016:	e9 66 f5 ff ff       	jmp    80106581 <alltraps>
...
8010701b:	6a 00                	push   $0x0
  pushl $119
8010701d:	6a 77                	push   $0x77
  jmp alltraps
8010701f:	e9 5d f5 ff ff       	jmp    80106581 <alltraps>
...
80107024:	6a 00                	push   $0x0
  pushl $120
80107026:	6a 78                	push   $0x78
  jmp alltraps
80107028:	e9 54 f5 ff ff       	jmp    80106581 <alltraps>
...
8010702d:	6a 00                	push   $0x0
  pushl $121
8010702f:	6a 79                	push   $0x79
  jmp alltraps
80107031:	e9 4b f5 ff ff       	jmp    80106581 <alltraps>
...
80107036:	6a 00                	push   $0x0
  pushl $122
80107038:	6a 7a                	push   $0x7a
  jmp alltraps
8010703a:	e9 42 f5 ff ff       	jmp    80106581 <alltraps>
...
8010703f:	6a 00                	push   $0x0
  pushl $123
80107041:	6a 7b                	push   $0x7b
  jmp alltraps
80107043:	e9 39 f5 ff ff       	jmp    80106581 <alltraps>
...
80107048:	6a 00                	push   $0x0
  pushl $124
8010704a:	6a 7c                	push   $0x7c
  jmp alltraps
8010704c:	e9 30 f5 ff ff       	jmp    80106581 <alltraps>
...
80107051:	6a 00                	push   $0x0
  pushl $125
80107053:	6a 7d                	push   $0x7d
  jmp alltraps
80107055:	e9 27 f5 ff ff       	jmp    80106581 <alltraps>
...
8010705a:	6a 00                	push   $0x0
  pushl $126
8010705c:	6a 7e                	push   $0x7e
  jmp alltraps
8010705e:	e9 1e f5 ff ff       	jmp    80106581 <alltraps>
...
80107063:	6a 00                	push   $0x0
  pushl $127
80107065:	6a 7f                	push   $0x7f
  jmp alltraps
80107067:	e9 15 f5 ff ff       	jmp    80106581 <alltraps>
...
8010706c:	6a 00                	push   $0x0
  pushl $128
8010706e:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107073:	e9 09 f5 ff ff       	jmp    80106581 <alltraps>
...
80107078:	6a 00                	push   $0x0
  pushl $129
8010707a:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010707f:	e9 fd f4 ff ff       	jmp    80106581 <alltraps>
...
80107084:	6a 00                	push   $0x0
  pushl $130
80107086:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010708b:	e9 f1 f4 ff ff       	jmp    80106581 <alltraps>
...
80107090:	6a 00                	push   $0x0
  pushl $131
80107092:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107097:	e9 e5 f4 ff ff       	jmp    80106581 <alltraps>
...
8010709c:	6a 00                	push   $0x0
  pushl $132
8010709e:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801070a3:	e9 d9 f4 ff ff       	jmp    80106581 <alltraps>
...
801070a8:	6a 00                	push   $0x0
  pushl $133
801070aa:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801070af:	e9 cd f4 ff ff       	jmp    80106581 <alltraps>
...
801070b4:	6a 00                	push   $0x0
  pushl $134
801070b6:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801070bb:	e9 c1 f4 ff ff       	jmp    80106581 <alltraps>
...
801070c0:	6a 00                	push   $0x0
  pushl $135
801070c2:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801070c7:	e9 b5 f4 ff ff       	jmp    80106581 <alltraps>
...
801070cc:	6a 00                	push   $0x0
  pushl $136
801070ce:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801070d3:	e9 a9 f4 ff ff       	jmp    80106581 <alltraps>
...
801070d8:	6a 00                	push   $0x0
  pushl $137
801070da:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801070df:	e9 9d f4 ff ff       	jmp    80106581 <alltraps>
...
801070e4:	6a 00                	push   $0x0
  pushl $138
801070e6:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801070eb:	e9 91 f4 ff ff       	jmp    80106581 <alltraps>
...
801070f0:	6a 00                	push   $0x0
  pushl $139
801070f2:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801070f7:	e9 85 f4 ff ff       	jmp    80106581 <alltraps>
...
801070fc:	6a 00                	push   $0x0
  pushl $140
801070fe:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107103:	e9 79 f4 ff ff       	jmp    80106581 <alltraps>
...
80107108:	6a 00                	push   $0x0
  pushl $141
8010710a:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010710f:	e9 6d f4 ff ff       	jmp    80106581 <alltraps>
...
80107114:	6a 00                	push   $0x0
  pushl $142
80107116:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010711b:	e9 61 f4 ff ff       	jmp    80106581 <alltraps>
...
80107120:	6a 00                	push   $0x0
  pushl $143
80107122:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107127:	e9 55 f4 ff ff       	jmp    80106581 <alltraps>
...
8010712c:	6a 00                	push   $0x0
  pushl $144
8010712e:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107133:	e9 49 f4 ff ff       	jmp    80106581 <alltraps>
...
80107138:	6a 00                	push   $0x0
  pushl $145
8010713a:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010713f:	e9 3d f4 ff ff       	jmp    80106581 <alltraps>
...
80107144:	6a 00                	push   $0x0
  pushl $146
80107146:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010714b:	e9 31 f4 ff ff       	jmp    80106581 <alltraps>
...
80107150:	6a 00                	push   $0x0
  pushl $147
80107152:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107157:	e9 25 f4 ff ff       	jmp    80106581 <alltraps>
...
8010715c:	6a 00                	push   $0x0
  pushl $148
8010715e:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107163:	e9 19 f4 ff ff       	jmp    80106581 <alltraps>
...
80107168:	6a 00                	push   $0x0
  pushl $149
8010716a:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010716f:	e9 0d f4 ff ff       	jmp    80106581 <alltraps>
...
80107174:	6a 00                	push   $0x0
  pushl $150
80107176:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010717b:	e9 01 f4 ff ff       	jmp    80106581 <alltraps>
...
80107180:	6a 00                	push   $0x0
  pushl $151
80107182:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107187:	e9 f5 f3 ff ff       	jmp    80106581 <alltraps>
...
8010718c:	6a 00                	push   $0x0
  pushl $152
8010718e:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107193:	e9 e9 f3 ff ff       	jmp    80106581 <alltraps>
...
80107198:	6a 00                	push   $0x0
  pushl $153
8010719a:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010719f:	e9 dd f3 ff ff       	jmp    80106581 <alltraps>
...
801071a4:	6a 00                	push   $0x0
  pushl $154
801071a6:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801071ab:	e9 d1 f3 ff ff       	jmp    80106581 <alltraps>
...
801071b0:	6a 00                	push   $0x0
  pushl $155
801071b2:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801071b7:	e9 c5 f3 ff ff       	jmp    80106581 <alltraps>
...
801071bc:	6a 00                	push   $0x0
  pushl $156
801071be:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801071c3:	e9 b9 f3 ff ff       	jmp    80106581 <alltraps>
...
801071c8:	6a 00                	push   $0x0
  pushl $157
801071ca:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801071cf:	e9 ad f3 ff ff       	jmp    80106581 <alltraps>
...
801071d4:	6a 00                	push   $0x0
  pushl $158
801071d6:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801071db:	e9 a1 f3 ff ff       	jmp    80106581 <alltraps>
...
801071e0:	6a 00                	push   $0x0
  pushl $159
801071e2:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801071e7:	e9 95 f3 ff ff       	jmp    80106581 <alltraps>
...
801071ec:	6a 00                	push   $0x0
  pushl $160
801071ee:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801071f3:	e9 89 f3 ff ff       	jmp    80106581 <alltraps>
...
801071f8:	6a 00                	push   $0x0
  pushl $161
801071fa:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801071ff:	e9 7d f3 ff ff       	jmp    80106581 <alltraps>
...
80107204:	6a 00                	push   $0x0
  pushl $162
80107206:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010720b:	e9 71 f3 ff ff       	jmp    80106581 <alltraps>
...
80107210:	6a 00                	push   $0x0
  pushl $163
80107212:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107217:	e9 65 f3 ff ff       	jmp    80106581 <alltraps>
...
8010721c:	6a 00                	push   $0x0
  pushl $164
8010721e:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107223:	e9 59 f3 ff ff       	jmp    80106581 <alltraps>
...
80107228:	6a 00                	push   $0x0
  pushl $165
8010722a:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010722f:	e9 4d f3 ff ff       	jmp    80106581 <alltraps>
...
80107234:	6a 00                	push   $0x0
  pushl $166
80107236:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010723b:	e9 41 f3 ff ff       	jmp    80106581 <alltraps>
...
80107240:	6a 00                	push   $0x0
  pushl $167
80107242:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107247:	e9 35 f3 ff ff       	jmp    80106581 <alltraps>
...
8010724c:	6a 00                	push   $0x0
  pushl $168
8010724e:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107253:	e9 29 f3 ff ff       	jmp    80106581 <alltraps>
...
80107258:	6a 00                	push   $0x0
  pushl $169
8010725a:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010725f:	e9 1d f3 ff ff       	jmp    80106581 <alltraps>
...
80107264:	6a 00                	push   $0x0
  pushl $170
80107266:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010726b:	e9 11 f3 ff ff       	jmp    80106581 <alltraps>
...
80107270:	6a 00                	push   $0x0
  pushl $171
80107272:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107277:	e9 05 f3 ff ff       	jmp    80106581 <alltraps>
...
8010727c:	6a 00                	push   $0x0
  pushl $172
8010727e:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107283:	e9 f9 f2 ff ff       	jmp    80106581 <alltraps>
...
80107288:	6a 00                	push   $0x0
  pushl $173
8010728a:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010728f:	e9 ed f2 ff ff       	jmp    80106581 <alltraps>
...
80107294:	6a 00                	push   $0x0
  pushl $174
80107296:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010729b:	e9 e1 f2 ff ff       	jmp    80106581 <alltraps>
...
801072a0:	6a 00                	push   $0x0
  pushl $175
801072a2:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801072a7:	e9 d5 f2 ff ff       	jmp    80106581 <alltraps>
...
801072ac:	6a 00                	push   $0x0
  pushl $176
801072ae:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801072b3:	e9 c9 f2 ff ff       	jmp    80106581 <alltraps>
...
801072b8:	6a 00                	push   $0x0
  pushl $177
801072ba:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801072bf:	e9 bd f2 ff ff       	jmp    80106581 <alltraps>
...
801072c4:	6a 00                	push   $0x0
  pushl $178
801072c6:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801072cb:	e9 b1 f2 ff ff       	jmp    80106581 <alltraps>
...
801072d0:	6a 00                	push   $0x0
  pushl $179
801072d2:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801072d7:	e9 a5 f2 ff ff       	jmp    80106581 <alltraps>
...
801072dc:	6a 00                	push   $0x0
  pushl $180
801072de:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801072e3:	e9 99 f2 ff ff       	jmp    80106581 <alltraps>
...
801072e8:	6a 00                	push   $0x0
  pushl $181
801072ea:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801072ef:	e9 8d f2 ff ff       	jmp    80106581 <alltraps>
...
801072f4:	6a 00                	push   $0x0
  pushl $182
801072f6:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801072fb:	e9 81 f2 ff ff       	jmp    80106581 <alltraps>
...
80107300:	6a 00                	push   $0x0
  pushl $183
80107302:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107307:	e9 75 f2 ff ff       	jmp    80106581 <alltraps>
...
8010730c:	6a 00                	push   $0x0
  pushl $184
8010730e:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107313:	e9 69 f2 ff ff       	jmp    80106581 <alltraps>
...
80107318:	6a 00                	push   $0x0
  pushl $185
8010731a:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010731f:	e9 5d f2 ff ff       	jmp    80106581 <alltraps>
...
80107324:	6a 00                	push   $0x0
  pushl $186
80107326:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010732b:	e9 51 f2 ff ff       	jmp    80106581 <alltraps>
...
80107330:	6a 00                	push   $0x0
  pushl $187
80107332:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107337:	e9 45 f2 ff ff       	jmp    80106581 <alltraps>
...
8010733c:	6a 00                	push   $0x0
  pushl $188
8010733e:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107343:	e9 39 f2 ff ff       	jmp    80106581 <alltraps>
...
80107348:	6a 00                	push   $0x0
  pushl $189
8010734a:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010734f:	e9 2d f2 ff ff       	jmp    80106581 <alltraps>
...
80107354:	6a 00                	push   $0x0
  pushl $190
80107356:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010735b:	e9 21 f2 ff ff       	jmp    80106581 <alltraps>
...
80107360:	6a 00                	push   $0x0
  pushl $191
80107362:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107367:	e9 15 f2 ff ff       	jmp    80106581 <alltraps>
...
8010736c:	6a 00                	push   $0x0
  pushl $192
8010736e:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107373:	e9 09 f2 ff ff       	jmp    80106581 <alltraps>
...
80107378:	6a 00                	push   $0x0
  pushl $193
8010737a:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010737f:	e9 fd f1 ff ff       	jmp    80106581 <alltraps>
...
80107384:	6a 00                	push   $0x0
  pushl $194
80107386:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010738b:	e9 f1 f1 ff ff       	jmp    80106581 <alltraps>
...
80107390:	6a 00                	push   $0x0
  pushl $195
80107392:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107397:	e9 e5 f1 ff ff       	jmp    80106581 <alltraps>
...
8010739c:	6a 00                	push   $0x0
  pushl $196
8010739e:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801073a3:	e9 d9 f1 ff ff       	jmp    80106581 <alltraps>
...
801073a8:	6a 00                	push   $0x0
  pushl $197
801073aa:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801073af:	e9 cd f1 ff ff       	jmp    80106581 <alltraps>
...
801073b4:	6a 00                	push   $0x0
  pushl $198
801073b6:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801073bb:	e9 c1 f1 ff ff       	jmp    80106581 <alltraps>
...
801073c0:	6a 00                	push   $0x0
  pushl $199
801073c2:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801073c7:	e9 b5 f1 ff ff       	jmp    80106581 <alltraps>
...
801073cc:	6a 00                	push   $0x0
  pushl $200
801073ce:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801073d3:	e9 a9 f1 ff ff       	jmp    80106581 <alltraps>
...
801073d8:	6a 00                	push   $0x0
  pushl $201
801073da:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801073df:	e9 9d f1 ff ff       	jmp    80106581 <alltraps>
...
801073e4:	6a 00                	push   $0x0
  pushl $202
801073e6:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801073eb:	e9 91 f1 ff ff       	jmp    80106581 <alltraps>
...
801073f0:	6a 00                	push   $0x0
  pushl $203
801073f2:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801073f7:	e9 85 f1 ff ff       	jmp    80106581 <alltraps>
...
801073fc:	6a 00                	push   $0x0
  pushl $204
801073fe:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107403:	e9 79 f1 ff ff       	jmp    80106581 <alltraps>
...
80107408:	6a 00                	push   $0x0
  pushl $205
8010740a:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010740f:	e9 6d f1 ff ff       	jmp    80106581 <alltraps>
...
80107414:	6a 00                	push   $0x0
  pushl $206
80107416:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010741b:	e9 61 f1 ff ff       	jmp    80106581 <alltraps>
...
80107420:	6a 00                	push   $0x0
  pushl $207
80107422:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107427:	e9 55 f1 ff ff       	jmp    80106581 <alltraps>
...
8010742c:	6a 00                	push   $0x0
  pushl $208
8010742e:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107433:	e9 49 f1 ff ff       	jmp    80106581 <alltraps>
...
80107438:	6a 00                	push   $0x0
  pushl $209
8010743a:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010743f:	e9 3d f1 ff ff       	jmp    80106581 <alltraps>
...
80107444:	6a 00                	push   $0x0
  pushl $210
80107446:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010744b:	e9 31 f1 ff ff       	jmp    80106581 <alltraps>
...
80107450:	6a 00                	push   $0x0
  pushl $211
80107452:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107457:	e9 25 f1 ff ff       	jmp    80106581 <alltraps>
...
8010745c:	6a 00                	push   $0x0
  pushl $212
8010745e:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107463:	e9 19 f1 ff ff       	jmp    80106581 <alltraps>
...
80107468:	6a 00                	push   $0x0
  pushl $213
8010746a:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010746f:	e9 0d f1 ff ff       	jmp    80106581 <alltraps>
...
80107474:	6a 00                	push   $0x0
  pushl $214
80107476:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010747b:	e9 01 f1 ff ff       	jmp    80106581 <alltraps>
...
80107480:	6a 00                	push   $0x0
  pushl $215
80107482:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107487:	e9 f5 f0 ff ff       	jmp    80106581 <alltraps>
...
8010748c:	6a 00                	push   $0x0
  pushl $216
8010748e:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107493:	e9 e9 f0 ff ff       	jmp    80106581 <alltraps>
...
80107498:	6a 00                	push   $0x0
  pushl $217
8010749a:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010749f:	e9 dd f0 ff ff       	jmp    80106581 <alltraps>
...
801074a4:	6a 00                	push   $0x0
  pushl $218
801074a6:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801074ab:	e9 d1 f0 ff ff       	jmp    80106581 <alltraps>
...
801074b0:	6a 00                	push   $0x0
  pushl $219
801074b2:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801074b7:	e9 c5 f0 ff ff       	jmp    80106581 <alltraps>
...
801074bc:	6a 00                	push   $0x0
  pushl $220
801074be:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801074c3:	e9 b9 f0 ff ff       	jmp    80106581 <alltraps>
...
801074c8:	6a 00                	push   $0x0
  pushl $221
801074ca:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801074cf:	e9 ad f0 ff ff       	jmp    80106581 <alltraps>
...
801074d4:	6a 00                	push   $0x0
  pushl $222
801074d6:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801074db:	e9 a1 f0 ff ff       	jmp    80106581 <alltraps>
...
801074e0:	6a 00                	push   $0x0
  pushl $223
801074e2:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801074e7:	e9 95 f0 ff ff       	jmp    80106581 <alltraps>
...
801074ec:	6a 00                	push   $0x0
  pushl $224
801074ee:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801074f3:	e9 89 f0 ff ff       	jmp    80106581 <alltraps>
...
801074f8:	6a 00                	push   $0x0
  pushl $225
801074fa:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801074ff:	e9 7d f0 ff ff       	jmp    80106581 <alltraps>
...
80107504:	6a 00                	push   $0x0
  pushl $226
80107506:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010750b:	e9 71 f0 ff ff       	jmp    80106581 <alltraps>
...
80107510:	6a 00                	push   $0x0
  pushl $227
80107512:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107517:	e9 65 f0 ff ff       	jmp    80106581 <alltraps>
...
8010751c:	6a 00                	push   $0x0
  pushl $228
8010751e:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107523:	e9 59 f0 ff ff       	jmp    80106581 <alltraps>
...
80107528:	6a 00                	push   $0x0
  pushl $229
8010752a:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010752f:	e9 4d f0 ff ff       	jmp    80106581 <alltraps>
...
80107534:	6a 00                	push   $0x0
  pushl $230
80107536:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010753b:	e9 41 f0 ff ff       	jmp    80106581 <alltraps>
...
80107540:	6a 00                	push   $0x0
  pushl $231
80107542:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107547:	e9 35 f0 ff ff       	jmp    80106581 <alltraps>
...
8010754c:	6a 00                	push   $0x0
  pushl $232
8010754e:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107553:	e9 29 f0 ff ff       	jmp    80106581 <alltraps>
...
80107558:	6a 00                	push   $0x0
  pushl $233
8010755a:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010755f:	e9 1d f0 ff ff       	jmp    80106581 <alltraps>
...
80107564:	6a 00                	push   $0x0
  pushl $234
80107566:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010756b:	e9 11 f0 ff ff       	jmp    80106581 <alltraps>
...
80107570:	6a 00                	push   $0x0
  pushl $235
80107572:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107577:	e9 05 f0 ff ff       	jmp    80106581 <alltraps>
...
8010757c:	6a 00                	push   $0x0
  pushl $236
8010757e:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107583:	e9 f9 ef ff ff       	jmp    80106581 <alltraps>
...
80107588:	6a 00                	push   $0x0
  pushl $237
8010758a:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010758f:	e9 ed ef ff ff       	jmp    80106581 <alltraps>
...
80107594:	6a 00                	push   $0x0
  pushl $238
80107596:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010759b:	e9 e1 ef ff ff       	jmp    80106581 <alltraps>
...
801075a0:	6a 00                	push   $0x0
  pushl $239
801075a2:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801075a7:	e9 d5 ef ff ff       	jmp    80106581 <alltraps>
...
801075ac:	6a 00                	push   $0x0
  pushl $240
801075ae:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801075b3:	e9 c9 ef ff ff       	jmp    80106581 <alltraps>
...
801075b8:	6a 00                	push   $0x0
  pushl $241
801075ba:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801075bf:	e9 bd ef ff ff       	jmp    80106581 <alltraps>
...
801075c4:	6a 00                	push   $0x0
  pushl $242
801075c6:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801075cb:	e9 b1 ef ff ff       	jmp    80106581 <alltraps>
...
801075d0:	6a 00                	push   $0x0
  pushl $243
801075d2:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801075d7:	e9 a5 ef ff ff       	jmp    80106581 <alltraps>
...
801075dc:	6a 00                	push   $0x0
  pushl $244
801075de:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801075e3:	e9 99 ef ff ff       	jmp    80106581 <alltraps>
...
801075e8:	6a 00                	push   $0x0
  pushl $245
801075ea:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801075ef:	e9 8d ef ff ff       	jmp    80106581 <alltraps>
...
801075f4:	6a 00                	push   $0x0
  pushl $246
801075f6:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801075fb:	e9 81 ef ff ff       	jmp    80106581 <alltraps>
...
80107600:	6a 00                	push   $0x0
  pushl $247
80107602:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107607:	e9 75 ef ff ff       	jmp    80106581 <alltraps>
...
8010760c:	6a 00                	push   $0x0
  pushl $248
8010760e:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107613:	e9 69 ef ff ff       	jmp    80106581 <alltraps>
...
80107618:	6a 00                	push   $0x0
  pushl $249
8010761a:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010761f:	e9 5d ef ff ff       	jmp    80106581 <alltraps>
...
80107624:	6a 00                	push   $0x0
  pushl $250
80107626:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010762b:	e9 51 ef ff ff       	jmp    80106581 <alltraps>
...
80107630:	6a 00                	push   $0x0
  pushl $251
80107632:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107637:	e9 45 ef ff ff       	jmp    80106581 <alltraps>
...
8010763c:	6a 00                	push   $0x0
  pushl $252
8010763e:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107643:	e9 39 ef ff ff       	jmp    80106581 <alltraps>
...
80107648:	6a 00                	push   $0x0
  pushl $253
8010764a:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010764f:	e9 2d ef ff ff       	jmp    80106581 <alltraps>
...
80107654:	6a 00                	push   $0x0
  pushl $254
80107656:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010765b:	e9 21 ef ff ff       	jmp    80106581 <alltraps>
...
80107660:	6a 00                	push   $0x0
  pushl $255
80107662:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107667:	e9 15 ef ff ff       	jmp    80106581 <alltraps>
...
8010766f:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107672:	8b 45 0c             	mov    0xc(%ebp),%eax
80107675:	83 e8 01             	sub    $0x1,%eax
80107678:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010767c:	8b 45 08             	mov    0x8(%ebp),%eax
8010767f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107683:	8b 45 08             	mov    0x8(%ebp),%eax
80107686:	c1 e8 10             	shr    $0x10,%eax
80107689:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
8010768d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107690:	0f 01 10             	lgdtl  (%eax)
}
80107693:	c9                   	leave  
80107694:	c3                   	ret    
...
8010769e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801076a2:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801076a6:	0f 00 d8             	ltr    %ax
}
801076a9:	c9                   	leave  
801076aa:	c3                   	ret    
...
801076ae:	83 ec 04             	sub    $0x4,%esp
801076b1:	8b 45 08             	mov    0x8(%ebp),%eax
801076b4:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
801076b8:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801076bc:	8e e8                	mov    %eax,%gs
}
801076be:	c9                   	leave  
801076bf:	c3                   	ret    
...
801076d1:	05 00 00 00 80       	add    $0x80000000,%eax
801076d6:	5d                   	pop    %ebp
801076d7:	c3                   	ret    
...
801076de:	05 00 00 00 80       	add    $0x80000000,%eax
801076e3:	5d                   	pop    %ebp
801076e4:	c3                   	ret    
...
801076e9:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801076ec:	e8 94 b7 ff ff       	call   80102e85 <cpunum>
801076f1:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801076f7:	05 60 23 11 80       	add    $0x80112360,%eax
...
80107874:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
8010787b:	ff ff 
8010787d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107880:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107887:	00 00 
80107889:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010788c:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107893:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107896:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010789d:	83 e2 f0             	and    $0xfffffff0,%edx
801078a0:	83 ca 0a             	or     $0xa,%edx
801078a3:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801078a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ac:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801078b3:	83 ca 10             	or     $0x10,%edx
801078b6:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801078bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078bf:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801078c6:	83 ca 60             	or     $0x60,%edx
801078c9:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801078cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d2:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801078d9:	83 ca 80             	or     $0xffffff80,%edx
801078dc:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
...
801078f8:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801078ff:	83 e2 ef             	and    $0xffffffef,%edx
80107902:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107908:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010790b:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107912:	83 e2 df             	and    $0xffffffdf,%edx
80107915:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
8010791b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010791e:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107925:	83 ca 40             	or     $0x40,%edx
80107928:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
8010792e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107931:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107938:	83 ca 80             	or     $0xffffff80,%edx
8010793b:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107941:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107944:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010794b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010794e:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107955:	ff ff 
80107957:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010795a:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107961:	00 00 
80107963:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107966:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
8010796d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107970:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107977:	83 e2 f0             	and    $0xfffffff0,%edx
8010797a:	83 ca 02             	or     $0x2,%edx
8010797d:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107983:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107986:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010798d:	83 ca 10             	or     $0x10,%edx
80107990:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107996:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107999:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801079a0:	83 ca 60             	or     $0x60,%edx
801079a3:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801079a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ac:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801079b3:	83 ca 80             	or     $0xffffff80,%edx
801079b6:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
...
801079d2:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801079d9:	83 e2 ef             	and    $0xffffffef,%edx
801079dc:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801079e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079e5:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801079ec:	83 e2 df             	and    $0xffffffdf,%edx
801079ef:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801079f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f8:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801079ff:	83 ca 40             	or     $0x40,%edx
80107a02:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107a08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a0b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107a12:	83 ca 80             	or     $0xffffff80,%edx
80107a15:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107a1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a1e:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107a25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a28:	05 b4 00 00 00       	add    $0xb4,%eax
80107a2d:	89 c3                	mov    %eax,%ebx
80107a2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a32:	05 b4 00 00 00       	add    $0xb4,%eax
80107a37:	c1 e8 10             	shr    $0x10,%eax
80107a3a:	89 c1                	mov    %eax,%ecx
80107a3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a3f:	05 b4 00 00 00       	add    $0xb4,%eax
80107a44:	c1 e8 18             	shr    $0x18,%eax
80107a47:	89 c2                	mov    %eax,%edx
80107a49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4c:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107a53:	00 00 
80107a55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a58:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107a5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a62:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107a68:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a6b:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107a72:	83 e1 f0             	and    $0xfffffff0,%ecx
80107a75:	83 c9 02             	or     $0x2,%ecx
80107a78:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107a7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a81:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107a88:	83 c9 10             	or     $0x10,%ecx
80107a8b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107a91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a94:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107a9b:	83 e1 9f             	and    $0xffffff9f,%ecx
80107a9e:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107aa4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aa7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107aae:	83 c9 80             	or     $0xffffff80,%ecx
80107ab1:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107ab7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aba:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ac1:	83 e1 f0             	and    $0xfffffff0,%ecx
80107ac4:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107aca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107acd:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ad4:	83 e1 ef             	and    $0xffffffef,%ecx
80107ad7:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107add:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ae0:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ae7:	83 e1 df             	and    $0xffffffdf,%ecx
80107aea:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107af0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107af3:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107afa:	83 c9 40             	or     $0x40,%ecx
80107afd:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b06:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b0d:	83 c9 80             	or     $0xffffff80,%ecx
80107b10:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b19:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107b1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b22:	83 c0 70             	add    $0x70,%eax
80107b25:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107b2c:	00 
80107b2d:	89 04 24             	mov    %eax,(%esp)
80107b30:	e8 37 fb ff ff       	call   8010766c <lgdt>
  loadgs(SEG_KCPU << 3);
80107b35:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107b3c:	e8 6a fb ff ff       	call   801076ab <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107b41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b44:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107b4a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107b51:	00 00 00 00 
}
80107b55:	83 c4 24             	add    $0x24,%esp
80107b58:	5b                   	pop    %ebx
80107b59:	5d                   	pop    %ebp
80107b5a:	c3                   	ret    
...
80107b5e:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107b61:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b64:	c1 e8 16             	shr    $0x16,%eax
80107b67:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107b6e:	8b 45 08             	mov    0x8(%ebp),%eax
80107b71:	01 d0                	add    %edx,%eax
80107b73:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107b76:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b79:	8b 00                	mov    (%eax),%eax
80107b7b:	83 e0 01             	and    $0x1,%eax
80107b7e:	85 c0                	test   %eax,%eax
80107b80:	74 17                	je     80107b99 <walkpgdir+0x3e>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107b82:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b85:	8b 00                	mov    (%eax),%eax
80107b87:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b8c:	89 04 24             	mov    %eax,(%esp)
80107b8f:	e8 44 fb ff ff       	call   801076d8 <p2v>
80107b94:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107b97:	eb 4b                	jmp    80107be4 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107b99:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107b9d:	74 0e                	je     80107bad <walkpgdir+0x52>
80107b9f:	e8 4b af ff ff       	call   80102aef <kalloc>
80107ba4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107ba7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107bab:	75 07                	jne    80107bb4 <walkpgdir+0x59>
      return 0;
80107bad:	b8 00 00 00 00       	mov    $0x0,%eax
80107bb2:	eb 47                	jmp    80107bfb <walkpgdir+0xa0>
...
80107bca:	e8 85 d5 ff ff       	call   80105154 <memset>
...
80107bd5:	e8 f1 fa ff ff       	call   801076cb <v2p>
80107bda:	83 c8 07             	or     $0x7,%eax
80107bdd:	89 c2                	mov    %eax,%edx
80107bdf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107be2:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107be4:	8b 45 0c             	mov    0xc(%ebp),%eax
80107be7:	c1 e8 0c             	shr    $0xc,%eax
80107bea:	25 ff 03 00 00       	and    $0x3ff,%eax
...
80107c0e:	8b 55 0c             	mov    0xc(%ebp),%edx
80107c11:	8b 45 10             	mov    0x10(%ebp),%eax
80107c14:	01 d0                	add    %edx,%eax
80107c16:	83 e8 01             	sub    $0x1,%eax
80107c19:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107c1e:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107c21:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107c28:	00 
...
80107c36:	e8 20 ff ff ff       	call   80107b5b <walkpgdir>
80107c3b:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107c3e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107c42:	75 07                	jne    80107c4b <mappages+0x4e>
      return -1;
80107c44:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107c49:	eb 48                	jmp    80107c93 <mappages+0x96>
    if(*pte & PTE_P)
80107c4b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c4e:	8b 00                	mov    (%eax),%eax
80107c50:	83 e0 01             	and    $0x1,%eax
80107c53:	85 c0                	test   %eax,%eax
80107c55:	74 0c                	je     80107c63 <mappages+0x66>
      panic("remap");
80107c57:	c7 04 24 a4 8a 10 80 	movl   $0x80108aa4,(%esp)
80107c5e:	e8 d7 88 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80107c63:	8b 45 18             	mov    0x18(%ebp),%eax
80107c66:	0b 45 14             	or     0x14(%ebp),%eax
80107c69:	83 c8 01             	or     $0x1,%eax
80107c6c:	89 c2                	mov    %eax,%edx
80107c6e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c71:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107c73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c76:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107c79:	75 08                	jne    80107c83 <mappages+0x86>
      break;
80107c7b:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107c81:	eb 10                	jmp    80107c93 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
80107c83:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107c8a:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107c91:	eb 8e                	jmp    80107c21 <mappages+0x24>
  return 0;
}
80107c93:	c9                   	leave  
80107c94:	c3                   	ret    
...
80107c99:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107c9c:	e8 4e ae ff ff       	call   80102aef <kalloc>
80107ca1:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107ca4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107ca8:	75 0a                	jne    80107cb4 <setupkvm+0x1f>
    return 0;
80107caa:	b8 00 00 00 00       	mov    $0x0,%eax
80107caf:	e9 98 00 00 00       	jmp    80107d4c <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107cb4:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107cbb:	00 
80107cbc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107cc3:	00 
80107cc4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107cc7:	89 04 24             	mov    %eax,(%esp)
80107cca:	e8 85 d4 ff ff       	call   80105154 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107ccf:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107cd6:	e8 fd f9 ff ff       	call   801076d8 <p2v>
80107cdb:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107ce0:	76 0c                	jbe    80107cee <setupkvm+0x59>
    panic("PHYSTOP too high");
80107ce2:	c7 04 24 aa 8a 10 80 	movl   $0x80108aaa,(%esp)
80107ce9:	e8 4c 88 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107cee:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107cf5:	eb 49                	jmp    80107d40 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107cf7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cfa:	8b 48 0c             	mov    0xc(%eax),%ecx
80107cfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d00:	8b 50 04             	mov    0x4(%eax),%edx
80107d03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d06:	8b 58 08             	mov    0x8(%eax),%ebx
80107d09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d0c:	8b 40 04             	mov    0x4(%eax),%eax
80107d0f:	29 c3                	sub    %eax,%ebx
80107d11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d14:	8b 00                	mov    (%eax),%eax
80107d16:	89 4c 24 10          	mov    %ecx,0x10(%esp)
...
80107d2c:	e8 cc fe ff ff       	call   80107bfd <mappages>
80107d31:	85 c0                	test   %eax,%eax
80107d33:	79 07                	jns    80107d3c <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107d35:	b8 00 00 00 00       	mov    $0x0,%eax
80107d3a:	eb 10                	jmp    80107d4c <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107d3c:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107d40:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107d47:	72 ae                	jb     80107cf7 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107d4c:	83 c4 34             	add    $0x34,%esp
80107d4f:	5b                   	pop    %ebx
80107d50:	5d                   	pop    %ebp
80107d51:	c3                   	ret    
...
80107d55:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107d58:	e8 38 ff ff ff       	call   80107c95 <setupkvm>
80107d5d:	a3 38 52 11 80       	mov    %eax,0x80115238
  switchkvm();
80107d62:	e8 02 00 00 00       	call   80107d69 <switchkvm>
}
80107d67:	c9                   	leave  
80107d68:	c3                   	ret    
...
80107d6f:	a1 38 52 11 80       	mov    0x80115238,%eax
80107d74:	89 04 24             	mov    %eax,(%esp)
80107d77:	e8 4f f9 ff ff       	call   801076cb <v2p>
80107d7c:	89 04 24             	mov    %eax,(%esp)
80107d7f:	e8 3c f9 ff ff       	call   801076c0 <lcr3>
}
80107d84:	c9                   	leave  
80107d85:	c3                   	ret    
...
80107d8a:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107d8d:	e8 c2 d2 ff ff       	call   80105054 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107d92:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d98:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d9f:	83 c2 08             	add    $0x8,%edx
80107da2:	89 d3                	mov    %edx,%ebx
80107da4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107dab:	83 c2 08             	add    $0x8,%edx
80107dae:	c1 ea 10             	shr    $0x10,%edx
80107db1:	89 d1                	mov    %edx,%ecx
80107db3:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107dba:	83 c2 08             	add    $0x8,%edx
80107dbd:	c1 ea 18             	shr    $0x18,%edx
80107dc0:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107dc7:	67 00 
80107dc9:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107dd0:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107dd6:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ddd:	83 e1 f0             	and    $0xfffffff0,%ecx
80107de0:	83 c9 09             	or     $0x9,%ecx
80107de3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107de9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107df0:	83 c9 10             	or     $0x10,%ecx
80107df3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107df9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e00:	83 e1 9f             	and    $0xffffff9f,%ecx
80107e03:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e09:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e10:	83 c9 80             	or     $0xffffff80,%ecx
80107e13:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e19:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107e20:	83 e1 f0             	and    $0xfffffff0,%ecx
...
80107e40:	83 e1 df             	and    $0xffffffdf,%ecx
80107e43:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e49:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107e50:	83 c9 40             	or     $0x40,%ecx
80107e53:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e59:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107e60:	83 e1 7f             	and    $0x7f,%ecx
80107e63:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e69:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107e6f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e75:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107e7c:	83 e2 ef             	and    $0xffffffef,%edx
80107e7f:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107e85:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e8b:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107e91:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e97:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107e9e:	8b 52 08             	mov    0x8(%edx),%edx
80107ea1:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107ea7:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107eaa:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107eb1:	e8 df f7 ff ff       	call   80107695 <ltr>
  if(p->pgdir == 0)
80107eb6:	8b 45 08             	mov    0x8(%ebp),%eax
80107eb9:	8b 40 04             	mov    0x4(%eax),%eax
80107ebc:	85 c0                	test   %eax,%eax
80107ebe:	75 0c                	jne    80107ecc <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107ec0:	c7 04 24 bb 8a 10 80 	movl   $0x80108abb,(%esp)
80107ec7:	e8 6e 86 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107ecc:	8b 45 08             	mov    0x8(%ebp),%eax
80107ecf:	8b 40 04             	mov    0x4(%eax),%eax
80107ed2:	89 04 24             	mov    %eax,(%esp)
80107ed5:	e8 f1 f7 ff ff       	call   801076cb <v2p>
80107eda:	89 04 24             	mov    %eax,(%esp)
80107edd:	e8 de f7 ff ff       	call   801076c0 <lcr3>
  popcli();
80107ee2:	e8 b1 d1 ff ff       	call   80105098 <popcli>
}
80107ee7:	83 c4 14             	add    $0x14,%esp
80107eea:	5b                   	pop    %ebx
80107eeb:	5d                   	pop    %ebp
80107eec:	c3                   	ret    
...
80107ef0:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107ef3:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107efa:	76 0c                	jbe    80107f08 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107efc:	c7 04 24 cf 8a 10 80 	movl   $0x80108acf,(%esp)
80107f03:	e8 32 86 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107f08:	e8 e2 ab ff ff       	call   80102aef <kalloc>
80107f0d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
...
80107f26:	e8 29 d2 ff ff       	call   80105154 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107f2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f2e:	89 04 24             	mov    %eax,(%esp)
80107f31:	e8 95 f7 ff ff       	call   801076cb <v2p>
80107f36:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107f3d:	00 
...
80107f58:	e8 a0 fc ff ff       	call   80107bfd <mappages>
  memmove(mem, init, sz);
80107f5d:	8b 45 10             	mov    0x10(%ebp),%eax
80107f60:	89 44 24 08          	mov    %eax,0x8(%esp)
80107f64:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f67:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f6e:	89 04 24             	mov    %eax,(%esp)
80107f71:	e8 ad d2 ff ff       	call   80105223 <memmove>
}
80107f76:	c9                   	leave  
80107f77:	c3                   	ret    
...
80107f7c:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
80107f89:	74 0c                	je     80107f97 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107f8b:	c7 04 24 ec 8a 10 80 	movl   $0x80108aec,(%esp)
80107f92:	e8 a3 85 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107f97:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f9e:	e9 a9 00 00 00       	jmp    8010804c <loaduvm+0xd4>
...
80107fbd:	e8 99 fb ff ff       	call   80107b5b <walkpgdir>
80107fc2:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107fc5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107fc9:	75 0c                	jne    80107fd7 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107fcb:	c7 04 24 0f 8b 10 80 	movl   $0x80108b0f,(%esp)
80107fd2:	e8 63 85 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
80107ff3:	77 0f                	ja     80108004 <loaduvm+0x8c>
      n = sz - i;
...
80108002:	eb 07                	jmp    8010800b <loaduvm+0x93>
    else
      n = PGSIZE;
...
80108011:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108014:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108017:	89 04 24             	mov    %eax,(%esp)
8010801a:	e8 b9 f6 ff ff       	call   801076d8 <p2v>
8010801f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108022:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108026:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010802a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010802e:	8b 45 10             	mov    0x10(%ebp),%eax
80108031:	89 04 24             	mov    %eax,(%esp)
80108034:	e8 3c 9d ff ff       	call   80101d75 <readi>
80108039:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010803c:	74 07                	je     80108045 <loaduvm+0xcd>
      return -1;
8010803e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108043:	eb 18                	jmp    8010805d <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
8010804f:	3b 45 18             	cmp    0x18(%ebp),%eax
80108052:	0f 82 4b ff ff ff    	jb     80107fa3 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
8010805d:	83 c4 24             	add    $0x24,%esp
80108060:	5b                   	pop    %ebx
80108061:	5d                   	pop    %ebp
80108062:	c3                   	ret    
...
80108066:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
8010806e:	79 0a                	jns    8010807a <allocuvm+0x17>
    return 0;
80108070:	b8 00 00 00 00       	mov    $0x0,%eax
80108075:	e9 c1 00 00 00       	jmp    8010813b <allocuvm+0xd8>
  if(newsz < oldsz)
8010807a:	8b 45 10             	mov    0x10(%ebp),%eax
8010807d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108080:	73 08                	jae    8010808a <allocuvm+0x27>
    return oldsz;
80108082:	8b 45 0c             	mov    0xc(%ebp),%eax
80108085:	e9 b1 00 00 00       	jmp    8010813b <allocuvm+0xd8>
...
8010809a:	e9 8d 00 00 00       	jmp    8010812c <allocuvm+0xc9>
    mem = kalloc();
8010809f:	e8 4b aa ff ff       	call   80102aef <kalloc>
801080a4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801080a7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801080ab:	75 2c                	jne    801080d9 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
801080ad:	c7 04 24 2d 8b 10 80 	movl   $0x80108b2d,(%esp)
801080b4:	e8 e7 82 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801080b9:	8b 45 0c             	mov    0xc(%ebp),%eax
801080bc:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801080cd:	e8 6b 00 00 00       	call   8010813d <deallocuvm>
      return 0;
801080d2:	b8 00 00 00 00       	mov    $0x0,%eax
801080d7:	eb 62                	jmp    8010813b <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
801080d9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080e0:	00 
801080e1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801080e8:	00 
801080e9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080ec:	89 04 24             	mov    %eax,(%esp)
801080ef:	e8 60 d0 ff ff       	call   80105154 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801080f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080f7:	89 04 24             	mov    %eax,(%esp)
801080fa:	e8 cc f5 ff ff       	call   801076cb <v2p>
801080ff:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108102:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108109:	00 
8010810a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010810e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108115:	00 
80108116:	89 54 24 04          	mov    %edx,0x4(%esp)
8010811a:	8b 45 08             	mov    0x8(%ebp),%eax
8010811d:	89 04 24             	mov    %eax,(%esp)
80108120:	e8 d8 fa ff ff       	call   80107bfd <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
8010812f:	3b 45 10             	cmp    0x10(%ebp),%eax
80108132:	0f 82 67 ff ff ff    	jb     8010809f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108140:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80108143:	8b 45 10             	mov    0x10(%ebp),%eax
80108146:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108149:	72 08                	jb     80108153 <deallocuvm+0x16>
    return oldsz;
8010814b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010814e:	e9 a4 00 00 00       	jmp    801081f7 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108153:	8b 45 10             	mov    0x10(%ebp),%eax
80108156:	05 ff 0f 00 00       	add    $0xfff,%eax
8010815b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108160:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108163:	e9 80 00 00 00       	jmp    801081e8 <deallocuvm+0xab>
...
8010817d:	e8 d9 f9 ff ff       	call   80107b5b <walkpgdir>
80108182:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108185:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108189:	75 09                	jne    80108194 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010818b:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108192:	eb 4d                	jmp    801081e1 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108194:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108197:	8b 00                	mov    (%eax),%eax
80108199:	83 e0 01             	and    $0x1,%eax
8010819c:	85 c0                	test   %eax,%eax
8010819e:	74 41                	je     801081e1 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
801081b1:	75 0c                	jne    801081bf <deallocuvm+0x82>
        panic("kfree");
801081b3:	c7 04 24 45 8b 10 80 	movl   $0x80108b45,(%esp)
801081ba:	e8 7b 83 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
801081bf:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081c2:	89 04 24             	mov    %eax,(%esp)
801081c5:	e8 0e f5 ff ff       	call   801076d8 <p2v>
801081ca:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801081cd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801081d0:	89 04 24             	mov    %eax,(%esp)
801081d3:	e8 7e a8 ff ff       	call   80102a56 <kfree>
      *pte = 0;
801081d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081db:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801081e1:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801081e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081eb:	3b 45 0c             	cmp    0xc(%ebp),%eax
801081ee:	0f 82 74 ff ff ff    	jb     80108168 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801081fc:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
801081ff:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108203:	75 0c                	jne    80108211 <freevm+0x18>
    panic("freevm: no pgdir");
80108205:	c7 04 24 4b 8b 10 80 	movl   $0x80108b4b,(%esp)
8010820c:	e8 29 83 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108211:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108218:	00 
80108219:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108220:	80 
80108221:	8b 45 08             	mov    0x8(%ebp),%eax
80108224:	89 04 24             	mov    %eax,(%esp)
80108227:	e8 11 ff ff ff       	call   8010813d <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010822c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108233:	eb 48                	jmp    8010827d <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
80108274:	e8 dd a7 ff ff       	call   80102a56 <kfree>
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108279:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010827d:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108284:	76 af                	jbe    80108235 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
8010828c:	e8 c5 a7 ff ff       	call   80102a56 <kfree>
}
80108291:	c9                   	leave  
80108292:	c3                   	ret    
...
80108296:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
801082a4:	89 44 24 04          	mov    %eax,0x4(%esp)
801082a8:	8b 45 08             	mov    0x8(%ebp),%eax
801082ab:	89 04 24             	mov    %eax,(%esp)
801082ae:	e8 a8 f8 ff ff       	call   80107b5b <walkpgdir>
801082b3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801082b6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801082ba:	75 0c                	jne    801082c8 <clearpteu+0x35>
    panic("clearpteu");
801082bc:	c7 04 24 5c 8b 10 80 	movl   $0x80108b5c,(%esp)
801082c3:	e8 72 82 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
801082c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082cb:	8b 00                	mov    (%eax),%eax
801082cd:	83 e0 fb             	and    $0xfffffffb,%eax
801082d0:	89 c2                	mov    %eax,%edx
801082d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082d5:	89 10                	mov    %edx,(%eax)
}
801082d7:	c9                   	leave  
801082d8:	c3                   	ret    
...
801082dd:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801082e0:	e8 b0 f9 ff ff       	call   80107c95 <setupkvm>
801082e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
801082e8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801082ec:	75 0a                	jne    801082f8 <copyuvm+0x1f>
    return 0;
801082ee:	b8 00 00 00 00       	mov    $0x0,%eax
801082f3:	e9 fd 00 00 00       	jmp    801083f5 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
801082f8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801082ff:	e9 d0 00 00 00       	jmp    801083d4 <copyuvm+0xfb>
...
80108319:	e8 3d f8 ff ff       	call   80107b5b <walkpgdir>
8010831e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108321:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108325:	75 0c                	jne    80108333 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108327:	c7 04 24 66 8b 10 80 	movl   $0x80108b66,(%esp)
...
8010833d:	75 0c                	jne    8010834b <copyuvm+0x72>
      panic("copyuvm: page not present");
8010833f:	c7 04 24 80 8b 10 80 	movl   $0x80108b80,(%esp)
80108346:	e8 ef 81 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
8010834b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010834e:	8b 00                	mov    (%eax),%eax
80108350:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108355:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
80108358:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010835b:	8b 00                	mov    (%eax),%eax
8010835d:	25 ff 0f 00 00       	and    $0xfff,%eax
80108362:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108365:	e8 85 a7 ff ff       	call   80102aef <kalloc>
8010836a:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010836d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108371:	75 02                	jne    80108375 <copyuvm+0x9c>
      goto bad;
80108373:	eb 70                	jmp    801083e5 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108375:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108378:	89 04 24             	mov    %eax,(%esp)
8010837b:	e8 58 f3 ff ff       	call   801076d8 <p2v>
80108380:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108387:	00 
80108388:	89 44 24 04          	mov    %eax,0x4(%esp)
8010838c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010838f:	89 04 24             	mov    %eax,(%esp)
80108392:	e8 8c ce ff ff       	call   80105223 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108397:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
8010839a:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010839d:	89 04 24             	mov    %eax,(%esp)
801083a0:	e8 26 f3 ff ff       	call   801076cb <v2p>
801083a5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801083a8:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801083ac:	89 44 24 0c          	mov    %eax,0xc(%esp)
801083b0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083b7:	00 
801083b8:	89 54 24 04          	mov    %edx,0x4(%esp)
801083bc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083bf:	89 04 24             	mov    %eax,(%esp)
801083c2:	e8 36 f8 ff ff       	call   80107bfd <mappages>
801083c7:	85 c0                	test   %eax,%eax
801083c9:	79 02                	jns    801083cd <copyuvm+0xf4>
      goto bad;
801083cb:	eb 18                	jmp    801083e5 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801083cd:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801083d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083d7:	3b 45 0c             	cmp    0xc(%ebp),%eax
801083da:	0f 82 24 ff ff ff    	jb     80108304 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
801083e3:	eb 10                	jmp    801083f5 <copyuvm+0x11c>

bad:
  freevm(d);
801083e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083e8:	89 04 24             	mov    %eax,(%esp)
801083eb:	e8 09 fe ff ff       	call   801081f9 <freevm>
  return 0;
801083f0:	b8 00 00 00 00       	mov    $0x0,%eax
}
801083f5:	83 c4 44             	add    $0x44,%esp
801083f8:	5b                   	pop    %ebx
801083f9:	5d                   	pop    %ebp
801083fa:	c3                   	ret    
...
801083fe:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80108401:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108408:	00 
80108409:	8b 45 0c             	mov    0xc(%ebp),%eax
8010840c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108410:	8b 45 08             	mov    0x8(%ebp),%eax
80108413:	89 04 24             	mov    %eax,(%esp)
80108416:	e8 40 f7 ff ff       	call   80107b5b <walkpgdir>
...
80108461:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108464:	e9 87 00 00 00       	jmp    801084f0 <copyout+0x98>
...
80108481:	e8 75 ff ff ff       	call   801083fb <uva2ka>
80108486:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108489:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
8010848d:	75 07                	jne    80108496 <copyout+0x3e>
      return -1;
8010848f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108494:	eb 69                	jmp    801084ff <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108496:	8b 45 0c             	mov    0xc(%ebp),%eax
80108499:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010849c:	29 c2                	sub    %eax,%edx
8010849e:	89 d0                	mov    %edx,%eax
801084a0:	05 00 10 00 00       	add    $0x1000,%eax
801084a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801084a8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084ab:	3b 45 14             	cmp    0x14(%ebp),%eax
801084ae:	76 06                	jbe    801084b6 <copyout+0x5e>
      n = len;
801084b0:	8b 45 14             	mov    0x14(%ebp),%eax
801084b3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801084b6:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084b9:	8b 55 0c             	mov    0xc(%ebp),%edx
801084bc:	29 c2                	sub    %eax,%edx
801084be:	8b 45 e8             	mov    -0x18(%ebp),%eax
801084c1:	01 c2                	add    %eax,%edx
801084c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084c6:	89 44 24 08          	mov    %eax,0x8(%esp)
801084ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084cd:	89 44 24 04          	mov    %eax,0x4(%esp)
801084d1:	89 14 24             	mov    %edx,(%esp)
801084d4:	e8 4a cd ff ff       	call   80105223 <memmove>
    len -= n;
...
801084f4:	0f 85 6f ff ff ff    	jne    80108469 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
