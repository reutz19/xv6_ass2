...
8010003a:	c7 44 24 04 b0 8b 10 	movl   $0x80108bb0,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 c0 d6 10 80 	movl   $0x8010d6c0,(%esp)
80100049:	e8 cb 54 00 00       	call   80105519 <initlock>
...
801000bd:	e8 78 54 00 00       	call   8010553a <acquire>
...
80100104:	e8 93 54 00 00       	call   8010559c <release>
        return b;
...
8010011f:	e8 7f 4c 00 00       	call   80104da3 <sleep>
      goto loop;
...
8010017c:	e8 1b 54 00 00       	call   8010559c <release>
      return b;
...
80100198:	c7 04 24 b7 8b 10 80 	movl   $0x80108bb7,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 c8 8b 10 80 	movl   $0x80108bc8,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 cf 8b 10 80 	movl   $0x80108bcf,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 c0 d6 10 80 	movl   $0x8010d6c0,(%esp)
8010023c:	e8 f9 52 00 00       	call   8010553a <acquire>
...
8010029d:	e8 09 4c 00 00       	call   80104eab <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 c0 d6 10 80 	movl   $0x8010d6c0,(%esp)
801002a9:	e8 ee 52 00 00       	call   8010559c <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 7a 51 00 00       	call   8010553a <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 d6 8b 10 80 	movl   $0x80108bd6,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec df 8b 10 80 	movl   $0x80108bdf,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 64 50 00 00       	call   8010559c <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 e6 8b 10 80 	movl   $0x80108be6,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 f5 8b 10 80 	movl   $0x80108bf5,(%esp)
...
8010058f:	e8 57 50 00 00       	call   801055eb <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 f7 8b 10 80 	movl   $0x80108bf7,(%esp)
...
801006b2:	e8 a6 51 00 00       	call   8010585d <memmove>
    pos -= 80;
...
801006e1:	e8 a8 50 00 00       	call   8010578e <memset>
  }
...
80100776:	e8 75 6a 00 00       	call   801071f0 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 69 6a 00 00       	call   801071f0 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 5d 6a 00 00       	call   801071f0 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 50 6a 00 00       	call   801071f0 <uartputc>
  cgaputc(c);
...
801007ba:	e8 7b 4d 00 00       	call   8010553a <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 54 47 00 00       	call   80104f43 <procdump>
      break;
...
801008f3:	e8 b3 45 00 00       	call   80104eab <wakeup>
        }
      }
      break;
...
80100914:	e8 83 4c 00 00       	call   8010559c <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 fc 4b 00 00       	call   8010553a <acquire>
  while(n > 0){
...
80100959:	e8 3e 4c 00 00       	call   8010559c <release>
        ilock(ip);
...
80100982:	e8 1c 44 00 00       	call   80104da3 <sleep>
...
801009fe:	e8 99 4b 00 00       	call   8010559c <release>
  ilock(ip);
...
80100a32:	e8 03 4b 00 00       	call   8010553a <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 2b 4b 00 00       	call   8010559c <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 fb 8b 10 	movl   $0x80108bfb,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
80100a96:	e8 7e 4a 00 00       	call   80105519 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 03 8c 10 	movl   $0x80108c03,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 e0 17 11 80 	movl   $0x801117e0,(%esp)
80100aaa:	e8 6a 4a 00 00       	call   80105519 <initlock>
...
80100b6e:	e9 76 03 00 00       	jmp    80100ee9 <exec+0x3fa>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 c9 77 00 00       	call   80108341 <setupkvm>
...
80100c14:	e8 f6 7a 00 00       	call   8010870f <allocuvm>
...
80100c52:	e8 cd 79 00 00       	call   80108624 <loaduvm>
...
80100cc0:	e8 4a 7a 00 00       	call   8010870f <allocuvm>
...
80100ce5:	e8 55 7c 00 00       	call   8010893f <clearpteu>
  sp = sz;
...
80100d1b:	e8 d8 4c 00 00       	call   801059f8 <strlen>
...
80100d44:	e8 af 4c 00 00       	call   801059f8 <strlen>
...
80100d74:	e8 8b 7d 00 00       	call   80108b04 <copyout>
...
80100e1b:	e8 e4 7c 00 00       	call   80108b04 <copyout>
...
80100e73:	e8 36 4b 00 00       	call   801059ae <safestrcpy>
...
80100ed2:	e8 5b 75 00 00       	call   80108432 <switchuvm>
  freevm(oldpgdir);
80100ed7:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eda:	89 04 24             	mov    %eax,(%esp)
80100edd:	e8 c3 79 00 00       	call   801088a5 <freevm>
  return 0;
...
80100ef5:	e8 ab 79 00 00       	call   801088a5 <freevm>
  if(ip){
...
80100f1d:	c7 44 24 04 09 8c 10 	movl   $0x80108c09,0x4(%esp)
80100f24:	80 
80100f25:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100f2c:	e8 e8 45 00 00       	call   80105519 <initlock>
}
80100f31:	c9                   	leave  
80100f32:	c3                   	ret    
...
80100f40:	e8 f5 45 00 00       	call   8010553a <acquire>
...
80100f69:	e8 2e 46 00 00       	call   8010559c <release>
      return f;
...
80100f87:	e8 10 46 00 00       	call   8010559c <release>
  return 0;
...
80100fa0:	e8 95 45 00 00       	call   8010553a <acquire>
  if(f->ref < 1)
...
80100fad:	7f 0c                	jg     80100fbb <filedup+0x28>
    panic("filedup");
80100faf:	c7 04 24 10 8c 10 80 	movl   $0x80108c10,(%esp)
...
80100fd1:	e8 c6 45 00 00       	call   8010559c <release>
  return f;
...
80100fe8:	e8 4d 45 00 00       	call   8010553a <acquire>
  if(f->ref < 1)
...
80100ff5:	7f 0c                	jg     80101003 <fileclose+0x28>
    panic("fileclose");
80100ff7:	c7 04 24 18 8c 10 80 	movl   $0x80108c18,(%esp)
...
80101023:	e8 74 45 00 00       	call   8010559c <release>
...
8010106d:	e8 2a 45 00 00       	call   8010559c <release>
...
801011ac:	eb 0c                	jmp    801011ba <fileread+0xba>
  ...
  panic("fileread");
801011ae:	c7 04 24 22 8c 10 80 	movl   $0x80108c22,(%esp)
...
801012ba:	c7 04 24 2b 8c 10 80 	movl   $0x80108c2b,(%esp)
...
801012ea:	eb 0c                	jmp    801012f8 <filewrite+0x13c>
  ...
  panic("filewrite");
801012ec:	c7 04 24 3b 8c 10 80 	movl   $0x80108c3b,(%esp)
...
80101332:	e8 26 45 00 00       	call   8010585d <memmove>
  brelse(bp);
...
80101378:	e8 11 44 00 00       	call   8010578e <memset>
  log_write(bp);
...
801014d5:	c7 04 24 45 8c 10 80 	movl   $0x80108c45,(%esp)
...
80101567:	c7 04 24 5b 8c 10 80 	movl   $0x80108c5b,(%esp)
...
801015b7:	c7 44 24 04 6e 8c 10 	movl   $0x80108c6e,0x4(%esp)
801015be:	80 
801015bf:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801015c6:	e8 4e 3f 00 00       	call   80105519 <initlock>
}
801015cb:	c9                   	leave  
801015cc:	c3                   	ret    
...
80101648:	e8 41 41 00 00       	call   8010578e <memset>
      dip->type = type;
...
8010169e:	c7 04 24 75 8c 10 80 	movl   $0x80108c75,(%esp)
...
80101747:	e8 11 41 00 00       	call   8010585d <memmove>
  log_write(bp);
...
80101771:	e8 c4 3d 00 00       	call   8010553a <acquire>
...
801017bb:	e8 dc 3d 00 00       	call   8010559c <release>
      return ip;
...
801017ee:	c7 04 24 87 8c 10 80 	movl   $0x80108c87,(%esp)
...
8010182c:	e8 6b 3d 00 00       	call   8010559c <release>
...
80101843:	e8 f2 3c 00 00       	call   8010553a <acquire>
  ip->ref++;
...
8010185e:	e8 39 3d 00 00       	call   8010559c <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 97 8c 10 80 	movl   $0x80108c97,(%esp)
80101885:	e8 b0 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101891:	e8 a4 3c 00 00       	call   8010553a <acquire>
...
801018a6:	e8 f8 34 00 00       	call   80104da3 <sleep>
...
801018d0:	e8 c7 3c 00 00       	call   8010559c <release>
...
8010197b:	e8 dd 3e 00 00       	call   8010585d <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 9d 8c 10 80 	movl   $0x80108c9d,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 ac 8c 10 80 	movl   $0x80108cac,(%esp)
801019e0:	e8 55 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801019ec:	e8 49 3b 00 00       	call   8010553a <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 9e 34 00 00       	call   80104eab <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101a14:	e8 83 3b 00 00       	call   8010559c <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 0d 3b 00 00       	call   8010553a <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 b4 8c 10 80 	movl   $0x80108cb4,(%esp)
...
80101a8a:	e8 0d 3b 00 00       	call   8010559c <release>
    itrunc(ip);
...
80101ab5:	e8 80 3a 00 00       	call   8010553a <acquire>
    ip->flags = 0;
...
80101aca:	e8 dc 33 00 00       	call   80104eab <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 b2 3a 00 00       	call   8010559c <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101c05:	c7 04 24 be 8c 10 80 	movl   $0x80108cbe,(%esp)
...
80101ea6:	e8 b2 39 00 00       	call   8010585d <memmove>
    brelse(bp);
...
80102005:	e8 53 38 00 00       	call   8010585d <memmove>
    log_write(bp);
...
80102083:	e8 78 38 00 00       	call   80105900 <strncmp>
}
80102088:	c9                   	leave  
80102089:	c3                   	ret    
...
8010209d:	c7 04 24 d1 8c 10 80 	movl   $0x80108cd1,(%esp)
...
801020d9:	74 0c                	je     801020e7 <dirlookup+0x5d>
      panic("dirlink read");
801020db:	c7 04 24 e3 8c 10 80 	movl   $0x80108ce3,(%esp)
...
801021be:	74 0c                	je     801021cc <dirlink+0x79>
      panic("dirlink read");
801021c0:	c7 04 24 e3 8c 10 80 	movl   $0x80108ce3,(%esp)
...
80102205:	e8 4c 37 00 00       	call   80105956 <strncpy>
  de.inum = inum;
...
80102235:	74 0c                	je     80102243 <dirlink+0xf0>
    panic("dirlink");
80102237:	c7 04 24 f0 8c 10 80 	movl   $0x80108cf0,(%esp)
...
801022bc:	e8 9c 35 00 00       	call   8010585d <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d7:	e8 81 35 00 00       	call   8010585d <memmove>
    name[len] = 0;
...
80102526:	c7 44 24 04 f8 8c 10 	movl   $0x80108cf8,0x4(%esp)
8010252d:	80 
8010252e:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80102535:	e8 df 2f 00 00       	call   80105519 <initlock>
  picenable(IRQ_IDE);
...
801025d0:	75 0c                	jne    801025de <idestart+0x18>
    panic("idestart");
801025d2:	c7 04 24 fc 8c 10 80 	movl   $0x80108cfc,(%esp)
...
801026f8:	e8 3d 2e 00 00       	call   8010553a <acquire>
  if((b = idequeue) == 0){
...
80102712:	e8 85 2e 00 00       	call   8010559c <release>
...
80102785:	e8 21 27 00 00       	call   80104eab <wakeup>
...
801027a7:	e8 f0 2d 00 00       	call   8010559c <release>
}
801027ac:	c9                   	leave  
801027ad:	c3                   	ret    
...
801027c0:	c7 04 24 05 8d 10 80 	movl   $0x80108d05,(%esp)
...
801027d9:	c7 04 24 19 8d 10 80 	movl   $0x80108d19,(%esp)
...
80102866:	e8 38 25 00 00       	call   80104da3 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
8010287f:	e8 18 2d 00 00       	call   8010559c <release>
}
80102884:	c9                   	leave  
80102885:	c3                   	ret    
...
8010290d:	c7 04 24 4c 8d 10 80 	movl   $0x80108d4c,(%esp)
...
801029c7:	c7 44 24 04 7e 8d 10 	movl   $0x80108d7e,0x4(%esp)
801029ce:	80 
801029cf:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
801029d6:	e8 3e 2b 00 00       	call   80105519 <initlock>
  kmem.use_lock = 0;
...
80102a81:	76 0c                	jbe    80102a8f <kfree+0x39>
    panic("kfree");
80102a83:	c7 04 24 83 8d 10 80 	movl   $0x80108d83,(%esp)
...
80102aa5:	e8 e4 2c 00 00       	call   8010578e <memset>
...
80102aba:	e8 7b 2a 00 00       	call   8010553a <acquire>
  r = (struct run*)v;
...
80102ae8:	e8 af 2a 00 00       	call   8010559c <release>
}
80102aed:	c9                   	leave  
80102aee:	c3                   	ret    
...
80102b05:	e8 30 2a 00 00       	call   8010553a <acquire>
  r = kmem.freelist;
...
80102b32:	e8 65 2a 00 00       	call   8010559c <release>
  return (char*)r;
...
80102eb2:	c7 04 24 8c 8d 10 80 	movl   $0x80108d8c,(%esp)
...
80103115:	e8 eb 26 00 00       	call   80105805 <memcmp>
...
80103215:	c7 44 24 04 b8 8d 10 	movl   $0x80108db8,0x4(%esp)
8010321c:	80 
8010321d:	c7 04 24 c0 32 11 80 	movl   $0x801132c0,(%esp)
80103224:	e8 f0 22 00 00       	call   80105519 <initlock>
  readsb(ROOTDEV, &sb);
...
801032d8:	e8 80 25 00 00       	call   8010585d <memmove>
...
8010342a:	e8 0b 21 00 00       	call   8010553a <acquire>
  while(1){
    if(log.committing){
...
80103447:	e8 57 19 00 00       	call   80104da3 <sleep>
...
8010347b:	e8 23 19 00 00       	call   80104da3 <sleep>
...
80103496:	e8 01 21 00 00       	call   8010559c <release>
      break;
...
801034b5:	e8 80 20 00 00       	call   8010553a <acquire>
  log.outstanding -= 1;
...
801034d0:	c7 04 24 bc 8d 10 80 	movl   $0x80108dbc,(%esp)
...
801034ff:	e8 a7 19 00 00       	call   80104eab <wakeup>
  }
  release(&log.lock);
80103504:	c7 04 24 c0 32 11 80 	movl   $0x801132c0,(%esp)
8010350b:	e8 8c 20 00 00       	call   8010559c <release>
...
801035bf:	e8 99 22 00 00       	call   8010585d <memmove>
...
8010364a:	c7 04 24 cb 8d 10 80 	movl   $0x80108dcb,(%esp)
...
8010365f:	c7 04 24 e1 8d 10 80 	movl   $0x80108de1,(%esp)
80103666:	e8 cf ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
8010366b:	c7 04 24 c0 32 11 80 	movl   $0x801132c0,(%esp)
80103672:	e8 c3 1e 00 00       	call   8010553a <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801036e9:	e8 ae 1e 00 00       	call   8010559c <release>
}
801036ee:	c9                   	leave  
801036ef:	c3                   	ret    
...
80103765:	c7 04 24 fc 8d 10 80 	movl   $0x80108dfc,(%esp)
...
80103780:	e8 5b 39 00 00       	call   801070e0 <uartinit>
  pinit();         // process table
80103785:	e8 a3 0b 00 00       	call   8010432d <pinit>
  tvinit();        // trap vectors
8010378a:	e8 03 35 00 00       	call   80106c92 <tvinit>
  binit();         // buffer cache
...
801037ac:	e8 23 34 00 00       	call   80106bd4 <timerinit>
...
801037d7:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801037da:	e8 36 4c 00 00       	call   80108415 <switchkvm>
  seginit();
801037df:	e8 ad 45 00 00       	call   80107d91 <seginit>
  lapicinit();
...
80103804:	c7 04 24 13 8e 10 80 	movl   $0x80108e13,(%esp)
8010380b:	e8 90 cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
80103810:	e8 f1 35 00 00       	call   80106e06 <idtinit>
...
80103830:	e8 3b 13 00 00       	call   80104b70 <scheduler>
...
80103862:	e8 f6 1f 00 00       	call   8010585d <memmove>
...
801039e3:	00 
801039e4:	c7 44 24 04 24 8e 10 	movl   $0x80108e24,0x4(%esp)
801039eb:	80 
801039ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039ef:	89 04 24             	mov    %eax,(%esp)
801039f2:	e8 0e 1e 00 00       	call   80105805 <memcmp>
...
80103b24:	00 
80103b25:	c7 44 24 04 29 8e 10 	movl   $0x80108e29,0x4(%esp)
80103b2c:	80 
80103b2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b30:	89 04 24             	mov    %eax,(%esp)
80103b33:	e8 cd 1c 00 00       	call   80105805 <memcmp>
...
80103c01:	8b 04 85 6c 8e 10 80 	mov    -0x7fef7194(,%eax,4),%eax
...
80103c3a:	c7 04 24 2e 8e 10 80 	movl   $0x80108e2e,(%esp)
...
80103ccd:	c7 04 24 4c 8e 10 80 	movl   $0x80108e4c,(%esp)
...
80103fc6:	c7 44 24 04 80 8e 10 	movl   $0x80108e80,0x4(%esp)
80103fcd:	80 
80103fce:	89 04 24             	mov    %eax,(%esp)
80103fd1:	e8 43 15 00 00       	call   80105519 <initlock>
  (*f0)->type = FD_PIPE;
...
8010407d:	e8 b8 14 00 00       	call   8010553a <acquire>
  if(writable){
...
801040a0:	e8 06 0e 00 00       	call   80104eab <wakeup>
...
801040bf:	e8 e7 0d 00 00       	call   80104eab <wakeup>
  }
...
801040e4:	e8 b3 14 00 00       	call   8010559c <release>
    kfree((char*)p);
...
801040fc:	e8 9b 14 00 00       	call   8010559c <release>
}
80104101:	c9                   	leave  
80104102:	c3                   	ret    
...
8010410f:	e8 26 14 00 00       	call   8010553a <acquire>
  for(i = 0; i < n; i++){
...
80104142:	e8 55 14 00 00       	call   8010559c <release>
        return -1;
...
8010415c:	e8 4a 0d 00 00       	call   80104eab <wakeup>
...
80104174:	e8 2a 0c 00 00       	call   80104da3 <sleep>
{
  int i;
...
801041dd:	e8 c9 0c 00 00       	call   80104eab <wakeup>
  release(&p->lock);
801041e2:	8b 45 08             	mov    0x8(%ebp),%eax
801041e5:	89 04 24             	mov    %eax,(%esp)
801041e8:	e8 af 13 00 00       	call   8010559c <release>
  return n;
...
801041ff:	e8 36 13 00 00       	call   8010553a <acquire>
...
80104219:	e8 7e 13 00 00       	call   8010559c <release>
      return -1;
...
8010423b:	e8 63 0b 00 00       	call   80104da3 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801042ca:	e8 dc 0b 00 00       	call   80104eab <wakeup>
  release(&p->lock);
801042cf:	8b 45 08             	mov    0x8(%ebp),%eax
801042d2:	89 04 24             	mov    %eax,(%esp)
801042d5:	e8 c2 12 00 00       	call   8010559c <release>
  return i;
...
80104407:	ba 44 6c 10 80       	mov    $0x80106c44,%edx
...
80104437:	e8 52 13 00 00       	call   8010578e <memset>
  p->context->eip = (uint)forkret;
8010443c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010443f:	8b 40 1c             	mov    0x1c(%eax),%eax
80104442:	ba 7e 4d 10 80       	mov    $0x80104d7e,%edx
...
801044a5:	e8 97 3e 00 00       	call   80108341 <setupkvm>
...
801044ba:	c7 04 24 85 8e 10 80 	movl   $0x80108e85,(%esp)
...
801044e0:	e8 b4 40 00 00       	call   80108599 <inituvm>
  p->sz = PGSIZE;
...
80104507:	e8 82 12 00 00       	call   8010578e <memset>
...
80104580:	00 
80104581:	c7 44 24 04 9e 8e 10 	movl   $0x80108e9e,0x4(%esp)
80104588:	80 
80104589:	89 04 24             	mov    %eax,(%esp)
8010458c:	e8 1d 14 00 00       	call   801059ae <safestrcpy>
  p->cwd = namei("/");
80104591:	c7 04 24 a7 8e 10 80 	movl   $0x80108ea7,(%esp)
...
801045e5:	e8 25 41 00 00       	call   8010870f <allocuvm>
...
8010461f:	e8 c5 41 00 00       	call   801087e9 <deallocuvm>
...
80104648:	e8 e5 3d 00 00       	call   80108432 <switchuvm>
  return 0;
...
8010468d:	e8 f3 42 00 00       	call   80108985 <copyuvm>
...
80104794:	e8 15 12 00 00       	call   801059ae <safestrcpy>
  //copy signal handler
...
801047ae:	89 45 dc             	mov    %eax,-0x24(%ebp)
  ...
  pushcli();
801047b1:	e8 d8 0e 00 00       	call   8010568e <pushcli>
...
801047d6:	75 0c                	jne    801047e4 <fork+0x190>
  {
    popcli();
801047d8:	e8 f5 0e 00 00       	call   801056d2 <popcli>
    return -1;
...
801047e2:	eb 08                	jmp    801047ec <fork+0x198>
  ...
  popcli();
801047e4:	e8 e9 0e 00 00       	call   801056d2 <popcli>
  return pid;
...
80104808:	75 0c                	jne    80104816 <exit+0x22>
    panic("init exiting");
8010480a:	c7 04 24 a9 8e 10 80 	movl   $0x80108ea9,(%esp)
...
8010488a:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)
  ...
  pushcli();
80104891:	e8 f8 0d 00 00       	call   8010568e <pushcli>
...
801048bb:	eb 46                	jmp    80104903 <exit+0x10f>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048bd:	c7 45 f4 c0 39 11 80 	movl   $0x801139c0,-0xc(%ebp)
801048c4:	eb 23                	jmp    801048e9 <exit+0xf5>
    if(p->parent == proc)
...
801048d4:	75 0c                	jne    801048e2 <exit+0xee>
    {
      p->parent = initproc;
801048d6:	8b 15 a8 c6 10 80    	mov    0x8010c6a8,%edx
...
801048df:	89 50 14             	mov    %edx,0x14(%eax)
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048e2:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
801048e9:	81 7d f4 c0 a1 11 80 	cmpl   $0x8011a1c0,-0xc(%ebp)
801048f0:	72 d4                	jb     801048c6 <exit+0xd2>
  ...
  sched();
801048f2:	e8 b9 03 00 00       	call   80104cb0 <sched>
  panic("zombie exit");
801048f7:	c7 04 24 b6 8e 10 80 	movl   $0x80108eb6,(%esp)
...
80104926:	83 c0 0c             	add    $0xc,%eax
80104929:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
80104930:	00 
80104931:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
80104938:	00 
80104939:	89 04 24             	mov    %eax,(%esp)
8010493c:	e8 b8 f9 ff ff       	call   801042f9 <cas>
    // Scan through table looking for zombie children.
    havekids = 0;
80104941:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104948:	c7 45 f4 c0 39 11 80 	movl   $0x801139c0,-0xc(%ebp)
8010494f:	e9 36 01 00 00       	jmp    80104a8a <wait+0x185>
      if(p->parent != proc)
80104954:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104957:	8b 50 14             	mov    0x14(%eax),%edx
8010495a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104960:	39 c2                	cmp    %eax,%edx
80104962:	74 05                	je     80104969 <wait+0x64>
        continue;
80104964:	e9 1a 01 00 00       	jmp    80104a83 <wait+0x17e>
      
      havekids = 1;
80104969:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
...
80104977:	83 f8 08             	cmp    $0x8,%eax
8010497a:	74 f5                	je     80104971 <wait+0x6c>

      // transition finished, now we are sure the state is ZOMBIE
      if(p->state == ZOMBIE){
8010497c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010497f:	8b 40 0c             	mov    0xc(%eax),%eax
80104982:	83 f8 05             	cmp    $0x5,%eax
80104985:	0f 85 f8 00 00 00    	jne    80104a83 <wait+0x17e>
        // Found one.
        pid = p->pid;
8010498b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010498e:	8b 40 10             	mov    0x10(%eax),%eax
80104991:	89 45 e8             	mov    %eax,-0x18(%ebp)
        cas(&(p->state), ZOMBIE, UNUSED);
80104994:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104997:	83 c0 0c             	add    $0xc,%eax
8010499a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801049a1:	00 
801049a2:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
801049a9:	00 
801049aa:	89 04 24             	mov    %eax,(%esp)
801049ad:	e8 47 f9 ff ff       	call   801042f9 <cas>
        p->pid = 0;
801049b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049b5:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801049bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049bf:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
801049c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049c9:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)

        // clean it's signals attributes
        p->pending_signals.head = 0;
801049cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049d0:	c7 80 48 01 00 00 00 	movl   $0x0,0x148(%eax)
801049d7:	00 00 00 
        struct cstackframe *csf;
        for(csf = p->pending_signals.frames; csf < &p->pending_signals.frames[MAX_CSTACK_FRAMES]; csf++){
801049da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049dd:	83 e8 80             	sub    $0xffffff80,%eax
801049e0:	89 45 ec             	mov    %eax,-0x14(%ebp)
801049e3:	eb 0e                	jmp    801049f3 <wait+0xee>
             csf->used = 0;
801049e5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801049e8:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        ...
        struct cstackframe *csf;
        for(csf = p->pending_signals.frames; csf < &p->pending_signals.frames[MAX_CSTACK_FRAMES]; csf++){
801049ef:	83 45 ec 14          	addl   $0x14,-0x14(%ebp)
801049f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049f6:	05 48 01 00 00       	add    $0x148,%eax
801049fb:	3b 45 ec             	cmp    -0x14(%ebp),%eax
801049fe:	77 e5                	ja     801049e5 <wait+0xe0>
             csf->used = 0;
        }
        p->sighandler = (sig_handler)(-1);
80104a00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a03:	c7 40 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%eax)
        p->handling_signal = 0;
80104a0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a0d:	c7 80 9c 01 00 00 00 	movl   $0x0,0x19c(%eax)
80104a14:	00 00 00 
        p->curr_signal->used = 0;
80104a17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a1a:	8b 80 98 01 00 00    	mov    0x198(%eax),%eax
80104a20:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        
        proc->chan = 0;
80104a27:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a2d:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
...
80104a3a:	83 c0 0c             	add    $0xc,%eax
80104a3d:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80104a44:	00 
80104a45:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80104a4c:	00 
80104a4d:	89 04 24             	mov    %eax,(%esp)
80104a50:	e8 a4 f8 ff ff       	call   801042f9 <cas>
        cas(&(proc->state), nRUNNABLE, RUNNING);  
80104a55:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a5b:	83 c0 0c             	add    $0xc,%eax
80104a5e:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80104a65:	00 
80104a66:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
80104a6d:	00 
80104a6e:	89 04 24             	mov    %eax,(%esp)
80104a71:	e8 83 f8 ff ff       	call   801042f9 <cas>

        popcli();
80104a76:	e8 57 0c 00 00       	call   801056d2 <popcli>
        return pid;
80104a7b:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104a7e:	e9 8c 00 00 00       	jmp    80104b0f <wait+0x20a>
    proc->chan = (int)proc;
    // start transition to SLEEPING (finish in scheduler)
    cas(&(proc->state),RUNNING, nSLEEPING);    
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a83:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
80104a8a:	81 7d f4 c0 a1 11 80 	cmpl   $0x8011a1c0,-0xc(%ebp)
80104a91:	0f 82 bd fe ff ff    	jb     80104954 <wait+0x4f>
        return pid;
      }
    }
...
80104a9b:	74 0d                	je     80104aaa <wait+0x1a5>
80104a9d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104aa3:	8b 40 24             	mov    0x24(%eax),%eax
80104aa6:	85 c0                	test   %eax,%eax
80104aa8:	74 5b                	je     80104b05 <wait+0x200>
      proc->chan = 0;
80104aaa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ab0:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

      cas(&(proc->state), nSLEEPING, RUNNING);
80104ab7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104abd:	83 c0 0c             	add    $0xc,%eax
80104ac0:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80104ac7:	00 
80104ac8:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80104acf:	00 
80104ad0:	89 04 24             	mov    %eax,(%esp)
80104ad3:	e8 21 f8 ff ff       	call   801042f9 <cas>
      cas(&(proc->state), SLEEPING, RUNNING);
80104ad8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ade:	83 c0 0c             	add    $0xc,%eax
80104ae1:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80104ae8:	00 
80104ae9:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80104af0:	00 
80104af1:	89 04 24             	mov    %eax,(%esp)
80104af4:	e8 00 f8 ff ff       	call   801042f9 <cas>

      popcli();
80104af9:	e8 d4 0b 00 00       	call   801056d2 <popcli>
      return -1;
80104afe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b03:	eb 0a                	jmp    80104b0f <wait+0x20a>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sched();
80104b05:	e8 a6 01 00 00       	call   80104cb0 <sched>
  }
80104b0a:	e9 01 fe ff ff       	jmp    80104910 <wait+0xb>
}
80104b0f:	c9                   	leave  
80104b10:	c3                   	ret    
...
80104b17:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104b1b:	74 0b                	je     80104b28 <freeproc+0x17>
80104b1d:	8b 45 08             	mov    0x8(%ebp),%eax
80104b20:	8b 40 0c             	mov    0xc(%eax),%eax
80104b23:	83 f8 09             	cmp    $0x9,%eax
80104b26:	74 0c                	je     80104b34 <freeproc+0x23>
  //if (!p || p->state != ZOMBIE)
    panic("freeproc not zombie");
80104b28:	c7 04 24 c2 8e 10 80 	movl   $0x80108ec2,(%esp)
...
80104b3d:	e8 14 df ff ff       	call   80102a56 <kfree>
  p->kstack = 0;
...
80104b55:	e8 4b 3d 00 00       	call   801088a5 <freevm>
  p->killed = 0;
80104b5a:	8b 45 08             	mov    0x8(%ebp),%eax
80104b5d:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
  p->chan = 0;
80104b64:	8b 45 08             	mov    0x8(%ebp),%eax
80104b67:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
}
80104b6e:	c9                   	leave  
80104b6f:	c3                   	ret    
...
80104b73:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104b76:	e8 78 f7 ff ff       	call   801042f3 <sti>

    // Loop over process table looking for process to run.
    pushcli();
80104b7b:	e8 0e 0b 00 00       	call   8010568e <pushcli>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b80:	c7 45 f4 c0 39 11 80 	movl   $0x801139c0,-0xc(%ebp)
80104b87:	e9 0d 01 00 00       	jmp    80104c99 <scheduler+0x129>
      //if(p->state != RUNNABLE)
      if(!cas(&(p->state), RUNNABLE, RUNNING))
80104b8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b8f:	83 c0 0c             	add    $0xc,%eax
80104b92:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80104b99:	00 
80104b9a:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80104ba1:	00 
80104ba2:	89 04 24             	mov    %eax,(%esp)
80104ba5:	e8 4f f7 ff ff       	call   801042f9 <cas>
80104baa:	85 c0                	test   %eax,%eax
80104bac:	75 05                	jne    80104bb3 <scheduler+0x43>
        continue;
80104bae:	e9 df 00 00 00       	jmp    80104c92 <scheduler+0x122>
...
80104bc2:	e8 6b 38 00 00       	call   80108432 <switchuvm>
      swtch(&cpu->scheduler, proc->context);
80104bc7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bcd:	8b 40 1c             	mov    0x1c(%eax),%eax
80104bd0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104bd7:	83 c2 04             	add    $0x4,%edx
80104bda:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bde:	89 14 24             	mov    %edx,(%esp)
80104be1:	e8 39 0e 00 00       	call   80105a1f <swtch>

      cas(&(p->state), nSLEEPING, SLEEPING);
80104be6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104be9:	83 c0 0c             	add    $0xc,%eax
80104bec:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
80104bf3:	00 
80104bf4:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80104bfb:	00 
80104bfc:	89 04 24             	mov    %eax,(%esp)
80104bff:	e8 f5 f6 ff ff       	call   801042f9 <cas>
      cas(&(p->state), nRUNNABLE, RUNNABLE);
80104c04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c07:	83 c0 0c             	add    $0xc,%eax
80104c0a:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
80104c11:	00 
80104c12:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
80104c19:	00 
80104c1a:	89 04 24             	mov    %eax,(%esp)
80104c1d:	e8 d7 f6 ff ff       	call   801042f9 <cas>
      //cas(&(p->state), nZOMBIE, ZOMBIE);

      switchkvm();
80104c22:	e8 ee 37 00 00       	call   80108415 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104c27:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104c2e:	00 00 00 00 
         
      if (p->state == nZOMBIE)
80104c32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c35:	8b 40 0c             	mov    0xc(%eax),%eax
80104c38:	83 f8 08             	cmp    $0x8,%eax
80104c3b:	75 55                	jne    80104c92 <scheduler+0x122>
      {
        cas(&(p->state), nZOMBIE, nnZOMBIE);
80104c3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c40:	83 c0 0c             	add    $0xc,%eax
80104c43:	c7 44 24 08 09 00 00 	movl   $0x9,0x8(%esp)
80104c4a:	00 
80104c4b:	c7 44 24 04 08 00 00 	movl   $0x8,0x4(%esp)
80104c52:	00 
80104c53:	89 04 24             	mov    %eax,(%esp)
80104c56:	e8 9e f6 ff ff       	call   801042f9 <cas>
        freeproc(p);
80104c5b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c5e:	89 04 24             	mov    %eax,(%esp)
80104c61:	e8 ab fe ff ff       	call   80104b11 <freeproc>
        cas(&(p->state), nnZOMBIE, ZOMBIE);
80104c66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c69:	83 c0 0c             	add    $0xc,%eax
80104c6c:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
80104c73:	00 
80104c74:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
80104c7b:	00 
80104c7c:	89 04 24             	mov    %eax,(%esp)
80104c7f:	e8 75 f6 ff ff       	call   801042f9 <cas>
        wakeup1(p->parent);
80104c84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c87:	8b 40 14             	mov    0x14(%eax),%eax
80104c8a:	89 04 24             	mov    %eax,(%esp)
80104c8d:	e8 93 01 00 00       	call   80104e25 <wakeup1>
    // Enable interrupts on this processor.
    sti();
    ...
    pushcli();
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c92:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
80104c99:	81 7d f4 c0 a1 11 80 	cmpl   $0x8011a1c0,-0xc(%ebp)
80104ca0:	0f 82 e6 fe ff ff    	jb     80104b8c <scheduler+0x1c>
        freeproc(p);
        wakeup1(p->parent);
      }
      */
    ...
    popcli();
80104ca6:	e8 27 0a 00 00       	call   801056d2 <popcli>
  }
80104cab:	e9 c6 fe ff ff       	jmp    80104b76 <scheduler+0x6>
...
80104cbc:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104cc2:	83 f8 01             	cmp    $0x1,%eax
80104cc5:	74 0c                	je     80104cd3 <sched+0x23>
    panic("sched locks");
80104cc7:	c7 04 24 d6 8e 10 80 	movl   $0x80108ed6,(%esp)
...
80104cdf:	75 0c                	jne    80104ced <sched+0x3d>
    panic("sched running");
80104ce1:	c7 04 24 e2 8e 10 80 	movl   $0x80108ee2,(%esp)
80104ce8:	e8 4d b8 ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104ced:	e8 f1 f5 ff ff       	call   801042e3 <readeflags>
80104cf2:	25 00 02 00 00       	and    $0x200,%eax
80104cf7:	85 c0                	test   %eax,%eax
80104cf9:	74 0c                	je     80104d07 <sched+0x57>
    panic("sched interruptible");
80104cfb:	c7 04 24 f0 8e 10 80 	movl   $0x80108ef0,(%esp)
80104d02:	e8 33 b8 ff ff       	call   8010053a <panic>
  intena = cpu->intena;
...
80104d1f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104d26:	83 c2 1c             	add    $0x1c,%edx
80104d29:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d2d:	89 14 24             	mov    %edx,(%esp)
80104d30:	e8 ea 0c 00 00       	call   80105a1f <swtch>
  cpu->intena = intena;
80104d35:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104d3b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d3e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104d44:	c9                   	leave  
80104d45:	c3                   	ret    
...
80104d49:	83 ec 18             	sub    $0x18,%esp
  pushcli();
80104d4c:	e8 3d 09 00 00       	call   8010568e <pushcli>
  cas(&(proc->state), RUNNING, nRUNNABLE);
80104d51:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d57:	83 c0 0c             	add    $0xc,%eax
80104d5a:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
80104d61:	00 
80104d62:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
80104d69:	00 
80104d6a:	89 04 24             	mov    %eax,(%esp)
80104d6d:	e8 87 f5 ff ff       	call   801042f9 <cas>
  sched();
80104d72:	e8 39 ff ff ff       	call   80104cb0 <sched>
  popcli();
80104d77:	e8 56 09 00 00       	call   801056d2 <popcli>
}
80104d7c:	c9                   	leave  
80104d7d:	c3                   	ret    
...
80104d81:	83 ec 08             	sub    $0x8,%esp
  ...
  popcli();
80104d84:	e8 49 09 00 00       	call   801056d2 <popcli>

  if (first) {
80104d89:	a1 24 c0 10 80       	mov    0x8010c024,%eax
80104d8e:	85 c0                	test   %eax,%eax
80104d90:	74 0f                	je     80104da1 <forkret+0x23>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104d92:	c7 05 24 c0 10 80 00 	movl   $0x0,0x8010c024
80104d99:	00 00 00 
    initlog();
80104d9c:	e8 6e e4 ff ff       	call   8010320f <initlog>
  }
...
80104db1:	75 0c                	jne    80104dbf <sleep+0x1c>
    panic("sleep");
80104db3:	c7 04 24 04 8f 10 80 	movl   $0x80108f04,(%esp)
80104dba:	e8 7b b7 ff ff       	call   8010053a <panic>

  if(lk == 0)
80104dbf:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104dc3:	75 0c                	jne    80104dd1 <sleep+0x2e>
    panic("sleep without lk");
80104dc5:	c7 04 24 0a 8f 10 80 	movl   $0x80108f0a,(%esp)
...
80104de3:	83 c0 0c             	add    $0xc,%eax
80104de6:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
80104ded:	00 
80104dee:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
80104df5:	00 
80104df6:	89 04 24             	mov    %eax,(%esp)
80104df9:	e8 fb f4 ff ff       	call   801042f9 <cas>

  pushcli();
80104dfe:	e8 8b 08 00 00       	call   8010568e <pushcli>

  release(lk);
80104e03:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e06:	89 04 24             	mov    %eax,(%esp)
80104e09:	e8 8e 07 00 00       	call   8010559c <release>
  sched();
80104e0e:	e8 9d fe ff ff       	call   80104cb0 <sched>
  acquire(lk);
80104e13:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e16:	89 04 24             	mov    %eax,(%esp)
80104e19:	e8 1c 07 00 00       	call   8010553a <acquire>

  popcli();
80104e1e:	e8 af 08 00 00       	call   801056d2 <popcli>
...
80104e28:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e2b:	c7 45 fc c0 39 11 80 	movl   $0x801139c0,-0x4(%ebp)
80104e32:	eb 6c                	jmp    80104ea0 <wakeup1+0x7b>
    // if the proccess is sleeping
    if(p->chan == (int)chan)
80104e34:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e37:	8b 50 20             	mov    0x20(%eax),%edx
80104e3a:	8b 45 08             	mov    0x8(%ebp),%eax
80104e3d:	39 c2                	cmp    %eax,%edx
80104e3f:	75 58                	jne    80104e99 <wakeup1+0x74>
    {
...
80104e44:	83 c0 0c             	add    $0xc,%eax
80104e47:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
80104e4e:	00 
80104e4f:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80104e56:	00 
80104e57:	89 04 24             	mov    %eax,(%esp)
80104e5a:	e8 9a f4 ff ff       	call   801042f9 <cas>
80104e5f:	85 c0                	test   %eax,%eax
80104e61:	74 0a                	je     80104e6d <wakeup1+0x48>
        p->chan= 0;
80104e63:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e66:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
      // proccess is SLEEPING
      if(cas(&(p->state),SLEEPING, RUNNABLE))
80104e6d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e70:	83 c0 0c             	add    $0xc,%eax
80104e73:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
80104e7a:	00 
80104e7b:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80104e82:	00 
80104e83:	89 04 24             	mov    %eax,(%esp)
80104e86:	e8 6e f4 ff ff       	call   801042f9 <cas>
80104e8b:	85 c0                	test   %eax,%eax
80104e8d:	74 0a                	je     80104e99 <wakeup1+0x74>
        p->chan= 0;
80104e8f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e92:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
// The ptable lock must be held.
static void
wakeup1(void *chan)
{
  struct proc *p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e99:	81 45 fc a0 01 00 00 	addl   $0x1a0,-0x4(%ebp)
80104ea0:	81 7d fc c0 a1 11 80 	cmpl   $0x8011a1c0,-0x4(%ebp)
80104ea7:	72 8b                	jb     80104e34 <wakeup1+0xf>
      // proccess is SLEEPING
      if(cas(&(p->state),SLEEPING, RUNNABLE))
        p->chan= 0;
    }
...
80104eae:	83 ec 18             	sub    $0x18,%esp
  pushcli();
80104eb1:	e8 d8 07 00 00       	call   8010568e <pushcli>
  wakeup1(chan);
80104eb6:	8b 45 08             	mov    0x8(%ebp),%eax
80104eb9:	89 04 24             	mov    %eax,(%esp)
80104ebc:	e8 64 ff ff ff       	call   80104e25 <wakeup1>
  popcli();
80104ec1:	e8 0c 08 00 00       	call   801056d2 <popcli>
}
80104ec6:	c9                   	leave  
80104ec7:	c3                   	ret    
...
80104ecb:	83 ec 28             	sub    $0x28,%esp
  ...
  pushcli();
80104ece:	e8 bb 07 00 00       	call   8010568e <pushcli>

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104ed3:	c7 45 f4 c0 39 11 80 	movl   $0x801139c0,-0xc(%ebp)
80104eda:	eb 52                	jmp    80104f2e <kill+0x66>
  {  
    if(p->pid == pid)
80104edc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104edf:	8b 40 10             	mov    0x10(%eax),%eax
80104ee2:	3b 45 08             	cmp    0x8(%ebp),%eax
80104ee5:	75 40                	jne    80104f27 <kill+0x5f>
    {
      p->killed = 1;
80104ee7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eea:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
...
80104ef8:	83 f8 06             	cmp    $0x6,%eax
80104efb:	74 f5                	je     80104ef2 <kill+0x2a>
      cas(&(p->state), SLEEPING, RUNNABLE);
80104efd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f00:	83 c0 0c             	add    $0xc,%eax
80104f03:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
80104f0a:	00 
80104f0b:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80104f12:	00 
80104f13:	89 04 24             	mov    %eax,(%esp)
80104f16:	e8 de f3 ff ff       	call   801042f9 <cas>

      popcli();
80104f1b:	e8 b2 07 00 00       	call   801056d2 <popcli>
      return 0;
80104f20:	b8 00 00 00 00       	mov    $0x0,%eax
80104f25:	eb 1a                	jmp    80104f41 <kill+0x79>
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104f27:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
80104f2e:	81 7d f4 c0 a1 11 80 	cmpl   $0x8011a1c0,-0xc(%ebp)
80104f35:	72 a5                	jb     80104edc <kill+0x14>
      popcli();
      return 0;
    }
  }
  ...
  popcli();
80104f37:	e8 96 07 00 00       	call   801056d2 <popcli>
  return -1;
...
80104f46:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f49:	c7 45 f0 c0 39 11 80 	movl   $0x801139c0,-0x10(%ebp)
80104f50:	e9 ef 00 00 00       	jmp    80105044 <procdump+0x101>
    if(p->state == UNUSED)
80104f55:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f58:	8b 40 0c             	mov    0xc(%eax),%eax
80104f5b:	85 c0                	test   %eax,%eax
80104f5d:	75 05                	jne    80104f64 <procdump+0x21>
      continue;
80104f5f:	e9 d9 00 00 00       	jmp    8010503d <procdump+0xfa>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104f64:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f67:	8b 40 0c             	mov    0xc(%eax),%eax
80104f6a:	85 c0                	test   %eax,%eax
80104f6c:	78 2e                	js     80104f9c <procdump+0x59>
80104f6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f71:	8b 40 0c             	mov    0xc(%eax),%eax
80104f74:	83 f8 08             	cmp    $0x8,%eax
80104f77:	77 23                	ja     80104f9c <procdump+0x59>
80104f79:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f7c:	8b 40 0c             	mov    0xc(%eax),%eax
80104f7f:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80104f86:	85 c0                	test   %eax,%eax
80104f88:	74 12                	je     80104f9c <procdump+0x59>
      state = states[p->state];
80104f8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f8d:	8b 40 0c             	mov    0xc(%eax),%eax
80104f90:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80104f97:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104f9a:	eb 07                	jmp    80104fa3 <procdump+0x60>
    else
      state = "???";
80104f9c:	c7 45 ec 1b 8f 10 80 	movl   $0x80108f1b,-0x14(%ebp)
...
80104fbe:	c7 04 24 1f 8f 10 80 	movl   $0x80108f1f,(%esp)
...
80104fd4:	74 f5                	je     80104fcb <procdump+0x88>

    if(p->state == SLEEPING){
80104fd6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104fd9:	8b 40 0c             	mov    0xc(%eax),%eax
80104fdc:	83 f8 02             	cmp    $0x2,%eax
80104fdf:	75 50                	jne    80105031 <procdump+0xee>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104fe1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104fe4:	8b 40 1c             	mov    0x1c(%eax),%eax
80104fe7:	8b 40 0c             	mov    0xc(%eax),%eax
80104fea:	83 c0 08             	add    $0x8,%eax
80104fed:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104ff0:	89 54 24 04          	mov    %edx,0x4(%esp)
80104ff4:	89 04 24             	mov    %eax,(%esp)
80104ff7:	e8 ef 05 00 00       	call   801055eb <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104ffc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105003:	eb 1b                	jmp    80105020 <procdump+0xdd>
        cprintf(" %p", pc[i]);
80105005:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105008:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
8010500c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105010:	c7 04 24 28 8f 10 80 	movl   $0x80108f28,(%esp)
80105017:	e8 84 b3 ff ff       	call   801003a0 <cprintf>
    //busy wait until scheduler finish transition to SLEEPING
    while(p->state == nSLEEPING);
    ...
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
8010501c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105020:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105024:	7f 0b                	jg     80105031 <procdump+0xee>
80105026:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105029:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
8010502d:	85 c0                	test   %eax,%eax
8010502f:	75 d4                	jne    80105005 <procdump+0xc2>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80105031:	c7 04 24 2c 8f 10 80 	movl   $0x80108f2c,(%esp)
80105038:	e8 63 b3 ff ff       	call   801003a0 <cprintf>
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010503d:	81 45 f0 a0 01 00 00 	addl   $0x1a0,-0x10(%ebp)
80105044:	81 7d f0 c0 a1 11 80 	cmpl   $0x8011a1c0,-0x10(%ebp)
8010504b:	0f 82 04 ff ff ff    	jb     80104f55 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
8010505f:	8b 40 7c             	mov    0x7c(%eax),%eax
80105062:	89 45 fc             	mov    %eax,-0x4(%ebp)
  proc->sighandler = new_handler;
80105065:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010506b:	8b 55 08             	mov    0x8(%ebp),%edx
8010506e:	89 50 7c             	mov    %edx,0x7c(%eax)
  return oldhandler;
...
80105079:	83 ec 28             	sub    $0x28,%esp
  struct proc *p; 

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010507c:	c7 45 f4 c0 39 11 80 	movl   $0x801139c0,-0xc(%ebp)
80105083:	eb 59                	jmp    801050de <sigsend+0x68>
    if (p->pid == dest_pid) {
80105085:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105088:	8b 40 10             	mov    0x10(%eax),%eax
8010508b:	3b 45 08             	cmp    0x8(%ebp),%eax
8010508e:	75 47                	jne    801050d7 <sigsend+0x61>
...
8010509c:	8d 8a 80 00 00 00    	lea    0x80(%edx),%ecx
801050a2:	8b 55 0c             	mov    0xc(%ebp),%edx
801050a5:	89 54 24 0c          	mov    %edx,0xc(%esp)
801050a9:	8b 55 08             	mov    0x8(%ebp),%edx
801050ac:	89 54 24 08          	mov    %edx,0x8(%esp)
801050b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801050b4:	89 0c 24             	mov    %ecx,(%esp)
801050b7:	e8 69 01 00 00       	call   80105225 <push>
801050bc:	85 c0                	test   %eax,%eax
801050be:	74 15                	je     801050d5 <sigsend+0x5f>
      {
        wakeup((void*)p->chan);
801050c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050c3:	8b 40 20             	mov    0x20(%eax),%eax
801050c6:	89 04 24             	mov    %eax,(%esp)
801050c9:	e8 dd fd ff ff       	call   80104eab <wakeup>
        return 0;
801050ce:	b8 00 00 00 00       	mov    $0x0,%eax
801050d3:	eb 17                	jmp    801050ec <sigsend+0x76>
      }
      break;
801050d5:	eb 10                	jmp    801050e7 <sigsend+0x71>
int
sigsend(int dest_pid, int value)
{
  struct proc *p; 
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801050d7:	81 45 f4 a0 01 00 00 	addl   $0x1a0,-0xc(%ebp)
801050de:	81 7d f4 c0 a1 11 80 	cmpl   $0x8011a1c0,-0xc(%ebp)
801050e5:	72 9e                	jb     80105085 <sigsend+0xf>
        return 0;
      }
      break;
    }
...
801050fc:	74 45                	je     80105143 <sigret+0x55>
  {
    // restore origin user stack
    *(proc->tf) = proc->old_tf;  
801050fe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105104:	8b 50 18             	mov    0x18(%eax),%edx
80105107:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010510d:	8d 98 4c 01 00 00    	lea    0x14c(%eax),%ebx
80105113:	b8 13 00 00 00       	mov    $0x13,%eax
80105118:	89 d7                	mov    %edx,%edi
8010511a:	89 de                	mov    %ebx,%esi
8010511c:	89 c1                	mov    %eax,%ecx
8010511e:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

    //finish handling signal so we could handle the next one
    proc->handling_signal = 0;
80105120:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105126:	c7 80 9c 01 00 00 00 	movl   $0x0,0x19c(%eax)
8010512d:	00 00 00 
    proc->curr_signal->used = 0;
80105130:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105136:	8b 80 98 01 00 00    	mov    0x198(%eax),%eax
...
80105150:	83 ec 18             	sub    $0x18,%esp
  if(proc)
80105153:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105159:	85 c0                	test   %eax,%eax
8010515b:	0f 84 bd 00 00 00    	je     8010521e <sigpause+0xd1>
  {
    if(!is_empty(&(proc->pending_signals)))
80105161:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105167:	83 e8 80             	sub    $0xffffff80,%eax
8010516a:	89 04 24             	mov    %eax,(%esp)
8010516d:	e8 a4 01 00 00       	call   80105316 <is_empty>
80105172:	85 c0                	test   %eax,%eax
80105174:	75 0a                	jne    80105180 <sigpause+0x33>
      return 0;
80105176:	b8 00 00 00 00       	mov    $0x0,%eax
8010517b:	e9 a3 00 00 00       	jmp    80105223 <sigpause+0xd6>

      proc->chan = (int)proc;    
80105180:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105186:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010518d:	89 50 20             	mov    %edx,0x20(%eax)
      cas(&proc->state, RUNNING, nSLEEPING);
80105190:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105196:	83 c0 0c             	add    $0xc,%eax
80105199:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
801051a0:	00 
801051a1:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
801051a8:	00 
801051a9:	89 04 24             	mov    %eax,(%esp)
801051ac:	e8 48 f1 ff ff       	call   801042f9 <cas>
      // again, check if there are pending signals
      if(!is_empty(&(proc->pending_signals)))
801051b1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051b7:	83 e8 80             	sub    $0xffffff80,%eax
801051ba:	89 04 24             	mov    %eax,(%esp)
801051bd:	e8 54 01 00 00       	call   80105316 <is_empty>
801051c2:	85 c0                	test   %eax,%eax
801051c4:	75 49                	jne    8010520f <sigpause+0xc2>
      {
        cas(&proc->state, SLEEPING, RUNNING);
801051c6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051cc:	83 c0 0c             	add    $0xc,%eax
801051cf:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801051d6:	00 
801051d7:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801051de:	00 
801051df:	89 04 24             	mov    %eax,(%esp)
801051e2:	e8 12 f1 ff ff       	call   801042f9 <cas>
        cas(&proc->state, nSLEEPING, RUNNING);
801051e7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051ed:	83 c0 0c             	add    $0xc,%eax
801051f0:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801051f7:	00 
801051f8:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
801051ff:	00 
80105200:	89 04 24             	mov    %eax,(%esp)
80105203:	e8 f1 f0 ff ff       	call   801042f9 <cas>

        return 0;
80105208:	b8 00 00 00 00       	mov    $0x0,%eax
8010520d:	eb 14                	jmp    80105223 <sigpause+0xd6>
      }
      pushcli();
8010520f:	e8 7a 04 00 00       	call   8010568e <pushcli>
      sched();
80105214:	e8 97 fa ff ff       	call   80104cb0 <sched>
      popcli();
80105219:	e8 b4 04 00 00       	call   801056d2 <popcli>
  }
  return 0;
...
80105231:	eb 43                	jmp    80105276 <push+0x51>
    if(cas(&(csf->used), 0, 1)) 
80105233:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105236:	83 c0 0c             	add    $0xc,%eax
80105239:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80105240:	00 
80105241:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105248:	00 
80105249:	89 04 24             	mov    %eax,(%esp)
8010524c:	e8 a8 f0 ff ff       	call   801042f9 <cas>
80105251:	85 c0                	test   %eax,%eax
80105253:	74 1d                	je     80105272 <push+0x4d>
      goto found;
80105255:	90                   	nop
...
80105259:	8b 55 0c             	mov    0xc(%ebp),%edx
8010525c:	89 10                	mov    %edx,(%eax)
  csf->recepient_pid = recepient_pid;
8010525e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105261:	8b 55 10             	mov    0x10(%ebp),%edx
80105264:	89 50 04             	mov    %edx,0x4(%eax)
  csf->value = value;
80105267:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010526a:	8b 55 14             	mov    0x14(%ebp),%edx
8010526d:	89 50 08             	mov    %edx,0x8(%eax)
80105270:	eb 18                	jmp    8010528a <push+0x65>
// -------------- cstack implementation ------------
int 
push(struct cstack *cstack, int sender_pid, int recepient_pid, int value)
{
  struct cstackframe *csf;
  for(csf = cstack->frames; csf < &cstack->frames[MAX_CSTACK_FRAMES]; csf++) {
80105272:	83 45 fc 14          	addl   $0x14,-0x4(%ebp)
80105276:	8b 45 08             	mov    0x8(%ebp),%eax
80105279:	05 c8 00 00 00       	add    $0xc8,%eax
8010527e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
80105281:	77 b0                	ja     80105233 <push+0xe>
    if(cas(&(csf->used), 0, 1)) 
      goto found;
  }
...
80105288:	eb 3a                	jmp    801052c4 <push+0x9f>
  csf->sender_pid = sender_pid;
  csf->recepient_pid = recepient_pid;
  csf->value = value;
...
8010528d:	8b 90 c8 00 00 00    	mov    0xc8(%eax),%edx
80105293:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105296:	89 50 10             	mov    %edx,0x10(%eax)
  } while (!cas((int*)&(cstack->head), (int)csf->next, (int)csf));
80105299:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010529c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010529f:	8b 40 10             	mov    0x10(%eax),%eax
801052a2:	8b 4d 08             	mov    0x8(%ebp),%ecx
801052a5:	81 c1 c8 00 00 00    	add    $0xc8,%ecx
801052ab:	89 54 24 08          	mov    %edx,0x8(%esp)
801052af:	89 44 24 04          	mov    %eax,0x4(%esp)
801052b3:	89 0c 24             	mov    %ecx,(%esp)
801052b6:	e8 3e f0 ff ff       	call   801042f9 <cas>
801052bb:	85 c0                	test   %eax,%eax
801052bd:	74 cb                	je     8010528a <push+0x65>
  
  return 1;
801052bf:	b8 01 00 00 00       	mov    $0x1,%eax
}
801052c4:	c9                   	leave  
801052c5:	c3                   	ret    
...
801052c9:	83 ec 1c             	sub    $0x1c,%esp
  struct cstackframe *csf;
...
801052cf:	8b 80 c8 00 00 00    	mov    0xc8(%eax),%eax
801052d5:	89 45 fc             	mov    %eax,-0x4(%ebp)
    if (!csf)
801052d8:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801052dc:	75 07                	jne    801052e5 <pop+0x1f>
      return 0;
801052de:	b8 00 00 00 00       	mov    $0x0,%eax
801052e3:	eb 2f                	jmp    80105314 <pop+0x4e>
...
801052ee:	8b 55 f8             	mov    -0x8(%ebp),%edx
801052f1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052f4:	8b 4d 08             	mov    0x8(%ebp),%ecx
801052f7:	81 c1 c8 00 00 00    	add    $0xc8,%ecx
801052fd:	89 54 24 08          	mov    %edx,0x8(%esp)
80105301:	89 44 24 04          	mov    %eax,0x4(%esp)
80105305:	89 0c 24             	mov    %ecx,(%esp)
80105308:	e8 ec ef ff ff       	call   801042f9 <cas>
8010530d:	85 c0                	test   %eax,%eax
8010530f:	74 bb                	je     801052cc <pop+0x6>
...
8010531c:	8b 80 c8 00 00 00    	mov    0xc8(%eax),%eax
80105322:	85 c0                	test   %eax,%eax
80105324:	0f 94 c0             	sete   %al
80105327:	0f b6 c0             	movzbl %al,%eax
}
8010532a:	5d                   	pop    %ebp
8010532b:	c3                   	ret    

8010532c <roundup_4div>:
...
80105332:	83 c0 03             	add    $0x3,%eax
80105335:	83 e0 fc             	and    $0xfffffffc,%eax
}
80105338:	5d                   	pop    %ebp
80105339:	c3                   	ret    
...
80105340:	83 ec 2c             	sub    $0x2c,%esp
  if (proc == 0)  //no proccess
80105343:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105349:	85 c0                	test   %eax,%eax
8010534b:	75 05                	jne    80105352 <fix_tf+0x18>
    return;
8010534d:	e9 89 01 00 00       	jmp    801054db <fix_tf+0x1a1>

  if (((tf->cs) & 3) != DPL_USER) //has no user privilge
80105352:	8b 45 08             	mov    0x8(%ebp),%eax
80105355:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80105359:	0f b7 c0             	movzwl %ax,%eax
8010535c:	83 e0 03             	and    $0x3,%eax
8010535f:	83 f8 03             	cmp    $0x3,%eax
80105362:	74 05                	je     80105369 <fix_tf+0x2f>
    return;
80105364:	e9 72 01 00 00       	jmp    801054db <fix_tf+0x1a1>
...
8010536f:	05 9c 01 00 00       	add    $0x19c,%eax
80105374:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010537b:	00 
8010537c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105383:	00 
80105384:	89 04 24             	mov    %eax,(%esp)
80105387:	e8 6d ef ff ff       	call   801042f9 <cas>
8010538c:	85 c0                	test   %eax,%eax
8010538e:	75 05                	jne    80105395 <fix_tf+0x5b>
    goto done;
80105390:	e9 46 01 00 00       	jmp    801054db <fix_tf+0x1a1>
...
80105395:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010539b:	83 e8 80             	sub    $0xffffff80,%eax
8010539e:	89 04 24             	mov    %eax,(%esp)
801053a1:	e8 20 ff ff ff       	call   801052c6 <pop>
801053a6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801053a9:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801053ad:	74 0e                	je     801053bd <fix_tf+0x83>
801053af:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053b5:	8b 40 7c             	mov    0x7c(%eax),%eax
801053b8:	83 f8 ff             	cmp    $0xffffffff,%eax
801053bb:	75 25                	jne    801053e2 <fix_tf+0xa8>
    if (new_signal)
801053bd:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801053c1:	74 0a                	je     801053cd <fix_tf+0x93>
      new_signal->used = 0;
801053c3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801053c6:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    proc->handling_signal = 0;
801053cd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053d3:	c7 80 9c 01 00 00 00 	movl   $0x0,0x19c(%eax)
801053da:	00 00 00 
    goto done; 
801053dd:	e9 f9 00 00 00       	jmp    801054db <fix_tf+0x1a1>
  }

  proc->curr_signal = new_signal;
801053e2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053e8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801053eb:	89 90 98 01 00 00    	mov    %edx,0x198(%eax)

  //else, we have a pending signal and a handler: 
  
  // back-up the old trap-frame for handeling user stack
  proc->old_tf = *(tf);
801053f1:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801053f8:	8b 45 08             	mov    0x8(%ebp),%eax
801053fb:	8d 9a 4c 01 00 00    	lea    0x14c(%edx),%ebx
80105401:	89 c2                	mov    %eax,%edx
80105403:	b8 13 00 00 00       	mov    $0x13,%eax
80105408:	89 df                	mov    %ebx,%edi
8010540a:	89 d6                	mov    %edx,%esi
8010540c:	89 c1                	mov    %eax,%ecx
8010540e:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  
  int addr_space; 
  //int ret_addr;
  
  int stam = 0;
80105410:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  if (1 == stam) {
80105417:	83 7d e0 01          	cmpl   $0x1,-0x20(%ebp)
8010541b:	75 07                	jne    80105424 <fix_tf+0xea>
    goToStack: // lable#1
    asm volatile("movl $24, %eax; int $64"); //movl $SYS_sigret, %eax; int $T_SYSCALL; 
8010541d:	b8 18 00 00 00       	mov    $0x18,%eax
80105422:	cd 40                	int    $0x40
    returnFromStack:; // lable#2
  }

  addr_space = &&returnFromStack - &&goToStack;
80105424:	ba 24 54 10 80       	mov    $0x80105424,%edx
80105429:	b8 1d 54 10 80       	mov    $0x8010541d,%eax
8010542e:	29 c2                	sub    %eax,%edx
80105430:	89 d0                	mov    %edx,%eax
80105432:	89 45 dc             	mov    %eax,-0x24(%ebp)
  addr_space = roundup_4div(addr_space);
80105435:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105438:	89 04 24             	mov    %eax,(%esp)
8010543b:	e8 ec fe ff ff       	call   8010532c <roundup_4div>
80105440:	89 45 dc             	mov    %eax,-0x24(%ebp)

  tf->esp -= addr_space;
80105443:	8b 45 08             	mov    0x8(%ebp),%eax
80105446:	8b 50 44             	mov    0x44(%eax),%edx
80105449:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010544c:	29 c2                	sub    %eax,%edx
8010544e:	8b 45 08             	mov    0x8(%ebp),%eax
80105451:	89 50 44             	mov    %edx,0x44(%eax)
  memmove((void *)tf->esp, &&goToStack, addr_space);
80105454:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105457:	8b 45 08             	mov    0x8(%ebp),%eax
8010545a:	8b 40 44             	mov    0x44(%eax),%eax
8010545d:	89 54 24 08          	mov    %edx,0x8(%esp)
80105461:	c7 44 24 04 1d 54 10 	movl   $0x8010541d,0x4(%esp)
80105468:	80 
80105469:	89 04 24             	mov    %eax,(%esp)
8010546c:	e8 ec 03 00 00       	call   8010585d <memmove>

  tf->esp -= 4;
80105471:	8b 45 08             	mov    0x8(%ebp),%eax
80105474:	8b 40 44             	mov    0x44(%eax),%eax
80105477:	8d 50 fc             	lea    -0x4(%eax),%edx
8010547a:	8b 45 08             	mov    0x8(%ebp),%eax
8010547d:	89 50 44             	mov    %edx,0x44(%eax)
  *(uint *)tf->esp = new_signal->value;      //param 2
80105480:	8b 45 08             	mov    0x8(%ebp),%eax
80105483:	8b 40 44             	mov    0x44(%eax),%eax
80105486:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105489:	8b 52 08             	mov    0x8(%edx),%edx
8010548c:	89 10                	mov    %edx,(%eax)

  tf->esp -= 4;
8010548e:	8b 45 08             	mov    0x8(%ebp),%eax
80105491:	8b 40 44             	mov    0x44(%eax),%eax
80105494:	8d 50 fc             	lea    -0x4(%eax),%edx
80105497:	8b 45 08             	mov    0x8(%ebp),%eax
8010549a:	89 50 44             	mov    %edx,0x44(%eax)
  *(uint *)tf->esp = new_signal->sender_pid; //param 1
8010549d:	8b 45 08             	mov    0x8(%ebp),%eax
801054a0:	8b 40 44             	mov    0x44(%eax),%eax
801054a3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801054a6:	8b 12                	mov    (%edx),%edx
801054a8:	89 10                	mov    %edx,(%eax)

  tf->esp -= 4;
801054aa:	8b 45 08             	mov    0x8(%ebp),%eax
801054ad:	8b 40 44             	mov    0x44(%eax),%eax
801054b0:	8d 50 fc             	lea    -0x4(%eax),%edx
801054b3:	8b 45 08             	mov    0x8(%ebp),%eax
801054b6:	89 50 44             	mov    %edx,0x44(%eax)
  *(uint *)tf->esp = tf->esp + 12;
801054b9:	8b 45 08             	mov    0x8(%ebp),%eax
801054bc:	8b 40 44             	mov    0x44(%eax),%eax
801054bf:	8b 55 08             	mov    0x8(%ebp),%edx
801054c2:	8b 52 44             	mov    0x44(%edx),%edx
801054c5:	83 c2 0c             	add    $0xc,%edx
801054c8:	89 10                	mov    %edx,(%eax)
  
  tf->eip = (int)proc->sighandler;  
801054ca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054d0:	8b 40 7c             	mov    0x7c(%eax),%eax
801054d3:	89 c2                	mov    %eax,%edx
801054d5:	8b 45 08             	mov    0x8(%ebp),%eax
801054d8:	89 50 38             	mov    %edx,0x38(%eax)

  done:;
801054db:	83 c4 2c             	add    $0x2c,%esp
801054de:	5b                   	pop    %ebx
801054df:	5e                   	pop    %esi
801054e0:	5f                   	pop    %edi
801054e1:	5d                   	pop    %ebp
...
801054e6:	83 ec 10             	sub    $0x10,%esp
  uint eflags;
  asm volatile("pushfl; popl %0" : "=r" (eflags));
801054e9:	9c                   	pushf  
801054ea:	58                   	pop    %eax
...
8010550e:	f0 87 02             	lock xchg %eax,(%edx)
...
80105522:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80105525:	8b 45 08             	mov    0x8(%ebp),%eax
80105528:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
...
80105540:	e8 49 01 00 00       	call   8010568e <pushcli>
  if(holding(lk))
80105545:	8b 45 08             	mov    0x8(%ebp),%eax
80105548:	89 04 24             	mov    %eax,(%esp)
8010554b:	e8 14 01 00 00       	call   80105664 <holding>
80105550:	85 c0                	test   %eax,%eax
80105552:	74 0c                	je     80105560 <acquire+0x26>
    panic("acquire");
80105554:	c7 04 24 6f 8f 10 80 	movl   $0x80108f6f,(%esp)
8010555b:	e8 da af ff ff       	call   8010053a <panic>
...
80105564:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010556b:	00 
8010556c:	89 04 24             	mov    %eax,(%esp)
8010556f:	e8 8b ff ff ff       	call   801054ff <xchg>
80105574:	85 c0                	test   %eax,%eax
80105576:	75 e9                	jne    80105561 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80105578:	8b 45 08             	mov    0x8(%ebp),%eax
8010557b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105582:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105585:	8b 45 08             	mov    0x8(%ebp),%eax
80105588:	83 c0 0c             	add    $0xc,%eax
8010558b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010558f:	8d 45 08             	lea    0x8(%ebp),%eax
80105592:	89 04 24             	mov    %eax,(%esp)
80105595:	e8 51 00 00 00       	call   801055eb <getcallerpcs>
}
8010559a:	c9                   	leave  
8010559b:	c3                   	ret    
...
801055a8:	e8 b7 00 00 00       	call   80105664 <holding>
801055ad:	85 c0                	test   %eax,%eax
801055af:	75 0c                	jne    801055bd <release+0x21>
    panic("release");
801055b1:	c7 04 24 77 8f 10 80 	movl   $0x80108f77,(%esp)
801055b8:	e8 7d af ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
801055bd:	8b 45 08             	mov    0x8(%ebp),%eax
801055c0:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
801055d4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801055db:	00 
801055dc:	89 04 24             	mov    %eax,(%esp)
801055df:	e8 1b ff ff ff       	call   801054ff <xchg>

  popcli();
801055e4:	e8 e9 00 00 00       	call   801056d2 <popcli>
}
801055e9:	c9                   	leave  
801055ea:	c3                   	ret    

801055eb <getcallerpcs>:
...
801055f4:	83 e8 08             	sub    $0x8,%eax
801055f7:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801055fa:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105601:	eb 38                	jmp    8010563b <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105603:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105607:	74 38                	je     80105641 <getcallerpcs+0x56>
80105609:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105610:	76 2f                	jbe    80105641 <getcallerpcs+0x56>
80105612:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105616:	74 29                	je     80105641 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105618:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010561b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105622:	8b 45 0c             	mov    0xc(%ebp),%eax
80105625:	01 c2                	add    %eax,%edx
80105627:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010562a:	8b 40 04             	mov    0x4(%eax),%eax
8010562d:	89 02                	mov    %eax,(%edx)
...
80105634:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80105637:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010563b:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010563f:	7e c2                	jle    80105603 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105641:	eb 19                	jmp    8010565c <getcallerpcs+0x71>
    pcs[i] = 0;
80105643:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105646:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010564d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105650:	01 d0                	add    %edx,%eax
...
80105660:	7e e1                	jle    80105643 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80105662:	c9                   	leave  
80105663:	c3                   	ret    
...
8010566a:	8b 00                	mov    (%eax),%eax
8010566c:	85 c0                	test   %eax,%eax
8010566e:	74 17                	je     80105687 <holding+0x23>
80105670:	8b 45 08             	mov    0x8(%ebp),%eax
80105673:	8b 50 08             	mov    0x8(%eax),%edx
80105676:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010567c:	39 c2                	cmp    %eax,%edx
8010567e:	75 07                	jne    80105687 <holding+0x23>
80105680:	b8 01 00 00 00       	mov    $0x1,%eax
80105685:	eb 05                	jmp    8010568c <holding+0x28>
...
80105691:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105694:	e8 4a fe ff ff       	call   801054e3 <readeflags>
80105699:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
8010569c:	e8 52 fe ff ff       	call   801054f3 <cli>
  if(cpu->ncli++ == 0)
801056a1:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801056a8:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
801056ae:	8d 48 01             	lea    0x1(%eax),%ecx
801056b1:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
801056b7:	85 c0                	test   %eax,%eax
801056b9:	75 15                	jne    801056d0 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
801056bb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056c1:	8b 55 fc             	mov    -0x4(%ebp),%edx
801056c4:	81 e2 00 02 00 00    	and    $0x200,%edx
801056ca:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801056d0:	c9                   	leave  
801056d1:	c3                   	ret    
...
801056d5:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
801056d8:	e8 06 fe ff ff       	call   801054e3 <readeflags>
801056dd:	25 00 02 00 00       	and    $0x200,%eax
801056e2:	85 c0                	test   %eax,%eax
801056e4:	74 0c                	je     801056f2 <popcli+0x20>
    panic("popcli - interruptible");
801056e6:	c7 04 24 7f 8f 10 80 	movl   $0x80108f7f,(%esp)
801056ed:	e8 48 ae ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
801056f2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056f8:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801056fe:	83 ea 01             	sub    $0x1,%edx
80105701:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105707:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010570d:	85 c0                	test   %eax,%eax
8010570f:	79 0c                	jns    8010571d <popcli+0x4b>
    panic("popcli");
80105711:	c7 04 24 96 8f 10 80 	movl   $0x80108f96,(%esp)
80105718:	e8 1d ae ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010571d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105723:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105729:	85 c0                	test   %eax,%eax
8010572b:	75 15                	jne    80105742 <popcli+0x70>
8010572d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105733:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105739:	85 c0                	test   %eax,%eax
8010573b:	74 05                	je     80105742 <popcli+0x70>
    sti();
8010573d:	e8 b7 fd ff ff       	call   801054f9 <sti>
}
80105742:	c9                   	leave  
80105743:	c3                   	ret    
...
8010574c:	8b 55 10             	mov    0x10(%ebp),%edx
8010574f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105752:	89 cb                	mov    %ecx,%ebx
80105754:	89 df                	mov    %ebx,%edi
80105756:	89 d1                	mov    %edx,%ecx
80105758:	fc                   	cld    
80105759:	f3 aa                	rep stos %al,%es:(%edi)
8010575b:	89 ca                	mov    %ecx,%edx
8010575d:	89 fb                	mov    %edi,%ebx
8010575f:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
8010576e:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105771:	8b 55 10             	mov    0x10(%ebp),%edx
80105774:	8b 45 0c             	mov    0xc(%ebp),%eax
80105777:	89 cb                	mov    %ecx,%ebx
80105779:	89 df                	mov    %ebx,%edi
8010577b:	89 d1                	mov    %edx,%ecx
8010577d:	fc                   	cld    
8010577e:	f3 ab                	rep stos %eax,%es:(%edi)
80105780:	89 ca                	mov    %ecx,%edx
80105782:	89 fb                	mov    %edi,%ebx
80105784:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801057fb:	e8 44 ff ff ff       	call   80105744 <stosb>
  return dst;
...
80105814:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105817:	eb 30                	jmp    80105849 <memcmp+0x44>
    if(*s1 != *s2)
80105819:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010581c:	0f b6 10             	movzbl (%eax),%edx
8010581f:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105822:	0f b6 00             	movzbl (%eax),%eax
80105825:	38 c2                	cmp    %al,%dl
80105827:	74 18                	je     80105841 <memcmp+0x3c>
      return *s1 - *s2;
80105829:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010582c:	0f b6 00             	movzbl (%eax),%eax
8010582f:	0f b6 d0             	movzbl %al,%edx
80105832:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105835:	0f b6 00             	movzbl (%eax),%eax
80105838:	0f b6 c0             	movzbl %al,%eax
8010583b:	29 c2                	sub    %eax,%edx
8010583d:	89 d0                	mov    %edx,%eax
8010583f:	eb 1a                	jmp    8010585b <memcmp+0x56>
    s1++, s2++;
80105841:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105845:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
80105849:	8b 45 10             	mov    0x10(%ebp),%eax
8010584c:	8d 50 ff             	lea    -0x1(%eax),%edx
8010584f:	89 55 10             	mov    %edx,0x10(%ebp)
80105852:	85 c0                	test   %eax,%eax
80105854:	75 c3                	jne    80105819 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
  ...
  return 0;
80105856:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010585b:	c9                   	leave  
8010585c:	c3                   	ret    
...
80105860:	83 ec 10             	sub    $0x10,%esp
  const char *s;
  char *d;

  s = src;
80105863:	8b 45 0c             	mov    0xc(%ebp),%eax
80105866:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
80105869:	8b 45 08             	mov    0x8(%ebp),%eax
8010586c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
8010586f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105872:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105875:	73 3d                	jae    801058b4 <memmove+0x57>
80105877:	8b 45 10             	mov    0x10(%ebp),%eax
8010587a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010587d:	01 d0                	add    %edx,%eax
8010587f:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105882:	76 30                	jbe    801058b4 <memmove+0x57>
    s += n;
80105884:	8b 45 10             	mov    0x10(%ebp),%eax
80105887:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010588a:	8b 45 10             	mov    0x10(%ebp),%eax
8010588d:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105890:	eb 13                	jmp    801058a5 <memmove+0x48>
      *--d = *--s;
80105892:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105896:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
8010589a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010589d:	0f b6 10             	movzbl (%eax),%edx
801058a0:	8b 45 f8             	mov    -0x8(%ebp),%eax
801058a3:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
801058a8:	8d 50 ff             	lea    -0x1(%eax),%edx
801058ab:	89 55 10             	mov    %edx,0x10(%ebp)
801058ae:	85 c0                	test   %eax,%eax
801058b0:	75 e0                	jne    80105892 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801058b2:	eb 26                	jmp    801058da <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
801058b4:	eb 17                	jmp    801058cd <memmove+0x70>
      *d++ = *s++;
801058b6:	8b 45 f8             	mov    -0x8(%ebp),%eax
801058b9:	8d 50 01             	lea    0x1(%eax),%edx
801058bc:	89 55 f8             	mov    %edx,-0x8(%ebp)
801058bf:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058c2:	8d 4a 01             	lea    0x1(%edx),%ecx
801058c5:	89 4d fc             	mov    %ecx,-0x4(%ebp)
...
801058d0:	8d 50 ff             	lea    -0x1(%eax),%edx
801058d3:	89 55 10             	mov    %edx,0x10(%ebp)
801058d6:	85 c0                	test   %eax,%eax
801058d8:	75 dc                	jne    801058b6 <memmove+0x59>
      *d++ = *s++;
...
801058ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801058f3:	8b 45 08             	mov    0x8(%ebp),%eax
801058f6:	89 04 24             	mov    %eax,(%esp)
801058f9:	e8 5f ff ff ff       	call   8010585d <memmove>
}
801058fe:	c9                   	leave  
801058ff:	c3                   	ret    
...
80105901:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105903:	eb 0c                	jmp    80105911 <strncmp+0x11>
    n--, p++, q++;
80105905:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105909:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010590d:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
80105959:	83 ec 10             	sub    $0x10,%esp
  ...
  os = s;
8010595c:	8b 45 08             	mov    0x8(%ebp),%eax
8010595f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
80105962:	90                   	nop
80105963:	8b 45 10             	mov    0x10(%ebp),%eax
80105966:	8d 50 ff             	lea    -0x1(%eax),%edx
80105969:	89 55 10             	mov    %edx,0x10(%ebp)
8010596c:	85 c0                	test   %eax,%eax
8010596e:	7e 1e                	jle    8010598e <strncpy+0x38>
...
8010598c:	75 d5                	jne    80105963 <strncpy+0xd>
    ;
  while(n-- > 0)
8010598e:	eb 0c                	jmp    8010599c <strncpy+0x46>
    *s++ = 0;
80105990:	8b 45 08             	mov    0x8(%ebp),%eax
80105993:	8d 50 01             	lea    0x1(%eax),%edx
80105996:	89 55 08             	mov    %edx,0x8(%ebp)
80105999:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
801059a2:	89 55 10             	mov    %edx,0x10(%ebp)
801059a5:	85 c0                	test   %eax,%eax
801059a7:	7f e7                	jg     80105990 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
801059c3:	eb 31                	jmp    801059f6 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
801059c5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801059c9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801059cd:	7e 1e                	jle    801059ed <safestrcpy+0x3f>
801059cf:	8b 45 08             	mov    0x8(%ebp),%eax
801059d2:	8d 50 01             	lea    0x1(%eax),%edx
801059d5:	89 55 08             	mov    %edx,0x8(%ebp)
801059d8:	8b 55 0c             	mov    0xc(%ebp),%edx
801059db:	8d 4a 01             	lea    0x1(%edx),%ecx
801059de:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801059e1:	0f b6 12             	movzbl (%edx),%edx
801059e4:	88 10                	mov    %dl,(%eax)
801059e6:	0f b6 00             	movzbl (%eax),%eax
801059e9:	84 c0                	test   %al,%al
801059eb:	75 d8                	jne    801059c5 <safestrcpy+0x17>
    ;
  *s = 0;
801059ed:	8b 45 08             	mov    0x8(%ebp),%eax
801059f0:	c6 00 00             	movb   $0x0,(%eax)
  return os;
801059f3:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801059f6:	c9                   	leave  
801059f7:	c3                   	ret    
...
801059fb:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
801059fe:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105a05:	eb 04                	jmp    80105a0b <strlen+0x13>
80105a07:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105a0b:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a0e:	8b 45 08             	mov    0x8(%ebp),%eax
80105a11:	01 d0                	add    %edx,%eax
80105a13:	0f b6 00             	movzbl (%eax),%eax
80105a16:	84 c0                	test   %al,%al
80105a18:	75 ed                	jne    80105a07 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105a1f:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105a23:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105a29:	56                   	push   %esi
  pushl %edi
80105a2a:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80105a2b:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105a2d:	89 d4                	mov    %edx,%esp
...
80105a3f:	3b 45 08             	cmp    0x8(%ebp),%eax
80105a42:	76 12                	jbe    80105a56 <fetchint+0x22>
80105a44:	8b 45 08             	mov    0x8(%ebp),%eax
80105a47:	8d 50 04             	lea    0x4(%eax),%edx
80105a4a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a50:	8b 00                	mov    (%eax),%eax
80105a52:	39 c2                	cmp    %eax,%edx
80105a54:	76 07                	jbe    80105a5d <fetchint+0x29>
    return -1;
80105a56:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a5b:	eb 0f                	jmp    80105a6c <fetchint+0x38>
  *ip = *(int*)(addr);
80105a5d:	8b 45 08             	mov    0x8(%ebp),%eax
...
80105a7c:	3b 45 08             	cmp    0x8(%ebp),%eax
80105a7f:	77 07                	ja     80105a88 <fetchstr+0x1a>
    return -1;
80105a81:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a86:	eb 46                	jmp    80105ace <fetchstr+0x60>
  *pp = (char*)addr;
80105a88:	8b 55 08             	mov    0x8(%ebp),%edx
80105a8b:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a8e:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
...
80105aa0:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105aa3:	eb 1c                	jmp    80105ac1 <fetchstr+0x53>
    if(*s == 0)
80105aa5:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105aa8:	0f b6 00             	movzbl (%eax),%eax
80105aab:	84 c0                	test   %al,%al
80105aad:	75 0e                	jne    80105abd <fetchstr+0x4f>
      return s - *pp;
80105aaf:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105ab2:	8b 45 0c             	mov    0xc(%ebp),%eax
80105ab5:	8b 00                	mov    (%eax),%eax
80105ab7:	29 c2                	sub    %eax,%edx
80105ab9:	89 d0                	mov    %edx,%eax
80105abb:	eb 11                	jmp    80105ace <fetchstr+0x60>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
80105abd:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105ac1:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105ac4:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105ac7:	72 dc                	jb     80105aa5 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105af7:	e8 38 ff ff ff       	call   80105a34 <fetchint>
}
80105afc:	c9                   	leave  
80105afd:	c3                   	ret    
...
80105b11:	e8 ba ff ff ff       	call   80105ad0 <argint>
80105b16:	85 c0                	test   %eax,%eax
80105b18:	79 07                	jns    80105b21 <argptr+0x23>
    return -1;
80105b1a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b1f:	eb 3d                	jmp    80105b5e <argptr+0x60>
  if((uint)i >= proc->sz || (uint)i+size > proc->sz)
80105b21:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b24:	89 c2                	mov    %eax,%edx
80105b26:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b2c:	8b 00                	mov    (%eax),%eax
80105b2e:	39 c2                	cmp    %eax,%edx
80105b30:	73 16                	jae    80105b48 <argptr+0x4a>
80105b32:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b35:	89 c2                	mov    %eax,%edx
80105b37:	8b 45 10             	mov    0x10(%ebp),%eax
80105b3a:	01 c2                	add    %eax,%edx
80105b3c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b42:	8b 00                	mov    (%eax),%eax
80105b44:	39 c2                	cmp    %eax,%edx
80105b46:	76 07                	jbe    80105b4f <argptr+0x51>
    return -1;
80105b48:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b4d:	eb 0f                	jmp    80105b5e <argptr+0x60>
  *pp = (char*)i;
80105b4f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b52:	89 c2                	mov    %eax,%edx
80105b54:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b57:	89 10                	mov    %edx,(%eax)
  return 0;
80105b59:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105b5e:	c9                   	leave  
80105b5f:	c3                   	ret    
...
80105b9b:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105b9e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ba4:	8b 40 18             	mov    0x18(%eax),%eax
80105ba7:	8b 40 1c             	mov    0x1c(%eax),%eax
80105baa:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105bad:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bb1:	7e 30                	jle    80105be3 <syscall+0x4c>
80105bb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bb6:	83 f8 19             	cmp    $0x19,%eax
80105bb9:	77 28                	ja     80105be3 <syscall+0x4c>
80105bbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bbe:	8b 04 85 80 c0 10 80 	mov    -0x7fef3f80(,%eax,4),%eax
80105bc5:	85 c0                	test   %eax,%eax
80105bc7:	74 1a                	je     80105be3 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105bc9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bcf:	8b 58 18             	mov    0x18(%eax),%ebx
80105bd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bd5:	8b 04 85 80 c0 10 80 	mov    -0x7fef3f80(,%eax,4),%eax
80105bdc:	ff d0                	call   *%eax
80105bde:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105be1:	eb 3d                	jmp    80105c20 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105be3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105be9:	8d 48 6c             	lea    0x6c(%eax),%ecx
80105bec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105bf2:	8b 40 10             	mov    0x10(%eax),%eax
80105bf5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105bf8:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105bfc:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105c00:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c04:	c7 04 24 9d 8f 10 80 	movl   $0x80108f9d,(%esp)
80105c0b:	e8 90 a7 ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
...
80105c20:	83 c4 24             	add    $0x24,%esp
80105c23:	5b                   	pop    %ebx
80105c24:	5d                   	pop    %ebp
80105c25:	c3                   	ret    
...
80105c39:	e8 92 fe ff ff       	call   80105ad0 <argint>
...
80105cf4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105cfb:	00 
80105cfc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d03:	e8 1e ff ff ff       	call   80105c26 <argfd>
80105d08:	85 c0                	test   %eax,%eax
80105d0a:	79 07                	jns    80105d13 <sys_dup+0x2c>
    return -1;
80105d0c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d11:	eb 29                	jmp    80105d3c <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105d13:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d16:	89 04 24             	mov    %eax,(%esp)
80105d19:	e8 7d ff ff ff       	call   80105c9b <fdalloc>
80105d1e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d21:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d25:	79 07                	jns    80105d2e <sys_dup+0x47>
    return -1;
80105d27:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d2c:	eb 0e                	jmp    80105d3c <sys_dup+0x55>
  filedup(f);
80105d2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d31:	89 04 24             	mov    %eax,(%esp)
80105d34:	e8 5a b2 ff ff       	call   80100f93 <filedup>
  return fd;
...
80105d41:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105d4b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d52:	00 
80105d53:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d5a:	e8 c7 fe ff ff       	call   80105c26 <argfd>
80105d5f:	85 c0                	test   %eax,%eax
80105d61:	78 35                	js     80105d98 <sys_read+0x5a>
80105d63:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105d66:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d6a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105d71:	e8 5a fd ff ff       	call   80105ad0 <argint>
80105d76:	85 c0                	test   %eax,%eax
80105d78:	78 1e                	js     80105d98 <sys_read+0x5a>
...
80105d88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d8f:	e8 6a fd ff ff       	call   80105afe <argptr>
80105d94:	85 c0                	test   %eax,%eax
80105d96:	79 07                	jns    80105d9f <sys_read+0x61>
    return -1;
80105d98:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d9d:	eb 19                	jmp    80105db8 <sys_read+0x7a>
  return fileread(f, p, n);
80105d9f:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105da2:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105da5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105da8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105dac:	89 54 24 04          	mov    %edx,0x4(%esp)
80105db0:	89 04 24             	mov    %eax,(%esp)
80105db3:	e8 48 b3 ff ff       	call   80101100 <fileread>
}
80105db8:	c9                   	leave  
80105db9:	c3                   	ret    
...
80105dbd:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105dc3:	89 44 24 08          	mov    %eax,0x8(%esp)
80105dc7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105dce:	00 
80105dcf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105dd6:	e8 4b fe ff ff       	call   80105c26 <argfd>
80105ddb:	85 c0                	test   %eax,%eax
80105ddd:	78 35                	js     80105e14 <sys_write+0x5a>
80105ddf:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105de2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105de6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105ded:	e8 de fc ff ff       	call   80105ad0 <argint>
80105df2:	85 c0                	test   %eax,%eax
80105df4:	78 1e                	js     80105e14 <sys_write+0x5a>
80105df6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105df9:	89 44 24 08          	mov    %eax,0x8(%esp)
80105dfd:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105e00:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e0b:	e8 ee fc ff ff       	call   80105afe <argptr>
80105e10:	85 c0                	test   %eax,%eax
80105e12:	79 07                	jns    80105e1b <sys_write+0x61>
    return -1;
80105e14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e19:	eb 19                	jmp    80105e34 <sys_write+0x7a>
  return filewrite(f, p, n);
80105e1b:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105e1e:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105e21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e24:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105e28:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e2c:	89 04 24             	mov    %eax,(%esp)
80105e2f:	e8 88 b3 ff ff       	call   801011bc <filewrite>
}
80105e34:	c9                   	leave  
80105e35:	c3                   	ret    
...
80105e8a:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
  
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80105e8d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105e90:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e94:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105e9b:	00 
80105e9c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ea3:	e8 7e fd ff ff       	call   80105c26 <argfd>
80105ea8:	85 c0                	test   %eax,%eax
80105eaa:	78 1f                	js     80105ecb <sys_fstat+0x44>
80105eac:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105eb3:	00 
80105eb4:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105eb7:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ebb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105ec2:	e8 37 fc ff ff       	call   80105afe <argptr>
80105ec7:	85 c0                	test   %eax,%eax
80105ec9:	79 07                	jns    80105ed2 <sys_fstat+0x4b>
    return -1;
80105ecb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ed0:	eb 12                	jmp    80105ee4 <sys_fstat+0x5d>
  return filestat(f, st);
80105ed2:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105ed5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ed8:	89 54 24 04          	mov    %edx,0x4(%esp)
80105edc:	89 04 24             	mov    %eax,(%esp)
80105edf:	e8 cd b1 ff ff       	call   801010b1 <filestat>
}
80105ee4:	c9                   	leave  
80105ee5:	c3                   	ret    
...
80105ee9:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105eec:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105eef:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ef3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105efa:	e8 61 fc ff ff       	call   80105b60 <argstr>
80105eff:	85 c0                	test   %eax,%eax
80105f01:	78 17                	js     80105f1a <sys_link+0x34>
80105f03:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105f06:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f0a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105f11:	e8 4a fc ff ff       	call   80105b60 <argstr>
80105f16:	85 c0                	test   %eax,%eax
80105f18:	79 0a                	jns    80105f24 <sys_link+0x3e>
    return -1;
80105f1a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f1f:	e9 42 01 00 00       	jmp    80106066 <sys_link+0x180>

  begin_op();
80105f24:	e8 f4 d4 ff ff       	call   8010341d <begin_op>
  if((ip = namei(old)) == 0){
80105f29:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105f2c:	89 04 24             	mov    %eax,(%esp)
80105f2f:	e8 df c4 ff ff       	call   80102413 <namei>
80105f34:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f37:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f3b:	75 0f                	jne    80105f4c <sys_link+0x66>
    end_op();
80105f3d:	e8 5f d5 ff ff       	call   801034a1 <end_op>
    return -1;
80105f42:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f47:	e9 1a 01 00 00       	jmp    80106066 <sys_link+0x180>
  }

  ilock(ip);
80105f4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f4f:	89 04 24             	mov    %eax,(%esp)
80105f52:	e8 11 b9 ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105f57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f5a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f5e:	66 83 f8 01          	cmp    $0x1,%ax
80105f62:	75 1a                	jne    80105f7e <sys_link+0x98>
    iunlockput(ip);
80105f64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f67:	89 04 24             	mov    %eax,(%esp)
80105f6a:	e8 7d bb ff ff       	call   80101aec <iunlockput>
    end_op();
80105f6f:	e8 2d d5 ff ff       	call   801034a1 <end_op>
    return -1;
80105f74:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f79:	e9 e8 00 00 00       	jmp    80106066 <sys_link+0x180>
  }

  ip->nlink++;
80105f7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f81:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f85:	8d 50 01             	lea    0x1(%eax),%edx
80105f88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f8b:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105f8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f92:	89 04 24             	mov    %eax,(%esp)
80105f95:	e8 12 b7 ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80105f9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f9d:	89 04 24             	mov    %eax,(%esp)
80105fa0:	e8 11 ba ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105fa5:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105fa8:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105fab:	89 54 24 04          	mov    %edx,0x4(%esp)
80105faf:	89 04 24             	mov    %eax,(%esp)
80105fb2:	e8 7e c4 ff ff       	call   80102435 <nameiparent>
80105fb7:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105fba:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105fbe:	75 02                	jne    80105fc2 <sys_link+0xdc>
    goto bad;
80105fc0:	eb 68                	jmp    8010602a <sys_link+0x144>
  ilock(dp);
80105fc2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fc5:	89 04 24             	mov    %eax,(%esp)
80105fc8:	e8 9b b8 ff ff       	call   80101868 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105fcd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fd0:	8b 10                	mov    (%eax),%edx
80105fd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fd5:	8b 00                	mov    (%eax),%eax
80105fd7:	39 c2                	cmp    %eax,%edx
80105fd9:	75 20                	jne    80105ffb <sys_link+0x115>
80105fdb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fde:	8b 40 04             	mov    0x4(%eax),%eax
80105fe1:	89 44 24 08          	mov    %eax,0x8(%esp)
80105fe5:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105fe8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fec:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fef:	89 04 24             	mov    %eax,(%esp)
80105ff2:	e8 5c c1 ff ff       	call   80102153 <dirlink>
80105ff7:	85 c0                	test   %eax,%eax
80105ff9:	79 0d                	jns    80106008 <sys_link+0x122>
    iunlockput(dp);
80105ffb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ffe:	89 04 24             	mov    %eax,(%esp)
80106001:	e8 e6 ba ff ff       	call   80101aec <iunlockput>
    goto bad;
80106006:	eb 22                	jmp    8010602a <sys_link+0x144>
  }
  iunlockput(dp);
...
80106019:	e8 fd b9 ff ff       	call   80101a1b <iput>

  end_op();
8010601e:	e8 7e d4 ff ff       	call   801034a1 <end_op>

  return 0;
80106023:	b8 00 00 00 00       	mov    $0x0,%eax
80106028:	eb 3c                	jmp    80106066 <sys_link+0x180>

bad:
  ilock(ip);
8010602a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010602d:	89 04 24             	mov    %eax,(%esp)
80106030:	e8 33 b8 ff ff       	call   80101868 <ilock>
  ip->nlink--;
80106035:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106038:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010603c:	8d 50 ff             	lea    -0x1(%eax),%edx
...
8010604c:	e8 5b b6 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106051:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106054:	89 04 24             	mov    %eax,(%esp)
80106057:	e8 90 ba ff ff       	call   80101aec <iunlockput>
  end_op();
...
8010606b:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010606e:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80106075:	eb 4b                	jmp    801060c2 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106077:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010607a:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106081:	00 
80106082:	89 44 24 08          	mov    %eax,0x8(%esp)
80106086:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106089:	89 44 24 04          	mov    %eax,0x4(%esp)
8010608d:	8b 45 08             	mov    0x8(%ebp),%eax
80106090:	89 04 24             	mov    %eax,(%esp)
80106093:	e8 dd bc ff ff       	call   80101d75 <readi>
80106098:	83 f8 10             	cmp    $0x10,%eax
8010609b:	74 0c                	je     801060a9 <isdirempty+0x41>
      panic("isdirempty: readi");
8010609d:	c7 04 24 b9 8f 10 80 	movl   $0x80108fb9,(%esp)
801060a4:	e8 91 a4 ff ff       	call   8010053a <panic>
    if(de.inum != 0)
801060a9:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
801060ad:	66 85 c0             	test   %ax,%ax
801060b0:	74 07                	je     801060b9 <isdirempty+0x51>
      return 0;
801060b2:	b8 00 00 00 00       	mov    $0x0,%eax
801060b7:	eb 1b                	jmp    801060d4 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801060bc:	83 c0 10             	add    $0x10,%eax
...
801060cb:	39 c2                	cmp    %eax,%edx
801060cd:	72 a8                	jb     80106077 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
801060cf:	b8 01 00 00 00       	mov    $0x1,%eax
}
801060d4:	c9                   	leave  
801060d5:	c3                   	ret    
...
801060d9:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801060dc:	8d 45 cc             	lea    -0x34(%ebp),%eax
801060df:	89 44 24 04          	mov    %eax,0x4(%esp)
801060e3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060ea:	e8 71 fa ff ff       	call   80105b60 <argstr>
801060ef:	85 c0                	test   %eax,%eax
801060f1:	79 0a                	jns    801060fd <sys_unlink+0x27>
    return -1;
801060f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060f8:	e9 af 01 00 00       	jmp    801062ac <sys_unlink+0x1d6>

  begin_op();
801060fd:	e8 1b d3 ff ff       	call   8010341d <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80106102:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106105:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80106108:	89 54 24 04          	mov    %edx,0x4(%esp)
8010610c:	89 04 24             	mov    %eax,(%esp)
8010610f:	e8 21 c3 ff ff       	call   80102435 <nameiparent>
80106114:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106117:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010611b:	75 0f                	jne    8010612c <sys_unlink+0x56>
    end_op();
8010611d:	e8 7f d3 ff ff       	call   801034a1 <end_op>
    return -1;
80106122:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106127:	e9 80 01 00 00       	jmp    801062ac <sys_unlink+0x1d6>
  }

  ilock(dp);
8010612c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010612f:	89 04 24             	mov    %eax,(%esp)
80106132:	e8 31 b7 ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106137:	c7 44 24 04 cb 8f 10 	movl   $0x80108fcb,0x4(%esp)
8010613e:	80 
8010613f:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106142:	89 04 24             	mov    %eax,(%esp)
80106145:	e8 1e bf ff ff       	call   80102068 <namecmp>
8010614a:	85 c0                	test   %eax,%eax
8010614c:	0f 84 45 01 00 00    	je     80106297 <sys_unlink+0x1c1>
80106152:	c7 44 24 04 cd 8f 10 	movl   $0x80108fcd,0x4(%esp)
80106159:	80 
8010615a:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010615d:	89 04 24             	mov    %eax,(%esp)
80106160:	e8 03 bf ff ff       	call   80102068 <namecmp>
80106165:	85 c0                	test   %eax,%eax
80106167:	0f 84 2a 01 00 00    	je     80106297 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
8010616d:	8d 45 c8             	lea    -0x38(%ebp),%eax
80106170:	89 44 24 08          	mov    %eax,0x8(%esp)
80106174:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106177:	89 44 24 04          	mov    %eax,0x4(%esp)
8010617b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010617e:	89 04 24             	mov    %eax,(%esp)
80106181:	e8 04 bf ff ff       	call   8010208a <dirlookup>
80106186:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106189:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010618d:	75 05                	jne    80106194 <sys_unlink+0xbe>
    goto bad;
8010618f:	e9 03 01 00 00       	jmp    80106297 <sys_unlink+0x1c1>
  ilock(ip);
80106194:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106197:	89 04 24             	mov    %eax,(%esp)
8010619a:	e8 c9 b6 ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
8010619f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061a2:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801061a6:	66 85 c0             	test   %ax,%ax
801061a9:	7f 0c                	jg     801061b7 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
801061ab:	c7 04 24 d0 8f 10 80 	movl   $0x80108fd0,(%esp)
801061b2:	e8 83 a3 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801061b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061ba:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801061be:	66 83 f8 01          	cmp    $0x1,%ax
801061c2:	75 1f                	jne    801061e3 <sys_unlink+0x10d>
801061c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061c7:	89 04 24             	mov    %eax,(%esp)
801061ca:	e8 99 fe ff ff       	call   80106068 <isdirempty>
801061cf:	85 c0                	test   %eax,%eax
801061d1:	75 10                	jne    801061e3 <sys_unlink+0x10d>
    iunlockput(ip);
801061d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061d6:	89 04 24             	mov    %eax,(%esp)
801061d9:	e8 0e b9 ff ff       	call   80101aec <iunlockput>
    goto bad;
801061de:	e9 b4 00 00 00       	jmp    80106297 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
801061e3:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801061ea:	00 
801061eb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801061f2:	00 
801061f3:	8d 45 e0             	lea    -0x20(%ebp),%eax
801061f6:	89 04 24             	mov    %eax,(%esp)
801061f9:	e8 90 f5 ff ff       	call   8010578e <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801061fe:	8b 45 c8             	mov    -0x38(%ebp),%eax
80106201:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106208:	00 
80106209:	89 44 24 08          	mov    %eax,0x8(%esp)
8010620d:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106210:	89 44 24 04          	mov    %eax,0x4(%esp)
80106214:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106217:	89 04 24             	mov    %eax,(%esp)
8010621a:	e8 ba bc ff ff       	call   80101ed9 <writei>
8010621f:	83 f8 10             	cmp    $0x10,%eax
80106222:	74 0c                	je     80106230 <sys_unlink+0x15a>
    panic("unlink: writei");
80106224:	c7 04 24 e2 8f 10 80 	movl   $0x80108fe2,(%esp)
8010622b:	e8 0a a3 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80106230:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106233:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106237:	66 83 f8 01          	cmp    $0x1,%ax
8010623b:	75 1c                	jne    80106259 <sys_unlink+0x183>
    dp->nlink--;
8010623d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106240:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106244:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80106254:	e8 53 b4 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
...
80106267:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010626b:	8d 50 ff             	lea    -0x1(%eax),%edx
8010626e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106271:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106275:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106278:	89 04 24             	mov    %eax,(%esp)
8010627b:	e8 2c b4 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106280:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106283:	89 04 24             	mov    %eax,(%esp)
80106286:	e8 61 b8 ff ff       	call   80101aec <iunlockput>

  end_op();
8010628b:	e8 11 d2 ff ff       	call   801034a1 <end_op>

  return 0;
80106290:	b8 00 00 00 00       	mov    $0x0,%eax
80106295:	eb 15                	jmp    801062ac <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80106297:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010629a:	89 04 24             	mov    %eax,(%esp)
8010629d:	e8 4a b8 ff ff       	call   80101aec <iunlockput>
  end_op();
801062a2:	e8 fa d1 ff ff       	call   801034a1 <end_op>
  return -1;
...
801062b1:	83 ec 48             	sub    $0x48,%esp
801062b4:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801062b7:	8b 55 10             	mov    0x10(%ebp),%edx
801062ba:	8b 45 14             	mov    0x14(%ebp),%eax
801062bd:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
801062c1:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
801062c5:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801062c9:	8d 45 de             	lea    -0x22(%ebp),%eax
801062cc:	89 44 24 04          	mov    %eax,0x4(%esp)
801062d0:	8b 45 08             	mov    0x8(%ebp),%eax
801062d3:	89 04 24             	mov    %eax,(%esp)
801062d6:	e8 5a c1 ff ff       	call   80102435 <nameiparent>
801062db:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062de:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062e2:	75 0a                	jne    801062ee <create+0x40>
    return 0;
801062e4:	b8 00 00 00 00       	mov    $0x0,%eax
801062e9:	e9 7e 01 00 00       	jmp    8010646c <create+0x1be>
  ilock(dp);
801062ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062f1:	89 04 24             	mov    %eax,(%esp)
801062f4:	e8 6f b5 ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801062f9:	8d 45 ec             	lea    -0x14(%ebp),%eax
801062fc:	89 44 24 08          	mov    %eax,0x8(%esp)
80106300:	8d 45 de             	lea    -0x22(%ebp),%eax
80106303:	89 44 24 04          	mov    %eax,0x4(%esp)
80106307:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010630a:	89 04 24             	mov    %eax,(%esp)
8010630d:	e8 78 bd ff ff       	call   8010208a <dirlookup>
80106312:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106315:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106319:	74 47                	je     80106362 <create+0xb4>
    iunlockput(dp);
8010631b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010631e:	89 04 24             	mov    %eax,(%esp)
80106321:	e8 c6 b7 ff ff       	call   80101aec <iunlockput>
    ilock(ip);
80106326:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106329:	89 04 24             	mov    %eax,(%esp)
8010632c:	e8 37 b5 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106331:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106336:	75 15                	jne    8010634d <create+0x9f>
80106338:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010633b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010633f:	66 83 f8 02          	cmp    $0x2,%ax
80106343:	75 08                	jne    8010634d <create+0x9f>
      return ip;
80106345:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106348:	e9 1f 01 00 00       	jmp    8010646c <create+0x1be>
    iunlockput(ip);
8010634d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106350:	89 04 24             	mov    %eax,(%esp)
80106353:	e8 94 b7 ff ff       	call   80101aec <iunlockput>
    return 0;
80106358:	b8 00 00 00 00       	mov    $0x0,%eax
8010635d:	e9 0a 01 00 00       	jmp    8010646c <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106362:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80106372:	e8 56 b2 ff ff       	call   801015cd <ialloc>
80106377:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010637a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010637e:	75 0c                	jne    8010638c <create+0xde>
    panic("create: ialloc");
80106380:	c7 04 24 f1 8f 10 80 	movl   $0x80108ff1,(%esp)
80106387:	e8 ae a1 ff ff       	call   8010053a <panic>

  ilock(ip);
8010638c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010638f:	89 04 24             	mov    %eax,(%esp)
80106392:	e8 d1 b4 ff ff       	call   80101868 <ilock>
  ip->major = major;
80106397:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010639a:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
8010639e:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
801063a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063a5:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
801063a9:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
801063ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063b0:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
801063b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063b9:	89 04 24             	mov    %eax,(%esp)
801063bc:	e8 eb b2 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801063c1:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801063c6:	75 6a                	jne    80106432 <create+0x184>
    dp->nlink++;  // for ".."
801063c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063cb:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801063cf:	8d 50 01             	lea    0x1(%eax),%edx
801063d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063d5:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
801063d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063dc:	89 04 24             	mov    %eax,(%esp)
801063df:	e8 c8 b2 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801063e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063e7:	8b 40 04             	mov    0x4(%eax),%eax
801063ea:	89 44 24 08          	mov    %eax,0x8(%esp)
801063ee:	c7 44 24 04 cb 8f 10 	movl   $0x80108fcb,0x4(%esp)
801063f5:	80 
801063f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063f9:	89 04 24             	mov    %eax,(%esp)
801063fc:	e8 52 bd ff ff       	call   80102153 <dirlink>
80106401:	85 c0                	test   %eax,%eax
80106403:	78 21                	js     80106426 <create+0x178>
80106405:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106408:	8b 40 04             	mov    0x4(%eax),%eax
8010640b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010640f:	c7 44 24 04 cd 8f 10 	movl   $0x80108fcd,0x4(%esp)
80106416:	80 
80106417:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010641a:	89 04 24             	mov    %eax,(%esp)
8010641d:	e8 31 bd ff ff       	call   80102153 <dirlink>
80106422:	85 c0                	test   %eax,%eax
80106424:	79 0c                	jns    80106432 <create+0x184>
      panic("create dots");
80106426:	c7 04 24 00 90 10 80 	movl   $0x80109000,(%esp)
8010642d:	e8 08 a1 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80106432:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106435:	8b 40 04             	mov    0x4(%eax),%eax
80106438:	89 44 24 08          	mov    %eax,0x8(%esp)
8010643c:	8d 45 de             	lea    -0x22(%ebp),%eax
8010643f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106443:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106446:	89 04 24             	mov    %eax,(%esp)
80106449:	e8 05 bd ff ff       	call   80102153 <dirlink>
8010644e:	85 c0                	test   %eax,%eax
80106450:	79 0c                	jns    8010645e <create+0x1b0>
    panic("create: dirlink");
80106452:	c7 04 24 0c 90 10 80 	movl   $0x8010900c,(%esp)
80106459:	e8 dc a0 ff ff       	call   8010053a <panic>

  iunlockput(dp);
8010645e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106461:	89 04 24             	mov    %eax,(%esp)
80106464:	e8 83 b6 ff ff       	call   80101aec <iunlockput>
...
80106471:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106482:	e8 d9 f6 ff ff       	call   80105b60 <argstr>
80106487:	85 c0                	test   %eax,%eax
80106489:	78 17                	js     801064a2 <sys_open+0x34>
8010648b:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010648e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106492:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106499:	e8 32 f6 ff ff       	call   80105ad0 <argint>
8010649e:	85 c0                	test   %eax,%eax
801064a0:	79 0a                	jns    801064ac <sys_open+0x3e>
    return -1;
801064a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064a7:	e9 5c 01 00 00       	jmp    80106608 <sys_open+0x19a>

  begin_op();
801064ac:	e8 6c cf ff ff       	call   8010341d <begin_op>

  if(omode & O_CREATE){
801064b1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801064b4:	25 00 02 00 00       	and    $0x200,%eax
801064b9:	85 c0                	test   %eax,%eax
801064bb:	74 3b                	je     801064f8 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
801064bd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801064c0:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801064c7:	00 
801064c8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801064cf:	00 
801064d0:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801064d7:	00 
801064d8:	89 04 24             	mov    %eax,(%esp)
801064db:	e8 ce fd ff ff       	call   801062ae <create>
801064e0:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
801064e3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801064e7:	75 6b                	jne    80106554 <sys_open+0xe6>
      end_op();
801064e9:	e8 b3 cf ff ff       	call   801034a1 <end_op>
      return -1;
801064ee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064f3:	e9 10 01 00 00       	jmp    80106608 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
801064f8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801064fb:	89 04 24             	mov    %eax,(%esp)
801064fe:	e8 10 bf ff ff       	call   80102413 <namei>
80106503:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106506:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010650a:	75 0f                	jne    8010651b <sys_open+0xad>
      end_op();
8010650c:	e8 90 cf ff ff       	call   801034a1 <end_op>
      return -1;
80106511:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106516:	e9 ed 00 00 00       	jmp    80106608 <sys_open+0x19a>
    }
    ilock(ip);
8010651b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651e:	89 04 24             	mov    %eax,(%esp)
80106521:	e8 42 b3 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106526:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106529:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010652d:	66 83 f8 01          	cmp    $0x1,%ax
80106531:	75 21                	jne    80106554 <sys_open+0xe6>
80106533:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106536:	85 c0                	test   %eax,%eax
80106538:	74 1a                	je     80106554 <sys_open+0xe6>
      iunlockput(ip);
8010653a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010653d:	89 04 24             	mov    %eax,(%esp)
80106540:	e8 a7 b5 ff ff       	call   80101aec <iunlockput>
      end_op();
80106545:	e8 57 cf ff ff       	call   801034a1 <end_op>
      return -1;
8010654a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010654f:	e9 b4 00 00 00       	jmp    80106608 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106554:	e8 da a9 ff ff       	call   80100f33 <filealloc>
80106559:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010655c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106560:	74 14                	je     80106576 <sys_open+0x108>
80106562:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106565:	89 04 24             	mov    %eax,(%esp)
80106568:	e8 2e f7 ff ff       	call   80105c9b <fdalloc>
8010656d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106570:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106574:	79 28                	jns    8010659e <sys_open+0x130>
    if(f)
80106576:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010657a:	74 0b                	je     80106587 <sys_open+0x119>
      fileclose(f);
8010657c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010657f:	89 04 24             	mov    %eax,(%esp)
80106582:	e8 54 aa ff ff       	call   80100fdb <fileclose>
    iunlockput(ip);
80106587:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010658a:	89 04 24             	mov    %eax,(%esp)
8010658d:	e8 5a b5 ff ff       	call   80101aec <iunlockput>
    end_op();
80106592:	e8 0a cf ff ff       	call   801034a1 <end_op>
    return -1;
80106597:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010659c:	eb 6a                	jmp    80106608 <sys_open+0x19a>
  }
  iunlock(ip);
8010659e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065a1:	89 04 24             	mov    %eax,(%esp)
801065a4:	e8 0d b4 ff ff       	call   801019b6 <iunlock>
  end_op();
801065a9:	e8 f3 ce ff ff       	call   801034a1 <end_op>

  f->type = FD_INODE;
801065ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065b1:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
801065b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065ba:	8b 55 f4             	mov    -0xc(%ebp),%edx
801065bd:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
801065c0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065c3:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
801065ca:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801065cd:	83 e0 01             	and    $0x1,%eax
801065d0:	85 c0                	test   %eax,%eax
801065d2:	0f 94 c0             	sete   %al
801065d5:	89 c2                	mov    %eax,%edx
801065d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065da:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801065dd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801065e0:	83 e0 01             	and    $0x1,%eax
801065e3:	85 c0                	test   %eax,%eax
801065e5:	75 0a                	jne    801065f1 <sys_open+0x183>
801065e7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801065ea:	83 e0 02             	and    $0x2,%eax
801065ed:	85 c0                	test   %eax,%eax
801065ef:	74 07                	je     801065f8 <sys_open+0x18a>
801065f1:	b8 01 00 00 00       	mov    $0x1,%eax
801065f6:	eb 05                	jmp    801065fd <sys_open+0x18f>
801065f8:	b8 00 00 00 00       	mov    $0x0,%eax
801065fd:	89 c2                	mov    %eax,%edx
801065ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106602:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80106605:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80106608:	c9                   	leave  
80106609:	c3                   	ret    
...
8010660d:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106610:	e8 08 ce ff ff       	call   8010341d <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80106615:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106618:	89 44 24 04          	mov    %eax,0x4(%esp)
8010661c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106623:	e8 38 f5 ff ff       	call   80105b60 <argstr>
80106628:	85 c0                	test   %eax,%eax
8010662a:	78 2c                	js     80106658 <sys_mkdir+0x4e>
8010662c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010662f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106636:	00 
80106637:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010663e:	00 
8010663f:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106646:	00 
80106647:	89 04 24             	mov    %eax,(%esp)
8010664a:	e8 5f fc ff ff       	call   801062ae <create>
8010664f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106652:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106656:	75 0c                	jne    80106664 <sys_mkdir+0x5a>
    end_op();
80106658:	e8 44 ce ff ff       	call   801034a1 <end_op>
    return -1;
8010665d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106662:	eb 15                	jmp    80106679 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106664:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106667:	89 04 24             	mov    %eax,(%esp)
8010666a:	e8 7d b4 ff ff       	call   80101aec <iunlockput>
  end_op();
8010666f:	e8 2d ce ff ff       	call   801034a1 <end_op>
  return 0;
...
8010667e:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80106681:	e8 97 cd ff ff       	call   8010341d <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80106686:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106689:	89 44 24 04          	mov    %eax,0x4(%esp)
8010668d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106694:	e8 c7 f4 ff ff       	call   80105b60 <argstr>
80106699:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010669c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066a0:	78 5e                	js     80106700 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
801066a2:	8d 45 e8             	lea    -0x18(%ebp),%eax
801066a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801066a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801066b0:	e8 1b f4 ff ff       	call   80105ad0 <argint>
  char *path;
  int len;
  int major, minor;
...
801066b7:	78 47                	js     80106700 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801066b9:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801066bc:	89 44 24 04          	mov    %eax,0x4(%esp)
801066c0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801066c7:	e8 04 f4 ff ff       	call   80105ad0 <argint>
  int len;
  int major, minor;
...
801066ce:	78 30                	js     80106700 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
801066d0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066d3:	0f bf c8             	movswl %ax,%ecx
801066d6:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066d9:	0f bf d0             	movswl %ax,%edx
801066dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801066df:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801066e3:	89 54 24 08          	mov    %edx,0x8(%esp)
801066e7:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801066ee:	00 
801066ef:	89 04 24             	mov    %eax,(%esp)
801066f2:	e8 b7 fb ff ff       	call   801062ae <create>
801066f7:	89 45 f0             	mov    %eax,-0x10(%ebp)
801066fa:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801066fe:	75 0c                	jne    8010670c <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80106700:	e8 9c cd ff ff       	call   801034a1 <end_op>
    return -1;
80106705:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010670a:	eb 15                	jmp    80106721 <sys_mknod+0xa6>
  }
  iunlockput(ip);
...
80106712:	e8 d5 b3 ff ff       	call   80101aec <iunlockput>
  end_op();
80106717:	e8 85 cd ff ff       	call   801034a1 <end_op>
  return 0;
8010671c:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106721:	c9                   	leave  
80106722:	c3                   	ret    
...
801067cb:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801067d1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801067d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801067d8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067df:	e8 7c f3 ff ff       	call   80105b60 <argstr>
801067e4:	85 c0                	test   %eax,%eax
801067e6:	78 1a                	js     80106802 <sys_exec+0x3a>
...
801067f9:	e8 d2 f2 ff ff       	call   80105ad0 <argint>
801067fe:	85 c0                	test   %eax,%eax
80106800:	79 0a                	jns    8010680c <sys_exec+0x44>
    return -1;
80106802:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106807:	e9 c8 00 00 00       	jmp    801068d4 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
8010680c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106813:	00 
80106814:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010681b:	00 
8010681c:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106822:	89 04 24             	mov    %eax,(%esp)
80106825:	e8 64 ef ff ff       	call   8010578e <memset>
  for(i=0;; i++){
8010682a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106831:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106834:	83 f8 1f             	cmp    $0x1f,%eax
80106837:	76 0a                	jbe    80106843 <sys_exec+0x7b>
      return -1;
80106839:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010683e:	e9 91 00 00 00       	jmp    801068d4 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106843:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106846:	c1 e0 02             	shl    $0x2,%eax
80106849:	89 c2                	mov    %eax,%edx
8010684b:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106851:	01 c2                	add    %eax,%edx
80106853:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106859:	89 44 24 04          	mov    %eax,0x4(%esp)
8010685d:	89 14 24             	mov    %edx,(%esp)
80106860:	e8 cf f1 ff ff       	call   80105a34 <fetchint>
80106865:	85 c0                	test   %eax,%eax
80106867:	79 07                	jns    80106870 <sys_exec+0xa8>
      return -1;
80106869:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010686e:	eb 64                	jmp    801068d4 <sys_exec+0x10c>
    if(uarg == 0){
80106870:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106876:	85 c0                	test   %eax,%eax
80106878:	75 26                	jne    801068a0 <sys_exec+0xd8>
      argv[i] = 0;
...
8010688c:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106892:	89 54 24 04          	mov    %edx,0x4(%esp)
80106896:	89 04 24             	mov    %eax,(%esp)
80106899:	e8 51 a2 ff ff       	call   80100aef <exec>
8010689e:	eb 34                	jmp    801068d4 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
801068a0:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801068a6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801068a9:	c1 e2 02             	shl    $0x2,%edx
801068ac:	01 c2                	add    %eax,%edx
801068ae:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801068b4:	89 54 24 04          	mov    %edx,0x4(%esp)
801068b8:	89 04 24             	mov    %eax,(%esp)
801068bb:	e8 ae f1 ff ff       	call   80105a6e <fetchstr>
801068c0:	85 c0                	test   %eax,%eax
801068c2:	79 07                	jns    801068cb <sys_exec+0x103>
      return -1;
801068c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068c9:	eb 09                	jmp    801068d4 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801068cb:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
801068cf:	e9 5d ff ff ff       	jmp    80106831 <sys_exec+0x69>
  return exec(path, argv);
}
801068d4:	c9                   	leave  
801068d5:	c3                   	ret    
...
801068d9:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801068dc:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801068e3:	00 
801068e4:	8d 45 ec             	lea    -0x14(%ebp),%eax
801068e7:	89 44 24 04          	mov    %eax,0x4(%esp)
801068eb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068f2:	e8 07 f2 ff ff       	call   80105afe <argptr>
801068f7:	85 c0                	test   %eax,%eax
801068f9:	79 0a                	jns    80106905 <sys_pipe+0x2f>
    return -1;
801068fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106900:	e9 9b 00 00 00       	jmp    801069a0 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106905:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106908:	89 44 24 04          	mov    %eax,0x4(%esp)
8010690c:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010690f:	89 04 24             	mov    %eax,(%esp)
80106912:	e8 17 d6 ff ff       	call   80103f2e <pipealloc>
80106917:	85 c0                	test   %eax,%eax
80106919:	79 07                	jns    80106922 <sys_pipe+0x4c>
    return -1;
8010691b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106920:	eb 7e                	jmp    801069a0 <sys_pipe+0xca>
  fd0 = -1;
80106922:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106929:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010692c:	89 04 24             	mov    %eax,(%esp)
8010692f:	e8 67 f3 ff ff       	call   80105c9b <fdalloc>
80106934:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106937:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010693b:	78 14                	js     80106951 <sys_pipe+0x7b>
8010693d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106940:	89 04 24             	mov    %eax,(%esp)
80106943:	e8 53 f3 ff ff       	call   80105c9b <fdalloc>
80106948:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010694b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010694f:	79 37                	jns    80106988 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106951:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106955:	78 14                	js     8010696b <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
...
8010696e:	89 04 24             	mov    %eax,(%esp)
80106971:	e8 65 a6 ff ff       	call   80100fdb <fileclose>
    fileclose(wf);
80106976:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106979:	89 04 24             	mov    %eax,(%esp)
8010697c:	e8 5a a6 ff ff       	call   80100fdb <fileclose>
    return -1;
80106981:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106986:	eb 18                	jmp    801069a0 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106988:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010698b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010698e:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106990:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106993:	8d 50 04             	lea    0x4(%eax),%edx
80106996:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106999:	89 02                	mov    %eax,(%edx)
  return 0;
...
801069a5:	83 ec 08             	sub    $0x8,%esp
  return fork();
801069a8:	e8 a7 dc ff ff       	call   80104654 <fork>
}
801069ad:	c9                   	leave  
801069ae:	c3                   	ret    
...
801069b2:	83 ec 08             	sub    $0x8,%esp
  exit();
801069b5:	e8 3a de ff ff       	call   801047f4 <exit>
...
801069c4:	83 ec 08             	sub    $0x8,%esp
  return wait();
801069c7:	e8 39 df ff ff       	call   80104905 <wait>
}
801069cc:	c9                   	leave  
801069cd:	c3                   	ret    
...
801069e2:	e8 e9 f0 ff ff       	call   80105ad0 <argint>
801069e7:	85 c0                	test   %eax,%eax
801069e9:	79 07                	jns    801069f2 <sys_kill+0x24>
    return -1;
801069eb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069f0:	eb 0b                	jmp    801069fd <sys_kill+0x2f>
  return kill(pid);
801069f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069f5:	89 04 24             	mov    %eax,(%esp)
801069f8:	e8 cb e4 ff ff       	call   80104ec8 <kill>
}
801069fd:	c9                   	leave  
801069fe:	c3                   	ret    
...
80106a08:	8b 40 10             	mov    0x10(%eax),%eax
}
80106a0b:	5d                   	pop    %ebp
80106a0c:	c3                   	ret    
...
80106a10:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80106a13:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106a16:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a1a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a21:	e8 aa f0 ff ff       	call   80105ad0 <argint>
80106a26:	85 c0                	test   %eax,%eax
80106a28:	79 07                	jns    80106a31 <sys_sbrk+0x24>
    return -1;
80106a2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a2f:	eb 24                	jmp    80106a55 <sys_sbrk+0x48>
  addr = proc->sz;
80106a31:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a37:	8b 00                	mov    (%eax),%eax
80106a39:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80106a3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a3f:	89 04 24             	mov    %eax,(%esp)
80106a42:	e8 68 db ff ff       	call   801045af <growproc>
80106a47:	85 c0                	test   %eax,%eax
80106a49:	79 07                	jns    80106a52 <sys_sbrk+0x45>
    return -1;
80106a4b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a50:	eb 03                	jmp    80106a55 <sys_sbrk+0x48>
  return addr;
...
80106a6b:	e8 60 f0 ff ff       	call   80105ad0 <argint>
80106a70:	85 c0                	test   %eax,%eax
80106a72:	79 07                	jns    80106a7b <sys_sleep+0x24>
    return -1;
80106a74:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a79:	eb 6c                	jmp    80106ae7 <sys_sleep+0x90>
  acquire(&tickslock);
80106a7b:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106a82:	e8 b3 ea ff ff       	call   8010553a <acquire>
  ticks0 = ticks;
80106a87:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106a8c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106a8f:	eb 34                	jmp    80106ac5 <sys_sleep+0x6e>
    if(proc->killed){
80106a91:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a97:	8b 40 24             	mov    0x24(%eax),%eax
80106a9a:	85 c0                	test   %eax,%eax
80106a9c:	74 13                	je     80106ab1 <sys_sleep+0x5a>
      release(&tickslock);
80106a9e:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106aa5:	e8 f2 ea ff ff       	call   8010559c <release>
      return -1;
80106aaa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106aaf:	eb 36                	jmp    80106ae7 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106ab1:	c7 44 24 04 c0 a1 11 	movl   $0x8011a1c0,0x4(%esp)
80106ab8:	80 
80106ab9:	c7 04 24 00 aa 11 80 	movl   $0x8011aa00,(%esp)
80106ac0:	e8 de e2 ff ff       	call   80104da3 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106ac5:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106aca:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106acd:	89 c2                	mov    %eax,%edx
80106acf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ad2:	39 c2                	cmp    %eax,%edx
80106ad4:	72 bb                	jb     80106a91 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106ad6:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106add:	e8 ba ea ff ff       	call   8010559c <release>
  return 0;
80106ae2:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106ae7:	c9                   	leave  
80106ae8:	c3                   	ret    
...
80106aec:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106aef:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106af6:	e8 3f ea ff ff       	call   8010553a <acquire>
  xticks = ticks;
80106afb:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106b00:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106b03:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106b0a:	e8 8d ea ff ff       	call   8010559c <release>
  return xticks;
...
80106b1a:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106b21:	00 
80106b22:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b25:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b29:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b30:	e8 c9 ef ff ff       	call   80105afe <argptr>
80106b35:	85 c0                	test   %eax,%eax
80106b37:	79 07                	jns    80106b40 <sys_sigset+0x2c>
    return -1;
80106b39:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b3e:	eb 0b                	jmp    80106b4b <sys_sigset+0x37>
  return (int) sigset(new_handler);
80106b40:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b43:	89 04 24             	mov    %eax,(%esp)
80106b46:	e8 08 e5 ff ff       	call   80105053 <sigset>
}
80106b4b:	c9                   	leave  
80106b4c:	c3                   	ret    

80106b4d <sys_sigsend>:
...
80106b61:	e8 6a ef ff ff       	call   80105ad0 <argint>
80106b66:	85 c0                	test   %eax,%eax
80106b68:	78 17                	js     80106b81 <sys_sigsend+0x34>
80106b6a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b6d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106b78:	e8 53 ef ff ff       	call   80105ad0 <argint>
80106b7d:	85 c0                	test   %eax,%eax
80106b7f:	79 07                	jns    80106b88 <sys_sigsend+0x3b>
    return -1;
80106b81:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b86:	eb 12                	jmp    80106b9a <sys_sigsend+0x4d>
  return sigsend(dest_pid, value);
80106b88:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106b8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b8e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b92:	89 04 24             	mov    %eax,(%esp)
80106b95:	e8 dc e4 ff ff       	call   80105076 <sigsend>
}
80106b9a:	c9                   	leave  
80106b9b:	c3                   	ret    
...
80106b9f:	83 ec 08             	sub    $0x8,%esp
  return sigret();
80106ba2:	e8 47 e5 ff ff       	call   801050ee <sigret>
}
80106ba7:	c9                   	leave  
80106ba8:	c3                   	ret    

80106ba9 <sys_sigpause>:
...
80106bac:	83 ec 08             	sub    $0x8,%esp
  return sigpause();
80106baf:	e8 99 e5 ff ff       	call   8010514d <sigpause>
}
80106bb4:	c9                   	leave  
80106bb5:	c3                   	ret    
...
80106bbc:	8b 55 08             	mov    0x8(%ebp),%edx
80106bbf:	8b 45 0c             	mov    0xc(%ebp),%eax
80106bc2:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106bc6:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106bc9:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106bcd:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106bda:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106be1:	00 
80106be2:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106be9:	e8 c8 ff ff ff       	call   80106bb6 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106bee:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106bf5:	00 
80106bf6:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106bfd:	e8 b4 ff ff ff       	call   80106bb6 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106c02:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106c09:	00 
80106c0a:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106c11:	e8 a0 ff ff ff       	call   80106bb6 <outb>
  picenable(IRQ_TIMER);
80106c16:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c1d:	e8 9f d1 ff ff       	call   80103dc1 <picenable>
}
80106c22:	c9                   	leave  
80106c23:	c3                   	ret    
...
80106c31:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106c33:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106c37:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106c39:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106c3b:	54                   	push   %esp
  call trap
80106c3c:	e8 e1 01 00 00       	call   80106e22 <trap>
  addl $4, %esp
80106c41:	83 c4 04             	add    $0x4,%esp
...
trapret:
  pushl %esp
80106c44:	54                   	push   %esp
  call fix_tf
80106c45:	e8 f0 e6 ff ff       	call   8010533a <fix_tf>
  addl $4, %esp  
80106c4a:	83 c4 04             	add    $0x4,%esp
  popal
80106c4d:	61                   	popa   
  popl %gs
80106c4e:	0f a9                	pop    %gs
  popl %fs
80106c50:	0f a1                	pop    %fs
  popl %es
80106c52:	07                   	pop    %es
  popl %ds
80106c53:	1f                   	pop    %ds
...
80106c95:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
80106c98:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106c9f:	e9 c3 00 00 00       	jmp    80106d67 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106ca4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ca7:	8b 04 85 e8 c0 10 80 	mov    -0x7fef3f18(,%eax,4),%eax
80106cae:	89 c2                	mov    %eax,%edx
80106cb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cb3:	66 89 14 c5 00 a2 11 	mov    %dx,-0x7fee5e00(,%eax,8)
80106cba:	80 
80106cbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cbe:	66 c7 04 c5 02 a2 11 	movw   $0x8,-0x7fee5dfe(,%eax,8)
80106cc5:	80 08 00 
80106cc8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ccb:	0f b6 14 c5 04 a2 11 	movzbl -0x7fee5dfc(,%eax,8),%edx
80106cd2:	80 
80106cd3:	83 e2 e0             	and    $0xffffffe0,%edx
80106cd6:	88 14 c5 04 a2 11 80 	mov    %dl,-0x7fee5dfc(,%eax,8)
80106cdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ce0:	0f b6 14 c5 04 a2 11 	movzbl -0x7fee5dfc(,%eax,8),%edx
80106ce7:	80 
80106ce8:	83 e2 1f             	and    $0x1f,%edx
80106ceb:	88 14 c5 04 a2 11 80 	mov    %dl,-0x7fee5dfc(,%eax,8)
80106cf2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cf5:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106cfc:	80 
80106cfd:	83 e2 f0             	and    $0xfffffff0,%edx
80106d00:	83 ca 0e             	or     $0xe,%edx
80106d03:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106d0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d0d:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106d14:	80 
80106d15:	83 e2 ef             	and    $0xffffffef,%edx
80106d18:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106d1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d22:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106d29:	80 
80106d2a:	83 e2 9f             	and    $0xffffff9f,%edx
80106d2d:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106d34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d37:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106d3e:	80 
80106d3f:	83 ca 80             	or     $0xffffff80,%edx
80106d42:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106d49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d4c:	8b 04 85 e8 c0 10 80 	mov    -0x7fef3f18(,%eax,4),%eax
80106d53:	c1 e8 10             	shr    $0x10,%eax
80106d56:	89 c2                	mov    %eax,%edx
80106d58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d5b:	66 89 14 c5 06 a2 11 	mov    %dx,-0x7fee5dfa(,%eax,8)
80106d62:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106d63:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106d67:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106d6e:	0f 8e 30 ff ff ff    	jle    80106ca4 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106d74:	a1 e8 c1 10 80       	mov    0x8010c1e8,%eax
80106d79:	66 a3 00 a4 11 80    	mov    %ax,0x8011a400
80106d7f:	66 c7 05 02 a4 11 80 	movw   $0x8,0x8011a402
80106d86:	08 00 
80106d88:	0f b6 05 04 a4 11 80 	movzbl 0x8011a404,%eax
80106d8f:	83 e0 e0             	and    $0xffffffe0,%eax
80106d92:	a2 04 a4 11 80       	mov    %al,0x8011a404
80106d97:	0f b6 05 04 a4 11 80 	movzbl 0x8011a404,%eax
80106d9e:	83 e0 1f             	and    $0x1f,%eax
80106da1:	a2 04 a4 11 80       	mov    %al,0x8011a404
80106da6:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106dad:	83 c8 0f             	or     $0xf,%eax
80106db0:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106db5:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106dbc:	83 e0 ef             	and    $0xffffffef,%eax
80106dbf:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106dc4:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106dcb:	83 c8 60             	or     $0x60,%eax
80106dce:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106dd3:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106dda:	83 c8 80             	or     $0xffffff80,%eax
80106ddd:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106de2:	a1 e8 c1 10 80       	mov    0x8010c1e8,%eax
80106de7:	c1 e8 10             	shr    $0x10,%eax
80106dea:	66 a3 06 a4 11 80    	mov    %ax,0x8011a406
  
  initlock(&tickslock, "time");
80106df0:	c7 44 24 04 1c 90 10 	movl   $0x8010901c,0x4(%esp)
80106df7:	80 
80106df8:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106dff:	e8 15 e7 ff ff       	call   80105519 <initlock>
}
80106e04:	c9                   	leave  
80106e05:	c3                   	ret    
...
80106e09:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106e0c:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106e13:	00 
80106e14:	c7 04 24 00 a2 11 80 	movl   $0x8011a200,(%esp)
80106e1b:	e8 38 fe ff ff       	call   80106c58 <lidt>
}
80106e20:	c9                   	leave  
80106e21:	c3                   	ret    
...
80106e28:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106e2b:	8b 45 08             	mov    0x8(%ebp),%eax
80106e2e:	8b 40 30             	mov    0x30(%eax),%eax
80106e31:	83 f8 40             	cmp    $0x40,%eax
80106e34:	75 3f                	jne    80106e75 <trap+0x53>
    if(proc->killed)
80106e36:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e3c:	8b 40 24             	mov    0x24(%eax),%eax
80106e3f:	85 c0                	test   %eax,%eax
80106e41:	74 05                	je     80106e48 <trap+0x26>
      exit();
80106e43:	e8 ac d9 ff ff       	call   801047f4 <exit>
    proc->tf = tf;
80106e48:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e4e:	8b 55 08             	mov    0x8(%ebp),%edx
80106e51:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106e54:	e8 3e ed ff ff       	call   80105b97 <syscall>
    if(proc->killed)
80106e59:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e5f:	8b 40 24             	mov    0x24(%eax),%eax
80106e62:	85 c0                	test   %eax,%eax
80106e64:	74 0a                	je     80106e70 <trap+0x4e>
      exit();
80106e66:	e8 89 d9 ff ff       	call   801047f4 <exit>
    return;
80106e6b:	e9 2d 02 00 00       	jmp    8010709d <trap+0x27b>
80106e70:	e9 28 02 00 00       	jmp    8010709d <trap+0x27b>
  }

  switch(tf->trapno){
80106e75:	8b 45 08             	mov    0x8(%ebp),%eax
80106e78:	8b 40 30             	mov    0x30(%eax),%eax
80106e7b:	83 e8 20             	sub    $0x20,%eax
80106e7e:	83 f8 1f             	cmp    $0x1f,%eax
80106e81:	0f 87 bc 00 00 00    	ja     80106f43 <trap+0x121>
80106e87:	8b 04 85 c4 90 10 80 	mov    -0x7fef6f3c(,%eax,4),%eax
80106e8e:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106e90:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106e96:	0f b6 00             	movzbl (%eax),%eax
80106e99:	84 c0                	test   %al,%al
80106e9b:	75 31                	jne    80106ece <trap+0xac>
      acquire(&tickslock);
80106e9d:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106ea4:	e8 91 e6 ff ff       	call   8010553a <acquire>
      ticks++;
80106ea9:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106eae:	83 c0 01             	add    $0x1,%eax
80106eb1:	a3 00 aa 11 80       	mov    %eax,0x8011aa00
      wakeup(&ticks);
80106eb6:	c7 04 24 00 aa 11 80 	movl   $0x8011aa00,(%esp)
80106ebd:	e8 e9 df ff ff       	call   80104eab <wakeup>
      release(&tickslock);
80106ec2:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106ec9:	e8 ce e6 ff ff       	call   8010559c <release>
    }
    lapiceoi();
80106ece:	e8 0a c0 ff ff       	call   80102edd <lapiceoi>
    break;
80106ed3:	e9 41 01 00 00       	jmp    80107019 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106ed8:	e8 0e b8 ff ff       	call   801026eb <ideintr>
    lapiceoi();
80106edd:	e8 fb bf ff ff       	call   80102edd <lapiceoi>
    break;
80106ee2:	e9 32 01 00 00       	jmp    80107019 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106ee7:	e8 c0 bd ff ff       	call   80102cac <kbdintr>
    lapiceoi();
80106eec:	e8 ec bf ff ff       	call   80102edd <lapiceoi>
    break;
80106ef1:	e9 23 01 00 00       	jmp    80107019 <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106ef6:	e8 97 03 00 00       	call   80107292 <uartintr>
    lapiceoi();
80106efb:	e8 dd bf ff ff       	call   80102edd <lapiceoi>
    break;
80106f00:	e9 14 01 00 00       	jmp    80107019 <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106f05:	8b 45 08             	mov    0x8(%ebp),%eax
80106f08:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
80106f0e:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106f12:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106f15:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106f1b:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80106f21:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106f25:	89 54 24 08          	mov    %edx,0x8(%esp)
80106f29:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f2d:	c7 04 24 24 90 10 80 	movl   $0x80109024,(%esp)
80106f34:	e8 67 94 ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106f39:	e8 9f bf ff ff       	call   80102edd <lapiceoi>
    break;
80106f3e:	e9 d6 00 00 00       	jmp    80107019 <trap+0x1f7>
...
80106f4b:	74 11                	je     80106f5e <trap+0x13c>
80106f4d:	8b 45 08             	mov    0x8(%ebp),%eax
80106f50:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106f54:	0f b7 c0             	movzwl %ax,%eax
80106f57:	83 e0 03             	and    $0x3,%eax
80106f5a:	85 c0                	test   %eax,%eax
80106f5c:	75 46                	jne    80106fa4 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f5e:	e8 1e fd ff ff       	call   80106c81 <rcr2>
80106f63:	8b 55 08             	mov    0x8(%ebp),%edx
80106f66:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106f69:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106f70:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f73:	0f b6 ca             	movzbl %dl,%ecx
80106f76:	8b 55 08             	mov    0x8(%ebp),%edx
80106f79:	8b 52 30             	mov    0x30(%edx),%edx
80106f7c:	89 44 24 10          	mov    %eax,0x10(%esp)
80106f80:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106f84:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106f88:	89 54 24 04          	mov    %edx,0x4(%esp)
80106f8c:	c7 04 24 48 90 10 80 	movl   $0x80109048,(%esp)
80106f93:	e8 08 94 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106f98:	c7 04 24 7a 90 10 80 	movl   $0x8010907a,(%esp)
80106f9f:	e8 96 95 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106fa4:	e8 d8 fc ff ff       	call   80106c81 <rcr2>
80106fa9:	89 c2                	mov    %eax,%edx
80106fab:	8b 45 08             	mov    0x8(%ebp),%eax
80106fae:	8b 78 38             	mov    0x38(%eax),%edi
...
80106fb7:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106fba:	0f b6 f0             	movzbl %al,%esi
80106fbd:	8b 45 08             	mov    0x8(%ebp),%eax
80106fc0:	8b 58 34             	mov    0x34(%eax),%ebx
80106fc3:	8b 45 08             	mov    0x8(%ebp),%eax
80106fc6:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106fc9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106fcf:	83 c0 6c             	add    $0x6c,%eax
...
80106fd5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106fdb:	8b 40 10             	mov    0x10(%eax),%eax
80106fde:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106fe2:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106fe6:	89 74 24 14          	mov    %esi,0x14(%esp)
80106fea:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106fee:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106ff2:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106ff5:	89 74 24 08          	mov    %esi,0x8(%esp)
80106ff9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ffd:	c7 04 24 80 90 10 80 	movl   $0x80109080,(%esp)
80107004:	e8 97 93 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80107009:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010700f:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80107016:	eb 01                	jmp    80107019 <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80107021:	74 24                	je     80107047 <trap+0x225>
80107023:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107029:	8b 40 24             	mov    0x24(%eax),%eax
8010702c:	85 c0                	test   %eax,%eax
8010702e:	74 17                	je     80107047 <trap+0x225>
80107030:	8b 45 08             	mov    0x8(%ebp),%eax
80107033:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107037:	0f b7 c0             	movzwl %ax,%eax
8010703a:	83 e0 03             	and    $0x3,%eax
8010703d:	83 f8 03             	cmp    $0x3,%eax
80107040:	75 05                	jne    80107047 <trap+0x225>
    exit();
80107042:	e8 ad d7 ff ff       	call   801047f4 <exit>
...
8010704f:	74 1e                	je     8010706f <trap+0x24d>
80107051:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107057:	8b 40 0c             	mov    0xc(%eax),%eax
8010705a:	83 f8 04             	cmp    $0x4,%eax
8010705d:	75 10                	jne    8010706f <trap+0x24d>
8010705f:	8b 45 08             	mov    0x8(%ebp),%eax
80107062:	8b 40 30             	mov    0x30(%eax),%eax
80107065:	83 f8 20             	cmp    $0x20,%eax
80107068:	75 05                	jne    8010706f <trap+0x24d>
    yield();
8010706a:	e8 d7 dc ff ff       	call   80104d46 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
8010706f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107075:	85 c0                	test   %eax,%eax
80107077:	74 24                	je     8010709d <trap+0x27b>
80107079:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010707f:	8b 40 24             	mov    0x24(%eax),%eax
80107082:	85 c0                	test   %eax,%eax
80107084:	74 17                	je     8010709d <trap+0x27b>
80107086:	8b 45 08             	mov    0x8(%ebp),%eax
80107089:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010708d:	0f b7 c0             	movzwl %ax,%eax
80107090:	83 e0 03             	and    $0x3,%eax
80107093:	83 f8 03             	cmp    $0x3,%eax
80107096:	75 05                	jne    8010709d <trap+0x27b>
    exit();
80107098:	e8 57 d7 ff ff       	call   801047f4 <exit>
}
8010709d:	83 c4 3c             	add    $0x3c,%esp
801070a0:	5b                   	pop    %ebx
801070a1:	5e                   	pop    %esi
801070a2:	5f                   	pop    %edi
801070a3:	5d                   	pop    %ebp
...
801070a8:	83 ec 14             	sub    $0x14,%esp
801070ab:	8b 45 08             	mov    0x8(%ebp),%eax
801070ae:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801070b2:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
801070b6:	89 c2                	mov    %eax,%edx
801070b8:	ec                   	in     (%dx),%al
801070b9:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
801070bc:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
801070c0:	c9                   	leave  
801070c1:	c3                   	ret    
...
801070c8:	8b 55 08             	mov    0x8(%ebp),%edx
801070cb:	8b 45 0c             	mov    0xc(%ebp),%eax
801070ce:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801070d2:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801070d5:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801070d9:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
801070e3:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
801070e6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801070ed:	00 
801070ee:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801070f5:	e8 c8 ff ff ff       	call   801070c2 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801070fa:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80107101:	00 
80107102:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107109:	e8 b4 ff ff ff       	call   801070c2 <outb>
  outb(COM1+0, 115200/9600);
8010710e:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80107115:	00 
80107116:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010711d:	e8 a0 ff ff ff       	call   801070c2 <outb>
  outb(COM1+1, 0);
80107122:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107129:	00 
8010712a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107131:	e8 8c ff ff ff       	call   801070c2 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107136:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010713d:	00 
8010713e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107145:	e8 78 ff ff ff       	call   801070c2 <outb>
  outb(COM1+4, 0);
8010714a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107151:	00 
80107152:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107159:	e8 64 ff ff ff       	call   801070c2 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010715e:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107165:	00 
80107166:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010716d:	e8 50 ff ff ff       	call   801070c2 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80107172:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107179:	e8 27 ff ff ff       	call   801070a5 <inb>
8010717e:	3c ff                	cmp    $0xff,%al
80107180:	75 02                	jne    80107184 <uartinit+0xa4>
    return;
80107182:	eb 6a                	jmp    801071ee <uartinit+0x10e>
  uart = 1;
80107184:	c7 05 ac c6 10 80 01 	movl   $0x1,0x8010c6ac
8010718b:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
8010718e:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107195:	e8 0b ff ff ff       	call   801070a5 <inb>
  inb(COM1+0);
8010719a:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801071a1:	e8 ff fe ff ff       	call   801070a5 <inb>
  picenable(IRQ_COM1);
801071a6:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801071ad:	e8 0f cc ff ff       	call   80103dc1 <picenable>
  ioapicenable(IRQ_COM1, 0);
801071b2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801071b9:	00 
801071ba:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801071c1:	e8 a4 b7 ff ff       	call   8010296a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801071c6:	c7 45 f4 44 91 10 80 	movl   $0x80109144,-0xc(%ebp)
801071cd:	eb 15                	jmp    801071e4 <uartinit+0x104>
    uartputc(*p);
801071cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071d2:	0f b6 00             	movzbl (%eax),%eax
801071d5:	0f be c0             	movsbl %al,%eax
801071d8:	89 04 24             	mov    %eax,(%esp)
801071db:	e8 10 00 00 00       	call   801071f0 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801071e0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801071e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071e7:	0f b6 00             	movzbl (%eax),%eax
801071ea:	84 c0                	test   %al,%al
801071ec:	75 e1                	jne    801071cf <uartinit+0xef>
    uartputc(*p);
}
801071ee:	c9                   	leave  
801071ef:	c3                   	ret    
...
801071f3:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801071f6:	a1 ac c6 10 80       	mov    0x8010c6ac,%eax
801071fb:	85 c0                	test   %eax,%eax
801071fd:	75 02                	jne    80107201 <uartputc+0x11>
    return;
801071ff:	eb 4b                	jmp    8010724c <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107201:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107208:	eb 10                	jmp    8010721a <uartputc+0x2a>
    microdelay(10);
8010720a:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107211:	e8 ec bc ff ff       	call   80102f02 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107216:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010721a:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
8010721e:	7f 16                	jg     80107236 <uartputc+0x46>
80107220:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107227:	e8 79 fe ff ff       	call   801070a5 <inb>
8010722c:	0f b6 c0             	movzbl %al,%eax
8010722f:	83 e0 20             	and    $0x20,%eax
80107232:	85 c0                	test   %eax,%eax
80107234:	74 d4                	je     8010720a <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80107236:	8b 45 08             	mov    0x8(%ebp),%eax
80107239:	0f b6 c0             	movzbl %al,%eax
8010723c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107240:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107247:	e8 76 fe ff ff       	call   801070c2 <outb>
}
8010724c:	c9                   	leave  
8010724d:	c3                   	ret    
...
80107251:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107254:	a1 ac c6 10 80       	mov    0x8010c6ac,%eax
80107259:	85 c0                	test   %eax,%eax
8010725b:	75 07                	jne    80107264 <uartgetc+0x16>
    return -1;
8010725d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107262:	eb 2c                	jmp    80107290 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107264:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010726b:	e8 35 fe ff ff       	call   801070a5 <inb>
80107270:	0f b6 c0             	movzbl %al,%eax
80107273:	83 e0 01             	and    $0x1,%eax
80107276:	85 c0                	test   %eax,%eax
80107278:	75 07                	jne    80107281 <uartgetc+0x33>
    return -1;
8010727a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010727f:	eb 0f                	jmp    80107290 <uartgetc+0x42>
  return inb(COM1+0);
80107281:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107288:	e8 18 fe ff ff       	call   801070a5 <inb>
8010728d:	0f b6 c0             	movzbl %al,%eax
}
80107290:	c9                   	leave  
80107291:	c3                   	ret    
...
80107298:	c7 04 24 4e 72 10 80 	movl   $0x8010724e,(%esp)
8010729f:	e8 09 95 ff ff       	call   801007ad <consoleintr>
}
801072a4:	c9                   	leave  
801072a5:	c3                   	ret    
...
801072a8:	6a 00                	push   $0x0
  jmp alltraps
801072aa:	e9 75 f9 ff ff       	jmp    80106c24 <alltraps>
...
801072af:	6a 00                	push   $0x0
  pushl $1
801072b1:	6a 01                	push   $0x1
  jmp alltraps
801072b3:	e9 6c f9 ff ff       	jmp    80106c24 <alltraps>
...
801072b8:	6a 00                	push   $0x0
  pushl $2
801072ba:	6a 02                	push   $0x2
  jmp alltraps
801072bc:	e9 63 f9 ff ff       	jmp    80106c24 <alltraps>
...
801072c1:	6a 00                	push   $0x0
  pushl $3
801072c3:	6a 03                	push   $0x3
  jmp alltraps
801072c5:	e9 5a f9 ff ff       	jmp    80106c24 <alltraps>
...
801072ca:	6a 00                	push   $0x0
  pushl $4
801072cc:	6a 04                	push   $0x4
  jmp alltraps
801072ce:	e9 51 f9 ff ff       	jmp    80106c24 <alltraps>
...
801072d3:	6a 00                	push   $0x0
  pushl $5
801072d5:	6a 05                	push   $0x5
  jmp alltraps
801072d7:	e9 48 f9 ff ff       	jmp    80106c24 <alltraps>
...
801072dc:	6a 00                	push   $0x0
  pushl $6
801072de:	6a 06                	push   $0x6
  jmp alltraps
801072e0:	e9 3f f9 ff ff       	jmp    80106c24 <alltraps>
...
801072e5:	6a 00                	push   $0x0
  pushl $7
801072e7:	6a 07                	push   $0x7
  jmp alltraps
801072e9:	e9 36 f9 ff ff       	jmp    80106c24 <alltraps>

801072ee <vector8>:
.globl vector8
vector8:
  pushl $8
801072ee:	6a 08                	push   $0x8
  jmp alltraps
801072f0:	e9 2f f9 ff ff       	jmp    80106c24 <alltraps>
...
801072f5:	6a 00                	push   $0x0
  pushl $9
801072f7:	6a 09                	push   $0x9
  jmp alltraps
801072f9:	e9 26 f9 ff ff       	jmp    80106c24 <alltraps>

801072fe <vector10>:
.globl vector10
vector10:
  pushl $10
801072fe:	6a 0a                	push   $0xa
  jmp alltraps
80107300:	e9 1f f9 ff ff       	jmp    80106c24 <alltraps>

80107305 <vector11>:
.globl vector11
vector11:
  pushl $11
80107305:	6a 0b                	push   $0xb
  jmp alltraps
80107307:	e9 18 f9 ff ff       	jmp    80106c24 <alltraps>

8010730c <vector12>:
.globl vector12
vector12:
  pushl $12
8010730c:	6a 0c                	push   $0xc
  jmp alltraps
8010730e:	e9 11 f9 ff ff       	jmp    80106c24 <alltraps>

80107313 <vector13>:
.globl vector13
vector13:
  pushl $13
80107313:	6a 0d                	push   $0xd
  jmp alltraps
80107315:	e9 0a f9 ff ff       	jmp    80106c24 <alltraps>

8010731a <vector14>:
.globl vector14
vector14:
  pushl $14
8010731a:	6a 0e                	push   $0xe
  jmp alltraps
8010731c:	e9 03 f9 ff ff       	jmp    80106c24 <alltraps>
...
80107321:	6a 00                	push   $0x0
  pushl $15
80107323:	6a 0f                	push   $0xf
  jmp alltraps
80107325:	e9 fa f8 ff ff       	jmp    80106c24 <alltraps>
...
8010732a:	6a 00                	push   $0x0
  pushl $16
8010732c:	6a 10                	push   $0x10
  jmp alltraps
8010732e:	e9 f1 f8 ff ff       	jmp    80106c24 <alltraps>

80107333 <vector17>:
.globl vector17
vector17:
  pushl $17
80107333:	6a 11                	push   $0x11
  jmp alltraps
80107335:	e9 ea f8 ff ff       	jmp    80106c24 <alltraps>
...
8010733a:	6a 00                	push   $0x0
  pushl $18
8010733c:	6a 12                	push   $0x12
  jmp alltraps
8010733e:	e9 e1 f8 ff ff       	jmp    80106c24 <alltraps>
...
80107343:	6a 00                	push   $0x0
  pushl $19
80107345:	6a 13                	push   $0x13
  jmp alltraps
80107347:	e9 d8 f8 ff ff       	jmp    80106c24 <alltraps>
...
8010734c:	6a 00                	push   $0x0
  pushl $20
8010734e:	6a 14                	push   $0x14
  jmp alltraps
80107350:	e9 cf f8 ff ff       	jmp    80106c24 <alltraps>
...
80107355:	6a 00                	push   $0x0
  pushl $21
80107357:	6a 15                	push   $0x15
  jmp alltraps
80107359:	e9 c6 f8 ff ff       	jmp    80106c24 <alltraps>
...
8010735e:	6a 00                	push   $0x0
  pushl $22
80107360:	6a 16                	push   $0x16
  jmp alltraps
80107362:	e9 bd f8 ff ff       	jmp    80106c24 <alltraps>
...
80107367:	6a 00                	push   $0x0
  pushl $23
80107369:	6a 17                	push   $0x17
  jmp alltraps
8010736b:	e9 b4 f8 ff ff       	jmp    80106c24 <alltraps>
...
80107370:	6a 00                	push   $0x0
  pushl $24
80107372:	6a 18                	push   $0x18
  jmp alltraps
80107374:	e9 ab f8 ff ff       	jmp    80106c24 <alltraps>
...
80107379:	6a 00                	push   $0x0
  pushl $25
8010737b:	6a 19                	push   $0x19
  jmp alltraps
8010737d:	e9 a2 f8 ff ff       	jmp    80106c24 <alltraps>
...
80107382:	6a 00                	push   $0x0
  pushl $26
80107384:	6a 1a                	push   $0x1a
  jmp alltraps
80107386:	e9 99 f8 ff ff       	jmp    80106c24 <alltraps>
...
8010738b:	6a 00                	push   $0x0
  pushl $27
8010738d:	6a 1b                	push   $0x1b
  jmp alltraps
8010738f:	e9 90 f8 ff ff       	jmp    80106c24 <alltraps>
...
80107394:	6a 00                	push   $0x0
  pushl $28
80107396:	6a 1c                	push   $0x1c
  jmp alltraps
80107398:	e9 87 f8 ff ff       	jmp    80106c24 <alltraps>
...
8010739d:	6a 00                	push   $0x0
  pushl $29
8010739f:	6a 1d                	push   $0x1d
  jmp alltraps
801073a1:	e9 7e f8 ff ff       	jmp    80106c24 <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $30
801073a8:	6a 1e                	push   $0x1e
  jmp alltraps
801073aa:	e9 75 f8 ff ff       	jmp    80106c24 <alltraps>
...
801073af:	6a 00                	push   $0x0
  pushl $31
801073b1:	6a 1f                	push   $0x1f
  jmp alltraps
801073b3:	e9 6c f8 ff ff       	jmp    80106c24 <alltraps>
...
801073b8:	6a 00                	push   $0x0
  pushl $32
801073ba:	6a 20                	push   $0x20
  jmp alltraps
801073bc:	e9 63 f8 ff ff       	jmp    80106c24 <alltraps>
...
801073c1:	6a 00                	push   $0x0
  pushl $33
801073c3:	6a 21                	push   $0x21
  jmp alltraps
801073c5:	e9 5a f8 ff ff       	jmp    80106c24 <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $34
801073cc:	6a 22                	push   $0x22
  jmp alltraps
801073ce:	e9 51 f8 ff ff       	jmp    80106c24 <alltraps>
...
801073d3:	6a 00                	push   $0x0
  pushl $35
801073d5:	6a 23                	push   $0x23
  jmp alltraps
801073d7:	e9 48 f8 ff ff       	jmp    80106c24 <alltraps>
...
801073dc:	6a 00                	push   $0x0
  pushl $36
801073de:	6a 24                	push   $0x24
  jmp alltraps
801073e0:	e9 3f f8 ff ff       	jmp    80106c24 <alltraps>
...
801073e5:	6a 00                	push   $0x0
  pushl $37
801073e7:	6a 25                	push   $0x25
  jmp alltraps
801073e9:	e9 36 f8 ff ff       	jmp    80106c24 <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $38
801073f0:	6a 26                	push   $0x26
  jmp alltraps
801073f2:	e9 2d f8 ff ff       	jmp    80106c24 <alltraps>
...
801073f7:	6a 00                	push   $0x0
  pushl $39
801073f9:	6a 27                	push   $0x27
  jmp alltraps
801073fb:	e9 24 f8 ff ff       	jmp    80106c24 <alltraps>
...
80107400:	6a 00                	push   $0x0
  pushl $40
80107402:	6a 28                	push   $0x28
  jmp alltraps
80107404:	e9 1b f8 ff ff       	jmp    80106c24 <alltraps>
...
80107409:	6a 00                	push   $0x0
  pushl $41
8010740b:	6a 29                	push   $0x29
  jmp alltraps
8010740d:	e9 12 f8 ff ff       	jmp    80106c24 <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $42
80107414:	6a 2a                	push   $0x2a
  jmp alltraps
80107416:	e9 09 f8 ff ff       	jmp    80106c24 <alltraps>
...
8010741b:	6a 00                	push   $0x0
  pushl $43
8010741d:	6a 2b                	push   $0x2b
  jmp alltraps
8010741f:	e9 00 f8 ff ff       	jmp    80106c24 <alltraps>
...
80107424:	6a 00                	push   $0x0
  pushl $44
80107426:	6a 2c                	push   $0x2c
  jmp alltraps
80107428:	e9 f7 f7 ff ff       	jmp    80106c24 <alltraps>
...
8010742d:	6a 00                	push   $0x0
  pushl $45
8010742f:	6a 2d                	push   $0x2d
  jmp alltraps
80107431:	e9 ee f7 ff ff       	jmp    80106c24 <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $46
80107438:	6a 2e                	push   $0x2e
  jmp alltraps
8010743a:	e9 e5 f7 ff ff       	jmp    80106c24 <alltraps>
...
8010743f:	6a 00                	push   $0x0
  pushl $47
80107441:	6a 2f                	push   $0x2f
  jmp alltraps
80107443:	e9 dc f7 ff ff       	jmp    80106c24 <alltraps>
...
80107448:	6a 00                	push   $0x0
  pushl $48
8010744a:	6a 30                	push   $0x30
  jmp alltraps
8010744c:	e9 d3 f7 ff ff       	jmp    80106c24 <alltraps>
...
80107451:	6a 00                	push   $0x0
  pushl $49
80107453:	6a 31                	push   $0x31
  jmp alltraps
80107455:	e9 ca f7 ff ff       	jmp    80106c24 <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $50
8010745c:	6a 32                	push   $0x32
  jmp alltraps
8010745e:	e9 c1 f7 ff ff       	jmp    80106c24 <alltraps>
...
80107463:	6a 00                	push   $0x0
  pushl $51
80107465:	6a 33                	push   $0x33
  jmp alltraps
80107467:	e9 b8 f7 ff ff       	jmp    80106c24 <alltraps>
...
8010746c:	6a 00                	push   $0x0
  pushl $52
8010746e:	6a 34                	push   $0x34
  jmp alltraps
80107470:	e9 af f7 ff ff       	jmp    80106c24 <alltraps>
...
80107475:	6a 00                	push   $0x0
  pushl $53
80107477:	6a 35                	push   $0x35
  jmp alltraps
80107479:	e9 a6 f7 ff ff       	jmp    80106c24 <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $54
80107480:	6a 36                	push   $0x36
  jmp alltraps
80107482:	e9 9d f7 ff ff       	jmp    80106c24 <alltraps>
...
80107487:	6a 00                	push   $0x0
  pushl $55
80107489:	6a 37                	push   $0x37
  jmp alltraps
8010748b:	e9 94 f7 ff ff       	jmp    80106c24 <alltraps>
...
80107490:	6a 00                	push   $0x0
  pushl $56
80107492:	6a 38                	push   $0x38
  jmp alltraps
80107494:	e9 8b f7 ff ff       	jmp    80106c24 <alltraps>
...
80107499:	6a 00                	push   $0x0
  pushl $57
8010749b:	6a 39                	push   $0x39
  jmp alltraps
8010749d:	e9 82 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074a2:	6a 00                	push   $0x0
  pushl $58
801074a4:	6a 3a                	push   $0x3a
  jmp alltraps
801074a6:	e9 79 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074ab:	6a 00                	push   $0x0
  pushl $59
801074ad:	6a 3b                	push   $0x3b
  jmp alltraps
801074af:	e9 70 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074b4:	6a 00                	push   $0x0
  pushl $60
801074b6:	6a 3c                	push   $0x3c
  jmp alltraps
801074b8:	e9 67 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074bd:	6a 00                	push   $0x0
  pushl $61
801074bf:	6a 3d                	push   $0x3d
  jmp alltraps
801074c1:	e9 5e f7 ff ff       	jmp    80106c24 <alltraps>
...
801074c6:	6a 00                	push   $0x0
  pushl $62
801074c8:	6a 3e                	push   $0x3e
  jmp alltraps
801074ca:	e9 55 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074cf:	6a 00                	push   $0x0
  pushl $63
801074d1:	6a 3f                	push   $0x3f
  jmp alltraps
801074d3:	e9 4c f7 ff ff       	jmp    80106c24 <alltraps>
...
801074d8:	6a 00                	push   $0x0
  pushl $64
801074da:	6a 40                	push   $0x40
  jmp alltraps
801074dc:	e9 43 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074e1:	6a 00                	push   $0x0
  pushl $65
801074e3:	6a 41                	push   $0x41
  jmp alltraps
801074e5:	e9 3a f7 ff ff       	jmp    80106c24 <alltraps>
...
801074ea:	6a 00                	push   $0x0
  pushl $66
801074ec:	6a 42                	push   $0x42
  jmp alltraps
801074ee:	e9 31 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074f3:	6a 00                	push   $0x0
  pushl $67
801074f5:	6a 43                	push   $0x43
  jmp alltraps
801074f7:	e9 28 f7 ff ff       	jmp    80106c24 <alltraps>
...
801074fc:	6a 00                	push   $0x0
  pushl $68
801074fe:	6a 44                	push   $0x44
  jmp alltraps
80107500:	e9 1f f7 ff ff       	jmp    80106c24 <alltraps>
...
80107505:	6a 00                	push   $0x0
  pushl $69
80107507:	6a 45                	push   $0x45
  jmp alltraps
80107509:	e9 16 f7 ff ff       	jmp    80106c24 <alltraps>
...
8010750e:	6a 00                	push   $0x0
  pushl $70
80107510:	6a 46                	push   $0x46
  jmp alltraps
80107512:	e9 0d f7 ff ff       	jmp    80106c24 <alltraps>
...
80107517:	6a 00                	push   $0x0
  pushl $71
80107519:	6a 47                	push   $0x47
  jmp alltraps
8010751b:	e9 04 f7 ff ff       	jmp    80106c24 <alltraps>
...
80107520:	6a 00                	push   $0x0
  pushl $72
80107522:	6a 48                	push   $0x48
  jmp alltraps
80107524:	e9 fb f6 ff ff       	jmp    80106c24 <alltraps>
...
80107529:	6a 00                	push   $0x0
  pushl $73
8010752b:	6a 49                	push   $0x49
  jmp alltraps
8010752d:	e9 f2 f6 ff ff       	jmp    80106c24 <alltraps>
...
80107532:	6a 00                	push   $0x0
  pushl $74
80107534:	6a 4a                	push   $0x4a
  jmp alltraps
80107536:	e9 e9 f6 ff ff       	jmp    80106c24 <alltraps>
...
8010753b:	6a 00                	push   $0x0
  pushl $75
8010753d:	6a 4b                	push   $0x4b
  jmp alltraps
8010753f:	e9 e0 f6 ff ff       	jmp    80106c24 <alltraps>
...
80107544:	6a 00                	push   $0x0
  pushl $76
80107546:	6a 4c                	push   $0x4c
  jmp alltraps
80107548:	e9 d7 f6 ff ff       	jmp    80106c24 <alltraps>
...
8010754d:	6a 00                	push   $0x0
  pushl $77
8010754f:	6a 4d                	push   $0x4d
  jmp alltraps
80107551:	e9 ce f6 ff ff       	jmp    80106c24 <alltraps>
...
80107556:	6a 00                	push   $0x0
  pushl $78
80107558:	6a 4e                	push   $0x4e
  jmp alltraps
8010755a:	e9 c5 f6 ff ff       	jmp    80106c24 <alltraps>
...
8010755f:	6a 00                	push   $0x0
  pushl $79
80107561:	6a 4f                	push   $0x4f
  jmp alltraps
80107563:	e9 bc f6 ff ff       	jmp    80106c24 <alltraps>
...
80107568:	6a 00                	push   $0x0
  pushl $80
8010756a:	6a 50                	push   $0x50
  jmp alltraps
8010756c:	e9 b3 f6 ff ff       	jmp    80106c24 <alltraps>
...
80107571:	6a 00                	push   $0x0
  pushl $81
80107573:	6a 51                	push   $0x51
  jmp alltraps
80107575:	e9 aa f6 ff ff       	jmp    80106c24 <alltraps>
...
8010757a:	6a 00                	push   $0x0
  pushl $82
8010757c:	6a 52                	push   $0x52
  jmp alltraps
8010757e:	e9 a1 f6 ff ff       	jmp    80106c24 <alltraps>
...
80107583:	6a 00                	push   $0x0
  pushl $83
80107585:	6a 53                	push   $0x53
  jmp alltraps
80107587:	e9 98 f6 ff ff       	jmp    80106c24 <alltraps>
...
8010758c:	6a 00                	push   $0x0
  pushl $84
8010758e:	6a 54                	push   $0x54
  jmp alltraps
80107590:	e9 8f f6 ff ff       	jmp    80106c24 <alltraps>
...
80107595:	6a 00                	push   $0x0
  pushl $85
80107597:	6a 55                	push   $0x55
  jmp alltraps
80107599:	e9 86 f6 ff ff       	jmp    80106c24 <alltraps>
...
8010759e:	6a 00                	push   $0x0
  pushl $86
801075a0:	6a 56                	push   $0x56
  jmp alltraps
801075a2:	e9 7d f6 ff ff       	jmp    80106c24 <alltraps>
...
801075a7:	6a 00                	push   $0x0
  pushl $87
801075a9:	6a 57                	push   $0x57
  jmp alltraps
801075ab:	e9 74 f6 ff ff       	jmp    80106c24 <alltraps>
...
801075b0:	6a 00                	push   $0x0
  pushl $88
801075b2:	6a 58                	push   $0x58
  jmp alltraps
801075b4:	e9 6b f6 ff ff       	jmp    80106c24 <alltraps>
...
801075b9:	6a 00                	push   $0x0
  pushl $89
801075bb:	6a 59                	push   $0x59
  jmp alltraps
801075bd:	e9 62 f6 ff ff       	jmp    80106c24 <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $90
801075c4:	6a 5a                	push   $0x5a
  jmp alltraps
801075c6:	e9 59 f6 ff ff       	jmp    80106c24 <alltraps>
...
801075cb:	6a 00                	push   $0x0
  pushl $91
801075cd:	6a 5b                	push   $0x5b
  jmp alltraps
801075cf:	e9 50 f6 ff ff       	jmp    80106c24 <alltraps>
...
801075d4:	6a 00                	push   $0x0
  pushl $92
801075d6:	6a 5c                	push   $0x5c
  jmp alltraps
801075d8:	e9 47 f6 ff ff       	jmp    80106c24 <alltraps>
...
801075dd:	6a 00                	push   $0x0
  pushl $93
801075df:	6a 5d                	push   $0x5d
  jmp alltraps
801075e1:	e9 3e f6 ff ff       	jmp    80106c24 <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $94
801075e8:	6a 5e                	push   $0x5e
  jmp alltraps
801075ea:	e9 35 f6 ff ff       	jmp    80106c24 <alltraps>
...
801075ef:	6a 00                	push   $0x0
  pushl $95
801075f1:	6a 5f                	push   $0x5f
  jmp alltraps
801075f3:	e9 2c f6 ff ff       	jmp    80106c24 <alltraps>
...
801075f8:	6a 00                	push   $0x0
  pushl $96
801075fa:	6a 60                	push   $0x60
  jmp alltraps
801075fc:	e9 23 f6 ff ff       	jmp    80106c24 <alltraps>
...
80107601:	6a 00                	push   $0x0
  pushl $97
80107603:	6a 61                	push   $0x61
  jmp alltraps
80107605:	e9 1a f6 ff ff       	jmp    80106c24 <alltraps>
...
8010760a:	6a 00                	push   $0x0
  pushl $98
8010760c:	6a 62                	push   $0x62
  jmp alltraps
8010760e:	e9 11 f6 ff ff       	jmp    80106c24 <alltraps>
...
80107613:	6a 00                	push   $0x0
  pushl $99
80107615:	6a 63                	push   $0x63
  jmp alltraps
80107617:	e9 08 f6 ff ff       	jmp    80106c24 <alltraps>
...
8010761c:	6a 00                	push   $0x0
  pushl $100
8010761e:	6a 64                	push   $0x64
  jmp alltraps
80107620:	e9 ff f5 ff ff       	jmp    80106c24 <alltraps>
...
80107625:	6a 00                	push   $0x0
  pushl $101
80107627:	6a 65                	push   $0x65
  jmp alltraps
80107629:	e9 f6 f5 ff ff       	jmp    80106c24 <alltraps>
...
8010762e:	6a 00                	push   $0x0
  pushl $102
80107630:	6a 66                	push   $0x66
  jmp alltraps
80107632:	e9 ed f5 ff ff       	jmp    80106c24 <alltraps>
...
80107637:	6a 00                	push   $0x0
  pushl $103
80107639:	6a 67                	push   $0x67
  jmp alltraps
8010763b:	e9 e4 f5 ff ff       	jmp    80106c24 <alltraps>
...
80107640:	6a 00                	push   $0x0
  pushl $104
80107642:	6a 68                	push   $0x68
  jmp alltraps
80107644:	e9 db f5 ff ff       	jmp    80106c24 <alltraps>
...
80107649:	6a 00                	push   $0x0
  pushl $105
8010764b:	6a 69                	push   $0x69
  jmp alltraps
8010764d:	e9 d2 f5 ff ff       	jmp    80106c24 <alltraps>
...
80107652:	6a 00                	push   $0x0
  pushl $106
80107654:	6a 6a                	push   $0x6a
  jmp alltraps
80107656:	e9 c9 f5 ff ff       	jmp    80106c24 <alltraps>
...
8010765b:	6a 00                	push   $0x0
  pushl $107
8010765d:	6a 6b                	push   $0x6b
  jmp alltraps
8010765f:	e9 c0 f5 ff ff       	jmp    80106c24 <alltraps>
...
80107664:	6a 00                	push   $0x0
  pushl $108
80107666:	6a 6c                	push   $0x6c
  jmp alltraps
80107668:	e9 b7 f5 ff ff       	jmp    80106c24 <alltraps>
...
8010766d:	6a 00                	push   $0x0
  pushl $109
8010766f:	6a 6d                	push   $0x6d
  jmp alltraps
80107671:	e9 ae f5 ff ff       	jmp    80106c24 <alltraps>
...
80107676:	6a 00                	push   $0x0
  pushl $110
80107678:	6a 6e                	push   $0x6e
  jmp alltraps
8010767a:	e9 a5 f5 ff ff       	jmp    80106c24 <alltraps>
...
8010767f:	6a 00                	push   $0x0
  pushl $111
80107681:	6a 6f                	push   $0x6f
  jmp alltraps
80107683:	e9 9c f5 ff ff       	jmp    80106c24 <alltraps>
...
80107688:	6a 00                	push   $0x0
  pushl $112
8010768a:	6a 70                	push   $0x70
  jmp alltraps
8010768c:	e9 93 f5 ff ff       	jmp    80106c24 <alltraps>
...
80107691:	6a 00                	push   $0x0
  pushl $113
80107693:	6a 71                	push   $0x71
  jmp alltraps
80107695:	e9 8a f5 ff ff       	jmp    80106c24 <alltraps>
...
8010769a:	6a 00                	push   $0x0
  pushl $114
8010769c:	6a 72                	push   $0x72
  jmp alltraps
8010769e:	e9 81 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076a3:	6a 00                	push   $0x0
  pushl $115
801076a5:	6a 73                	push   $0x73
  jmp alltraps
801076a7:	e9 78 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076ac:	6a 00                	push   $0x0
  pushl $116
801076ae:	6a 74                	push   $0x74
  jmp alltraps
801076b0:	e9 6f f5 ff ff       	jmp    80106c24 <alltraps>
...
801076b5:	6a 00                	push   $0x0
  pushl $117
801076b7:	6a 75                	push   $0x75
  jmp alltraps
801076b9:	e9 66 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076be:	6a 00                	push   $0x0
  pushl $118
801076c0:	6a 76                	push   $0x76
  jmp alltraps
801076c2:	e9 5d f5 ff ff       	jmp    80106c24 <alltraps>
...
801076c7:	6a 00                	push   $0x0
  pushl $119
801076c9:	6a 77                	push   $0x77
  jmp alltraps
801076cb:	e9 54 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076d0:	6a 00                	push   $0x0
  pushl $120
801076d2:	6a 78                	push   $0x78
  jmp alltraps
801076d4:	e9 4b f5 ff ff       	jmp    80106c24 <alltraps>
...
801076d9:	6a 00                	push   $0x0
  pushl $121
801076db:	6a 79                	push   $0x79
  jmp alltraps
801076dd:	e9 42 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076e2:	6a 00                	push   $0x0
  pushl $122
801076e4:	6a 7a                	push   $0x7a
  jmp alltraps
801076e6:	e9 39 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076eb:	6a 00                	push   $0x0
  pushl $123
801076ed:	6a 7b                	push   $0x7b
  jmp alltraps
801076ef:	e9 30 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076f4:	6a 00                	push   $0x0
  pushl $124
801076f6:	6a 7c                	push   $0x7c
  jmp alltraps
801076f8:	e9 27 f5 ff ff       	jmp    80106c24 <alltraps>
...
801076fd:	6a 00                	push   $0x0
  pushl $125
801076ff:	6a 7d                	push   $0x7d
  jmp alltraps
80107701:	e9 1e f5 ff ff       	jmp    80106c24 <alltraps>
...
80107706:	6a 00                	push   $0x0
  pushl $126
80107708:	6a 7e                	push   $0x7e
  jmp alltraps
8010770a:	e9 15 f5 ff ff       	jmp    80106c24 <alltraps>
...
8010770f:	6a 00                	push   $0x0
  pushl $127
80107711:	6a 7f                	push   $0x7f
  jmp alltraps
80107713:	e9 0c f5 ff ff       	jmp    80106c24 <alltraps>
...
80107718:	6a 00                	push   $0x0
  pushl $128
8010771a:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010771f:	e9 00 f5 ff ff       	jmp    80106c24 <alltraps>
...
80107724:	6a 00                	push   $0x0
  pushl $129
80107726:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010772b:	e9 f4 f4 ff ff       	jmp    80106c24 <alltraps>
...
80107730:	6a 00                	push   $0x0
  pushl $130
80107732:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107737:	e9 e8 f4 ff ff       	jmp    80106c24 <alltraps>
...
8010773c:	6a 00                	push   $0x0
  pushl $131
8010773e:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107743:	e9 dc f4 ff ff       	jmp    80106c24 <alltraps>
...
80107748:	6a 00                	push   $0x0
  pushl $132
8010774a:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010774f:	e9 d0 f4 ff ff       	jmp    80106c24 <alltraps>
...
80107754:	6a 00                	push   $0x0
  pushl $133
80107756:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010775b:	e9 c4 f4 ff ff       	jmp    80106c24 <alltraps>
...
80107760:	6a 00                	push   $0x0
  pushl $134
80107762:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107767:	e9 b8 f4 ff ff       	jmp    80106c24 <alltraps>
...
8010776c:	6a 00                	push   $0x0
  pushl $135
8010776e:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107773:	e9 ac f4 ff ff       	jmp    80106c24 <alltraps>
...
80107778:	6a 00                	push   $0x0
  pushl $136
8010777a:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010777f:	e9 a0 f4 ff ff       	jmp    80106c24 <alltraps>
...
80107784:	6a 00                	push   $0x0
  pushl $137
80107786:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010778b:	e9 94 f4 ff ff       	jmp    80106c24 <alltraps>
...
80107790:	6a 00                	push   $0x0
  pushl $138
80107792:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107797:	e9 88 f4 ff ff       	jmp    80106c24 <alltraps>
...
8010779c:	6a 00                	push   $0x0
  pushl $139
8010779e:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801077a3:	e9 7c f4 ff ff       	jmp    80106c24 <alltraps>
...
801077a8:	6a 00                	push   $0x0
  pushl $140
801077aa:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801077af:	e9 70 f4 ff ff       	jmp    80106c24 <alltraps>
...
801077b4:	6a 00                	push   $0x0
  pushl $141
801077b6:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801077bb:	e9 64 f4 ff ff       	jmp    80106c24 <alltraps>
...
801077c0:	6a 00                	push   $0x0
  pushl $142
801077c2:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801077c7:	e9 58 f4 ff ff       	jmp    80106c24 <alltraps>
...
801077cc:	6a 00                	push   $0x0
  pushl $143
801077ce:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801077d3:	e9 4c f4 ff ff       	jmp    80106c24 <alltraps>
...
801077d8:	6a 00                	push   $0x0
  pushl $144
801077da:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801077df:	e9 40 f4 ff ff       	jmp    80106c24 <alltraps>
...
801077e4:	6a 00                	push   $0x0
  pushl $145
801077e6:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801077eb:	e9 34 f4 ff ff       	jmp    80106c24 <alltraps>
...
801077f0:	6a 00                	push   $0x0
  pushl $146
801077f2:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801077f7:	e9 28 f4 ff ff       	jmp    80106c24 <alltraps>
...
801077fc:	6a 00                	push   $0x0
  pushl $147
801077fe:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107803:	e9 1c f4 ff ff       	jmp    80106c24 <alltraps>
...
80107808:	6a 00                	push   $0x0
  pushl $148
8010780a:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010780f:	e9 10 f4 ff ff       	jmp    80106c24 <alltraps>
...
80107814:	6a 00                	push   $0x0
  pushl $149
80107816:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010781b:	e9 04 f4 ff ff       	jmp    80106c24 <alltraps>
...
80107820:	6a 00                	push   $0x0
  pushl $150
80107822:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107827:	e9 f8 f3 ff ff       	jmp    80106c24 <alltraps>
...
8010782c:	6a 00                	push   $0x0
  pushl $151
8010782e:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107833:	e9 ec f3 ff ff       	jmp    80106c24 <alltraps>
...
80107838:	6a 00                	push   $0x0
  pushl $152
8010783a:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010783f:	e9 e0 f3 ff ff       	jmp    80106c24 <alltraps>
...
80107844:	6a 00                	push   $0x0
  pushl $153
80107846:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010784b:	e9 d4 f3 ff ff       	jmp    80106c24 <alltraps>
...
80107850:	6a 00                	push   $0x0
  pushl $154
80107852:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107857:	e9 c8 f3 ff ff       	jmp    80106c24 <alltraps>
...
8010785c:	6a 00                	push   $0x0
  pushl $155
8010785e:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107863:	e9 bc f3 ff ff       	jmp    80106c24 <alltraps>
...
80107868:	6a 00                	push   $0x0
  pushl $156
8010786a:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010786f:	e9 b0 f3 ff ff       	jmp    80106c24 <alltraps>
...
80107874:	6a 00                	push   $0x0
  pushl $157
80107876:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010787b:	e9 a4 f3 ff ff       	jmp    80106c24 <alltraps>
...
80107880:	6a 00                	push   $0x0
  pushl $158
80107882:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107887:	e9 98 f3 ff ff       	jmp    80106c24 <alltraps>
...
8010788c:	6a 00                	push   $0x0
  pushl $159
8010788e:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107893:	e9 8c f3 ff ff       	jmp    80106c24 <alltraps>
...
80107898:	6a 00                	push   $0x0
  pushl $160
8010789a:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010789f:	e9 80 f3 ff ff       	jmp    80106c24 <alltraps>
...
801078a4:	6a 00                	push   $0x0
  pushl $161
801078a6:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801078ab:	e9 74 f3 ff ff       	jmp    80106c24 <alltraps>
...
801078b0:	6a 00                	push   $0x0
  pushl $162
801078b2:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801078b7:	e9 68 f3 ff ff       	jmp    80106c24 <alltraps>
...
801078bc:	6a 00                	push   $0x0
  pushl $163
801078be:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801078c3:	e9 5c f3 ff ff       	jmp    80106c24 <alltraps>
...
801078c8:	6a 00                	push   $0x0
  pushl $164
801078ca:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801078cf:	e9 50 f3 ff ff       	jmp    80106c24 <alltraps>
...
801078d4:	6a 00                	push   $0x0
  pushl $165
801078d6:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801078db:	e9 44 f3 ff ff       	jmp    80106c24 <alltraps>
...
801078e0:	6a 00                	push   $0x0
  pushl $166
801078e2:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801078e7:	e9 38 f3 ff ff       	jmp    80106c24 <alltraps>
...
801078ec:	6a 00                	push   $0x0
  pushl $167
801078ee:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801078f3:	e9 2c f3 ff ff       	jmp    80106c24 <alltraps>
...
801078f8:	6a 00                	push   $0x0
  pushl $168
801078fa:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801078ff:	e9 20 f3 ff ff       	jmp    80106c24 <alltraps>
...
80107904:	6a 00                	push   $0x0
  pushl $169
80107906:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010790b:	e9 14 f3 ff ff       	jmp    80106c24 <alltraps>
...
80107910:	6a 00                	push   $0x0
  pushl $170
80107912:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107917:	e9 08 f3 ff ff       	jmp    80106c24 <alltraps>
...
8010791c:	6a 00                	push   $0x0
  pushl $171
8010791e:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107923:	e9 fc f2 ff ff       	jmp    80106c24 <alltraps>
...
80107928:	6a 00                	push   $0x0
  pushl $172
8010792a:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010792f:	e9 f0 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107934:	6a 00                	push   $0x0
  pushl $173
80107936:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010793b:	e9 e4 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107940:	6a 00                	push   $0x0
  pushl $174
80107942:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107947:	e9 d8 f2 ff ff       	jmp    80106c24 <alltraps>
...
8010794c:	6a 00                	push   $0x0
  pushl $175
8010794e:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107953:	e9 cc f2 ff ff       	jmp    80106c24 <alltraps>
...
80107958:	6a 00                	push   $0x0
  pushl $176
8010795a:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010795f:	e9 c0 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107964:	6a 00                	push   $0x0
  pushl $177
80107966:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010796b:	e9 b4 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107970:	6a 00                	push   $0x0
  pushl $178
80107972:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107977:	e9 a8 f2 ff ff       	jmp    80106c24 <alltraps>
...
8010797c:	6a 00                	push   $0x0
  pushl $179
8010797e:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107983:	e9 9c f2 ff ff       	jmp    80106c24 <alltraps>
...
80107988:	6a 00                	push   $0x0
  pushl $180
8010798a:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010798f:	e9 90 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107994:	6a 00                	push   $0x0
  pushl $181
80107996:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010799b:	e9 84 f2 ff ff       	jmp    80106c24 <alltraps>
...
801079a0:	6a 00                	push   $0x0
  pushl $182
801079a2:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801079a7:	e9 78 f2 ff ff       	jmp    80106c24 <alltraps>
...
801079ac:	6a 00                	push   $0x0
  pushl $183
801079ae:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801079b3:	e9 6c f2 ff ff       	jmp    80106c24 <alltraps>
...
801079b8:	6a 00                	push   $0x0
  pushl $184
801079ba:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801079bf:	e9 60 f2 ff ff       	jmp    80106c24 <alltraps>
...
801079c4:	6a 00                	push   $0x0
  pushl $185
801079c6:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801079cb:	e9 54 f2 ff ff       	jmp    80106c24 <alltraps>
...
801079d0:	6a 00                	push   $0x0
  pushl $186
801079d2:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801079d7:	e9 48 f2 ff ff       	jmp    80106c24 <alltraps>
...
801079dc:	6a 00                	push   $0x0
  pushl $187
801079de:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801079e3:	e9 3c f2 ff ff       	jmp    80106c24 <alltraps>
...
801079e8:	6a 00                	push   $0x0
  pushl $188
801079ea:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801079ef:	e9 30 f2 ff ff       	jmp    80106c24 <alltraps>
...
801079f4:	6a 00                	push   $0x0
  pushl $189
801079f6:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801079fb:	e9 24 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107a00:	6a 00                	push   $0x0
  pushl $190
80107a02:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107a07:	e9 18 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107a0c:	6a 00                	push   $0x0
  pushl $191
80107a0e:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107a13:	e9 0c f2 ff ff       	jmp    80106c24 <alltraps>
...
80107a18:	6a 00                	push   $0x0
  pushl $192
80107a1a:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107a1f:	e9 00 f2 ff ff       	jmp    80106c24 <alltraps>
...
80107a24:	6a 00                	push   $0x0
  pushl $193
80107a26:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107a2b:	e9 f4 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a30:	6a 00                	push   $0x0
  pushl $194
80107a32:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107a37:	e9 e8 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a3c:	6a 00                	push   $0x0
  pushl $195
80107a3e:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107a43:	e9 dc f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a48:	6a 00                	push   $0x0
  pushl $196
80107a4a:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107a4f:	e9 d0 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a54:	6a 00                	push   $0x0
  pushl $197
80107a56:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107a5b:	e9 c4 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a60:	6a 00                	push   $0x0
  pushl $198
80107a62:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107a67:	e9 b8 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a6c:	6a 00                	push   $0x0
  pushl $199
80107a6e:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107a73:	e9 ac f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a78:	6a 00                	push   $0x0
  pushl $200
80107a7a:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107a7f:	e9 a0 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a84:	6a 00                	push   $0x0
  pushl $201
80107a86:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107a8b:	e9 94 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a90:	6a 00                	push   $0x0
  pushl $202
80107a92:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107a97:	e9 88 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107a9c:	6a 00                	push   $0x0
  pushl $203
80107a9e:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107aa3:	e9 7c f1 ff ff       	jmp    80106c24 <alltraps>
...
80107aa8:	6a 00                	push   $0x0
  pushl $204
80107aaa:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107aaf:	e9 70 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107ab4:	6a 00                	push   $0x0
  pushl $205
80107ab6:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107abb:	e9 64 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107ac0:	6a 00                	push   $0x0
  pushl $206
80107ac2:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107ac7:	e9 58 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107acc:	6a 00                	push   $0x0
  pushl $207
80107ace:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107ad3:	e9 4c f1 ff ff       	jmp    80106c24 <alltraps>
...
80107ad8:	6a 00                	push   $0x0
  pushl $208
80107ada:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107adf:	e9 40 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107ae4:	6a 00                	push   $0x0
  pushl $209
80107ae6:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107aeb:	e9 34 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107af0:	6a 00                	push   $0x0
  pushl $210
80107af2:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107af7:	e9 28 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107afc:	6a 00                	push   $0x0
  pushl $211
80107afe:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107b03:	e9 1c f1 ff ff       	jmp    80106c24 <alltraps>
...
80107b08:	6a 00                	push   $0x0
  pushl $212
80107b0a:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107b0f:	e9 10 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107b14:	6a 00                	push   $0x0
  pushl $213
80107b16:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107b1b:	e9 04 f1 ff ff       	jmp    80106c24 <alltraps>
...
80107b20:	6a 00                	push   $0x0
  pushl $214
80107b22:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107b27:	e9 f8 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b2c:	6a 00                	push   $0x0
  pushl $215
80107b2e:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107b33:	e9 ec f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b38:	6a 00                	push   $0x0
  pushl $216
80107b3a:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107b3f:	e9 e0 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b44:	6a 00                	push   $0x0
  pushl $217
80107b46:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107b4b:	e9 d4 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b50:	6a 00                	push   $0x0
  pushl $218
80107b52:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107b57:	e9 c8 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b5c:	6a 00                	push   $0x0
  pushl $219
80107b5e:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107b63:	e9 bc f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b68:	6a 00                	push   $0x0
  pushl $220
80107b6a:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107b6f:	e9 b0 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b74:	6a 00                	push   $0x0
  pushl $221
80107b76:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107b7b:	e9 a4 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b80:	6a 00                	push   $0x0
  pushl $222
80107b82:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107b87:	e9 98 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b8c:	6a 00                	push   $0x0
  pushl $223
80107b8e:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107b93:	e9 8c f0 ff ff       	jmp    80106c24 <alltraps>
...
80107b98:	6a 00                	push   $0x0
  pushl $224
80107b9a:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107b9f:	e9 80 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107ba4:	6a 00                	push   $0x0
  pushl $225
80107ba6:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107bab:	e9 74 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107bb0:	6a 00                	push   $0x0
  pushl $226
80107bb2:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107bb7:	e9 68 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107bbc:	6a 00                	push   $0x0
  pushl $227
80107bbe:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107bc3:	e9 5c f0 ff ff       	jmp    80106c24 <alltraps>
...
80107bc8:	6a 00                	push   $0x0
  pushl $228
80107bca:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107bcf:	e9 50 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107bd4:	6a 00                	push   $0x0
  pushl $229
80107bd6:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107bdb:	e9 44 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107be0:	6a 00                	push   $0x0
  pushl $230
80107be2:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107be7:	e9 38 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107bec:	6a 00                	push   $0x0
  pushl $231
80107bee:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107bf3:	e9 2c f0 ff ff       	jmp    80106c24 <alltraps>
...
80107bf8:	6a 00                	push   $0x0
  pushl $232
80107bfa:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107bff:	e9 20 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107c04:	6a 00                	push   $0x0
  pushl $233
80107c06:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107c0b:	e9 14 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107c10:	6a 00                	push   $0x0
  pushl $234
80107c12:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107c17:	e9 08 f0 ff ff       	jmp    80106c24 <alltraps>
...
80107c1c:	6a 00                	push   $0x0
  pushl $235
80107c1e:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107c23:	e9 fc ef ff ff       	jmp    80106c24 <alltraps>
...
80107c28:	6a 00                	push   $0x0
  pushl $236
80107c2a:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107c2f:	e9 f0 ef ff ff       	jmp    80106c24 <alltraps>
...
80107c34:	6a 00                	push   $0x0
  pushl $237
80107c36:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107c3b:	e9 e4 ef ff ff       	jmp    80106c24 <alltraps>
...
80107c40:	6a 00                	push   $0x0
  pushl $238
80107c42:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107c47:	e9 d8 ef ff ff       	jmp    80106c24 <alltraps>
...
80107c4c:	6a 00                	push   $0x0
  pushl $239
80107c4e:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107c53:	e9 cc ef ff ff       	jmp    80106c24 <alltraps>
...
80107c58:	6a 00                	push   $0x0
  pushl $240
80107c5a:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107c5f:	e9 c0 ef ff ff       	jmp    80106c24 <alltraps>
...
80107c64:	6a 00                	push   $0x0
  pushl $241
80107c66:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107c6b:	e9 b4 ef ff ff       	jmp    80106c24 <alltraps>
...
80107c70:	6a 00                	push   $0x0
  pushl $242
80107c72:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107c77:	e9 a8 ef ff ff       	jmp    80106c24 <alltraps>
...
80107c7c:	6a 00                	push   $0x0
  pushl $243
80107c7e:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107c83:	e9 9c ef ff ff       	jmp    80106c24 <alltraps>
...
80107c88:	6a 00                	push   $0x0
  pushl $244
80107c8a:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107c8f:	e9 90 ef ff ff       	jmp    80106c24 <alltraps>
...
80107c94:	6a 00                	push   $0x0
  pushl $245
80107c96:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107c9b:	e9 84 ef ff ff       	jmp    80106c24 <alltraps>
...
80107ca0:	6a 00                	push   $0x0
  pushl $246
80107ca2:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107ca7:	e9 78 ef ff ff       	jmp    80106c24 <alltraps>
...
80107cac:	6a 00                	push   $0x0
  pushl $247
80107cae:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107cb3:	e9 6c ef ff ff       	jmp    80106c24 <alltraps>
...
80107cb8:	6a 00                	push   $0x0
  pushl $248
80107cba:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107cbf:	e9 60 ef ff ff       	jmp    80106c24 <alltraps>
...
80107cc4:	6a 00                	push   $0x0
  pushl $249
80107cc6:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107ccb:	e9 54 ef ff ff       	jmp    80106c24 <alltraps>
...
80107cd0:	6a 00                	push   $0x0
  pushl $250
80107cd2:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107cd7:	e9 48 ef ff ff       	jmp    80106c24 <alltraps>
...
80107cdc:	6a 00                	push   $0x0
  pushl $251
80107cde:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107ce3:	e9 3c ef ff ff       	jmp    80106c24 <alltraps>
...
80107ce8:	6a 00                	push   $0x0
  pushl $252
80107cea:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107cef:	e9 30 ef ff ff       	jmp    80106c24 <alltraps>
...
80107cf4:	6a 00                	push   $0x0
  pushl $253
80107cf6:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107cfb:	e9 24 ef ff ff       	jmp    80106c24 <alltraps>
...
80107d00:	6a 00                	push   $0x0
  pushl $254
80107d02:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107d07:	e9 18 ef ff ff       	jmp    80106c24 <alltraps>
...
80107d0c:	6a 00                	push   $0x0
  pushl $255
80107d0e:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107d13:	e9 0c ef ff ff       	jmp    80106c24 <alltraps>
...
80107d1b:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107d1e:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d21:	83 e8 01             	sub    $0x1,%eax
80107d24:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107d28:	8b 45 08             	mov    0x8(%ebp),%eax
80107d2b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107d2f:	8b 45 08             	mov    0x8(%ebp),%eax
80107d32:	c1 e8 10             	shr    $0x10,%eax
80107d35:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107d39:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107d3c:	0f 01 10             	lgdtl  (%eax)
}
80107d3f:	c9                   	leave  
80107d40:	c3                   	ret    
...
80107d4a:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107d4e:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107d52:	0f 00 d8             	ltr    %ax
}
80107d55:	c9                   	leave  
80107d56:	c3                   	ret    
...
80107d60:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107d64:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107d68:	8e e8                	mov    %eax,%gs
}
80107d6a:	c9                   	leave  
80107d6b:	c3                   	ret    
...
80107d7d:	05 00 00 00 80       	add    $0x80000000,%eax
80107d82:	5d                   	pop    %ebp
80107d83:	c3                   	ret    
...
80107d95:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107d98:	e8 e8 b0 ff ff       	call   80102e85 <cpunum>
80107d9d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107da3:	05 c0 33 11 80       	add    $0x801133c0,%eax
80107da8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107dab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dae:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107db4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107db7:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107dbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc0:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107dc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107dcb:	83 e2 f0             	and    $0xfffffff0,%edx
80107dce:	83 ca 0a             	or     $0xa,%edx
80107dd1:	88 50 7d             	mov    %dl,0x7d(%eax)
80107dd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dd7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107ddb:	83 ca 10             	or     $0x10,%edx
...
80107e3f:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107e43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e46:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107e4d:	ff ff 
80107e4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e52:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107e59:	00 00 
80107e5b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e5e:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107e65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e68:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
...
80107e7e:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107e85:	83 ca 10             	or     $0x10,%edx
80107e88:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107e8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e91:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107e98:	83 e2 9f             	and    $0xffffff9f,%edx
80107e9b:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107ea1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea4:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107eab:	83 ca 80             	or     $0xffffff80,%edx
80107eae:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
...
80107edd:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ee4:	83 e2 df             	and    $0xffffffdf,%edx
80107ee7:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107eed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ef0:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ef7:	83 ca 40             	or     $0x40,%edx
80107efa:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107f00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f03:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107f0a:	83 ca 80             	or     $0xffffff80,%edx
80107f0d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107f13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f16:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
...
80107ffa:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80108001:	ff ff 
80108003:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108006:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
8010800d:	00 00 
8010800f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108012:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80108019:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010801c:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108023:	83 e2 f0             	and    $0xfffffff0,%edx
80108026:	83 ca 02             	or     $0x2,%edx
80108029:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010802f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108032:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108039:	83 ca 10             	or     $0x10,%edx
8010803c:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108042:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108045:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010804c:	83 ca 60             	or     $0x60,%edx
8010804f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108055:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108058:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010805f:	83 ca 80             	or     $0xffffff80,%edx
80108062:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108068:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010806b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108072:	83 ca 0f             	or     $0xf,%edx
...
80108091:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108098:	83 e2 df             	and    $0xffffffdf,%edx
8010809b:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801080a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a4:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801080ab:	83 ca 40             	or     $0x40,%edx
801080ae:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801080b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b7:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801080be:	83 ca 80             	or     $0xffffff80,%edx
801080c1:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801080c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080ca:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801080d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080d4:	05 b4 00 00 00       	add    $0xb4,%eax
801080d9:	89 c3                	mov    %eax,%ebx
801080db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080de:	05 b4 00 00 00       	add    $0xb4,%eax
801080e3:	c1 e8 10             	shr    $0x10,%eax
801080e6:	89 c1                	mov    %eax,%ecx
801080e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080eb:	05 b4 00 00 00       	add    $0xb4,%eax
801080f0:	c1 e8 18             	shr    $0x18,%eax
801080f3:	89 c2                	mov    %eax,%edx
801080f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080f8:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801080ff:	00 00 
80108101:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108104:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
8010810b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010810e:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80108114:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108117:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010811e:	83 e1 f0             	and    $0xfffffff0,%ecx
80108121:	83 c9 02             	or     $0x2,%ecx
80108124:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010812a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010812d:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108134:	83 c9 10             	or     $0x10,%ecx
80108137:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010813d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108140:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108147:	83 e1 9f             	and    $0xffffff9f,%ecx
8010814a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108150:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108153:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010815a:	83 c9 80             	or     $0xffffff80,%ecx
8010815d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108163:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108166:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010816d:	83 e1 f0             	and    $0xfffffff0,%ecx
...
80108180:	83 e1 ef             	and    $0xffffffef,%ecx
80108183:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108189:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010818c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108193:	83 e1 df             	and    $0xffffffdf,%ecx
80108196:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010819c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819f:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801081a6:	83 c9 40             	or     $0x40,%ecx
801081a9:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801081af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b2:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801081b9:	83 c9 80             	or     $0xffffff80,%ecx
801081bc:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801081c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c5:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
801081cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ce:	83 c0 70             	add    $0x70,%eax
801081d1:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801081d8:	00 
801081d9:	89 04 24             	mov    %eax,(%esp)
801081dc:	e8 37 fb ff ff       	call   80107d18 <lgdt>
  loadgs(SEG_KCPU << 3);
801081e1:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801081e8:	e8 6a fb ff ff       	call   80107d57 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801081ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f0:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801081f6:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801081fd:	00 00 00 00 
}
80108201:	83 c4 24             	add    $0x24,%esp
80108204:	5b                   	pop    %ebx
80108205:	5d                   	pop    %ebp
80108206:	c3                   	ret    
...
80108210:	c1 e8 16             	shr    $0x16,%eax
80108213:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010821a:	8b 45 08             	mov    0x8(%ebp),%eax
8010821d:	01 d0                	add    %edx,%eax
...
8010822c:	74 17                	je     80108245 <walkpgdir+0x3e>
...
8010823b:	e8 44 fb ff ff       	call   80107d84 <p2v>
80108240:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108243:	eb 4b                	jmp    80108290 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108245:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108249:	74 0e                	je     80108259 <walkpgdir+0x52>
8010824b:	e8 9f a8 ff ff       	call   80102aef <kalloc>
80108250:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108253:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108257:	75 07                	jne    80108260 <walkpgdir+0x59>
      return 0;
80108259:	b8 00 00 00 00       	mov    $0x0,%eax
8010825e:	eb 47                	jmp    801082a7 <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80108260:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108267:	00 
80108268:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010826f:	00 
80108270:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108273:	89 04 24             	mov    %eax,(%esp)
80108276:	e8 13 d5 ff ff       	call   8010578e <memset>
...
80108281:	e8 f1 fa ff ff       	call   80107d77 <v2p>
80108286:	83 c8 07             	or     $0x7,%eax
80108289:	89 c2                	mov    %eax,%edx
8010828b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010828e:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80108290:	8b 45 0c             	mov    0xc(%ebp),%eax
80108293:	c1 e8 0c             	shr    $0xc,%eax
80108296:	25 ff 03 00 00       	and    $0x3ff,%eax
8010829b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801082a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a5:	01 d0                	add    %edx,%eax
}
801082a7:	c9                   	leave  
801082a8:	c3                   	ret    
...
801082ac:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
801082e2:	e8 20 ff ff ff       	call   80108207 <walkpgdir>
801082e7:	89 45 ec             	mov    %eax,-0x14(%ebp)
801082ea:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801082ee:	75 07                	jne    801082f7 <mappages+0x4e>
      return -1;
801082f0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801082f5:	eb 48                	jmp    8010833f <mappages+0x96>
    if(*pte & PTE_P)
801082f7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082fa:	8b 00                	mov    (%eax),%eax
801082fc:	83 e0 01             	and    $0x1,%eax
801082ff:	85 c0                	test   %eax,%eax
80108301:	74 0c                	je     8010830f <mappages+0x66>
      panic("remap");
80108303:	c7 04 24 4c 91 10 80 	movl   $0x8010914c,(%esp)
8010830a:	e8 2b 82 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
8010830f:	8b 45 18             	mov    0x18(%ebp),%eax
80108312:	0b 45 14             	or     0x14(%ebp),%eax
80108315:	83 c8 01             	or     $0x1,%eax
80108318:	89 c2                	mov    %eax,%edx
8010831a:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010831d:	89 10                	mov    %edx,(%eax)
    if(a == last)
8010831f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108322:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108325:	75 08                	jne    8010832f <mappages+0x86>
      break;
80108327:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
8010832d:	eb 10                	jmp    8010833f <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
8010832f:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80108336:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
8010833d:	eb 8e                	jmp    801082cd <mappages+0x24>
  return 0;
}
8010833f:	c9                   	leave  
80108340:	c3                   	ret    
...
80108345:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108348:	e8 a2 a7 ff ff       	call   80102aef <kalloc>
8010834d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108350:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108354:	75 0a                	jne    80108360 <setupkvm+0x1f>
    return 0;
80108356:	b8 00 00 00 00       	mov    $0x0,%eax
8010835b:	e9 98 00 00 00       	jmp    801083f8 <setupkvm+0xb7>
...
80108376:	e8 13 d4 ff ff       	call   8010578e <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
8010837b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108382:	e8 fd f9 ff ff       	call   80107d84 <p2v>
80108387:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
8010838c:	76 0c                	jbe    8010839a <setupkvm+0x59>
    panic("PHYSTOP too high");
8010838e:	c7 04 24 52 91 10 80 	movl   $0x80109152,(%esp)
80108395:	e8 a0 81 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010839a:	c7 45 f4 00 c5 10 80 	movl   $0x8010c500,-0xc(%ebp)
801083a1:	eb 49                	jmp    801083ec <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
801083a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083a6:	8b 48 0c             	mov    0xc(%eax),%ecx
801083a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083ac:	8b 50 04             	mov    0x4(%eax),%edx
801083af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083b2:	8b 58 08             	mov    0x8(%eax),%ebx
801083b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083b8:	8b 40 04             	mov    0x4(%eax),%eax
801083bb:	29 c3                	sub    %eax,%ebx
801083bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083c0:	8b 00                	mov    (%eax),%eax
801083c2:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801083c6:	89 54 24 0c          	mov    %edx,0xc(%esp)
801083ca:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801083ce:	89 44 24 04          	mov    %eax,0x4(%esp)
801083d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083d5:	89 04 24             	mov    %eax,(%esp)
801083d8:	e8 cc fe ff ff       	call   801082a9 <mappages>
801083dd:	85 c0                	test   %eax,%eax
801083df:	79 07                	jns    801083e8 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
801083e1:	b8 00 00 00 00       	mov    $0x0,%eax
801083e6:	eb 10                	jmp    801083f8 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801083e8:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801083ec:	81 7d f4 40 c5 10 80 	cmpl   $0x8010c540,-0xc(%ebp)
801083f3:	72 ae                	jb     801083a3 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801083f8:	83 c4 34             	add    $0x34,%esp
801083fb:	5b                   	pop    %ebx
801083fc:	5d                   	pop    %ebp
801083fd:	c3                   	ret    
...
80108401:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108404:	e8 38 ff ff ff       	call   80108341 <setupkvm>
80108409:	a3 58 aa 11 80       	mov    %eax,0x8011aa58
  switchkvm();
8010840e:	e8 02 00 00 00       	call   80108415 <switchkvm>
}
80108413:	c9                   	leave  
80108414:	c3                   	ret    
...
8010841b:	a1 58 aa 11 80       	mov    0x8011aa58,%eax
80108420:	89 04 24             	mov    %eax,(%esp)
80108423:	e8 4f f9 ff ff       	call   80107d77 <v2p>
80108428:	89 04 24             	mov    %eax,(%esp)
8010842b:	e8 3c f9 ff ff       	call   80107d6c <lcr3>
}
80108430:	c9                   	leave  
80108431:	c3                   	ret    
...
80108436:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108439:	e8 50 d2 ff ff       	call   8010568e <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010843e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108444:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010844b:	83 c2 08             	add    $0x8,%edx
8010844e:	89 d3                	mov    %edx,%ebx
80108450:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108457:	83 c2 08             	add    $0x8,%edx
8010845a:	c1 ea 10             	shr    $0x10,%edx
8010845d:	89 d1                	mov    %edx,%ecx
8010845f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108466:	83 c2 08             	add    $0x8,%edx
80108469:	c1 ea 18             	shr    $0x18,%edx
8010846c:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108473:	67 00 
80108475:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010847c:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108482:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108489:	83 e1 f0             	and    $0xfffffff0,%ecx
8010848c:	83 c9 09             	or     $0x9,%ecx
8010848f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108495:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010849c:	83 c9 10             	or     $0x10,%ecx
8010849f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801084a5:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801084ac:	83 e1 9f             	and    $0xffffff9f,%ecx
801084af:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801084b5:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801084bc:	83 c9 80             	or     $0xffffff80,%ecx
801084bf:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801084c5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084cc:	83 e1 f0             	and    $0xfffffff0,%ecx
801084cf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084d5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084dc:	83 e1 ef             	and    $0xffffffef,%ecx
801084df:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084e5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084ec:	83 e1 df             	and    $0xffffffdf,%ecx
801084ef:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084f5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084fc:	83 c9 40             	or     $0x40,%ecx
801084ff:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108505:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010850c:	83 e1 7f             	and    $0x7f,%ecx
8010850f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108515:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
8010851b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108521:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80108528:	83 e2 ef             	and    $0xffffffef,%edx
8010852b:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80108531:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108537:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
8010853d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108543:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010854a:	8b 52 08             	mov    0x8(%edx),%edx
8010854d:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108553:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108556:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010855d:	e8 df f7 ff ff       	call   80107d41 <ltr>
  if(p->pgdir == 0)
80108562:	8b 45 08             	mov    0x8(%ebp),%eax
80108565:	8b 40 04             	mov    0x4(%eax),%eax
80108568:	85 c0                	test   %eax,%eax
8010856a:	75 0c                	jne    80108578 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010856c:	c7 04 24 63 91 10 80 	movl   $0x80109163,(%esp)
80108573:	e8 c2 7f ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108578:	8b 45 08             	mov    0x8(%ebp),%eax
8010857b:	8b 40 04             	mov    0x4(%eax),%eax
8010857e:	89 04 24             	mov    %eax,(%esp)
80108581:	e8 f1 f7 ff ff       	call   80107d77 <v2p>
80108586:	89 04 24             	mov    %eax,(%esp)
80108589:	e8 de f7 ff ff       	call   80107d6c <lcr3>
  popcli();
8010858e:	e8 3f d1 ff ff       	call   801056d2 <popcli>
}
80108593:	83 c4 14             	add    $0x14,%esp
80108596:	5b                   	pop    %ebx
80108597:	5d                   	pop    %ebp
80108598:	c3                   	ret    
...
8010859c:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010859f:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801085a6:	76 0c                	jbe    801085b4 <inituvm+0x1b>
    panic("inituvm: more than a page");
801085a8:	c7 04 24 77 91 10 80 	movl   $0x80109177,(%esp)
801085af:	e8 86 7f ff ff       	call   8010053a <panic>
  mem = kalloc();
801085b4:	e8 36 a5 ff ff       	call   80102aef <kalloc>
...
801085d2:	e8 b7 d1 ff ff       	call   8010578e <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801085d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085da:	89 04 24             	mov    %eax,(%esp)
801085dd:	e8 95 f7 ff ff       	call   80107d77 <v2p>
801085e2:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801085e9:	00 
801085ea:	89 44 24 0c          	mov    %eax,0xc(%esp)
801085ee:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801085f5:	00 
801085f6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801085fd:	00 
801085fe:	8b 45 08             	mov    0x8(%ebp),%eax
80108601:	89 04 24             	mov    %eax,(%esp)
80108604:	e8 a0 fc ff ff       	call   801082a9 <mappages>
  memmove(mem, init, sz);
80108609:	8b 45 10             	mov    0x10(%ebp),%eax
8010860c:	89 44 24 08          	mov    %eax,0x8(%esp)
80108610:	8b 45 0c             	mov    0xc(%ebp),%eax
80108613:	89 44 24 04          	mov    %eax,0x4(%esp)
80108617:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010861a:	89 04 24             	mov    %eax,(%esp)
8010861d:	e8 3b d2 ff ff       	call   8010585d <memmove>
}
80108622:	c9                   	leave  
80108623:	c3                   	ret    
...
8010862e:	25 ff 0f 00 00       	and    $0xfff,%eax
80108633:	85 c0                	test   %eax,%eax
80108635:	74 0c                	je     80108643 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108637:	c7 04 24 94 91 10 80 	movl   $0x80109194,(%esp)
8010863e:	e8 f7 7e ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108643:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010864a:	e9 a9 00 00 00       	jmp    801086f8 <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010864f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108652:	8b 55 0c             	mov    0xc(%ebp),%edx
...
80108669:	e8 99 fb ff ff       	call   80108207 <walkpgdir>
8010866e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108671:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108675:	75 0c                	jne    80108683 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108677:	c7 04 24 b7 91 10 80 	movl   $0x801091b7,(%esp)
8010867e:	e8 b7 7e ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80108683:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108686:	8b 00                	mov    (%eax),%eax
80108688:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010868d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108690:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108693:	8b 55 18             	mov    0x18(%ebp),%edx
80108696:	29 c2                	sub    %eax,%edx
80108698:	89 d0                	mov    %edx,%eax
8010869a:	3d ff 0f 00 00       	cmp    $0xfff,%eax
8010869f:	77 0f                	ja     801086b0 <loaduvm+0x8c>
      n = sz - i;
801086a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086a4:	8b 55 18             	mov    0x18(%ebp),%edx
801086a7:	29 c2                	sub    %eax,%edx
801086a9:	89 d0                	mov    %edx,%eax
801086ab:	89 45 f0             	mov    %eax,-0x10(%ebp)
801086ae:	eb 07                	jmp    801086b7 <loaduvm+0x93>
    else
      n = PGSIZE;
801086b0:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801086b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086ba:	8b 55 14             	mov    0x14(%ebp),%edx
801086bd:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801086c0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801086c3:	89 04 24             	mov    %eax,(%esp)
801086c6:	e8 b9 f6 ff ff       	call   80107d84 <p2v>
801086cb:	8b 55 f0             	mov    -0x10(%ebp),%edx
801086ce:	89 54 24 0c          	mov    %edx,0xc(%esp)
801086d2:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801086d6:	89 44 24 04          	mov    %eax,0x4(%esp)
801086da:	8b 45 10             	mov    0x10(%ebp),%eax
801086dd:	89 04 24             	mov    %eax,(%esp)
801086e0:	e8 90 96 ff ff       	call   80101d75 <readi>
801086e5:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801086e8:	74 07                	je     801086f1 <loaduvm+0xcd>
      return -1;
801086ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801086ef:	eb 18                	jmp    80108709 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
801086fb:	3b 45 18             	cmp    0x18(%ebp),%eax
801086fe:	0f 82 4b ff ff ff    	jb     8010864f <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108712:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
80108715:	8b 45 10             	mov    0x10(%ebp),%eax
80108718:	85 c0                	test   %eax,%eax
8010871a:	79 0a                	jns    80108726 <allocuvm+0x17>
    return 0;
8010871c:	b8 00 00 00 00       	mov    $0x0,%eax
80108721:	e9 c1 00 00 00       	jmp    801087e7 <allocuvm+0xd8>
  if(newsz < oldsz)
80108726:	8b 45 10             	mov    0x10(%ebp),%eax
80108729:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010872c:	73 08                	jae    80108736 <allocuvm+0x27>
    return oldsz;
8010872e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108731:	e9 b1 00 00 00       	jmp    801087e7 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108736:	8b 45 0c             	mov    0xc(%ebp),%eax
80108739:	05 ff 0f 00 00       	add    $0xfff,%eax
8010873e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108743:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108746:	e9 8d 00 00 00       	jmp    801087d8 <allocuvm+0xc9>
    mem = kalloc();
8010874b:	e8 9f a3 ff ff       	call   80102aef <kalloc>
80108750:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108753:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108757:	75 2c                	jne    80108785 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108759:	c7 04 24 d5 91 10 80 	movl   $0x801091d5,(%esp)
80108760:	e8 3b 7c ff ff       	call   801003a0 <cprintf>
...
80108779:	e8 6b 00 00 00       	call   801087e9 <deallocuvm>
      return 0;
8010877e:	b8 00 00 00 00       	mov    $0x0,%eax
80108783:	eb 62                	jmp    801087e7 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108785:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010878c:	00 
8010878d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108794:	00 
80108795:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108798:	89 04 24             	mov    %eax,(%esp)
8010879b:	e8 ee cf ff ff       	call   8010578e <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801087a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087a3:	89 04 24             	mov    %eax,(%esp)
801087a6:	e8 cc f5 ff ff       	call   80107d77 <v2p>
801087ab:	8b 55 f4             	mov    -0xc(%ebp),%edx
801087ae:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801087b5:	00 
801087b6:	89 44 24 0c          	mov    %eax,0xc(%esp)
801087ba:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801087c1:	00 
801087c2:	89 54 24 04          	mov    %edx,0x4(%esp)
801087c6:	8b 45 08             	mov    0x8(%ebp),%eax
801087c9:	89 04 24             	mov    %eax,(%esp)
801087cc:	e8 d8 fa ff ff       	call   801082a9 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
801087db:	3b 45 10             	cmp    0x10(%ebp),%eax
801087de:	0f 82 67 ff ff ff    	jb     8010874b <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801087f2:	3b 45 0c             	cmp    0xc(%ebp),%eax
801087f5:	72 08                	jb     801087ff <deallocuvm+0x16>
    return oldsz;
801087f7:	8b 45 0c             	mov    0xc(%ebp),%eax
801087fa:	e9 a4 00 00 00       	jmp    801088a3 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801087ff:	8b 45 10             	mov    0x10(%ebp),%eax
80108802:	05 ff 0f 00 00       	add    $0xfff,%eax
80108807:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010880c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010880f:	e9 80 00 00 00       	jmp    80108894 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108814:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108817:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010881e:	00 
8010881f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108823:	8b 45 08             	mov    0x8(%ebp),%eax
80108826:	89 04 24             	mov    %eax,(%esp)
80108829:	e8 d9 f9 ff ff       	call   80108207 <walkpgdir>
8010882e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108831:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108835:	75 09                	jne    80108840 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108837:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
8010883e:	eb 4d                	jmp    8010888d <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108840:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108843:	8b 00                	mov    (%eax),%eax
80108845:	83 e0 01             	and    $0x1,%eax
80108848:	85 c0                	test   %eax,%eax
8010884a:	74 41                	je     8010888d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010884c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010884f:	8b 00                	mov    (%eax),%eax
80108851:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108856:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108859:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010885d:	75 0c                	jne    8010886b <deallocuvm+0x82>
        panic("kfree");
8010885f:	c7 04 24 ed 91 10 80 	movl   $0x801091ed,(%esp)
80108866:	e8 cf 7c ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
8010886b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010886e:	89 04 24             	mov    %eax,(%esp)
80108871:	e8 0e f5 ff ff       	call   80107d84 <p2v>
80108876:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108879:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010887c:	89 04 24             	mov    %eax,(%esp)
8010887f:	e8 d2 a1 ff ff       	call   80102a56 <kfree>
      *pte = 0;
80108884:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108887:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
8010889a:	0f 82 74 ff ff ff    	jb     80108814 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801088a8:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
801088ab:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801088af:	75 0c                	jne    801088bd <freevm+0x18>
    panic("freevm: no pgdir");
801088b1:	c7 04 24 f3 91 10 80 	movl   $0x801091f3,(%esp)
801088b8:	e8 7d 7c ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801088bd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801088c4:	00 
801088c5:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801088cc:	80 
801088cd:	8b 45 08             	mov    0x8(%ebp),%eax
801088d0:	89 04 24             	mov    %eax,(%esp)
801088d3:	e8 11 ff ff ff       	call   801087e9 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801088d8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801088df:	eb 48                	jmp    80108929 <freevm+0x84>
    if(pgdir[i] & PTE_P){
801088e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088e4:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801088eb:	8b 45 08             	mov    0x8(%ebp),%eax
801088ee:	01 d0                	add    %edx,%eax
801088f0:	8b 00                	mov    (%eax),%eax
801088f2:	83 e0 01             	and    $0x1,%eax
801088f5:	85 c0                	test   %eax,%eax
801088f7:	74 2c                	je     80108925 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801088f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088fc:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108903:	8b 45 08             	mov    0x8(%ebp),%eax
80108906:	01 d0                	add    %edx,%eax
80108908:	8b 00                	mov    (%eax),%eax
8010890a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010890f:	89 04 24             	mov    %eax,(%esp)
80108912:	e8 6d f4 ff ff       	call   80107d84 <p2v>
80108917:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
8010891a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010891d:	89 04 24             	mov    %eax,(%esp)
80108920:	e8 31 a1 ff ff       	call   80102a56 <kfree>
  uint i;
...
80108930:	76 af                	jbe    801088e1 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108938:	e8 19 a1 ff ff       	call   80102a56 <kfree>
}
8010893d:	c9                   	leave  
8010893e:	c3                   	ret    
...
80108989:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010898c:	e8 b0 f9 ff ff       	call   80108341 <setupkvm>
80108991:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108994:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108998:	75 0a                	jne    801089a4 <copyuvm+0x1f>
    return 0;
8010899a:	b8 00 00 00 00       	mov    $0x0,%eax
8010899f:	e9 fd 00 00 00       	jmp    80108aa1 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
801089a4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801089ab:	e9 d0 00 00 00       	jmp    80108a80 <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801089b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089b3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801089ba:	00 
801089bb:	89 44 24 04          	mov    %eax,0x4(%esp)
801089bf:	8b 45 08             	mov    0x8(%ebp),%eax
801089c2:	89 04 24             	mov    %eax,(%esp)
801089c5:	e8 3d f8 ff ff       	call   80108207 <walkpgdir>
801089ca:	89 45 ec             	mov    %eax,-0x14(%ebp)
801089cd:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801089d1:	75 0c                	jne    801089df <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801089d3:	c7 04 24 0e 92 10 80 	movl   $0x8010920e,(%esp)
801089da:	e8 5b 7b ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
801089df:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089e2:	8b 00                	mov    (%eax),%eax
801089e4:	83 e0 01             	and    $0x1,%eax
801089e7:	85 c0                	test   %eax,%eax
801089e9:	75 0c                	jne    801089f7 <copyuvm+0x72>
      panic("copyuvm: page not present");
801089eb:	c7 04 24 28 92 10 80 	movl   $0x80109228,(%esp)
801089f2:	e8 43 7b ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
801089f7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089fa:	8b 00                	mov    (%eax),%eax
801089fc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a01:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
80108a04:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a07:	8b 00                	mov    (%eax),%eax
80108a09:	25 ff 0f 00 00       	and    $0xfff,%eax
80108a0e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108a11:	e8 d9 a0 ff ff       	call   80102aef <kalloc>
80108a16:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108a19:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108a1d:	75 02                	jne    80108a21 <copyuvm+0x9c>
      goto bad;
80108a1f:	eb 70                	jmp    80108a91 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108a21:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a24:	89 04 24             	mov    %eax,(%esp)
80108a27:	e8 58 f3 ff ff       	call   80107d84 <p2v>
80108a2c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108a33:	00 
80108a34:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a38:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108a3b:	89 04 24             	mov    %eax,(%esp)
80108a3e:	e8 1a ce ff ff       	call   8010585d <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108a43:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108a46:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108a49:	89 04 24             	mov    %eax,(%esp)
80108a4c:	e8 26 f3 ff ff       	call   80107d77 <v2p>
80108a51:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108a54:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108a58:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108a5c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108a63:	00 
80108a64:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a68:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a6b:	89 04 24             	mov    %eax,(%esp)
80108a6e:	e8 36 f8 ff ff       	call   801082a9 <mappages>
80108a73:	85 c0                	test   %eax,%eax
80108a75:	79 02                	jns    80108a79 <copyuvm+0xf4>
      goto bad;
80108a77:	eb 18                	jmp    80108a91 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108a79:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108a80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a83:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108a86:	0f 82 24 ff ff ff    	jb     801089b0 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108a8f:	eb 10                	jmp    80108aa1 <copyuvm+0x11c>

bad:
  freevm(d);
80108a91:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a94:	89 04 24             	mov    %eax,(%esp)
80108a97:	e8 09 fe ff ff       	call   801088a5 <freevm>
  return 0;
80108a9c:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108aa1:	83 c4 44             	add    $0x44,%esp
80108aa4:	5b                   	pop    %ebx
80108aa5:	5d                   	pop    %ebp
80108aa6:	c3                   	ret    
...
80108aaa:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108aad:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ab4:	00 
...
80108ac2:	e8 40 f7 ff ff       	call   80108207 <walkpgdir>
80108ac7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108aca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108acd:	8b 00                	mov    (%eax),%eax
80108acf:	83 e0 01             	and    $0x1,%eax
80108ad2:	85 c0                	test   %eax,%eax
80108ad4:	75 07                	jne    80108add <uva2ka+0x36>
    return 0;
80108ad6:	b8 00 00 00 00       	mov    $0x0,%eax
80108adb:	eb 25                	jmp    80108b02 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108add:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ae0:	8b 00                	mov    (%eax),%eax
80108ae2:	83 e0 04             	and    $0x4,%eax
80108ae5:	85 c0                	test   %eax,%eax
80108ae7:	75 07                	jne    80108af0 <uva2ka+0x49>
    return 0;
80108ae9:	b8 00 00 00 00       	mov    $0x0,%eax
80108aee:	eb 12                	jmp    80108b02 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108af0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108af3:	8b 00                	mov    (%eax),%eax
80108af5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108afa:	89 04 24             	mov    %eax,(%esp)
80108afd:	e8 82 f2 ff ff       	call   80107d84 <p2v>
}
80108b02:	c9                   	leave  
80108b03:	c3                   	ret    
...
80108b07:	83 ec 28             	sub    $0x28,%esp
  ...
  buf = (char*)p;
80108b0a:	8b 45 10             	mov    0x10(%ebp),%eax
80108b0d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108b10:	e9 87 00 00 00       	jmp    80108b9c <copyout+0x98>
...
80108b23:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b27:	8b 45 08             	mov    0x8(%ebp),%eax
80108b2a:	89 04 24             	mov    %eax,(%esp)
80108b2d:	e8 75 ff ff ff       	call   80108aa7 <uva2ka>
80108b32:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108b35:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108b39:	75 07                	jne    80108b42 <copyout+0x3e>
      return -1;
80108b3b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108b40:	eb 69                	jmp    80108bab <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108b42:	8b 45 0c             	mov    0xc(%ebp),%eax
80108b45:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108b48:	29 c2                	sub    %eax,%edx
...
80108b57:	3b 45 14             	cmp    0x14(%ebp),%eax
80108b5a:	76 06                	jbe    80108b62 <copyout+0x5e>
      n = len;
80108b5c:	8b 45 14             	mov    0x14(%ebp),%eax
80108b5f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108b62:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b65:	8b 55 0c             	mov    0xc(%ebp),%edx
80108b68:	29 c2                	sub    %eax,%edx
80108b6a:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108b6d:	01 c2                	add    %eax,%edx
80108b6f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b72:	89 44 24 08          	mov    %eax,0x8(%esp)
80108b76:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b79:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b7d:	89 14 24             	mov    %edx,(%esp)
80108b80:	e8 d8 cc ff ff       	call   8010585d <memmove>
    len -= n;
80108b85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b88:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108b8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b8e:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108b91:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b94:	05 00 10 00 00       	add    $0x1000,%eax
80108b99:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108b9c:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108ba0:	0f 85 6f ff ff ff    	jne    80108b15 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
