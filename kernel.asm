...
8010003a:	c7 44 24 04 b0 87 10 	movl   $0x801087b0,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
80100049:	e8 da 50 00 00       	call   80105128 <initlock>
...
801000bd:	e8 87 50 00 00       	call   80105149 <acquire>
...
80100104:	e8 a2 50 00 00       	call   801051ab <release>
        return b;
...
8010017c:	e8 2a 50 00 00       	call   801051ab <release>
      return b;
...
80100198:	c7 04 24 b7 87 10 80 	movl   $0x801087b7,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 c8 87 10 80 	movl   $0x801087c8,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 cf 87 10 80 	movl   $0x801087cf,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
8010023c:	e8 08 4f 00 00       	call   80105149 <acquire>
...
8010029d:	e8 9e 4a 00 00       	call   80104d40 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
801002a9:	e8 fd 4e 00 00       	call   801051ab <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 89 4d 00 00       	call   80105149 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 d6 87 10 80 	movl   $0x801087d6,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec df 87 10 80 	movl   $0x801087df,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 73 4c 00 00       	call   801051ab <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 e6 87 10 80 	movl   $0x801087e6,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 f5 87 10 80 	movl   $0x801087f5,(%esp)
...
8010058f:	e8 66 4c 00 00       	call   801051fa <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 f7 87 10 80 	movl   $0x801087f7,(%esp)
...
801006b2:	e8 b5 4d 00 00       	call   8010546c <memmove>
    pos -= 80;
...
801006e1:	e8 b7 4c 00 00       	call   8010539d <memset>
  }
...
80100776:	e8 78 66 00 00       	call   80106df3 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 6c 66 00 00       	call   80106df3 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 60 66 00 00       	call   80106df3 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 53 66 00 00       	call   80106df3 <uartputc>
  cgaputc(c);
...
801007ba:	e8 8a 49 00 00       	call   80105149 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 28 46 00 00       	call   80104e17 <procdump>
      break;
...
801008f3:	e8 48 44 00 00       	call   80104d40 <wakeup>
        }
      }
      break;
...
80100914:	e8 92 48 00 00       	call   801051ab <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 0b 48 00 00       	call   80105149 <acquire>
  while(n > 0){
...
80100959:	e8 4d 48 00 00       	call   801051ab <release>
        ilock(ip);
...
801009fe:	e8 a8 47 00 00       	call   801051ab <release>
  ilock(ip);
...
80100a32:	e8 12 47 00 00       	call   80105149 <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 3a 47 00 00       	call   801051ab <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 fb 87 10 	movl   $0x801087fb,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
80100a96:	e8 8d 46 00 00       	call   80105128 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 03 88 10 	movl   $0x80108803,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 a0 07 11 80 	movl   $0x801107a0,(%esp)
80100aaa:	e8 79 46 00 00       	call   80105128 <initlock>
...
80100b6e:	e9 76 03 00 00       	jmp    80100ee9 <exec+0x3fa>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 cc 73 00 00       	call   80107f44 <setupkvm>
...
80100c14:	e8 f9 76 00 00       	call   80108312 <allocuvm>
...
80100c52:	e8 d0 75 00 00       	call   80108227 <loaduvm>
...
80100cc0:	e8 4d 76 00 00       	call   80108312 <allocuvm>
...
80100ce5:	e8 58 78 00 00       	call   80108542 <clearpteu>
  sp = sz;
...
80100d1b:	e8 e7 48 00 00       	call   80105607 <strlen>
...
80100d44:	e8 be 48 00 00       	call   80105607 <strlen>
...
80100d74:	e8 8e 79 00 00       	call   80108707 <copyout>
...
80100e1b:	e8 e7 78 00 00       	call   80108707 <copyout>
...
80100e73:	e8 45 47 00 00       	call   801055bd <safestrcpy>
...
80100ed2:	e8 5e 71 00 00       	call   80108035 <switchuvm>
  freevm(oldpgdir);
80100ed7:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eda:	89 04 24             	mov    %eax,(%esp)
80100edd:	e8 c6 75 00 00       	call   801084a8 <freevm>
  return 0;
...
80100ef5:	e8 ae 75 00 00       	call   801084a8 <freevm>
  if(ip){
...
80100f1d:	c7 44 24 04 09 88 10 	movl   $0x80108809,0x4(%esp)
80100f24:	80 
80100f25:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
80100f2c:	e8 f7 41 00 00       	call   80105128 <initlock>
}
80100f31:	c9                   	leave  
80100f32:	c3                   	ret    
...
80100f40:	e8 04 42 00 00       	call   80105149 <acquire>
...
80100f69:	e8 3d 42 00 00       	call   801051ab <release>
      return f;
...
80100f87:	e8 1f 42 00 00       	call   801051ab <release>
  return 0;
...
80100fa0:	e8 a4 41 00 00       	call   80105149 <acquire>
  if(f->ref < 1)
...
80100fad:	7f 0c                	jg     80100fbb <filedup+0x28>
    panic("filedup");
80100faf:	c7 04 24 10 88 10 80 	movl   $0x80108810,(%esp)
...
80100fd1:	e8 d5 41 00 00       	call   801051ab <release>
  return f;
...
80100fe8:	e8 5c 41 00 00       	call   80105149 <acquire>
  if(f->ref < 1)
...
80100ff5:	7f 0c                	jg     80101003 <fileclose+0x28>
    panic("fileclose");
80100ff7:	c7 04 24 18 88 10 80 	movl   $0x80108818,(%esp)
...
80101023:	e8 83 41 00 00       	call   801051ab <release>
...
8010106d:	e8 39 41 00 00       	call   801051ab <release>
...
801011ac:	eb 0c                	jmp    801011ba <fileread+0xba>
  ...
  panic("fileread");
801011ae:	c7 04 24 22 88 10 80 	movl   $0x80108822,(%esp)
...
801012ba:	c7 04 24 2b 88 10 80 	movl   $0x8010882b,(%esp)
...
801012ea:	eb 0c                	jmp    801012f8 <filewrite+0x13c>
  ...
  panic("filewrite");
801012ec:	c7 04 24 3b 88 10 80 	movl   $0x8010883b,(%esp)
...
80101332:	e8 35 41 00 00       	call   8010546c <memmove>
  brelse(bp);
...
80101378:	e8 20 40 00 00       	call   8010539d <memset>
  log_write(bp);
...
801014d5:	c7 04 24 45 88 10 80 	movl   $0x80108845,(%esp)
...
80101567:	c7 04 24 5b 88 10 80 	movl   $0x8010885b,(%esp)
...
801015b7:	c7 44 24 04 6e 88 10 	movl   $0x8010886e,0x4(%esp)
801015be:	80 
801015bf:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
801015c6:	e8 5d 3b 00 00       	call   80105128 <initlock>
}
801015cb:	c9                   	leave  
801015cc:	c3                   	ret    
...
80101648:	e8 50 3d 00 00       	call   8010539d <memset>
      dip->type = type;
...
8010169e:	c7 04 24 75 88 10 80 	movl   $0x80108875,(%esp)
...
80101747:	e8 20 3d 00 00       	call   8010546c <memmove>
  log_write(bp);
...
80101771:	e8 d3 39 00 00       	call   80105149 <acquire>
...
801017bb:	e8 eb 39 00 00       	call   801051ab <release>
      return ip;
...
801017ee:	c7 04 24 87 88 10 80 	movl   $0x80108887,(%esp)
...
8010182c:	e8 7a 39 00 00       	call   801051ab <release>
...
80101843:	e8 01 39 00 00       	call   80105149 <acquire>
  ip->ref++;
...
8010185e:	e8 48 39 00 00       	call   801051ab <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 97 88 10 80 	movl   $0x80108897,(%esp)
80101885:	e8 b0 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
80101891:	e8 b3 38 00 00       	call   80105149 <acquire>
...
801018a6:	e8 ba 33 00 00       	call   80104c65 <sleep>
...
801018d0:	e8 d6 38 00 00       	call   801051ab <release>
...
8010197b:	e8 ec 3a 00 00       	call   8010546c <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 9d 88 10 80 	movl   $0x8010889d,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 ac 88 10 80 	movl   $0x801088ac,(%esp)
801019e0:	e8 55 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
801019ec:	e8 58 37 00 00       	call   80105149 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 33 33 00 00       	call   80104d40 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
80101a14:	e8 92 37 00 00       	call   801051ab <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 1c 37 00 00       	call   80105149 <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 b4 88 10 80 	movl   $0x801088b4,(%esp)
...
80101a8a:	e8 1c 37 00 00       	call   801051ab <release>
    itrunc(ip);
...
80101ab5:	e8 8f 36 00 00       	call   80105149 <acquire>
    ip->flags = 0;
...
80101aca:	e8 71 32 00 00       	call   80104d40 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 c1 36 00 00       	call   801051ab <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101c05:	c7 04 24 be 88 10 80 	movl   $0x801088be,(%esp)
...
80101ea6:	e8 c1 35 00 00       	call   8010546c <memmove>
    brelse(bp);
...
80102005:	e8 62 34 00 00       	call   8010546c <memmove>
    log_write(bp);
...
80102083:	e8 87 34 00 00       	call   8010550f <strncmp>
}
80102088:	c9                   	leave  
80102089:	c3                   	ret    
...
8010209d:	c7 04 24 d1 88 10 80 	movl   $0x801088d1,(%esp)
...
801020d9:	74 0c                	je     801020e7 <dirlookup+0x5d>
      panic("dirlink read");
801020db:	c7 04 24 e3 88 10 80 	movl   $0x801088e3,(%esp)
...
801021be:	74 0c                	je     801021cc <dirlink+0x79>
      panic("dirlink read");
801021c0:	c7 04 24 e3 88 10 80 	movl   $0x801088e3,(%esp)
...
80102205:	e8 5b 33 00 00       	call   80105565 <strncpy>
  de.inum = inum;
...
80102235:	74 0c                	je     80102243 <dirlink+0xf0>
    panic("dirlink");
80102237:	c7 04 24 f0 88 10 80 	movl   $0x801088f0,(%esp)
...
801022bc:	e8 ab 31 00 00       	call   8010546c <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d7:	e8 90 31 00 00       	call   8010546c <memmove>
    name[len] = 0;
...
80102526:	c7 44 24 04 f8 88 10 	movl   $0x801088f8,0x4(%esp)
8010252d:	80 
8010252e:	c7 04 24 20 b6 10 80 	movl   $0x8010b620,(%esp)
80102535:	e8 ee 2b 00 00       	call   80105128 <initlock>
  picenable(IRQ_IDE);
...
801025d0:	75 0c                	jne    801025de <idestart+0x18>
    panic("idestart");
801025d2:	c7 04 24 fc 88 10 80 	movl   $0x801088fc,(%esp)
...
801026f8:	e8 4c 2a 00 00       	call   80105149 <acquire>
  if((b = idequeue) == 0){
...
80102712:	e8 94 2a 00 00       	call   801051ab <release>
...
80102785:	e8 b6 25 00 00       	call   80104d40 <wakeup>
...
801027a7:	e8 ff 29 00 00       	call   801051ab <release>
}
801027ac:	c9                   	leave  
801027ad:	c3                   	ret    
...
801027c0:	c7 04 24 05 89 10 80 	movl   $0x80108905,(%esp)
...
801027d9:	c7 04 24 19 89 10 80 	movl   $0x80108919,(%esp)
...
80102866:	e8 fa 23 00 00       	call   80104c65 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
8010287f:	e8 27 29 00 00       	call   801051ab <release>
}
80102884:	c9                   	leave  
80102885:	c3                   	ret    
...
8010290d:	c7 04 24 4c 89 10 80 	movl   $0x8010894c,(%esp)
...
801029c7:	c7 44 24 04 7e 89 10 	movl   $0x8010897e,0x4(%esp)
801029ce:	80 
801029cf:	c7 04 24 40 22 11 80 	movl   $0x80112240,(%esp)
801029d6:	e8 4d 27 00 00       	call   80105128 <initlock>
  kmem.use_lock = 0;
...
80102a81:	76 0c                	jbe    80102a8f <kfree+0x39>
    panic("kfree");
80102a83:	c7 04 24 83 89 10 80 	movl   $0x80108983,(%esp)
...
80102aa5:	e8 f3 28 00 00       	call   8010539d <memset>
...
80102aba:	e8 8a 26 00 00       	call   80105149 <acquire>
  r = (struct run*)v;
...
80102ae8:	e8 be 26 00 00       	call   801051ab <release>
}
80102aed:	c9                   	leave  
80102aee:	c3                   	ret    
...
80102b05:	e8 3f 26 00 00       	call   80105149 <acquire>
  r = kmem.freelist;
...
80102b32:	e8 74 26 00 00       	call   801051ab <release>
  return (char*)r;
...
80102eb2:	c7 04 24 8c 89 10 80 	movl   $0x8010898c,(%esp)
...
80103115:	e8 fa 22 00 00       	call   80105414 <memcmp>
...
80103215:	c7 44 24 04 b8 89 10 	movl   $0x801089b8,0x4(%esp)
8010321c:	80 
8010321d:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80103224:	e8 ff 1e 00 00       	call   80105128 <initlock>
  readsb(ROOTDEV, &sb);
...
801032d8:	e8 8f 21 00 00       	call   8010546c <memmove>
...
8010342a:	e8 1a 1d 00 00       	call   80105149 <acquire>
  while(1){
    if(log.committing){
...
80103447:	e8 19 18 00 00       	call   80104c65 <sleep>
...
8010347b:	e8 e5 17 00 00       	call   80104c65 <sleep>
...
80103496:	e8 10 1d 00 00       	call   801051ab <release>
      break;
...
801034b5:	e8 8f 1c 00 00       	call   80105149 <acquire>
  log.outstanding -= 1;
...
801034d0:	c7 04 24 bc 89 10 80 	movl   $0x801089bc,(%esp)
...
801034ff:	e8 3c 18 00 00       	call   80104d40 <wakeup>
  }
  release(&log.lock);
80103504:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
8010350b:	e8 9b 1c 00 00       	call   801051ab <release>
...
801035bf:	e8 a8 1e 00 00       	call   8010546c <memmove>
...
8010364a:	c7 04 24 cb 89 10 80 	movl   $0x801089cb,(%esp)
...
8010365f:	c7 04 24 e1 89 10 80 	movl   $0x801089e1,(%esp)
80103666:	e8 cf ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
8010366b:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80103672:	e8 d2 1a 00 00       	call   80105149 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801036e9:	e8 bd 1a 00 00       	call   801051ab <release>
}
801036ee:	c9                   	leave  
801036ef:	c3                   	ret    
...
80103765:	c7 04 24 fc 89 10 80 	movl   $0x801089fc,(%esp)
...
80103780:	e8 5e 35 00 00       	call   80106ce3 <uartinit>
  pinit();         // process table
80103785:	e8 a3 0b 00 00       	call   8010432d <pinit>
  tvinit();        // trap vectors
8010378a:	e8 06 31 00 00       	call   80106895 <tvinit>
  binit();         // buffer cache
...
801037ac:	e8 2f 30 00 00       	call   801067e0 <timerinit>
...
801037ca:	e8 e3 0c 00 00       	call   801044b2 <userinit>
...
801037d7:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801037da:	e8 39 48 00 00       	call   80108018 <switchkvm>
  seginit();
801037df:	e8 b0 41 00 00       	call   80107994 <seginit>
  lapicinit();
...
80103804:	c7 04 24 13 8a 10 80 	movl   $0x80108a13,(%esp)
8010380b:	e8 90 cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
80103810:	e8 f4 31 00 00       	call   80106a09 <idtinit>
...
80103830:	e8 6f 12 00 00       	call   80104aa4 <scheduler>
...
80103862:	e8 05 1c 00 00       	call   8010546c <memmove>
...
801039e3:	00 
801039e4:	c7 44 24 04 24 8a 10 	movl   $0x80108a24,0x4(%esp)
801039eb:	80 
801039ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039ef:	89 04 24             	mov    %eax,(%esp)
801039f2:	e8 1d 1a 00 00       	call   80105414 <memcmp>
...
80103b24:	00 
80103b25:	c7 44 24 04 29 8a 10 	movl   $0x80108a29,0x4(%esp)
80103b2c:	80 
80103b2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b30:	89 04 24             	mov    %eax,(%esp)
80103b33:	e8 dc 18 00 00       	call   80105414 <memcmp>
...
80103c01:	8b 04 85 6c 8a 10 80 	mov    -0x7fef7594(,%eax,4),%eax
...
80103c3a:	c7 04 24 2e 8a 10 80 	movl   $0x80108a2e,(%esp)
...
80103ccd:	c7 04 24 4c 8a 10 80 	movl   $0x80108a4c,(%esp)
...
80103fc6:	c7 44 24 04 80 8a 10 	movl   $0x80108a80,0x4(%esp)
80103fcd:	80 
80103fce:	89 04 24             	mov    %eax,(%esp)
80103fd1:	e8 52 11 00 00       	call   80105128 <initlock>
  (*f0)->type = FD_PIPE;
...
8010407d:	e8 c7 10 00 00       	call   80105149 <acquire>
  if(writable){
...
801040a0:	e8 9b 0c 00 00       	call   80104d40 <wakeup>
...
801040bf:	e8 7c 0c 00 00       	call   80104d40 <wakeup>
  }
...
801040e4:	e8 c2 10 00 00       	call   801051ab <release>
    kfree((char*)p);
...
801040fc:	e8 aa 10 00 00       	call   801051ab <release>
}
80104101:	c9                   	leave  
80104102:	c3                   	ret    
...
8010410f:	e8 35 10 00 00       	call   80105149 <acquire>
  for(i = 0; i < n; i++){
...
80104142:	e8 64 10 00 00       	call   801051ab <release>
        return -1;
...
8010415c:	e8 df 0b 00 00       	call   80104d40 <wakeup>
...
80104174:	e8 ec 0a 00 00       	call   80104c65 <sleep>
{
  int i;
...
801041dd:	e8 5e 0b 00 00       	call   80104d40 <wakeup>
  release(&p->lock);
801041e2:	8b 45 08             	mov    0x8(%ebp),%eax
801041e5:	89 04 24             	mov    %eax,(%esp)
801041e8:	e8 be 0f 00 00       	call   801051ab <release>
  return n;
...
801041ff:	e8 45 0f 00 00       	call   80105149 <acquire>
...
80104219:	e8 8d 0f 00 00       	call   801051ab <release>
      return -1;
...
8010423b:	e8 25 0a 00 00       	call   80104c65 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801042ca:	e8 71 0a 00 00       	call   80104d40 <wakeup>
  release(&p->lock);
801042cf:	8b 45 08             	mov    0x8(%ebp),%eax
801042d2:	89 04 24             	mov    %eax,(%esp)
801042d5:	e8 d1 0e 00 00       	call   801051ab <release>
  return i;
...
80104333:	c7 44 24 04 88 8a 10 	movl   $0x80108a88,0x4(%esp)
8010433a:	80 
8010433b:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104342:	e8 e1 0d 00 00       	call   80105128 <initlock>
}
80104347:	c9                   	leave  
80104348:	c3                   	ret    
...
80104354:	89 45 f4             	mov    %eax,-0xc(%ebp)
...
8010437e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104382:	c7 04 24 8f 8a 10 80 	movl   $0x80108a8f,(%esp)
80104389:	e8 12 c0 ff ff       	call   801003a0 <cprintf>
  return pid + 1;
8010438e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104391:	83 c0 01             	add    $0x1,%eax
}
80104394:	c9                   	leave  
80104395:	c3                   	ret    
...
80104399:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  char *sp;

  //acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010439c:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
801043a3:	eb 4c                	jmp    801043f1 <allocproc+0x5b>
    //if(p->state == UNUSED)
    if(cas(&p->state, UNUSED, EMBRYO))
801043a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043a8:	83 c0 0c             	add    $0xc,%eax
801043ab:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
801043b2:	00 
801043b3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801043ba:	00 
801043bb:	89 04 24             	mov    %eax,(%esp)
801043be:	e8 36 ff ff ff       	call   801042f9 <cas>
801043c3:	85 c0                	test   %eax,%eax
801043c5:	74 23                	je     801043ea <allocproc+0x54>
      goto found;
801043c7:	90                   	nop
...
found:
  ...
  p->pid = allocpid();
801043c8:	e8 7c ff ff ff       	call   80104349 <allocpid>
801043cd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043d0:	89 42 10             	mov    %eax,0x10(%edx)

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
801043d3:	e8 17 e7 ff ff       	call   80102aef <kalloc>
801043d8:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043db:	89 42 08             	mov    %eax,0x8(%edx)
801043de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043e1:	8b 40 08             	mov    0x8(%eax),%eax
801043e4:	85 c0                	test   %eax,%eax
801043e6:	75 30                	jne    80104418 <allocproc+0x82>
801043e8:	eb 1a                	jmp    80104404 <allocproc+0x6e>
{
  struct proc *p;
  char *sp;
  ...
  //acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043ea:	81 45 f4 4c 01 00 00 	addl   $0x14c,-0xc(%ebp)
801043f1:	81 7d f4 b4 7c 11 80 	cmpl   $0x80117cb4,-0xc(%ebp)
801043f8:	72 ab                	jb     801043a5 <allocproc+0xf>
    //if(p->state == UNUSED)
    if(cas(&p->state, UNUSED, EMBRYO))
      goto found;
  //release(&ptable.lock);
...
801043ff:	e9 ac 00 00 00       	jmp    801044b0 <allocproc+0x11a>
...
80104413:	e9 98 00 00 00       	jmp    801044b0 <allocproc+0x11a>
  }
  sp = p->kstack + KSTACKSIZE;
80104418:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010441b:	8b 40 08             	mov    0x8(%eax),%eax
8010441e:	05 00 10 00 00       	add    $0x1000,%eax
80104423:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
80104429:	83 e8 80             	sub    $0xffffff80,%eax
8010442c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010442f:	eb 0e                	jmp    8010443f <allocproc+0xa9>
    csf->used = 0;
...
80104434:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  ...
  struct cstackframe *csf;
  for(csf = p->pending_signals.frames; csf < &p->pending_signals.frames[MAX_CSTACK_FRAMES]; csf++) {
8010443b:	83 45 f0 14          	addl   $0x14,-0x10(%ebp)
8010443f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104442:	05 48 01 00 00       	add    $0x148,%eax
80104447:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010444a:	77 e5                	ja     80104431 <allocproc+0x9b>
    csf->used = 0;
  }
  p->pending_signals.head = 0;
8010444c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010444f:	c7 80 48 01 00 00 00 	movl   $0x0,0x148(%eax)
80104456:	00 00 00 

  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80104459:	83 6d ec 4c          	subl   $0x4c,-0x14(%ebp)
  p->tf = (struct trapframe*)sp;
8010445d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104460:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104463:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104466:	83 6d ec 04          	subl   $0x4,-0x14(%ebp)
  *(uint*)sp = (uint)trapret;
8010446a:	ba 50 68 10 80       	mov    $0x80106850,%edx
8010446f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104472:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
80104474:	83 6d ec 14          	subl   $0x14,-0x14(%ebp)
  p->context = (struct context*)sp;
80104478:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010447b:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010447e:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
80104481:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104484:	8b 40 1c             	mov    0x1c(%eax),%eax
80104487:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010448e:	00 
8010448f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104496:	00 
80104497:	89 04 24             	mov    %eax,(%esp)
8010449a:	e8 fe 0e 00 00       	call   8010539d <memset>
  p->context->eip = (uint)forkret;
8010449f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044a2:	8b 40 1c             	mov    0x1c(%eax),%eax
801044a5:	ba 39 4c 10 80       	mov    $0x80104c39,%edx
801044aa:	89 50 10             	mov    %edx,0x10(%eax)
...
801044b5:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  extern char _binary_initcode_start[], _binary_initcode_size[];
  
  p = allocproc();
801044b8:	e8 d9 fe ff ff       	call   80104396 <allocproc>
801044bd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801044c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044c3:	a3 68 b6 10 80       	mov    %eax,0x8010b668
  if((p->pgdir = setupkvm()) == 0)
801044c8:	e8 77 3a 00 00       	call   80107f44 <setupkvm>
801044cd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801044d0:	89 42 04             	mov    %eax,0x4(%edx)
801044d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044d6:	8b 40 04             	mov    0x4(%eax),%eax
801044d9:	85 c0                	test   %eax,%eax
801044db:	75 0c                	jne    801044e9 <userinit+0x37>
    panic("userinit: out of memory?");
801044dd:	c7 04 24 9e 8a 10 80 	movl   $0x80108a9e,(%esp)
801044e4:	e8 51 c0 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801044e9:	ba 2c 00 00 00       	mov    $0x2c,%edx
801044ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f1:	8b 40 04             	mov    0x4(%eax),%eax
801044f4:	89 54 24 08          	mov    %edx,0x8(%esp)
801044f8:	c7 44 24 04 00 b5 10 	movl   $0x8010b500,0x4(%esp)
801044ff:	80 
80104500:	89 04 24             	mov    %eax,(%esp)
80104503:	e8 94 3c 00 00       	call   8010819c <inituvm>
  p->sz = PGSIZE;
80104508:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010450b:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104511:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104514:	8b 40 18             	mov    0x18(%eax),%eax
80104517:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
8010451e:	00 
8010451f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104526:	00 
80104527:	89 04 24             	mov    %eax,(%esp)
8010452a:	e8 6e 0e 00 00       	call   8010539d <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010452f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104532:	8b 40 18             	mov    0x18(%eax),%eax
80104535:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010453b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010453e:	8b 40 18             	mov    0x18(%eax),%eax
80104541:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
...
80104557:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
...
8010456b:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010456f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104572:	8b 40 18             	mov    0x18(%eax),%eax
80104575:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
8010457c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010457f:	8b 40 18             	mov    0x18(%eax),%eax
80104582:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80104589:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010458c:	8b 40 18             	mov    0x18(%eax),%eax
8010458f:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104596:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104599:	83 c0 6c             	add    $0x6c,%eax
8010459c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801045a3:	00 
801045a4:	c7 44 24 04 b7 8a 10 	movl   $0x80108ab7,0x4(%esp)
801045ab:	80 
801045ac:	89 04 24             	mov    %eax,(%esp)
801045af:	e8 09 10 00 00       	call   801055bd <safestrcpy>
  p->cwd = namei("/");
801045b4:	c7 04 24 c0 8a 10 80 	movl   $0x80108ac0,(%esp)
801045bb:	e8 53 de ff ff       	call   80102413 <namei>
801045c0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045c3:	89 42 68             	mov    %eax,0x68(%edx)

  p->state = RUNNABLE;
801045c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045c9:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
}
801045d0:	c9                   	leave  
801045d1:	c3                   	ret    
...
801045de:	8b 00                	mov    (%eax),%eax
801045e0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
801045e3:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801045e7:	7e 34                	jle    8010461d <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
801045e9:	8b 55 08             	mov    0x8(%ebp),%edx
801045ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045ef:	01 c2                	add    %eax,%edx
...
80104608:	e8 05 3d 00 00       	call   80108312 <allocuvm>
8010460d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104610:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104614:	75 41                	jne    80104657 <growproc+0x85>
      return -1;
80104616:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010461b:	eb 58                	jmp    80104675 <growproc+0xa3>
  } else if(n < 0){
8010461d:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104621:	79 34                	jns    80104657 <growproc+0x85>
...
80104642:	e8 a5 3d 00 00       	call   801083ec <deallocuvm>
80104647:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010464a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010464e:	75 07                	jne    80104657 <growproc+0x85>
      return -1;
80104650:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104655:	eb 1e                	jmp    80104675 <growproc+0xa3>
  }
  proc->sz = sz;
...
8010466b:	e8 c5 39 00 00       	call   80108035 <switchuvm>
  return 0;
...
8010467d:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
80104680:	e8 11 fd ff ff       	call   80104396 <allocproc>
80104685:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104688:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010468c:	75 0a                	jne    80104698 <fork+0x21>
    return -1;
8010468e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104693:	e9 61 01 00 00       	jmp    801047f9 <fork+0x182>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
80104698:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010469e:	8b 10                	mov    (%eax),%edx
801046a0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046a6:	8b 40 04             	mov    0x4(%eax),%eax
801046a9:	89 54 24 04          	mov    %edx,0x4(%esp)
801046ad:	89 04 24             	mov    %eax,(%esp)
801046b0:	e8 d3 3e 00 00       	call   80108588 <copyuvm>
801046b5:	8b 55 e0             	mov    -0x20(%ebp),%edx
801046b8:	89 42 04             	mov    %eax,0x4(%edx)
801046bb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046be:	8b 40 04             	mov    0x4(%eax),%eax
801046c1:	85 c0                	test   %eax,%eax
801046c3:	75 2c                	jne    801046f1 <fork+0x7a>
    kfree(np->kstack);
801046c5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046c8:	8b 40 08             	mov    0x8(%eax),%eax
801046cb:	89 04 24             	mov    %eax,(%esp)
801046ce:	e8 83 e3 ff ff       	call   80102a56 <kfree>
    np->kstack = 0;
801046d3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046d6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
801046dd:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046e0:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
801046e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046ec:	e9 08 01 00 00       	jmp    801047f9 <fork+0x182>
  }
  np->sz = proc->sz;
801046f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046f7:	8b 10                	mov    (%eax),%edx
801046f9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046fc:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
801046fe:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104705:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104708:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
8010470b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010470e:	8b 50 18             	mov    0x18(%eax),%edx
80104711:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104717:	8b 40 18             	mov    0x18(%eax),%eax
8010471a:	89 c3                	mov    %eax,%ebx
8010471c:	b8 13 00 00 00       	mov    $0x13,%eax
80104721:	89 d7                	mov    %edx,%edi
80104723:	89 de                	mov    %ebx,%esi
80104725:	89 c1                	mov    %eax,%ecx
80104727:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
...
8010473d:	eb 3d                	jmp    8010477c <fork+0x105>
    if(proc->ofile[i])
...
80104751:	74 25                	je     80104778 <fork+0x101>
...
80104780:	7e bd                	jle    8010473f <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
801047b7:	e8 01 0e 00 00       	call   801055bd <safestrcpy>
  np->sighandler = proc->sighandler; 
801047bc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047c2:	8b 50 7c             	mov    0x7c(%eax),%edx
801047c5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047c8:	89 50 7c             	mov    %edx,0x7c(%eax)
  //copy signal handler

  pid = np->pid;
801047cb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047ce:	8b 40 10             	mov    0x10(%eax),%eax
801047d1:	89 45 dc             	mov    %eax,-0x24(%ebp)

  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
801047d4:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
801047db:	e8 69 09 00 00       	call   80105149 <acquire>
  np->state = RUNNABLE;
801047e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047e3:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
801047ea:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
801047f1:	e8 b5 09 00 00       	call   801051ab <release>
  
  return pid;
801047f6:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801047f9:	83 c4 2c             	add    $0x2c,%esp
801047fc:	5b                   	pop    %ebx
801047fd:	5e                   	pop    %esi
801047fe:	5f                   	pop    %edi
801047ff:	5d                   	pop    %ebp
...
80104804:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int fd;

  if(proc == initproc)
80104807:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010480e:	a1 68 b6 10 80       	mov    0x8010b668,%eax
80104813:	39 c2                	cmp    %eax,%edx
80104815:	75 0c                	jne    80104823 <exit+0x22>
    panic("init exiting");
80104817:	c7 04 24 c2 8a 10 80 	movl   $0x80108ac2,(%esp)
8010481e:	e8 17 bd ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104823:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010482a:	eb 44                	jmp    80104870 <exit+0x6f>
    if(proc->ofile[fd]){
8010482c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104832:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104835:	83 c2 08             	add    $0x8,%edx
80104838:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010483c:	85 c0                	test   %eax,%eax
8010483e:	74 2c                	je     8010486c <exit+0x6b>
...
8010486b:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010486c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104870:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104874:	7e b6                	jle    8010482c <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80104876:	e8 a2 eb ff ff       	call   8010341d <begin_op>
  iput(proc->cwd);
8010487b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104881:	8b 40 68             	mov    0x68(%eax),%eax
80104884:	89 04 24             	mov    %eax,(%esp)
80104887:	e8 8f d1 ff ff       	call   80101a1b <iput>
  end_op();
8010488c:	e8 10 ec ff ff       	call   801034a1 <end_op>
  proc->cwd = 0;
80104891:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104897:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
8010489e:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
801048a5:	e8 9f 08 00 00       	call   80105149 <acquire>

  proc->state = ZOMBIE;
801048aa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048b0:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
...
801048c3:	e8 2b 04 00 00       	call   80104cf3 <wakeup1>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048c8:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
801048cf:	eb 3b                	jmp    8010490c <exit+0x10b>
    if(p->parent == proc){
801048d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048d4:	8b 50 14             	mov    0x14(%eax),%edx
801048d7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048dd:	39 c2                	cmp    %eax,%edx
801048df:	75 24                	jne    80104905 <exit+0x104>
      p->parent = initproc;
801048e1:	8b 15 68 b6 10 80    	mov    0x8010b668,%edx
...
801048f6:	75 0d                	jne    80104905 <exit+0x104>
        wakeup1(initproc);
801048f8:	a1 68 b6 10 80       	mov    0x8010b668,%eax
801048fd:	89 04 24             	mov    %eax,(%esp)
80104900:	e8 ee 03 00 00       	call   80104cf3 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104905:	81 45 f4 4c 01 00 00 	addl   $0x14c,-0xc(%ebp)
8010490c:	81 7d f4 b4 7c 11 80 	cmpl   $0x80117cb4,-0xc(%ebp)
80104913:	72 bc                	jb     801048d1 <exit+0xd0>
    }
  }
  ...
  sched();
80104915:	e8 3b 02 00 00       	call   80104b55 <sched>
  panic("zombie exit");
8010491a:	c7 04 24 cf 8a 10 80 	movl   $0x80108acf,(%esp)
...
80104929:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
8010492c:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104933:	e8 11 08 00 00       	call   80105149 <acquire>
  for(;;){
    proc->chan = (int)proc;
80104938:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010493e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104945:	89 50 20             	mov    %edx,0x20(%eax)
    proc->state = SLEEPING;    
80104948:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010494e:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
    // Scan through table looking for zombie children.
    havekids = 0;
80104955:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010495c:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
80104963:	e9 84 00 00 00       	jmp    801049ec <wait+0xc6>
      if(p->parent != proc)
80104968:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010496b:	8b 50 14             	mov    0x14(%eax),%edx
8010496e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104974:	39 c2                	cmp    %eax,%edx
80104976:	74 02                	je     8010497a <wait+0x54>
        continue;
80104978:	eb 6b                	jmp    801049e5 <wait+0xbf>
      havekids = 1;
8010497a:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104981:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104984:	8b 40 0c             	mov    0xc(%eax),%eax
80104987:	83 f8 05             	cmp    $0x5,%eax
8010498a:	75 59                	jne    801049e5 <wait+0xbf>
        // Found one.
        pid = p->pid;
8010498c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010498f:	8b 40 10             	mov    0x10(%eax),%eax
80104992:	89 45 ec             	mov    %eax,-0x14(%ebp)
        p->state = UNUSED;
...
801049c0:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
        proc->state = RUNNING;
801049c7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049cd:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
        release(&ptable.lock);
801049d4:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
801049db:	e8 cb 07 00 00       	call   801051ab <release>
        return pid;
801049e0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801049e3:	eb 5e                	jmp    80104a43 <wait+0x11d>
  for(;;){
    proc->chan = (int)proc;
    proc->state = SLEEPING;    
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049e5:	81 45 f4 4c 01 00 00 	addl   $0x14c,-0xc(%ebp)
801049ec:	81 7d f4 b4 7c 11 80 	cmpl   $0x80117cb4,-0xc(%ebp)
801049f3:	0f 82 6f ff ff ff    	jb     80104968 <wait+0x42>
        return pid;
      }
    }
...
801049fd:	74 0d                	je     80104a0c <wait+0xe6>
801049ff:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a05:	8b 40 24             	mov    0x24(%eax),%eax
80104a08:	85 c0                	test   %eax,%eax
80104a0a:	74 2d                	je     80104a39 <wait+0x113>
      proc->chan = 0;
80104a0c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a12:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
      proc->state = RUNNING;      
80104a19:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a1f:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      release(&ptable.lock);
80104a26:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104a2d:	e8 79 07 00 00       	call   801051ab <release>
      return -1;
80104a32:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a37:	eb 0a                	jmp    80104a43 <wait+0x11d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sched();
80104a39:	e8 17 01 00 00       	call   80104b55 <sched>
  }
80104a3e:	e9 f5 fe ff ff       	jmp    80104938 <wait+0x12>
}
80104a43:	c9                   	leave  
80104a44:	c3                   	ret    
...
80104a4f:	74 0b                	je     80104a5c <freeproc+0x17>
80104a51:	8b 45 08             	mov    0x8(%ebp),%eax
80104a54:	8b 40 0c             	mov    0xc(%eax),%eax
80104a57:	83 f8 05             	cmp    $0x5,%eax
80104a5a:	74 0c                	je     80104a68 <freeproc+0x23>
    panic("freeproc not zombie");
80104a5c:	c7 04 24 db 8a 10 80 	movl   $0x80108adb,(%esp)
80104a63:	e8 d2 ba ff ff       	call   8010053a <panic>
  kfree(p->kstack);
80104a68:	8b 45 08             	mov    0x8(%ebp),%eax
80104a6b:	8b 40 08             	mov    0x8(%eax),%eax
80104a6e:	89 04 24             	mov    %eax,(%esp)
80104a71:	e8 e0 df ff ff       	call   80102a56 <kfree>
  p->kstack = 0;
80104a76:	8b 45 08             	mov    0x8(%ebp),%eax
80104a79:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  freevm(p->pgdir);
80104a80:	8b 45 08             	mov    0x8(%ebp),%eax
80104a83:	8b 40 04             	mov    0x4(%eax),%eax
80104a86:	89 04 24             	mov    %eax,(%esp)
80104a89:	e8 1a 3a 00 00       	call   801084a8 <freevm>
  p->killed = 0;
80104a8e:	8b 45 08             	mov    0x8(%ebp),%eax
80104a91:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
  p->chan = 0;
80104a98:	8b 45 08             	mov    0x8(%ebp),%eax
80104a9b:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
}
80104aa2:	c9                   	leave  
80104aa3:	c3                   	ret    
...
80104aa7:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104aaa:	e8 44 f8 ff ff       	call   801042f3 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104aaf:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104ab6:	e8 8e 06 00 00       	call   80105149 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104abb:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
80104ac2:	eb 77                	jmp    80104b3b <scheduler+0x97>
      if(p->state != RUNNABLE)
80104ac4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ac7:	8b 40 0c             	mov    0xc(%eax),%eax
80104aca:	83 f8 03             	cmp    $0x3,%eax
80104acd:	74 02                	je     80104ad1 <scheduler+0x2d>
        continue;
80104acf:	eb 63                	jmp    80104b34 <scheduler+0x90>
...
80104ad4:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104ada:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104add:	89 04 24             	mov    %eax,(%esp)
80104ae0:	e8 50 35 00 00       	call   80108035 <switchuvm>
      p->state = RUNNING;
80104ae5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ae8:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
...
80104aff:	83 c2 04             	add    $0x4,%edx
80104b02:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b06:	89 14 24             	mov    %edx,(%esp)
80104b09:	e8 20 0b 00 00       	call   8010562e <swtch>
      switchkvm();
80104b0e:	e8 05 35 00 00       	call   80108018 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104b13:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104b1a:	00 00 00 00 
      if (p->state == ZOMBIE)
80104b1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b21:	8b 40 0c             	mov    0xc(%eax),%eax
80104b24:	83 f8 05             	cmp    $0x5,%eax
80104b27:	75 0b                	jne    80104b34 <scheduler+0x90>
        freeproc(p);
80104b29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b2c:	89 04 24             	mov    %eax,(%esp)
80104b2f:	e8 11 ff ff ff       	call   80104a45 <freeproc>
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b34:	81 45 f4 4c 01 00 00 	addl   $0x14c,-0xc(%ebp)
80104b3b:	81 7d f4 b4 7c 11 80 	cmpl   $0x80117cb4,-0xc(%ebp)
80104b42:	72 80                	jb     80104ac4 <scheduler+0x20>
      // It should have changed its p->state before coming back.
      proc = 0;
      if (p->state == ZOMBIE)
        freeproc(p);
    ...
    release(&ptable.lock);
80104b44:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104b4b:	e8 5b 06 00 00       	call   801051ab <release>

  }
80104b50:	e9 55 ff ff ff       	jmp    80104aaa <scheduler+0x6>
...
80104b58:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80104b5b:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104b62:	e8 0c 07 00 00       	call   80105273 <holding>
80104b67:	85 c0                	test   %eax,%eax
80104b69:	75 0c                	jne    80104b77 <sched+0x22>
    panic("sched ptable.lock");
80104b6b:	c7 04 24 ef 8a 10 80 	movl   $0x80108aef,(%esp)
80104b72:	e8 c3 b9 ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
80104b77:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b7d:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104b83:	83 f8 01             	cmp    $0x1,%eax
80104b86:	74 0c                	je     80104b94 <sched+0x3f>
    panic("sched locks");
80104b88:	c7 04 24 01 8b 10 80 	movl   $0x80108b01,(%esp)
80104b8f:	e8 a6 b9 ff ff       	call   8010053a <panic>
  if(proc->state == RUNNING)
80104b94:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b9a:	8b 40 0c             	mov    0xc(%eax),%eax
80104b9d:	83 f8 04             	cmp    $0x4,%eax
80104ba0:	75 0c                	jne    80104bae <sched+0x59>
    panic("sched running");
80104ba2:	c7 04 24 0d 8b 10 80 	movl   $0x80108b0d,(%esp)
80104ba9:	e8 8c b9 ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104bae:	e8 30 f7 ff ff       	call   801042e3 <readeflags>
80104bb3:	25 00 02 00 00       	and    $0x200,%eax
80104bb8:	85 c0                	test   %eax,%eax
80104bba:	74 0c                	je     80104bc8 <sched+0x73>
    panic("sched interruptible");
80104bbc:	c7 04 24 1b 8b 10 80 	movl   $0x80108b1b,(%esp)
80104bc3:	e8 72 b9 ff ff       	call   8010053a <panic>
  intena = cpu->intena;
80104bc8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104bce:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104bd4:	89 45 f4             	mov    %eax,-0xc(%ebp)
...
80104be7:	83 c2 1c             	add    $0x1c,%edx
80104bea:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bee:	89 14 24             	mov    %edx,(%esp)
80104bf1:	e8 38 0a 00 00       	call   8010562e <swtch>
  cpu->intena = intena;
80104bf6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104bfc:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104bff:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104c05:	c9                   	leave  
80104c06:	c3                   	ret    
...
80104c0d:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104c14:	e8 30 05 00 00       	call   80105149 <acquire>
  proc->state = RUNNABLE;
80104c19:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c1f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104c26:	e8 2a ff ff ff       	call   80104b55 <sched>
  release(&ptable.lock);
80104c2b:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104c32:	e8 74 05 00 00       	call   801051ab <release>
}
80104c37:	c9                   	leave  
80104c38:	c3                   	ret    
...
80104c3c:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104c3f:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104c46:	e8 60 05 00 00       	call   801051ab <release>

  if (first) {
80104c4b:	a1 08 b0 10 80       	mov    0x8010b008,%eax
...
80104c52:	74 0f                	je     80104c63 <forkret+0x2a>
    ...
    // be run from main().
    first = 0;
80104c54:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104c5b:	00 00 00 
    initlog();
80104c5e:	e8 ac e5 ff ff       	call   8010320f <initlog>
  }
...
80104c73:	75 0c                	jne    80104c81 <sleep+0x1c>
    panic("sleep");
80104c75:	c7 04 24 2f 8b 10 80 	movl   $0x80108b2f,(%esp)
80104c7c:	e8 b9 b8 ff ff       	call   8010053a <panic>

  if(lk == 0)
80104c81:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104c85:	75 0c                	jne    80104c93 <sleep+0x2e>
    panic("sleep without lk");
80104c87:	c7 04 24 35 8b 10 80 	movl   $0x80108b35,(%esp)
...
80104c93:	81 7d 0c 80 29 11 80 	cmpl   $0x80112980,0xc(%ebp)
80104c9a:	74 17                	je     80104cb3 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104c9c:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104ca3:	e8 a1 04 00 00       	call   80105149 <acquire>
    release(lk);
80104ca8:	8b 45 0c             	mov    0xc(%ebp),%eax
80104cab:	89 04 24             	mov    %eax,(%esp)
80104cae:	e8 f8 04 00 00       	call   801051ab <release>
  }

  // Go to sleep.
  proc->chan = (int)chan;
80104cb3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cb9:	8b 55 08             	mov    0x8(%ebp),%edx
80104cbc:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104cbf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cc5:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)


  sched();
80104ccc:	e8 84 fe ff ff       	call   80104b55 <sched>

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104cd1:	81 7d 0c 80 29 11 80 	cmpl   $0x80112980,0xc(%ebp)
80104cd8:	74 17                	je     80104cf1 <sleep+0x8c>
    release(&ptable.lock);
80104cda:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104ce1:	e8 c5 04 00 00       	call   801051ab <release>
    acquire(lk);
80104ce6:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ce9:	89 04 24             	mov    %eax,(%esp)
80104cec:	e8 58 04 00 00       	call   80105149 <acquire>
  }
}
80104cf1:	c9                   	leave  
80104cf2:	c3                   	ret    
...
80104cf6:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104cf9:	c7 45 fc b4 29 11 80 	movl   $0x801129b4,-0x4(%ebp)
80104d00:	eb 33                	jmp    80104d35 <wakeup1+0x42>
...
80104d0b:	75 21                	jne    80104d2e <wakeup1+0x3b>
80104d0d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d10:	8b 50 20             	mov    0x20(%eax),%edx
80104d13:	8b 45 08             	mov    0x8(%ebp),%eax
80104d16:	39 c2                	cmp    %eax,%edx
80104d18:	75 14                	jne    80104d2e <wakeup1+0x3b>
      // Tidy up.
      p->chan = 0;
80104d1a:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d1d:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104d2e:	81 45 fc 4c 01 00 00 	addl   $0x14c,-0x4(%ebp)
80104d35:	81 7d fc b4 7c 11 80 	cmpl   $0x80117cb4,-0x4(%ebp)
80104d3c:	72 c4                	jb     80104d02 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == (int)chan){
      // Tidy up.
      p->chan = 0;
      p->state = RUNNABLE;
...
80104d43:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104d46:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104d4d:	e8 f7 03 00 00       	call   80105149 <acquire>
  wakeup1(chan);
80104d52:	8b 45 08             	mov    0x8(%ebp),%eax
80104d55:	89 04 24             	mov    %eax,(%esp)
80104d58:	e8 96 ff ff ff       	call   80104cf3 <wakeup1>
  release(&ptable.lock);
80104d5d:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104d64:	e8 42 04 00 00       	call   801051ab <release>
}
80104d69:	c9                   	leave  
80104d6a:	c3                   	ret    
...
80104d6e:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
cprintf("my input pid is %d go over %d procs\n", pid, NPROC );
80104d71:	c7 44 24 08 40 00 00 	movl   $0x40,0x8(%esp)
80104d78:	00 
80104d79:	8b 45 08             	mov    0x8(%ebp),%eax
80104d7c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d80:	c7 04 24 48 8b 10 80 	movl   $0x80108b48,(%esp)
80104d87:	e8 14 b6 ff ff       	call   801003a0 <cprintf>
  acquire(&ptable.lock);
80104d8c:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104d93:	e8 b1 03 00 00       	call   80105149 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d98:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
80104d9f:	eb 66                	jmp    80104e07 <kill+0x9c>
    
    cprintf("my pid is %d\n", p->pid );
80104da1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da4:	8b 40 10             	mov    0x10(%eax),%eax
80104da7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dab:	c7 04 24 6d 8b 10 80 	movl   $0x80108b6d,(%esp)
80104db2:	e8 e9 b5 ff ff       	call   801003a0 <cprintf>
    if(p->pid == pid){
80104db7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dba:	8b 40 10             	mov    0x10(%eax),%eax
80104dbd:	3b 45 08             	cmp    0x8(%ebp),%eax
80104dc0:	75 32                	jne    80104df4 <kill+0x89>
      p->killed = 1;
...
80104dd2:	83 f8 02             	cmp    $0x2,%eax
80104dd5:	75 0a                	jne    80104de1 <kill+0x76>
        p->state = RUNNABLE;
...
80104de8:	e8 be 03 00 00       	call   801051ab <release>
      return 0;
80104ded:	b8 00 00 00 00       	mov    $0x0,%eax
80104df2:	eb 21                	jmp    80104e15 <kill+0xaa>
...
//  cprintf("i'm in kill ! outside for loop, my pid is %d\n", p->pid );
    release(&ptable.lock);
80104df4:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104dfb:	e8 ab 03 00 00       	call   801051ab <release>
kill(int pid)
{
  struct proc *p;
cprintf("my input pid is %d go over %d procs\n", pid, NPROC );
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e00:	81 45 f4 4c 01 00 00 	addl   $0x14c,-0xc(%ebp)
80104e07:	81 7d f4 b4 7c 11 80 	cmpl   $0x80117cb4,-0xc(%ebp)
80104e0e:	72 91                	jb     80104da1 <kill+0x36>
      //cprintf("res = %d,    pid = %d", res, pid_test);
//  cprintf("i'm in kill ! outside for loop, my pid is %d\n", p->pid );
    release(&ptable.lock);
  }
...
80104e1a:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e1d:	c7 45 f0 b4 29 11 80 	movl   $0x801129b4,-0x10(%ebp)
80104e24:	e9 e3 00 00 00       	jmp    80104f0c <procdump+0xf5>
    if(p->state == UNUSED)
80104e29:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e2c:	8b 40 0c             	mov    0xc(%eax),%eax
80104e2f:	85 c0                	test   %eax,%eax
80104e31:	75 05                	jne    80104e38 <procdump+0x21>
      continue;
80104e33:	e9 cd 00 00 00       	jmp    80104f05 <procdump+0xee>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104e38:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e3b:	8b 40 0c             	mov    0xc(%eax),%eax
80104e3e:	85 c0                	test   %eax,%eax
80104e40:	78 2e                	js     80104e70 <procdump+0x59>
80104e42:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e45:	8b 40 0c             	mov    0xc(%eax),%eax
80104e48:	83 f8 05             	cmp    $0x5,%eax
80104e4b:	77 23                	ja     80104e70 <procdump+0x59>
80104e4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e50:	8b 40 0c             	mov    0xc(%eax),%eax
80104e53:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104e5a:	85 c0                	test   %eax,%eax
80104e5c:	74 12                	je     80104e70 <procdump+0x59>
      state = states[p->state];
80104e5e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e61:	8b 40 0c             	mov    0xc(%eax),%eax
80104e64:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104e6b:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104e6e:	eb 07                	jmp    80104e77 <procdump+0x60>
    else
      state = "???";
80104e70:	c7 45 ec 7b 8b 10 80 	movl   $0x80108b7b,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104e77:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e7a:	8d 50 6c             	lea    0x6c(%eax),%edx
80104e7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e80:	8b 40 10             	mov    0x10(%eax),%eax
80104e83:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104e87:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104e8a:	89 54 24 08          	mov    %edx,0x8(%esp)
80104e8e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e92:	c7 04 24 7f 8b 10 80 	movl   $0x80108b7f,(%esp)
...
80104ea7:	75 50                	jne    80104ef9 <procdump+0xe2>
...
80104eb5:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104eb8:	89 54 24 04          	mov    %edx,0x4(%esp)
80104ebc:	89 04 24             	mov    %eax,(%esp)
80104ebf:	e8 36 03 00 00       	call   801051fa <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104ec4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104ecb:	eb 1b                	jmp    80104ee8 <procdump+0xd1>
        cprintf(" %p", pc[i]);
80104ecd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ed0:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ed4:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ed8:	c7 04 24 88 8b 10 80 	movl   $0x80108b88,(%esp)
80104edf:	e8 bc b4 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104ee4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104ee8:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104eec:	7f 0b                	jg     80104ef9 <procdump+0xe2>
80104eee:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ef1:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ef5:	85 c0                	test   %eax,%eax
80104ef7:	75 d4                	jne    80104ecd <procdump+0xb6>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104ef9:	c7 04 24 8c 8b 10 80 	movl   $0x80108b8c,(%esp)
80104f00:	e8 9b b4 ff ff       	call   801003a0 <cprintf>
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f05:	81 45 f0 4c 01 00 00 	addl   $0x14c,-0x10(%ebp)
80104f0c:	81 7d f0 b4 7c 11 80 	cmpl   $0x80117cb4,-0x10(%ebp)
80104f13:	0f 82 10 ff ff ff    	jb     80104e29 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104f27:	8b 40 7c             	mov    0x7c(%eax),%eax
80104f2a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  proc->sighandler = new_handler;
80104f2d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f33:	8b 55 08             	mov    0x8(%ebp),%edx
80104f36:	89 50 7c             	mov    %edx,0x7c(%eax)
  return oldhandler;
...
80104f41:	83 ec 28             	sub    $0x28,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104f44:	c7 45 f4 b4 29 11 80 	movl   $0x801129b4,-0xc(%ebp)
80104f4b:	eb 5e                	jmp    80104fab <sigsend+0x6d>
    if (p->pid == dest_pid) {
80104f4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f50:	8b 40 10             	mov    0x10(%eax),%eax
80104f53:	3b 45 08             	cmp    0x8(%ebp),%eax
80104f56:	75 4c                	jne    80104fa4 <sigsend+0x66>
...
80104f64:	8d 8a 80 00 00 00    	lea    0x80(%edx),%ecx
80104f6a:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f6d:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104f71:	8b 55 08             	mov    0x8(%ebp),%edx
80104f74:	89 54 24 08          	mov    %edx,0x8(%esp)
80104f78:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f7c:	89 0c 24             	mov    %ecx,(%esp)
80104f7f:	e8 7e 00 00 00       	call   80105002 <push>
80104f84:	85 c0                	test   %eax,%eax
80104f86:	74 15                	je     80104f9d <sigsend+0x5f>
      { 
        wakeup((void*)p->chan);
80104f88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f8b:	8b 40 20             	mov    0x20(%eax),%eax
80104f8e:	89 04 24             	mov    %eax,(%esp)
80104f91:	e8 aa fd ff ff       	call   80104d40 <wakeup>
        return 0;
80104f96:	b8 00 00 00 00       	mov    $0x0,%eax
80104f9b:	eb 1c                	jmp    80104fb9 <sigsend+0x7b>
      }
      else
        return -1;
80104f9d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104fa2:	eb 15                	jmp    80104fb9 <sigsend+0x7b>
int
sigsend(int dest_pid, int value)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104fa4:	81 45 f4 4c 01 00 00 	addl   $0x14c,-0xc(%ebp)
80104fab:	81 7d f4 b4 7c 11 80 	cmpl   $0x80117cb4,-0xc(%ebp)
80104fb2:	72 99                	jb     80104f4d <sigsend+0xf>
      }
      else
        return -1;
    }
...
80104fc8:	e8 7c 01 00 00       	call   80105149 <acquire>
  //f(cas(&proc->state, RUNNING, SLEEPING)){
  proc->state = SLEEPING;
80104fcd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fd3:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  proc->chan = (int)proc;
80104fda:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fe0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104fe7:	89 50 20             	mov    %edx,0x20(%eax)
  //while(!cas(proc->chan, 0, ()))
  sched();
80104fea:	e8 66 fb ff ff       	call   80104b55 <sched>
  release(&ptable.lock);
80104fef:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
80104ff6:	e8 b0 01 00 00       	call   801051ab <release>
  return 0;
...
80105005:	83 ec 1c             	sub    $0x1c,%esp
  struct cstackframe *csf;
...
8010500e:	eb 48                	jmp    80105058 <push+0x56>
    if(cas(&csf->used, 0, 1)) 
80105010:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105013:	83 c0 0c             	add    $0xc,%eax
80105016:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010501d:	00 
8010501e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105025:	00 
80105026:	89 04 24             	mov    %eax,(%esp)
80105029:	e8 cb f2 ff ff       	call   801042f9 <cas>
8010502e:	85 c0                	test   %eax,%eax
80105030:	74 1d                	je     8010504f <push+0x4d>
      goto found;
80105032:	90                   	nop
  return 0;
...
8010503e:	8b 55 10             	mov    0x10(%ebp),%edx
80105041:	89 50 04             	mov    %edx,0x4(%eax)
  csf->value = value;
80105044:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105047:	8b 55 14             	mov    0x14(%ebp),%edx
8010504a:	89 50 08             	mov    %edx,0x8(%eax)
8010504d:	eb 20                	jmp    8010506f <push+0x6d>
// -------------- cstack implementation ------------
int 
push(struct cstack *cstack, int sender_pid, int recepient_pid, int value)
{
  struct cstackframe *csf;
  for(csf = cstack->frames; csf < &cstack->frames[MAX_CSTACK_FRAMES]; csf++) {
8010504f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105052:	83 c0 14             	add    $0x14,%eax
80105055:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105058:	8b 45 08             	mov    0x8(%ebp),%eax
8010505b:	8d 90 c8 00 00 00    	lea    0xc8(%eax),%edx
80105061:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105064:	39 c2                	cmp    %eax,%edx
80105066:	77 a8                	ja     80105010 <push+0xe>
    if(cas(&csf->used, 0, 1)) 
      goto found;
  }
...
8010506d:	eb 3a                	jmp    801050a9 <push+0xa7>
  csf->sender_pid = sender_pid;
  csf->recepient_pid = recepient_pid;
  csf->value = value;
...
80105075:	8b 92 c8 00 00 00    	mov    0xc8(%edx),%edx
8010507b:	89 50 10             	mov    %edx,0x10(%eax)
  } while (!cas((int*)&(cstack->head), (int)csf->next, (int)&csf));
8010507e:	8d 55 fc             	lea    -0x4(%ebp),%edx
80105081:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105084:	8b 40 10             	mov    0x10(%eax),%eax
80105087:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010508a:	81 c1 c8 00 00 00    	add    $0xc8,%ecx
80105090:	89 54 24 08          	mov    %edx,0x8(%esp)
80105094:	89 44 24 04          	mov    %eax,0x4(%esp)
80105098:	89 0c 24             	mov    %ecx,(%esp)
8010509b:	e8 59 f2 ff ff       	call   801042f9 <cas>
801050a0:	85 c0                	test   %eax,%eax
801050a2:	74 cb                	je     8010506f <push+0x6d>

  return 1;
801050a4:	b8 01 00 00 00       	mov    $0x1,%eax
}
801050a9:	c9                   	leave  
801050aa:	c3                   	ret    
...
801050ae:	83 ec 1c             	sub    $0x1c,%esp
  struct cstackframe *csf;
...
801050b4:	8b 80 c8 00 00 00    	mov    0xc8(%eax),%eax
801050ba:	89 45 fc             	mov    %eax,-0x4(%ebp)
    if (!csf)
801050bd:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801050c1:	75 07                	jne    801050ca <pop+0x1f>
      return 0;
801050c3:	b8 00 00 00 00       	mov    $0x0,%eax
801050c8:	eb 26                	jmp    801050f0 <pop+0x45>
  } while (!cas((int*)&(cstack->head), (int)csf, (int)&next));
801050ca:	8d 55 f8             	lea    -0x8(%ebp),%edx
801050cd:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050d0:	8b 4d 08             	mov    0x8(%ebp),%ecx
801050d3:	81 c1 c8 00 00 00    	add    $0xc8,%ecx
801050d9:	89 54 24 08          	mov    %edx,0x8(%esp)
801050dd:	89 44 24 04          	mov    %eax,0x4(%esp)
801050e1:	89 0c 24             	mov    %ecx,(%esp)
801050e4:	e8 10 f2 ff ff       	call   801042f9 <cas>
801050e9:	85 c0                	test   %eax,%eax
801050eb:	74 c4                	je     801050b1 <pop+0x6>
...
801050f8:	9c                   	pushf  
801050f9:	58                   	pop    %eax
801050fa:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
...
8010511d:	f0 87 02             	lock xchg %eax,(%edx)
...
8010514f:	e8 49 01 00 00       	call   8010529d <pushcli>
  if(holding(lk))
80105154:	8b 45 08             	mov    0x8(%ebp),%eax
80105157:	89 04 24             	mov    %eax,(%esp)
8010515a:	e8 14 01 00 00       	call   80105273 <holding>
8010515f:	85 c0                	test   %eax,%eax
80105161:	74 0c                	je     8010516f <acquire+0x26>
    panic("acquire");
80105163:	c7 04 24 b8 8b 10 80 	movl   $0x80108bb8,(%esp)
8010516a:	e8 cb b3 ff ff       	call   8010053a <panic>
...
80105173:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010517a:	00 
8010517b:	89 04 24             	mov    %eax,(%esp)
8010517e:	e8 8b ff ff ff       	call   8010510e <xchg>
80105183:	85 c0                	test   %eax,%eax
80105185:	75 e9                	jne    80105170 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80105187:	8b 45 08             	mov    0x8(%ebp),%eax
8010518a:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105191:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105194:	8b 45 08             	mov    0x8(%ebp),%eax
80105197:	83 c0 0c             	add    $0xc,%eax
8010519a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010519e:	8d 45 08             	lea    0x8(%ebp),%eax
801051a1:	89 04 24             	mov    %eax,(%esp)
801051a4:	e8 51 00 00 00       	call   801051fa <getcallerpcs>
}
801051a9:	c9                   	leave  
801051aa:	c3                   	ret    
...
801051b7:	e8 b7 00 00 00       	call   80105273 <holding>
801051bc:	85 c0                	test   %eax,%eax
801051be:	75 0c                	jne    801051cc <release+0x21>
    panic("release");
801051c0:	c7 04 24 c0 8b 10 80 	movl   $0x80108bc0,(%esp)
801051c7:	e8 6e b3 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
801051cc:	8b 45 08             	mov    0x8(%ebp),%eax
801051cf:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
801051e3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801051ea:	00 
801051eb:	89 04 24             	mov    %eax,(%esp)
801051ee:	e8 1b ff ff ff       	call   8010510e <xchg>

  popcli();
801051f3:	e8 e9 00 00 00       	call   801052e1 <popcli>
}
801051f8:	c9                   	leave  
801051f9:	c3                   	ret    

801051fa <getcallerpcs>:
...
80105203:	83 e8 08             	sub    $0x8,%eax
80105206:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105209:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105210:	eb 38                	jmp    8010524a <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105212:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105216:	74 38                	je     80105250 <getcallerpcs+0x56>
80105218:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
8010521f:	76 2f                	jbe    80105250 <getcallerpcs+0x56>
80105221:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105225:	74 29                	je     80105250 <getcallerpcs+0x56>
      break;
...
80105239:	8b 40 04             	mov    0x4(%eax),%eax
8010523c:	89 02                	mov    %eax,(%edx)
...
80105243:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80105246:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010524a:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010524e:	7e c2                	jle    80105212 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105250:	eb 19                	jmp    8010526b <getcallerpcs+0x71>
    pcs[i] = 0;
...
80105261:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105267:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010526b:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010526f:	7e e1                	jle    80105252 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80105271:	c9                   	leave  
80105272:	c3                   	ret    
...
8010527d:	74 17                	je     80105296 <holding+0x23>
8010527f:	8b 45 08             	mov    0x8(%ebp),%eax
80105282:	8b 50 08             	mov    0x8(%eax),%edx
80105285:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010528b:	39 c2                	cmp    %eax,%edx
8010528d:	75 07                	jne    80105296 <holding+0x23>
8010528f:	b8 01 00 00 00       	mov    $0x1,%eax
80105294:	eb 05                	jmp    8010529b <holding+0x28>
...
801052a0:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
801052a3:	e8 4a fe ff ff       	call   801050f2 <readeflags>
801052a8:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
801052ab:	e8 52 fe ff ff       	call   80105102 <cli>
  if(cpu->ncli++ == 0)
801052b0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801052b7:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
801052bd:	8d 48 01             	lea    0x1(%eax),%ecx
801052c0:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
801052c6:	85 c0                	test   %eax,%eax
801052c8:	75 15                	jne    801052df <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
801052ca:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801052d0:	8b 55 fc             	mov    -0x4(%ebp),%edx
801052d3:	81 e2 00 02 00 00    	and    $0x200,%edx
801052d9:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801052df:	c9                   	leave  
801052e0:	c3                   	ret    
...
801052e4:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
801052e7:	e8 06 fe ff ff       	call   801050f2 <readeflags>
801052ec:	25 00 02 00 00       	and    $0x200,%eax
801052f1:	85 c0                	test   %eax,%eax
801052f3:	74 0c                	je     80105301 <popcli+0x20>
    panic("popcli - interruptible");
801052f5:	c7 04 24 c8 8b 10 80 	movl   $0x80108bc8,(%esp)
801052fc:	e8 39 b2 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
...
8010531e:	79 0c                	jns    8010532c <popcli+0x4b>
    panic("popcli");
80105320:	c7 04 24 df 8b 10 80 	movl   $0x80108bdf,(%esp)
80105327:	e8 0e b2 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010532c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105332:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105338:	85 c0                	test   %eax,%eax
8010533a:	75 15                	jne    80105351 <popcli+0x70>
8010533c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105342:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105348:	85 c0                	test   %eax,%eax
8010534a:	74 05                	je     80105351 <popcli+0x70>
    sti();
8010534c:	e8 b7 fd ff ff       	call   80105108 <sti>
}
80105351:	c9                   	leave  
80105352:	c3                   	ret    
...
80105367:	fc                   	cld    
80105368:	f3 aa                	rep stos %al,%es:(%edi)
...
8010538c:	fc                   	cld    
8010538d:	f3 ab                	rep stos %eax,%es:(%edi)
...
801053ab:	75 49                	jne    801053f6 <memset+0x59>
801053ad:	8b 45 10             	mov    0x10(%ebp),%eax
801053b0:	83 e0 03             	and    $0x3,%eax
801053b3:	85 c0                	test   %eax,%eax
801053b5:	75 3f                	jne    801053f6 <memset+0x59>
    c &= 0xFF;
801053b7:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801053be:	8b 45 10             	mov    0x10(%ebp),%eax
801053c1:	c1 e8 02             	shr    $0x2,%eax
801053c4:	89 c2                	mov    %eax,%edx
801053c6:	8b 45 0c             	mov    0xc(%ebp),%eax
801053c9:	c1 e0 18             	shl    $0x18,%eax
801053cc:	89 c1                	mov    %eax,%ecx
801053ce:	8b 45 0c             	mov    0xc(%ebp),%eax
801053d1:	c1 e0 10             	shl    $0x10,%eax
801053d4:	09 c1                	or     %eax,%ecx
801053d6:	8b 45 0c             	mov    0xc(%ebp),%eax
801053d9:	c1 e0 08             	shl    $0x8,%eax
801053dc:	09 c8                	or     %ecx,%eax
801053de:	0b 45 0c             	or     0xc(%ebp),%eax
801053e1:	89 54 24 08          	mov    %edx,0x8(%esp)
801053e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801053e9:	8b 45 08             	mov    0x8(%ebp),%eax
801053ec:	89 04 24             	mov    %eax,(%esp)
801053ef:	e8 84 ff ff ff       	call   80105378 <stosl>
801053f4:	eb 19                	jmp    8010540f <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010540a:	e8 44 ff ff ff       	call   80105353 <stosb>
  return dst;
...
80105417:	83 ec 10             	sub    $0x10,%esp
  const uchar *s1, *s2;
  
  s1 = v1;
8010541a:	8b 45 08             	mov    0x8(%ebp),%eax
8010541d:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
80105420:	8b 45 0c             	mov    0xc(%ebp),%eax
80105423:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105426:	eb 30                	jmp    80105458 <memcmp+0x44>
    if(*s1 != *s2)
...
80105463:	75 c3                	jne    80105428 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105475:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
80105478:	8b 45 08             	mov    0x8(%ebp),%eax
8010547b:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
8010547e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105481:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105484:	73 3d                	jae    801054c3 <memmove+0x57>
80105486:	8b 45 10             	mov    0x10(%ebp),%eax
80105489:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010548c:	01 d0                	add    %edx,%eax
8010548e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105491:	76 30                	jbe    801054c3 <memmove+0x57>
    s += n;
80105493:	8b 45 10             	mov    0x10(%ebp),%eax
80105496:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105499:	8b 45 10             	mov    0x10(%ebp),%eax
8010549c:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
8010549f:	eb 13                	jmp    801054b4 <memmove+0x48>
      *--d = *--s;
801054a1:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801054a5:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
801054a9:	8b 45 fc             	mov    -0x4(%ebp),%eax
801054ac:	0f b6 10             	movzbl (%eax),%edx
...
801054bf:	75 e0                	jne    801054a1 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801054c1:	eb 26                	jmp    801054e9 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
801054c3:	eb 17                	jmp    801054dc <memmove+0x70>
      *d++ = *s++;
801054c5:	8b 45 f8             	mov    -0x8(%ebp),%eax
801054c8:	8d 50 01             	lea    0x1(%eax),%edx
801054cb:	89 55 f8             	mov    %edx,-0x8(%ebp)
801054ce:	8b 55 fc             	mov    -0x4(%ebp),%edx
801054d1:	8d 4a 01             	lea    0x1(%edx),%ecx
801054d4:	89 4d fc             	mov    %ecx,-0x4(%ebp)
801054d7:	0f b6 12             	movzbl (%edx),%edx
...
801054e7:	75 dc                	jne    801054c5 <memmove+0x59>
      *d++ = *s++;
...
80105508:	e8 5f ff ff ff       	call   8010546c <memmove>
}
8010550d:	c9                   	leave  
8010550e:	c3                   	ret    
...
8010557d:	7e 1e                	jle    8010559d <strncpy+0x38>
...
801056ee:	8b 50 44             	mov    0x44(%eax),%edx
801056f1:	8b 45 08             	mov    0x8(%ebp),%eax
801056f4:	c1 e0 02             	shl    $0x2,%eax
801056f7:	01 d0                	add    %edx,%eax
801056f9:	8d 50 04             	lea    0x4(%eax),%edx
801056fc:	8b 45 0c             	mov    0xc(%ebp),%eax
801056ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80105703:	89 14 24             	mov    %edx,(%esp)
80105706:	e8 38 ff ff ff       	call   80105643 <fetchint>
}
8010570b:	c9                   	leave  
8010570c:	c3                   	ret    
...
8010573d:	39 c2                	cmp    %eax,%edx
8010573f:	73 16                	jae    80105757 <argptr+0x4a>
...
80105755:	76 07                	jbe    8010575e <argptr+0x51>
    return -1;
80105757:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010575c:	eb 0f                	jmp    8010576d <argptr+0x60>
  *pp = (char*)i;
8010575e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105761:	89 c2                	mov    %eax,%edx
...
80105782:	e8 58 ff ff ff       	call   801056df <argint>
80105787:	85 c0                	test   %eax,%eax
80105789:	79 07                	jns    80105792 <argstr+0x23>
    return -1;
8010578b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105790:	eb 12                	jmp    801057a4 <argstr+0x35>
...
8010579f:	e8 d9 fe ff ff       	call   8010567d <fetchstr>
}
801057a4:	c9                   	leave  
801057a5:	c3                   	ret    
...
801057aa:	83 ec 24             	sub    $0x24,%esp
  int num;
...
801057c0:	7e 30                	jle    801057f2 <syscall+0x4c>
801057c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057c5:	83 f8 19             	cmp    $0x19,%eax
801057c8:	77 28                	ja     801057f2 <syscall+0x4c>
801057ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057cd:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801057d4:	85 c0                	test   %eax,%eax
801057d6:	74 1a                	je     801057f2 <syscall+0x4c>
...
801057ed:	89 43 1c             	mov    %eax,0x1c(%ebx)
801057f0:	eb 3d                	jmp    8010582f <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801057f2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057f8:	8d 48 6c             	lea    0x6c(%eax),%ecx
801057fb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105801:	8b 40 10             	mov    0x10(%eax),%eax
80105804:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105807:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010580b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010580f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105813:	c7 04 24 e6 8b 10 80 	movl   $0x80108be6,(%esp)
8010581a:	e8 81 ab ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
8010581f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105825:	8b 40 18             	mov    0x18(%eax),%eax
80105828:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
8010582f:	83 c4 24             	add    $0x24,%esp
80105832:	5b                   	pop    %ebx
80105833:	5d                   	pop    %ebp
80105834:	c3                   	ret    
...
80105848:	e8 92 fe ff ff       	call   801056df <argint>
8010584d:	85 c0                	test   %eax,%eax
8010584f:	79 07                	jns    80105858 <argfd+0x23>
    return -1;
80105851:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105856:	eb 50                	jmp    801058a8 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105858:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010585b:	85 c0                	test   %eax,%eax
8010585d:	78 21                	js     80105880 <argfd+0x4b>
8010585f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105862:	83 f8 0f             	cmp    $0xf,%eax
80105865:	7f 19                	jg     80105880 <argfd+0x4b>
80105867:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010586d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105870:	83 c2 08             	add    $0x8,%edx
80105873:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105877:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010587a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010587e:	75 07                	jne    80105887 <argfd+0x52>
    return -1;
80105880:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105885:	eb 21                	jmp    801058a8 <argfd+0x73>
  if(pfd)
80105887:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010588b:	74 08                	je     80105895 <argfd+0x60>
    *pfd = fd;
...
80105899:	74 08                	je     801058a3 <argfd+0x6e>
    *pf = f;
...
801058ad:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
801058b0:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801058b7:	eb 30                	jmp    801058e9 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
801058b9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058bf:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058c2:	83 c2 08             	add    $0x8,%edx
801058c5:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801058c9:	85 c0                	test   %eax,%eax
801058cb:	75 18                	jne    801058e5 <fdalloc+0x3b>
      proc->ofile[fd] = f;
801058cd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058d3:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058d6:	8d 4a 08             	lea    0x8(%edx),%ecx
801058d9:	8b 55 08             	mov    0x8(%ebp),%edx
801058dc:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801058e0:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058e3:	eb 0f                	jmp    801058f4 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
801058e5:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801058e9:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801058ed:	7e ca                	jle    801058b9 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105903:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010590a:	00 
8010590b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105912:	e8 1e ff ff ff       	call   80105835 <argfd>
80105917:	85 c0                	test   %eax,%eax
80105919:	79 07                	jns    80105922 <sys_dup+0x2c>
    return -1;
8010591b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105920:	eb 29                	jmp    8010594b <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105922:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105925:	89 04 24             	mov    %eax,(%esp)
80105928:	e8 7d ff ff ff       	call   801058aa <fdalloc>
8010592d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105930:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105934:	79 07                	jns    8010593d <sys_dup+0x47>
    return -1;
80105936:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010593b:	eb 0e                	jmp    8010594b <sys_dup+0x55>
  filedup(f);
8010593d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105940:	89 04 24             	mov    %eax,(%esp)
80105943:	e8 4b b6 ff ff       	call   80100f93 <filedup>
  return fd;
...
80105950:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
8010595a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105961:	00 
80105962:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105969:	e8 c7 fe ff ff       	call   80105835 <argfd>
8010596e:	85 c0                	test   %eax,%eax
80105970:	78 35                	js     801059a7 <sys_read+0x5a>
80105972:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105975:	89 44 24 04          	mov    %eax,0x4(%esp)
80105979:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105980:	e8 5a fd ff ff       	call   801056df <argint>
80105985:	85 c0                	test   %eax,%eax
80105987:	78 1e                	js     801059a7 <sys_read+0x5a>
80105989:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010598c:	89 44 24 08          	mov    %eax,0x8(%esp)
80105990:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105993:	89 44 24 04          	mov    %eax,0x4(%esp)
80105997:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010599e:	e8 6a fd ff ff       	call   8010570d <argptr>
801059a3:	85 c0                	test   %eax,%eax
801059a5:	79 07                	jns    801059ae <sys_read+0x61>
    return -1;
801059a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059ac:	eb 19                	jmp    801059c7 <sys_read+0x7a>
  return fileread(f, p, n);
801059ae:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801059b1:	8b 55 ec             	mov    -0x14(%ebp),%edx
801059b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059b7:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801059bb:	89 54 24 04          	mov    %edx,0x4(%esp)
801059bf:	89 04 24             	mov    %eax,(%esp)
801059c2:	e8 39 b7 ff ff       	call   80101100 <fileread>
}
801059c7:	c9                   	leave  
801059c8:	c3                   	ret    
...
801059d2:	89 44 24 08          	mov    %eax,0x8(%esp)
801059d6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801059dd:	00 
801059de:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059e5:	e8 4b fe ff ff       	call   80105835 <argfd>
801059ea:	85 c0                	test   %eax,%eax
801059ec:	78 35                	js     80105a23 <sys_write+0x5a>
801059ee:	8d 45 f0             	lea    -0x10(%ebp),%eax
801059f1:	89 44 24 04          	mov    %eax,0x4(%esp)
801059f5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801059fc:	e8 de fc ff ff       	call   801056df <argint>
80105a01:	85 c0                	test   %eax,%eax
80105a03:	78 1e                	js     80105a23 <sys_write+0x5a>
80105a05:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a08:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a0c:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105a0f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a1a:	e8 ee fc ff ff       	call   8010570d <argptr>
80105a1f:	85 c0                	test   %eax,%eax
80105a21:	79 07                	jns    80105a2a <sys_write+0x61>
    return -1;
80105a23:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a28:	eb 19                	jmp    80105a43 <sys_write+0x7a>
  return filewrite(f, p, n);
80105a2a:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105a2d:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105a30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a33:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105a37:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a3b:	89 04 24             	mov    %eax,(%esp)
80105a3e:	e8 79 b7 ff ff       	call   801011bc <filewrite>
}
80105a43:	c9                   	leave  
80105a44:	c3                   	ret    
...
80105a60:	e8 d0 fd ff ff       	call   80105835 <argfd>
80105a65:	85 c0                	test   %eax,%eax
80105a67:	79 07                	jns    80105a70 <sys_close+0x2b>
    return -1;
80105a69:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a6e:	eb 24                	jmp    80105a94 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105a70:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a76:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105a79:	83 c2 08             	add    $0x8,%edx
80105a7c:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105a83:	00 
  fileclose(f);
80105a84:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a87:	89 04 24             	mov    %eax,(%esp)
80105a8a:	e8 4c b5 ff ff       	call   80100fdb <fileclose>
  return 0;
...
80105ab2:	e8 7e fd ff ff       	call   80105835 <argfd>
80105ab7:	85 c0                	test   %eax,%eax
80105ab9:	78 1f                	js     80105ada <sys_fstat+0x44>
80105abb:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105ac2:	00 
80105ac3:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105ac6:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105ad1:	e8 37 fc ff ff       	call   8010570d <argptr>
80105ad6:	85 c0                	test   %eax,%eax
80105ad8:	79 07                	jns    80105ae1 <sys_fstat+0x4b>
    return -1;
80105ada:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105adf:	eb 12                	jmp    80105af3 <sys_fstat+0x5d>
  return filestat(f, st);
80105ae1:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105ae4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ae7:	89 54 24 04          	mov    %edx,0x4(%esp)
80105aeb:	89 04 24             	mov    %eax,(%esp)
80105aee:	e8 be b5 ff ff       	call   801010b1 <filestat>
}
80105af3:	c9                   	leave  
80105af4:	c3                   	ret    
...
80105af8:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105afb:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105afe:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b02:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b09:	e8 61 fc ff ff       	call   8010576f <argstr>
80105b0e:	85 c0                	test   %eax,%eax
80105b10:	78 17                	js     80105b29 <sys_link+0x34>
80105b12:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105b15:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b19:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105b20:	e8 4a fc ff ff       	call   8010576f <argstr>
80105b25:	85 c0                	test   %eax,%eax
80105b27:	79 0a                	jns    80105b33 <sys_link+0x3e>
    return -1;
80105b29:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b2e:	e9 42 01 00 00       	jmp    80105c75 <sys_link+0x180>

  begin_op();
80105b33:	e8 e5 d8 ff ff       	call   8010341d <begin_op>
  if((ip = namei(old)) == 0){
80105b38:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105b3b:	89 04 24             	mov    %eax,(%esp)
80105b3e:	e8 d0 c8 ff ff       	call   80102413 <namei>
80105b43:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105b46:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b4a:	75 0f                	jne    80105b5b <sys_link+0x66>
    end_op();
80105b4c:	e8 50 d9 ff ff       	call   801034a1 <end_op>
    return -1;
80105b51:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b56:	e9 1a 01 00 00       	jmp    80105c75 <sys_link+0x180>
  }

  ilock(ip);
80105b5b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5e:	89 04 24             	mov    %eax,(%esp)
80105b61:	e8 02 bd ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105b66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b69:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b6d:	66 83 f8 01          	cmp    $0x1,%ax
80105b71:	75 1a                	jne    80105b8d <sys_link+0x98>
    iunlockput(ip);
80105b73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b76:	89 04 24             	mov    %eax,(%esp)
80105b79:	e8 6e bf ff ff       	call   80101aec <iunlockput>
    end_op();
80105b7e:	e8 1e d9 ff ff       	call   801034a1 <end_op>
    return -1;
80105b83:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b88:	e9 e8 00 00 00       	jmp    80105c75 <sys_link+0x180>
  }
...
80105ba4:	e8 03 bb ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80105ba9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bac:	89 04 24             	mov    %eax,(%esp)
80105baf:	e8 02 be ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105bb4:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105bb7:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105bba:	89 54 24 04          	mov    %edx,0x4(%esp)
80105bbe:	89 04 24             	mov    %eax,(%esp)
80105bc1:	e8 6f c8 ff ff       	call   80102435 <nameiparent>
80105bc6:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105bc9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105bcd:	75 02                	jne    80105bd1 <sys_link+0xdc>
    goto bad;
80105bcf:	eb 68                	jmp    80105c39 <sys_link+0x144>
  ilock(dp);
...
80105bdf:	8b 10                	mov    (%eax),%edx
80105be1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105be4:	8b 00                	mov    (%eax),%eax
80105be6:	39 c2                	cmp    %eax,%edx
80105be8:	75 20                	jne    80105c0a <sys_link+0x115>
80105bea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bed:	8b 40 04             	mov    0x4(%eax),%eax
80105bf0:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bf4:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105bf7:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bfb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bfe:	89 04 24             	mov    %eax,(%esp)
80105c01:	e8 4d c5 ff ff       	call   80102153 <dirlink>
80105c06:	85 c0                	test   %eax,%eax
80105c08:	79 0d                	jns    80105c17 <sys_link+0x122>
    iunlockput(dp);
80105c0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c0d:	89 04 24             	mov    %eax,(%esp)
80105c10:	e8 d7 be ff ff       	call   80101aec <iunlockput>
    goto bad;
80105c15:	eb 22                	jmp    80105c39 <sys_link+0x144>
  }
  iunlockput(dp);
80105c17:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c1a:	89 04 24             	mov    %eax,(%esp)
80105c1d:	e8 ca be ff ff       	call   80101aec <iunlockput>
  iput(ip);
80105c22:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c25:	89 04 24             	mov    %eax,(%esp)
80105c28:	e8 ee bd ff ff       	call   80101a1b <iput>

  end_op();
80105c2d:	e8 6f d8 ff ff       	call   801034a1 <end_op>

  return 0;
80105c32:	b8 00 00 00 00       	mov    $0x0,%eax
80105c37:	eb 3c                	jmp    80105c75 <sys_link+0x180>

bad:
  ilock(ip);
80105c39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c3c:	89 04 24             	mov    %eax,(%esp)
80105c3f:	e8 24 bc ff ff       	call   80101868 <ilock>
  ip->nlink--;
...
80105c5b:	e8 4c ba ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105c60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c63:	89 04 24             	mov    %eax,(%esp)
80105c66:	e8 81 be ff ff       	call   80101aec <iunlockput>
  end_op();
80105c6b:	e8 31 d8 ff ff       	call   801034a1 <end_op>
  return -1;
...
80105c7a:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105c7d:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105c84:	eb 4b                	jmp    80105cd1 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105c86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c89:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105c90:	00 
...
80105ca2:	e8 ce c0 ff ff       	call   80101d75 <readi>
80105ca7:	83 f8 10             	cmp    $0x10,%eax
80105caa:	74 0c                	je     80105cb8 <isdirempty+0x41>
      panic("isdirempty: readi");
80105cac:	c7 04 24 02 8c 10 80 	movl   $0x80108c02,(%esp)
80105cb3:	e8 82 a8 ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105cb8:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105cbc:	66 85 c0             	test   %ax,%ax
80105cbf:	74 07                	je     80105cc8 <isdirempty+0x51>
      return 0;
80105cc1:	b8 00 00 00 00       	mov    $0x0,%eax
80105cc6:	eb 1b                	jmp    80105ce3 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105cdc:	72 a8                	jb     80105c86 <isdirempty+0xf>
  ...
  return 1;
80105cde:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105ce3:	c9                   	leave  
80105ce4:	c3                   	ret    
...
80105ce8:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105ceb:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105cee:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cf2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105cf9:	e8 71 fa ff ff       	call   8010576f <argstr>
80105cfe:	85 c0                	test   %eax,%eax
80105d00:	79 0a                	jns    80105d0c <sys_unlink+0x27>
    return -1;
80105d02:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d07:	e9 af 01 00 00       	jmp    80105ebb <sys_unlink+0x1d6>

  begin_op();
80105d0c:	e8 0c d7 ff ff       	call   8010341d <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105d11:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105d14:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105d17:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d1b:	89 04 24             	mov    %eax,(%esp)
80105d1e:	e8 12 c7 ff ff       	call   80102435 <nameiparent>
80105d23:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d26:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d2a:	75 0f                	jne    80105d3b <sys_unlink+0x56>
    end_op();
80105d2c:	e8 70 d7 ff ff       	call   801034a1 <end_op>
    return -1;
80105d31:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d36:	e9 80 01 00 00       	jmp    80105ebb <sys_unlink+0x1d6>
  }

  ilock(dp);
80105d3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d3e:	89 04 24             	mov    %eax,(%esp)
80105d41:	e8 22 bb ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105d46:	c7 44 24 04 14 8c 10 	movl   $0x80108c14,0x4(%esp)
80105d4d:	80 
80105d4e:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105d51:	89 04 24             	mov    %eax,(%esp)
80105d54:	e8 0f c3 ff ff       	call   80102068 <namecmp>
80105d59:	85 c0                	test   %eax,%eax
80105d5b:	0f 84 45 01 00 00    	je     80105ea6 <sys_unlink+0x1c1>
80105d61:	c7 44 24 04 16 8c 10 	movl   $0x80108c16,0x4(%esp)
80105d68:	80 
80105d69:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105d6c:	89 04 24             	mov    %eax,(%esp)
80105d6f:	e8 f4 c2 ff ff       	call   80102068 <namecmp>
80105d74:	85 c0                	test   %eax,%eax
80105d76:	0f 84 2a 01 00 00    	je     80105ea6 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105d7c:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105d7f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d83:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105d86:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d8a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d8d:	89 04 24             	mov    %eax,(%esp)
80105d90:	e8 f5 c2 ff ff       	call   8010208a <dirlookup>
80105d95:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d98:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d9c:	75 05                	jne    80105da3 <sys_unlink+0xbe>
    goto bad;
80105d9e:	e9 03 01 00 00       	jmp    80105ea6 <sys_unlink+0x1c1>
  ilock(ip);
80105da3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105da6:	89 04 24             	mov    %eax,(%esp)
80105da9:	e8 ba ba ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80105dae:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105db1:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105db5:	66 85 c0             	test   %ax,%ax
80105db8:	7f 0c                	jg     80105dc6 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105dba:	c7 04 24 19 8c 10 80 	movl   $0x80108c19,(%esp)
80105dc1:	e8 74 a7 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105dc6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dc9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105dcd:	66 83 f8 01          	cmp    $0x1,%ax
80105dd1:	75 1f                	jne    80105df2 <sys_unlink+0x10d>
80105dd3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dd6:	89 04 24             	mov    %eax,(%esp)
80105dd9:	e8 99 fe ff ff       	call   80105c77 <isdirempty>
80105dde:	85 c0                	test   %eax,%eax
80105de0:	75 10                	jne    80105df2 <sys_unlink+0x10d>
    iunlockput(ip);
80105de2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de5:	89 04 24             	mov    %eax,(%esp)
80105de8:	e8 ff bc ff ff       	call   80101aec <iunlockput>
    goto bad;
80105ded:	e9 b4 00 00 00       	jmp    80105ea6 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105df2:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105df9:	00 
80105dfa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105e01:	00 
80105e02:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105e05:	89 04 24             	mov    %eax,(%esp)
80105e08:	e8 90 f5 ff ff       	call   8010539d <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105e0d:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105e10:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105e17:	00 
80105e18:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e1c:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105e1f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e26:	89 04 24             	mov    %eax,(%esp)
80105e29:	e8 ab c0 ff ff       	call   80101ed9 <writei>
80105e2e:	83 f8 10             	cmp    $0x10,%eax
80105e31:	74 0c                	je     80105e3f <sys_unlink+0x15a>
    panic("unlink: writei");
80105e33:	c7 04 24 2b 8c 10 80 	movl   $0x80108c2b,(%esp)
80105e3a:	e8 fb a6 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105e3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e42:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e46:	66 83 f8 01          	cmp    $0x1,%ax
80105e4a:	75 1c                	jne    80105e68 <sys_unlink+0x183>
    dp->nlink--;
80105e4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e4f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105e53:	8d 50 ff             	lea    -0x1(%eax),%edx
80105e56:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e59:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105e5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e60:	89 04 24             	mov    %eax,(%esp)
80105e63:	e8 44 b8 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
80105e68:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e6b:	89 04 24             	mov    %eax,(%esp)
80105e6e:	e8 79 bc ff ff       	call   80101aec <iunlockput>
...
80105e95:	e8 52 bc ff ff       	call   80101aec <iunlockput>
  ...
  end_op();
80105e9a:	e8 02 d6 ff ff       	call   801034a1 <end_op>

  return 0;
80105e9f:	b8 00 00 00 00       	mov    $0x0,%eax
80105ea4:	eb 15                	jmp    80105ebb <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ea9:	89 04 24             	mov    %eax,(%esp)
80105eac:	e8 3b bc ff ff       	call   80101aec <iunlockput>
  end_op();
80105eb1:	e8 eb d5 ff ff       	call   801034a1 <end_op>
  return -1;
...
80105ec0:	83 ec 48             	sub    $0x48,%esp
80105ec3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105ec6:	8b 55 10             	mov    0x10(%ebp),%edx
80105ec9:	8b 45 14             	mov    0x14(%ebp),%eax
80105ecc:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105ed0:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105ed4:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105ed8:	8d 45 de             	lea    -0x22(%ebp),%eax
80105edb:	89 44 24 04          	mov    %eax,0x4(%esp)
80105edf:	8b 45 08             	mov    0x8(%ebp),%eax
80105ee2:	89 04 24             	mov    %eax,(%esp)
80105ee5:	e8 4b c5 ff ff       	call   80102435 <nameiparent>
80105eea:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105eed:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ef1:	75 0a                	jne    80105efd <create+0x40>
    return 0;
80105ef3:	b8 00 00 00 00       	mov    $0x0,%eax
80105ef8:	e9 7e 01 00 00       	jmp    8010607b <create+0x1be>
  ilock(dp);
80105efd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f00:	89 04 24             	mov    %eax,(%esp)
80105f03:	e8 60 b9 ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105f08:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105f0b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f0f:	8d 45 de             	lea    -0x22(%ebp),%eax
80105f12:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f19:	89 04 24             	mov    %eax,(%esp)
80105f1c:	e8 69 c1 ff ff       	call   8010208a <dirlookup>
80105f21:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f24:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f28:	74 47                	je     80105f71 <create+0xb4>
    iunlockput(dp);
80105f2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f2d:	89 04 24             	mov    %eax,(%esp)
80105f30:	e8 b7 bb ff ff       	call   80101aec <iunlockput>
    ilock(ip);
80105f35:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f38:	89 04 24             	mov    %eax,(%esp)
80105f3b:	e8 28 b9 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105f40:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105f45:	75 15                	jne    80105f5c <create+0x9f>
80105f47:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f4a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f4e:	66 83 f8 02          	cmp    $0x2,%ax
80105f52:	75 08                	jne    80105f5c <create+0x9f>
      return ip;
80105f54:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f57:	e9 1f 01 00 00       	jmp    8010607b <create+0x1be>
    iunlockput(ip);
80105f5c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f5f:	89 04 24             	mov    %eax,(%esp)
80105f62:	e8 85 bb ff ff       	call   80101aec <iunlockput>
    return 0;
80105f67:	b8 00 00 00 00       	mov    $0x0,%eax
80105f6c:	e9 0a 01 00 00       	jmp    8010607b <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105f71:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105f75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f78:	8b 00                	mov    (%eax),%eax
80105f7a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105f7e:	89 04 24             	mov    %eax,(%esp)
80105f81:	e8 47 b6 ff ff       	call   801015cd <ialloc>
80105f86:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f89:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f8d:	75 0c                	jne    80105f9b <create+0xde>
    panic("create: ialloc");
80105f8f:	c7 04 24 3a 8c 10 80 	movl   $0x80108c3a,(%esp)
80105f96:	e8 9f a5 ff ff       	call   8010053a <panic>

  ilock(ip);
80105f9b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f9e:	89 04 24             	mov    %eax,(%esp)
80105fa1:	e8 c2 b8 ff ff       	call   80101868 <ilock>
  ip->major = major;
80105fa6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa9:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105fad:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105fb1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fb4:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105fb8:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105fbc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fbf:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105fc5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fc8:	89 04 24             	mov    %eax,(%esp)
80105fcb:	e8 dc b6 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105fd0:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105fd5:	75 6a                	jne    80106041 <create+0x184>
    dp->nlink++;  // for ".."
...
80105ff6:	8b 40 04             	mov    0x4(%eax),%eax
80105ff9:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ffd:	c7 44 24 04 14 8c 10 	movl   $0x80108c14,0x4(%esp)
80106004:	80 
80106005:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106008:	89 04 24             	mov    %eax,(%esp)
8010600b:	e8 43 c1 ff ff       	call   80102153 <dirlink>
80106010:	85 c0                	test   %eax,%eax
80106012:	78 21                	js     80106035 <create+0x178>
80106014:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106017:	8b 40 04             	mov    0x4(%eax),%eax
8010601a:	89 44 24 08          	mov    %eax,0x8(%esp)
8010601e:	c7 44 24 04 16 8c 10 	movl   $0x80108c16,0x4(%esp)
80106025:	80 
80106026:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106029:	89 04 24             	mov    %eax,(%esp)
8010602c:	e8 22 c1 ff ff       	call   80102153 <dirlink>
80106031:	85 c0                	test   %eax,%eax
80106033:	79 0c                	jns    80106041 <create+0x184>
      panic("create dots");
80106035:	c7 04 24 49 8c 10 80 	movl   $0x80108c49,(%esp)
...
8010604b:	8d 45 de             	lea    -0x22(%ebp),%eax
8010604e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106052:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106055:	89 04 24             	mov    %eax,(%esp)
80106058:	e8 f6 c0 ff ff       	call   80102153 <dirlink>
8010605d:	85 c0                	test   %eax,%eax
8010605f:	79 0c                	jns    8010606d <create+0x1b0>
    panic("create: dirlink");
80106061:	c7 04 24 55 8c 10 80 	movl   $0x80108c55,(%esp)
80106068:	e8 cd a4 ff ff       	call   8010053a <panic>

  iunlockput(dp);
8010606d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106070:	89 04 24             	mov    %eax,(%esp)
80106073:	e8 74 ba ff ff       	call   80101aec <iunlockput>
...
80106080:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106083:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106086:	89 44 24 04          	mov    %eax,0x4(%esp)
8010608a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106091:	e8 d9 f6 ff ff       	call   8010576f <argstr>
80106096:	85 c0                	test   %eax,%eax
80106098:	78 17                	js     801060b1 <sys_open+0x34>
8010609a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010609d:	89 44 24 04          	mov    %eax,0x4(%esp)
801060a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060a8:	e8 32 f6 ff ff       	call   801056df <argint>
801060ad:	85 c0                	test   %eax,%eax
801060af:	79 0a                	jns    801060bb <sys_open+0x3e>
    return -1;
801060b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060b6:	e9 5c 01 00 00       	jmp    80106217 <sys_open+0x19a>

  begin_op();
801060bb:	e8 5d d3 ff ff       	call   8010341d <begin_op>

  if(omode & O_CREATE){
801060c0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801060c3:	25 00 02 00 00       	and    $0x200,%eax
801060c8:	85 c0                	test   %eax,%eax
801060ca:	74 3b                	je     80106107 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
801060cc:	8b 45 e8             	mov    -0x18(%ebp),%eax
801060cf:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801060d6:	00 
801060d7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801060de:	00 
801060df:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801060e6:	00 
801060e7:	89 04 24             	mov    %eax,(%esp)
801060ea:	e8 ce fd ff ff       	call   80105ebd <create>
801060ef:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
801060f2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060f6:	75 6b                	jne    80106163 <sys_open+0xe6>
      end_op();
801060f8:	e8 a4 d3 ff ff       	call   801034a1 <end_op>
      return -1;
801060fd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106102:	e9 10 01 00 00       	jmp    80106217 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80106107:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010610a:	89 04 24             	mov    %eax,(%esp)
8010610d:	e8 01 c3 ff ff       	call   80102413 <namei>
80106112:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106115:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106119:	75 0f                	jne    8010612a <sys_open+0xad>
      end_op();
8010611b:	e8 81 d3 ff ff       	call   801034a1 <end_op>
      return -1;
80106120:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106125:	e9 ed 00 00 00       	jmp    80106217 <sys_open+0x19a>
    }
    ilock(ip);
8010612a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010612d:	89 04 24             	mov    %eax,(%esp)
80106130:	e8 33 b7 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106135:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106138:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010613c:	66 83 f8 01          	cmp    $0x1,%ax
80106140:	75 21                	jne    80106163 <sys_open+0xe6>
80106142:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106145:	85 c0                	test   %eax,%eax
80106147:	74 1a                	je     80106163 <sys_open+0xe6>
      iunlockput(ip);
80106149:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010614c:	89 04 24             	mov    %eax,(%esp)
8010614f:	e8 98 b9 ff ff       	call   80101aec <iunlockput>
      end_op();
80106154:	e8 48 d3 ff ff       	call   801034a1 <end_op>
      return -1;
80106159:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010615e:	e9 b4 00 00 00       	jmp    80106217 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106163:	e8 cb ad ff ff       	call   80100f33 <filealloc>
80106168:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010616b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010616f:	74 14                	je     80106185 <sys_open+0x108>
80106171:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106174:	89 04 24             	mov    %eax,(%esp)
80106177:	e8 2e f7 ff ff       	call   801058aa <fdalloc>
8010617c:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010617f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106183:	79 28                	jns    801061ad <sys_open+0x130>
    if(f)
80106185:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106189:	74 0b                	je     80106196 <sys_open+0x119>
      fileclose(f);
8010618b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010618e:	89 04 24             	mov    %eax,(%esp)
80106191:	e8 45 ae ff ff       	call   80100fdb <fileclose>
    iunlockput(ip);
80106196:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106199:	89 04 24             	mov    %eax,(%esp)
8010619c:	e8 4b b9 ff ff       	call   80101aec <iunlockput>
    end_op();
801061a1:	e8 fb d2 ff ff       	call   801034a1 <end_op>
    return -1;
801061a6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061ab:	eb 6a                	jmp    80106217 <sys_open+0x19a>
  }
  iunlock(ip);
801061ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061b0:	89 04 24             	mov    %eax,(%esp)
801061b3:	e8 fe b7 ff ff       	call   801019b6 <iunlock>
  end_op();
801061b8:	e8 e4 d2 ff ff       	call   801034a1 <end_op>
...
801061f4:	75 0a                	jne    80106200 <sys_open+0x183>
801061f6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801061f9:	83 e0 02             	and    $0x2,%eax
801061fc:	85 c0                	test   %eax,%eax
801061fe:	74 07                	je     80106207 <sys_open+0x18a>
80106200:	b8 01 00 00 00       	mov    $0x1,%eax
80106205:	eb 05                	jmp    8010620c <sys_open+0x18f>
...
8010621c:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
8010621f:	e8 f9 d1 ff ff       	call   8010341d <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80106224:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106227:	89 44 24 04          	mov    %eax,0x4(%esp)
8010622b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106232:	e8 38 f5 ff ff       	call   8010576f <argstr>
80106237:	85 c0                	test   %eax,%eax
80106239:	78 2c                	js     80106267 <sys_mkdir+0x4e>
8010623b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010623e:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106245:	00 
80106246:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010624d:	00 
8010624e:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106255:	00 
80106256:	89 04 24             	mov    %eax,(%esp)
80106259:	e8 5f fc ff ff       	call   80105ebd <create>
8010625e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106261:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106265:	75 0c                	jne    80106273 <sys_mkdir+0x5a>
    end_op();
80106267:	e8 35 d2 ff ff       	call   801034a1 <end_op>
    return -1;
8010626c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106271:	eb 15                	jmp    80106288 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106273:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106276:	89 04 24             	mov    %eax,(%esp)
80106279:	e8 6e b8 ff ff       	call   80101aec <iunlockput>
  end_op();
8010627e:	e8 1e d2 ff ff       	call   801034a1 <end_op>
  return 0;
...
8010628d:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80106290:	e8 88 d1 ff ff       	call   8010341d <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80106295:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106298:	89 44 24 04          	mov    %eax,0x4(%esp)
8010629c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801062a3:	e8 c7 f4 ff ff       	call   8010576f <argstr>
801062a8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062ab:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062af:	78 5e                	js     8010630f <sys_mknod+0x85>
     argint(1, &major) < 0 ||
801062b1:	8d 45 e8             	lea    -0x18(%ebp),%eax
801062b4:	89 44 24 04          	mov    %eax,0x4(%esp)
801062b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801062bf:	e8 1b f4 ff ff       	call   801056df <argint>
  char *path;
  int len;
  int major, minor;
...
801062c6:	78 47                	js     8010630f <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801062c8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801062cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801062cf:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801062d6:	e8 04 f4 ff ff       	call   801056df <argint>
  int len;
  int major, minor;
...
801062dd:	78 30                	js     8010630f <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
801062df:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062e2:	0f bf c8             	movswl %ax,%ecx
801062e5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062e8:	0f bf d0             	movswl %ax,%edx
801062eb:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801062ee:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801062f2:	89 54 24 08          	mov    %edx,0x8(%esp)
801062f6:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801062fd:	00 
801062fe:	89 04 24             	mov    %eax,(%esp)
80106301:	e8 b7 fb ff ff       	call   80105ebd <create>
80106306:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106309:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010630d:	75 0c                	jne    8010631b <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
8010630f:	e8 8d d1 ff ff       	call   801034a1 <end_op>
    return -1;
80106314:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106319:	eb 15                	jmp    80106330 <sys_mknod+0xa6>
  }
  iunlockput(ip);
...
80106321:	e8 c6 b7 ff ff       	call   80101aec <iunlockput>
  end_op();
80106326:	e8 76 d1 ff ff       	call   801034a1 <end_op>
  return 0;
...
80106335:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106338:	e8 e0 d0 ff ff       	call   8010341d <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
8010633d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106340:	89 44 24 04          	mov    %eax,0x4(%esp)
80106344:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010634b:	e8 1f f4 ff ff       	call   8010576f <argstr>
80106350:	85 c0                	test   %eax,%eax
80106352:	78 14                	js     80106368 <sys_chdir+0x36>
80106354:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106357:	89 04 24             	mov    %eax,(%esp)
8010635a:	e8 b4 c0 ff ff       	call   80102413 <namei>
8010635f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106362:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106366:	75 0c                	jne    80106374 <sys_chdir+0x42>
    end_op();
80106368:	e8 34 d1 ff ff       	call   801034a1 <end_op>
    return -1;
8010636d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106372:	eb 61                	jmp    801063d5 <sys_chdir+0xa3>
  }
  ilock(ip);
80106374:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106377:	89 04 24             	mov    %eax,(%esp)
8010637a:	e8 e9 b4 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
8010637f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106382:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106386:	66 83 f8 01          	cmp    $0x1,%ax
8010638a:	74 17                	je     801063a3 <sys_chdir+0x71>
    iunlockput(ip);
8010638c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010638f:	89 04 24             	mov    %eax,(%esp)
80106392:	e8 55 b7 ff ff       	call   80101aec <iunlockput>
    end_op();
80106397:	e8 05 d1 ff ff       	call   801034a1 <end_op>
    return -1;
8010639c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063a1:	eb 32                	jmp    801063d5 <sys_chdir+0xa3>
  }
  iunlock(ip);
801063a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063a6:	89 04 24             	mov    %eax,(%esp)
801063a9:	e8 08 b6 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
801063ae:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063b4:	8b 40 68             	mov    0x68(%eax),%eax
801063b7:	89 04 24             	mov    %eax,(%esp)
801063ba:	e8 5c b6 ff ff       	call   80101a1b <iput>
  end_op();
801063bf:	e8 dd d0 ff ff       	call   801034a1 <end_op>
  proc->cwd = ip;
...
801063da:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801063e7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063ee:	e8 7c f3 ff ff       	call   8010576f <argstr>
801063f3:	85 c0                	test   %eax,%eax
801063f5:	78 1a                	js     80106411 <sys_exec+0x3a>
801063f7:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801063fd:	89 44 24 04          	mov    %eax,0x4(%esp)
80106401:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106408:	e8 d2 f2 ff ff       	call   801056df <argint>
8010640d:	85 c0                	test   %eax,%eax
8010640f:	79 0a                	jns    8010641b <sys_exec+0x44>
    return -1;
80106411:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106416:	e9 c8 00 00 00       	jmp    801064e3 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
8010641b:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106422:	00 
80106423:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010642a:	00 
8010642b:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106431:	89 04 24             	mov    %eax,(%esp)
80106434:	e8 64 ef ff ff       	call   8010539d <memset>
  for(i=0;; i++){
80106439:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106440:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106443:	83 f8 1f             	cmp    $0x1f,%eax
80106446:	76 0a                	jbe    80106452 <sys_exec+0x7b>
      return -1;
80106448:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010644d:	e9 91 00 00 00       	jmp    801064e3 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106452:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106455:	c1 e0 02             	shl    $0x2,%eax
80106458:	89 c2                	mov    %eax,%edx
8010645a:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106460:	01 c2                	add    %eax,%edx
80106462:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106468:	89 44 24 04          	mov    %eax,0x4(%esp)
8010646c:	89 14 24             	mov    %edx,(%esp)
8010646f:	e8 cf f1 ff ff       	call   80105643 <fetchint>
80106474:	85 c0                	test   %eax,%eax
80106476:	79 07                	jns    8010647f <sys_exec+0xa8>
      return -1;
80106478:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010647d:	eb 64                	jmp    801064e3 <sys_exec+0x10c>
    if(uarg == 0){
8010647f:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106485:	85 c0                	test   %eax,%eax
80106487:	75 26                	jne    801064af <sys_exec+0xd8>
      argv[i] = 0;
80106489:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010648c:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106493:	00 00 00 00 
      break;
80106497:	90                   	nop
    }
...
801064a1:	89 54 24 04          	mov    %edx,0x4(%esp)
801064a5:	89 04 24             	mov    %eax,(%esp)
801064a8:	e8 42 a6 ff ff       	call   80100aef <exec>
801064ad:	eb 34                	jmp    801064e3 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
801064af:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801064b5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801064b8:	c1 e2 02             	shl    $0x2,%edx
801064bb:	01 c2                	add    %eax,%edx
801064bd:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801064c3:	89 54 24 04          	mov    %edx,0x4(%esp)
801064c7:	89 04 24             	mov    %eax,(%esp)
801064ca:	e8 ae f1 ff ff       	call   8010567d <fetchstr>
801064cf:	85 c0                	test   %eax,%eax
801064d1:	79 07                	jns    801064da <sys_exec+0x103>
      return -1;
801064d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064d8:	eb 09                	jmp    801064e3 <sys_exec+0x10c>
...
801064de:	e9 5d ff ff ff       	jmp    80106440 <sys_exec+0x69>
  return exec(path, argv);
}
801064e3:	c9                   	leave  
801064e4:	c3                   	ret    
...
801064e8:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801064eb:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801064f2:	00 
801064f3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801064f6:	89 44 24 04          	mov    %eax,0x4(%esp)
801064fa:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106501:	e8 07 f2 ff ff       	call   8010570d <argptr>
80106506:	85 c0                	test   %eax,%eax
80106508:	79 0a                	jns    80106514 <sys_pipe+0x2f>
    return -1;
8010650a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010650f:	e9 9b 00 00 00       	jmp    801065af <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106514:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106517:	89 44 24 04          	mov    %eax,0x4(%esp)
8010651b:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010651e:	89 04 24             	mov    %eax,(%esp)
80106521:	e8 08 da ff ff       	call   80103f2e <pipealloc>
80106526:	85 c0                	test   %eax,%eax
80106528:	79 07                	jns    80106531 <sys_pipe+0x4c>
    return -1;
8010652a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010652f:	eb 7e                	jmp    801065af <sys_pipe+0xca>
  fd0 = -1;
80106531:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106538:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010653b:	89 04 24             	mov    %eax,(%esp)
8010653e:	e8 67 f3 ff ff       	call   801058aa <fdalloc>
80106543:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106546:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010654a:	78 14                	js     80106560 <sys_pipe+0x7b>
8010654c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010654f:	89 04 24             	mov    %eax,(%esp)
80106552:	e8 53 f3 ff ff       	call   801058aa <fdalloc>
80106557:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010655a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010655e:	79 37                	jns    80106597 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106560:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106564:	78 14                	js     8010657a <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106566:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010656c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010656f:	83 c2 08             	add    $0x8,%edx
80106572:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106579:	00 
    fileclose(rf);
8010657a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010657d:	89 04 24             	mov    %eax,(%esp)
80106580:	e8 56 aa ff ff       	call   80100fdb <fileclose>
    fileclose(wf);
80106585:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106588:	89 04 24             	mov    %eax,(%esp)
8010658b:	e8 4b aa ff ff       	call   80100fdb <fileclose>
    return -1;
80106590:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106595:	eb 18                	jmp    801065af <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106597:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010659a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010659d:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010659f:	8b 45 ec             	mov    -0x14(%ebp),%eax
801065a2:	8d 50 04             	lea    0x4(%eax),%edx
801065a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065a8:	89 02                	mov    %eax,(%edx)
  return 0;
...
801065b4:	83 ec 08             	sub    $0x8,%esp
  return fork();
801065b7:	e8 bb e0 ff ff       	call   80104677 <fork>
}
801065bc:	c9                   	leave  
801065bd:	c3                   	ret    
...
801065c1:	83 ec 08             	sub    $0x8,%esp
  exit();
801065c4:	e8 38 e2 ff ff       	call   80104801 <exit>
...
801065d3:	83 ec 08             	sub    $0x8,%esp
  return wait();
801065d6:	e8 4b e3 ff ff       	call   80104926 <wait>
}
801065db:	c9                   	leave  
801065dc:	c3                   	ret    
...
801065e0:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
801065e3:	8d 45 f4             	lea    -0xc(%ebp),%eax
801065e6:	89 44 24 04          	mov    %eax,0x4(%esp)
801065ea:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065f1:	e8 e9 f0 ff ff       	call   801056df <argint>
801065f6:	85 c0                	test   %eax,%eax
801065f8:	79 07                	jns    80106601 <sys_kill+0x24>
    return -1;
801065fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065ff:	eb 0b                	jmp    8010660c <sys_kill+0x2f>
  return kill(pid);
80106601:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106604:	89 04 24             	mov    %eax,(%esp)
80106607:	e8 5f e7 ff ff       	call   80104d6b <kill>
}
8010660c:	c9                   	leave  
8010660d:	c3                   	ret    
...
80106630:	e8 aa f0 ff ff       	call   801056df <argint>
80106635:	85 c0                	test   %eax,%eax
80106637:	79 07                	jns    80106640 <sys_sbrk+0x24>
    return -1;
80106639:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010663e:	eb 24                	jmp    80106664 <sys_sbrk+0x48>
  addr = proc->sz;
80106640:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106646:	8b 00                	mov    (%eax),%eax
80106648:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
8010664b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010664e:	89 04 24             	mov    %eax,(%esp)
80106651:	e8 7c df ff ff       	call   801045d2 <growproc>
80106656:	85 c0                	test   %eax,%eax
80106658:	79 07                	jns    80106661 <sys_sbrk+0x45>
    return -1;
8010665a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010665f:	eb 03                	jmp    80106664 <sys_sbrk+0x48>
  return addr;
...
80106673:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010667a:	e8 60 f0 ff ff       	call   801056df <argint>
8010667f:	85 c0                	test   %eax,%eax
80106681:	79 07                	jns    8010668a <sys_sleep+0x24>
    return -1;
80106683:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106688:	eb 6c                	jmp    801066f6 <sys_sleep+0x90>
  acquire(&tickslock);
8010668a:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
80106691:	e8 b3 ea ff ff       	call   80105149 <acquire>
  ticks0 = ticks;
80106696:	a1 00 85 11 80       	mov    0x80118500,%eax
8010669b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
8010669e:	eb 34                	jmp    801066d4 <sys_sleep+0x6e>
    if(proc->killed){
801066a0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066a6:	8b 40 24             	mov    0x24(%eax),%eax
801066a9:	85 c0                	test   %eax,%eax
801066ab:	74 13                	je     801066c0 <sys_sleep+0x5a>
      release(&tickslock);
801066ad:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
801066b4:	e8 f2 ea ff ff       	call   801051ab <release>
      return -1;
801066b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066be:	eb 36                	jmp    801066f6 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801066c0:	c7 44 24 04 c0 7c 11 	movl   $0x80117cc0,0x4(%esp)
801066c7:	80 
801066c8:	c7 04 24 00 85 11 80 	movl   $0x80118500,(%esp)
801066cf:	e8 91 e5 ff ff       	call   80104c65 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801066d4:	a1 00 85 11 80       	mov    0x80118500,%eax
801066d9:	2b 45 f4             	sub    -0xc(%ebp),%eax
801066dc:	89 c2                	mov    %eax,%edx
801066de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066e1:	39 c2                	cmp    %eax,%edx
801066e3:	72 bb                	jb     801066a0 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801066e5:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
801066ec:	e8 ba ea ff ff       	call   801051ab <release>
  return 0;
...
801066fb:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801066fe:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
80106705:	e8 3f ea ff ff       	call   80105149 <acquire>
  xticks = ticks;
8010670a:	a1 00 85 11 80       	mov    0x80118500,%eax
8010670f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106712:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
80106719:	e8 8d ea ff ff       	call   801051ab <release>
  return xticks;
...
80106770:	e8 6a ef ff ff       	call   801056df <argint>
80106775:	85 c0                	test   %eax,%eax
80106777:	78 17                	js     80106790 <sys_sigsend+0x34>
80106779:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010677c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106780:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106787:	e8 53 ef ff ff       	call   801056df <argint>
8010678c:	85 c0                	test   %eax,%eax
8010678e:	79 07                	jns    80106797 <sys_sigsend+0x3b>
    return -1;
80106790:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106795:	eb 12                	jmp    801067a9 <sys_sigsend+0x4d>

  return sigsend(dest_pid, value);
80106797:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010679a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010679d:	89 54 24 04          	mov    %edx,0x4(%esp)
801067a1:	89 04 24             	mov    %eax,(%esp)
801067a4:	e8 95 e7 ff ff       	call   80104f3e <sigsend>
}
801067a9:	c9                   	leave  
801067aa:	c3                   	ret    
...
801067b8:	83 ec 08             	sub    $0x8,%esp
  return sigpause();
801067bb:	e8 fb e7 ff ff       	call   80104fbb <sigpause>
}
801067c0:	c9                   	leave  
801067c1:	c3                   	ret    
...
801067e6:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801067ed:	00 
801067ee:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801067f5:	e8 c8 ff ff ff       	call   801067c2 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801067fa:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106801:	00 
80106802:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106809:	e8 b4 ff ff ff       	call   801067c2 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
8010680e:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106815:	00 
80106816:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010681d:	e8 a0 ff ff ff       	call   801067c2 <outb>
  picenable(IRQ_TIMER);
80106822:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106829:	e8 93 d5 ff ff       	call   80103dc1 <picenable>
}
8010682e:	c9                   	leave  
8010682f:	c3                   	ret    
...
80106831:	06                   	push   %es
  pushl %fs
80106832:	0f a0                	push   %fs
  pushl %gs
80106834:	0f a8                	push   %gs
  pushal
80106836:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106837:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010683b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010683d:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
8010683f:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106843:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106845:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106847:	54                   	push   %esp
  call trap
80106848:	e8 d8 01 00 00       	call   80106a25 <trap>
  addl $4, %esp
8010684d:	83 c4 04             	add    $0x4,%esp
...
80106850:	61                   	popa   
  popl %gs
80106851:	0f a9                	pop    %gs
  popl %fs
80106853:	0f a1                	pop    %fs
  popl %es
80106855:	07                   	pop    %es
  popl %ds
80106856:	1f                   	pop    %ds
...
80106864:	83 e8 01             	sub    $0x1,%eax
80106867:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010686b:	8b 45 08             	mov    0x8(%ebp),%eax
8010686e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106872:	8b 45 08             	mov    0x8(%ebp),%eax
80106875:	c1 e8 10             	shr    $0x10,%eax
80106878:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
8010687c:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010687f:	0f 01 18             	lidtl  (%eax)
}
80106882:	c9                   	leave  
80106883:	c3                   	ret    
...
8010688a:	0f 20 d0             	mov    %cr2,%eax
8010688d:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106890:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106893:	c9                   	leave  
80106894:	c3                   	ret    
...
80106898:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
8010689b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801068a2:	e9 c3 00 00 00       	jmp    8010696a <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801068a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068aa:	8b 04 85 a8 b0 10 80 	mov    -0x7fef4f58(,%eax,4),%eax
801068b1:	89 c2                	mov    %eax,%edx
801068b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068b6:	66 89 14 c5 00 7d 11 	mov    %dx,-0x7fee8300(,%eax,8)
801068bd:	80 
801068be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068c1:	66 c7 04 c5 02 7d 11 	movw   $0x8,-0x7fee82fe(,%eax,8)
801068c8:	80 08 00 
801068cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068ce:	0f b6 14 c5 04 7d 11 	movzbl -0x7fee82fc(,%eax,8),%edx
801068d5:	80 
801068d6:	83 e2 e0             	and    $0xffffffe0,%edx
801068d9:	88 14 c5 04 7d 11 80 	mov    %dl,-0x7fee82fc(,%eax,8)
801068e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068e3:	0f b6 14 c5 04 7d 11 	movzbl -0x7fee82fc(,%eax,8),%edx
801068ea:	80 
801068eb:	83 e2 1f             	and    $0x1f,%edx
801068ee:	88 14 c5 04 7d 11 80 	mov    %dl,-0x7fee82fc(,%eax,8)
801068f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068f8:	0f b6 14 c5 05 7d 11 	movzbl -0x7fee82fb(,%eax,8),%edx
801068ff:	80 
80106900:	83 e2 f0             	and    $0xfffffff0,%edx
80106903:	83 ca 0e             	or     $0xe,%edx
80106906:	88 14 c5 05 7d 11 80 	mov    %dl,-0x7fee82fb(,%eax,8)
8010690d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106910:	0f b6 14 c5 05 7d 11 	movzbl -0x7fee82fb(,%eax,8),%edx
80106917:	80 
80106918:	83 e2 ef             	and    $0xffffffef,%edx
8010691b:	88 14 c5 05 7d 11 80 	mov    %dl,-0x7fee82fb(,%eax,8)
80106922:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106925:	0f b6 14 c5 05 7d 11 	movzbl -0x7fee82fb(,%eax,8),%edx
8010692c:	80 
8010692d:	83 e2 9f             	and    $0xffffff9f,%edx
80106930:	88 14 c5 05 7d 11 80 	mov    %dl,-0x7fee82fb(,%eax,8)
80106937:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010693a:	0f b6 14 c5 05 7d 11 	movzbl -0x7fee82fb(,%eax,8),%edx
80106941:	80 
80106942:	83 ca 80             	or     $0xffffff80,%edx
80106945:	88 14 c5 05 7d 11 80 	mov    %dl,-0x7fee82fb(,%eax,8)
8010694c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010694f:	8b 04 85 a8 b0 10 80 	mov    -0x7fef4f58(,%eax,4),%eax
80106956:	c1 e8 10             	shr    $0x10,%eax
80106959:	89 c2                	mov    %eax,%edx
8010695b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010695e:	66 89 14 c5 06 7d 11 	mov    %dx,-0x7fee82fa(,%eax,8)
80106965:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106966:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010696a:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106971:	0f 8e 30 ff ff ff    	jle    801068a7 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106977:	a1 a8 b1 10 80       	mov    0x8010b1a8,%eax
8010697c:	66 a3 00 7f 11 80    	mov    %ax,0x80117f00
80106982:	66 c7 05 02 7f 11 80 	movw   $0x8,0x80117f02
80106989:	08 00 
8010698b:	0f b6 05 04 7f 11 80 	movzbl 0x80117f04,%eax
80106992:	83 e0 e0             	and    $0xffffffe0,%eax
80106995:	a2 04 7f 11 80       	mov    %al,0x80117f04
8010699a:	0f b6 05 04 7f 11 80 	movzbl 0x80117f04,%eax
801069a1:	83 e0 1f             	and    $0x1f,%eax
801069a4:	a2 04 7f 11 80       	mov    %al,0x80117f04
801069a9:	0f b6 05 05 7f 11 80 	movzbl 0x80117f05,%eax
801069b0:	83 c8 0f             	or     $0xf,%eax
801069b3:	a2 05 7f 11 80       	mov    %al,0x80117f05
801069b8:	0f b6 05 05 7f 11 80 	movzbl 0x80117f05,%eax
801069bf:	83 e0 ef             	and    $0xffffffef,%eax
801069c2:	a2 05 7f 11 80       	mov    %al,0x80117f05
801069c7:	0f b6 05 05 7f 11 80 	movzbl 0x80117f05,%eax
801069ce:	83 c8 60             	or     $0x60,%eax
801069d1:	a2 05 7f 11 80       	mov    %al,0x80117f05
801069d6:	0f b6 05 05 7f 11 80 	movzbl 0x80117f05,%eax
801069dd:	83 c8 80             	or     $0xffffff80,%eax
801069e0:	a2 05 7f 11 80       	mov    %al,0x80117f05
801069e5:	a1 a8 b1 10 80       	mov    0x8010b1a8,%eax
801069ea:	c1 e8 10             	shr    $0x10,%eax
801069ed:	66 a3 06 7f 11 80    	mov    %ax,0x80117f06
  
  initlock(&tickslock, "time");
801069f3:	c7 44 24 04 68 8c 10 	movl   $0x80108c68,0x4(%esp)
801069fa:	80 
801069fb:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
80106a02:	e8 21 e7 ff ff       	call   80105128 <initlock>
}
80106a07:	c9                   	leave  
80106a08:	c3                   	ret    
...
80106a0c:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106a0f:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106a16:	00 
80106a17:	c7 04 24 00 7d 11 80 	movl   $0x80117d00,(%esp)
80106a1e:	e8 38 fe ff ff       	call   8010685b <lidt>
}
80106a23:	c9                   	leave  
80106a24:	c3                   	ret    
...
80106a2b:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106a2e:	8b 45 08             	mov    0x8(%ebp),%eax
80106a31:	8b 40 30             	mov    0x30(%eax),%eax
80106a34:	83 f8 40             	cmp    $0x40,%eax
80106a37:	75 3f                	jne    80106a78 <trap+0x53>
    if(proc->killed)
80106a39:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a3f:	8b 40 24             	mov    0x24(%eax),%eax
80106a42:	85 c0                	test   %eax,%eax
80106a44:	74 05                	je     80106a4b <trap+0x26>
      exit();
80106a46:	e8 b6 dd ff ff       	call   80104801 <exit>
    proc->tf = tf;
80106a4b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a51:	8b 55 08             	mov    0x8(%ebp),%edx
80106a54:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106a57:	e8 4a ed ff ff       	call   801057a6 <syscall>
    if(proc->killed)
80106a5c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a62:	8b 40 24             	mov    0x24(%eax),%eax
80106a65:	85 c0                	test   %eax,%eax
80106a67:	74 0a                	je     80106a73 <trap+0x4e>
      exit();
80106a69:	e8 93 dd ff ff       	call   80104801 <exit>
    return;
80106a6e:	e9 2d 02 00 00       	jmp    80106ca0 <trap+0x27b>
80106a73:	e9 28 02 00 00       	jmp    80106ca0 <trap+0x27b>
  }

  switch(tf->trapno){
80106a78:	8b 45 08             	mov    0x8(%ebp),%eax
80106a7b:	8b 40 30             	mov    0x30(%eax),%eax
80106a7e:	83 e8 20             	sub    $0x20,%eax
80106a81:	83 f8 1f             	cmp    $0x1f,%eax
80106a84:	0f 87 bc 00 00 00    	ja     80106b46 <trap+0x121>
80106a8a:	8b 04 85 10 8d 10 80 	mov    -0x7fef72f0(,%eax,4),%eax
80106a91:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106a93:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106a99:	0f b6 00             	movzbl (%eax),%eax
80106a9c:	84 c0                	test   %al,%al
80106a9e:	75 31                	jne    80106ad1 <trap+0xac>
      acquire(&tickslock);
80106aa0:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
80106aa7:	e8 9d e6 ff ff       	call   80105149 <acquire>
      ticks++;
80106aac:	a1 00 85 11 80       	mov    0x80118500,%eax
80106ab1:	83 c0 01             	add    $0x1,%eax
80106ab4:	a3 00 85 11 80       	mov    %eax,0x80118500
      wakeup(&ticks);
80106ab9:	c7 04 24 00 85 11 80 	movl   $0x80118500,(%esp)
80106ac0:	e8 7b e2 ff ff       	call   80104d40 <wakeup>
      release(&tickslock);
80106ac5:	c7 04 24 c0 7c 11 80 	movl   $0x80117cc0,(%esp)
80106acc:	e8 da e6 ff ff       	call   801051ab <release>
    }
    lapiceoi();
80106ad1:	e8 07 c4 ff ff       	call   80102edd <lapiceoi>
    break;
80106ad6:	e9 41 01 00 00       	jmp    80106c1c <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106adb:	e8 0b bc ff ff       	call   801026eb <ideintr>
    lapiceoi();
80106ae0:	e8 f8 c3 ff ff       	call   80102edd <lapiceoi>
    break;
80106ae5:	e9 32 01 00 00       	jmp    80106c1c <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106aea:	e8 bd c1 ff ff       	call   80102cac <kbdintr>
    lapiceoi();
80106aef:	e8 e9 c3 ff ff       	call   80102edd <lapiceoi>
    break;
80106af4:	e9 23 01 00 00       	jmp    80106c1c <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106af9:	e8 97 03 00 00       	call   80106e95 <uartintr>
    lapiceoi();
80106afe:	e8 da c3 ff ff       	call   80102edd <lapiceoi>
    break;
80106b03:	e9 14 01 00 00       	jmp    80106c1c <trap+0x1f7>
  case T_IRQ0 + 7:
...
80106b11:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106b15:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106b1e:	0f b6 00             	movzbl (%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106b21:	0f b6 c0             	movzbl %al,%eax
80106b24:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106b28:	89 54 24 08          	mov    %edx,0x8(%esp)
80106b2c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b30:	c7 04 24 70 8c 10 80 	movl   $0x80108c70,(%esp)
80106b37:	e8 64 98 ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106b3c:	e8 9c c3 ff ff       	call   80102edd <lapiceoi>
    break;
80106b41:	e9 d6 00 00 00       	jmp    80106c1c <trap+0x1f7>
...
80106b4e:	74 11                	je     80106b61 <trap+0x13c>
80106b50:	8b 45 08             	mov    0x8(%ebp),%eax
80106b53:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106b57:	0f b7 c0             	movzwl %ax,%eax
80106b5a:	83 e0 03             	and    $0x3,%eax
80106b5d:	85 c0                	test   %eax,%eax
80106b5f:	75 46                	jne    80106ba7 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b61:	e8 1e fd ff ff       	call   80106884 <rcr2>
80106b66:	8b 55 08             	mov    0x8(%ebp),%edx
80106b69:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106b6c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106b73:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b76:	0f b6 ca             	movzbl %dl,%ecx
80106b79:	8b 55 08             	mov    0x8(%ebp),%edx
80106b7c:	8b 52 30             	mov    0x30(%edx),%edx
80106b7f:	89 44 24 10          	mov    %eax,0x10(%esp)
80106b83:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106b87:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106b8b:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b8f:	c7 04 24 94 8c 10 80 	movl   $0x80108c94,(%esp)
80106b96:	e8 05 98 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106b9b:	c7 04 24 c6 8c 10 80 	movl   $0x80108cc6,(%esp)
80106ba2:	e8 93 99 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106ba7:	e8 d8 fc ff ff       	call   80106884 <rcr2>
80106bac:	89 c2                	mov    %eax,%edx
80106bae:	8b 45 08             	mov    0x8(%ebp),%eax
80106bb1:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106bb4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106bba:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106bbd:	0f b6 f0             	movzbl %al,%esi
80106bc0:	8b 45 08             	mov    0x8(%ebp),%eax
80106bc3:	8b 58 34             	mov    0x34(%eax),%ebx
80106bc6:	8b 45 08             	mov    0x8(%ebp),%eax
80106bc9:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106bcc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bd2:	83 c0 6c             	add    $0x6c,%eax
...
80106be1:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106be5:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106be9:	89 74 24 14          	mov    %esi,0x14(%esp)
80106bed:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106bf1:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106bf5:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106bf8:	89 74 24 08          	mov    %esi,0x8(%esp)
80106bfc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c00:	c7 04 24 cc 8c 10 80 	movl   $0x80108ccc,(%esp)
80106c07:	e8 94 97 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106c0c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c12:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106c19:	eb 01                	jmp    80106c1c <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106c24:	74 24                	je     80106c4a <trap+0x225>
80106c26:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c2c:	8b 40 24             	mov    0x24(%eax),%eax
80106c2f:	85 c0                	test   %eax,%eax
80106c31:	74 17                	je     80106c4a <trap+0x225>
80106c33:	8b 45 08             	mov    0x8(%ebp),%eax
80106c36:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106c3a:	0f b7 c0             	movzwl %ax,%eax
80106c3d:	83 e0 03             	and    $0x3,%eax
80106c40:	83 f8 03             	cmp    $0x3,%eax
80106c43:	75 05                	jne    80106c4a <trap+0x225>
    exit();
80106c45:	e8 b7 db ff ff       	call   80104801 <exit>
...
80106c52:	74 1e                	je     80106c72 <trap+0x24d>
80106c54:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c5a:	8b 40 0c             	mov    0xc(%eax),%eax
80106c5d:	83 f8 04             	cmp    $0x4,%eax
80106c60:	75 10                	jne    80106c72 <trap+0x24d>
80106c62:	8b 45 08             	mov    0x8(%ebp),%eax
80106c65:	8b 40 30             	mov    0x30(%eax),%eax
80106c68:	83 f8 20             	cmp    $0x20,%eax
80106c6b:	75 05                	jne    80106c72 <trap+0x24d>
    yield();
80106c6d:	e8 95 df ff ff       	call   80104c07 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106c72:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c78:	85 c0                	test   %eax,%eax
80106c7a:	74 24                	je     80106ca0 <trap+0x27b>
80106c7c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c82:	8b 40 24             	mov    0x24(%eax),%eax
80106c85:	85 c0                	test   %eax,%eax
80106c87:	74 17                	je     80106ca0 <trap+0x27b>
80106c89:	8b 45 08             	mov    0x8(%ebp),%eax
80106c8c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106c90:	0f b7 c0             	movzwl %ax,%eax
80106c93:	83 e0 03             	and    $0x3,%eax
80106c96:	83 f8 03             	cmp    $0x3,%eax
80106c99:	75 05                	jne    80106ca0 <trap+0x27b>
    exit();
80106c9b:	e8 61 db ff ff       	call   80104801 <exit>
}
80106ca0:	83 c4 3c             	add    $0x3c,%esp
80106ca3:	5b                   	pop    %ebx
80106ca4:	5e                   	pop    %esi
80106ca5:	5f                   	pop    %edi
80106ca6:	5d                   	pop    %ebp
...
80106cab:	83 ec 14             	sub    $0x14,%esp
80106cae:	8b 45 08             	mov    0x8(%ebp),%eax
80106cb1:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106cb5:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106cb9:	89 c2                	mov    %eax,%edx
80106cbb:	ec                   	in     (%dx),%al
80106cbc:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106cbf:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106cc3:	c9                   	leave  
80106cc4:	c3                   	ret    
...
80106cd1:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106cd5:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106cd8:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106cdc:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106ce6:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106ce9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106cf0:	00 
80106cf1:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106cf8:	e8 c8 ff ff ff       	call   80106cc5 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106cfd:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106d04:	00 
80106d05:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106d0c:	e8 b4 ff ff ff       	call   80106cc5 <outb>
  outb(COM1+0, 115200/9600);
80106d11:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106d18:	00 
80106d19:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106d20:	e8 a0 ff ff ff       	call   80106cc5 <outb>
  outb(COM1+1, 0);
80106d25:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d2c:	00 
80106d2d:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106d34:	e8 8c ff ff ff       	call   80106cc5 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106d39:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106d40:	00 
80106d41:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106d48:	e8 78 ff ff ff       	call   80106cc5 <outb>
  outb(COM1+4, 0);
80106d4d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d54:	00 
80106d55:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106d5c:	e8 64 ff ff ff       	call   80106cc5 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106d61:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106d68:	00 
80106d69:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106d70:	e8 50 ff ff ff       	call   80106cc5 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106d75:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106d7c:	e8 27 ff ff ff       	call   80106ca8 <inb>
80106d81:	3c ff                	cmp    $0xff,%al
80106d83:	75 02                	jne    80106d87 <uartinit+0xa4>
    return;
80106d85:	eb 6a                	jmp    80106df1 <uartinit+0x10e>
  uart = 1;
80106d87:	c7 05 6c b6 10 80 01 	movl   $0x1,0x8010b66c
80106d8e:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106d91:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106d98:	e8 0b ff ff ff       	call   80106ca8 <inb>
  inb(COM1+0);
80106d9d:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106da4:	e8 ff fe ff ff       	call   80106ca8 <inb>
  picenable(IRQ_COM1);
80106da9:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106db0:	e8 0c d0 ff ff       	call   80103dc1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106db5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106dbc:	00 
80106dbd:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106dc4:	e8 a1 bb ff ff       	call   8010296a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106dc9:	c7 45 f4 90 8d 10 80 	movl   $0x80108d90,-0xc(%ebp)
80106dd0:	eb 15                	jmp    80106de7 <uartinit+0x104>
    uartputc(*p);
80106dd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dd5:	0f b6 00             	movzbl (%eax),%eax
80106dd8:	0f be c0             	movsbl %al,%eax
80106ddb:	89 04 24             	mov    %eax,(%esp)
80106dde:	e8 10 00 00 00       	call   80106df3 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106de3:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106de7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dea:	0f b6 00             	movzbl (%eax),%eax
80106ded:	84 c0                	test   %al,%al
80106def:	75 e1                	jne    80106dd2 <uartinit+0xef>
    uartputc(*p);
}
80106df1:	c9                   	leave  
80106df2:	c3                   	ret    
...
80106df6:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106df9:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80106dfe:	85 c0                	test   %eax,%eax
80106e00:	75 02                	jne    80106e04 <uartputc+0x11>
    return;
80106e02:	eb 4b                	jmp    80106e4f <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106e04:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106e0b:	eb 10                	jmp    80106e1d <uartputc+0x2a>
    microdelay(10);
80106e0d:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106e14:	e8 e9 c0 ff ff       	call   80102f02 <microdelay>
{
  int i;
...
80106e21:	7f 16                	jg     80106e39 <uartputc+0x46>
80106e23:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106e2a:	e8 79 fe ff ff       	call   80106ca8 <inb>
80106e2f:	0f b6 c0             	movzbl %al,%eax
80106e32:	83 e0 20             	and    $0x20,%eax
80106e35:	85 c0                	test   %eax,%eax
80106e37:	74 d4                	je     80106e0d <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106e39:	8b 45 08             	mov    0x8(%ebp),%eax
80106e3c:	0f b6 c0             	movzbl %al,%eax
80106e3f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e43:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106e4a:	e8 76 fe ff ff       	call   80106cc5 <outb>
}
80106e4f:	c9                   	leave  
80106e50:	c3                   	ret    
...
80106e5e:	75 07                	jne    80106e67 <uartgetc+0x16>
    return -1;
80106e60:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e65:	eb 2c                	jmp    80106e93 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106e67:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106e6e:	e8 35 fe ff ff       	call   80106ca8 <inb>
80106e73:	0f b6 c0             	movzbl %al,%eax
80106e76:	83 e0 01             	and    $0x1,%eax
80106e79:	85 c0                	test   %eax,%eax
80106e7b:	75 07                	jne    80106e84 <uartgetc+0x33>
    return -1;
80106e7d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e82:	eb 0f                	jmp    80106e93 <uartgetc+0x42>
  return inb(COM1+0);
80106e84:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106e8b:	e8 18 fe ff ff       	call   80106ca8 <inb>
80106e90:	0f b6 c0             	movzbl %al,%eax
}
80106e93:	c9                   	leave  
80106e94:	c3                   	ret    
...
80106e98:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106e9b:	c7 04 24 51 6e 10 80 	movl   $0x80106e51,(%esp)
80106ea2:	e8 06 99 ff ff       	call   801007ad <consoleintr>
}
80106ea7:	c9                   	leave  
80106ea8:	c3                   	ret    
...
80106eab:	6a 00                	push   $0x0
  jmp alltraps
80106ead:	e9 7e f9 ff ff       	jmp    80106830 <alltraps>
...
80106eb4:	6a 01                	push   $0x1
  jmp alltraps
80106eb6:	e9 75 f9 ff ff       	jmp    80106830 <alltraps>
...
80106ebd:	6a 02                	push   $0x2
  jmp alltraps
80106ebf:	e9 6c f9 ff ff       	jmp    80106830 <alltraps>
...
80106ec6:	6a 03                	push   $0x3
  jmp alltraps
80106ec8:	e9 63 f9 ff ff       	jmp    80106830 <alltraps>
...
80106ecf:	6a 04                	push   $0x4
  jmp alltraps
80106ed1:	e9 5a f9 ff ff       	jmp    80106830 <alltraps>
...
80106ed8:	6a 05                	push   $0x5
  jmp alltraps
80106eda:	e9 51 f9 ff ff       	jmp    80106830 <alltraps>
...
80106ee1:	6a 06                	push   $0x6
  jmp alltraps
80106ee3:	e9 48 f9 ff ff       	jmp    80106830 <alltraps>
...
80106eea:	6a 07                	push   $0x7
  jmp alltraps
80106eec:	e9 3f f9 ff ff       	jmp    80106830 <alltraps>
...
80106ef1:	6a 08                	push   $0x8
  jmp alltraps
80106ef3:	e9 38 f9 ff ff       	jmp    80106830 <alltraps>
...
80106efa:	6a 09                	push   $0x9
  jmp alltraps
80106efc:	e9 2f f9 ff ff       	jmp    80106830 <alltraps>
...
80106f01:	6a 0a                	push   $0xa
  jmp alltraps
80106f03:	e9 28 f9 ff ff       	jmp    80106830 <alltraps>
...
80106f08:	6a 0b                	push   $0xb
  jmp alltraps
80106f0a:	e9 21 f9 ff ff       	jmp    80106830 <alltraps>
...
80106f0f:	6a 0c                	push   $0xc
  jmp alltraps
80106f11:	e9 1a f9 ff ff       	jmp    80106830 <alltraps>
...
80106f16:	6a 0d                	push   $0xd
  jmp alltraps
80106f18:	e9 13 f9 ff ff       	jmp    80106830 <alltraps>
...
80106f1d:	6a 0e                	push   $0xe
  jmp alltraps
80106f1f:	e9 0c f9 ff ff       	jmp    80106830 <alltraps>
...
80106f26:	6a 0f                	push   $0xf
  jmp alltraps
80106f28:	e9 03 f9 ff ff       	jmp    80106830 <alltraps>
...
80106f2f:	6a 10                	push   $0x10
  jmp alltraps
80106f31:	e9 fa f8 ff ff       	jmp    80106830 <alltraps>
...
80106f36:	6a 11                	push   $0x11
  jmp alltraps
80106f38:	e9 f3 f8 ff ff       	jmp    80106830 <alltraps>
...
80106f3f:	6a 12                	push   $0x12
  jmp alltraps
80106f41:	e9 ea f8 ff ff       	jmp    80106830 <alltraps>
...
80106f48:	6a 13                	push   $0x13
  jmp alltraps
80106f4a:	e9 e1 f8 ff ff       	jmp    80106830 <alltraps>
...
80106f51:	6a 14                	push   $0x14
  jmp alltraps
80106f53:	e9 d8 f8 ff ff       	jmp    80106830 <alltraps>
...
80106f5a:	6a 15                	push   $0x15
  jmp alltraps
80106f5c:	e9 cf f8 ff ff       	jmp    80106830 <alltraps>
...
80106f63:	6a 16                	push   $0x16
  jmp alltraps
80106f65:	e9 c6 f8 ff ff       	jmp    80106830 <alltraps>
...
80106f6c:	6a 17                	push   $0x17
  jmp alltraps
80106f6e:	e9 bd f8 ff ff       	jmp    80106830 <alltraps>
...
80106f75:	6a 18                	push   $0x18
  jmp alltraps
80106f77:	e9 b4 f8 ff ff       	jmp    80106830 <alltraps>
...
80106f7e:	6a 19                	push   $0x19
  jmp alltraps
80106f80:	e9 ab f8 ff ff       	jmp    80106830 <alltraps>
...
80106f87:	6a 1a                	push   $0x1a
  jmp alltraps
80106f89:	e9 a2 f8 ff ff       	jmp    80106830 <alltraps>
...
80106f90:	6a 1b                	push   $0x1b
  jmp alltraps
80106f92:	e9 99 f8 ff ff       	jmp    80106830 <alltraps>
...
80106f99:	6a 1c                	push   $0x1c
  jmp alltraps
80106f9b:	e9 90 f8 ff ff       	jmp    80106830 <alltraps>
...
80106fa2:	6a 1d                	push   $0x1d
  jmp alltraps
80106fa4:	e9 87 f8 ff ff       	jmp    80106830 <alltraps>
...
80106fab:	6a 1e                	push   $0x1e
  jmp alltraps
80106fad:	e9 7e f8 ff ff       	jmp    80106830 <alltraps>
...
80106fb4:	6a 1f                	push   $0x1f
  jmp alltraps
80106fb6:	e9 75 f8 ff ff       	jmp    80106830 <alltraps>
...
80106fbd:	6a 20                	push   $0x20
  jmp alltraps
80106fbf:	e9 6c f8 ff ff       	jmp    80106830 <alltraps>
...
80106fc6:	6a 21                	push   $0x21
  jmp alltraps
80106fc8:	e9 63 f8 ff ff       	jmp    80106830 <alltraps>
...
80106fcf:	6a 22                	push   $0x22
  jmp alltraps
80106fd1:	e9 5a f8 ff ff       	jmp    80106830 <alltraps>
...
80106fd8:	6a 23                	push   $0x23
  jmp alltraps
80106fda:	e9 51 f8 ff ff       	jmp    80106830 <alltraps>
...
80106fe1:	6a 24                	push   $0x24
  jmp alltraps
80106fe3:	e9 48 f8 ff ff       	jmp    80106830 <alltraps>
...
80106fea:	6a 25                	push   $0x25
  jmp alltraps
80106fec:	e9 3f f8 ff ff       	jmp    80106830 <alltraps>
...
80106ff3:	6a 26                	push   $0x26
  jmp alltraps
80106ff5:	e9 36 f8 ff ff       	jmp    80106830 <alltraps>
...
80106ffc:	6a 27                	push   $0x27
  jmp alltraps
80106ffe:	e9 2d f8 ff ff       	jmp    80106830 <alltraps>
...
80107005:	6a 28                	push   $0x28
  jmp alltraps
80107007:	e9 24 f8 ff ff       	jmp    80106830 <alltraps>
...
8010700e:	6a 29                	push   $0x29
  jmp alltraps
80107010:	e9 1b f8 ff ff       	jmp    80106830 <alltraps>
...
80107017:	6a 2a                	push   $0x2a
  jmp alltraps
80107019:	e9 12 f8 ff ff       	jmp    80106830 <alltraps>
...
80107020:	6a 2b                	push   $0x2b
  jmp alltraps
80107022:	e9 09 f8 ff ff       	jmp    80106830 <alltraps>
...
80107029:	6a 2c                	push   $0x2c
  jmp alltraps
8010702b:	e9 00 f8 ff ff       	jmp    80106830 <alltraps>
...
80107032:	6a 2d                	push   $0x2d
  jmp alltraps
80107034:	e9 f7 f7 ff ff       	jmp    80106830 <alltraps>
...
8010703b:	6a 2e                	push   $0x2e
  jmp alltraps
8010703d:	e9 ee f7 ff ff       	jmp    80106830 <alltraps>
...
80107044:	6a 2f                	push   $0x2f
  jmp alltraps
80107046:	e9 e5 f7 ff ff       	jmp    80106830 <alltraps>
...
8010704d:	6a 30                	push   $0x30
  jmp alltraps
8010704f:	e9 dc f7 ff ff       	jmp    80106830 <alltraps>
...
80107056:	6a 31                	push   $0x31
  jmp alltraps
80107058:	e9 d3 f7 ff ff       	jmp    80106830 <alltraps>
...
8010705f:	6a 32                	push   $0x32
  jmp alltraps
80107061:	e9 ca f7 ff ff       	jmp    80106830 <alltraps>
...
80107068:	6a 33                	push   $0x33
  jmp alltraps
8010706a:	e9 c1 f7 ff ff       	jmp    80106830 <alltraps>
...
80107071:	6a 34                	push   $0x34
  jmp alltraps
80107073:	e9 b8 f7 ff ff       	jmp    80106830 <alltraps>
...
8010707a:	6a 35                	push   $0x35
  jmp alltraps
8010707c:	e9 af f7 ff ff       	jmp    80106830 <alltraps>
...
80107083:	6a 36                	push   $0x36
  jmp alltraps
80107085:	e9 a6 f7 ff ff       	jmp    80106830 <alltraps>
...
8010708c:	6a 37                	push   $0x37
  jmp alltraps
8010708e:	e9 9d f7 ff ff       	jmp    80106830 <alltraps>
...
80107095:	6a 38                	push   $0x38
  jmp alltraps
80107097:	e9 94 f7 ff ff       	jmp    80106830 <alltraps>
...
8010709e:	6a 39                	push   $0x39
  jmp alltraps
801070a0:	e9 8b f7 ff ff       	jmp    80106830 <alltraps>
...
801070a7:	6a 3a                	push   $0x3a
  jmp alltraps
801070a9:	e9 82 f7 ff ff       	jmp    80106830 <alltraps>
...
801070b0:	6a 3b                	push   $0x3b
  jmp alltraps
801070b2:	e9 79 f7 ff ff       	jmp    80106830 <alltraps>
...
801070b9:	6a 3c                	push   $0x3c
  jmp alltraps
801070bb:	e9 70 f7 ff ff       	jmp    80106830 <alltraps>
...
801070c2:	6a 3d                	push   $0x3d
  jmp alltraps
801070c4:	e9 67 f7 ff ff       	jmp    80106830 <alltraps>
...
801070cb:	6a 3e                	push   $0x3e
  jmp alltraps
801070cd:	e9 5e f7 ff ff       	jmp    80106830 <alltraps>
...
801070d4:	6a 3f                	push   $0x3f
  jmp alltraps
801070d6:	e9 55 f7 ff ff       	jmp    80106830 <alltraps>
...
801070dd:	6a 40                	push   $0x40
  jmp alltraps
801070df:	e9 4c f7 ff ff       	jmp    80106830 <alltraps>
...
801070e6:	6a 41                	push   $0x41
  jmp alltraps
801070e8:	e9 43 f7 ff ff       	jmp    80106830 <alltraps>
...
801070ef:	6a 42                	push   $0x42
  jmp alltraps
801070f1:	e9 3a f7 ff ff       	jmp    80106830 <alltraps>
...
801070f8:	6a 43                	push   $0x43
  jmp alltraps
801070fa:	e9 31 f7 ff ff       	jmp    80106830 <alltraps>
...
80107101:	6a 44                	push   $0x44
  jmp alltraps
80107103:	e9 28 f7 ff ff       	jmp    80106830 <alltraps>
...
8010710a:	6a 45                	push   $0x45
  jmp alltraps
8010710c:	e9 1f f7 ff ff       	jmp    80106830 <alltraps>
...
80107113:	6a 46                	push   $0x46
  jmp alltraps
80107115:	e9 16 f7 ff ff       	jmp    80106830 <alltraps>
...
8010711c:	6a 47                	push   $0x47
  jmp alltraps
8010711e:	e9 0d f7 ff ff       	jmp    80106830 <alltraps>
...
80107125:	6a 48                	push   $0x48
  jmp alltraps
80107127:	e9 04 f7 ff ff       	jmp    80106830 <alltraps>
...
8010712e:	6a 49                	push   $0x49
  jmp alltraps
80107130:	e9 fb f6 ff ff       	jmp    80106830 <alltraps>
...
80107137:	6a 4a                	push   $0x4a
  jmp alltraps
80107139:	e9 f2 f6 ff ff       	jmp    80106830 <alltraps>
...
80107140:	6a 4b                	push   $0x4b
  jmp alltraps
80107142:	e9 e9 f6 ff ff       	jmp    80106830 <alltraps>
...
80107149:	6a 4c                	push   $0x4c
  jmp alltraps
8010714b:	e9 e0 f6 ff ff       	jmp    80106830 <alltraps>
...
80107152:	6a 4d                	push   $0x4d
  jmp alltraps
80107154:	e9 d7 f6 ff ff       	jmp    80106830 <alltraps>
...
8010715b:	6a 4e                	push   $0x4e
  jmp alltraps
8010715d:	e9 ce f6 ff ff       	jmp    80106830 <alltraps>
...
80107164:	6a 4f                	push   $0x4f
  jmp alltraps
80107166:	e9 c5 f6 ff ff       	jmp    80106830 <alltraps>
...
8010716d:	6a 50                	push   $0x50
  jmp alltraps
8010716f:	e9 bc f6 ff ff       	jmp    80106830 <alltraps>
...
80107176:	6a 51                	push   $0x51
  jmp alltraps
80107178:	e9 b3 f6 ff ff       	jmp    80106830 <alltraps>
...
8010717f:	6a 52                	push   $0x52
  jmp alltraps
80107181:	e9 aa f6 ff ff       	jmp    80106830 <alltraps>
...
80107188:	6a 53                	push   $0x53
  jmp alltraps
8010718a:	e9 a1 f6 ff ff       	jmp    80106830 <alltraps>
...
80107191:	6a 54                	push   $0x54
  jmp alltraps
80107193:	e9 98 f6 ff ff       	jmp    80106830 <alltraps>
...
8010719a:	6a 55                	push   $0x55
  jmp alltraps
8010719c:	e9 8f f6 ff ff       	jmp    80106830 <alltraps>
...
801071a3:	6a 56                	push   $0x56
  jmp alltraps
801071a5:	e9 86 f6 ff ff       	jmp    80106830 <alltraps>
...
801071ac:	6a 57                	push   $0x57
  jmp alltraps
801071ae:	e9 7d f6 ff ff       	jmp    80106830 <alltraps>
...
801071b5:	6a 58                	push   $0x58
  jmp alltraps
801071b7:	e9 74 f6 ff ff       	jmp    80106830 <alltraps>
...
801071be:	6a 59                	push   $0x59
  jmp alltraps
801071c0:	e9 6b f6 ff ff       	jmp    80106830 <alltraps>
...
801071c7:	6a 5a                	push   $0x5a
  jmp alltraps
801071c9:	e9 62 f6 ff ff       	jmp    80106830 <alltraps>
...
801071d0:	6a 5b                	push   $0x5b
  jmp alltraps
801071d2:	e9 59 f6 ff ff       	jmp    80106830 <alltraps>
...
801071d9:	6a 5c                	push   $0x5c
  jmp alltraps
801071db:	e9 50 f6 ff ff       	jmp    80106830 <alltraps>
...
801071e2:	6a 5d                	push   $0x5d
  jmp alltraps
801071e4:	e9 47 f6 ff ff       	jmp    80106830 <alltraps>
...
801071eb:	6a 5e                	push   $0x5e
  jmp alltraps
801071ed:	e9 3e f6 ff ff       	jmp    80106830 <alltraps>
...
801071f4:	6a 5f                	push   $0x5f
  jmp alltraps
801071f6:	e9 35 f6 ff ff       	jmp    80106830 <alltraps>
...
801071fd:	6a 60                	push   $0x60
  jmp alltraps
801071ff:	e9 2c f6 ff ff       	jmp    80106830 <alltraps>
...
80107206:	6a 61                	push   $0x61
  jmp alltraps
80107208:	e9 23 f6 ff ff       	jmp    80106830 <alltraps>
...
8010720f:	6a 62                	push   $0x62
  jmp alltraps
80107211:	e9 1a f6 ff ff       	jmp    80106830 <alltraps>
...
80107218:	6a 63                	push   $0x63
  jmp alltraps
8010721a:	e9 11 f6 ff ff       	jmp    80106830 <alltraps>
...
80107221:	6a 64                	push   $0x64
  jmp alltraps
80107223:	e9 08 f6 ff ff       	jmp    80106830 <alltraps>
...
8010722a:	6a 65                	push   $0x65
  jmp alltraps
8010722c:	e9 ff f5 ff ff       	jmp    80106830 <alltraps>
...
80107233:	6a 66                	push   $0x66
  jmp alltraps
80107235:	e9 f6 f5 ff ff       	jmp    80106830 <alltraps>
...
8010723c:	6a 67                	push   $0x67
  jmp alltraps
8010723e:	e9 ed f5 ff ff       	jmp    80106830 <alltraps>
...
80107245:	6a 68                	push   $0x68
  jmp alltraps
80107247:	e9 e4 f5 ff ff       	jmp    80106830 <alltraps>
...
8010724e:	6a 69                	push   $0x69
  jmp alltraps
80107250:	e9 db f5 ff ff       	jmp    80106830 <alltraps>
...
80107257:	6a 6a                	push   $0x6a
  jmp alltraps
80107259:	e9 d2 f5 ff ff       	jmp    80106830 <alltraps>
...
80107260:	6a 6b                	push   $0x6b
  jmp alltraps
80107262:	e9 c9 f5 ff ff       	jmp    80106830 <alltraps>
...
80107269:	6a 6c                	push   $0x6c
  jmp alltraps
8010726b:	e9 c0 f5 ff ff       	jmp    80106830 <alltraps>
...
80107272:	6a 6d                	push   $0x6d
  jmp alltraps
80107274:	e9 b7 f5 ff ff       	jmp    80106830 <alltraps>
...
8010727b:	6a 6e                	push   $0x6e
  jmp alltraps
8010727d:	e9 ae f5 ff ff       	jmp    80106830 <alltraps>
...
80107284:	6a 6f                	push   $0x6f
  jmp alltraps
80107286:	e9 a5 f5 ff ff       	jmp    80106830 <alltraps>
...
8010728d:	6a 70                	push   $0x70
  jmp alltraps
8010728f:	e9 9c f5 ff ff       	jmp    80106830 <alltraps>
...
80107296:	6a 71                	push   $0x71
  jmp alltraps
80107298:	e9 93 f5 ff ff       	jmp    80106830 <alltraps>
...
8010729f:	6a 72                	push   $0x72
  jmp alltraps
801072a1:	e9 8a f5 ff ff       	jmp    80106830 <alltraps>
...
801072a8:	6a 73                	push   $0x73
  jmp alltraps
801072aa:	e9 81 f5 ff ff       	jmp    80106830 <alltraps>
...
801072b1:	6a 74                	push   $0x74
  jmp alltraps
801072b3:	e9 78 f5 ff ff       	jmp    80106830 <alltraps>
...
801072ba:	6a 75                	push   $0x75
  jmp alltraps
801072bc:	e9 6f f5 ff ff       	jmp    80106830 <alltraps>
...
801072c3:	6a 76                	push   $0x76
  jmp alltraps
801072c5:	e9 66 f5 ff ff       	jmp    80106830 <alltraps>
...
801072cc:	6a 77                	push   $0x77
  jmp alltraps
801072ce:	e9 5d f5 ff ff       	jmp    80106830 <alltraps>
...
801072d5:	6a 78                	push   $0x78
  jmp alltraps
801072d7:	e9 54 f5 ff ff       	jmp    80106830 <alltraps>
...
801072de:	6a 79                	push   $0x79
  jmp alltraps
801072e0:	e9 4b f5 ff ff       	jmp    80106830 <alltraps>
...
801072e7:	6a 7a                	push   $0x7a
  jmp alltraps
801072e9:	e9 42 f5 ff ff       	jmp    80106830 <alltraps>
...
801072f0:	6a 7b                	push   $0x7b
  jmp alltraps
801072f2:	e9 39 f5 ff ff       	jmp    80106830 <alltraps>
...
801072f9:	6a 7c                	push   $0x7c
  jmp alltraps
801072fb:	e9 30 f5 ff ff       	jmp    80106830 <alltraps>
...
80107302:	6a 7d                	push   $0x7d
  jmp alltraps
80107304:	e9 27 f5 ff ff       	jmp    80106830 <alltraps>
...
8010730b:	6a 7e                	push   $0x7e
  jmp alltraps
8010730d:	e9 1e f5 ff ff       	jmp    80106830 <alltraps>
...
80107314:	6a 7f                	push   $0x7f
  jmp alltraps
80107316:	e9 15 f5 ff ff       	jmp    80106830 <alltraps>
...
8010731d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107322:	e9 09 f5 ff ff       	jmp    80106830 <alltraps>
...
80107329:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010732e:	e9 fd f4 ff ff       	jmp    80106830 <alltraps>
...
80107335:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010733a:	e9 f1 f4 ff ff       	jmp    80106830 <alltraps>
...
80107341:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107346:	e9 e5 f4 ff ff       	jmp    80106830 <alltraps>
...
8010734d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107352:	e9 d9 f4 ff ff       	jmp    80106830 <alltraps>
...
80107359:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010735e:	e9 cd f4 ff ff       	jmp    80106830 <alltraps>
...
80107365:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010736a:	e9 c1 f4 ff ff       	jmp    80106830 <alltraps>
...
80107371:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107376:	e9 b5 f4 ff ff       	jmp    80106830 <alltraps>
...
8010737d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107382:	e9 a9 f4 ff ff       	jmp    80106830 <alltraps>
...
80107389:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010738e:	e9 9d f4 ff ff       	jmp    80106830 <alltraps>
...
80107395:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010739a:	e9 91 f4 ff ff       	jmp    80106830 <alltraps>
...
801073a1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801073a6:	e9 85 f4 ff ff       	jmp    80106830 <alltraps>
...
801073ad:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801073b2:	e9 79 f4 ff ff       	jmp    80106830 <alltraps>
...
801073b9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801073be:	e9 6d f4 ff ff       	jmp    80106830 <alltraps>
...
801073c5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801073ca:	e9 61 f4 ff ff       	jmp    80106830 <alltraps>
...
801073d1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801073d6:	e9 55 f4 ff ff       	jmp    80106830 <alltraps>
...
801073dd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801073e2:	e9 49 f4 ff ff       	jmp    80106830 <alltraps>
...
801073e9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801073ee:	e9 3d f4 ff ff       	jmp    80106830 <alltraps>
...
801073f5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801073fa:	e9 31 f4 ff ff       	jmp    80106830 <alltraps>
...
80107401:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107406:	e9 25 f4 ff ff       	jmp    80106830 <alltraps>
...
8010740d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107412:	e9 19 f4 ff ff       	jmp    80106830 <alltraps>
...
80107419:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010741e:	e9 0d f4 ff ff       	jmp    80106830 <alltraps>
...
80107425:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010742a:	e9 01 f4 ff ff       	jmp    80106830 <alltraps>
...
80107431:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107436:	e9 f5 f3 ff ff       	jmp    80106830 <alltraps>
...
8010743d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107442:	e9 e9 f3 ff ff       	jmp    80106830 <alltraps>
...
80107449:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010744e:	e9 dd f3 ff ff       	jmp    80106830 <alltraps>
...
80107455:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010745a:	e9 d1 f3 ff ff       	jmp    80106830 <alltraps>
...
80107461:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107466:	e9 c5 f3 ff ff       	jmp    80106830 <alltraps>
...
8010746d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107472:	e9 b9 f3 ff ff       	jmp    80106830 <alltraps>
...
80107479:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010747e:	e9 ad f3 ff ff       	jmp    80106830 <alltraps>
...
80107485:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010748a:	e9 a1 f3 ff ff       	jmp    80106830 <alltraps>
...
80107491:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107496:	e9 95 f3 ff ff       	jmp    80106830 <alltraps>
...
8010749d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801074a2:	e9 89 f3 ff ff       	jmp    80106830 <alltraps>
...
801074a9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801074ae:	e9 7d f3 ff ff       	jmp    80106830 <alltraps>
...
801074b5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801074ba:	e9 71 f3 ff ff       	jmp    80106830 <alltraps>
...
801074c1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801074c6:	e9 65 f3 ff ff       	jmp    80106830 <alltraps>
...
801074cd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801074d2:	e9 59 f3 ff ff       	jmp    80106830 <alltraps>
...
801074d9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801074de:	e9 4d f3 ff ff       	jmp    80106830 <alltraps>
...
801074e5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801074ea:	e9 41 f3 ff ff       	jmp    80106830 <alltraps>
...
801074f1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801074f6:	e9 35 f3 ff ff       	jmp    80106830 <alltraps>
...
801074fd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107502:	e9 29 f3 ff ff       	jmp    80106830 <alltraps>
...
80107509:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010750e:	e9 1d f3 ff ff       	jmp    80106830 <alltraps>
...
80107515:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010751a:	e9 11 f3 ff ff       	jmp    80106830 <alltraps>
...
80107521:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107526:	e9 05 f3 ff ff       	jmp    80106830 <alltraps>
...
8010752d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107532:	e9 f9 f2 ff ff       	jmp    80106830 <alltraps>
...
80107539:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010753e:	e9 ed f2 ff ff       	jmp    80106830 <alltraps>
...
80107545:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010754a:	e9 e1 f2 ff ff       	jmp    80106830 <alltraps>
...
80107551:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107556:	e9 d5 f2 ff ff       	jmp    80106830 <alltraps>
...
8010755d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107562:	e9 c9 f2 ff ff       	jmp    80106830 <alltraps>
...
80107569:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010756e:	e9 bd f2 ff ff       	jmp    80106830 <alltraps>
...
80107575:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010757a:	e9 b1 f2 ff ff       	jmp    80106830 <alltraps>
...
80107581:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107586:	e9 a5 f2 ff ff       	jmp    80106830 <alltraps>
...
8010758d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107592:	e9 99 f2 ff ff       	jmp    80106830 <alltraps>
...
80107599:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010759e:	e9 8d f2 ff ff       	jmp    80106830 <alltraps>
...
801075a5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801075aa:	e9 81 f2 ff ff       	jmp    80106830 <alltraps>
...
801075b1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801075b6:	e9 75 f2 ff ff       	jmp    80106830 <alltraps>
...
801075bd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801075c2:	e9 69 f2 ff ff       	jmp    80106830 <alltraps>
...
801075c9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801075ce:	e9 5d f2 ff ff       	jmp    80106830 <alltraps>
...
801075d5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801075da:	e9 51 f2 ff ff       	jmp    80106830 <alltraps>
...
801075e1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801075e6:	e9 45 f2 ff ff       	jmp    80106830 <alltraps>
...
801075ed:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801075f2:	e9 39 f2 ff ff       	jmp    80106830 <alltraps>
...
801075f9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801075fe:	e9 2d f2 ff ff       	jmp    80106830 <alltraps>
...
80107605:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010760a:	e9 21 f2 ff ff       	jmp    80106830 <alltraps>
...
80107611:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107616:	e9 15 f2 ff ff       	jmp    80106830 <alltraps>
...
8010761d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107622:	e9 09 f2 ff ff       	jmp    80106830 <alltraps>
...
80107629:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010762e:	e9 fd f1 ff ff       	jmp    80106830 <alltraps>
...
80107635:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010763a:	e9 f1 f1 ff ff       	jmp    80106830 <alltraps>
...
80107641:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107646:	e9 e5 f1 ff ff       	jmp    80106830 <alltraps>
...
8010764d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107652:	e9 d9 f1 ff ff       	jmp    80106830 <alltraps>
...
80107659:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010765e:	e9 cd f1 ff ff       	jmp    80106830 <alltraps>
...
80107665:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010766a:	e9 c1 f1 ff ff       	jmp    80106830 <alltraps>
...
80107671:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107676:	e9 b5 f1 ff ff       	jmp    80106830 <alltraps>
...
8010767d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107682:	e9 a9 f1 ff ff       	jmp    80106830 <alltraps>
...
80107689:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010768e:	e9 9d f1 ff ff       	jmp    80106830 <alltraps>
...
80107695:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010769a:	e9 91 f1 ff ff       	jmp    80106830 <alltraps>
...
801076a1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801076a6:	e9 85 f1 ff ff       	jmp    80106830 <alltraps>
...
801076ad:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801076b2:	e9 79 f1 ff ff       	jmp    80106830 <alltraps>
...
801076b9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801076be:	e9 6d f1 ff ff       	jmp    80106830 <alltraps>
...
801076c5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801076ca:	e9 61 f1 ff ff       	jmp    80106830 <alltraps>
...
801076d1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801076d6:	e9 55 f1 ff ff       	jmp    80106830 <alltraps>
...
801076dd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801076e2:	e9 49 f1 ff ff       	jmp    80106830 <alltraps>
...
801076e9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801076ee:	e9 3d f1 ff ff       	jmp    80106830 <alltraps>
...
801076f5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801076fa:	e9 31 f1 ff ff       	jmp    80106830 <alltraps>
...
80107701:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107706:	e9 25 f1 ff ff       	jmp    80106830 <alltraps>
...
8010770d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107712:	e9 19 f1 ff ff       	jmp    80106830 <alltraps>
...
80107719:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010771e:	e9 0d f1 ff ff       	jmp    80106830 <alltraps>
...
80107725:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010772a:	e9 01 f1 ff ff       	jmp    80106830 <alltraps>
...
80107731:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107736:	e9 f5 f0 ff ff       	jmp    80106830 <alltraps>
...
8010773d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107742:	e9 e9 f0 ff ff       	jmp    80106830 <alltraps>
...
80107749:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010774e:	e9 dd f0 ff ff       	jmp    80106830 <alltraps>
...
80107755:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010775a:	e9 d1 f0 ff ff       	jmp    80106830 <alltraps>
...
80107761:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107766:	e9 c5 f0 ff ff       	jmp    80106830 <alltraps>
...
8010776d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107772:	e9 b9 f0 ff ff       	jmp    80106830 <alltraps>
...
80107779:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010777e:	e9 ad f0 ff ff       	jmp    80106830 <alltraps>
...
80107785:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010778a:	e9 a1 f0 ff ff       	jmp    80106830 <alltraps>
...
80107791:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107796:	e9 95 f0 ff ff       	jmp    80106830 <alltraps>
...
8010779d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801077a2:	e9 89 f0 ff ff       	jmp    80106830 <alltraps>
...
801077a9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801077ae:	e9 7d f0 ff ff       	jmp    80106830 <alltraps>
...
801077b5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801077ba:	e9 71 f0 ff ff       	jmp    80106830 <alltraps>
...
801077c1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801077c6:	e9 65 f0 ff ff       	jmp    80106830 <alltraps>
...
801077cd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801077d2:	e9 59 f0 ff ff       	jmp    80106830 <alltraps>
...
801077d9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801077de:	e9 4d f0 ff ff       	jmp    80106830 <alltraps>
...
801077e5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801077ea:	e9 41 f0 ff ff       	jmp    80106830 <alltraps>
...
801077f1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801077f6:	e9 35 f0 ff ff       	jmp    80106830 <alltraps>
...
801077fd:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107802:	e9 29 f0 ff ff       	jmp    80106830 <alltraps>
...
80107809:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010780e:	e9 1d f0 ff ff       	jmp    80106830 <alltraps>
...
80107815:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010781a:	e9 11 f0 ff ff       	jmp    80106830 <alltraps>
...
80107821:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107826:	e9 05 f0 ff ff       	jmp    80106830 <alltraps>
...
8010782d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107832:	e9 f9 ef ff ff       	jmp    80106830 <alltraps>
...
80107839:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010783e:	e9 ed ef ff ff       	jmp    80106830 <alltraps>
...
80107845:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010784a:	e9 e1 ef ff ff       	jmp    80106830 <alltraps>
...
80107851:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107856:	e9 d5 ef ff ff       	jmp    80106830 <alltraps>
...
8010785d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107862:	e9 c9 ef ff ff       	jmp    80106830 <alltraps>
...
80107869:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010786e:	e9 bd ef ff ff       	jmp    80106830 <alltraps>
...
80107875:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010787a:	e9 b1 ef ff ff       	jmp    80106830 <alltraps>
...
80107881:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107886:	e9 a5 ef ff ff       	jmp    80106830 <alltraps>
...
8010788d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107892:	e9 99 ef ff ff       	jmp    80106830 <alltraps>
...
80107899:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010789e:	e9 8d ef ff ff       	jmp    80106830 <alltraps>
...
801078a5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801078aa:	e9 81 ef ff ff       	jmp    80106830 <alltraps>
...
801078b1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801078b6:	e9 75 ef ff ff       	jmp    80106830 <alltraps>
...
801078bd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801078c2:	e9 69 ef ff ff       	jmp    80106830 <alltraps>
...
801078c9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801078ce:	e9 5d ef ff ff       	jmp    80106830 <alltraps>
...
801078d5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801078da:	e9 51 ef ff ff       	jmp    80106830 <alltraps>
...
801078e1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801078e6:	e9 45 ef ff ff       	jmp    80106830 <alltraps>
...
801078ed:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801078f2:	e9 39 ef ff ff       	jmp    80106830 <alltraps>
...
801078f9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801078fe:	e9 2d ef ff ff       	jmp    80106830 <alltraps>
...
80107905:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010790a:	e9 21 ef ff ff       	jmp    80106830 <alltraps>
...
80107911:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107916:	e9 15 ef ff ff       	jmp    80106830 <alltraps>
...
8010791e:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107921:	8b 45 0c             	mov    0xc(%ebp),%eax
80107924:	83 e8 01             	sub    $0x1,%eax
80107927:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010792b:	8b 45 08             	mov    0x8(%ebp),%eax
8010792e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107932:	8b 45 08             	mov    0x8(%ebp),%eax
80107935:	c1 e8 10             	shr    $0x10,%eax
80107938:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
8010793c:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010793f:	0f 01 10             	lgdtl  (%eax)
}
80107942:	c9                   	leave  
80107943:	c3                   	ret    
...
80107947:	83 ec 04             	sub    $0x4,%esp
8010794a:	8b 45 08             	mov    0x8(%ebp),%eax
8010794d:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107951:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
...
80107970:	89 e5                	mov    %esp,%ebp
  asm volatile("movl %0,%%cr3" : : "r" (val));
80107972:	8b 45 08             	mov    0x8(%ebp),%eax
80107975:	0f 22 d8             	mov    %eax,%cr3
}
80107978:	5d                   	pop    %ebp
80107979:	c3                   	ret    
...
8010798d:	05 00 00 00 80       	add    $0x80000000,%eax
80107992:	5d                   	pop    %ebp
80107993:	c3                   	ret    
...
80107998:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
8010799b:	e8 e5 b4 ff ff       	call   80102e85 <cpunum>
801079a0:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801079a6:	05 80 23 11 80       	add    $0x80112380,%eax
801079ab:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801079ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b1:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801079b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ba:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801079c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c3:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
...
801079d4:	88 50 7d             	mov    %dl,0x7d(%eax)
801079d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079da:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801079de:	83 ca 10             	or     $0x10,%edx
801079e1:	88 50 7d             	mov    %dl,0x7d(%eax)
801079e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079e7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801079eb:	83 e2 9f             	and    $0xffffff9f,%edx
801079ee:	88 50 7d             	mov    %dl,0x7d(%eax)
801079f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f4:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801079f8:	83 ca 80             	or     $0xffffff80,%edx
801079fb:	88 50 7d             	mov    %dl,0x7d(%eax)
801079fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a01:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107a05:	83 ca 0f             	or     $0xf,%edx
80107a08:	88 50 7e             	mov    %dl,0x7e(%eax)
80107a0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a0e:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107a12:	83 e2 ef             	and    $0xffffffef,%edx
80107a15:	88 50 7e             	mov    %dl,0x7e(%eax)
80107a18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a1b:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107a1f:	83 e2 df             	and    $0xffffffdf,%edx
80107a22:	88 50 7e             	mov    %dl,0x7e(%eax)
80107a25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a28:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107a2c:	83 ca 40             	or     $0x40,%edx
80107a2f:	88 50 7e             	mov    %dl,0x7e(%eax)
80107a32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a35:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107a39:	83 ca 80             	or     $0xffffff80,%edx
80107a3c:	88 50 7e             	mov    %dl,0x7e(%eax)
80107a3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a42:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107a46:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a49:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107a50:	ff ff 
80107a52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a55:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107a5c:	00 00 
80107a5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a61:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107a68:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a6b:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107a72:	83 e2 f0             	and    $0xfffffff0,%edx
80107a75:	83 ca 02             	or     $0x2,%edx
80107a78:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107a7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a81:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107a88:	83 ca 10             	or     $0x10,%edx
80107a8b:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107a91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a94:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107a9b:	83 e2 9f             	and    $0xffffff9f,%edx
...
80107aba:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ac1:	83 ca 0f             	or     $0xf,%edx
80107ac4:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107aca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107acd:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ad4:	83 e2 ef             	and    $0xffffffef,%edx
80107ad7:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107add:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ae0:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ae7:	83 e2 df             	and    $0xffffffdf,%edx
...
80107b19:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107b20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b23:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107b2a:	ff ff 
80107b2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b2f:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107b36:	00 00 
80107b38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b3b:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107b42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b45:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107b4c:	83 e2 f0             	and    $0xfffffff0,%edx
80107b4f:	83 ca 0a             	or     $0xa,%edx
80107b52:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107b58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b5b:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107b62:	83 ca 10             	or     $0x10,%edx
...
80107b94:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107b9b:	83 ca 0f             	or     $0xf,%edx
80107b9e:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107ba4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ba7:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107bae:	83 e2 ef             	and    $0xffffffef,%edx
...
80107bc1:	83 e2 df             	and    $0xffffffdf,%edx
...
80107bf3:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107bfa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bfd:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107c04:	ff ff 
80107c06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c09:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107c10:	00 00 
80107c12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c15:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107c1c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c1f:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107c26:	83 e2 f0             	and    $0xfffffff0,%edx
80107c29:	83 ca 02             	or     $0x2,%edx
80107c2c:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107c32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c35:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107c3c:	83 ca 10             	or     $0x10,%edx
80107c3f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107c45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c48:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107c4f:	83 ca 60             	or     $0x60,%edx
...
80107c6e:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107c75:	83 ca 0f             	or     $0xf,%edx
80107c78:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107c7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c81:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107c88:	83 e2 ef             	and    $0xffffffef,%edx
80107c8b:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107c91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c94:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107c9b:	83 e2 df             	and    $0xffffffdf,%edx
...
80107cc1:	83 ca 80             	or     $0xffffff80,%edx
80107cc4:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107cca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ccd:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107cd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cd7:	05 b4 00 00 00       	add    $0xb4,%eax
80107cdc:	89 c3                	mov    %eax,%ebx
80107cde:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ce1:	05 b4 00 00 00       	add    $0xb4,%eax
80107ce6:	c1 e8 10             	shr    $0x10,%eax
80107ce9:	89 c1                	mov    %eax,%ecx
80107ceb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cee:	05 b4 00 00 00       	add    $0xb4,%eax
80107cf3:	c1 e8 18             	shr    $0x18,%eax
80107cf6:	89 c2                	mov    %eax,%edx
80107cf8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cfb:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107d02:	00 00 
80107d04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d07:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107d0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d11:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107d17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d1a:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d21:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d24:	83 c9 02             	or     $0x2,%ecx
80107d27:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d30:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d37:	83 c9 10             	or     $0x10,%ecx
80107d3a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d40:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d43:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d4a:	83 e1 9f             	and    $0xffffff9f,%ecx
...
80107d5d:	83 c9 80             	or     $0xffffff80,%ecx
80107d60:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d69:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d70:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d73:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107d79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d7c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d83:	83 e1 ef             	and    $0xffffffef,%ecx
80107d86:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107d8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d8f:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d96:	83 e1 df             	and    $0xffffffdf,%ecx
...
80107dbc:	83 c9 80             	or     $0xffffff80,%ecx
80107dbf:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107dc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc8:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107dce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dd1:	83 c0 70             	add    $0x70,%eax
80107dd4:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107ddb:	00 
80107ddc:	89 04 24             	mov    %eax,(%esp)
80107ddf:	e8 37 fb ff ff       	call   8010791b <lgdt>
  loadgs(SEG_KCPU << 3);
80107de4:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107deb:	e8 6a fb ff ff       	call   8010795a <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107df0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107df3:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107df9:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107e00:	00 00 00 00 
}
80107e04:	83 c4 24             	add    $0x24,%esp
80107e07:	5b                   	pop    %ebx
80107e08:	5d                   	pop    %ebp
80107e09:	c3                   	ret    
...
80107e0d:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107e10:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e13:	c1 e8 16             	shr    $0x16,%eax
...
80107e2f:	74 17                	je     80107e48 <walkpgdir+0x3e>
...
80107e3e:	e8 44 fb ff ff       	call   80107987 <p2v>
80107e43:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107e46:	eb 4b                	jmp    80107e93 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107e48:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107e4c:	74 0e                	je     80107e5c <walkpgdir+0x52>
80107e4e:	e8 9c ac ff ff       	call   80102aef <kalloc>
80107e53:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107e56:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107e5a:	75 07                	jne    80107e63 <walkpgdir+0x59>
      return 0;
80107e5c:	b8 00 00 00 00       	mov    $0x0,%eax
80107e61:	eb 47                	jmp    80107eaa <walkpgdir+0xa0>
...
80107e79:	e8 1f d5 ff ff       	call   8010539d <memset>
...
80107e84:	e8 f1 fa ff ff       	call   8010797a <v2p>
...
80107eb2:	8b 45 0c             	mov    0xc(%ebp),%eax
80107eb5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107eba:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107ebd:	8b 55 0c             	mov    0xc(%ebp),%edx
...
80107ed0:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107ed7:	00 
...
80107ee5:	e8 20 ff ff ff       	call   80107e0a <walkpgdir>
80107eea:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107eed:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ef1:	75 07                	jne    80107efa <mappages+0x4e>
      return -1;
80107ef3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107ef8:	eb 48                	jmp    80107f42 <mappages+0x96>
    if(*pte & PTE_P)
80107efa:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107efd:	8b 00                	mov    (%eax),%eax
80107eff:	83 e0 01             	and    $0x1,%eax
80107f02:	85 c0                	test   %eax,%eax
80107f04:	74 0c                	je     80107f12 <mappages+0x66>
      panic("remap");
80107f06:	c7 04 24 98 8d 10 80 	movl   $0x80108d98,(%esp)
80107f0d:	e8 28 86 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
...
80107f28:	75 08                	jne    80107f32 <mappages+0x86>
      break;
80107f2a:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107f30:	eb 10                	jmp    80107f42 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
80107f32:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107f39:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107f40:	eb 8e                	jmp    80107ed0 <mappages+0x24>
  return 0;
}
80107f42:	c9                   	leave  
80107f43:	c3                   	ret    
...
80107f48:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107f4b:	e8 9f ab ff ff       	call   80102aef <kalloc>
...
80107f5e:	e9 98 00 00 00       	jmp    80107ffb <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107f63:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f6a:	00 
80107f6b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107f72:	00 
80107f73:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f76:	89 04 24             	mov    %eax,(%esp)
80107f79:	e8 1f d4 ff ff       	call   8010539d <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107f7e:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107f85:	e8 fd f9 ff ff       	call   80107987 <p2v>
80107f8a:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107f8f:	76 0c                	jbe    80107f9d <setupkvm+0x59>
    panic("PHYSTOP too high");
80107f91:	c7 04 24 9e 8d 10 80 	movl   $0x80108d9e,(%esp)
80107f98:	e8 9d 85 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107f9d:	c7 45 f4 c0 b4 10 80 	movl   $0x8010b4c0,-0xc(%ebp)
80107fa4:	eb 49                	jmp    80107fef <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107fa6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa9:	8b 48 0c             	mov    0xc(%eax),%ecx
80107fac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107faf:	8b 50 04             	mov    0x4(%eax),%edx
80107fb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb5:	8b 58 08             	mov    0x8(%eax),%ebx
80107fb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fbb:	8b 40 04             	mov    0x4(%eax),%eax
80107fbe:	29 c3                	sub    %eax,%ebx
80107fc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc3:	8b 00                	mov    (%eax),%eax
80107fc5:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107fc9:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107fcd:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107fd1:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fd5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fd8:	89 04 24             	mov    %eax,(%esp)
80107fdb:	e8 cc fe ff ff       	call   80107eac <mappages>
80107fe0:	85 c0                	test   %eax,%eax
80107fe2:	79 07                	jns    80107feb <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107fe4:	b8 00 00 00 00       	mov    $0x0,%eax
80107fe9:	eb 10                	jmp    80107ffb <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107feb:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107fef:	81 7d f4 00 b5 10 80 	cmpl   $0x8010b500,-0xc(%ebp)
80107ff6:	72 ae                	jb     80107fa6 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107ffb:	83 c4 34             	add    $0x34,%esp
80107ffe:	5b                   	pop    %ebx
80107fff:	5d                   	pop    %ebp
80108000:	c3                   	ret    
...
80108004:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108007:	e8 38 ff ff ff       	call   80107f44 <setupkvm>
8010800c:	a3 58 85 11 80       	mov    %eax,0x80118558
  switchkvm();
80108011:	e8 02 00 00 00       	call   80108018 <switchkvm>
}
80108016:	c9                   	leave  
80108017:	c3                   	ret    
...
8010801e:	a1 58 85 11 80       	mov    0x80118558,%eax
80108023:	89 04 24             	mov    %eax,(%esp)
80108026:	e8 4f f9 ff ff       	call   8010797a <v2p>
8010802b:	89 04 24             	mov    %eax,(%esp)
8010802e:	e8 3c f9 ff ff       	call   8010796f <lcr3>
}
80108033:	c9                   	leave  
80108034:	c3                   	ret    
...
80108039:	83 ec 14             	sub    $0x14,%esp
  pushcli();
8010803c:	e8 5c d2 ff ff       	call   8010529d <pushcli>
...
80108051:	89 d3                	mov    %edx,%ebx
80108053:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010805a:	83 c2 08             	add    $0x8,%edx
8010805d:	c1 ea 10             	shr    $0x10,%edx
80108060:	89 d1                	mov    %edx,%ecx
80108062:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108069:	83 c2 08             	add    $0x8,%edx
8010806c:	c1 ea 18             	shr    $0x18,%edx
8010806f:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108076:	67 00 
80108078:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010807f:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108085:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010808c:	83 e1 f0             	and    $0xfffffff0,%ecx
8010808f:	83 c9 09             	or     $0x9,%ecx
80108092:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108098:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010809f:	83 c9 10             	or     $0x10,%ecx
801080a2:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080a8:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801080af:	83 e1 9f             	and    $0xffffff9f,%ecx
801080b2:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080b8:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801080bf:	83 c9 80             	or     $0xffffff80,%ecx
801080c2:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080c8:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080cf:	83 e1 f0             	and    $0xfffffff0,%ecx
801080d2:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080d8:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080df:	83 e1 ef             	and    $0xffffffef,%ecx
801080e2:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080e8:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080ef:	83 e1 df             	and    $0xffffffdf,%ecx
801080f2:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080f8:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080ff:	83 c9 40             	or     $0x40,%ecx
80108102:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108108:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010810f:	83 e1 7f             	and    $0x7f,%ecx
80108112:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108118:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
8010811e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108124:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
8010812b:	83 e2 ef             	and    $0xffffffef,%edx
8010812e:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80108134:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010813a:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80108140:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108146:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010814d:	8b 52 08             	mov    0x8(%edx),%edx
80108150:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108156:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108159:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80108160:	e8 df f7 ff ff       	call   80107944 <ltr>
  if(p->pgdir == 0)
80108165:	8b 45 08             	mov    0x8(%ebp),%eax
80108168:	8b 40 04             	mov    0x4(%eax),%eax
8010816b:	85 c0                	test   %eax,%eax
8010816d:	75 0c                	jne    8010817b <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010816f:	c7 04 24 af 8d 10 80 	movl   $0x80108daf,(%esp)
80108176:	e8 bf 83 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
8010817b:	8b 45 08             	mov    0x8(%ebp),%eax
8010817e:	8b 40 04             	mov    0x4(%eax),%eax
80108181:	89 04 24             	mov    %eax,(%esp)
80108184:	e8 f1 f7 ff ff       	call   8010797a <v2p>
80108189:	89 04 24             	mov    %eax,(%esp)
8010818c:	e8 de f7 ff ff       	call   8010796f <lcr3>
  popcli();
80108191:	e8 4b d1 ff ff       	call   801052e1 <popcli>
}
80108196:	83 c4 14             	add    $0x14,%esp
80108199:	5b                   	pop    %ebx
8010819a:	5d                   	pop    %ebp
8010819b:	c3                   	ret    
...
8010819f:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
801081a2:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801081a9:	76 0c                	jbe    801081b7 <inituvm+0x1b>
    panic("inituvm: more than a page");
801081ab:	c7 04 24 c3 8d 10 80 	movl   $0x80108dc3,(%esp)
801081b2:	e8 83 83 ff ff       	call   8010053a <panic>
  mem = kalloc();
801081b7:	e8 33 a9 ff ff       	call   80102aef <kalloc>
801081bc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
801081bf:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081c6:	00 
801081c7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801081ce:	00 
801081cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081d2:	89 04 24             	mov    %eax,(%esp)
801081d5:	e8 c3 d1 ff ff       	call   8010539d <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801081da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081dd:	89 04 24             	mov    %eax,(%esp)
801081e0:	e8 95 f7 ff ff       	call   8010797a <v2p>
801081e5:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801081ec:	00 
801081ed:	89 44 24 0c          	mov    %eax,0xc(%esp)
801081f1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081f8:	00 
801081f9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108200:	00 
80108201:	8b 45 08             	mov    0x8(%ebp),%eax
80108204:	89 04 24             	mov    %eax,(%esp)
80108207:	e8 a0 fc ff ff       	call   80107eac <mappages>
  memmove(mem, init, sz);
8010820c:	8b 45 10             	mov    0x10(%ebp),%eax
8010820f:	89 44 24 08          	mov    %eax,0x8(%esp)
80108213:	8b 45 0c             	mov    0xc(%ebp),%eax
80108216:	89 44 24 04          	mov    %eax,0x4(%esp)
8010821a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010821d:	89 04 24             	mov    %eax,(%esp)
80108220:	e8 47 d2 ff ff       	call   8010546c <memmove>
}
80108225:	c9                   	leave  
80108226:	c3                   	ret    
...
8010822b:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010822e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108231:	25 ff 0f 00 00       	and    $0xfff,%eax
80108236:	85 c0                	test   %eax,%eax
80108238:	74 0c                	je     80108246 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
8010823a:	c7 04 24 e0 8d 10 80 	movl   $0x80108de0,(%esp)
80108241:	e8 f4 82 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108246:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010824d:	e9 a9 00 00 00       	jmp    801082fb <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108252:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108255:	8b 55 0c             	mov    0xc(%ebp),%edx
...
8010826c:	e8 99 fb ff ff       	call   80107e0a <walkpgdir>
80108271:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108274:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108278:	75 0c                	jne    80108286 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010827a:	c7 04 24 03 8e 10 80 	movl   $0x80108e03,(%esp)
80108281:	e8 b4 82 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80108286:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108289:	8b 00                	mov    (%eax),%eax
8010828b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108290:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108293:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108296:	8b 55 18             	mov    0x18(%ebp),%edx
80108299:	29 c2                	sub    %eax,%edx
8010829b:	89 d0                	mov    %edx,%eax
8010829d:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801082a2:	77 0f                	ja     801082b3 <loaduvm+0x8c>
      n = sz - i;
801082a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a7:	8b 55 18             	mov    0x18(%ebp),%edx
801082aa:	29 c2                	sub    %eax,%edx
801082ac:	89 d0                	mov    %edx,%eax
801082ae:	89 45 f0             	mov    %eax,-0x10(%ebp)
801082b1:	eb 07                	jmp    801082ba <loaduvm+0x93>
    else
      n = PGSIZE;
801082b3:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801082ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082bd:	8b 55 14             	mov    0x14(%ebp),%edx
801082c0:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801082c3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082c6:	89 04 24             	mov    %eax,(%esp)
801082c9:	e8 b9 f6 ff ff       	call   80107987 <p2v>
801082ce:	8b 55 f0             	mov    -0x10(%ebp),%edx
801082d1:	89 54 24 0c          	mov    %edx,0xc(%esp)
801082d5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801082d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801082dd:	8b 45 10             	mov    0x10(%ebp),%eax
801082e0:	89 04 24             	mov    %eax,(%esp)
801082e3:	e8 8d 9a ff ff       	call   80101d75 <readi>
801082e8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801082eb:	74 07                	je     801082f4 <loaduvm+0xcd>
      return -1;
801082ed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801082f2:	eb 18                	jmp    8010830c <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801082f4:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801082fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082fe:	3b 45 18             	cmp    0x18(%ebp),%eax
80108301:	0f 82 4b ff ff ff    	jb     80108252 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
8010830c:	83 c4 24             	add    $0x24,%esp
8010830f:	5b                   	pop    %ebx
80108310:	5d                   	pop    %ebp
80108311:	c3                   	ret    
...
80108315:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
8010831d:	79 0a                	jns    80108329 <allocuvm+0x17>
    return 0;
8010831f:	b8 00 00 00 00       	mov    $0x0,%eax
80108324:	e9 c1 00 00 00       	jmp    801083ea <allocuvm+0xd8>
  if(newsz < oldsz)
80108329:	8b 45 10             	mov    0x10(%ebp),%eax
8010832c:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010832f:	73 08                	jae    80108339 <allocuvm+0x27>
    return oldsz;
80108331:	8b 45 0c             	mov    0xc(%ebp),%eax
80108334:	e9 b1 00 00 00       	jmp    801083ea <allocuvm+0xd8>
...
80108349:	e9 8d 00 00 00       	jmp    801083db <allocuvm+0xc9>
    mem = kalloc();
8010834e:	e8 9c a7 ff ff       	call   80102aef <kalloc>
80108353:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108356:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010835a:	75 2c                	jne    80108388 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010835c:	c7 04 24 21 8e 10 80 	movl   $0x80108e21,(%esp)
80108363:	e8 38 80 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108368:	8b 45 0c             	mov    0xc(%ebp),%eax
8010836b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010836f:	8b 45 10             	mov    0x10(%ebp),%eax
80108372:	89 44 24 04          	mov    %eax,0x4(%esp)
80108376:	8b 45 08             	mov    0x8(%ebp),%eax
80108379:	89 04 24             	mov    %eax,(%esp)
8010837c:	e8 6b 00 00 00       	call   801083ec <deallocuvm>
      return 0;
80108381:	b8 00 00 00 00       	mov    $0x0,%eax
80108386:	eb 62                	jmp    801083ea <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108388:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010838f:	00 
80108390:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108397:	00 
80108398:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010839b:	89 04 24             	mov    %eax,(%esp)
8010839e:	e8 fa cf ff ff       	call   8010539d <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801083a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083a6:	89 04 24             	mov    %eax,(%esp)
801083a9:	e8 cc f5 ff ff       	call   8010797a <v2p>
801083ae:	8b 55 f4             	mov    -0xc(%ebp),%edx
801083b1:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801083b8:	00 
801083b9:	89 44 24 0c          	mov    %eax,0xc(%esp)
801083bd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083c4:	00 
801083c5:	89 54 24 04          	mov    %edx,0x4(%esp)
801083c9:	8b 45 08             	mov    0x8(%ebp),%eax
801083cc:	89 04 24             	mov    %eax,(%esp)
801083cf:	e8 d8 fa ff ff       	call   80107eac <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801083d4:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801083db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083de:	3b 45 10             	cmp    0x10(%ebp),%eax
801083e1:	0f 82 67 ff ff ff    	jb     8010834e <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
801083e7:	8b 45 10             	mov    0x10(%ebp),%eax
}
801083ea:	c9                   	leave  
801083eb:	c3                   	ret    
...
801083f5:	3b 45 0c             	cmp    0xc(%ebp),%eax
801083f8:	72 08                	jb     80108402 <deallocuvm+0x16>
    return oldsz;
801083fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801083fd:	e9 a4 00 00 00       	jmp    801084a6 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108402:	8b 45 10             	mov    0x10(%ebp),%eax
80108405:	05 ff 0f 00 00       	add    $0xfff,%eax
8010840a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010840f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108412:	e9 80 00 00 00       	jmp    80108497 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108417:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010841a:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108421:	00 
80108422:	89 44 24 04          	mov    %eax,0x4(%esp)
80108426:	8b 45 08             	mov    0x8(%ebp),%eax
80108429:	89 04 24             	mov    %eax,(%esp)
8010842c:	e8 d9 f9 ff ff       	call   80107e0a <walkpgdir>
80108431:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108434:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108438:	75 09                	jne    80108443 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010843a:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108441:	eb 4d                	jmp    80108490 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108443:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108446:	8b 00                	mov    (%eax),%eax
80108448:	83 e0 01             	and    $0x1,%eax
8010844b:	85 c0                	test   %eax,%eax
8010844d:	74 41                	je     80108490 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010844f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108452:	8b 00                	mov    (%eax),%eax
80108454:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108459:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
8010845c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108460:	75 0c                	jne    8010846e <deallocuvm+0x82>
        panic("kfree");
80108462:	c7 04 24 39 8e 10 80 	movl   $0x80108e39,(%esp)
80108469:	e8 cc 80 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
8010846e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108471:	89 04 24             	mov    %eax,(%esp)
80108474:	e8 0e f5 ff ff       	call   80107987 <p2v>
80108479:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010847c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010847f:	89 04 24             	mov    %eax,(%esp)
80108482:	e8 cf a5 ff ff       	call   80102a56 <kfree>
      *pte = 0;
80108487:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010848a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108490:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108497:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010849a:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010849d:	0f 82 74 ff ff ff    	jb     80108417 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801084ab:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
801084ae:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801084b2:	75 0c                	jne    801084c0 <freevm+0x18>
    panic("freevm: no pgdir");
801084b4:	c7 04 24 3f 8e 10 80 	movl   $0x80108e3f,(%esp)
801084bb:	e8 7a 80 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801084c0:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801084c7:	00 
801084c8:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801084cf:	80 
801084d0:	8b 45 08             	mov    0x8(%ebp),%eax
801084d3:	89 04 24             	mov    %eax,(%esp)
801084d6:	e8 11 ff ff ff       	call   801083ec <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801084db:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801084e2:	eb 48                	jmp    8010852c <freevm+0x84>
    if(pgdir[i] & PTE_P){
801084e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084e7:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801084ee:	8b 45 08             	mov    0x8(%ebp),%eax
801084f1:	01 d0                	add    %edx,%eax
801084f3:	8b 00                	mov    (%eax),%eax
801084f5:	83 e0 01             	and    $0x1,%eax
801084f8:	85 c0                	test   %eax,%eax
801084fa:	74 2c                	je     80108528 <freevm+0x80>
...
80108523:	e8 2e a5 ff ff       	call   80102a56 <kfree>
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108528:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010852c:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108533:	76 af                	jbe    801084e4 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
8010853b:	e8 16 a5 ff ff       	call   80102a56 <kfree>
}
80108540:	c9                   	leave  
80108541:	c3                   	ret    
...
80108548:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010854f:	00 
...
8010855d:	e8 a8 f8 ff ff       	call   80107e0a <walkpgdir>
80108562:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108565:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108569:	75 0c                	jne    80108577 <clearpteu+0x35>
    panic("clearpteu");
8010856b:	c7 04 24 50 8e 10 80 	movl   $0x80108e50,(%esp)
80108572:	e8 c3 7f ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108577:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010857a:	8b 00                	mov    (%eax),%eax
8010857c:	83 e0 fb             	and    $0xfffffffb,%eax
8010857f:	89 c2                	mov    %eax,%edx
80108581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108584:	89 10                	mov    %edx,(%eax)
}
80108586:	c9                   	leave  
80108587:	c3                   	ret    
...
8010858c:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010858f:	e8 b0 f9 ff ff       	call   80107f44 <setupkvm>
80108594:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108597:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010859b:	75 0a                	jne    801085a7 <copyuvm+0x1f>
    return 0;
8010859d:	b8 00 00 00 00       	mov    $0x0,%eax
801085a2:	e9 fd 00 00 00       	jmp    801086a4 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
801085a7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801085ae:	e9 d0 00 00 00       	jmp    80108683 <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801085b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085b6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801085bd:	00 
801085be:	89 44 24 04          	mov    %eax,0x4(%esp)
801085c2:	8b 45 08             	mov    0x8(%ebp),%eax
801085c5:	89 04 24             	mov    %eax,(%esp)
801085c8:	e8 3d f8 ff ff       	call   80107e0a <walkpgdir>
801085cd:	89 45 ec             	mov    %eax,-0x14(%ebp)
801085d0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801085d4:	75 0c                	jne    801085e2 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801085d6:	c7 04 24 5a 8e 10 80 	movl   $0x80108e5a,(%esp)
801085dd:	e8 58 7f ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
801085e2:	8b 45 ec             	mov    -0x14(%ebp),%eax
801085e5:	8b 00                	mov    (%eax),%eax
801085e7:	83 e0 01             	and    $0x1,%eax
801085ea:	85 c0                	test   %eax,%eax
801085ec:	75 0c                	jne    801085fa <copyuvm+0x72>
      panic("copyuvm: page not present");
801085ee:	c7 04 24 74 8e 10 80 	movl   $0x80108e74,(%esp)
801085f5:	e8 40 7f ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
801085fa:	8b 45 ec             	mov    -0x14(%ebp),%eax
801085fd:	8b 00                	mov    (%eax),%eax
801085ff:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108604:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
80108607:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010860a:	8b 00                	mov    (%eax),%eax
8010860c:	25 ff 0f 00 00       	and    $0xfff,%eax
80108611:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108614:	e8 d6 a4 ff ff       	call   80102aef <kalloc>
80108619:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010861c:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108620:	75 02                	jne    80108624 <copyuvm+0x9c>
      goto bad;
80108622:	eb 70                	jmp    80108694 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108624:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108627:	89 04 24             	mov    %eax,(%esp)
8010862a:	e8 58 f3 ff ff       	call   80107987 <p2v>
8010862f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108636:	00 
80108637:	89 44 24 04          	mov    %eax,0x4(%esp)
8010863b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010863e:	89 04 24             	mov    %eax,(%esp)
80108641:	e8 26 ce ff ff       	call   8010546c <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108646:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108649:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010864c:	89 04 24             	mov    %eax,(%esp)
8010864f:	e8 26 f3 ff ff       	call   8010797a <v2p>
80108654:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108657:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010865b:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010865f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108666:	00 
80108667:	89 54 24 04          	mov    %edx,0x4(%esp)
8010866b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010866e:	89 04 24             	mov    %eax,(%esp)
80108671:	e8 36 f8 ff ff       	call   80107eac <mappages>
80108676:	85 c0                	test   %eax,%eax
80108678:	79 02                	jns    8010867c <copyuvm+0xf4>
      goto bad;
8010867a:	eb 18                	jmp    80108694 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010867c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108683:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108686:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108689:	0f 82 24 ff ff ff    	jb     801085b3 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108692:	eb 10                	jmp    801086a4 <copyuvm+0x11c>

bad:
  freevm(d);
80108694:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108697:	89 04 24             	mov    %eax,(%esp)
8010869a:	e8 09 fe ff ff       	call   801084a8 <freevm>
  return 0;
8010869f:	b8 00 00 00 00       	mov    $0x0,%eax
}
801086a4:	83 c4 44             	add    $0x44,%esp
801086a7:	5b                   	pop    %ebx
801086a8:	5d                   	pop    %ebp
801086a9:	c3                   	ret    
...
801086ad:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801086b0:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801086b7:	00 
801086b8:	8b 45 0c             	mov    0xc(%ebp),%eax
801086bb:	89 44 24 04          	mov    %eax,0x4(%esp)
801086bf:	8b 45 08             	mov    0x8(%ebp),%eax
801086c2:	89 04 24             	mov    %eax,(%esp)
801086c5:	e8 40 f7 ff ff       	call   80107e0a <walkpgdir>
801086ca:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
801086cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086d0:	8b 00                	mov    (%eax),%eax
801086d2:	83 e0 01             	and    $0x1,%eax
801086d5:	85 c0                	test   %eax,%eax
801086d7:	75 07                	jne    801086e0 <uva2ka+0x36>
    return 0;
801086d9:	b8 00 00 00 00       	mov    $0x0,%eax
801086de:	eb 25                	jmp    80108705 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
801086e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086e3:	8b 00                	mov    (%eax),%eax
801086e5:	83 e0 04             	and    $0x4,%eax
801086e8:	85 c0                	test   %eax,%eax
801086ea:	75 07                	jne    801086f3 <uva2ka+0x49>
    return 0;
801086ec:	b8 00 00 00 00       	mov    $0x0,%eax
801086f1:	eb 12                	jmp    80108705 <uva2ka+0x5b>
...
80108700:	e8 82 f2 ff ff       	call   80107987 <p2v>
}
80108705:	c9                   	leave  
80108706:	c3                   	ret    
...
8010870a:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
8010870d:	8b 45 10             	mov    0x10(%ebp),%eax
80108710:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108713:	e9 87 00 00 00       	jmp    8010879f <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
80108718:	8b 45 0c             	mov    0xc(%ebp),%eax
8010871b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108720:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108723:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108726:	89 44 24 04          	mov    %eax,0x4(%esp)
8010872a:	8b 45 08             	mov    0x8(%ebp),%eax
8010872d:	89 04 24             	mov    %eax,(%esp)
80108730:	e8 75 ff ff ff       	call   801086aa <uva2ka>
80108735:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108738:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
8010873c:	75 07                	jne    80108745 <copyout+0x3e>
      return -1;
8010873e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108743:	eb 69                	jmp    801087ae <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108745:	8b 45 0c             	mov    0xc(%ebp),%eax
80108748:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010874b:	29 c2                	sub    %eax,%edx
8010874d:	89 d0                	mov    %edx,%eax
8010874f:	05 00 10 00 00       	add    $0x1000,%eax
80108754:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108757:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010875a:	3b 45 14             	cmp    0x14(%ebp),%eax
8010875d:	76 06                	jbe    80108765 <copyout+0x5e>
      n = len;
8010875f:	8b 45 14             	mov    0x14(%ebp),%eax
80108762:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108765:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108768:	8b 55 0c             	mov    0xc(%ebp),%edx
8010876b:	29 c2                	sub    %eax,%edx
8010876d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108770:	01 c2                	add    %eax,%edx
80108772:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108775:	89 44 24 08          	mov    %eax,0x8(%esp)
80108779:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010877c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108780:	89 14 24             	mov    %edx,(%esp)
80108783:	e8 e4 cc ff ff       	call   8010546c <memmove>
    len -= n;
80108788:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010878b:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010878e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108791:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108794:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108797:	05 00 10 00 00       	add    $0x1000,%eax
8010879c:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
8010879f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
801087a3:	0f 85 6f ff ff ff    	jne    80108718 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  ...
  return 0;
801087a9:	b8 00 00 00 00       	mov    $0x0,%eax
}
801087ae:	c9                   	leave  
801087af:	c3                   	ret    
