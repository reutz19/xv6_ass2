...
80100049:	e8 79 54 00 00       	call   801054c7 <initlock>
...
801000bd:	e8 26 54 00 00       	call   801054e8 <acquire>
...
80100104:	e8 41 54 00 00       	call   8010554a <release>
        return b;
...
8010017c:	e8 c9 53 00 00       	call   8010554a <release>
      return b;
...
8010023c:	e8 a7 52 00 00       	call   801054e8 <acquire>
...
801002a9:	e8 9c 52 00 00       	call   8010554a <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 28 51 00 00       	call   801054e8 <acquire>
...
80100533:	e8 12 50 00 00       	call   8010554a <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010058f:	e8 05 50 00 00       	call   80105599 <getcallerpcs>
  for(i=0; i<10; i++)
...
801006b2:	e8 54 51 00 00       	call   8010580b <memmove>
    pos -= 80;
...
801006e1:	e8 56 50 00 00       	call   8010573c <memset>
  }
...
80100776:	e8 23 6a 00 00       	call   8010719e <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 17 6a 00 00       	call   8010719e <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 0b 6a 00 00       	call   8010719e <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 fe 69 00 00       	call   8010719e <uartputc>
  cgaputc(c);
...
801007ba:	e8 29 4d 00 00       	call   801054e8 <acquire>
  while((c = getc()) >= 0){
...
80100914:	e8 31 4c 00 00       	call   8010554a <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 aa 4b 00 00       	call   801054e8 <acquire>
  while(n > 0){
...
80100959:	e8 ec 4b 00 00       	call   8010554a <release>
        ilock(ip);
...
801009fe:	e8 47 4b 00 00       	call   8010554a <release>
  ilock(ip);
...
80100a32:	e8 b1 4a 00 00       	call   801054e8 <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 d9 4a 00 00       	call   8010554a <release>
  ilock(ip);
...
80100b6e:	e9 76 03 00 00       	jmp    80100ee9 <exec+0x3fa>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 77 77 00 00       	call   801082ef <setupkvm>
...
80100c14:	e8 a4 7a 00 00       	call   801086bd <allocuvm>
...
80100c52:	e8 7b 79 00 00       	call   801085d2 <loaduvm>
...
80100cc0:	e8 f8 79 00 00       	call   801086bd <allocuvm>
...
80100ce5:	e8 03 7c 00 00       	call   801088ed <clearpteu>
  sp = sz;
...
80100d1b:	e8 86 4c 00 00       	call   801059a6 <strlen>
...
80100d44:	e8 5d 4c 00 00       	call   801059a6 <strlen>
...
80100d74:	e8 39 7d 00 00       	call   80108ab2 <copyout>
...
80100e1b:	e8 92 7c 00 00       	call   80108ab2 <copyout>
...
80100e73:	e8 e4 4a 00 00       	call   8010595c <safestrcpy>
...
80100ed2:	e8 09 75 00 00       	call   801083e0 <switchuvm>
  freevm(oldpgdir);
80100ed7:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eda:	89 04 24             	mov    %eax,(%esp)
80100edd:	e8 71 79 00 00       	call   80108853 <freevm>
  return 0;
...
80100ef5:	e8 59 79 00 00       	call   80108853 <freevm>
  if(ip){
...
80100f2c:	e8 96 45 00 00       	call   801054c7 <initlock>
}
80100f31:	c9                   	leave  
80100f32:	c3                   	ret    
...
80100f40:	e8 a3 45 00 00       	call   801054e8 <acquire>
...
80100f69:	e8 dc 45 00 00       	call   8010554a <release>
      return f;
...
80100f87:	e8 be 45 00 00       	call   8010554a <release>
  return 0;
...
80100fa0:	e8 43 45 00 00       	call   801054e8 <acquire>
  if(f->ref < 1)
...
80100fd1:	e8 74 45 00 00       	call   8010554a <release>
  return f;
...
80100fe8:	e8 fb 44 00 00       	call   801054e8 <acquire>
  if(f->ref < 1)
...
80101023:	e8 22 45 00 00       	call   8010554a <release>
...
8010106d:	e8 d8 44 00 00       	call   8010554a <release>
...
80101332:	e8 d4 44 00 00       	call   8010580b <memmove>
  brelse(bp);
...
80101378:	e8 bf 43 00 00       	call   8010573c <memset>
  log_write(bp);
...
801015c6:	e8 fc 3e 00 00       	call   801054c7 <initlock>
}
801015cb:	c9                   	leave  
801015cc:	c3                   	ret    
...
80101648:	e8 ef 40 00 00       	call   8010573c <memset>
      dip->type = type;
...
80101747:	e8 bf 40 00 00       	call   8010580b <memmove>
  log_write(bp);
...
80101771:	e8 72 3d 00 00       	call   801054e8 <acquire>
...
801017bb:	e8 8a 3d 00 00       	call   8010554a <release>
      return ip;
...
8010182c:	e8 19 3d 00 00       	call   8010554a <release>
...
80101843:	e8 a0 3c 00 00       	call   801054e8 <acquire>
  ip->ref++;
...
8010185e:	e8 e7 3c 00 00       	call   8010554a <release>
  return ip;
...
80101891:	e8 52 3c 00 00       	call   801054e8 <acquire>
...
801018d0:	e8 75 3c 00 00       	call   8010554a <release>
...
8010197b:	e8 8b 3e 00 00       	call   8010580b <memmove>
    brelse(bp);
...
801019ec:	e8 f7 3a 00 00       	call   801054e8 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a14:	e8 31 3b 00 00       	call   8010554a <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 bb 3a 00 00       	call   801054e8 <acquire>
...
80101a8a:	e8 bb 3a 00 00       	call   8010554a <release>
    itrunc(ip);
...
80101ab5:	e8 2e 3a 00 00       	call   801054e8 <acquire>
    ip->flags = 0;
...
80101ae5:	e8 60 3a 00 00       	call   8010554a <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101ea6:	e8 60 39 00 00       	call   8010580b <memmove>
    brelse(bp);
...
80102005:	e8 01 38 00 00       	call   8010580b <memmove>
    log_write(bp);
...
80102083:	e8 26 38 00 00       	call   801058ae <strncmp>
}
80102088:	c9                   	leave  
80102089:	c3                   	ret    
...
80102205:	e8 fa 36 00 00       	call   80105904 <strncpy>
  de.inum = inum;
...
801022bc:	e8 4a 35 00 00       	call   8010580b <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d7:	e8 2f 35 00 00       	call   8010580b <memmove>
    name[len] = 0;
...
80102535:	e8 8d 2f 00 00       	call   801054c7 <initlock>
  picenable(IRQ_IDE);
...
801026f8:	e8 eb 2d 00 00       	call   801054e8 <acquire>
  if((b = idequeue) == 0){
...
80102712:	e8 33 2e 00 00       	call   8010554a <release>
...
801027a7:	e8 9e 2d 00 00       	call   8010554a <release>
}
801027ac:	c9                   	leave  
801027ad:	c3                   	ret    
...
8010280b:	e8 d8 2c 00 00       	call   801054e8 <acquire>
...
8010287f:	e8 c6 2c 00 00       	call   8010554a <release>
}
80102884:	c9                   	leave  
80102885:	c3                   	ret    
...
801029d6:	e8 ec 2a 00 00       	call   801054c7 <initlock>
  kmem.use_lock = 0;
...
80102aa5:	e8 92 2c 00 00       	call   8010573c <memset>
...
80102aba:	e8 29 2a 00 00       	call   801054e8 <acquire>
  r = (struct run*)v;
...
80102ae8:	e8 5d 2a 00 00       	call   8010554a <release>
}
80102aed:	c9                   	leave  
80102aee:	c3                   	ret    
...
80102b05:	e8 de 29 00 00       	call   801054e8 <acquire>
  r = kmem.freelist;
...
80102b32:	e8 13 2a 00 00       	call   8010554a <release>
  return (char*)r;
...
80103115:	e8 99 26 00 00       	call   801057b3 <memcmp>
...
80103224:	e8 9e 22 00 00       	call   801054c7 <initlock>
  readsb(ROOTDEV, &sb);
...
801032d8:	e8 2e 25 00 00       	call   8010580b <memmove>
...
8010342a:	e8 b9 20 00 00       	call   801054e8 <acquire>
  while(1){
    if(log.committing){
...
80103496:	e8 af 20 00 00       	call   8010554a <release>
      break;
...
801034b5:	e8 2e 20 00 00       	call   801054e8 <acquire>
  log.outstanding -= 1;
...
8010350b:	e8 3a 20 00 00       	call   8010554a <release>
...
80103522:	e8 c1 1f 00 00       	call   801054e8 <acquire>
    log.committing = 0;
...
80103544:	e8 01 20 00 00       	call   8010554a <release>
  }
}
80103549:	c9                   	leave  
8010354a:	c3                   	ret    
...
801035bf:	e8 47 22 00 00       	call   8010580b <memmove>
...
80103672:	e8 71 1e 00 00       	call   801054e8 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801036e9:	e8 5c 1e 00 00       	call   8010554a <release>
}
801036ee:	c9                   	leave  
801036ef:	c3                   	ret    
...
80103780:	e8 09 39 00 00       	call   8010708e <uartinit>
  pinit();         // process table
80103785:	e8 a3 0b 00 00       	call   8010432d <pinit>
  tvinit();        // trap vectors
8010378a:	e8 b1 34 00 00       	call   80106c40 <tvinit>
  binit();         // buffer cache
...
801037ac:	e8 d1 33 00 00       	call   80106b82 <timerinit>
...
801037d7:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801037da:	e8 e4 4b 00 00       	call   801083c3 <switchkvm>
  seginit();
801037df:	e8 5b 45 00 00       	call   80107d3f <seginit>
  lapicinit();
...
80103810:	e8 9f 35 00 00       	call   80106db4 <idtinit>
...
80103862:	e8 a4 1f 00 00       	call   8010580b <memmove>
...
801039f2:	e8 bc 1d 00 00       	call   801057b3 <memcmp>
...
80103b33:	e8 7b 1c 00 00       	call   801057b3 <memcmp>
...
80103fd1:	e8 f1 14 00 00       	call   801054c7 <initlock>
  (*f0)->type = FD_PIPE;
...
8010407d:	e8 66 14 00 00       	call   801054e8 <acquire>
  if(writable){
...
801040e4:	e8 61 14 00 00       	call   8010554a <release>
    kfree((char*)p);
...
801040fc:	e8 49 14 00 00       	call   8010554a <release>
}
80104101:	c9                   	leave  
80104102:	c3                   	ret    
...
8010410f:	e8 d4 13 00 00       	call   801054e8 <acquire>
  for(i = 0; i < n; i++){
...
80104142:	e8 03 14 00 00       	call   8010554a <release>
        return -1;
...
801041e8:	e8 5d 13 00 00       	call   8010554a <release>
  return n;
...
801041ff:	e8 e4 12 00 00       	call   801054e8 <acquire>
...
80104219:	e8 2c 13 00 00       	call   8010554a <release>
      return -1;
...
801042d5:	e8 70 12 00 00       	call   8010554a <release>
  return i;
...
80104407:	ba f2 6b 10 80       	mov    $0x80106bf2,%edx
...
80104437:	e8 00 13 00 00       	call   8010573c <memset>
...
801044a5:	e8 45 3e 00 00       	call   801082ef <setupkvm>
...
801044ba:	c7 04 24 31 8e 10 80 	movl   $0x80108e31,(%esp)
...
801044e0:	e8 62 40 00 00       	call   80108547 <inituvm>
  p->sz = PGSIZE;
...
80104507:	e8 30 12 00 00       	call   8010573c <memset>
...
80104580:	00 
80104581:	c7 44 24 04 4a 8e 10 	movl   $0x80108e4a,0x4(%esp)
80104588:	80 
80104589:	89 04 24             	mov    %eax,(%esp)
8010458c:	e8 cb 13 00 00       	call   8010595c <safestrcpy>
  p->cwd = namei("/");
80104591:	c7 04 24 53 8e 10 80 	movl   $0x80108e53,(%esp)
...
801045e5:	e8 d3 40 00 00       	call   801086bd <allocuvm>
...
8010461f:	e8 73 41 00 00       	call   80108797 <deallocuvm>
...
80104648:	e8 93 3d 00 00       	call   801083e0 <switchuvm>
  return 0;
...
8010468d:	e8 a1 42 00 00       	call   80108933 <copyuvm>
...
80104794:	e8 c3 11 00 00       	call   8010595c <safestrcpy>
  //copy signal handler
...
801047d6:	75 0c                	jne    801047e4 <fork+0x190>
  {
    popcli();
801047d8:	e8 a3 0e 00 00       	call   80105680 <popcli>
    return -1;
...
80104808:	75 0c                	jne    80104816 <exit+0x22>
    panic("init exiting");
8010480a:	c7 04 24 55 8e 10 80 	movl   $0x80108e55,(%esp)
...
80104926:	e8 33 03 00 00       	call   80104c5e <sched>
  panic("zombie exit");
8010492b:	c7 04 24 62 8e 10 80 	movl   $0x80108e62,(%esp)
...
80104a4b:	e8 a9 f8 ff ff       	call   801042f9 <cas>
        ...
        popcli();
80104a50:	e8 2b 0c 00 00       	call   80105680 <popcli>
        return pid;
...
80104ace:	e8 26 f8 ff ff       	call   801042f9 <cas>
      popcli();
80104ad3:	e8 a8 0b 00 00       	call   80105680 <popcli>
      return -1;
...
80104b02:	c7 04 24 6e 8e 10 80 	movl   $0x80108e6e,(%esp)
...
80104b2f:	e8 1f 3d 00 00       	call   80108853 <freevm>
  p->killed = 0;
...
80104c73:	74 0c                	je     80104c81 <sched+0x23>
    panic("sched locks");
80104c75:	c7 04 24 82 8e 10 80 	movl   $0x80108e82,(%esp)
...
80104c8d:	75 0c                	jne    80104c9b <sched+0x3d>
    panic("sched running");
80104c8f:	c7 04 24 8e 8e 10 80 	movl   $0x80108e8e,(%esp)
...
80104ca9:	c7 04 24 9c 8e 10 80 	movl   $0x80108e9c,(%esp)
...
80104cde:	e8 ea 0c 00 00       	call   801059cd <swtch>
  cpu->intena = intena;
...
80104d5f:	75 0c                	jne    80104d6d <sleep+0x1c>
    panic("sleep");
80104d61:	c7 04 24 b0 8e 10 80 	movl   $0x80108eb0,(%esp)
...
80104db7:	e8 8e 07 00 00       	call   8010554a <release>
  sched();
...
80104f48:	eb 07                	jmp    80104f51 <procdump+0x60>
      ...
      state = "???";
80104f4a:	c7 45 ec c7 8e 10 80 	movl   $0x80108ec7,-0x14(%ebp)
...
80104fa5:	e8 ef 05 00 00       	call   80105599 <getcallerpcs>
...
80104fdd:	75 d4                	jne    80104fb3 <procdump+0xc2>
    ...
    cprintf("\n");
80104fdf:	c7 04 24 d8 8e 10 80 	movl   $0x80108ed8,(%esp)
...
80105065:	e8 69 01 00 00       	call   801051d3 <push>
...
80105109:	0f 84 bd 00 00 00    	je     801051cc <sigpause+0xd1>
  {
...
8010511b:	e8 a4 01 00 00       	call   801052c4 <is_empty>
80105120:	85 c0                	test   %eax,%eax
80105122:	75 0a                	jne    8010512e <sigpause+0x33>
      return 0;
...
8010513b:	89 50 20             	mov    %edx,0x20(%eax)
      cas(&proc->state, RUNNING, nSLEEPING);
8010513e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105144:	83 c0 0c             	add    $0xc,%eax
80105147:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
8010514e:	00 
8010514f:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
80105156:	00 
80105157:	89 04 24             	mov    %eax,(%esp)
8010515a:	e8 9a f1 ff ff       	call   801042f9 <cas>
      // again, check if there are pending signals
      if(!is_empty(&(proc->pending_signals)))
8010515f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105165:	83 e8 80             	sub    $0xffffff80,%eax
80105168:	89 04 24             	mov    %eax,(%esp)
8010516b:	e8 54 01 00 00       	call   801052c4 <is_empty>
80105170:	85 c0                	test   %eax,%eax
80105172:	75 49                	jne    801051bd <sigpause+0xc2>
      {
        cas(&proc->state, SLEEPING, RUNNING);
80105174:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010517a:	83 c0 0c             	add    $0xc,%eax
8010517d:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105184:	00 
80105185:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010518c:	00 
8010518d:	89 04 24             	mov    %eax,(%esp)
80105190:	e8 64 f1 ff ff       	call   801042f9 <cas>
        cas(&proc->state, nSLEEPING, RUNNING);
80105195:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010519b:	83 c0 0c             	add    $0xc,%eax
8010519e:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801051a5:	00 
801051a6:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
801051ad:	00 
...
801051bb:	eb 14                	jmp    801051d1 <sigpause+0xd6>
      ...
      pushcli();
801051bd:	e8 7a 04 00 00       	call   8010563c <pushcli>
      sched();
...
801051dc:	89 45 fc             	mov    %eax,-0x4(%ebp)
801051df:	eb 43                	jmp    80105224 <push+0x51>
    if(cas(&(csf->used), 0, 1)) 
801051e1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051e4:	83 c0 0c             	add    $0xc,%eax
801051e7:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
801051ee:	00 
801051ef:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801051f6:	00 
801051f7:	89 04 24             	mov    %eax,(%esp)
801051fa:	e8 fa f0 ff ff       	call   801042f9 <cas>
801051ff:	85 c0                	test   %eax,%eax
80105201:	74 1d                	je     80105220 <push+0x4d>
      goto found;
80105203:	90                   	nop
...
8010520a:	89 10                	mov    %edx,(%eax)
  csf->recepient_pid = recepient_pid;
8010520c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010520f:	8b 55 10             	mov    0x10(%ebp),%edx
80105212:	89 50 04             	mov    %edx,0x4(%eax)
  csf->value = value;
80105215:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105218:	8b 55 14             	mov    0x14(%ebp),%edx
8010521b:	89 50 08             	mov    %edx,0x8(%eax)
8010521e:	eb 18                	jmp    80105238 <push+0x65>
// -------------- cstack implementation ------------
int 
push(struct cstack *cstack, int sender_pid, int recepient_pid, int value)
{
  struct cstackframe *csf;
  for(csf = cstack->frames; csf < &cstack->frames[MAX_CSTACK_FRAMES]; csf++) {
80105220:	83 45 fc 14          	addl   $0x14,-0x4(%ebp)
80105224:	8b 45 08             	mov    0x8(%ebp),%eax
80105227:	05 c8 00 00 00       	add    $0xc8,%eax
8010522c:	3b 45 fc             	cmp    -0x4(%ebp),%eax
8010522f:	77 b0                	ja     801051e1 <push+0xe>
    if(cas(&(csf->used), 0, 1)) 
      goto found;
  }
...
80105236:	eb 3a                	jmp    80105272 <push+0x9f>
  csf->sender_pid = sender_pid;
  csf->recepient_pid = recepient_pid;
  csf->value = value;
...
8010523b:	8b 90 c8 00 00 00    	mov    0xc8(%eax),%edx
80105241:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105244:	89 50 10             	mov    %edx,0x10(%eax)
  } while (!cas((int*)&(cstack->head), (int)csf->next, (int)csf));
80105247:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010524a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010524d:	8b 40 10             	mov    0x10(%eax),%eax
80105250:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105253:	81 c1 c8 00 00 00    	add    $0xc8,%ecx
80105259:	89 54 24 08          	mov    %edx,0x8(%esp)
8010525d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105261:	89 0c 24             	mov    %ecx,(%esp)
80105264:	e8 90 f0 ff ff       	call   801042f9 <cas>
80105269:	85 c0                	test   %eax,%eax
8010526b:	74 cb                	je     80105238 <push+0x65>
...
8010527d:	8b 80 c8 00 00 00    	mov    0xc8(%eax),%eax
80105283:	89 45 fc             	mov    %eax,-0x4(%ebp)
    if (!csf)
80105286:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010528a:	75 07                	jne    80105293 <pop+0x1f>
      return 0;
8010528c:	b8 00 00 00 00       	mov    $0x0,%eax
80105291:	eb 2f                	jmp    801052c2 <pop+0x4e>

    next = csf->next;
80105293:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105296:	8b 40 10             	mov    0x10(%eax),%eax
80105299:	89 45 f8             	mov    %eax,-0x8(%ebp)
...
801052bd:	74 bb                	je     8010527a <pop+0x6>
...
801052ca:	8b 80 c8 00 00 00    	mov    0xc8(%eax),%eax
801052d0:	85 c0                	test   %eax,%eax
801052d2:	0f 94 c0             	sete   %al
801052d5:	0f b6 c0             	movzbl %al,%eax
}
801052d8:	5d                   	pop    %ebp
801052d9:	c3                   	ret    

801052da <roundup_4div>:
...
801052e0:	83 c0 03             	add    $0x3,%eax
801052e3:	83 e0 fc             	and    $0xfffffffc,%eax
}
801052e6:	5d                   	pop    %ebp
801052e7:	c3                   	ret    
...
801052ee:	83 ec 2c             	sub    $0x2c,%esp
  if (proc == 0)  //no proccess
801052f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052f7:	85 c0                	test   %eax,%eax
801052f9:	75 05                	jne    80105300 <fix_tf+0x18>
    return;
801052fb:	e9 89 01 00 00       	jmp    80105489 <fix_tf+0x1a1>

  if (((tf->cs) & 3) != DPL_USER) //has no user privilge
80105300:	8b 45 08             	mov    0x8(%ebp),%eax
80105303:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80105307:	0f b7 c0             	movzwl %ax,%eax
8010530a:	83 e0 03             	and    $0x3,%eax
8010530d:	83 f8 03             	cmp    $0x3,%eax
80105310:	74 05                	je     80105317 <fix_tf+0x2f>
    return;
80105312:	e9 72 01 00 00       	jmp    80105489 <fix_tf+0x1a1>
...
8010531d:	05 9c 01 00 00       	add    $0x19c,%eax
80105322:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80105329:	00 
8010532a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105331:	00 
80105332:	89 04 24             	mov    %eax,(%esp)
80105335:	e8 bf ef ff ff       	call   801042f9 <cas>
8010533a:	85 c0                	test   %eax,%eax
8010533c:	75 05                	jne    80105343 <fix_tf+0x5b>
    goto done;
8010533e:	e9 46 01 00 00       	jmp    80105489 <fix_tf+0x1a1>
...
80105349:	83 e8 80             	sub    $0xffffff80,%eax
8010534c:	89 04 24             	mov    %eax,(%esp)
8010534f:	e8 20 ff ff ff       	call   80105274 <pop>
80105354:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105357:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
8010535b:	74 0e                	je     8010536b <fix_tf+0x83>
8010535d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105363:	8b 40 7c             	mov    0x7c(%eax),%eax
80105366:	83 f8 ff             	cmp    $0xffffffff,%eax
80105369:	75 25                	jne    80105390 <fix_tf+0xa8>
    if (new_signal)
8010536b:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
8010536f:	74 0a                	je     8010537b <fix_tf+0x93>
      new_signal->used = 0;
80105371:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105374:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    proc->handling_signal = 0;
8010537b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105381:	c7 80 9c 01 00 00 00 	movl   $0x0,0x19c(%eax)
80105388:	00 00 00 
    goto done; 
8010538b:	e9 f9 00 00 00       	jmp    80105489 <fix_tf+0x1a1>
  }

  proc->curr_signal = new_signal;
80105390:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105396:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105399:	89 90 98 01 00 00    	mov    %edx,0x198(%eax)

  //else, we have a pending signal and a handler: 
  
  // back-up the old trap-frame for handeling user stack
  proc->old_tf = *(tf);
8010539f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801053a6:	8b 45 08             	mov    0x8(%ebp),%eax
801053a9:	8d 9a 4c 01 00 00    	lea    0x14c(%edx),%ebx
801053af:	89 c2                	mov    %eax,%edx
801053b1:	b8 13 00 00 00       	mov    $0x13,%eax
801053b6:	89 df                	mov    %ebx,%edi
801053b8:	89 d6                	mov    %edx,%esi
801053ba:	89 c1                	mov    %eax,%ecx
801053bc:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  
  int addr_space; 
  //int ret_addr;
  
  int stam = 0;
801053be:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  if (1 == stam) {
801053c5:	83 7d e0 01          	cmpl   $0x1,-0x20(%ebp)
801053c9:	75 07                	jne    801053d2 <fix_tf+0xea>
    goToStack: // lable#1
    asm volatile("movl $24, %eax; int $64"); //movl $SYS_sigret, %eax; int $T_SYSCALL; 
801053cb:	b8 18 00 00 00       	mov    $0x18,%eax
801053d0:	cd 40                	int    $0x40
    returnFromStack:; // lable#2
  }

  addr_space = &&returnFromStack - &&goToStack;
801053d2:	ba d2 53 10 80       	mov    $0x801053d2,%edx
801053d7:	b8 cb 53 10 80       	mov    $0x801053cb,%eax
801053dc:	29 c2                	sub    %eax,%edx
801053de:	89 d0                	mov    %edx,%eax
801053e0:	89 45 dc             	mov    %eax,-0x24(%ebp)
  addr_space = roundup_4div(addr_space);
801053e3:	8b 45 dc             	mov    -0x24(%ebp),%eax
801053e6:	89 04 24             	mov    %eax,(%esp)
801053e9:	e8 ec fe ff ff       	call   801052da <roundup_4div>
801053ee:	89 45 dc             	mov    %eax,-0x24(%ebp)

  tf->esp -= addr_space;
801053f1:	8b 45 08             	mov    0x8(%ebp),%eax
801053f4:	8b 50 44             	mov    0x44(%eax),%edx
801053f7:	8b 45 dc             	mov    -0x24(%ebp),%eax
801053fa:	29 c2                	sub    %eax,%edx
801053fc:	8b 45 08             	mov    0x8(%ebp),%eax
801053ff:	89 50 44             	mov    %edx,0x44(%eax)
  memmove((void *)tf->esp, &&goToStack, addr_space);
80105402:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105405:	8b 45 08             	mov    0x8(%ebp),%eax
80105408:	8b 40 44             	mov    0x44(%eax),%eax
8010540b:	89 54 24 08          	mov    %edx,0x8(%esp)
8010540f:	c7 44 24 04 cb 53 10 	movl   $0x801053cb,0x4(%esp)
80105416:	80 
80105417:	89 04 24             	mov    %eax,(%esp)
8010541a:	e8 ec 03 00 00       	call   8010580b <memmove>

  tf->esp -= 4;
8010541f:	8b 45 08             	mov    0x8(%ebp),%eax
80105422:	8b 40 44             	mov    0x44(%eax),%eax
80105425:	8d 50 fc             	lea    -0x4(%eax),%edx
80105428:	8b 45 08             	mov    0x8(%ebp),%eax
8010542b:	89 50 44             	mov    %edx,0x44(%eax)
  *(uint *)tf->esp = new_signal->value;      //param 2
8010542e:	8b 45 08             	mov    0x8(%ebp),%eax
80105431:	8b 40 44             	mov    0x44(%eax),%eax
80105434:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105437:	8b 52 08             	mov    0x8(%edx),%edx
8010543a:	89 10                	mov    %edx,(%eax)
...
801054b9:	8b 4d 08             	mov    0x8(%ebp),%ecx
801054bc:	f0 87 02             	lock xchg %eax,(%edx)
...
801054cd:	8b 55 0c             	mov    0xc(%ebp),%edx
801054d0:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
801054d3:	8b 45 08             	mov    0x8(%ebp),%eax
801054d6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
801054dc:	8b 45 08             	mov    0x8(%ebp),%eax
801054df:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801054e6:	5d                   	pop    %ebp
801054e7:	c3                   	ret    
...
801054ee:	e8 49 01 00 00       	call   8010563c <pushcli>
  if(holding(lk))
801054f3:	8b 45 08             	mov    0x8(%ebp),%eax
801054f6:	89 04 24             	mov    %eax,(%esp)
801054f9:	e8 14 01 00 00       	call   80105612 <holding>
801054fe:	85 c0                	test   %eax,%eax
80105500:	74 0c                	je     8010550e <acquire+0x26>
    panic("acquire");
80105502:	c7 04 24 1b 8f 10 80 	movl   $0x80108f1b,(%esp)
80105509:	e8 2c b0 ff ff       	call   8010053a <panic>
...
80105512:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105519:	00 
8010551a:	89 04 24             	mov    %eax,(%esp)
8010551d:	e8 8b ff ff ff       	call   801054ad <xchg>
80105522:	85 c0                	test   %eax,%eax
80105524:	75 e9                	jne    8010550f <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80105526:	8b 45 08             	mov    0x8(%ebp),%eax
80105529:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105530:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105533:	8b 45 08             	mov    0x8(%ebp),%eax
80105536:	83 c0 0c             	add    $0xc,%eax
80105539:	89 44 24 04          	mov    %eax,0x4(%esp)
8010553d:	8d 45 08             	lea    0x8(%ebp),%eax
80105540:	89 04 24             	mov    %eax,(%esp)
80105543:	e8 51 00 00 00       	call   80105599 <getcallerpcs>
}
80105548:	c9                   	leave  
80105549:	c3                   	ret    
...
8010554d:	83 ec 18             	sub    $0x18,%esp
  if(!holding(lk))
80105550:	8b 45 08             	mov    0x8(%ebp),%eax
80105553:	89 04 24             	mov    %eax,(%esp)
80105556:	e8 b7 00 00 00       	call   80105612 <holding>
8010555b:	85 c0                	test   %eax,%eax
8010555d:	75 0c                	jne    8010556b <release+0x21>
    panic("release");
8010555f:	c7 04 24 23 8f 10 80 	movl   $0x80108f23,(%esp)
80105566:	e8 cf af ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
8010556b:	8b 45 08             	mov    0x8(%ebp),%eax
8010556e:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105575:	8b 45 08             	mov    0x8(%ebp),%eax
80105578:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105582:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105589:	00 
8010558a:	89 04 24             	mov    %eax,(%esp)
8010558d:	e8 1b ff ff ff       	call   801054ad <xchg>

  popcli();
80105592:	e8 e9 00 00 00       	call   80105680 <popcli>
}
80105597:	c9                   	leave  
80105598:	c3                   	ret    

80105599 <getcallerpcs>:
...
801055a2:	83 e8 08             	sub    $0x8,%eax
801055a5:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801055a8:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
801055af:	eb 38                	jmp    801055e9 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801055b1:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801055b5:	74 38                	je     801055ef <getcallerpcs+0x56>
801055b7:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801055be:	76 2f                	jbe    801055ef <getcallerpcs+0x56>
801055c0:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801055c4:	74 29                	je     801055ef <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
801055c6:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055c9:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801055d0:	8b 45 0c             	mov    0xc(%ebp),%eax
801055d3:	01 c2                	add    %eax,%edx
801055d5:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055d8:	8b 40 04             	mov    0x4(%eax),%eax
801055db:	89 02                	mov    %eax,(%edx)
...
801055e2:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
801055e5:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801055e9:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801055ed:	7e c2                	jle    801055b1 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801055ef:	eb 19                	jmp    8010560a <getcallerpcs+0x71>
    pcs[i] = 0;
801055f1:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055f4:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801055fb:	8b 45 0c             	mov    0xc(%ebp),%eax
801055fe:	01 d0                	add    %edx,%eax
80105600:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
8010560e:	7e e1                	jle    801055f1 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80105610:	c9                   	leave  
80105611:	c3                   	ret    
...
8010561c:	74 17                	je     80105635 <holding+0x23>
8010561e:	8b 45 08             	mov    0x8(%ebp),%eax
80105621:	8b 50 08             	mov    0x8(%eax),%edx
80105624:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010562a:	39 c2                	cmp    %eax,%edx
8010562c:	75 07                	jne    80105635 <holding+0x23>
8010562e:	b8 01 00 00 00       	mov    $0x1,%eax
80105633:	eb 05                	jmp    8010563a <holding+0x28>
...
8010563f:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105642:	e8 4a fe ff ff       	call   80105491 <readeflags>
80105647:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
8010564a:	e8 52 fe ff ff       	call   801054a1 <cli>
  if(cpu->ncli++ == 0)
8010564f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105656:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
8010565c:	8d 48 01             	lea    0x1(%eax),%ecx
8010565f:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
80105665:	85 c0                	test   %eax,%eax
80105667:	75 15                	jne    8010567e <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80105669:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010566f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105672:	81 e2 00 02 00 00    	and    $0x200,%edx
80105678:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010567e:	c9                   	leave  
8010567f:	c3                   	ret    
...
80105683:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105686:	e8 06 fe ff ff       	call   80105491 <readeflags>
8010568b:	25 00 02 00 00       	and    $0x200,%eax
80105690:	85 c0                	test   %eax,%eax
80105692:	74 0c                	je     801056a0 <popcli+0x20>
    panic("popcli - interruptible");
80105694:	c7 04 24 2b 8f 10 80 	movl   $0x80108f2b,(%esp)
8010569b:	e8 9a ae ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
801056a0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056a6:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801056ac:	83 ea 01             	sub    $0x1,%edx
801056af:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801056b5:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801056bb:	85 c0                	test   %eax,%eax
801056bd:	79 0c                	jns    801056cb <popcli+0x4b>
    panic("popcli");
801056bf:	c7 04 24 42 8f 10 80 	movl   $0x80108f42,(%esp)
801056c6:	e8 6f ae ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
801056cb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056d1:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801056d7:	85 c0                	test   %eax,%eax
801056d9:	75 15                	jne    801056f0 <popcli+0x70>
801056db:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056e1:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801056e7:	85 c0                	test   %eax,%eax
801056e9:	74 05                	je     801056f0 <popcli+0x70>
    sti();
801056eb:	e8 b7 fd ff ff       	call   801054a7 <sti>
}
801056f0:	c9                   	leave  
801056f1:	c3                   	ret    
...
801056f7:	8b 4d 08             	mov    0x8(%ebp),%ecx
801056fa:	8b 55 10             	mov    0x10(%ebp),%edx
801056fd:	8b 45 0c             	mov    0xc(%ebp),%eax
80105700:	89 cb                	mov    %ecx,%ebx
80105702:	89 df                	mov    %ebx,%edi
80105704:	89 d1                	mov    %edx,%ecx
80105706:	fc                   	cld    
80105707:	f3 aa                	rep stos %al,%es:(%edi)
80105709:	89 ca                	mov    %ecx,%edx
8010570b:	89 fb                	mov    %edi,%ebx
8010570d:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
8010571c:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010571f:	8b 55 10             	mov    0x10(%ebp),%edx
80105722:	8b 45 0c             	mov    0xc(%ebp),%eax
80105725:	89 cb                	mov    %ecx,%ebx
80105727:	89 df                	mov    %ebx,%edi
80105729:	89 d1                	mov    %edx,%ecx
8010572b:	fc                   	cld    
8010572c:	f3 ab                	rep stos %eax,%es:(%edi)
8010572e:	89 ca                	mov    %ecx,%edx
80105730:	89 fb                	mov    %edi,%ebx
80105732:	89 5d 08             	mov    %ebx,0x8(%ebp)
80105735:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105745:	83 e0 03             	and    $0x3,%eax
80105748:	85 c0                	test   %eax,%eax
8010574a:	75 49                	jne    80105795 <memset+0x59>
8010574c:	8b 45 10             	mov    0x10(%ebp),%eax
8010574f:	83 e0 03             	and    $0x3,%eax
80105752:	85 c0                	test   %eax,%eax
80105754:	75 3f                	jne    80105795 <memset+0x59>
    c &= 0xFF;
80105756:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010575d:	8b 45 10             	mov    0x10(%ebp),%eax
80105760:	c1 e8 02             	shr    $0x2,%eax
80105763:	89 c2                	mov    %eax,%edx
80105765:	8b 45 0c             	mov    0xc(%ebp),%eax
80105768:	c1 e0 18             	shl    $0x18,%eax
8010576b:	89 c1                	mov    %eax,%ecx
8010576d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105770:	c1 e0 10             	shl    $0x10,%eax
80105773:	09 c1                	or     %eax,%ecx
80105775:	8b 45 0c             	mov    0xc(%ebp),%eax
80105778:	c1 e0 08             	shl    $0x8,%eax
8010577b:	09 c8                	or     %ecx,%eax
8010577d:	0b 45 0c             	or     0xc(%ebp),%eax
80105780:	89 54 24 08          	mov    %edx,0x8(%esp)
80105784:	89 44 24 04          	mov    %eax,0x4(%esp)
80105788:	8b 45 08             	mov    0x8(%ebp),%eax
8010578b:	89 04 24             	mov    %eax,(%esp)
8010578e:	e8 84 ff ff ff       	call   80105717 <stosl>
80105793:	eb 19                	jmp    801057ae <memset+0x72>
  } else
    stosb(dst, c, n);
80105795:	8b 45 10             	mov    0x10(%ebp),%eax
80105798:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801057a9:	e8 44 ff ff ff       	call   801056f2 <stosb>
  return dst;
...
801057b6:	83 ec 10             	sub    $0x10,%esp
  const uchar *s1, *s2;
  
  s1 = v1;
801057b9:	8b 45 08             	mov    0x8(%ebp),%eax
801057bc:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
801057bf:	8b 45 0c             	mov    0xc(%ebp),%eax
801057c2:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801057c5:	eb 30                	jmp    801057f7 <memcmp+0x44>
    if(*s1 != *s2)
801057c7:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057ca:	0f b6 10             	movzbl (%eax),%edx
801057cd:	8b 45 f8             	mov    -0x8(%ebp),%eax
801057d0:	0f b6 00             	movzbl (%eax),%eax
801057d3:	38 c2                	cmp    %al,%dl
801057d5:	74 18                	je     801057ef <memcmp+0x3c>
      return *s1 - *s2;
801057d7:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057da:	0f b6 00             	movzbl (%eax),%eax
801057dd:	0f b6 d0             	movzbl %al,%edx
801057e0:	8b 45 f8             	mov    -0x8(%ebp),%eax
801057e3:	0f b6 00             	movzbl (%eax),%eax
801057e6:	0f b6 c0             	movzbl %al,%eax
801057e9:	29 c2                	sub    %eax,%edx
801057eb:	89 d0                	mov    %edx,%eax
801057ed:	eb 1a                	jmp    80105809 <memcmp+0x56>
    s1++, s2++;
801057ef:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801057f3:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
80105802:	75 c3                	jne    801057c7 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105814:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
80105817:	8b 45 08             	mov    0x8(%ebp),%eax
8010581a:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
8010581d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105820:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105823:	73 3d                	jae    80105862 <memmove+0x57>
80105825:	8b 45 10             	mov    0x10(%ebp),%eax
80105828:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010582b:	01 d0                	add    %edx,%eax
8010582d:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105830:	76 30                	jbe    80105862 <memmove+0x57>
    s += n;
80105832:	8b 45 10             	mov    0x10(%ebp),%eax
80105835:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105838:	8b 45 10             	mov    0x10(%ebp),%eax
8010583b:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
8010583e:	eb 13                	jmp    80105853 <memmove+0x48>
      *--d = *--s;
80105840:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105844:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105848:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010584b:	0f b6 10             	movzbl (%eax),%edx
8010584e:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105851:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
8010585e:	75 e0                	jne    80105840 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105860:	eb 26                	jmp    80105888 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105862:	eb 17                	jmp    8010587b <memmove+0x70>
      *d++ = *s++;
80105864:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105867:	8d 50 01             	lea    0x1(%eax),%edx
8010586a:	89 55 f8             	mov    %edx,-0x8(%ebp)
8010586d:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105870:	8d 4a 01             	lea    0x1(%edx),%ecx
80105873:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105876:	0f b6 12             	movzbl (%edx),%edx
80105879:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
8010587b:	8b 45 10             	mov    0x10(%ebp),%eax
8010587e:	8d 50 ff             	lea    -0x1(%eax),%edx
80105881:	89 55 10             	mov    %edx,0x10(%ebp)
80105884:	85 c0                	test   %eax,%eax
80105886:	75 dc                	jne    80105864 <memmove+0x59>
      *d++ = *s++;
...
80105896:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801058a7:	e8 5f ff ff ff       	call   8010580b <memmove>
}
801058ac:	c9                   	leave  
801058ad:	c3                   	ret    
...
801058af:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801058b1:	eb 0c                	jmp    801058bf <strncmp+0x11>
    n--, p++, q++;
...
801058dd:	74 d4                	je     801058b3 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801058df:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058e3:	75 07                	jne    801058ec <strncmp+0x3e>
    return 0;
801058e5:	b8 00 00 00 00       	mov    $0x0,%eax
801058ea:	eb 16                	jmp    80105902 <strncmp+0x54>
...
8010594d:	8d 50 ff             	lea    -0x1(%eax),%edx
80105950:	89 55 10             	mov    %edx,0x10(%ebp)
80105953:	85 c0                	test   %eax,%eax
80105955:	7f e7                	jg     8010593e <strncpy+0x3a>
    *s++ = 0;
  return os;
...
8010595f:	83 ec 10             	sub    $0x10,%esp
  char *os;
  
  os = s;
80105962:	8b 45 08             	mov    0x8(%ebp),%eax
80105965:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105968:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010596c:	7f 05                	jg     80105973 <safestrcpy+0x17>
    return os;
8010596e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105971:	eb 31                	jmp    801059a4 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105973:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105977:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010597b:	7e 1e                	jle    8010599b <safestrcpy+0x3f>
8010597d:	8b 45 08             	mov    0x8(%ebp),%eax
80105980:	8d 50 01             	lea    0x1(%eax),%edx
80105983:	89 55 08             	mov    %edx,0x8(%ebp)
80105986:	8b 55 0c             	mov    0xc(%ebp),%edx
80105989:	8d 4a 01             	lea    0x1(%edx),%ecx
8010598c:	89 4d 0c             	mov    %ecx,0xc(%ebp)
8010598f:	0f b6 12             	movzbl (%edx),%edx
80105992:	88 10                	mov    %dl,(%eax)
80105994:	0f b6 00             	movzbl (%eax),%eax
80105997:	84 c0                	test   %al,%al
80105999:	75 d8                	jne    80105973 <safestrcpy+0x17>
    ;
  *s = 0;
8010599b:	8b 45 08             	mov    0x8(%ebp),%eax
8010599e:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
801059a9:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
801059ac:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801059b3:	eb 04                	jmp    801059b9 <strlen+0x13>
801059b5:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801059b9:	8b 55 fc             	mov    -0x4(%ebp),%edx
801059bc:	8b 45 08             	mov    0x8(%ebp),%eax
801059bf:	01 d0                	add    %edx,%eax
801059c1:	0f b6 00             	movzbl (%eax),%eax
801059c4:	84 c0                	test   %al,%al
801059c6:	75 ed                	jne    801059b5 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801059cd:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801059d1:	8b 54 24 08          	mov    0x8(%esp),%edx

  # Save old callee-save registers
  pushl %ebp
801059d5:	55                   	push   %ebp
  pushl %ebx
801059d6:	53                   	push   %ebx
  pushl %esi
...
801059d8:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801059d9:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801059db:	89 d4                	mov    %edx,%esp
...
801059ed:	3b 45 08             	cmp    0x8(%ebp),%eax
801059f0:	76 12                	jbe    80105a04 <fetchint+0x22>
801059f2:	8b 45 08             	mov    0x8(%ebp),%eax
801059f5:	8d 50 04             	lea    0x4(%eax),%edx
801059f8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059fe:	8b 00                	mov    (%eax),%eax
80105a00:	39 c2                	cmp    %eax,%edx
80105a02:	76 07                	jbe    80105a0b <fetchint+0x29>
    return -1;
80105a04:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a09:	eb 0f                	jmp    80105a1a <fetchint+0x38>
  *ip = *(int*)(addr);
80105a0b:	8b 45 08             	mov    0x8(%ebp),%eax
80105a0e:	8b 10                	mov    (%eax),%edx
...
80105a2a:	3b 45 08             	cmp    0x8(%ebp),%eax
80105a2d:	77 07                	ja     80105a36 <fetchstr+0x1a>
    return -1;
80105a2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a34:	eb 46                	jmp    80105a7c <fetchstr+0x60>
  *pp = (char*)addr;
80105a36:	8b 55 08             	mov    0x8(%ebp),%edx
...
80105a46:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
80105a49:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a4c:	8b 00                	mov    (%eax),%eax
80105a4e:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105a51:	eb 1c                	jmp    80105a6f <fetchstr+0x53>
    if(*s == 0)
80105a53:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a56:	0f b6 00             	movzbl (%eax),%eax
80105a59:	84 c0                	test   %al,%al
80105a5b:	75 0e                	jne    80105a6b <fetchstr+0x4f>
      return s - *pp;
80105a5d:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a60:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a63:	8b 00                	mov    (%eax),%eax
80105a65:	29 c2                	sub    %eax,%edx
80105a67:	89 d0                	mov    %edx,%eax
80105a69:	eb 11                	jmp    80105a7c <fetchstr+0x60>
...
80105a6f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a72:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105a75:	72 dc                	jb     80105a53 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105a8d:	8b 50 44             	mov    0x44(%eax),%edx
80105a90:	8b 45 08             	mov    0x8(%ebp),%eax
80105a93:	c1 e0 02             	shl    $0x2,%eax
80105a96:	01 d0                	add    %edx,%eax
80105a98:	8d 50 04             	lea    0x4(%eax),%edx
80105a9b:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aa2:	89 14 24             	mov    %edx,(%esp)
80105aa5:	e8 38 ff ff ff       	call   801059e2 <fetchint>
}
80105aaa:	c9                   	leave  
80105aab:	c3                   	ret    
...
80105b11:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105b14:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105b17:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b1b:	8b 45 08             	mov    0x8(%ebp),%eax
80105b1e:	89 04 24             	mov    %eax,(%esp)
80105b21:	e8 58 ff ff ff       	call   80105a7e <argint>
80105b26:	85 c0                	test   %eax,%eax
80105b28:	79 07                	jns    80105b31 <argstr+0x23>
    return -1;
80105b2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b2f:	eb 12                	jmp    80105b43 <argstr+0x35>
  return fetchstr(addr, pp);
80105b31:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b34:	8b 55 0c             	mov    0xc(%ebp),%edx
80105b37:	89 54 24 04          	mov    %edx,0x4(%esp)
80105b3b:	89 04 24             	mov    %eax,(%esp)
80105b3e:	e8 d9 fe ff ff       	call   80105a1c <fetchstr>
}
80105b43:	c9                   	leave  
80105b44:	c3                   	ret    
...
80105b49:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105b4c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b52:	8b 40 18             	mov    0x18(%eax),%eax
80105b55:	8b 40 1c             	mov    0x1c(%eax),%eax
80105b58:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105b5b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b5f:	7e 30                	jle    80105b91 <syscall+0x4c>
80105b61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b64:	83 f8 19             	cmp    $0x19,%eax
80105b67:	77 28                	ja     80105b91 <syscall+0x4c>
80105b69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b6c:	8b 04 85 80 c0 10 80 	mov    -0x7fef3f80(,%eax,4),%eax
80105b73:	85 c0                	test   %eax,%eax
80105b75:	74 1a                	je     80105b91 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105b77:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b7d:	8b 58 18             	mov    0x18(%eax),%ebx
80105b80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b83:	8b 04 85 80 c0 10 80 	mov    -0x7fef3f80(,%eax,4),%eax
80105b8a:	ff d0                	call   *%eax
80105b8c:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105b8f:	eb 3d                	jmp    80105bce <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105b91:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b97:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
80105ba6:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105baa:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105bae:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bb2:	c7 04 24 49 8f 10 80 	movl   $0x80108f49,(%esp)
80105bb9:	e8 e2 a7 ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105bbe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bc4:	8b 40 18             	mov    0x18(%eax),%eax
80105bc7:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105bce:	83 c4 24             	add    $0x24,%esp
80105bd1:	5b                   	pop    %ebx
80105bd2:	5d                   	pop    %ebp
80105bd3:	c3                   	ret    
...
80105bd7:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
80105be7:	e8 92 fe ff ff       	call   80105a7e <argint>
80105bec:	85 c0                	test   %eax,%eax
80105bee:	79 07                	jns    80105bf7 <argfd+0x23>
    return -1;
80105bf0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bf5:	eb 50                	jmp    80105c47 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105bf7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bfa:	85 c0                	test   %eax,%eax
80105bfc:	78 21                	js     80105c1f <argfd+0x4b>
80105bfe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c01:	83 f8 0f             	cmp    $0xf,%eax
80105c04:	7f 19                	jg     80105c1f <argfd+0x4b>
80105c06:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c0c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105c0f:	83 c2 08             	add    $0x8,%edx
80105c12:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105c16:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c19:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c1d:	75 07                	jne    80105c26 <argfd+0x52>
    return -1;
80105c1f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c24:	eb 21                	jmp    80105c47 <argfd+0x73>
  if(pfd)
80105c26:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105c2a:	74 08                	je     80105c34 <argfd+0x60>
    *pfd = fd;
80105c2c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105c2f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105c32:	89 10                	mov    %edx,(%eax)
  if(pf)
80105c34:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105c38:	74 08                	je     80105c42 <argfd+0x6e>
    *pf = f;
80105c3a:	8b 45 10             	mov    0x10(%ebp),%eax
80105c3d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c40:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105c4c:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105c4f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105c56:	eb 30                	jmp    80105c88 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105c58:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c5e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c61:	83 c2 08             	add    $0x8,%edx
80105c64:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105c68:	85 c0                	test   %eax,%eax
80105c6a:	75 18                	jne    80105c84 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105c6c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c72:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c75:	8d 4a 08             	lea    0x8(%edx),%ecx
80105c78:	8b 55 08             	mov    0x8(%ebp),%edx
80105c7b:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105c7f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105c82:	eb 0f                	jmp    80105c93 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105c84:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105c88:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105c8c:	7e ca                	jle    80105c58 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105c98:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
80105c9b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105c9e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ca2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105ca9:	00 
80105caa:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105cb1:	e8 1e ff ff ff       	call   80105bd4 <argfd>
80105cb6:	85 c0                	test   %eax,%eax
80105cb8:	79 07                	jns    80105cc1 <sys_dup+0x2c>
    return -1;
80105cba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cbf:	eb 29                	jmp    80105cea <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105cc1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cc4:	89 04 24             	mov    %eax,(%esp)
80105cc7:	e8 7d ff ff ff       	call   80105c49 <fdalloc>
80105ccc:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ccf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105cd3:	79 07                	jns    80105cdc <sys_dup+0x47>
    return -1;
80105cd5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cda:	eb 0e                	jmp    80105cea <sys_dup+0x55>
  filedup(f);
80105cdc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cdf:	89 04 24             	mov    %eax,(%esp)
80105ce2:	e8 ac b2 ff ff       	call   80100f93 <filedup>
  return fd;
...
80105cf9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d00:	00 
80105d01:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d08:	e8 c7 fe ff ff       	call   80105bd4 <argfd>
80105d0d:	85 c0                	test   %eax,%eax
80105d0f:	78 35                	js     80105d46 <sys_read+0x5a>
80105d11:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105d14:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d18:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105d1f:	e8 5a fd ff ff       	call   80105a7e <argint>
80105d24:	85 c0                	test   %eax,%eax
80105d26:	78 1e                	js     80105d46 <sys_read+0x5a>
80105d28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d2b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d2f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105d32:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d36:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d3d:	e8 6a fd ff ff       	call   80105aac <argptr>
80105d42:	85 c0                	test   %eax,%eax
80105d44:	79 07                	jns    80105d4d <sys_read+0x61>
    return -1;
80105d46:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d4b:	eb 19                	jmp    80105d66 <sys_read+0x7a>
  return fileread(f, p, n);
80105d4d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105d50:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105d53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d56:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105d5a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d5e:	89 04 24             	mov    %eax,(%esp)
80105d61:	e8 9a b3 ff ff       	call   80101100 <fileread>
}
80105d66:	c9                   	leave  
80105d67:	c3                   	ret    
...
80105d6b:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;

  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80105d6e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105d71:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d75:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d7c:	00 
80105d7d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d84:	e8 4b fe ff ff       	call   80105bd4 <argfd>
80105d89:	85 c0                	test   %eax,%eax
80105d8b:	78 35                	js     80105dc2 <sys_write+0x5a>
80105d8d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105d90:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d94:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105d9b:	e8 de fc ff ff       	call   80105a7e <argint>
80105da0:	85 c0                	test   %eax,%eax
80105da2:	78 1e                	js     80105dc2 <sys_write+0x5a>
...
80105db2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105db9:	e8 ee fc ff ff       	call   80105aac <argptr>
80105dbe:	85 c0                	test   %eax,%eax
80105dc0:	79 07                	jns    80105dc9 <sys_write+0x61>
    return -1;
80105dc2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dc7:	eb 19                	jmp    80105de2 <sys_write+0x7a>
  return filewrite(f, p, n);
80105dc9:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105dcc:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105dcf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dd2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105dd6:	89 54 24 04          	mov    %edx,0x4(%esp)
80105dda:	89 04 24             	mov    %eax,(%esp)
80105ddd:	e8 da b3 ff ff       	call   801011bc <filewrite>
}
80105de2:	c9                   	leave  
80105de3:	c3                   	ret    
...
80105de7:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  
  if(argfd(0, &fd, &f) < 0)
80105dea:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105ded:	89 44 24 08          	mov    %eax,0x8(%esp)
80105df1:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105df4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105df8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105dff:	e8 d0 fd ff ff       	call   80105bd4 <argfd>
80105e04:	85 c0                	test   %eax,%eax
80105e06:	79 07                	jns    80105e0f <sys_close+0x2b>
    return -1;
80105e08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e0d:	eb 24                	jmp    80105e33 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105e0f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105e15:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e18:	83 c2 08             	add    $0x8,%edx
80105e1b:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105e22:	00 
  fileclose(f);
80105e23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e26:	89 04 24             	mov    %eax,(%esp)
80105e29:	e8 ad b1 ff ff       	call   80100fdb <fileclose>
  return 0;
...
80105e51:	e8 7e fd ff ff       	call   80105bd4 <argfd>
80105e56:	85 c0                	test   %eax,%eax
80105e58:	78 1f                	js     80105e79 <sys_fstat+0x44>
80105e5a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105e61:	00 
80105e62:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e65:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e70:	e8 37 fc ff ff       	call   80105aac <argptr>
80105e75:	85 c0                	test   %eax,%eax
80105e77:	79 07                	jns    80105e80 <sys_fstat+0x4b>
    return -1;
80105e79:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e7e:	eb 12                	jmp    80105e92 <sys_fstat+0x5d>
...
80105e8d:	e8 1f b2 ff ff       	call   801010b1 <filestat>
}
80105e92:	c9                   	leave  
80105e93:	c3                   	ret    
...
80105e97:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105e9a:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105e9d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ea1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ea8:	e8 61 fc ff ff       	call   80105b0e <argstr>
80105ead:	85 c0                	test   %eax,%eax
80105eaf:	78 17                	js     80105ec8 <sys_link+0x34>
80105eb1:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105eb4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105eb8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105ebf:	e8 4a fc ff ff       	call   80105b0e <argstr>
80105ec4:	85 c0                	test   %eax,%eax
80105ec6:	79 0a                	jns    80105ed2 <sys_link+0x3e>
    return -1;
80105ec8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ecd:	e9 42 01 00 00       	jmp    80106014 <sys_link+0x180>

  begin_op();
80105ed2:	e8 46 d5 ff ff       	call   8010341d <begin_op>
  if((ip = namei(old)) == 0){
80105ed7:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105eda:	89 04 24             	mov    %eax,(%esp)
80105edd:	e8 31 c5 ff ff       	call   80102413 <namei>
80105ee2:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ee5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ee9:	75 0f                	jne    80105efa <sys_link+0x66>
    end_op();
80105eeb:	e8 b1 d5 ff ff       	call   801034a1 <end_op>
    return -1;
80105ef0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ef5:	e9 1a 01 00 00       	jmp    80106014 <sys_link+0x180>
  }

  ilock(ip);
80105efa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105efd:	89 04 24             	mov    %eax,(%esp)
80105f00:	e8 63 b9 ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105f05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f08:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f0c:	66 83 f8 01          	cmp    $0x1,%ax
80105f10:	75 1a                	jne    80105f2c <sys_link+0x98>
    iunlockput(ip);
80105f12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f15:	89 04 24             	mov    %eax,(%esp)
80105f18:	e8 cf bb ff ff       	call   80101aec <iunlockput>
    end_op();
80105f1d:	e8 7f d5 ff ff       	call   801034a1 <end_op>
    return -1;
80105f22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f27:	e9 e8 00 00 00       	jmp    80106014 <sys_link+0x180>
  }

  ip->nlink++;
80105f2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f2f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f33:	8d 50 01             	lea    0x1(%eax),%edx
80105f36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f39:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105f3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f40:	89 04 24             	mov    %eax,(%esp)
80105f43:	e8 64 b7 ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80105f48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f4b:	89 04 24             	mov    %eax,(%esp)
80105f4e:	e8 63 ba ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105f53:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f56:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105f59:	89 54 24 04          	mov    %edx,0x4(%esp)
80105f5d:	89 04 24             	mov    %eax,(%esp)
80105f60:	e8 d0 c4 ff ff       	call   80102435 <nameiparent>
80105f65:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f68:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f6c:	75 02                	jne    80105f70 <sys_link+0xdc>
    goto bad;
80105f6e:	eb 68                	jmp    80105fd8 <sys_link+0x144>
  ilock(dp);
80105f70:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f73:	89 04 24             	mov    %eax,(%esp)
80105f76:	e8 ed b8 ff ff       	call   80101868 <ilock>
...
80105f85:	39 c2                	cmp    %eax,%edx
80105f87:	75 20                	jne    80105fa9 <sys_link+0x115>
80105f89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f8c:	8b 40 04             	mov    0x4(%eax),%eax
80105f8f:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105ffa:	e8 ad b6 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105fff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106002:	89 04 24             	mov    %eax,(%esp)
80106005:	e8 e2 ba ff ff       	call   80101aec <iunlockput>
  end_op();
8010600a:	e8 92 d4 ff ff       	call   801034a1 <end_op>
  return -1;
...
80106019:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010601c:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80106023:	eb 4b                	jmp    80106070 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106025:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106028:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010602f:	00 
80106030:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80106041:	e8 2f bd ff ff       	call   80101d75 <readi>
80106046:	83 f8 10             	cmp    $0x10,%eax
80106049:	74 0c                	je     80106057 <isdirempty+0x41>
      panic("isdirempty: readi");
8010604b:	c7 04 24 65 8f 10 80 	movl   $0x80108f65,(%esp)
80106052:	e8 e3 a4 ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80106057:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
8010605b:	66 85 c0             	test   %ax,%ax
8010605e:	74 07                	je     80106067 <isdirempty+0x51>
      return 0;
80106060:	b8 00 00 00 00       	mov    $0x0,%eax
80106065:	eb 1b                	jmp    80106082 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
8010606a:	83 c0 10             	add    $0x10,%eax
...
8010607b:	72 a8                	jb     80106025 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80106087:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
8010608a:	8d 45 cc             	lea    -0x34(%ebp),%eax
8010608d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106091:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106098:	e8 71 fa ff ff       	call   80105b0e <argstr>
8010609d:	85 c0                	test   %eax,%eax
8010609f:	79 0a                	jns    801060ab <sys_unlink+0x27>
    return -1;
801060a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060a6:	e9 af 01 00 00       	jmp    8010625a <sys_unlink+0x1d6>

  begin_op();
801060ab:	e8 6d d3 ff ff       	call   8010341d <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801060b0:	8b 45 cc             	mov    -0x34(%ebp),%eax
801060b3:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801060b6:	89 54 24 04          	mov    %edx,0x4(%esp)
801060ba:	89 04 24             	mov    %eax,(%esp)
801060bd:	e8 73 c3 ff ff       	call   80102435 <nameiparent>
801060c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060c5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060c9:	75 0f                	jne    801060da <sys_unlink+0x56>
    end_op();
801060cb:	e8 d1 d3 ff ff       	call   801034a1 <end_op>
    return -1;
801060d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060d5:	e9 80 01 00 00       	jmp    8010625a <sys_unlink+0x1d6>
  }

  ilock(dp);
801060da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060dd:	89 04 24             	mov    %eax,(%esp)
801060e0:	e8 83 b7 ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801060e5:	c7 44 24 04 77 8f 10 	movl   $0x80108f77,0x4(%esp)
801060ec:	80 
801060ed:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801060f0:	89 04 24             	mov    %eax,(%esp)
801060f3:	e8 70 bf ff ff       	call   80102068 <namecmp>
801060f8:	85 c0                	test   %eax,%eax
801060fa:	0f 84 45 01 00 00    	je     80106245 <sys_unlink+0x1c1>
80106100:	c7 44 24 04 79 8f 10 	movl   $0x80108f79,0x4(%esp)
80106107:	80 
80106108:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010610b:	89 04 24             	mov    %eax,(%esp)
8010610e:	e8 55 bf ff ff       	call   80102068 <namecmp>
80106113:	85 c0                	test   %eax,%eax
80106115:	0f 84 2a 01 00 00    	je     80106245 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
8010611b:	8d 45 c8             	lea    -0x38(%ebp),%eax
8010611e:	89 44 24 08          	mov    %eax,0x8(%esp)
80106122:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106125:	89 44 24 04          	mov    %eax,0x4(%esp)
80106129:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010612c:	89 04 24             	mov    %eax,(%esp)
8010612f:	e8 56 bf ff ff       	call   8010208a <dirlookup>
80106134:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106137:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010613b:	75 05                	jne    80106142 <sys_unlink+0xbe>
    goto bad;
8010613d:	e9 03 01 00 00       	jmp    80106245 <sys_unlink+0x1c1>
  ilock(ip);
...
80106157:	7f 0c                	jg     80106165 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80106159:	c7 04 24 7c 8f 10 80 	movl   $0x80108f7c,(%esp)
80106160:	e8 d5 a3 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106165:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106168:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010616c:	66 83 f8 01          	cmp    $0x1,%ax
80106170:	75 1f                	jne    80106191 <sys_unlink+0x10d>
80106172:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106175:	89 04 24             	mov    %eax,(%esp)
80106178:	e8 99 fe ff ff       	call   80106016 <isdirempty>
8010617d:	85 c0                	test   %eax,%eax
8010617f:	75 10                	jne    80106191 <sys_unlink+0x10d>
    iunlockput(ip);
80106181:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106184:	89 04 24             	mov    %eax,(%esp)
80106187:	e8 60 b9 ff ff       	call   80101aec <iunlockput>
    goto bad;
8010618c:	e9 b4 00 00 00       	jmp    80106245 <sys_unlink+0x1c1>
  }
...
801061a7:	e8 90 f5 ff ff       	call   8010573c <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
801061c8:	e8 0c bd ff ff       	call   80101ed9 <writei>
801061cd:	83 f8 10             	cmp    $0x10,%eax
801061d0:	74 0c                	je     801061de <sys_unlink+0x15a>
    panic("unlink: writei");
801061d2:	c7 04 24 8e 8f 10 80 	movl   $0x80108f8e,(%esp)
801061d9:	e8 5c a3 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
801061de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061e1:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801061e5:	66 83 f8 01          	cmp    $0x1,%ax
801061e9:	75 1c                	jne    80106207 <sys_unlink+0x183>
    dp->nlink--;
...
80106234:	e8 b3 b8 ff ff       	call   80101aec <iunlockput>
  ...
  end_op();
80106239:	e8 63 d2 ff ff       	call   801034a1 <end_op>

  return 0;
8010623e:	b8 00 00 00 00       	mov    $0x0,%eax
80106243:	eb 15                	jmp    8010625a <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80106245:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106248:	89 04 24             	mov    %eax,(%esp)
8010624b:	e8 9c b8 ff ff       	call   80101aec <iunlockput>
  end_op();
80106250:	e8 4c d2 ff ff       	call   801034a1 <end_op>
  return -1;
...
8010625f:	83 ec 48             	sub    $0x48,%esp
80106262:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106265:	8b 55 10             	mov    0x10(%ebp),%edx
80106268:	8b 45 14             	mov    0x14(%ebp),%eax
8010626b:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
8010626f:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106273:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80106277:	8d 45 de             	lea    -0x22(%ebp),%eax
8010627a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010627e:	8b 45 08             	mov    0x8(%ebp),%eax
80106281:	89 04 24             	mov    %eax,(%esp)
80106284:	e8 ac c1 ff ff       	call   80102435 <nameiparent>
80106289:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010628c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106290:	75 0a                	jne    8010629c <create+0x40>
    return 0;
80106292:	b8 00 00 00 00       	mov    $0x0,%eax
80106297:	e9 7e 01 00 00       	jmp    8010641a <create+0x1be>
  ilock(dp);
8010629c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010629f:	89 04 24             	mov    %eax,(%esp)
801062a2:	e8 c1 b5 ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801062a7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801062aa:	89 44 24 08          	mov    %eax,0x8(%esp)
801062ae:	8d 45 de             	lea    -0x22(%ebp),%eax
801062b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801062b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062b8:	89 04 24             	mov    %eax,(%esp)
801062bb:	e8 ca bd ff ff       	call   8010208a <dirlookup>
801062c0:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062c3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062c7:	74 47                	je     80106310 <create+0xb4>
    iunlockput(dp);
...
801062da:	e8 89 b5 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801062df:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801062e4:	75 15                	jne    801062fb <create+0x9f>
801062e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062e9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801062ed:	66 83 f8 02          	cmp    $0x2,%ax
801062f1:	75 08                	jne    801062fb <create+0x9f>
      return ip;
801062f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062f6:	e9 1f 01 00 00       	jmp    8010641a <create+0x1be>
    iunlockput(ip);
801062fb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062fe:	89 04 24             	mov    %eax,(%esp)
80106301:	e8 e6 b7 ff ff       	call   80101aec <iunlockput>
    return 0;
80106306:	b8 00 00 00 00       	mov    $0x0,%eax
8010630b:	e9 0a 01 00 00       	jmp    8010641a <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106310:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80106314:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106317:	8b 00                	mov    (%eax),%eax
80106319:	89 54 24 04          	mov    %edx,0x4(%esp)
8010631d:	89 04 24             	mov    %eax,(%esp)
80106320:	e8 a8 b2 ff ff       	call   801015cd <ialloc>
80106325:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106328:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010632c:	75 0c                	jne    8010633a <create+0xde>
    panic("create: ialloc");
8010632e:	c7 04 24 9d 8f 10 80 	movl   $0x80108f9d,(%esp)
80106335:	e8 00 a2 ff ff       	call   8010053a <panic>

  ilock(ip);
8010633a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010633d:	89 04 24             	mov    %eax,(%esp)
80106340:	e8 23 b5 ff ff       	call   80101868 <ilock>
  ip->major = major;
80106345:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106348:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
8010634c:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106350:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106353:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106357:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
8010635b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010635e:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106364:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106367:	89 04 24             	mov    %eax,(%esp)
8010636a:	e8 3d b3 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
8010636f:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106374:	75 6a                	jne    801063e0 <create+0x184>
    dp->nlink++;  // for ".."
80106376:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106379:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010637d:	8d 50 01             	lea    0x1(%eax),%edx
80106380:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106383:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106387:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010638a:	89 04 24             	mov    %eax,(%esp)
8010638d:	e8 1a b3 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106392:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106395:	8b 40 04             	mov    0x4(%eax),%eax
80106398:	89 44 24 08          	mov    %eax,0x8(%esp)
8010639c:	c7 44 24 04 77 8f 10 	movl   $0x80108f77,0x4(%esp)
801063a3:	80 
801063a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063a7:	89 04 24             	mov    %eax,(%esp)
801063aa:	e8 a4 bd ff ff       	call   80102153 <dirlink>
801063af:	85 c0                	test   %eax,%eax
801063b1:	78 21                	js     801063d4 <create+0x178>
801063b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063b6:	8b 40 04             	mov    0x4(%eax),%eax
801063b9:	89 44 24 08          	mov    %eax,0x8(%esp)
801063bd:	c7 44 24 04 79 8f 10 	movl   $0x80108f79,0x4(%esp)
801063c4:	80 
801063c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063c8:	89 04 24             	mov    %eax,(%esp)
801063cb:	e8 83 bd ff ff       	call   80102153 <dirlink>
801063d0:	85 c0                	test   %eax,%eax
801063d2:	79 0c                	jns    801063e0 <create+0x184>
      panic("create dots");
801063d4:	c7 04 24 ac 8f 10 80 	movl   $0x80108fac,(%esp)
801063db:	e8 5a a1 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
801063e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063e3:	8b 40 04             	mov    0x4(%eax),%eax
801063e6:	89 44 24 08          	mov    %eax,0x8(%esp)
801063ea:	8d 45 de             	lea    -0x22(%ebp),%eax
801063ed:	89 44 24 04          	mov    %eax,0x4(%esp)
801063f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063f4:	89 04 24             	mov    %eax,(%esp)
801063f7:	e8 57 bd ff ff       	call   80102153 <dirlink>
801063fc:	85 c0                	test   %eax,%eax
801063fe:	79 0c                	jns    8010640c <create+0x1b0>
    panic("create: dirlink");
80106400:	c7 04 24 b8 8f 10 80 	movl   $0x80108fb8,(%esp)
80106407:	e8 2e a1 ff ff       	call   8010053a <panic>

  iunlockput(dp);
8010640c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010640f:	89 04 24             	mov    %eax,(%esp)
80106412:	e8 d5 b6 ff ff       	call   80101aec <iunlockput>
...
80106430:	e8 d9 f6 ff ff       	call   80105b0e <argstr>
80106435:	85 c0                	test   %eax,%eax
80106437:	78 17                	js     80106450 <sys_open+0x34>
80106439:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010643c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106440:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106447:	e8 32 f6 ff ff       	call   80105a7e <argint>
8010644c:	85 c0                	test   %eax,%eax
8010644e:	79 0a                	jns    8010645a <sys_open+0x3e>
    return -1;
80106450:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106455:	e9 5c 01 00 00       	jmp    801065b6 <sys_open+0x19a>

  begin_op();
8010645a:	e8 be cf ff ff       	call   8010341d <begin_op>

  if(omode & O_CREATE){
8010645f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106462:	25 00 02 00 00       	and    $0x200,%eax
80106467:	85 c0                	test   %eax,%eax
80106469:	74 3b                	je     801064a6 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
8010646b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010646e:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106475:	00 
80106476:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010647d:	00 
8010647e:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106485:	00 
80106486:	89 04 24             	mov    %eax,(%esp)
80106489:	e8 ce fd ff ff       	call   8010625c <create>
8010648e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80106491:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106495:	75 6b                	jne    80106502 <sys_open+0xe6>
      end_op();
80106497:	e8 05 d0 ff ff       	call   801034a1 <end_op>
      return -1;
8010649c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064a1:	e9 10 01 00 00       	jmp    801065b6 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
801064a6:	8b 45 e8             	mov    -0x18(%ebp),%eax
801064a9:	89 04 24             	mov    %eax,(%esp)
801064ac:	e8 62 bf ff ff       	call   80102413 <namei>
801064b1:	89 45 f4             	mov    %eax,-0xc(%ebp)
801064b4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801064b8:	75 0f                	jne    801064c9 <sys_open+0xad>
      end_op();
801064ba:	e8 e2 cf ff ff       	call   801034a1 <end_op>
      return -1;
801064bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064c4:	e9 ed 00 00 00       	jmp    801065b6 <sys_open+0x19a>
    }
    ilock(ip);
801064c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064cc:	89 04 24             	mov    %eax,(%esp)
801064cf:	e8 94 b3 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801064d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064d7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801064db:	66 83 f8 01          	cmp    $0x1,%ax
801064df:	75 21                	jne    80106502 <sys_open+0xe6>
801064e1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801064e4:	85 c0                	test   %eax,%eax
801064e6:	74 1a                	je     80106502 <sys_open+0xe6>
      iunlockput(ip);
801064e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064eb:	89 04 24             	mov    %eax,(%esp)
801064ee:	e8 f9 b5 ff ff       	call   80101aec <iunlockput>
      end_op();
801064f3:	e8 a9 cf ff ff       	call   801034a1 <end_op>
      return -1;
801064f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064fd:	e9 b4 00 00 00       	jmp    801065b6 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106502:	e8 2c aa ff ff       	call   80100f33 <filealloc>
80106507:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010650a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010650e:	74 14                	je     80106524 <sys_open+0x108>
80106510:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106513:	89 04 24             	mov    %eax,(%esp)
80106516:	e8 2e f7 ff ff       	call   80105c49 <fdalloc>
8010651b:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010651e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106522:	79 28                	jns    8010654c <sys_open+0x130>
    if(f)
80106524:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106528:	74 0b                	je     80106535 <sys_open+0x119>
      fileclose(f);
8010652a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010652d:	89 04 24             	mov    %eax,(%esp)
80106530:	e8 a6 aa ff ff       	call   80100fdb <fileclose>
    iunlockput(ip);
80106535:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106538:	89 04 24             	mov    %eax,(%esp)
8010653b:	e8 ac b5 ff ff       	call   80101aec <iunlockput>
    end_op();
80106540:	e8 5c cf ff ff       	call   801034a1 <end_op>
    return -1;
80106545:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010654a:	eb 6a                	jmp    801065b6 <sys_open+0x19a>
  }
  iunlock(ip);
8010654c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010654f:	89 04 24             	mov    %eax,(%esp)
80106552:	e8 5f b4 ff ff       	call   801019b6 <iunlock>
  end_op();
80106557:	e8 45 cf ff ff       	call   801034a1 <end_op>

  f->type = FD_INODE;
8010655c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010655f:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106565:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106568:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010656b:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
8010656e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106571:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106578:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010657b:	83 e0 01             	and    $0x1,%eax
8010657e:	85 c0                	test   %eax,%eax
80106580:	0f 94 c0             	sete   %al
80106583:	89 c2                	mov    %eax,%edx
80106585:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106588:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010658b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010658e:	83 e0 01             	and    $0x1,%eax
80106591:	85 c0                	test   %eax,%eax
80106593:	75 0a                	jne    8010659f <sys_open+0x183>
80106595:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106598:	83 e0 02             	and    $0x2,%eax
8010659b:	85 c0                	test   %eax,%eax
8010659d:	74 07                	je     801065a6 <sys_open+0x18a>
8010659f:	b8 01 00 00 00       	mov    $0x1,%eax
801065a4:	eb 05                	jmp    801065ab <sys_open+0x18f>
801065a6:	b8 00 00 00 00       	mov    $0x0,%eax
801065ab:	89 c2                	mov    %eax,%edx
801065ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065b0:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801065bb:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801065be:	e8 5a ce ff ff       	call   8010341d <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801065c3:	8d 45 f0             	lea    -0x10(%ebp),%eax
801065c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801065ca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065d1:	e8 38 f5 ff ff       	call   80105b0e <argstr>
801065d6:	85 c0                	test   %eax,%eax
801065d8:	78 2c                	js     80106606 <sys_mkdir+0x4e>
801065da:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065dd:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801065e4:	00 
801065e5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801065ec:	00 
801065ed:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801065f4:	00 
801065f5:	89 04 24             	mov    %eax,(%esp)
801065f8:	e8 5f fc ff ff       	call   8010625c <create>
801065fd:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106600:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106604:	75 0c                	jne    80106612 <sys_mkdir+0x5a>
    end_op();
80106606:	e8 96 ce ff ff       	call   801034a1 <end_op>
    return -1;
8010660b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106610:	eb 15                	jmp    80106627 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106612:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106615:	89 04 24             	mov    %eax,(%esp)
80106618:	e8 cf b4 ff ff       	call   80101aec <iunlockput>
  end_op();
8010661d:	e8 7f ce ff ff       	call   801034a1 <end_op>
  return 0;
...
8010662c:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
8010662f:	e8 e9 cd ff ff       	call   8010341d <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80106634:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106637:	89 44 24 04          	mov    %eax,0x4(%esp)
8010663b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106642:	e8 c7 f4 ff ff       	call   80105b0e <argstr>
80106647:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010664a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010664e:	78 5e                	js     801066ae <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106650:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106653:	89 44 24 04          	mov    %eax,0x4(%esp)
80106657:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010665e:	e8 1b f4 ff ff       	call   80105a7e <argint>
  char *path;
  int len;
  int major, minor;
...
80106665:	78 47                	js     801066ae <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106667:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010666a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010666e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106675:	e8 04 f4 ff ff       	call   80105a7e <argint>
  int len;
  int major, minor;
...
8010667c:	78 30                	js     801066ae <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
8010667e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106681:	0f bf c8             	movswl %ax,%ecx
80106684:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106687:	0f bf d0             	movswl %ax,%edx
...
80106695:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010669c:	00 
8010669d:	89 04 24             	mov    %eax,(%esp)
801066a0:	e8 b7 fb ff ff       	call   8010625c <create>
801066a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
801066a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801066ac:	75 0c                	jne    801066ba <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801066ae:	e8 ee cd ff ff       	call   801034a1 <end_op>
    return -1;
801066b3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b8:	eb 15                	jmp    801066cf <sys_mknod+0xa6>
  }
  iunlockput(ip);
801066ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066bd:	89 04 24             	mov    %eax,(%esp)
801066c0:	e8 27 b4 ff ff       	call   80101aec <iunlockput>
  end_op();
801066c5:	e8 d7 cd ff ff       	call   801034a1 <end_op>
  return 0;
...
801066d4:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
801066d7:	e8 41 cd ff ff       	call   8010341d <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801066dc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801066df:	89 44 24 04          	mov    %eax,0x4(%esp)
801066e3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066ea:	e8 1f f4 ff ff       	call   80105b0e <argstr>
801066ef:	85 c0                	test   %eax,%eax
801066f1:	78 14                	js     80106707 <sys_chdir+0x36>
801066f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066f6:	89 04 24             	mov    %eax,(%esp)
801066f9:	e8 15 bd ff ff       	call   80102413 <namei>
801066fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106701:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106705:	75 0c                	jne    80106713 <sys_chdir+0x42>
    end_op();
80106707:	e8 95 cd ff ff       	call   801034a1 <end_op>
    return -1;
8010670c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106711:	eb 61                	jmp    80106774 <sys_chdir+0xa3>
  }
  ilock(ip);
80106713:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106716:	89 04 24             	mov    %eax,(%esp)
80106719:	e8 4a b1 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
8010671e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106721:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106725:	66 83 f8 01          	cmp    $0x1,%ax
80106729:	74 17                	je     80106742 <sys_chdir+0x71>
    iunlockput(ip);
8010672b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010672e:	89 04 24             	mov    %eax,(%esp)
80106731:	e8 b6 b3 ff ff       	call   80101aec <iunlockput>
    end_op();
80106736:	e8 66 cd ff ff       	call   801034a1 <end_op>
    return -1;
8010673b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106740:	eb 32                	jmp    80106774 <sys_chdir+0xa3>
  }
  iunlock(ip);
80106742:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106745:	89 04 24             	mov    %eax,(%esp)
80106748:	e8 69 b2 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
8010674d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106753:	8b 40 68             	mov    0x68(%eax),%eax
80106756:	89 04 24             	mov    %eax,(%esp)
80106759:	e8 bd b2 ff ff       	call   80101a1b <iput>
  end_op();
8010675e:	e8 3e cd ff ff       	call   801034a1 <end_op>
  proc->cwd = ip;
80106763:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106769:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010676c:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106779:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106782:	89 44 24 04          	mov    %eax,0x4(%esp)
80106786:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010678d:	e8 7c f3 ff ff       	call   80105b0e <argstr>
80106792:	85 c0                	test   %eax,%eax
80106794:	78 1a                	js     801067b0 <sys_exec+0x3a>
80106796:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010679c:	89 44 24 04          	mov    %eax,0x4(%esp)
801067a0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801067a7:	e8 d2 f2 ff ff       	call   80105a7e <argint>
801067ac:	85 c0                	test   %eax,%eax
801067ae:	79 0a                	jns    801067ba <sys_exec+0x44>
    return -1;
801067b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067b5:	e9 c8 00 00 00       	jmp    80106882 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
801067ba:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801067c1:	00 
801067c2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801067c9:	00 
801067ca:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801067d0:	89 04 24             	mov    %eax,(%esp)
801067d3:	e8 64 ef ff ff       	call   8010573c <memset>
  for(i=0;; i++){
801067d8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801067df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067e2:	83 f8 1f             	cmp    $0x1f,%eax
801067e5:	76 0a                	jbe    801067f1 <sys_exec+0x7b>
      return -1;
801067e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067ec:	e9 91 00 00 00       	jmp    80106882 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801067f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067f4:	c1 e0 02             	shl    $0x2,%eax
801067f7:	89 c2                	mov    %eax,%edx
801067f9:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801067ff:	01 c2                	add    %eax,%edx
80106801:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106807:	89 44 24 04          	mov    %eax,0x4(%esp)
8010680b:	89 14 24             	mov    %edx,(%esp)
8010680e:	e8 cf f1 ff ff       	call   801059e2 <fetchint>
80106813:	85 c0                	test   %eax,%eax
80106815:	79 07                	jns    8010681e <sys_exec+0xa8>
      return -1;
80106817:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010681c:	eb 64                	jmp    80106882 <sys_exec+0x10c>
    if(uarg == 0){
8010681e:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106824:	85 c0                	test   %eax,%eax
80106826:	75 26                	jne    8010684e <sys_exec+0xd8>
      argv[i] = 0;
80106828:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010682b:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106832:	00 00 00 00 
      break;
80106836:	90                   	nop
    }
...
8010683a:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106840:	89 54 24 04          	mov    %edx,0x4(%esp)
80106844:	89 04 24             	mov    %eax,(%esp)
80106847:	e8 a3 a2 ff ff       	call   80100aef <exec>
8010684c:	eb 34                	jmp    80106882 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
8010684e:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106854:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106857:	c1 e2 02             	shl    $0x2,%edx
8010685a:	01 c2                	add    %eax,%edx
8010685c:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106862:	89 54 24 04          	mov    %edx,0x4(%esp)
80106866:	89 04 24             	mov    %eax,(%esp)
80106869:	e8 ae f1 ff ff       	call   80105a1c <fetchstr>
8010686e:	85 c0                	test   %eax,%eax
80106870:	79 07                	jns    80106879 <sys_exec+0x103>
      return -1;
80106872:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106877:	eb 09                	jmp    80106882 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106879:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
8010687d:	e9 5d ff ff ff       	jmp    801067df <sys_exec+0x69>
  return exec(path, argv);
}
80106882:	c9                   	leave  
80106883:	c3                   	ret    
...
8010688a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106891:	00 
80106892:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106895:	89 44 24 04          	mov    %eax,0x4(%esp)
80106899:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068a0:	e8 07 f2 ff ff       	call   80105aac <argptr>
801068a5:	85 c0                	test   %eax,%eax
801068a7:	79 0a                	jns    801068b3 <sys_pipe+0x2f>
    return -1;
801068a9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068ae:	e9 9b 00 00 00       	jmp    8010694e <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801068b3:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801068b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801068ba:	8d 45 e8             	lea    -0x18(%ebp),%eax
801068bd:	89 04 24             	mov    %eax,(%esp)
801068c0:	e8 69 d6 ff ff       	call   80103f2e <pipealloc>
801068c5:	85 c0                	test   %eax,%eax
801068c7:	79 07                	jns    801068d0 <sys_pipe+0x4c>
    return -1;
801068c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068ce:	eb 7e                	jmp    8010694e <sys_pipe+0xca>
  fd0 = -1;
801068d0:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801068d7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801068da:	89 04 24             	mov    %eax,(%esp)
801068dd:	e8 67 f3 ff ff       	call   80105c49 <fdalloc>
801068e2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801068e5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801068e9:	78 14                	js     801068ff <sys_pipe+0x7b>
801068eb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801068ee:	89 04 24             	mov    %eax,(%esp)
801068f1:	e8 53 f3 ff ff       	call   80105c49 <fdalloc>
801068f6:	89 45 f0             	mov    %eax,-0x10(%ebp)
801068f9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801068fd:	79 37                	jns    80106936 <sys_pipe+0xb2>
    if(fd0 >= 0)
801068ff:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106903:	78 14                	js     80106919 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106905:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010690b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010690e:	83 c2 08             	add    $0x8,%edx
80106911:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106918:	00 
    fileclose(rf);
80106919:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010691c:	89 04 24             	mov    %eax,(%esp)
8010691f:	e8 b7 a6 ff ff       	call   80100fdb <fileclose>
    fileclose(wf);
80106924:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106927:	89 04 24             	mov    %eax,(%esp)
8010692a:	e8 ac a6 ff ff       	call   80100fdb <fileclose>
    return -1;
8010692f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106934:	eb 18                	jmp    8010694e <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106936:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106939:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010693c:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010693e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106941:	8d 50 04             	lea    0x4(%eax),%edx
80106944:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106947:	89 02                	mov    %eax,(%edx)
  return 0;
...
80106953:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106956:	e8 f9 dc ff ff       	call   80104654 <fork>
}
8010695b:	c9                   	leave  
8010695c:	c3                   	ret    
...
80106960:	83 ec 08             	sub    $0x8,%esp
  exit();
80106963:	e8 8c de ff ff       	call   801047f4 <exit>
...
80106972:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106975:	e8 bf df ff ff       	call   80104939 <wait>
}
8010697a:	c9                   	leave  
8010697b:	c3                   	ret    
...
8010697f:	83 ec 28             	sub    $0x28,%esp
  int pid;
...
80106990:	e8 e9 f0 ff ff       	call   80105a7e <argint>
80106995:	85 c0                	test   %eax,%eax
80106997:	79 07                	jns    801069a0 <sys_kill+0x24>
    return -1;
80106999:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010699e:	eb 0b                	jmp    801069ab <sys_kill+0x2f>
  return kill(pid);
801069a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069a3:	89 04 24             	mov    %eax,(%esp)
801069a6:	e8 cb e4 ff ff       	call   80104e76 <kill>
}
801069ab:	c9                   	leave  
801069ac:	c3                   	ret    
...
801069b6:	8b 40 10             	mov    0x10(%eax),%eax
}
801069b9:	5d                   	pop    %ebp
801069ba:	c3                   	ret    
...
801069c8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069cf:	e8 aa f0 ff ff       	call   80105a7e <argint>
801069d4:	85 c0                	test   %eax,%eax
801069d6:	79 07                	jns    801069df <sys_sbrk+0x24>
    return -1;
801069d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069dd:	eb 24                	jmp    80106a03 <sys_sbrk+0x48>
  addr = proc->sz;
801069df:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069e5:	8b 00                	mov    (%eax),%eax
801069e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
801069ea:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069ed:	89 04 24             	mov    %eax,(%esp)
801069f0:	e8 ba db ff ff       	call   801045af <growproc>
801069f5:	85 c0                	test   %eax,%eax
801069f7:	79 07                	jns    80106a00 <sys_sbrk+0x45>
    return -1;
801069f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069fe:	eb 03                	jmp    80106a03 <sys_sbrk+0x48>
  return addr;
...
80106a08:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
  
  if(argint(0, &n) < 0)
80106a0b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106a0e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a12:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a19:	e8 60 f0 ff ff       	call   80105a7e <argint>
80106a1e:	85 c0                	test   %eax,%eax
80106a20:	79 07                	jns    80106a29 <sys_sleep+0x24>
    return -1;
80106a22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a27:	eb 6c                	jmp    80106a95 <sys_sleep+0x90>
  acquire(&tickslock);
80106a29:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106a30:	e8 b3 ea ff ff       	call   801054e8 <acquire>
  ticks0 = ticks;
80106a35:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106a3a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106a3d:	eb 34                	jmp    80106a73 <sys_sleep+0x6e>
    if(proc->killed){
80106a3f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a45:	8b 40 24             	mov    0x24(%eax),%eax
80106a48:	85 c0                	test   %eax,%eax
80106a4a:	74 13                	je     80106a5f <sys_sleep+0x5a>
      release(&tickslock);
80106a4c:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106a53:	e8 f2 ea ff ff       	call   8010554a <release>
      return -1;
80106a58:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a5d:	eb 36                	jmp    80106a95 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106a5f:	c7 44 24 04 c0 a1 11 	movl   $0x8011a1c0,0x4(%esp)
80106a66:	80 
80106a67:	c7 04 24 00 aa 11 80 	movl   $0x8011aa00,(%esp)
80106a6e:	e8 de e2 ff ff       	call   80104d51 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106a73:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106a78:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106a7b:	89 c2                	mov    %eax,%edx
80106a7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a80:	39 c2                	cmp    %eax,%edx
80106a82:	72 bb                	jb     80106a3f <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106a84:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106a8b:	e8 ba ea ff ff       	call   8010554a <release>
  return 0;
80106a90:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106a95:	c9                   	leave  
80106a96:	c3                   	ret    
...
80106a9a:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
80106a9d:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106aa4:	e8 3f ea ff ff       	call   801054e8 <acquire>
  xticks = ticks;
80106aa9:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106aae:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106ab1:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106ab8:	e8 8d ea ff ff       	call   8010554a <release>
  return xticks;
...
80106ac8:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106acf:	00 
80106ad0:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106ad3:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ad7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ade:	e8 c9 ef ff ff       	call   80105aac <argptr>
80106ae3:	85 c0                	test   %eax,%eax
80106ae5:	79 07                	jns    80106aee <sys_sigset+0x2c>
    return -1;
80106ae7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106aec:	eb 0b                	jmp    80106af9 <sys_sigset+0x37>
  return (int) sigset(new_handler);
80106aee:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106af1:	89 04 24             	mov    %eax,(%esp)
80106af4:	e8 08 e5 ff ff       	call   80105001 <sigset>
}
80106af9:	c9                   	leave  
80106afa:	c3                   	ret    

80106afb <sys_sigsend>:
...
80106b01:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b04:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b08:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b0f:	e8 6a ef ff ff       	call   80105a7e <argint>
80106b14:	85 c0                	test   %eax,%eax
80106b16:	78 17                	js     80106b2f <sys_sigsend+0x34>
80106b18:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b1b:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b1f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106b26:	e8 53 ef ff ff       	call   80105a7e <argint>
80106b2b:	85 c0                	test   %eax,%eax
80106b2d:	79 07                	jns    80106b36 <sys_sigsend+0x3b>
    return -1;
80106b2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b34:	eb 12                	jmp    80106b48 <sys_sigsend+0x4d>
  return sigsend(dest_pid, value);
80106b36:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106b39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b3c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b40:	89 04 24             	mov    %eax,(%esp)
80106b43:	e8 dc e4 ff ff       	call   80105024 <sigsend>
}
80106b48:	c9                   	leave  
80106b49:	c3                   	ret    
...
80106b4d:	83 ec 08             	sub    $0x8,%esp
  return sigret();
80106b50:	e8 47 e5 ff ff       	call   8010509c <sigret>
}
80106b55:	c9                   	leave  
80106b56:	c3                   	ret    

80106b57 <sys_sigpause>:
...
80106b5a:	83 ec 08             	sub    $0x8,%esp
  return sigpause();
80106b5d:	e8 99 e5 ff ff       	call   801050fb <sigpause>
}
80106b62:	c9                   	leave  
80106b63:	c3                   	ret    
...
80106b6a:	8b 55 08             	mov    0x8(%ebp),%edx
80106b6d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b70:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106b74:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106b77:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106b7b:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106b7f:	ee                   	out    %al,(%dx)
}
80106b80:	c9                   	leave  
80106b81:	c3                   	ret    
...
80106b88:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106b8f:	00 
80106b90:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106b97:	e8 c8 ff ff ff       	call   80106b64 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106b9c:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106ba3:	00 
80106ba4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106bab:	e8 b4 ff ff ff       	call   80106b64 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106bb0:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106bb7:	00 
80106bb8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106bbf:	e8 a0 ff ff ff       	call   80106b64 <outb>
  picenable(IRQ_TIMER);
80106bc4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106bcb:	e8 f1 d1 ff ff       	call   80103dc1 <picenable>
}
80106bd0:	c9                   	leave  
80106bd1:	c3                   	ret    
...
80106bd3:	06                   	push   %es
  pushl %fs
80106bd4:	0f a0                	push   %fs
  pushl %gs
80106bd6:	0f a8                	push   %gs
  pushal
80106bd8:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106bd9:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106bdd:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106bdf:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106be1:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106be5:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106be7:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106be9:	54                   	push   %esp
  call trap
80106bea:	e8 e1 01 00 00       	call   80106dd0 <trap>
  addl $4, %esp
80106bef:	83 c4 04             	add    $0x4,%esp
...
trapret:
  pushl %esp
80106bf2:	54                   	push   %esp
  call fix_tf
80106bf3:	e8 f0 e6 ff ff       	call   801052e8 <fix_tf>
  addl $4, %esp  
80106bf8:	83 c4 04             	add    $0x4,%esp
  popal
80106bfb:	61                   	popa   
  popl %gs
80106bfc:	0f a9                	pop    %gs
  popl %fs
80106bfe:	0f a1                	pop    %fs
  popl %es
80106c00:	07                   	pop    %es
  popl %ds
80106c01:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80106c02:	83 c4 08             	add    $0x8,%esp
  iret
80106c05:	cf                   	iret   
...
80106c09:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106c0c:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c0f:	83 e8 01             	sub    $0x1,%eax
80106c12:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106c16:	8b 45 08             	mov    0x8(%ebp),%eax
80106c19:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106c1d:	8b 45 08             	mov    0x8(%ebp),%eax
80106c20:	c1 e8 10             	shr    $0x10,%eax
80106c23:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106c27:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106c2a:	0f 01 18             	lidtl  (%eax)
}
80106c2d:	c9                   	leave  
80106c2e:	c3                   	ret    
...
80106c35:	0f 20 d0             	mov    %cr2,%eax
80106c38:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106c3b:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106c3e:	c9                   	leave  
80106c3f:	c3                   	ret    
...
80106c43:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106c46:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106c4d:	e9 c3 00 00 00       	jmp    80106d15 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106c52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c55:	8b 04 85 e8 c0 10 80 	mov    -0x7fef3f18(,%eax,4),%eax
80106c5c:	89 c2                	mov    %eax,%edx
80106c5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c61:	66 89 14 c5 00 a2 11 	mov    %dx,-0x7fee5e00(,%eax,8)
80106c68:	80 
80106c69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c6c:	66 c7 04 c5 02 a2 11 	movw   $0x8,-0x7fee5dfe(,%eax,8)
80106c73:	80 08 00 
80106c76:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c79:	0f b6 14 c5 04 a2 11 	movzbl -0x7fee5dfc(,%eax,8),%edx
80106c80:	80 
80106c81:	83 e2 e0             	and    $0xffffffe0,%edx
80106c84:	88 14 c5 04 a2 11 80 	mov    %dl,-0x7fee5dfc(,%eax,8)
80106c8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c8e:	0f b6 14 c5 04 a2 11 	movzbl -0x7fee5dfc(,%eax,8),%edx
80106c95:	80 
80106c96:	83 e2 1f             	and    $0x1f,%edx
80106c99:	88 14 c5 04 a2 11 80 	mov    %dl,-0x7fee5dfc(,%eax,8)
80106ca0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ca3:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106caa:	80 
80106cab:	83 e2 f0             	and    $0xfffffff0,%edx
80106cae:	83 ca 0e             	or     $0xe,%edx
80106cb1:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106cb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cbb:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106cc2:	80 
80106cc3:	83 e2 ef             	and    $0xffffffef,%edx
80106cc6:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106ccd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cd0:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106cd7:	80 
80106cd8:	83 e2 9f             	and    $0xffffff9f,%edx
80106cdb:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106ce2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ce5:	0f b6 14 c5 05 a2 11 	movzbl -0x7fee5dfb(,%eax,8),%edx
80106cec:	80 
80106ced:	83 ca 80             	or     $0xffffff80,%edx
80106cf0:	88 14 c5 05 a2 11 80 	mov    %dl,-0x7fee5dfb(,%eax,8)
80106cf7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cfa:	8b 04 85 e8 c0 10 80 	mov    -0x7fef3f18(,%eax,4),%eax
80106d01:	c1 e8 10             	shr    $0x10,%eax
80106d04:	89 c2                	mov    %eax,%edx
80106d06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d09:	66 89 14 c5 06 a2 11 	mov    %dx,-0x7fee5dfa(,%eax,8)
80106d10:	80 
void
tvinit(void)
{
...
80106d15:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106d1c:	0f 8e 30 ff ff ff    	jle    80106c52 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106d22:	a1 e8 c1 10 80       	mov    0x8010c1e8,%eax
80106d27:	66 a3 00 a4 11 80    	mov    %ax,0x8011a400
80106d2d:	66 c7 05 02 a4 11 80 	movw   $0x8,0x8011a402
80106d34:	08 00 
80106d36:	0f b6 05 04 a4 11 80 	movzbl 0x8011a404,%eax
80106d3d:	83 e0 e0             	and    $0xffffffe0,%eax
80106d40:	a2 04 a4 11 80       	mov    %al,0x8011a404
80106d45:	0f b6 05 04 a4 11 80 	movzbl 0x8011a404,%eax
80106d4c:	83 e0 1f             	and    $0x1f,%eax
80106d4f:	a2 04 a4 11 80       	mov    %al,0x8011a404
80106d54:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106d5b:	83 c8 0f             	or     $0xf,%eax
80106d5e:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106d63:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106d6a:	83 e0 ef             	and    $0xffffffef,%eax
80106d6d:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106d72:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106d79:	83 c8 60             	or     $0x60,%eax
80106d7c:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106d81:	0f b6 05 05 a4 11 80 	movzbl 0x8011a405,%eax
80106d88:	83 c8 80             	or     $0xffffff80,%eax
80106d8b:	a2 05 a4 11 80       	mov    %al,0x8011a405
80106d90:	a1 e8 c1 10 80       	mov    0x8010c1e8,%eax
80106d95:	c1 e8 10             	shr    $0x10,%eax
80106d98:	66 a3 06 a4 11 80    	mov    %ax,0x8011a406
  
  initlock(&tickslock, "time");
80106d9e:	c7 44 24 04 c8 8f 10 	movl   $0x80108fc8,0x4(%esp)
80106da5:	80 
80106da6:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106dad:	e8 15 e7 ff ff       	call   801054c7 <initlock>
}
80106db2:	c9                   	leave  
80106db3:	c3                   	ret    
...
80106db7:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106dba:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106dc1:	00 
80106dc2:	c7 04 24 00 a2 11 80 	movl   $0x8011a200,(%esp)
80106dc9:	e8 38 fe ff ff       	call   80106c06 <lidt>
}
80106dce:	c9                   	leave  
80106dcf:	c3                   	ret    
...
80106dd6:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106dd9:	8b 45 08             	mov    0x8(%ebp),%eax
80106ddc:	8b 40 30             	mov    0x30(%eax),%eax
80106ddf:	83 f8 40             	cmp    $0x40,%eax
80106de2:	75 3f                	jne    80106e23 <trap+0x53>
    if(proc->killed)
80106de4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106dea:	8b 40 24             	mov    0x24(%eax),%eax
80106ded:	85 c0                	test   %eax,%eax
80106def:	74 05                	je     80106df6 <trap+0x26>
      exit();
80106df1:	e8 fe d9 ff ff       	call   801047f4 <exit>
    proc->tf = tf;
80106df6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106dfc:	8b 55 08             	mov    0x8(%ebp),%edx
80106dff:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106e02:	e8 3e ed ff ff       	call   80105b45 <syscall>
    if(proc->killed)
80106e07:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e0d:	8b 40 24             	mov    0x24(%eax),%eax
80106e10:	85 c0                	test   %eax,%eax
80106e12:	74 0a                	je     80106e1e <trap+0x4e>
      exit();
80106e14:	e8 db d9 ff ff       	call   801047f4 <exit>
    return;
80106e19:	e9 2d 02 00 00       	jmp    8010704b <trap+0x27b>
80106e1e:	e9 28 02 00 00       	jmp    8010704b <trap+0x27b>
  }

  switch(tf->trapno){
80106e23:	8b 45 08             	mov    0x8(%ebp),%eax
80106e26:	8b 40 30             	mov    0x30(%eax),%eax
80106e29:	83 e8 20             	sub    $0x20,%eax
80106e2c:	83 f8 1f             	cmp    $0x1f,%eax
80106e2f:	0f 87 bc 00 00 00    	ja     80106ef1 <trap+0x121>
80106e35:	8b 04 85 70 90 10 80 	mov    -0x7fef6f90(,%eax,4),%eax
80106e3c:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106e3e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106e44:	0f b6 00             	movzbl (%eax),%eax
80106e47:	84 c0                	test   %al,%al
80106e49:	75 31                	jne    80106e7c <trap+0xac>
      acquire(&tickslock);
80106e4b:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106e52:	e8 91 e6 ff ff       	call   801054e8 <acquire>
      ticks++;
80106e57:	a1 00 aa 11 80       	mov    0x8011aa00,%eax
80106e5c:	83 c0 01             	add    $0x1,%eax
80106e5f:	a3 00 aa 11 80       	mov    %eax,0x8011aa00
      wakeup(&ticks);
80106e64:	c7 04 24 00 aa 11 80 	movl   $0x8011aa00,(%esp)
80106e6b:	e8 e9 df ff ff       	call   80104e59 <wakeup>
      release(&tickslock);
80106e70:	c7 04 24 c0 a1 11 80 	movl   $0x8011a1c0,(%esp)
80106e77:	e8 ce e6 ff ff       	call   8010554a <release>
    }
    lapiceoi();
80106e7c:	e8 5c c0 ff ff       	call   80102edd <lapiceoi>
    break;
80106e81:	e9 41 01 00 00       	jmp    80106fc7 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106e86:	e8 60 b8 ff ff       	call   801026eb <ideintr>
    lapiceoi();
80106e8b:	e8 4d c0 ff ff       	call   80102edd <lapiceoi>
    break;
80106e90:	e9 32 01 00 00       	jmp    80106fc7 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106e95:	e8 12 be ff ff       	call   80102cac <kbdintr>
    lapiceoi();
80106e9a:	e8 3e c0 ff ff       	call   80102edd <lapiceoi>
    break;
80106e9f:	e9 23 01 00 00       	jmp    80106fc7 <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106ea4:	e8 97 03 00 00       	call   80107240 <uartintr>
    lapiceoi();
80106ea9:	e8 2f c0 ff ff       	call   80102edd <lapiceoi>
    break;
80106eae:	e9 14 01 00 00       	jmp    80106fc7 <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106eb3:	8b 45 08             	mov    0x8(%ebp),%eax
80106eb6:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106eb9:	8b 45 08             	mov    0x8(%ebp),%eax
80106ebc:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106ec0:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106ec3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
...
80106ecf:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106ed3:	89 54 24 08          	mov    %edx,0x8(%esp)
80106ed7:	89 44 24 04          	mov    %eax,0x4(%esp)
80106edb:	c7 04 24 d0 8f 10 80 	movl   $0x80108fd0,(%esp)
80106ee2:	e8 b9 94 ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106ee7:	e8 f1 bf ff ff       	call   80102edd <lapiceoi>
    break;
80106eec:	e9 d6 00 00 00       	jmp    80106fc7 <trap+0x1f7>
...
80106ef9:	74 11                	je     80106f0c <trap+0x13c>
80106efb:	8b 45 08             	mov    0x8(%ebp),%eax
80106efe:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106f02:	0f b7 c0             	movzwl %ax,%eax
80106f05:	83 e0 03             	and    $0x3,%eax
80106f08:	85 c0                	test   %eax,%eax
80106f0a:	75 46                	jne    80106f52 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f0c:	e8 1e fd ff ff       	call   80106c2f <rcr2>
80106f11:	8b 55 08             	mov    0x8(%ebp),%edx
80106f14:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106f17:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106f1e:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f21:	0f b6 ca             	movzbl %dl,%ecx
80106f24:	8b 55 08             	mov    0x8(%ebp),%edx
80106f27:	8b 52 30             	mov    0x30(%edx),%edx
80106f2a:	89 44 24 10          	mov    %eax,0x10(%esp)
80106f2e:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106f32:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106f36:	89 54 24 04          	mov    %edx,0x4(%esp)
80106f3a:	c7 04 24 f4 8f 10 80 	movl   $0x80108ff4,(%esp)
80106f41:	e8 5a 94 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106f46:	c7 04 24 26 90 10 80 	movl   $0x80109026,(%esp)
80106f4d:	e8 e8 95 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f52:	e8 d8 fc ff ff       	call   80106c2f <rcr2>
80106f57:	89 c2                	mov    %eax,%edx
80106f59:	8b 45 08             	mov    0x8(%ebp),%eax
80106f5c:	8b 78 38             	mov    0x38(%eax),%edi
...
80106f65:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f68:	0f b6 f0             	movzbl %al,%esi
80106f6b:	8b 45 08             	mov    0x8(%ebp),%eax
80106f6e:	8b 58 34             	mov    0x34(%eax),%ebx
80106f71:	8b 45 08             	mov    0x8(%ebp),%eax
80106f74:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106f77:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f7d:	83 c0 6c             	add    $0x6c,%eax
...
80106f83:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f89:	8b 40 10             	mov    0x10(%eax),%eax
80106f8c:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106f90:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106f94:	89 74 24 14          	mov    %esi,0x14(%esp)
80106f98:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106f9c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106fa0:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106fa3:	89 74 24 08          	mov    %esi,0x8(%esp)
80106fa7:	89 44 24 04          	mov    %eax,0x4(%esp)
80106fab:	c7 04 24 2c 90 10 80 	movl   $0x8010902c,(%esp)
80106fb2:	e8 e9 93 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
...
80106fc4:	eb 01                	jmp    80106fc7 <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106fee:	75 05                	jne    80106ff5 <trap+0x225>
    exit();
80106ff0:	e8 ff d7 ff ff       	call   801047f4 <exit>
...
80107044:	75 05                	jne    8010704b <trap+0x27b>
    exit();
80107046:	e8 a9 d7 ff ff       	call   801047f4 <exit>
}
8010704b:	83 c4 3c             	add    $0x3c,%esp
8010704e:	5b                   	pop    %ebx
8010704f:	5e                   	pop    %esi
80107050:	5f                   	pop    %edi
80107051:	5d                   	pop    %ebp
...
inb(ushort port)
{
80107053:	55                   	push   %ebp
80107054:	89 e5                	mov    %esp,%ebp
80107056:	83 ec 14             	sub    $0x14,%esp
80107059:	8b 45 08             	mov    0x8(%ebp),%eax
8010705c:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107060:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80107064:	89 c2                	mov    %eax,%edx
80107066:	ec                   	in     (%dx),%al
80107067:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
8010706a:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
8010706e:	c9                   	leave  
8010706f:	c3                   	ret    
...
8010707c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80107080:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107083:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80107087:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
8010708b:	ee                   	out    %al,(%dx)
}
8010708c:	c9                   	leave  
8010708d:	c3                   	ret    
...
80107091:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80107094:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010709b:	00 
8010709c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801070a3:	e8 c8 ff ff ff       	call   80107070 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801070a8:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801070af:	00 
801070b0:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801070b7:	e8 b4 ff ff ff       	call   80107070 <outb>
  outb(COM1+0, 115200/9600);
801070bc:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801070c3:	00 
801070c4:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801070cb:	e8 a0 ff ff ff       	call   80107070 <outb>
  outb(COM1+1, 0);
801070d0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801070d7:	00 
801070d8:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801070df:	e8 8c ff ff ff       	call   80107070 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801070e4:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801070eb:	00 
801070ec:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801070f3:	e8 78 ff ff ff       	call   80107070 <outb>
  outb(COM1+4, 0);
801070f8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801070ff:	00 
80107100:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107107:	e8 64 ff ff ff       	call   80107070 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010710c:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107113:	00 
80107114:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010711b:	e8 50 ff ff ff       	call   80107070 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80107120:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107127:	e8 27 ff ff ff       	call   80107053 <inb>
8010712c:	3c ff                	cmp    $0xff,%al
8010712e:	75 02                	jne    80107132 <uartinit+0xa4>
    return;
80107130:	eb 6a                	jmp    8010719c <uartinit+0x10e>
  uart = 1;
80107132:	c7 05 ac c6 10 80 01 	movl   $0x1,0x8010c6ac
80107139:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
8010713c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107143:	e8 0b ff ff ff       	call   80107053 <inb>
  inb(COM1+0);
80107148:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010714f:	e8 ff fe ff ff       	call   80107053 <inb>
  picenable(IRQ_COM1);
80107154:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010715b:	e8 61 cc ff ff       	call   80103dc1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80107160:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107167:	00 
80107168:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010716f:	e8 f6 b7 ff ff       	call   8010296a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107174:	c7 45 f4 f0 90 10 80 	movl   $0x801090f0,-0xc(%ebp)
8010717b:	eb 15                	jmp    80107192 <uartinit+0x104>
    uartputc(*p);
8010717d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107180:	0f b6 00             	movzbl (%eax),%eax
80107183:	0f be c0             	movsbl %al,%eax
80107186:	89 04 24             	mov    %eax,(%esp)
80107189:	e8 10 00 00 00       	call   8010719e <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010718e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107192:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107195:	0f b6 00             	movzbl (%eax),%eax
80107198:	84 c0                	test   %al,%al
8010719a:	75 e1                	jne    8010717d <uartinit+0xef>
    uartputc(*p);
}
8010719c:	c9                   	leave  
8010719d:	c3                   	ret    
...
801071a1:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801071a4:	a1 ac c6 10 80       	mov    0x8010c6ac,%eax
801071a9:	85 c0                	test   %eax,%eax
801071ab:	75 02                	jne    801071af <uartputc+0x11>
    return;
801071ad:	eb 4b                	jmp    801071fa <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801071af:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801071b6:	eb 10                	jmp    801071c8 <uartputc+0x2a>
    microdelay(10);
801071b8:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801071bf:	e8 3e bd ff ff       	call   80102f02 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801071c4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801071c8:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801071cc:	7f 16                	jg     801071e4 <uartputc+0x46>
801071ce:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801071d5:	e8 79 fe ff ff       	call   80107053 <inb>
801071da:	0f b6 c0             	movzbl %al,%eax
801071dd:	83 e0 20             	and    $0x20,%eax
801071e0:	85 c0                	test   %eax,%eax
801071e2:	74 d4                	je     801071b8 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
801071e4:	8b 45 08             	mov    0x8(%ebp),%eax
801071e7:	0f b6 c0             	movzbl %al,%eax
801071ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801071ee:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801071f5:	e8 76 fe ff ff       	call   80107070 <outb>
}
801071fa:	c9                   	leave  
801071fb:	c3                   	ret    
...
801071ff:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107202:	a1 ac c6 10 80       	mov    0x8010c6ac,%eax
80107207:	85 c0                	test   %eax,%eax
80107209:	75 07                	jne    80107212 <uartgetc+0x16>
    return -1;
8010720b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107210:	eb 2c                	jmp    8010723e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107212:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107219:	e8 35 fe ff ff       	call   80107053 <inb>
8010721e:	0f b6 c0             	movzbl %al,%eax
80107221:	83 e0 01             	and    $0x1,%eax
80107224:	85 c0                	test   %eax,%eax
80107226:	75 07                	jne    8010722f <uartgetc+0x33>
    return -1;
80107228:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010722d:	eb 0f                	jmp    8010723e <uartgetc+0x42>
  return inb(COM1+0);
8010722f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107236:	e8 18 fe ff ff       	call   80107053 <inb>
8010723b:	0f b6 c0             	movzbl %al,%eax
}
8010723e:	c9                   	leave  
8010723f:	c3                   	ret    
...
80107246:	c7 04 24 fc 71 10 80 	movl   $0x801071fc,(%esp)
8010724d:	e8 5b 95 ff ff       	call   801007ad <consoleintr>
}
80107252:	c9                   	leave  
80107253:	c3                   	ret    
...
80107256:	6a 00                	push   $0x0
  jmp alltraps
80107258:	e9 75 f9 ff ff       	jmp    80106bd2 <alltraps>
...
8010725f:	6a 01                	push   $0x1
  jmp alltraps
80107261:	e9 6c f9 ff ff       	jmp    80106bd2 <alltraps>
...
80107266:	6a 00                	push   $0x0
  pushl $2
80107268:	6a 02                	push   $0x2
  jmp alltraps
8010726a:	e9 63 f9 ff ff       	jmp    80106bd2 <alltraps>
...
8010726f:	6a 00                	push   $0x0
  pushl $3
80107271:	6a 03                	push   $0x3
  jmp alltraps
80107273:	e9 5a f9 ff ff       	jmp    80106bd2 <alltraps>
...
80107278:	6a 00                	push   $0x0
  pushl $4
8010727a:	6a 04                	push   $0x4
  jmp alltraps
8010727c:	e9 51 f9 ff ff       	jmp    80106bd2 <alltraps>
...
80107281:	6a 00                	push   $0x0
  pushl $5
80107283:	6a 05                	push   $0x5
  jmp alltraps
80107285:	e9 48 f9 ff ff       	jmp    80106bd2 <alltraps>
...
8010728c:	6a 06                	push   $0x6
  jmp alltraps
8010728e:	e9 3f f9 ff ff       	jmp    80106bd2 <alltraps>
...
80107293:	6a 00                	push   $0x0
  pushl $7
80107295:	6a 07                	push   $0x7
  jmp alltraps
80107297:	e9 36 f9 ff ff       	jmp    80106bd2 <alltraps>

8010729c <vector8>:
.globl vector8
vector8:
  pushl $8
8010729c:	6a 08                	push   $0x8
  jmp alltraps
8010729e:	e9 2f f9 ff ff       	jmp    80106bd2 <alltraps>
...
801072a3:	6a 00                	push   $0x0
  pushl $9
801072a5:	6a 09                	push   $0x9
  jmp alltraps
801072a7:	e9 26 f9 ff ff       	jmp    80106bd2 <alltraps>

801072ac <vector10>:
.globl vector10
vector10:
  pushl $10
801072ac:	6a 0a                	push   $0xa
  jmp alltraps
801072ae:	e9 1f f9 ff ff       	jmp    80106bd2 <alltraps>

801072b3 <vector11>:
.globl vector11
vector11:
  pushl $11
801072b3:	6a 0b                	push   $0xb
  jmp alltraps
801072b5:	e9 18 f9 ff ff       	jmp    80106bd2 <alltraps>

801072ba <vector12>:
.globl vector12
vector12:
  pushl $12
801072ba:	6a 0c                	push   $0xc
  jmp alltraps
801072bc:	e9 11 f9 ff ff       	jmp    80106bd2 <alltraps>

801072c1 <vector13>:
.globl vector13
vector13:
  pushl $13
801072c1:	6a 0d                	push   $0xd
  jmp alltraps
801072c3:	e9 0a f9 ff ff       	jmp    80106bd2 <alltraps>

801072c8 <vector14>:
.globl vector14
vector14:
  pushl $14
801072c8:	6a 0e                	push   $0xe
  jmp alltraps
801072ca:	e9 03 f9 ff ff       	jmp    80106bd2 <alltraps>
...
801072cf:	6a 00                	push   $0x0
  pushl $15
801072d1:	6a 0f                	push   $0xf
  jmp alltraps
801072d3:	e9 fa f8 ff ff       	jmp    80106bd2 <alltraps>
...
801072d8:	6a 00                	push   $0x0
  pushl $16
801072da:	6a 10                	push   $0x10
  jmp alltraps
801072dc:	e9 f1 f8 ff ff       	jmp    80106bd2 <alltraps>

801072e1 <vector17>:
.globl vector17
vector17:
  pushl $17
801072e1:	6a 11                	push   $0x11
  jmp alltraps
801072e3:	e9 ea f8 ff ff       	jmp    80106bd2 <alltraps>
...
801072e8:	6a 00                	push   $0x0
  pushl $18
801072ea:	6a 12                	push   $0x12
  jmp alltraps
801072ec:	e9 e1 f8 ff ff       	jmp    80106bd2 <alltraps>
...
801072f1:	6a 00                	push   $0x0
  pushl $19
801072f3:	6a 13                	push   $0x13
  jmp alltraps
801072f5:	e9 d8 f8 ff ff       	jmp    80106bd2 <alltraps>
...
801072fa:	6a 00                	push   $0x0
  pushl $20
801072fc:	6a 14                	push   $0x14
  jmp alltraps
801072fe:	e9 cf f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107303:	6a 00                	push   $0x0
  pushl $21
80107305:	6a 15                	push   $0x15
  jmp alltraps
80107307:	e9 c6 f8 ff ff       	jmp    80106bd2 <alltraps>
...
8010730c:	6a 00                	push   $0x0
  pushl $22
8010730e:	6a 16                	push   $0x16
  jmp alltraps
80107310:	e9 bd f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107315:	6a 00                	push   $0x0
  pushl $23
80107317:	6a 17                	push   $0x17
  jmp alltraps
80107319:	e9 b4 f8 ff ff       	jmp    80106bd2 <alltraps>
...
8010731e:	6a 00                	push   $0x0
  pushl $24
80107320:	6a 18                	push   $0x18
  jmp alltraps
80107322:	e9 ab f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107327:	6a 00                	push   $0x0
  pushl $25
80107329:	6a 19                	push   $0x19
  jmp alltraps
8010732b:	e9 a2 f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107330:	6a 00                	push   $0x0
  pushl $26
80107332:	6a 1a                	push   $0x1a
  jmp alltraps
80107334:	e9 99 f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107339:	6a 00                	push   $0x0
  pushl $27
8010733b:	6a 1b                	push   $0x1b
  jmp alltraps
8010733d:	e9 90 f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107342:	6a 00                	push   $0x0
  pushl $28
80107344:	6a 1c                	push   $0x1c
  jmp alltraps
80107346:	e9 87 f8 ff ff       	jmp    80106bd2 <alltraps>
...
8010734b:	6a 00                	push   $0x0
  pushl $29
8010734d:	6a 1d                	push   $0x1d
  jmp alltraps
8010734f:	e9 7e f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107354:	6a 00                	push   $0x0
  pushl $30
80107356:	6a 1e                	push   $0x1e
  jmp alltraps
80107358:	e9 75 f8 ff ff       	jmp    80106bd2 <alltraps>
...
8010735d:	6a 00                	push   $0x0
  pushl $31
8010735f:	6a 1f                	push   $0x1f
  jmp alltraps
80107361:	e9 6c f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107366:	6a 00                	push   $0x0
  pushl $32
80107368:	6a 20                	push   $0x20
  jmp alltraps
8010736a:	e9 63 f8 ff ff       	jmp    80106bd2 <alltraps>
...
8010736f:	6a 00                	push   $0x0
  pushl $33
80107371:	6a 21                	push   $0x21
  jmp alltraps
80107373:	e9 5a f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107378:	6a 00                	push   $0x0
  pushl $34
8010737a:	6a 22                	push   $0x22
  jmp alltraps
8010737c:	e9 51 f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107381:	6a 00                	push   $0x0
  pushl $35
80107383:	6a 23                	push   $0x23
  jmp alltraps
80107385:	e9 48 f8 ff ff       	jmp    80106bd2 <alltraps>
...
8010738a:	6a 00                	push   $0x0
  pushl $36
8010738c:	6a 24                	push   $0x24
  jmp alltraps
8010738e:	e9 3f f8 ff ff       	jmp    80106bd2 <alltraps>
...
80107393:	6a 00                	push   $0x0
  pushl $37
80107395:	6a 25                	push   $0x25
  jmp alltraps
80107397:	e9 36 f8 ff ff       	jmp    80106bd2 <alltraps>
...
8010739c:	6a 00                	push   $0x0
  pushl $38
8010739e:	6a 26                	push   $0x26
  jmp alltraps
801073a0:	e9 2d f8 ff ff       	jmp    80106bd2 <alltraps>
...
801073a5:	6a 00                	push   $0x0
  pushl $39
801073a7:	6a 27                	push   $0x27
  jmp alltraps
801073a9:	e9 24 f8 ff ff       	jmp    80106bd2 <alltraps>
...
801073ae:	6a 00                	push   $0x0
  pushl $40
801073b0:	6a 28                	push   $0x28
  jmp alltraps
801073b2:	e9 1b f8 ff ff       	jmp    80106bd2 <alltraps>
...
801073b7:	6a 00                	push   $0x0
  pushl $41
801073b9:	6a 29                	push   $0x29
  jmp alltraps
801073bb:	e9 12 f8 ff ff       	jmp    80106bd2 <alltraps>
...
801073c0:	6a 00                	push   $0x0
  pushl $42
801073c2:	6a 2a                	push   $0x2a
  jmp alltraps
801073c4:	e9 09 f8 ff ff       	jmp    80106bd2 <alltraps>
...
801073c9:	6a 00                	push   $0x0
  pushl $43
801073cb:	6a 2b                	push   $0x2b
  jmp alltraps
801073cd:	e9 00 f8 ff ff       	jmp    80106bd2 <alltraps>
...
801073d2:	6a 00                	push   $0x0
  pushl $44
801073d4:	6a 2c                	push   $0x2c
  jmp alltraps
801073d6:	e9 f7 f7 ff ff       	jmp    80106bd2 <alltraps>
...
801073db:	6a 00                	push   $0x0
  pushl $45
801073dd:	6a 2d                	push   $0x2d
  jmp alltraps
801073df:	e9 ee f7 ff ff       	jmp    80106bd2 <alltraps>
...
801073e4:	6a 00                	push   $0x0
  pushl $46
801073e6:	6a 2e                	push   $0x2e
  jmp alltraps
801073e8:	e9 e5 f7 ff ff       	jmp    80106bd2 <alltraps>
...
801073ed:	6a 00                	push   $0x0
  pushl $47
801073ef:	6a 2f                	push   $0x2f
  jmp alltraps
801073f1:	e9 dc f7 ff ff       	jmp    80106bd2 <alltraps>
...
801073f6:	6a 00                	push   $0x0
  pushl $48
801073f8:	6a 30                	push   $0x30
  jmp alltraps
801073fa:	e9 d3 f7 ff ff       	jmp    80106bd2 <alltraps>
...
801073ff:	6a 00                	push   $0x0
  pushl $49
80107401:	6a 31                	push   $0x31
  jmp alltraps
80107403:	e9 ca f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107408:	6a 00                	push   $0x0
  pushl $50
8010740a:	6a 32                	push   $0x32
  jmp alltraps
8010740c:	e9 c1 f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107411:	6a 00                	push   $0x0
  pushl $51
80107413:	6a 33                	push   $0x33
  jmp alltraps
80107415:	e9 b8 f7 ff ff       	jmp    80106bd2 <alltraps>
...
8010741a:	6a 00                	push   $0x0
  pushl $52
8010741c:	6a 34                	push   $0x34
  jmp alltraps
8010741e:	e9 af f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107423:	6a 00                	push   $0x0
  pushl $53
80107425:	6a 35                	push   $0x35
  jmp alltraps
80107427:	e9 a6 f7 ff ff       	jmp    80106bd2 <alltraps>
...
8010742c:	6a 00                	push   $0x0
  pushl $54
8010742e:	6a 36                	push   $0x36
  jmp alltraps
80107430:	e9 9d f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107435:	6a 00                	push   $0x0
  pushl $55
80107437:	6a 37                	push   $0x37
  jmp alltraps
80107439:	e9 94 f7 ff ff       	jmp    80106bd2 <alltraps>
...
8010743e:	6a 00                	push   $0x0
  pushl $56
80107440:	6a 38                	push   $0x38
  jmp alltraps
80107442:	e9 8b f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107447:	6a 00                	push   $0x0
  pushl $57
80107449:	6a 39                	push   $0x39
  jmp alltraps
8010744b:	e9 82 f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107450:	6a 00                	push   $0x0
  pushl $58
80107452:	6a 3a                	push   $0x3a
  jmp alltraps
80107454:	e9 79 f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107459:	6a 00                	push   $0x0
  pushl $59
8010745b:	6a 3b                	push   $0x3b
  jmp alltraps
8010745d:	e9 70 f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107462:	6a 00                	push   $0x0
  pushl $60
80107464:	6a 3c                	push   $0x3c
  jmp alltraps
80107466:	e9 67 f7 ff ff       	jmp    80106bd2 <alltraps>
...
8010746b:	6a 00                	push   $0x0
  pushl $61
8010746d:	6a 3d                	push   $0x3d
  jmp alltraps
8010746f:	e9 5e f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107474:	6a 00                	push   $0x0
  pushl $62
80107476:	6a 3e                	push   $0x3e
  jmp alltraps
80107478:	e9 55 f7 ff ff       	jmp    80106bd2 <alltraps>
...
8010747d:	6a 00                	push   $0x0
  pushl $63
8010747f:	6a 3f                	push   $0x3f
  jmp alltraps
80107481:	e9 4c f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107486:	6a 00                	push   $0x0
  pushl $64
80107488:	6a 40                	push   $0x40
  jmp alltraps
8010748a:	e9 43 f7 ff ff       	jmp    80106bd2 <alltraps>
...
8010748f:	6a 00                	push   $0x0
  pushl $65
80107491:	6a 41                	push   $0x41
  jmp alltraps
80107493:	e9 3a f7 ff ff       	jmp    80106bd2 <alltraps>
...
80107498:	6a 00                	push   $0x0
  pushl $66
8010749a:	6a 42                	push   $0x42
  jmp alltraps
8010749c:	e9 31 f7 ff ff       	jmp    80106bd2 <alltraps>
...
801074a1:	6a 00                	push   $0x0
  pushl $67
801074a3:	6a 43                	push   $0x43
  jmp alltraps
801074a5:	e9 28 f7 ff ff       	jmp    80106bd2 <alltraps>
...
801074aa:	6a 00                	push   $0x0
  pushl $68
801074ac:	6a 44                	push   $0x44
  jmp alltraps
801074ae:	e9 1f f7 ff ff       	jmp    80106bd2 <alltraps>
...
801074b3:	6a 00                	push   $0x0
  pushl $69
801074b5:	6a 45                	push   $0x45
  jmp alltraps
801074b7:	e9 16 f7 ff ff       	jmp    80106bd2 <alltraps>
...
801074bc:	6a 00                	push   $0x0
  pushl $70
801074be:	6a 46                	push   $0x46
  jmp alltraps
801074c0:	e9 0d f7 ff ff       	jmp    80106bd2 <alltraps>
...
801074c5:	6a 00                	push   $0x0
  pushl $71
801074c7:	6a 47                	push   $0x47
  jmp alltraps
801074c9:	e9 04 f7 ff ff       	jmp    80106bd2 <alltraps>
...
801074ce:	6a 00                	push   $0x0
  pushl $72
801074d0:	6a 48                	push   $0x48
  jmp alltraps
801074d2:	e9 fb f6 ff ff       	jmp    80106bd2 <alltraps>
...
801074d7:	6a 00                	push   $0x0
  pushl $73
801074d9:	6a 49                	push   $0x49
  jmp alltraps
801074db:	e9 f2 f6 ff ff       	jmp    80106bd2 <alltraps>
...
801074e0:	6a 00                	push   $0x0
  pushl $74
801074e2:	6a 4a                	push   $0x4a
  jmp alltraps
801074e4:	e9 e9 f6 ff ff       	jmp    80106bd2 <alltraps>
...
801074e9:	6a 00                	push   $0x0
  pushl $75
801074eb:	6a 4b                	push   $0x4b
  jmp alltraps
801074ed:	e9 e0 f6 ff ff       	jmp    80106bd2 <alltraps>
...
801074f2:	6a 00                	push   $0x0
  pushl $76
801074f4:	6a 4c                	push   $0x4c
  jmp alltraps
801074f6:	e9 d7 f6 ff ff       	jmp    80106bd2 <alltraps>
...
801074fb:	6a 00                	push   $0x0
  pushl $77
801074fd:	6a 4d                	push   $0x4d
  jmp alltraps
801074ff:	e9 ce f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107504:	6a 00                	push   $0x0
  pushl $78
80107506:	6a 4e                	push   $0x4e
  jmp alltraps
80107508:	e9 c5 f6 ff ff       	jmp    80106bd2 <alltraps>
...
8010750d:	6a 00                	push   $0x0
  pushl $79
8010750f:	6a 4f                	push   $0x4f
  jmp alltraps
80107511:	e9 bc f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107516:	6a 00                	push   $0x0
  pushl $80
80107518:	6a 50                	push   $0x50
  jmp alltraps
8010751a:	e9 b3 f6 ff ff       	jmp    80106bd2 <alltraps>
...
8010751f:	6a 00                	push   $0x0
  pushl $81
80107521:	6a 51                	push   $0x51
  jmp alltraps
80107523:	e9 aa f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107528:	6a 00                	push   $0x0
  pushl $82
8010752a:	6a 52                	push   $0x52
  jmp alltraps
8010752c:	e9 a1 f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107531:	6a 00                	push   $0x0
  pushl $83
80107533:	6a 53                	push   $0x53
  jmp alltraps
80107535:	e9 98 f6 ff ff       	jmp    80106bd2 <alltraps>
...
8010753a:	6a 00                	push   $0x0
  pushl $84
8010753c:	6a 54                	push   $0x54
  jmp alltraps
8010753e:	e9 8f f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107543:	6a 00                	push   $0x0
  pushl $85
80107545:	6a 55                	push   $0x55
  jmp alltraps
80107547:	e9 86 f6 ff ff       	jmp    80106bd2 <alltraps>
...
8010754c:	6a 00                	push   $0x0
  pushl $86
8010754e:	6a 56                	push   $0x56
  jmp alltraps
80107550:	e9 7d f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107555:	6a 00                	push   $0x0
  pushl $87
80107557:	6a 57                	push   $0x57
  jmp alltraps
80107559:	e9 74 f6 ff ff       	jmp    80106bd2 <alltraps>
...
8010755e:	6a 00                	push   $0x0
  pushl $88
80107560:	6a 58                	push   $0x58
  jmp alltraps
80107562:	e9 6b f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107567:	6a 00                	push   $0x0
  pushl $89
80107569:	6a 59                	push   $0x59
  jmp alltraps
8010756b:	e9 62 f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107570:	6a 00                	push   $0x0
  pushl $90
80107572:	6a 5a                	push   $0x5a
  jmp alltraps
80107574:	e9 59 f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107579:	6a 00                	push   $0x0
  pushl $91
8010757b:	6a 5b                	push   $0x5b
  jmp alltraps
8010757d:	e9 50 f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107582:	6a 00                	push   $0x0
  pushl $92
80107584:	6a 5c                	push   $0x5c
  jmp alltraps
80107586:	e9 47 f6 ff ff       	jmp    80106bd2 <alltraps>
...
8010758b:	6a 00                	push   $0x0
  pushl $93
8010758d:	6a 5d                	push   $0x5d
  jmp alltraps
8010758f:	e9 3e f6 ff ff       	jmp    80106bd2 <alltraps>
...
80107594:	6a 00                	push   $0x0
  pushl $94
80107596:	6a 5e                	push   $0x5e
  jmp alltraps
80107598:	e9 35 f6 ff ff       	jmp    80106bd2 <alltraps>
...
8010759d:	6a 00                	push   $0x0
  pushl $95
8010759f:	6a 5f                	push   $0x5f
  jmp alltraps
801075a1:	e9 2c f6 ff ff       	jmp    80106bd2 <alltraps>
...
801075a6:	6a 00                	push   $0x0
  pushl $96
801075a8:	6a 60                	push   $0x60
  jmp alltraps
801075aa:	e9 23 f6 ff ff       	jmp    80106bd2 <alltraps>
...
801075af:	6a 00                	push   $0x0
  pushl $97
801075b1:	6a 61                	push   $0x61
  jmp alltraps
801075b3:	e9 1a f6 ff ff       	jmp    80106bd2 <alltraps>
...
801075b8:	6a 00                	push   $0x0
  pushl $98
801075ba:	6a 62                	push   $0x62
  jmp alltraps
801075bc:	e9 11 f6 ff ff       	jmp    80106bd2 <alltraps>
...
801075c1:	6a 00                	push   $0x0
  pushl $99
801075c3:	6a 63                	push   $0x63
  jmp alltraps
801075c5:	e9 08 f6 ff ff       	jmp    80106bd2 <alltraps>
...
801075ca:	6a 00                	push   $0x0
  pushl $100
801075cc:	6a 64                	push   $0x64
  jmp alltraps
801075ce:	e9 ff f5 ff ff       	jmp    80106bd2 <alltraps>
...
801075d3:	6a 00                	push   $0x0
  pushl $101
801075d5:	6a 65                	push   $0x65
  jmp alltraps
801075d7:	e9 f6 f5 ff ff       	jmp    80106bd2 <alltraps>
...
801075dc:	6a 00                	push   $0x0
  pushl $102
801075de:	6a 66                	push   $0x66
  jmp alltraps
801075e0:	e9 ed f5 ff ff       	jmp    80106bd2 <alltraps>
...
801075e5:	6a 00                	push   $0x0
  pushl $103
801075e7:	6a 67                	push   $0x67
  jmp alltraps
801075e9:	e9 e4 f5 ff ff       	jmp    80106bd2 <alltraps>
...
801075ee:	6a 00                	push   $0x0
  pushl $104
801075f0:	6a 68                	push   $0x68
  jmp alltraps
801075f2:	e9 db f5 ff ff       	jmp    80106bd2 <alltraps>
...
801075f7:	6a 00                	push   $0x0
  pushl $105
801075f9:	6a 69                	push   $0x69
  jmp alltraps
801075fb:	e9 d2 f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107600:	6a 00                	push   $0x0
  pushl $106
80107602:	6a 6a                	push   $0x6a
  jmp alltraps
80107604:	e9 c9 f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107609:	6a 00                	push   $0x0
  pushl $107
8010760b:	6a 6b                	push   $0x6b
  jmp alltraps
8010760d:	e9 c0 f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107612:	6a 00                	push   $0x0
  pushl $108
80107614:	6a 6c                	push   $0x6c
  jmp alltraps
80107616:	e9 b7 f5 ff ff       	jmp    80106bd2 <alltraps>
...
8010761b:	6a 00                	push   $0x0
  pushl $109
8010761d:	6a 6d                	push   $0x6d
  jmp alltraps
8010761f:	e9 ae f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107624:	6a 00                	push   $0x0
  pushl $110
80107626:	6a 6e                	push   $0x6e
  jmp alltraps
80107628:	e9 a5 f5 ff ff       	jmp    80106bd2 <alltraps>
...
8010762d:	6a 00                	push   $0x0
  pushl $111
8010762f:	6a 6f                	push   $0x6f
  jmp alltraps
80107631:	e9 9c f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107636:	6a 00                	push   $0x0
  pushl $112
80107638:	6a 70                	push   $0x70
  jmp alltraps
8010763a:	e9 93 f5 ff ff       	jmp    80106bd2 <alltraps>
...
8010763f:	6a 00                	push   $0x0
  pushl $113
80107641:	6a 71                	push   $0x71
  jmp alltraps
80107643:	e9 8a f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107648:	6a 00                	push   $0x0
  pushl $114
8010764a:	6a 72                	push   $0x72
  jmp alltraps
8010764c:	e9 81 f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107651:	6a 00                	push   $0x0
  pushl $115
80107653:	6a 73                	push   $0x73
  jmp alltraps
80107655:	e9 78 f5 ff ff       	jmp    80106bd2 <alltraps>
...
8010765a:	6a 00                	push   $0x0
  pushl $116
8010765c:	6a 74                	push   $0x74
  jmp alltraps
8010765e:	e9 6f f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107663:	6a 00                	push   $0x0
  pushl $117
80107665:	6a 75                	push   $0x75
  jmp alltraps
80107667:	e9 66 f5 ff ff       	jmp    80106bd2 <alltraps>
...
8010766c:	6a 00                	push   $0x0
  pushl $118
8010766e:	6a 76                	push   $0x76
  jmp alltraps
80107670:	e9 5d f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107675:	6a 00                	push   $0x0
  pushl $119
80107677:	6a 77                	push   $0x77
  jmp alltraps
80107679:	e9 54 f5 ff ff       	jmp    80106bd2 <alltraps>
...
8010767e:	6a 00                	push   $0x0
  pushl $120
80107680:	6a 78                	push   $0x78
  jmp alltraps
80107682:	e9 4b f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107687:	6a 00                	push   $0x0
  pushl $121
80107689:	6a 79                	push   $0x79
  jmp alltraps
8010768b:	e9 42 f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107690:	6a 00                	push   $0x0
  pushl $122
80107692:	6a 7a                	push   $0x7a
  jmp alltraps
80107694:	e9 39 f5 ff ff       	jmp    80106bd2 <alltraps>
...
80107699:	6a 00                	push   $0x0
  pushl $123
8010769b:	6a 7b                	push   $0x7b
  jmp alltraps
8010769d:	e9 30 f5 ff ff       	jmp    80106bd2 <alltraps>
...
801076a2:	6a 00                	push   $0x0
  pushl $124
801076a4:	6a 7c                	push   $0x7c
  jmp alltraps
801076a6:	e9 27 f5 ff ff       	jmp    80106bd2 <alltraps>
...
801076ab:	6a 00                	push   $0x0
  pushl $125
801076ad:	6a 7d                	push   $0x7d
  jmp alltraps
801076af:	e9 1e f5 ff ff       	jmp    80106bd2 <alltraps>
...
801076b4:	6a 00                	push   $0x0
  pushl $126
801076b6:	6a 7e                	push   $0x7e
  jmp alltraps
801076b8:	e9 15 f5 ff ff       	jmp    80106bd2 <alltraps>
...
801076bd:	6a 00                	push   $0x0
  pushl $127
801076bf:	6a 7f                	push   $0x7f
  jmp alltraps
801076c1:	e9 0c f5 ff ff       	jmp    80106bd2 <alltraps>
...
801076c6:	6a 00                	push   $0x0
  pushl $128
801076c8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801076cd:	e9 00 f5 ff ff       	jmp    80106bd2 <alltraps>
...
801076d2:	6a 00                	push   $0x0
  pushl $129
801076d4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801076d9:	e9 f4 f4 ff ff       	jmp    80106bd2 <alltraps>
...
801076de:	6a 00                	push   $0x0
  pushl $130
801076e0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801076e5:	e9 e8 f4 ff ff       	jmp    80106bd2 <alltraps>
...
801076ea:	6a 00                	push   $0x0
  pushl $131
801076ec:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801076f1:	e9 dc f4 ff ff       	jmp    80106bd2 <alltraps>
...
801076f6:	6a 00                	push   $0x0
  pushl $132
801076f8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801076fd:	e9 d0 f4 ff ff       	jmp    80106bd2 <alltraps>
...
80107702:	6a 00                	push   $0x0
  pushl $133
80107704:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107709:	e9 c4 f4 ff ff       	jmp    80106bd2 <alltraps>
...
8010770e:	6a 00                	push   $0x0
  pushl $134
80107710:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107715:	e9 b8 f4 ff ff       	jmp    80106bd2 <alltraps>
...
8010771a:	6a 00                	push   $0x0
  pushl $135
8010771c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107721:	e9 ac f4 ff ff       	jmp    80106bd2 <alltraps>
...
80107726:	6a 00                	push   $0x0
  pushl $136
80107728:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010772d:	e9 a0 f4 ff ff       	jmp    80106bd2 <alltraps>
...
80107732:	6a 00                	push   $0x0
  pushl $137
80107734:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107739:	e9 94 f4 ff ff       	jmp    80106bd2 <alltraps>
...
8010773e:	6a 00                	push   $0x0
  pushl $138
80107740:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107745:	e9 88 f4 ff ff       	jmp    80106bd2 <alltraps>
...
8010774a:	6a 00                	push   $0x0
  pushl $139
8010774c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107751:	e9 7c f4 ff ff       	jmp    80106bd2 <alltraps>
...
80107756:	6a 00                	push   $0x0
  pushl $140
80107758:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010775d:	e9 70 f4 ff ff       	jmp    80106bd2 <alltraps>
...
80107762:	6a 00                	push   $0x0
  pushl $141
80107764:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107769:	e9 64 f4 ff ff       	jmp    80106bd2 <alltraps>
...
8010776e:	6a 00                	push   $0x0
  pushl $142
80107770:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107775:	e9 58 f4 ff ff       	jmp    80106bd2 <alltraps>
...
8010777a:	6a 00                	push   $0x0
  pushl $143
8010777c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107781:	e9 4c f4 ff ff       	jmp    80106bd2 <alltraps>
...
80107786:	6a 00                	push   $0x0
  pushl $144
80107788:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010778d:	e9 40 f4 ff ff       	jmp    80106bd2 <alltraps>
...
80107792:	6a 00                	push   $0x0
  pushl $145
80107794:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107799:	e9 34 f4 ff ff       	jmp    80106bd2 <alltraps>
...
8010779e:	6a 00                	push   $0x0
  pushl $146
801077a0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801077a5:	e9 28 f4 ff ff       	jmp    80106bd2 <alltraps>
...
801077aa:	6a 00                	push   $0x0
  pushl $147
801077ac:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801077b1:	e9 1c f4 ff ff       	jmp    80106bd2 <alltraps>
...
801077b6:	6a 00                	push   $0x0
  pushl $148
801077b8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801077bd:	e9 10 f4 ff ff       	jmp    80106bd2 <alltraps>
...
801077c2:	6a 00                	push   $0x0
  pushl $149
801077c4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801077c9:	e9 04 f4 ff ff       	jmp    80106bd2 <alltraps>
...
801077ce:	6a 00                	push   $0x0
  pushl $150
801077d0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801077d5:	e9 f8 f3 ff ff       	jmp    80106bd2 <alltraps>
...
801077da:	6a 00                	push   $0x0
  pushl $151
801077dc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801077e1:	e9 ec f3 ff ff       	jmp    80106bd2 <alltraps>
...
801077e6:	6a 00                	push   $0x0
  pushl $152
801077e8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801077ed:	e9 e0 f3 ff ff       	jmp    80106bd2 <alltraps>
...
801077f2:	6a 00                	push   $0x0
  pushl $153
801077f4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801077f9:	e9 d4 f3 ff ff       	jmp    80106bd2 <alltraps>
...
801077fe:	6a 00                	push   $0x0
  pushl $154
80107800:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107805:	e9 c8 f3 ff ff       	jmp    80106bd2 <alltraps>
...
8010780a:	6a 00                	push   $0x0
  pushl $155
8010780c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107811:	e9 bc f3 ff ff       	jmp    80106bd2 <alltraps>
...
80107816:	6a 00                	push   $0x0
  pushl $156
80107818:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010781d:	e9 b0 f3 ff ff       	jmp    80106bd2 <alltraps>
...
80107822:	6a 00                	push   $0x0
  pushl $157
80107824:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107829:	e9 a4 f3 ff ff       	jmp    80106bd2 <alltraps>
...
8010782e:	6a 00                	push   $0x0
  pushl $158
80107830:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107835:	e9 98 f3 ff ff       	jmp    80106bd2 <alltraps>
...
8010783a:	6a 00                	push   $0x0
  pushl $159
8010783c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107841:	e9 8c f3 ff ff       	jmp    80106bd2 <alltraps>
...
80107846:	6a 00                	push   $0x0
  pushl $160
80107848:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010784d:	e9 80 f3 ff ff       	jmp    80106bd2 <alltraps>
...
80107852:	6a 00                	push   $0x0
  pushl $161
80107854:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107859:	e9 74 f3 ff ff       	jmp    80106bd2 <alltraps>
...
8010785e:	6a 00                	push   $0x0
  pushl $162
80107860:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107865:	e9 68 f3 ff ff       	jmp    80106bd2 <alltraps>
...
8010786a:	6a 00                	push   $0x0
  pushl $163
8010786c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107871:	e9 5c f3 ff ff       	jmp    80106bd2 <alltraps>
...
80107876:	6a 00                	push   $0x0
  pushl $164
80107878:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010787d:	e9 50 f3 ff ff       	jmp    80106bd2 <alltraps>
...
80107882:	6a 00                	push   $0x0
  pushl $165
80107884:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107889:	e9 44 f3 ff ff       	jmp    80106bd2 <alltraps>
...
8010788e:	6a 00                	push   $0x0
  pushl $166
80107890:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107895:	e9 38 f3 ff ff       	jmp    80106bd2 <alltraps>
...
8010789a:	6a 00                	push   $0x0
  pushl $167
8010789c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801078a1:	e9 2c f3 ff ff       	jmp    80106bd2 <alltraps>
...
801078a6:	6a 00                	push   $0x0
  pushl $168
801078a8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801078ad:	e9 20 f3 ff ff       	jmp    80106bd2 <alltraps>
...
801078b2:	6a 00                	push   $0x0
  pushl $169
801078b4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801078b9:	e9 14 f3 ff ff       	jmp    80106bd2 <alltraps>
...
801078be:	6a 00                	push   $0x0
  pushl $170
801078c0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801078c5:	e9 08 f3 ff ff       	jmp    80106bd2 <alltraps>
...
801078ca:	6a 00                	push   $0x0
  pushl $171
801078cc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801078d1:	e9 fc f2 ff ff       	jmp    80106bd2 <alltraps>
...
801078d6:	6a 00                	push   $0x0
  pushl $172
801078d8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801078dd:	e9 f0 f2 ff ff       	jmp    80106bd2 <alltraps>
...
801078e2:	6a 00                	push   $0x0
  pushl $173
801078e4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801078e9:	e9 e4 f2 ff ff       	jmp    80106bd2 <alltraps>
...
801078ee:	6a 00                	push   $0x0
  pushl $174
801078f0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801078f5:	e9 d8 f2 ff ff       	jmp    80106bd2 <alltraps>
...
801078fa:	6a 00                	push   $0x0
  pushl $175
801078fc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107901:	e9 cc f2 ff ff       	jmp    80106bd2 <alltraps>
...
80107906:	6a 00                	push   $0x0
  pushl $176
80107908:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010790d:	e9 c0 f2 ff ff       	jmp    80106bd2 <alltraps>
...
80107912:	6a 00                	push   $0x0
  pushl $177
80107914:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107919:	e9 b4 f2 ff ff       	jmp    80106bd2 <alltraps>
...
8010791e:	6a 00                	push   $0x0
  pushl $178
80107920:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107925:	e9 a8 f2 ff ff       	jmp    80106bd2 <alltraps>
...
8010792a:	6a 00                	push   $0x0
  pushl $179
8010792c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107931:	e9 9c f2 ff ff       	jmp    80106bd2 <alltraps>
...
80107936:	6a 00                	push   $0x0
  pushl $180
80107938:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010793d:	e9 90 f2 ff ff       	jmp    80106bd2 <alltraps>
...
80107942:	6a 00                	push   $0x0
  pushl $181
80107944:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107949:	e9 84 f2 ff ff       	jmp    80106bd2 <alltraps>
...
8010794e:	6a 00                	push   $0x0
  pushl $182
80107950:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107955:	e9 78 f2 ff ff       	jmp    80106bd2 <alltraps>
...
8010795a:	6a 00                	push   $0x0
  pushl $183
8010795c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107961:	e9 6c f2 ff ff       	jmp    80106bd2 <alltraps>
...
80107966:	6a 00                	push   $0x0
  pushl $184
80107968:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010796d:	e9 60 f2 ff ff       	jmp    80106bd2 <alltraps>
...
80107972:	6a 00                	push   $0x0
  pushl $185
80107974:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107979:	e9 54 f2 ff ff       	jmp    80106bd2 <alltraps>
...
8010797e:	6a 00                	push   $0x0
  pushl $186
80107980:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107985:	e9 48 f2 ff ff       	jmp    80106bd2 <alltraps>
...
8010798a:	6a 00                	push   $0x0
  pushl $187
8010798c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107991:	e9 3c f2 ff ff       	jmp    80106bd2 <alltraps>
...
80107996:	6a 00                	push   $0x0
  pushl $188
80107998:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010799d:	e9 30 f2 ff ff       	jmp    80106bd2 <alltraps>
...
801079a2:	6a 00                	push   $0x0
  pushl $189
801079a4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801079a9:	e9 24 f2 ff ff       	jmp    80106bd2 <alltraps>
...
801079ae:	6a 00                	push   $0x0
  pushl $190
801079b0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801079b5:	e9 18 f2 ff ff       	jmp    80106bd2 <alltraps>
...
801079ba:	6a 00                	push   $0x0
  pushl $191
801079bc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801079c1:	e9 0c f2 ff ff       	jmp    80106bd2 <alltraps>
...
801079c6:	6a 00                	push   $0x0
  pushl $192
801079c8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801079cd:	e9 00 f2 ff ff       	jmp    80106bd2 <alltraps>
...
801079d2:	6a 00                	push   $0x0
  pushl $193
801079d4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801079d9:	e9 f4 f1 ff ff       	jmp    80106bd2 <alltraps>
...
801079de:	6a 00                	push   $0x0
  pushl $194
801079e0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801079e5:	e9 e8 f1 ff ff       	jmp    80106bd2 <alltraps>
...
801079ea:	6a 00                	push   $0x0
  pushl $195
801079ec:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801079f1:	e9 dc f1 ff ff       	jmp    80106bd2 <alltraps>
...
801079f6:	6a 00                	push   $0x0
  pushl $196
801079f8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801079fd:	e9 d0 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a02:	6a 00                	push   $0x0
  pushl $197
80107a04:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107a09:	e9 c4 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a0e:	6a 00                	push   $0x0
  pushl $198
80107a10:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107a15:	e9 b8 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a1a:	6a 00                	push   $0x0
  pushl $199
80107a1c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107a21:	e9 ac f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a26:	6a 00                	push   $0x0
  pushl $200
80107a28:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107a2d:	e9 a0 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a32:	6a 00                	push   $0x0
  pushl $201
80107a34:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107a39:	e9 94 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a3e:	6a 00                	push   $0x0
  pushl $202
80107a40:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107a45:	e9 88 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a4a:	6a 00                	push   $0x0
  pushl $203
80107a4c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107a51:	e9 7c f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a56:	6a 00                	push   $0x0
  pushl $204
80107a58:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107a5d:	e9 70 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a62:	6a 00                	push   $0x0
  pushl $205
80107a64:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107a69:	e9 64 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a6e:	6a 00                	push   $0x0
  pushl $206
80107a70:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107a75:	e9 58 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a7a:	6a 00                	push   $0x0
  pushl $207
80107a7c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107a81:	e9 4c f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a86:	6a 00                	push   $0x0
  pushl $208
80107a88:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107a8d:	e9 40 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a92:	6a 00                	push   $0x0
  pushl $209
80107a94:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107a99:	e9 34 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107a9e:	6a 00                	push   $0x0
  pushl $210
80107aa0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107aa5:	e9 28 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107aaa:	6a 00                	push   $0x0
  pushl $211
80107aac:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107ab1:	e9 1c f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107ab6:	6a 00                	push   $0x0
  pushl $212
80107ab8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107abd:	e9 10 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107ac2:	6a 00                	push   $0x0
  pushl $213
80107ac4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107ac9:	e9 04 f1 ff ff       	jmp    80106bd2 <alltraps>
...
80107ace:	6a 00                	push   $0x0
  pushl $214
80107ad0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107ad5:	e9 f8 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107ada:	6a 00                	push   $0x0
  pushl $215
80107adc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107ae1:	e9 ec f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107ae6:	6a 00                	push   $0x0
  pushl $216
80107ae8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107aed:	e9 e0 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107af2:	6a 00                	push   $0x0
  pushl $217
80107af4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107af9:	e9 d4 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107afe:	6a 00                	push   $0x0
  pushl $218
80107b00:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107b05:	e9 c8 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b0a:	6a 00                	push   $0x0
  pushl $219
80107b0c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107b11:	e9 bc f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b16:	6a 00                	push   $0x0
  pushl $220
80107b18:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107b1d:	e9 b0 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b22:	6a 00                	push   $0x0
  pushl $221
80107b24:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107b29:	e9 a4 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b2e:	6a 00                	push   $0x0
  pushl $222
80107b30:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107b35:	e9 98 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b3a:	6a 00                	push   $0x0
  pushl $223
80107b3c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107b41:	e9 8c f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b46:	6a 00                	push   $0x0
  pushl $224
80107b48:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107b4d:	e9 80 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b52:	6a 00                	push   $0x0
  pushl $225
80107b54:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107b59:	e9 74 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b5e:	6a 00                	push   $0x0
  pushl $226
80107b60:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107b65:	e9 68 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b6a:	6a 00                	push   $0x0
  pushl $227
80107b6c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107b71:	e9 5c f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b76:	6a 00                	push   $0x0
  pushl $228
80107b78:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107b7d:	e9 50 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b82:	6a 00                	push   $0x0
  pushl $229
80107b84:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107b89:	e9 44 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b8e:	6a 00                	push   $0x0
  pushl $230
80107b90:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107b95:	e9 38 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107b9a:	6a 00                	push   $0x0
  pushl $231
80107b9c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107ba1:	e9 2c f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107ba6:	6a 00                	push   $0x0
  pushl $232
80107ba8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107bad:	e9 20 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107bb2:	6a 00                	push   $0x0
  pushl $233
80107bb4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107bb9:	e9 14 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107bbe:	6a 00                	push   $0x0
  pushl $234
80107bc0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107bc5:	e9 08 f0 ff ff       	jmp    80106bd2 <alltraps>
...
80107bca:	6a 00                	push   $0x0
  pushl $235
80107bcc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107bd1:	e9 fc ef ff ff       	jmp    80106bd2 <alltraps>
...
80107bd6:	6a 00                	push   $0x0
  pushl $236
80107bd8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107bdd:	e9 f0 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107be2:	6a 00                	push   $0x0
  pushl $237
80107be4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107be9:	e9 e4 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107bee:	6a 00                	push   $0x0
  pushl $238
80107bf0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107bf5:	e9 d8 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107bfa:	6a 00                	push   $0x0
  pushl $239
80107bfc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107c01:	e9 cc ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c06:	6a 00                	push   $0x0
  pushl $240
80107c08:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107c0d:	e9 c0 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c12:	6a 00                	push   $0x0
  pushl $241
80107c14:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107c19:	e9 b4 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c1e:	6a 00                	push   $0x0
  pushl $242
80107c20:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107c25:	e9 a8 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c2a:	6a 00                	push   $0x0
  pushl $243
80107c2c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107c31:	e9 9c ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c36:	6a 00                	push   $0x0
  pushl $244
80107c38:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107c3d:	e9 90 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c42:	6a 00                	push   $0x0
  pushl $245
80107c44:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107c49:	e9 84 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c4e:	6a 00                	push   $0x0
  pushl $246
80107c50:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107c55:	e9 78 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c5a:	6a 00                	push   $0x0
  pushl $247
80107c5c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107c61:	e9 6c ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c66:	6a 00                	push   $0x0
  pushl $248
80107c68:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107c6d:	e9 60 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c72:	6a 00                	push   $0x0
  pushl $249
80107c74:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107c79:	e9 54 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c7e:	6a 00                	push   $0x0
  pushl $250
80107c80:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107c85:	e9 48 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c8a:	6a 00                	push   $0x0
  pushl $251
80107c8c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107c91:	e9 3c ef ff ff       	jmp    80106bd2 <alltraps>
...
80107c96:	6a 00                	push   $0x0
  pushl $252
80107c98:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107c9d:	e9 30 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107ca2:	6a 00                	push   $0x0
  pushl $253
80107ca4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107ca9:	e9 24 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107cae:	6a 00                	push   $0x0
  pushl $254
80107cb0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107cb5:	e9 18 ef ff ff       	jmp    80106bd2 <alltraps>
...
80107cba:	6a 00                	push   $0x0
  pushl $255
80107cbc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107cc1:	e9 0c ef ff ff       	jmp    80106bd2 <alltraps>
...
80107cc9:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107ccc:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ccf:	83 e8 01             	sub    $0x1,%eax
80107cd2:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107cd6:	8b 45 08             	mov    0x8(%ebp),%eax
80107cd9:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107cdd:	8b 45 08             	mov    0x8(%ebp),%eax
80107ce0:	c1 e8 10             	shr    $0x10,%eax
80107ce3:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107ce7:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107cea:	0f 01 10             	lgdtl  (%eax)
}
80107ced:	c9                   	leave  
80107cee:	c3                   	ret    
...
80107cf8:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107cfc:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107d00:	0f 00 d8             	ltr    %ax
}
80107d03:	c9                   	leave  
80107d04:	c3                   	ret    
...
80107d0e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107d12:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107d16:	8e e8                	mov    %eax,%gs
}
80107d18:	c9                   	leave  
80107d19:	c3                   	ret    
...
80107d1b:	89 e5                	mov    %esp,%ebp
  asm volatile("movl %0,%%cr3" : : "r" (val));
80107d1d:	8b 45 08             	mov    0x8(%ebp),%eax
80107d20:	0f 22 d8             	mov    %eax,%cr3
}
80107d23:	5d                   	pop    %ebp
80107d24:	c3                   	ret    
...
80107d2b:	05 00 00 00 80       	add    $0x80000000,%eax
80107d30:	5d                   	pop    %ebp
80107d31:	c3                   	ret    
...
80107d43:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107d46:	e8 3a b1 ff ff       	call   80102e85 <cpunum>
80107d4b:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107d51:	05 c0 33 11 80       	add    $0x801133c0,%eax
80107d56:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107d59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d5c:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107d62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d65:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107d6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d6e:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107d72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d75:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107d79:	83 e2 f0             	and    $0xfffffff0,%edx
80107d7c:	83 ca 0a             	or     $0xa,%edx
80107d7f:	88 50 7d             	mov    %dl,0x7d(%eax)
80107d82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d85:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107d89:	83 ca 10             	or     $0x10,%edx
80107d8c:	88 50 7d             	mov    %dl,0x7d(%eax)
80107d8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d92:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107d96:	83 e2 9f             	and    $0xffffff9f,%edx
...
80107dac:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107db0:	83 ca 0f             	or     $0xf,%edx
80107db3:	88 50 7e             	mov    %dl,0x7e(%eax)
80107db6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107db9:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107dbd:	83 e2 ef             	and    $0xffffffef,%edx
80107dc0:	88 50 7e             	mov    %dl,0x7e(%eax)
80107dc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc6:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107dca:	83 e2 df             	and    $0xffffffdf,%edx
...
80107ded:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107df1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107df4:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107dfb:	ff ff 
80107dfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e00:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107e07:	00 00 
80107e09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e0c:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107e13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e16:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107e1d:	83 e2 f0             	and    $0xfffffff0,%edx
80107e20:	83 ca 02             	or     $0x2,%edx
80107e23:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107e29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e2c:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107e33:	83 ca 10             	or     $0x10,%edx
80107e36:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107e3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e3f:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107e46:	83 e2 9f             	and    $0xffffff9f,%edx
80107e49:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107e4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e52:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107e59:	83 ca 80             	or     $0xffffff80,%edx
80107e5c:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107e62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e65:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107e6c:	83 ca 0f             	or     $0xf,%edx
80107e6f:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107e75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e78:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107e7f:	83 e2 ef             	and    $0xffffffef,%edx
80107e82:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107e88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e8b:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107e92:	83 e2 df             	and    $0xffffffdf,%edx
80107e95:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107e9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e9e:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ea5:	83 ca 40             	or     $0x40,%edx
80107ea8:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107eae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eb1:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107eb8:	83 ca 80             	or     $0xffffff80,%edx
80107ebb:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107ec1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ec4:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107ecb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ece:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107ed5:	ff ff 
80107ed7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eda:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107ee1:	00 00 
80107ee3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee6:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
...
80107efd:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107f03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f06:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107f0d:	83 ca 10             	or     $0x10,%edx
80107f10:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107f16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f19:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107f20:	83 ca 60             	or     $0x60,%edx
80107f23:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107f29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f2c:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107f33:	83 ca 80             	or     $0xffffff80,%edx
80107f36:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107f3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f3f:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107f46:	83 ca 0f             	or     $0xf,%edx
80107f49:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107f4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f52:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107f59:	83 e2 ef             	and    $0xffffffef,%edx
80107f5c:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107f62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f65:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107f6c:	83 e2 df             	and    $0xffffffdf,%edx
80107f6f:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107f75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f78:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107f7f:	83 ca 40             	or     $0x40,%edx
80107f82:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107f88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f8b:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107f92:	83 ca 80             	or     $0xffffff80,%edx
80107f95:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107f9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f9e:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107fa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa8:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107faf:	ff ff 
80107fb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb4:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107fbb:	00 00 
80107fbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc0:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107fc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fca:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107fd1:	83 e2 f0             	and    $0xfffffff0,%edx
80107fd4:	83 ca 02             	or     $0x2,%edx
80107fd7:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107fdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe0:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107fe7:	83 ca 10             	or     $0x10,%edx
80107fea:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ff0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff3:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107ffa:	83 ca 60             	or     $0x60,%edx
80107ffd:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108003:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108006:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010800d:	83 ca 80             	or     $0xffffff80,%edx
80108010:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108016:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108019:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108020:	83 ca 0f             	or     $0xf,%edx
80108023:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108029:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010802c:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108033:	83 e2 ef             	and    $0xffffffef,%edx
80108036:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010803c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803f:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108046:	83 e2 df             	and    $0xffffffdf,%edx
80108049:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010804f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108052:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108059:	83 ca 40             	or     $0x40,%edx
8010805c:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108062:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108065:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010806c:	83 ca 80             	or     $0xffffff80,%edx
8010806f:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108075:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108078:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010807f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108082:	05 b4 00 00 00       	add    $0xb4,%eax
80108087:	89 c3                	mov    %eax,%ebx
80108089:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010808c:	05 b4 00 00 00       	add    $0xb4,%eax
80108091:	c1 e8 10             	shr    $0x10,%eax
80108094:	89 c1                	mov    %eax,%ecx
80108096:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108099:	05 b4 00 00 00       	add    $0xb4,%eax
8010809e:	c1 e8 18             	shr    $0x18,%eax
801080a1:	89 c2                	mov    %eax,%edx
801080a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a6:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801080ad:	00 00 
801080af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b2:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801080b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080bc:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801080c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c5:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801080cc:	83 e1 f0             	and    $0xfffffff0,%ecx
801080cf:	83 c9 02             	or     $0x2,%ecx
801080d2:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801080d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080db:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801080e2:	83 c9 10             	or     $0x10,%ecx
801080e5:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801080eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080ee:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801080f5:	83 e1 9f             	and    $0xffffff9f,%ecx
801080f8:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801080fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108101:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108108:	83 c9 80             	or     $0xffffff80,%ecx
8010810b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108111:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108114:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010811b:	83 e1 f0             	and    $0xfffffff0,%ecx
8010811e:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108124:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108127:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010812e:	83 e1 ef             	and    $0xffffffef,%ecx
80108131:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108137:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813a:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108141:	83 e1 df             	and    $0xffffffdf,%ecx
80108144:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010814a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010814d:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108154:	83 c9 40             	or     $0x40,%ecx
80108157:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010815d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108160:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108167:	83 c9 80             	or     $0xffffff80,%ecx
8010816a:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108170:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108173:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108179:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010817c:	83 c0 70             	add    $0x70,%eax
8010817f:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80108186:	00 
80108187:	89 04 24             	mov    %eax,(%esp)
8010818a:	e8 37 fb ff ff       	call   80107cc6 <lgdt>
  loadgs(SEG_KCPU << 3);
8010818f:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80108196:	e8 6a fb ff ff       	call   80107d05 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
8010819b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819e:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801081a4:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801081ab:	00 00 00 00 
}
801081af:	83 c4 24             	add    $0x24,%esp
801081b2:	5b                   	pop    %ebx
801081b3:	5d                   	pop    %ebp
801081b4:	c3                   	ret    
...
801081be:	c1 e8 16             	shr    $0x16,%eax
...
801081da:	74 17                	je     801081f3 <walkpgdir+0x3e>
...
801081e9:	e8 44 fb ff ff       	call   80107d32 <p2v>
801081ee:	89 45 f4             	mov    %eax,-0xc(%ebp)
801081f1:	eb 4b                	jmp    8010823e <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801081f3:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801081f7:	74 0e                	je     80108207 <walkpgdir+0x52>
801081f9:	e8 f1 a8 ff ff       	call   80102aef <kalloc>
801081fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108201:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108205:	75 07                	jne    8010820e <walkpgdir+0x59>
      return 0;
80108207:	b8 00 00 00 00       	mov    $0x0,%eax
8010820c:	eb 47                	jmp    80108255 <walkpgdir+0xa0>
...
80108224:	e8 13 d5 ff ff       	call   8010573c <memset>
...
8010822f:	e8 f1 fa ff ff       	call   80107d25 <v2p>
80108234:	83 c8 07             	or     $0x7,%eax
...
80108241:	c1 e8 0c             	shr    $0xc,%eax
80108244:	25 ff 03 00 00       	and    $0x3ff,%eax
80108249:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108270:	83 e8 01             	sub    $0x1,%eax
80108273:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108278:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010827b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108282:	00 
80108283:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108286:	89 44 24 04          	mov    %eax,0x4(%esp)
8010828a:	8b 45 08             	mov    0x8(%ebp),%eax
8010828d:	89 04 24             	mov    %eax,(%esp)
80108290:	e8 20 ff ff ff       	call   801081b5 <walkpgdir>
80108295:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108298:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010829c:	75 07                	jne    801082a5 <mappages+0x4e>
      return -1;
8010829e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801082a3:	eb 48                	jmp    801082ed <mappages+0x96>
    if(*pte & PTE_P)
801082a5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082a8:	8b 00                	mov    (%eax),%eax
801082aa:	83 e0 01             	and    $0x1,%eax
801082ad:	85 c0                	test   %eax,%eax
801082af:	74 0c                	je     801082bd <mappages+0x66>
      panic("remap");
801082b1:	c7 04 24 f8 90 10 80 	movl   $0x801090f8,(%esp)
801082b8:	e8 7d 82 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
801082bd:	8b 45 18             	mov    0x18(%ebp),%eax
801082c0:	0b 45 14             	or     0x14(%ebp),%eax
801082c3:	83 c8 01             	or     $0x1,%eax
801082c6:	89 c2                	mov    %eax,%edx
801082c8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082cb:	89 10                	mov    %edx,(%eax)
    if(a == last)
801082cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082d0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801082d3:	75 08                	jne    801082dd <mappages+0x86>
      break;
801082d5:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
801082db:	eb 10                	jmp    801082ed <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
801082dd:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801082e4:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801082eb:	eb 8e                	jmp    8010827b <mappages+0x24>
  return 0;
}
801082ed:	c9                   	leave  
801082ee:	c3                   	ret    
...
801082f3:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
801082f6:	e8 f4 a7 ff ff       	call   80102aef <kalloc>
801082fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
801082fe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108302:	75 0a                	jne    8010830e <setupkvm+0x1f>
    return 0;
80108304:	b8 00 00 00 00       	mov    $0x0,%eax
80108309:	e9 98 00 00 00       	jmp    801083a6 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
8010830e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108315:	00 
80108316:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010831d:	00 
8010831e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108321:	89 04 24             	mov    %eax,(%esp)
80108324:	e8 13 d4 ff ff       	call   8010573c <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108329:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108330:	e8 fd f9 ff ff       	call   80107d32 <p2v>
80108335:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
8010833a:	76 0c                	jbe    80108348 <setupkvm+0x59>
    panic("PHYSTOP too high");
8010833c:	c7 04 24 fe 90 10 80 	movl   $0x801090fe,(%esp)
80108343:	e8 f2 81 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108348:	c7 45 f4 00 c5 10 80 	movl   $0x8010c500,-0xc(%ebp)
8010834f:	eb 49                	jmp    8010839a <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108351:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108354:	8b 48 0c             	mov    0xc(%eax),%ecx
80108357:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010835a:	8b 50 04             	mov    0x4(%eax),%edx
8010835d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108360:	8b 58 08             	mov    0x8(%eax),%ebx
80108363:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108366:	8b 40 04             	mov    0x4(%eax),%eax
80108369:	29 c3                	sub    %eax,%ebx
8010836b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010836e:	8b 00                	mov    (%eax),%eax
80108370:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108374:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108378:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010837c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108380:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108383:	89 04 24             	mov    %eax,(%esp)
80108386:	e8 cc fe ff ff       	call   80108257 <mappages>
8010838b:	85 c0                	test   %eax,%eax
8010838d:	79 07                	jns    80108396 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
8010838f:	b8 00 00 00 00       	mov    $0x0,%eax
80108394:	eb 10                	jmp    801083a6 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108396:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
8010839a:	81 7d f4 40 c5 10 80 	cmpl   $0x8010c540,-0xc(%ebp)
801083a1:	72 ae                	jb     80108351 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801083a6:	83 c4 34             	add    $0x34,%esp
801083a9:	5b                   	pop    %ebx
801083aa:	5d                   	pop    %ebp
801083ab:	c3                   	ret    
...
801083af:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801083b2:	e8 38 ff ff ff       	call   801082ef <setupkvm>
801083b7:	a3 58 aa 11 80       	mov    %eax,0x8011aa58
  switchkvm();
801083bc:	e8 02 00 00 00       	call   801083c3 <switchkvm>
}
801083c1:	c9                   	leave  
801083c2:	c3                   	ret    
...
801083c6:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
801083c9:	a1 58 aa 11 80       	mov    0x8011aa58,%eax
801083ce:	89 04 24             	mov    %eax,(%esp)
801083d1:	e8 4f f9 ff ff       	call   80107d25 <v2p>
801083d6:	89 04 24             	mov    %eax,(%esp)
801083d9:	e8 3c f9 ff ff       	call   80107d1a <lcr3>
}
801083de:	c9                   	leave  
801083df:	c3                   	ret    
...
801083e4:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801083e7:	e8 50 d2 ff ff       	call   8010563c <pushcli>
...
801083fc:	89 d3                	mov    %edx,%ebx
801083fe:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108405:	83 c2 08             	add    $0x8,%edx
80108408:	c1 ea 10             	shr    $0x10,%edx
8010840b:	89 d1                	mov    %edx,%ecx
8010840d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108414:	83 c2 08             	add    $0x8,%edx
80108417:	c1 ea 18             	shr    $0x18,%edx
8010841a:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108421:	67 00 
80108423:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010842a:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108430:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108437:	83 e1 f0             	and    $0xfffffff0,%ecx
8010843a:	83 c9 09             	or     $0x9,%ecx
8010843d:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108443:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010844a:	83 c9 10             	or     $0x10,%ecx
8010844d:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108453:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010845a:	83 e1 9f             	and    $0xffffff9f,%ecx
8010845d:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108463:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010846a:	83 c9 80             	or     $0xffffff80,%ecx
8010846d:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108473:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010847a:	83 e1 f0             	and    $0xfffffff0,%ecx
8010847d:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108483:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010848a:	83 e1 ef             	and    $0xffffffef,%ecx
8010848d:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108493:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010849a:	83 e1 df             	and    $0xffffffdf,%ecx
8010849d:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084a3:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084aa:	83 c9 40             	or     $0x40,%ecx
801084ad:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084b3:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084ba:	83 e1 7f             	and    $0x7f,%ecx
801084bd:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084c3:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801084c9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801084cf:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801084d6:	83 e2 ef             	and    $0xffffffef,%edx
801084d9:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801084df:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801084e5:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801084eb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801084f1:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801084f8:	8b 52 08             	mov    0x8(%edx),%edx
801084fb:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108501:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108504:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010850b:	e8 df f7 ff ff       	call   80107cef <ltr>
  if(p->pgdir == 0)
80108510:	8b 45 08             	mov    0x8(%ebp),%eax
80108513:	8b 40 04             	mov    0x4(%eax),%eax
80108516:	85 c0                	test   %eax,%eax
80108518:	75 0c                	jne    80108526 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010851a:	c7 04 24 0f 91 10 80 	movl   $0x8010910f,(%esp)
80108521:	e8 14 80 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108526:	8b 45 08             	mov    0x8(%ebp),%eax
80108529:	8b 40 04             	mov    0x4(%eax),%eax
8010852c:	89 04 24             	mov    %eax,(%esp)
8010852f:	e8 f1 f7 ff ff       	call   80107d25 <v2p>
80108534:	89 04 24             	mov    %eax,(%esp)
80108537:	e8 de f7 ff ff       	call   80107d1a <lcr3>
  popcli();
8010853c:	e8 3f d1 ff ff       	call   80105680 <popcli>
}
80108541:	83 c4 14             	add    $0x14,%esp
80108544:	5b                   	pop    %ebx
80108545:	5d                   	pop    %ebp
80108546:	c3                   	ret    
...
8010854a:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010854d:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108554:	76 0c                	jbe    80108562 <inituvm+0x1b>
    panic("inituvm: more than a page");
80108556:	c7 04 24 23 91 10 80 	movl   $0x80109123,(%esp)
8010855d:	e8 d8 7f ff ff       	call   8010053a <panic>
  mem = kalloc();
80108562:	e8 88 a5 ff ff       	call   80102aef <kalloc>
...
80108580:	e8 b7 d1 ff ff       	call   8010573c <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108585:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108588:	89 04 24             	mov    %eax,(%esp)
8010858b:	e8 95 f7 ff ff       	call   80107d25 <v2p>
80108590:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108597:	00 
80108598:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010859c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801085a3:	00 
801085a4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801085ab:	00 
801085ac:	8b 45 08             	mov    0x8(%ebp),%eax
801085af:	89 04 24             	mov    %eax,(%esp)
801085b2:	e8 a0 fc ff ff       	call   80108257 <mappages>
  memmove(mem, init, sz);
801085b7:	8b 45 10             	mov    0x10(%ebp),%eax
801085ba:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801085cb:	e8 3b d2 ff ff       	call   8010580b <memmove>
}
801085d0:	c9                   	leave  
801085d1:	c3                   	ret    
...
801085d6:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
801085e3:	74 0c                	je     801085f1 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801085e5:	c7 04 24 40 91 10 80 	movl   $0x80109140,(%esp)
801085ec:	e8 49 7f ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
801085f1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801085f8:	e9 a9 00 00 00       	jmp    801086a6 <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801085fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108600:	8b 55 0c             	mov    0xc(%ebp),%edx
80108603:	01 d0                	add    %edx,%eax
80108605:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010860c:	00 
8010860d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108611:	8b 45 08             	mov    0x8(%ebp),%eax
80108614:	89 04 24             	mov    %eax,(%esp)
80108617:	e8 99 fb ff ff       	call   801081b5 <walkpgdir>
8010861c:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010861f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108623:	75 0c                	jne    80108631 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108625:	c7 04 24 63 91 10 80 	movl   $0x80109163,(%esp)
8010862c:	e8 09 7f ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80108631:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108634:	8b 00                	mov    (%eax),%eax
80108636:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010863b:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
8010863e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108641:	8b 55 18             	mov    0x18(%ebp),%edx
80108644:	29 c2                	sub    %eax,%edx
80108646:	89 d0                	mov    %edx,%eax
80108648:	3d ff 0f 00 00       	cmp    $0xfff,%eax
8010864d:	77 0f                	ja     8010865e <loaduvm+0x8c>
      n = sz - i;
8010864f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108652:	8b 55 18             	mov    0x18(%ebp),%edx
80108655:	29 c2                	sub    %eax,%edx
80108657:	89 d0                	mov    %edx,%eax
80108659:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010865c:	eb 07                	jmp    80108665 <loaduvm+0x93>
    else
      n = PGSIZE;
8010865e:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108665:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108668:	8b 55 14             	mov    0x14(%ebp),%edx
8010866b:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
8010866e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108671:	89 04 24             	mov    %eax,(%esp)
80108674:	e8 b9 f6 ff ff       	call   80107d32 <p2v>
80108679:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010867c:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108680:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108684:	89 44 24 04          	mov    %eax,0x4(%esp)
80108688:	8b 45 10             	mov    0x10(%ebp),%eax
8010868b:	89 04 24             	mov    %eax,(%esp)
8010868e:	e8 e2 96 ff ff       	call   80101d75 <readi>
80108693:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108696:	74 07                	je     8010869f <loaduvm+0xcd>
      return -1;
80108698:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010869d:	eb 18                	jmp    801086b7 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
8010869f:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801086a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086a9:	3b 45 18             	cmp    0x18(%ebp),%eax
801086ac:	0f 82 4b ff ff ff    	jb     801085fd <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801086b7:	83 c4 24             	add    $0x24,%esp
801086ba:	5b                   	pop    %ebx
801086bb:	5d                   	pop    %ebp
801086bc:	c3                   	ret    
...
801086c0:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801086c8:	79 0a                	jns    801086d4 <allocuvm+0x17>
    return 0;
801086ca:	b8 00 00 00 00       	mov    $0x0,%eax
801086cf:	e9 c1 00 00 00       	jmp    80108795 <allocuvm+0xd8>
  if(newsz < oldsz)
801086d4:	8b 45 10             	mov    0x10(%ebp),%eax
801086d7:	3b 45 0c             	cmp    0xc(%ebp),%eax
801086da:	73 08                	jae    801086e4 <allocuvm+0x27>
    return oldsz;
801086dc:	8b 45 0c             	mov    0xc(%ebp),%eax
801086df:	e9 b1 00 00 00       	jmp    80108795 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801086e4:	8b 45 0c             	mov    0xc(%ebp),%eax
801086e7:	05 ff 0f 00 00       	add    $0xfff,%eax
801086ec:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801086f1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
801086f4:	e9 8d 00 00 00       	jmp    80108786 <allocuvm+0xc9>
    mem = kalloc();
801086f9:	e8 f1 a3 ff ff       	call   80102aef <kalloc>
801086fe:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108701:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108705:	75 2c                	jne    80108733 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108707:	c7 04 24 81 91 10 80 	movl   $0x80109181,(%esp)
8010870e:	e8 8d 7c ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108713:	8b 45 0c             	mov    0xc(%ebp),%eax
80108716:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108727:	e8 6b 00 00 00       	call   80108797 <deallocuvm>
      return 0;
8010872c:	b8 00 00 00 00       	mov    $0x0,%eax
80108731:	eb 62                	jmp    80108795 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108733:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010873a:	00 
8010873b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108742:	00 
80108743:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108746:	89 04 24             	mov    %eax,(%esp)
80108749:	e8 ee cf ff ff       	call   8010573c <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010874e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108751:	89 04 24             	mov    %eax,(%esp)
80108754:	e8 cc f5 ff ff       	call   80107d25 <v2p>
80108759:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010875c:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108763:	00 
80108764:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108768:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010876f:	00 
80108770:	89 54 24 04          	mov    %edx,0x4(%esp)
80108774:	8b 45 08             	mov    0x8(%ebp),%eax
80108777:	89 04 24             	mov    %eax,(%esp)
8010877a:	e8 d8 fa ff ff       	call   80108257 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
8010877f:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108786:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108789:	3b 45 10             	cmp    0x10(%ebp),%eax
8010878c:	0f 82 67 ff ff ff    	jb     801086f9 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
8010880b:	75 0c                	jne    80108819 <deallocuvm+0x82>
        panic("kfree");
8010880d:	c7 04 24 99 91 10 80 	movl   $0x80109199,(%esp)
80108814:	e8 21 7d ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
80108819:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010881c:	89 04 24             	mov    %eax,(%esp)
8010881f:	e8 0e f5 ff ff       	call   80107d32 <p2v>
80108824:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108827:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010882a:	89 04 24             	mov    %eax,(%esp)
8010882d:	e8 24 a2 ff ff       	call   80102a56 <kfree>
      *pte = 0;
80108832:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108835:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
8010883b:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108842:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108845:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108848:	0f 82 74 ff ff ff    	jb     801087c2 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
8010884e:	8b 45 10             	mov    0x10(%ebp),%eax
}
80108851:	c9                   	leave  
80108852:	c3                   	ret    
...
80108856:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80108859:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010885d:	75 0c                	jne    8010886b <freevm+0x18>
    panic("freevm: no pgdir");
8010885f:	c7 04 24 9f 91 10 80 	movl   $0x8010919f,(%esp)
80108866:	e8 cf 7c ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010886b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108872:	00 
80108873:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010887a:	80 
8010887b:	8b 45 08             	mov    0x8(%ebp),%eax
8010887e:	89 04 24             	mov    %eax,(%esp)
80108881:	e8 11 ff ff ff       	call   80108797 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108886:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010888d:	eb 48                	jmp    801088d7 <freevm+0x84>
    if(pgdir[i] & PTE_P){
8010888f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108892:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108899:	8b 45 08             	mov    0x8(%ebp),%eax
8010889c:	01 d0                	add    %edx,%eax
8010889e:	8b 00                	mov    (%eax),%eax
801088a0:	83 e0 01             	and    $0x1,%eax
801088a3:	85 c0                	test   %eax,%eax
801088a5:	74 2c                	je     801088d3 <freevm+0x80>
...
801088b8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801088bd:	89 04 24             	mov    %eax,(%esp)
801088c0:	e8 6d f4 ff ff       	call   80107d32 <p2v>
801088c5:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801088c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088cb:	89 04 24             	mov    %eax,(%esp)
801088ce:	e8 83 a1 ff ff       	call   80102a56 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801088d3:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801088d7:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801088de:	76 af                	jbe    8010888f <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
801088e0:	8b 45 08             	mov    0x8(%ebp),%eax
801088e3:	89 04 24             	mov    %eax,(%esp)
801088e6:	e8 6b a1 ff ff       	call   80102a56 <kfree>
}
801088eb:	c9                   	leave  
801088ec:	c3                   	ret    
...
{
801088ed:	55                   	push   %ebp
801088ee:	89 e5                	mov    %esp,%ebp
801088f0:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801088f3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801088fa:	00 
...
80108908:	e8 a8 f8 ff ff       	call   801081b5 <walkpgdir>
8010890d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108910:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108914:	75 0c                	jne    80108922 <clearpteu+0x35>
    panic("clearpteu");
80108916:	c7 04 24 b0 91 10 80 	movl   $0x801091b0,(%esp)
8010891d:	e8 18 7c ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108922:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108925:	8b 00                	mov    (%eax),%eax
80108927:	83 e0 fb             	and    $0xfffffffb,%eax
8010892a:	89 c2                	mov    %eax,%edx
8010892c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010892f:	89 10                	mov    %edx,(%eax)
}
80108931:	c9                   	leave  
80108932:	c3                   	ret    
...
80108937:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010893a:	e8 b0 f9 ff ff       	call   801082ef <setupkvm>
8010893f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108942:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108946:	75 0a                	jne    80108952 <copyuvm+0x1f>
    return 0;
80108948:	b8 00 00 00 00       	mov    $0x0,%eax
8010894d:	e9 fd 00 00 00       	jmp    80108a4f <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108952:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108959:	e9 d0 00 00 00       	jmp    80108a2e <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010895e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108961:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108968:	00 
80108969:	89 44 24 04          	mov    %eax,0x4(%esp)
8010896d:	8b 45 08             	mov    0x8(%ebp),%eax
80108970:	89 04 24             	mov    %eax,(%esp)
80108973:	e8 3d f8 ff ff       	call   801081b5 <walkpgdir>
80108978:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010897b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010897f:	75 0c                	jne    8010898d <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108981:	c7 04 24 ba 91 10 80 	movl   $0x801091ba,(%esp)
80108988:	e8 ad 7b ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
8010898d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108990:	8b 00                	mov    (%eax),%eax
80108992:	83 e0 01             	and    $0x1,%eax
80108995:	85 c0                	test   %eax,%eax
80108997:	75 0c                	jne    801089a5 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108999:	c7 04 24 d4 91 10 80 	movl   $0x801091d4,(%esp)
801089a0:	e8 95 7b ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
801089a5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089a8:	8b 00                	mov    (%eax),%eax
801089aa:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801089af:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
801089b2:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089b5:	8b 00                	mov    (%eax),%eax
801089b7:	25 ff 0f 00 00       	and    $0xfff,%eax
801089bc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801089bf:	e8 2b a1 ff ff       	call   80102aef <kalloc>
801089c4:	89 45 e0             	mov    %eax,-0x20(%ebp)
801089c7:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801089cb:	75 02                	jne    801089cf <copyuvm+0x9c>
      goto bad;
801089cd:	eb 70                	jmp    80108a3f <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
801089cf:	8b 45 e8             	mov    -0x18(%ebp),%eax
801089d2:	89 04 24             	mov    %eax,(%esp)
801089d5:	e8 58 f3 ff ff       	call   80107d32 <p2v>
801089da:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801089e1:	00 
801089e2:	89 44 24 04          	mov    %eax,0x4(%esp)
801089e6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801089e9:	89 04 24             	mov    %eax,(%esp)
801089ec:	e8 1a ce ff ff       	call   8010580b <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801089f1:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801089f4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801089f7:	89 04 24             	mov    %eax,(%esp)
801089fa:	e8 26 f3 ff ff       	call   80107d25 <v2p>
801089ff:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108a02:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108a06:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108a0a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108a11:	00 
80108a12:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a16:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a19:	89 04 24             	mov    %eax,(%esp)
80108a1c:	e8 36 f8 ff ff       	call   80108257 <mappages>
80108a21:	85 c0                	test   %eax,%eax
80108a23:	79 02                	jns    80108a27 <copyuvm+0xf4>
      goto bad;
80108a25:	eb 18                	jmp    80108a3f <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108a27:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108a2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a31:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108a34:	0f 82 24 ff ff ff    	jb     8010895e <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108a3d:	eb 10                	jmp    80108a4f <copyuvm+0x11c>

bad:
  freevm(d);
80108a3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a42:	89 04 24             	mov    %eax,(%esp)
80108a45:	e8 09 fe ff ff       	call   80108853 <freevm>
  return 0;
80108a4a:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108a4f:	83 c4 44             	add    $0x44,%esp
80108a52:	5b                   	pop    %ebx
80108a53:	5d                   	pop    %ebp
80108a54:	c3                   	ret    
...
80108a58:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80108a5b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a62:	00 
...
80108a70:	e8 40 f7 ff ff       	call   801081b5 <walkpgdir>
...
80108a82:	75 07                	jne    80108a8b <uva2ka+0x36>
    return 0;
80108a84:	b8 00 00 00 00       	mov    $0x0,%eax
80108a89:	eb 25                	jmp    80108ab0 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108a8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a8e:	8b 00                	mov    (%eax),%eax
80108a90:	83 e0 04             	and    $0x4,%eax
80108a93:	85 c0                	test   %eax,%eax
80108a95:	75 07                	jne    80108a9e <uva2ka+0x49>
    return 0;
80108a97:	b8 00 00 00 00       	mov    $0x0,%eax
80108a9c:	eb 12                	jmp    80108ab0 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108a9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108aa1:	8b 00                	mov    (%eax),%eax
80108aa3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108aa8:	89 04 24             	mov    %eax,(%esp)
80108aab:	e8 82 f2 ff ff       	call   80107d32 <p2v>
}
80108ab0:	c9                   	leave  
80108ab1:	c3                   	ret    
...
{
80108ab2:	55                   	push   %ebp
80108ab3:	89 e5                	mov    %esp,%ebp
80108ab5:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108ab8:	8b 45 10             	mov    0x10(%ebp),%eax
80108abb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108abe:	e9 87 00 00 00       	jmp    80108b4a <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
80108ac3:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ac6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108acb:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108ace:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108ad1:	89 44 24 04          	mov    %eax,0x4(%esp)
80108ad5:	8b 45 08             	mov    0x8(%ebp),%eax
80108ad8:	89 04 24             	mov    %eax,(%esp)
80108adb:	e8 75 ff ff ff       	call   80108a55 <uva2ka>
80108ae0:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108ae3:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108ae7:	75 07                	jne    80108af0 <copyout+0x3e>
      return -1;
80108ae9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108aee:	eb 69                	jmp    80108b59 <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108af0:	8b 45 0c             	mov    0xc(%ebp),%eax
80108af3:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108af6:	29 c2                	sub    %eax,%edx
80108af8:	89 d0                	mov    %edx,%eax
80108afa:	05 00 10 00 00       	add    $0x1000,%eax
80108aff:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108b02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b05:	3b 45 14             	cmp    0x14(%ebp),%eax
80108b08:	76 06                	jbe    80108b10 <copyout+0x5e>
      n = len;
80108b0a:	8b 45 14             	mov    0x14(%ebp),%eax
80108b0d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108b10:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b13:	8b 55 0c             	mov    0xc(%ebp),%edx
80108b16:	29 c2                	sub    %eax,%edx
80108b18:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108b1b:	01 c2                	add    %eax,%edx
80108b1d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b20:	89 44 24 08          	mov    %eax,0x8(%esp)
80108b24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b27:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b2b:	89 14 24             	mov    %edx,(%esp)
80108b2e:	e8 d8 cc ff ff       	call   8010580b <memmove>
    len -= n;
80108b33:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b36:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108b39:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b3c:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108b3f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b42:	05 00 10 00 00       	add    $0x1000,%eax
80108b47:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108b4a:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108b4e:	0f 85 6f ff ff ff    	jne    80108ac3 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
