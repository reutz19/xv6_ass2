  ...
  62:	e8 16 03 00 00       	call   37d <exit>
{
  ...
  84:	00 
  85:	c7 44 24 04 44 04 00 	movl   $0x444,0x4(%esp)
  8c:	00 
  ...
  a9:	c7 44 24 04 63 04 00 	movl   $0x463,0x4(%esp)
  b0:	00 
  ...
  d6:	c7 44 24 04 77 04 00 	movl   $0x477,0x4(%esp)
  dd:	00 
  ...
  ef:	c7 44 24 04 8a 04 00 	movl   $0x48a,0x4(%esp)
  f6:	00 
