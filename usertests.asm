...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 dc 62 00 00       	mov    0x62dc,%eax
       b:	c7 44 24 04 32 44 00 	movl   $0x4432,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 32 40 00 00       	call   404d <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 3d 44 00 00 	movl   $0x443d,(%esp)
      22:	e8 f6 3e 00 00       	call   3f1d <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 dc 62 00 00       	mov    0x62dc,%eax
      30:	c7 44 24 04 45 44 00 	movl   $0x4445,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 0d 40 00 00       	call   404d <printf>
    exit();
      40:	e8 70 3e 00 00       	call   3eb5 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 3d 44 00 00 	movl   $0x443d,(%esp)
      4c:	e8 d4 3e 00 00       	call   3f25 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 dc 62 00 00       	mov    0x62dc,%eax
      5a:	c7 44 24 04 53 44 00 	movl   $0x4453,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 e3 3f 00 00       	call   404d <printf>
    exit();
      6a:	e8 46 3e 00 00       	call   3eb5 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 69 44 00 00 	movl   $0x4469,(%esp)
      76:	e8 8a 3e 00 00       	call   3f05 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 dc 62 00 00       	mov    0x62dc,%eax
      84:	c7 44 24 04 74 44 00 	movl   $0x4474,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 b9 3f 00 00       	call   404d <printf>
    exit();
      94:	e8 1c 3e 00 00       	call   3eb5 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 8e 44 00 00 	movl   $0x448e,(%esp)
      a0:	e8 80 3e 00 00       	call   3f25 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 dc 62 00 00       	mov    0x62dc,%eax
      ae:	c7 44 24 04 90 44 00 	movl   $0x4490,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 8f 3f 00 00       	call   404d <printf>
    exit();
      be:	e8 f2 3d 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 dc 62 00 00       	mov    0x62dc,%eax
      c8:	c7 44 24 04 a0 44 00 	movl   $0x44a0,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 75 3f 00 00       	call   404d <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 dc 62 00 00       	mov    0x62dc,%eax
      e5:	c7 44 24 04 ae 44 00 	movl   $0x44ae,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 58 3f 00 00       	call   404d <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 dc 62 00 00       	mov    0x62dc,%eax
     108:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 35 3f 00 00       	call   404d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 3d 44 00 00 	movl   $0x443d,(%esp)
     12e:	e8 ea 3d 00 00       	call   3f1d <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 dc 62 00 00       	mov    0x62dc,%eax
     13c:	c7 44 24 04 45 44 00 	movl   $0x4445,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 01 3f 00 00       	call   404d <printf>
      exit();
     14c:	e8 64 3d 00 00       	call   3eb5 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 3d 44 00 00 	movl   $0x443d,(%esp)
     158:	e8 c8 3d 00 00       	call   3f25 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 dc 62 00 00       	mov    0x62dc,%eax
     166:	c7 44 24 04 ca 44 00 	movl   $0x44ca,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 d7 3e 00 00       	call   404d <printf>
      exit();
     176:	e8 3a 3d 00 00       	call   3eb5 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 69 44 00 00 	movl   $0x4469,(%esp)
     182:	e8 7e 3d 00 00       	call   3f05 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 dc 62 00 00       	mov    0x62dc,%eax
     190:	c7 44 24 04 74 44 00 	movl   $0x4474,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 ad 3e 00 00       	call   404d <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 dc 62 00 00       	mov    0x62dc,%eax
     1b4:	c7 44 24 04 de 44 00 	movl   $0x44de,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 89 3e 00 00       	call   404d <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 dc 62 00 00       	mov    0x62dc,%eax
     1d1:	c7 44 24 04 f0 44 00 	movl   $0x44f0,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 6c 3e 00 00       	call   404d <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 ff 44 00 00 	movl   $0x44ff,(%esp)
     1e8:	e8 30 3d 00 00       	call   3f1d <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 dc 62 00 00       	mov    0x62dc,%eax
     1f6:	c7 44 24 04 05 45 00 	movl   $0x4505,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 47 3e 00 00       	call   404d <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 dc 62 00 00       	mov    0x62dc,%eax
     21e:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 1f 3e 00 00       	call   404d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 ff 44 00 00 	movl   $0x44ff,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 dc 62 00 00       	mov    0x62dc,%eax
     25b:	c7 44 24 04 1c 45 00 	movl   $0x451c,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 e2 3d 00 00       	call   404d <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 ff 44 00 00 	movl   $0x44ff,(%esp)
     288:	e8 78 3c 00 00       	call   3f05 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 dc 62 00 00       	mov    0x62dc,%eax
     296:	c7 44 24 04 40 45 00 	movl   $0x4540,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 a7 3d 00 00       	call   404d <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 dc 62 00 00       	mov    0x62dc,%eax
     2b5:	c7 44 24 04 4f 45 00 	movl   $0x454f,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 88 3d 00 00       	call   404d <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 dc 62 00 00       	mov    0x62dc,%eax
     2d2:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 6b 3d 00 00       	call   404d <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 1c 44 00 00 	movl   $0x441c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 dc 62 00 00       	mov    0x62dc,%eax
     304:	c7 44 24 04 6c 45 00 	movl   $0x456c,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 39 3d 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 7f 45 00 00 	movl   $0x457f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 dc 62 00 00       	mov    0x62dc,%eax
     346:	c7 44 24 04 8c 45 00 	movl   $0x458c,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 f7 3c 00 00       	call   404d <printf>
    exit();
     356:	e8 5a 3b 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 dc 62 00 00       	mov    0x62dc,%eax
     360:	c7 44 24 04 aa 45 00 	movl   $0x45aa,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 dd 3c 00 00       	call   404d <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 dc 62 00 00       	mov    0x62dc,%eax
     37d:	c7 44 24 04 b8 45 00 	movl   $0x45b8,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 c0 3c 00 00       	call   404d <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 c9 45 00 00 	movl   $0x45c9,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 dc 62 00 00       	mov    0x62dc,%eax
     3af:	c7 44 24 04 cf 45 00 	movl   $0x45cf,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 8e 3c 00 00       	call   404d <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 dc 62 00 00       	mov    0x62dc,%eax
     3d0:	c7 44 24 04 ea 45 00 	movl   $0x45ea,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 6d 3c 00 00       	call   404d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 06 46 00 	movl   $0x4606,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 dc 62 00 00       	mov    0x62dc,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 14 46 00 	movl   $0x4614,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 2c 3c 00 00       	call   404d <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 38 46 00 	movl   $0x4638,0x4(%esp)
     435:	00 
     ...
     446:	a1 dc 62 00 00       	mov    0x62dc,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 44 46 00 	movl   $0x4644,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 eb 3b 00 00       	call   404d <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 dc 62 00 00       	mov    0x62dc,%eax
     47a:	c7 44 24 04 68 46 00 	movl   $0x4668,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 c3 3b 00 00       	call   404d <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 c9 45 00 00 	movl   $0x45c9,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 dc 62 00 00       	mov    0x62dc,%eax
     4b7:	c7 44 24 04 73 46 00 	movl   $0x4673,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 86 3b 00 00       	call   404d <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 dc 62 00 00       	mov    0x62dc,%eax
     4f5:	c7 44 24 04 8c 46 00 	movl   $0x468c,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 48 3b 00 00       	call   404d <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 dc 62 00 00       	mov    0x62dc,%eax
     50f:	c7 44 24 04 a7 46 00 	movl   $0x46a7,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 2e 3b 00 00       	call   404d <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 c9 45 00 00 	movl   $0x45c9,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 dc 62 00 00       	mov    0x62dc,%eax
     541:	c7 44 24 04 ba 46 00 	movl   $0x46ba,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 fc 3a 00 00       	call   404d <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     556:	a1 dc 62 00 00       	mov    0x62dc,%eax
     55b:	c7 44 24 04 c7 46 00 	movl   $0x46c7,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 e2 3a 00 00       	call   404d <printf>
    exit();
     56b:	e8 45 39 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 dc 62 00 00       	mov    0x62dc,%eax
     575:	c7 44 24 04 dc 46 00 	movl   $0x46dc,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 c8 3a 00 00       	call   404d <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 dc 62 00 00       	mov    0x62dc,%eax
     592:	c7 44 24 04 f0 46 00 	movl   $0x46f0,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 ab 3a 00 00       	call   404d <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 00 47 00 00 	movl   $0x4700,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 dc 62 00 00       	mov    0x62dc,%eax
     5c4:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 79 3a 00 00       	call   404d <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 dc 62 00 00       	mov    0x62dc,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 1e 47 00 	movl   $0x471e,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 23 3a 00 00       	call   404d <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 00 47 00 00 	movl   $0x4700,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 dc 62 00 00       	mov    0x62dc,%eax
     66a:	c7 44 24 04 3c 47 00 	movl   $0x473c,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 d3 39 00 00       	call   404d <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b3:	a1 dc 62 00 00       	mov    0x62dc,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 55 47 00 	movl   $0x4755,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 7e 39 00 00       	call   404d <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 00 47 00 00 	movl   $0x4700,(%esp)
     ...
     6ff:	a1 dc 62 00 00       	mov    0x62dc,%eax
     704:	8b 55 f4             	mov    -0xc(%ebp),%edx
     707:	89 54 24 08          	mov    %edx,0x8(%esp)
     70b:	c7 44 24 04 72 47 00 	movl   $0x4772,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 32 39 00 00       	call   404d <printf>
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     761:	a1 dc 62 00 00       	mov    0x62dc,%eax
     766:	c7 44 24 04 a4 47 00 	movl   $0x47a4,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 d7 38 00 00       	call   404d <printf>
    exit();
     776:	e8 3a 37 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 dc 62 00 00       	mov    0x62dc,%eax
     780:	c7 44 24 04 b7 47 00 	movl   $0x47b7,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 bd 38 00 00       	call   404d <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 dc 62 00 00       	mov    0x62dc,%eax
     79d:	c7 44 24 04 c8 47 00 	movl   $0x47c8,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 a0 38 00 00       	call   404d <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 dc 62 00 00       	mov    0x62dc,%eax
     838:	c7 44 24 04 f0 47 00 	movl   $0x47f0,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 05 38 00 00       	call   404d <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 dc 62 00 00       	mov    0x62dc,%eax
     855:	c7 44 24 04 16 48 00 	movl   $0x4816,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 e8 37 00 00       	call   404d <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 22 48 00 00 	movl   $0x4822,(%esp)
     86c:	e8 ac 36 00 00       	call   3f1d <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 dc 62 00 00       	mov    0x62dc,%eax
     87a:	c7 44 24 04 45 44 00 	movl   $0x4445,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 c3 37 00 00       	call   404d <printf>
    exit();
     88a:	e8 26 36 00 00       	call   3eb5 <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 22 48 00 00 	movl   $0x4822,(%esp)
     896:	e8 8a 36 00 00       	call   3f25 <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 dc 62 00 00       	mov    0x62dc,%eax
     8a4:	c7 44 24 04 27 48 00 	movl   $0x4827,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 99 37 00 00       	call   404d <printf>
    exit();
     8b4:	e8 fc 35 00 00       	call   3eb5 <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 3a 48 00 00 	movl   $0x483a,(%esp)
     8c0:	e8 60 36 00 00       	call   3f25 <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 dc 62 00 00       	mov    0x62dc,%eax
     8ce:	c7 44 24 04 3d 48 00 	movl   $0x483d,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 6f 37 00 00       	call   404d <printf>
    exit();
     8de:	e8 d2 35 00 00       	call   3eb5 <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 22 48 00 00 	movl   $0x4822,(%esp)
     8ea:	e8 16 36 00 00       	call   3f05 <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 dc 62 00 00       	mov    0x62dc,%eax
     8f8:	c7 44 24 04 4e 48 00 	movl   $0x484e,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 45 37 00 00       	call   404d <printf>
    exit();
     908:	e8 a8 35 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 dc 62 00 00       	mov    0x62dc,%eax
     912:	c7 44 24 04 62 48 00 	movl   $0x4862,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 2b 37 00 00       	call   404d <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 dc 62 00 00       	mov    0x62dc,%eax
     92f:	c7 44 24 04 71 48 00 	movl   $0x4871,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 0e 37 00 00       	call   404d <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 c8 62 00 	movl   $0x62c8,0x4(%esp)
     946:	00 
     947:	c7 04 24 1c 44 00 00 	movl   $0x441c,(%esp)
     94e:	e8 9a 35 00 00       	call   3eed <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 dc 62 00 00       	mov    0x62dc,%eax
     95c:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 e1 36 00 00       	call   404d <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 8e 48 00 	movl   $0x488e,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 b1 36 00 00       	call   404d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a1a:	c7 44 24 04 9d 48 00 	movl   $0x489d,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 1f 36 00 00       	call   404d <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 ab 48 00 	movl   $0x48ab,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 a9 35 00 00       	call   404d <printf>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 33 35 00 00       	call   404d <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 df 48 00 	movl   $0x48df,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 0a 35 00 00       	call   404d <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 d0 48 00 	movl   $0x48d0,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 f4 34 00 00       	call   404d <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 e9 48 00 	movl   $0x48e9,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 d3 34 00 00       	call   404d <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 f3 48 00 	movl   $0x48f3,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 f5 48 00 	movl   $0x48f5,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 5b 34 00 00       	call   404d <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 09 49 00 	movl   $0x4909,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 0f 34 00 00       	call   404d <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 1c 49 00 	movl   $0x491c,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 ee 33 00 00       	call   404d <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 25 49 00 	movl   $0x4925,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 b9 33 00 00       	call   404d <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 2e 49 00 	movl   $0x492e,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 96 33 00 00       	call   404d <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 63 33 00 00       	call   404d <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 3a 49 00 	movl   $0x493a,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 3d 33 00 00       	call   404d <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 4a 49 00 	movl   $0x494a,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 18 33 00 00       	call   404d <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 57 49 00 	movl   $0x4957,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 fc 32 00 00       	call   404d <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 ab 35 00 00       	call   4339 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 54 34 00 00       	call   4200 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 04 34 00 00       	call   4200 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 7b 49 00 	movl   $0x497b,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 3d 32 00 00       	call   404d <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 83 49 00 	movl   $0x4983,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 17 32 00 00       	call   404d <printf>

  unlink("sharedfd");
     e36:	c7 04 24 92 49 00 00 	movl   $0x4992,(%esp)
     e3d:	e8 c3 30 00 00       	call   3f05 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 92 49 00 00 	movl   $0x4992,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 9c 49 00 	movl   $0x499c,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 da 31 00 00       	call   404d <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 c8 49 00 	movl   $0x49c8,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 68 31 00 00       	call   404d <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 92 49 00 00 	movl   $0x4992,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 e8 49 00 	movl   $0x49e8,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 0d 31 00 00       	call   404d <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 92 49 00 00 	movl   $0x4992,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 13 4a 00 	movl   $0x4a13,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 5e 30 00 00       	call   404d <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 20 4a 00 	movl   $0x4a20,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 3a 30 00 00       	call   404d <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 35 4a 00 00 	movl   $0x4a35,-0x38(%ebp)
    1027:	c7 45 cc 38 4a 00 00 	movl   $0x4a38,-0x34(%ebp)
    102e:	c7 45 d0 3b 4a 00 00 	movl   $0x4a3b,-0x30(%ebp)
    1035:	c7 45 d4 3e 4a 00 00 	movl   $0x4a3e,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 41 4a 00 	movl   $0x4a41,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 fd 2f 00 00       	call   404d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 ba 2f 00 00       	call   404d <printf>
      exit();
    ...
    10be:	c7 44 24 04 51 4a 00 	movl   $0x4a51,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 7b 2f 00 00       	call   404d <printf>
        exit();
    ...
    112c:	c7 44 24 04 60 4a 00 	movl   $0x4a60,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 0d 2f 00 00       	call   404d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 71 4a 00 	movl   $0x4a71,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 69 2e 00 00       	call   404d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    123a:	c7 44 24 04 7d 4a 00 	movl   $0x4a7d,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 ff 2d 00 00       	call   404d <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 8e 4a 00 	movl   $0x4a8e,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 cd 2d 00 00       	call   404d <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 9c 4a 00 	movl   $0x4a9c,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 b1 2d 00 00       	call   404d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 83 2d 00 00       	call   404d <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 51 4a 00 	movl   $0x4a51,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 22 2d 00 00       	call   404d <printf>
          exit();
    ...
    136c:	c7 44 24 04 40 45 00 	movl   $0x4540,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 cd 2c 00 00       	call   404d <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 b0 4a 00 	movl   $0x4ab0,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 10 2c 00 00       	call   404d <printf>
        exit();
    ...
    145b:	c7 44 24 04 d4 4a 00 	movl   $0x4ad4,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 de 2b 00 00       	call   404d <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 f4 4a 00 	movl   $0x4af4,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 55 2b 00 00       	call   404d <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 05 4b 00 	movl   $0x4b05,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 39 2b 00 00       	call   404d <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 16 4b 00 00 	movl   $0x4b16,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 21 4b 00 	movl   $0x4b21,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 08 2b 00 00       	call   404d <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 3b 4b 00 	movl   $0x4b3b,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 16 4b 00 00 	movl   $0x4b16,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	c7 44 24 04 77 4b 00 	movl   $0x4b77,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 0d 2a 00 00       	call   404d <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 8e 4b 00 	movl   $0x4b8e,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 e9 29 00 00       	call   404d <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1689:	c7 44 24 04 a5 4b 00 	movl   $0x4ba5,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 b0 29 00 00       	call   404d <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 16 4b 00 00 	movl   $0x4b16,(%esp)
    16b4:	e8 4c 28 00 00       	call   3f05 <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 be 4b 00 	movl   $0x4bbe,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 80 29 00 00       	call   404d <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 cd 4b 00 	movl   $0x4bcd,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 64 29 00 00       	call   404d <printf>

  unlink("lf1");
    16e9:	c7 04 24 d7 4b 00 00 	movl   $0x4bd7,(%esp)
    16f0:	e8 10 28 00 00       	call   3f05 <unlink>
  unlink("lf2");
    16f5:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
    16fc:	e8 04 28 00 00       	call   3f05 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 d7 4b 00 00 	movl   $0x4bd7,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 df 4b 00 	movl   $0x4bdf,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 1b 29 00 00       	call   404d <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 3b 4b 00 	movl   $0x4b3b,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 f2 4b 00 	movl   $0x4bf2,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 e2 28 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 41 4c 00 	movl   $0x4c41,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 33 28 00 00       	call   404d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183f:	c7 44 24 04 52 4c 00 	movl   $0x4c52,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 fa 27 00 00       	call   404d <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 db 4b 00 	movl   $0x4bdb,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
    1872:	e8 9e 26 00 00       	call   3f15 <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 63 4c 00 	movl   $0x4c63,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 be 27 00 00       	call   404d <printf>
    exit();
    188f:	e8 21 26 00 00       	call   3eb5 <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
    189b:	e8 65 26 00 00       	call   3f05 <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 d7 4b 00 	movl   $0x4bd7,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
    18af:	e8 61 26 00 00       	call   3f15 <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 84 4c 00 	movl   $0x4c84,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 81 27 00 00       	call   404d <printf>
    exit();
    18cc:	e8 e4 25 00 00       	call   3eb5 <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 d7 4b 00 	movl   $0x4bd7,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 a7 4c 00 00 	movl   $0x4ca7,(%esp)
    18e0:	e8 30 26 00 00       	call   3f15 <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 a9 4c 00 	movl   $0x4ca9,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 50 27 00 00       	call   404d <printf>
    exit();
    18fd:	e8 b3 25 00 00       	call   3eb5 <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 c5 4c 00 	movl   $0x4cc5,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 37 27 00 00       	call   404d <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 d2 4c 00 	movl   $0x4cd2,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 1b 27 00 00       	call   404d <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 e2 4c 00 00 	movl   $0x4ce2,(%esp)
    ...
    19d4:	c7 04 24 e2 4c 00 00 	movl   $0x4ce2,(%esp)
    ...
    1a05:	c7 44 24 04 e5 4c 00 	movl   $0x4ce5,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 34 26 00 00       	call   404d <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 a7 4c 00 00 	movl   $0x4ca7,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 01 4d 00 	movl   $0x4d01,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 6d 25 00 00       	call   404d <printf>
        exit();
    ...
    1afe:	c7 44 24 04 1a 4d 00 	movl   $0x4d1a,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 3b 25 00 00       	call   404d <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 38 4d 00 	movl   $0x4d38,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 e0 24 00 00       	call   404d <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 a4 24 00 00       	call   404d <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 69 4d 00 	movl   $0x4d69,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 84 23 00 00       	call   404d <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 77 4d 00 	movl   $0x4d77,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 68 23 00 00       	call   404d <printf>

  unlink("x");
    1ce5:	c7 04 24 f3 48 00 00 	movl   $0x48f3,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 3a 23 00 00       	call   404d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 f3 48 00 00 	movl   $0x48f3,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 f3 48 00 	movl   $0x48f3,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 88 4d 00 00 	movl   $0x4d88,(%esp)
    1db0:	e8 60 21 00 00       	call   3f15 <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 f3 48 00 00 	movl   $0x48f3,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 8c 4d 00 	movl   $0x4d8c,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 56 22 00 00       	call   404d <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 9b 4d 00 	movl   $0x4d9b,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 3a 22 00 00       	call   404d <printf>
  unlink("bd");
    1e13:	c7 04 24 a8 4d 00 00 	movl   $0x4da8,(%esp)
    1e1a:	e8 e6 20 00 00       	call   3f05 <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 a8 4d 00 00 	movl   $0x4da8,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 ab 4d 00 	movl   $0x4dab,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 fd 21 00 00       	call   404d <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 a8 4d 00 00 	movl   $0x4da8,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 d5 4d 00 	movl   $0x4dd5,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 0f 21 00 00       	call   404d <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 ea 4d 00 	movl   $0x4dea,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 e9 20 00 00       	call   404d <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 f5 4d 00 	movl   $0x4df5,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 cd 20 00 00       	call   404d <printf>

  unlink("ff");
    1f80:	c7 04 24 02 4e 00 00 	movl   $0x4e02,(%esp)
    1f87:	e8 79 1f 00 00       	call   3f05 <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 05 4e 00 00 	movl   $0x4e05,(%esp)
    1f93:	e8 85 1f 00 00       	call   3f1d <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 08 4e 00 	movl   $0x4e08,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 9d 20 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 20 4e 00 00 	movl   $0x4e20,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 26 4e 00 	movl   $0x4e26,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 67 20 00 00       	call   404d <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 02 4e 00 	movl   $0x4e02,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 84 4e 00 00 	movl   $0x4e84,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 8d 4e 00 	movl   $0x4e8d,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 b9 1f 00 00       	call   404d <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 a5 4e 00 	movl   $0x4ea5,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 a8 4e 00 00 	movl   $0x4ea8,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 b4 4e 00 	movl   $0x4eb4,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 5d 1f 00 00       	call   404d <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 cd 4e 00 	movl   $0x4ecd,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 15 1f 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 e8 4e 00 00 	movl   $0x4ee8,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 b2 4f 00 	movl   $0x4fb2,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 a5 1d 00 00       	call   404d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cd:	c7 44 24 04 ca 4f 00 	movl   $0x4fca,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 6c 1d 00 00       	call   404d <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 44 52 00 	movl   $0x5244,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 87 19 00 00       	call   404d <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 53 52 00 00 	movl   $0x5253,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 53 52 00 00 	movl   $0x5253,(%esp)
    ...
    26fb:	c7 44 24 04 5c 52 00 	movl   $0x525c,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 3e 19 00 00       	call   404d <printf>
      exit();
    ...
    2750:	c7 44 24 04 74 52 00 	movl   $0x5274,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 e9 18 00 00       	call   404d <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 53 52 00 00 	movl   $0x5253,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 86 52 00 	movl   $0x5286,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 9b 18 00 00       	call   404d <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 93 52 00 	movl   $0x5293,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 7f 18 00 00       	call   404d <printf>

  unlink("bigfile");
    27ce:	c7 04 24 a1 52 00 00 	movl   $0x52a1,(%esp)
    27d5:	e8 2b 17 00 00       	call   3f05 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 a1 52 00 00 	movl   $0x52a1,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 a9 52 00 	movl   $0x52a9,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 42 18 00 00       	call   404d <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2856:	c7 44 24 04 bf 52 00 	movl   $0x52bf,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 e3 17 00 00       	call   404d <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 a1 52 00 00 	movl   $0x52a1,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 d5 52 00 	movl   $0x52d5,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 98 17 00 00       	call   404d <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ec:	c7 44 24 04 ea 52 00 	movl   $0x52ea,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 4d 17 00 00       	call   404d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 ff 52 00 	movl   $0x52ff,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 0a 17 00 00       	call   404d <printf>
      exit();
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 13 53 00 	movl   $0x5313,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 bd 16 00 00       	call   404d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 2c 53 00 	movl   $0x532c,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 95 16 00 00       	call   404d <printf>
    exit();
    29b8:	e8 f8 14 00 00       	call   3eb5 <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 a1 52 00 00 	movl   $0x52a1,(%esp)
    29c4:	e8 3c 15 00 00       	call   3f05 <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 46 53 00 	movl   $0x5346,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 70 16 00 00       	call   404d <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 e4 53 00 00 	movl   $0x53e4,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 14 54 00 	movl   $0x5414,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 d1 15 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 54 54 00 00 	movl   $0x5454,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 84 54 00 	movl   $0x5484,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 90 15 00 00       	call   404d <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 1b 56 00 	movl   $0x561b,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 86 13 00 00       	call   404d <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 28 56 00 00 	movl   $0x5628,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 30 56 00 	movl   $0x5630,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 55 13 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 61 56 00 00 	movl   $0x5661,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 6c 56 00 	movl   $0x566c,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 eb 12 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 61 56 00 00 	movl   $0x5661,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 a7 4c 00 00 	movl   $0x4ca7,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 04 57 00 	movl   $0x5704,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 d3 11 00 00       	call   404d <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 23 57 00 	movl   $0x5723,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 84 11 00 00       	call   404d <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 37 57 00 	movl   $0x5737,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 60 11 00 00       	call   404d <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 47 57 00 	movl   $0x5747,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 44 11 00 00       	call   404d <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 87 57 00 00 	movl   $0x5787,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 87 57 00 00 	movl   $0x5787,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 8e 44 00 00 	movl   $0x448e,(%esp)
    2ff8:	e8 28 0f 00 00       	call   3f25 <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 8a 57 00 	movl   $0x578a,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 3c 10 00 00       	call   404d <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 9e 57 00 	movl   $0x579e,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 20 10 00 00       	call   404d <printf>
    ...
    304c:	e8 64 0e 00 00       	call   3eb5 <exit>
{
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 ac 57 00 	movl   $0x57ac,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 d2 0f 00 00       	call   404d <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 ce 57 00 	movl   $0x57ce,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 ae 0f 00 00       	call   404d <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 e2 57 00 	movl   $0x57e2,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 81 0f 00 00       	call   404d <printf>
    exit();
    30cc:	e8 e4 0d 00 00       	call   3eb5 <exit>
  }
  
  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 f5 57 00 	movl   $0x57f5,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 68 0f 00 00       	call   404d <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 dc 62 00 00       	mov    0x62dc,%eax
    30f6:	c7 44 24 04 03 58 00 	movl   $0x5803,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 47 0f 00 00       	call   404d <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3144:	a1 dc 62 00 00       	mov    0x62dc,%eax
    ...
    315e:	c7 44 24 04 0e 58 00 	movl   $0x580e,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 df 0e 00 00       	call   404d <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 dc 62 00 00       	mov    0x62dc,%eax
    31a2:	c7 44 24 04 29 58 00 	movl   $0x5829,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 9b 0e 00 00       	call   404d <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 dc 62 00 00       	mov    0x62dc,%eax
    31e5:	c7 44 24 04 40 58 00 	movl   $0x5840,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 58 0e 00 00       	call   404d <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    323e:	a1 dc 62 00 00       	mov    0x62dc,%eax
    3243:	c7 44 24 04 5c 58 00 	movl   $0x585c,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 fa 0d 00 00       	call   404d <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 dc 62 00 00       	mov    0x62dc,%eax
    328e:	c7 44 24 04 9a 58 00 	movl   $0x589a,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 af 0d 00 00       	call   404d <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 dc 62 00 00       	mov    0x62dc,%eax
    ...
    32d2:	c7 44 24 04 b8 58 00 	movl   $0x58b8,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 6b 0d 00 00       	call   404d <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 dc 62 00 00       	mov    0x62dc,%eax
    ...
    3339:	c7 44 24 04 f0 58 00 	movl   $0x58f0,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 04 0d 00 00       	call   404d <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 dc 62 00 00       	mov    0x62dc,%eax
    335d:	c7 44 24 04 18 59 00 	movl   $0x5918,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 e0 0c 00 00       	call   404d <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 dc 62 00 00       	mov    0x62dc,%eax
    ...
    33ba:	c7 44 24 04 48 59 00 	movl   $0x5948,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 83 0c 00 00       	call   404d <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 dc 62 00 00       	mov    0x62dc,%eax
    33f3:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 4a 0c 00 00       	call   404d <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 8e 48 00 	movl   $0x488e,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 ca 0b 00 00       	call   404d <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 f3 48 00 	movl   $0x48f3,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 dc 62 00 00       	mov    0x62dc,%eax
    3578:	c7 44 24 04 82 59 00 	movl   $0x5982,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 c5 0a 00 00       	call   404d <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 dc 62 00 00       	mov    0x62dc,%eax
    35be:	c7 44 24 04 9d 59 00 	movl   $0x599d,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 7f 0a 00 00       	call   404d <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 dc 62 00 00       	mov    0x62dc,%eax
    3604:	c7 44 24 04 ab 59 00 	movl   $0x59ab,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 39 0a 00 00       	call   404d <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 ba 59 00 00 	movl   $0x59ba,(%esp)
    3678:	e8 98 08 00 00       	call   3f15 <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 dc 62 00 00       	mov    0x62dc,%eax
    3687:	c7 44 24 04 c5 59 00 	movl   $0x59c5,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 b6 09 00 00       	call   404d <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 dc 62 00 00       	mov    0x62dc,%eax
    36b4:	c7 44 24 04 de 59 00 	movl   $0x59de,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 89 09 00 00       	call   404d <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 dc 62 00 00       	mov    0x62dc,%eax
    36d1:	c7 44 24 04 eb 59 00 	movl   $0x59eb,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 6c 09 00 00       	call   404d <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36f9:	a1 dc 62 00 00       	mov    0x62dc,%eax
    36fe:	c7 44 24 04 f5 59 00 	movl   $0x59f5,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 3f 09 00 00       	call   404d <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 dc 62 00 00       	mov    0x62dc,%eax
    3726:	c7 44 24 04 06 5a 00 	movl   $0x5a06,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 17 09 00 00       	call   404d <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 13 5a 00 00 	movl   $0x5a13,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 00 63 00 00 	movl   $0x5a20,0x6300(,%eax,4)
    376f:	20 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3787:	a1 dc 62 00 00       	mov    0x62dc,%eax
    378c:	c7 44 24 04 fd 5a 00 	movl   $0x5afd,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 b1 08 00 00       	call   404d <printf>
    exec("echo", args);
    379c:	c7 44 24 04 00 63 00 	movl   $0x6300,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 1c 44 00 00 	movl   $0x441c,(%esp)
    37ab:	e8 3d 07 00 00       	call   3eed <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 dc 62 00 00       	mov    0x62dc,%eax
    37b5:	c7 44 24 04 0a 5b 00 	movl   $0x5b0a,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 88 08 00 00       	call   404d <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 13 5a 00 00 	movl   $0x5a13,(%esp)
    ...
    37f2:	a1 dc 62 00 00       	mov    0x62dc,%eax
    37f7:	c7 44 24 04 1a 5b 00 	movl   $0x5b1a,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 46 08 00 00       	call   404d <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 13 5a 00 00 	movl   $0x5a13,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 dc 62 00 00       	mov    0x62dc,%eax
    3833:	c7 44 24 04 33 5b 00 	movl   $0x5b33,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 0a 08 00 00       	call   404d <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 13 5a 00 00 	movl   $0x5a13,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 48 5b 00 	movl   $0x5b48,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 ca 07 00 00       	call   404d <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 55 5b 00 	movl   $0x5b55,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 e0 06 00 00       	call   404d <printf>
    ...
    3990:	c7 44 24 04 61 5b 00 	movl   $0x5b61,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 a9 06 00 00       	call   404d <printf>
      break;
    ...
    39dc:	c7 44 24 04 71 5b 00 	movl   $0x5b71,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 5d 06 00 00       	call   404d <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 81 5b 00 	movl   $0x5b81,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 39 05 00 00       	call   404d <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b1d:	a1 e0 62 00 00       	mov    0x62e0,%eax
    3b22:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b28:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b2d:	a3 e0 62 00 00       	mov    %eax,0x62e0
  return randstate;
    3b32:	a1 e0 62 00 00       	mov    0x62e0,%eax
}
    3b37:	5d                   	pop    %ebp
    3b38:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3b8e:	00 
    3b8f:	c7 04 24 ab 5b 00 00 	movl   $0x5bab,(%esp)
...
00003f65 <sigpause>:
    3f65:	b8 19 00 00 00       	mov    $0x19,%eax
    3f6a:	cd 40                	int    $0x40
    3f6c:	c3                   	ret    
...
{
    3f6d:	55                   	push   %ebp
    3f6e:	89 e5                	mov    %esp,%ebp
    3f70:	83 ec 18             	sub    $0x18,%esp
    3f73:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f76:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3f79:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f80:	00 
    3f81:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3f84:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f88:	8b 45 08             	mov    0x8(%ebp),%eax
    3f8b:	89 04 24             	mov    %eax,(%esp)
    3f8e:	e8 42 ff ff ff       	call   3ed5 <write>
}
    3f93:	c9                   	leave  
    3f94:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3f9d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3fa4:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fa8:	74 17                	je     3fc1 <printint+0x2c>
    3faa:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fae:	79 11                	jns    3fc1 <printint+0x2c>
    neg = 1;
    3fb0:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fb7:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fba:	f7 d8                	neg    %eax
    3fbc:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fbf:	eb 06                	jmp    3fc7 <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
    3fc7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3fce:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    3fd1:	8d 41 01             	lea    0x1(%ecx),%eax
    3fd4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3fd7:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3fda:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3fdd:	ba 00 00 00 00       	mov    $0x0,%edx
    3fe2:	f7 f3                	div    %ebx
    3fe4:	89 d0                	mov    %edx,%eax
    3fe6:	0f b6 80 e4 62 00 00 	movzbl 0x62e4(%eax),%eax
    3fed:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    3ff1:	8b 75 10             	mov    0x10(%ebp),%esi
    3ff4:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ff7:	ba 00 00 00 00       	mov    $0x0,%edx
    3ffc:	f7 f6                	div    %esi
    3ffe:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4001:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4005:	75 c7                	jne    3fce <printint+0x39>
  if(neg)
    4007:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    400b:	74 10                	je     401d <printint+0x88>
    buf[i++] = '-';
    400d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4010:	8d 50 01             	lea    0x1(%eax),%edx
    4013:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4016:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    401b:	eb 1f                	jmp    403c <printint+0xa7>
    401d:	eb 1d                	jmp    403c <printint+0xa7>
    putc(fd, buf[i]);
    401f:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4022:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4025:	01 d0                	add    %edx,%eax
    4027:	0f b6 00             	movzbl (%eax),%eax
    402a:	0f be c0             	movsbl %al,%eax
    402d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4031:	8b 45 08             	mov    0x8(%ebp),%eax
    4034:	89 04 24             	mov    %eax,(%esp)
    4037:	e8 31 ff ff ff       	call   3f6d <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    403c:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4040:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4044:	79 d9                	jns    401f <printint+0x8a>
    putc(fd, buf[i]);
}
    4046:	83 c4 30             	add    $0x30,%esp
    4049:	5b                   	pop    %ebx
    404a:	5e                   	pop    %esi
    404b:	5d                   	pop    %ebp
    404c:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    4050:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4053:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    405a:	8d 45 0c             	lea    0xc(%ebp),%eax
    405d:	83 c0 04             	add    $0x4,%eax
    4060:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4063:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    406a:	e9 7c 01 00 00       	jmp    41eb <printf+0x19e>
    c = fmt[i] & 0xff;
    406f:	8b 55 0c             	mov    0xc(%ebp),%edx
    4072:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4075:	01 d0                	add    %edx,%eax
    4077:	0f b6 00             	movzbl (%eax),%eax
    407a:	0f be c0             	movsbl %al,%eax
    407d:	25 ff 00 00 00       	and    $0xff,%eax
    4082:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    4085:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4089:	75 2c                	jne    40b7 <printf+0x6a>
      if(c == '%'){
    408b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    408f:	75 0c                	jne    409d <printf+0x50>
        state = '%';
    4091:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    4098:	e9 4a 01 00 00       	jmp    41e7 <printf+0x19a>
      } else {
        putc(fd, c);
    409d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    40a0:	0f be c0             	movsbl %al,%eax
    40a3:	89 44 24 04          	mov    %eax,0x4(%esp)
    40a7:	8b 45 08             	mov    0x8(%ebp),%eax
    40aa:	89 04 24             	mov    %eax,(%esp)
    40ad:	e8 bb fe ff ff       	call   3f6d <putc>
    40b2:	e9 30 01 00 00       	jmp    41e7 <printf+0x19a>
      }
    } else if(state == '%'){
    40b7:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40bb:	0f 85 26 01 00 00    	jne    41e7 <printf+0x19a>
      if(c == 'd'){
    40c1:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40c5:	75 2d                	jne    40f4 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    40c7:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40ca:	8b 00                	mov    (%eax),%eax
    40cc:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    40d3:	00 
    40d4:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    40db:	00 
    40dc:	89 44 24 04          	mov    %eax,0x4(%esp)
    40e0:	8b 45 08             	mov    0x8(%ebp),%eax
    40e3:	89 04 24             	mov    %eax,(%esp)
    40e6:	e8 aa fe ff ff       	call   3f95 <printint>
        ap++;
    40eb:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    40ef:	e9 ec 00 00 00       	jmp    41e0 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    40f4:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    40f8:	74 06                	je     4100 <printf+0xb3>
    40fa:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    40fe:	75 2d                	jne    412d <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4100:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4103:	8b 00                	mov    (%eax),%eax
    4105:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    410c:	00 
    410d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4114:	00 
    4115:	89 44 24 04          	mov    %eax,0x4(%esp)
    4119:	8b 45 08             	mov    0x8(%ebp),%eax
    411c:	89 04 24             	mov    %eax,(%esp)
    411f:	e8 71 fe ff ff       	call   3f95 <printint>
        ap++;
    4124:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4128:	e9 b3 00 00 00       	jmp    41e0 <printf+0x193>
      } else if(c == 's'){
    412d:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4131:	75 45                	jne    4178 <printf+0x12b>
        s = (char*)*ap;
    4133:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4136:	8b 00                	mov    (%eax),%eax
    4138:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    413b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    413f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4143:	75 09                	jne    414e <printf+0x101>
          s = "(null)";
    4145:	c7 45 f4 e6 5b 00 00 	movl   $0x5be6,-0xc(%ebp)
        while(*s != 0){
    414c:	eb 1e                	jmp    416c <printf+0x11f>
    414e:	eb 1c                	jmp    416c <printf+0x11f>
          putc(fd, *s);
    4150:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4153:	0f b6 00             	movzbl (%eax),%eax
    4156:	0f be c0             	movsbl %al,%eax
    4159:	89 44 24 04          	mov    %eax,0x4(%esp)
    415d:	8b 45 08             	mov    0x8(%ebp),%eax
    4160:	89 04 24             	mov    %eax,(%esp)
    4163:	e8 05 fe ff ff       	call   3f6d <putc>
          s++;
    4168:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    416f:	0f b6 00             	movzbl (%eax),%eax
    4172:	84 c0                	test   %al,%al
    4174:	75 da                	jne    4150 <printf+0x103>
    4176:	eb 68                	jmp    41e0 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4178:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    417c:	75 1d                	jne    419b <printf+0x14e>
        putc(fd, *ap);
    417e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4181:	8b 00                	mov    (%eax),%eax
    4183:	0f be c0             	movsbl %al,%eax
    4186:	89 44 24 04          	mov    %eax,0x4(%esp)
    418a:	8b 45 08             	mov    0x8(%ebp),%eax
    418d:	89 04 24             	mov    %eax,(%esp)
    4190:	e8 d8 fd ff ff       	call   3f6d <putc>
        ap++;
    4195:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4199:	eb 45                	jmp    41e0 <printf+0x193>
      } else if(c == '%'){
    419b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    419f:	75 17                	jne    41b8 <printf+0x16b>
        putc(fd, c);
    41a1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41a4:	0f be c0             	movsbl %al,%eax
    41a7:	89 44 24 04          	mov    %eax,0x4(%esp)
    41ab:	8b 45 08             	mov    0x8(%ebp),%eax
    41ae:	89 04 24             	mov    %eax,(%esp)
    41b1:	e8 b7 fd ff ff       	call   3f6d <putc>
    41b6:	eb 28                	jmp    41e0 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    41b8:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    41bf:	00 
    41c0:	8b 45 08             	mov    0x8(%ebp),%eax
    41c3:	89 04 24             	mov    %eax,(%esp)
    41c6:	e8 a2 fd ff ff       	call   3f6d <putc>
        putc(fd, c);
    41cb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41ce:	0f be c0             	movsbl %al,%eax
    41d1:	89 44 24 04          	mov    %eax,0x4(%esp)
    41d5:	8b 45 08             	mov    0x8(%ebp),%eax
    41d8:	89 04 24             	mov    %eax,(%esp)
    41db:	e8 8d fd ff ff       	call   3f6d <putc>
      }
      state = 0;
    41e0:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    41e7:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    41eb:	8b 55 0c             	mov    0xc(%ebp),%edx
    41ee:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41f1:	01 d0                	add    %edx,%eax
    41f3:	0f b6 00             	movzbl (%eax),%eax
    41f6:	84 c0                	test   %al,%al
    41f8:	0f 85 71 fe ff ff    	jne    406f <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  if(p + p->s.size == bp){
    ...
    42c6:	8b 10                	mov    (%eax),%edx
    42c8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42cb:	89 10                	mov    %edx,(%eax)
    42cd:	eb 08                	jmp    42d7 <free+0xd7>
  } else
    p->s.ptr = bp;
    42cf:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42d2:	8b 55 f8             	mov    -0x8(%ebp),%edx
    42d5:	89 10                	mov    %edx,(%eax)
  freep = p;
    42d7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42da:	a3 88 63 00 00       	mov    %eax,0x6388
}
    42df:	c9                   	leave  
    42e0:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    42e4:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    42e7:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    42ee:	77 07                	ja     42f7 <morecore+0x16>
    nu = 4096;
    42f0:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    42f7:	8b 45 08             	mov    0x8(%ebp),%eax
    42fa:	c1 e0 03             	shl    $0x3,%eax
    42fd:	89 04 24             	mov    %eax,(%esp)
    4300:	e8 38 fc ff ff       	call   3f3d <sbrk>
    4305:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4308:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    430c:	75 07                	jne    4315 <morecore+0x34>
    return 0;
    430e:	b8 00 00 00 00       	mov    $0x0,%eax
    4313:	eb 22                	jmp    4337 <morecore+0x56>
  hp = (Header*)p;
    4315:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4318:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    431b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    431e:	8b 55 08             	mov    0x8(%ebp),%edx
    4321:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4324:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4327:	83 c0 08             	add    $0x8,%eax
    432a:	89 04 24             	mov    %eax,(%esp)
    432d:	e8 ce fe ff ff       	call   4200 <free>
  return freep;
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43dd:	eb 38                	jmp    4417 <malloc+0xde>
    }
    if(p == freep)
    43df:	a1 88 63 00 00       	mov    0x6388,%eax
    43e4:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    43e7:	75 1b                	jne    4404 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    43e9:	8b 45 ec             	mov    -0x14(%ebp),%eax
    43ec:	89 04 24             	mov    %eax,(%esp)
    43ef:	e8 ed fe ff ff       	call   42e1 <morecore>
    43f4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    43f7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    43fb:	75 07                	jne    4404 <malloc+0xcb>
        return 0;
    43fd:	b8 00 00 00 00       	mov    $0x0,%eax
    4402:	eb 13                	jmp    4417 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4412:	e9 70 ff ff ff       	jmp    4387 <malloc+0x4e>
}
    4417:	c9                   	leave  
    4418:	c3                   	ret    
